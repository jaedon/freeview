...
#define PRMAPI_VERSION_MEDIUM 2
 ...
 *  @ingroup groupInitTerm 
 *  @brief
 *   Pause the DVR/VOD Library. This call should be made when entering in standby,
 *   especially when the CERT is used. 
 *   
 *
 *  @pre
 *    The DVR/VOD Library must be running.
 ...
 *            running.
*/
NAGRA_CA_API TDvlStatus dvlOnPause
(
  void
);
 ...
 *  @ingroup groupInitTerm 
 *  @brief
 *   Resume the DVR/VOD Library. This call should be made when DVL resumes after a standby,
 *   especially when the CERT is used. 
 *   
 *
 *  @pre
 ...
 *            running.
*/
NAGRA_CA_API TDvlStatus dvlOnResume
(
  void
);
