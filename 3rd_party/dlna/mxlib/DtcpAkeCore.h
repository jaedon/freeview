...
int DtcpAkeCore_ConsumeResponse2Data(DtcpAkeCoreSessionHandle aAkeCoreSessionHandle,
                                    unsigned char *aResponseCmdBuffer,
                                    unsigned int  aResponseCmdBufferSize,
                                    unsigned int *aOurSrmUpdateRequiredFlag);
...
int DtcpAkeCore_ConsumeMvExchangeKeyData(DtcpAkeCoreSessionHandle aAkeCoreSessionHandle,
                                       EnExchKeyId aExchKeyId,
                                       unsigned char *aExchangeKeyCmdBuffer,
                                       unsigned int aExchangeKeyCmdBufferSize);
...
int DtcpCore_CheckNeedToRttTest(DtcpAkeCoreSessionHandle *aAkeCoreSessionHandle , int moveMode);
int DtcpCore_AddRttRegistry(DtcpAkeCoreSessionHandle *aAkeCoreSessionHandle );
int DtcpAkeCore_CalcRttSetupData( DtcpAkeCoreSessionHandle aAkeCoreSessionHandle,unsigned char *aRttSetupCmdBuffer);
int DtcpAkeCore_CreateRttTestData(DtcpAkeCoreSessionHandle *aAkeCoreSessionHandle,
												  unsigned char **testBuffer,
												  int *testBufferLength);
int DtcpAkeCore_DestroyRttTestData( unsigned char *buffer );
int DtcpAkeCore_ConsumeRttSetupData(DtcpAkeCoreSessionHandle aAkeCoreSessionHandle,
                                     unsigned char *aRttSetupCmdBuffer,
                                     unsigned int aRttSetupCmdBufferSize);

int DtcpAkeCore_ConsumeRttTestData(DtcpAkeCoreSessionHandle aAkeCoreSessionHandle,
                                     unsigned char *aRttTestCmdBuffer,
                                     unsigned int aRttTestCmdBufferSize);

int DtcpAkeCore_ConsumeRttVerifyData(DtcpAkeCoreSessionHandle aAkeCoreSessionHandle,
                                     unsigned char *aRttVerifyCmdBuffer,
                                     unsigned int aRttVerifyCmdBufferSize);




int DtcpCore_AddHttpSessionInfo( long ip , DtcpAkeCoreSessionHandle *aAkeCoreSessionHandle );

int DtcpCore_UpdateHttpSessionInfo( long ip , unsigned char   HttpNonce[] , unsigned char ExchangeKey[] );


/// @}

// hoonie
#define HTTPSESSION_STATE_NOT_FOUND		-1
#define HTTPSESSION_STATE_INIT			0
#define HTTPSESSION_STATE_EXCHANGE		1
#define HTTPSESSION_STATE_TRANSPORT		2
#define HTTPSESSION_STATE_COMMIT		3
#define HTTPSESSION_STATE_MOVE_CANCEL	4
