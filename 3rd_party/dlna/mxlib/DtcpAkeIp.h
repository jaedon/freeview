...
int DtcpAkeIp_DoAke(DtcpAkeIpSessionHandle aAkeIpSessionHandle , int bMove);
#else
...
#ifdef DTCP_MOVE_SUPPORT
int DtcpAkeIp_MoveCommit(DtcpAkeIpSessionHandle aAkeIpSessionHandle, int bCommit);
#endif
