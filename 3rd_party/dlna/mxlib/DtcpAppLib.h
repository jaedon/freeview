...
int DtcpAppSetLogLevel( int level );
...
int DtcpAppLib_DoAkeForMove(const char *aRemoteIp, unsigned short aRemotePort, void **aAkeHandle);
int DtcpAppLib_MoveCommit(void *aAkeHandle, int bCommit);
int DtcpAppLib_WaitAKE( long ip );
int DtcpAppLib_WaitAKECommit( long ip );
int DtcpAppLib_WaitStopAKE( long ip );
int DtcpAppLib_IsMoveMode( long ip );
#endif
