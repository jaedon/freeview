...
#define DTCP_FULL_AUTH_RESPONSE2_SIZE                (DTCP_FULL_AUTH_RESPONSE_SIZE + 9)                     ///< Size of a full auth response
...
#define DTCP_FULL_AUTH_RESPONSE2_SIGN_BUFFER_SIZE	(DTCP_FULL_AUTH_RESPONSE_SIGN_BUFFER_SIZE+9)
