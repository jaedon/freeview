...
/*************************************************************************************************************
	CorsairDsmccStreamEventListener class body
*************************************************************************************************************/
CorsairDsmccStreamEventListener::CorsairDsmccStreamEventListener( const char* pcTargetURL, 
    ...
    ,m_event_name(pcEventName)
    ,m_target_url(pcTargetURL)
    ,m_listener_id(pListenerId)
...
CorsairDsmccStreamEventListener::~CorsairDsmccStreamEventListener()
{
	LOG_DEBUG(" (+)\n" );
	m_event_name.clear();
	m_target_url.clear();
...
int CorsairDsmccStreamEventListener::onStreamEventRecieved( const char *target_url, unsigned short event_id, const char *event_name, unsigned char *data, unsigned int data_length)
{
	...
	
	{
    	...
    	if ( event_name == NULL ||
    	     ...
    	     target_url == NULL ||
    	     target_uri.compareFilename(target_url) != 0 )
    	{
