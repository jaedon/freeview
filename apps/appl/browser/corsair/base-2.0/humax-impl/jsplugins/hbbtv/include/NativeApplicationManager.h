...
/**
  ...
  An application might include a link that the user can activate in order to close this application and load the start page of the HD+ SmartTV Portal (e.g. a ¡°portal¡± link).
  Therefore, the following method shall be supported by the STB, which is an extension to the methods defined in the OIPF Application Manager embedded object (see 7.2.2 of [14]):
*/
