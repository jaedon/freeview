...
#ifdef OIPF
	static void onApplicationManagerWidgetEvent(ApplicationManagerWidgetEvent event, \
	                                            WidgetDescriptorHandle handle, \
                                                ApplicationManagerWidgetEventState state, \
                                                ApplicationManagerWidgetEventStateReason reason);
#endif // OIPF
	static int loadPortal(jsplugin_obj *this_obj, jsplugin_obj *function_obj,int argc, jsplugin_value *argv, jsplugin_value *result);
