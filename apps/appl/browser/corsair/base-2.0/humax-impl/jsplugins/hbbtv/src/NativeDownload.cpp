...
{
	ParentalRatingHandle *myHandles = (ParentalRatingHandle*)HLIB_STD_MemAlloc(sizeof(ParentalRatingHandle)*3);
	myHandles[0] = (void*)444;
	myHandles[1] = (void*)555;
	myHandles[2] = (void*)666;
	*handles = myHandles;
	*count = 3;
	return OOIF_RETURN_OK;
}
