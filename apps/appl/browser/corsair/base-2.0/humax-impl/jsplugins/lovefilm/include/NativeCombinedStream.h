...
#ifndef __NATIVE_COMBINED_STREAM_H__
#define __NATIVE_COMBINED_STREAM_H__
...
typedef void * CombinedStreamHandle;
...
#endif /* __NATIVE_COMBINED_STREAM_H__ */
