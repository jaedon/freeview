...
#endif
#ifdef JLABS
	/** This event corresponds to the onProgrammesChanged event defined in JCOM Extension */
	, VOD_EVENT_PROGRAMME_CHANGED = 13
	/** This event corresponds to the onProgrammesChanged event defined in JCOM Extension */
	, VOD_EVENT_BML_START = 14
	/** This event corresponds to the onProgrammesChanged event defined in JCOM Extension */
	, VOD_EVENT_BML_END = 15
#endif
#ifdef HMX_WEBUI
	, VOD_EVENT_TRICK_RESTRICT_MODE_CHANGED = 16
	, VOD_EVENT_AUDIO_OUTPUT_RESTRICT = 17 /** HD Audio SampleRate Problem on HDMI output*/
#endif
} VodEvent;
...
#ifdef JLABS
   VOD_COMPONENT_TYPE_SUPERIMPOSE = 3,
   VOD_COMPONENT_TYPE_DATA =4,
#endif
} VodComponentType;
