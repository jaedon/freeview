...
ChannelChangeSucceedBroadcastEvent::ChannelChangeSucceedBroadcastEvent(jsplugin_obj *c, ChannelHandle id)
	: Event(c, "ChannelChangeSucceeded"), channel(NULL)
{
	ENTRY;
...
ChannelChangeSucceedBroadcastEvent::~ChannelChangeSucceedBroadcastEvent()
{
	ENTRY;
	delete channel;
}

int ChannelChangeSucceedBroadcastEvent::getter(jsplugin_obj *obj, const char *name,
...
int ChannelChangeSucceedBroadcastEvent::setter(jsplugin_obj *obj, const char *name,
...
//virtual
int ChannelChangeSucceedBroadcastEvent::serialize(jsplugin_value **argv)
{
