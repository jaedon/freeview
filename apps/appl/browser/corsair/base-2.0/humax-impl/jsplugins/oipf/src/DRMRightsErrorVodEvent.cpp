...
DRMRightsErrorVodEvent::DRMRightsErrorVodEvent(jsplugin_obj *c,
        int error_state,
...
DRMRightsErrorVodEvent::~DRMRightsErrorVodEvent()
{
	ENTRY;
...
int DRMRightsErrorVodEvent::getter(jsplugin_obj *obj, const char *name,
...
//virtual
int DRMRightsErrorVodEvent::serialize(jsplugin_value **argv)
{
