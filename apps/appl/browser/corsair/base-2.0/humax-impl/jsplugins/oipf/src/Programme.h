...
#ifdef OIPF
	ScheduledRecordingCollection *getRecordings(int recordingsCount, RecordingHandle *handles);
#endif // OIPF
...
public:
	...
	static int getSharedProgrammeInfo(jsplugin_obj *this_obj, jsplugin_obj *function_obj, int argc, jsplugin_value *argv, jsplugin_value *result);
#endif // JLABS
