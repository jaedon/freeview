                        ...
                        int argc, jsplugin_value *argv, jsplugin_value *result)
{
	...
	case SEARCH_CHANNEL_ITEM:
		...
		break;
#if defined(HMX_WEBUI)
    case SEARCH_FILE_ITEM:
        RETURN_OBJECT(this_obj, new HContent(res), result, JSP_CALL_VALUE);
        break;
    case SEARCH_RECORDING_ITEM:
        RETURN_OBJECT(this_obj, new Recording(res), result, JSP_CALL_VALUE);
        break;
#endif
	default:
