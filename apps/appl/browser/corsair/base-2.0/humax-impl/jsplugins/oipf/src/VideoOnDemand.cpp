...
int VideoOnDemand::getter(jsplugin_obj *obj, const char *name, jsplugin_value *result)
{
...
#ifdef JLABS
	GET_NUMBER("COMPONENT_TYPE_SUPOERIMPOSE", VOD_COMPONENT_TYPE_SUPERIMPOSE, JSP_GET_VALUE_CACHE);
	GET_NUMBER("COMPONENT_TYPE_DATA", VOD_COMPONENT_TYPE_DATA, JSP_GET_VALUE_CACHE);
#endif // JLABS
	...
	NATIVE_GET_BOOLEAN("hasSubtitle", native_VodGetSubtitleTotalLanguageCount(getIdentifier(), &RETVAL), JSP_GET_VALUE);
	NATIVE_GET_BOOLEAN("SubtitleDisplay", native_VodGetSubtitleDisplay(getIdentifier(), &RETVAL), JSP_GET_VALUE);
	NATIVE_GET_STRING("SubtitleLanguage", native_VodGetSubtitleCurrLanguage(getIdentifier(), &RETVAL), JSP_GET_VALUE);
	NATIVE_GET_NUMBER("SubtitleSyncTime", native_VodGetSubtitleSyncTime(getIdentifier(), &RETVAL), JSP_GET_VALUE);
	NATIVE_GET_NUMBER("SubtitleFontSize", native_VodGetSubtitleFontSize(getIdentifier(), &RETVAL), JSP_GET_VALUE);
	NATIVE_GET_NUMBER("SubtitleTextPosition", native_VodGetSubtitleTextPosition(getIdentifier(), &RETVAL), JSP_GET_VALUE);
	NATIVE_GET_STRING_COLLECTION("SubtitleSupportLanguages", obj,
								 native_VodGetSubtitleSupportedLanguage(getIdentifier(), &SIZE, &NATIVE_ARRAY),
								 JSP_GET_VALUE);
#endif

#ifdef JLABS
	NATIVE_GET_OBJECT("programme", obj, native_VodGetJlabsPbProgramme(getIdentifier(), &RETVAL), new jlabsPbProgramme(RETVAL), JSP_GET_VALUE);
...
#ifdef HMX_WEBUI
	GET_FUNCTION(getPlayingThumbnail, obj, "n", JSP_GET_VALUE_CACHE);
	NATIVE_GET_NUMBER("trickRestrictMode", native_VodGetTrickRestrictMode(getIdentifier(), &RETVAL), JSP_GET_VALUE);
	NATIVE_GET_NUMBER("storageRight", native_VodGetStorageRight(getIdentifier(), &RETVAL), JSP_GET_VALUE);
...
#if defined(HMX_VOD_MEDIA_SBTL)
	NATIVE_SET("SubtitleDisplay", native_VodSetSubtitleDisplay(getIdentifier(), BOOLEAN_VALUE(value[0])));
	NATIVE_SET("SubtitleLanguage", native_VodSetSubtitleCurrLanguage(getIdentifier(), STRING_VALUE(value[0])));
	NATIVE_SET("SubtitleSyncTime", native_VodSetSubtitleSyncTime(getIdentifier(), NUMBER_VALUE(value[0])));
	NATIVE_SET("SubtitleFontSize", native_VodSetSubtitleFontSize(getIdentifier(), NUMBER_VALUE(value[0])));
	NATIVE_SET("SubtitleTextPosition", native_VodSetSubtitleTextPosition(getIdentifier(), NUMBER_VALUE(value[0])));
#endif
                                 ...
                                 int argc, jsplugin_value *argv, jsplugin_value *result)
{
	...
	NATIVE_CALL(native_VodGetComponents(instance->getIdentifier(),
										(VodComponentType)componentType,
										&count, &handles));
        ...
        VodHandle id)
{
	...
	case VOD_EVENT_TRICK_RESTRICT_MODE_CHANGED:
	{
		OOIF_LOG_DEBUG("TrickRestrictModeChanged event received");
		e = new EmptyEvent(context, "TrickRestrictModeChanged");
		break;
	}
	case VOD_EVENT_AUDIO_OUTPUT_RESTRICT:
	{
		OOIF_LOG_DEBUG("TrickRestrictModeChanged event received");
		e = new EmptyEvent(context, "AudioOutputRestrict");
		break;
	}
#endif // OIPF
#if defined(OIPF) || defined(HBBTV_1_2_1)
...
#ifdef JLABS
	case VOD_EVENT_PROGRAMME_CHANGED:
		OOIF_LOG_DEBUG("ProgrammesChanged event received\n");
		e = new EmptyEvent(context, "ProgrammesChanged");
		break;

	case VOD_EVENT_BML_START:
		OOIF_LOG_DEBUG("bml start event received\n");
		e = new BMLStartEvent( context,
											info->bml_start.autoFlag
											);
		break;

	case VOD_EVENT_BML_END:
		OOIF_LOG_DEBUG("bml end event received\n");
...
#ifdef JLABS
//static
int VideoOnDemand::showVideoMessage(jsplugin_obj *this_obj, jsplugin_obj *function_obj,
								  int argc, jsplugin_value *argv, jsplugin_value *result)
{
#ifdef HBBTV_SECURITY
	CALL_SECURITY_CHECK(CHECK_TRUSTED, result);
	...
	OOIFBoolean retval;
	NATIVE_CALL(native_VodShowVideoMessage(instance->getIdentifier(), type, &retval));
	RETURN_BOOLEAN(retval, JSP_CALL_VALUE);
}

//static
int VideoOnDemand::hideVideoMessage(jsplugin_obj *this_obj, jsplugin_obj *function_obj,
								  int argc, jsplugin_value *argv, jsplugin_value *result)
{
#ifdef HBBTV_SECURITY
	CALL_SECURITY_CHECK(CHECK_TRUSTED, result);
	...
	OOIFBoolean retval;
	NATIVE_CALL(native_VodHideVideoMessage(instance->getIdentifier(), type, &retval));
	RETURN_BOOLEAN(retval, JSP_CALL_VALUE);
}


//static
int VideoOnDemand::startBML(jsplugin_obj *this_obj, jsplugin_obj *function_obj,
								  int argc, jsplugin_value *argv, jsplugin_value *result)
{
#ifdef HBBTV_SECURITY
	CALL_SECURITY_CHECK(CHECK_TRUSTED, result);
	...
	NATIVE_CALL(native_VodStartBML(instance->getIdentifier()));
	RETURN_NULL(JSP_CALL_VALUE);
}

//static
int VideoOnDemand::endBML(jsplugin_obj *this_obj, jsplugin_obj *function_obj,
								  int argc, jsplugin_value *argv, jsplugin_value *result)
{
#ifdef HBBTV_SECURITY
	CALL_SECURITY_CHECK(CHECK_TRUSTED, result);
	...
	NATIVE_CALL(native_VodEndBML(instance->getIdentifier()));
	RETURN_NULL(JSP_CALL_VALUE);
}

//static
int VideoOnDemand::setBMLKeyControlMode(jsplugin_obj *this_obj, jsplugin_obj *function_obj,
								  int argc, jsplugin_value *argv, jsplugin_value *result)
{
#ifdef HBBTV_SECURITY
	CALL_SECURITY_CHECK(CHECK_TRUSTED, result);
	...
	OOIFNumber retval;
	NATIVE_CALL(native_VodSetBMLKeyControlMode(instance->getIdentifier(), permit, &retval));
	RETURN_NUMBER(retval, JSP_CALL_VALUE);
}
...
#ifdef HMX_WEBUI
int VideoOnDemand::getPlayingThumbnail(jsplugin_obj *this_obj, jsplugin_obj *function_obj,
								  int argc, jsplugin_value *argv, jsplugin_value *result)
{
#if !defined(JLABS)
	CHECK_ARGUMENT_COUNT(0);
	...
	OOIFNumber pos = NUMBER_VALUE(argv[0]);
	const char *retval;
	NATIVE_CALL(native_VodGetPlayingThumbnail(instance->getIdentifier(), pos, &retval));
...
int VideoOnDemand::offComponent(jsplugin_obj *this_obj, jsplugin_obj *function_obj,
							  int argc, jsplugin_value *argv, jsplugin_value *result)
{
#ifdef HBBTV_SECURITY
	CALL_SECURITY_CHECK(CHECK_TRUSTED, result);
	...
	NATIVE_CALL(native_VodOffComponent(instance->getIdentifier(), NUMBER_VALUE(argv[0]), NUMBER_VALUE(argv[1])));
