...
#include "HMXOperatorFreesatMhegAppState.h"
...
HMXOperatorFreesatMhegAppState::HMXOperatorFreesatMhegAppState
	(jsplugin_obj *context, OOIFNumber eType, int appState, int userData)
  : Event(context, "FreesatMhegAppState")
{
	ENTRY;
...
int HMXOperatorFreesatMhegAppState::getter(jsplugin_obj *obj, const char *name, jsplugin_value *result)
{
	ENTRY;
...
int HMXOperatorFreesatMhegAppState::setter(jsplugin_obj *obj, const char *name, jsplugin_value *value)
{
	ENTRY;
...
//virtual
int HMXOperatorFreesatMhegAppState::serialize(jsplugin_value **argv)
{
	ENTRY;
