...
public:
	...
	void SetApplicationComponentTag(unsigned char comTag);
	void SetBoundaryExtension(unsigned char ext_count,
								unsigned char* ext_length,
								unsigned char** ext_byte);
 	void AddApplicationBoundary(const char* ext_byte);
 	void RemoveApplicationBoundary();
	...
	void GetApplicationComponentTag(unsigned char *comTag);
