...
#ifndef __IPEPG_CONFIG_HDNEO_H__
#define __IPEPG_CONFIG_HDNEO_H__
...
extern "C" {
	...
	#error ("!!! _ipepg_config_hdneo.h shall be included only in the ipepg_config.h !!!\n");
#endif
...
#endif // __IPEPG_CONFIG_HDNEO_H__
