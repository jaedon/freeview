...
#define IR_PARTITION_IRDETO_OFFSET			0x1200 // sys 영역은 자동으로 빠진다. 0x1200 -> actually 0x1600
...
/* Custom Area */
#define IR_PARTION_CUSTOM_HOME_TP0						(IR_PARTITION_CUSTOM - IR_PARTITION_IRDETO_OFFSET) // custom 은 pal_eep 를 바로 불러야 한다.
