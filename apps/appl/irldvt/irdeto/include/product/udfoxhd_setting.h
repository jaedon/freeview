...
*/
#define IRPLAT_SC_QUERY_NUMBER_OF_SECTORS_ID
#define IRPLAT_SC_QUERY_EXTENDED_PRODUCT_LIST_ID
...
#define FLASH_TOTAL_PARTITION_COUNT			146  //for 128 Mb, NAND only, octo 1.0
#define FLASH_TOTAL_SIZE						(73*1024*1024)
...
// UPC IRDETO User Payload Data
#define IRPLAT_FN_DDEMM_USER_PAYLOAD_FOR_UPC
