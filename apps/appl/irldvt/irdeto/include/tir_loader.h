...
//#define CONFIG_MW_SYS_NAND_FLASH_ONLY // 임시 test 용임!!! 절대 풀지 마세요! 풀라면 defconfig에서.
/* Followins are only used in octo application but not in loader */
#if defined(CONFIG_PROD_IR4000HD) || defined(CONFIG_PROD_ICORDHDPLUSIR) || defined(CONFIG_PROD_IRHD5100C) || defined(CONFIG_PROD_IHDR5200C) || defined(CONFIG_PROD_IRHD5100CTVT)||defined(CONFIG_PROD_SDHDR)
#define SUPPORT_IRDETO_LOADER_FLASH_32MB
#endif

#if defined(CONFIG_PROD_HDH100S) || defined(CONFIG_PROD_IR2020HD) || defined(CONFIG_PROD_HM9502HD) || defined(CONFIG_PROD_IRHD5100S) ||\
	defined(CONFIG_PROD_ICORDHDPLUSME) || defined(CONFIG_PROD_IRHD5200S) || defined(CONFIG_PROD_ICORDHDPLUSMEADM) || defined(CONFIG_PROD_IR2000HD)
#define SUPPORT_IRDETO_LOADER_FLASH_32MB_2ND
#endif

#if defined(CONFIG_PROD_IR2000SD)
#define SUPPORT_IRDETO_LOADER_FLASH_8MB
#endif

#if defined(CONFIG_PROD_IRHD5300C)
#define SUPPORT_IRDETO_LOADER_NOR_FLASH_4MB
#endif
