...
#define _Reference				ObjectReference_name(&r->ObjectReference)	// ExternalReference_name(&r->inst.ref)
#define _NeedContent			(r->inst.need_content ? "content need" : "content ok")
#define _AvailabilityStatus	(r->inst.AvailabilityStatus ? "available" : "not available")
#define _RunningStatus		(r->inst.RunningStatus ? "running" : "not running")
void
GroupItem_print(GroupItem *g)
{
	RootClass *r = GroupItem_rootClass(g);

	switch(g->choice)
	{
	case GroupItem_resident_program:
		Hx_Print("\t\tResidentPrg (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_remote_program:
		Hx_Print("\t\tRemotePrg (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_interchanged_program:
		Hx_Print("\t\tInterchgPrg (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_palette:
		Hx_Print("\t\tPalette (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_font:
		Hx_Print("\t\tFont (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_cursor_shape:
		Hx_Print("\t\tCursorShape (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_boolean_variable:
		Hx_Print("\t\tBooleanVar (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_integer_variable:
		Hx_Print("\t\tIntegerVar (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_octet_string_variable:
		Hx_Print("\t\tOStringVar (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_object_ref_variable:
		Hx_Print("\t\tObjectRefVar (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_content_ref_variable:
		Hx_Print("\t\tContentRefVar (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_link:
		Hx_Print("\t\tLink (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_stream:
		Hx_Print("\t\tStream (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_bitmap:
		Hx_Print("\t\tBitmap (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_line_art:
		Hx_Print("\t\tLineArt (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_dynamic_line_art:
		Hx_Print("\t\tDynamicLineArt (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_rectangle:
		Hx_Print("\t\tRectangle (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_hotspot:
		Hx_Print("\t\tHotspot (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_switch_button:
		Hx_Print("\t\tSwitchButton (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_push_button:
		Hx_Print("\t\tPushButton (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_text:
		Hx_Print("\t\tText (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_entry_field:
		Hx_Print("\t\tEntryField (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_hyper_text:
		Hx_Print("\t\tHyperText (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_slider:
		Hx_Print("\t\tSlider (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_token_group:
		Hx_Print("\t\tTokenGroup (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;

	case GroupItem_list_group:
		Hx_Print("\t\tListGroup (%s): %s, %s, %s\n", _Reference, _NeedContent, _AvailabilityStatus, _RunningStatus);
		break;
