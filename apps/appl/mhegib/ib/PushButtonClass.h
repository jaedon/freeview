...
bool PushButtonClass_Activation(PushButtonClass *);
bool PushButtonClass_Deactivation(PushButtonClass *);
...
void PushButtonClass_render(PushButtonClass *, MHEGDisplay *, XYPosition *, OriginalBoxSize *);
