...
{
#if (CLS_VERBOSE)
	verbose_class("RectangleClass: %s; Preparation", ExternalReference_name(&t->rootClass.inst.ref));
#endif
...
{
#if (CLS_VERBOSE)
	verbose_class("RectangleClass: %s; Activation", ExternalReference_name(&t->rootClass.inst.ref));
#endif
...
{
#if (CLS_VERBOSE)
	verbose_class("RectangleClass: %s; Deactivation", ExternalReference_name(&t->rootClass.inst.ref));
#endif
...
{
#if (CLS_VERBOSE)
	verbose_class("RectangleClass: %s; Destruction", ExternalReference_name(&t->rootClass.inst.ref));
#endif
...
{
	verbose_class("RectangleClass: %s; Clone", ExternalReference_name(&t->rootClass.inst.ref));
...
//	old.y_position = t->inst.Position.y_position;
	...
	verbose_class("RectangleClass: %s; SetPosition; (%d, %d)", ExternalReference_name(&t->rootClass.inst.ref), t->inst.Position.x_position, t->inst.Position.y_position);
...
RectangleClass_GetPosition(RectangleClass *t, GetPosition *params, OctetString *caller_gid)
{
	...
	verbose_class("RectangleClass: %s; GetPosition", ExternalReference_name(&t->rootClass.inst.ref));
	...
	{
		error("RectangleClass: GetPosition: type mismatch (%d, %d)", var->rootClass.inst.rtti, VariableClass_type(var));
		return;
	}
...
//	old.y_length = t->inst.BoxSize.y_length;
	...
	verbose_class("RectangleClass: %s; SetBoxSize; (%d, %d)", ExternalReference_name(&t->rootClass.inst.ref), t->inst.BoxSize.x_length, t->inst.BoxSize.y_length);
...
RectangleClass_GetBoxSize(RectangleClass *t, GetBoxSize *params, OctetString *caller_gid)
{
	...
	verbose_class("RectangleClass: %s; GetBoxSize", ExternalReference_name(&t->rootClass.inst.ref));
	...
	|| VariableClass_type(var) != OriginalValue_integer)
	{
		error("RectangleClass: GetBoxSize: type mismatch (%d, %d)", var->rootClass.inst.rtti, VariableClass_type(var));
		return;
	}
...
{
	verbose_class("RectangleClass: %s; BringToFront", ExternalReference_name(&t->rootClass.inst.ref));
...
{
	verbose_class("RectangleClass: %s; SendToBack", ExternalReference_name(&t->rootClass.inst.ref));
...
RectangleClass_PutBefore(RectangleClass *t, PutBefore *params, OctetString *caller_gid)
{
	...
	verbose_class("RectangleClass: %s; PutBefore", ExternalReference_name(&t->rootClass.inst.ref));
...
RectangleClass_PutBehind(RectangleClass *t, PutBehind *params, OctetString *caller_gid)
{
	...
	verbose_class("RectangleClass: %s; PutBehind", ExternalReference_name(&t->rootClass.inst.ref));
...
RectangleClass_SetPaletteRef(RectangleClass *t, SetPaletteRef *params, OctetString *caller_gid)
{
	...
	error("RectangleClass: %s; SetPaletteRef not supported in UK / CI+ MHEG Profile", ExternalReference_name(&t->rootClass.inst.ref));
...
RectangleClass_SetLineWidth(RectangleClass *t, SetLineWidth *params, OctetString *caller_gid)
{
	...
	verbose_class("RectangleClass: %s; SetLineWidth; %d", ExternalReference_name(&t->rootClass.inst.ref), t->inst.LineWidth);
...
RectangleClass_SetLineStyle(RectangleClass *t, SetLineStyle *params, OctetString *caller_gid)
{
	...
	verbose_class("RectangleClass: %s; SetLineStyle; %d", ExternalReference_name(&t->rootClass.inst.ref), t->inst.LineStyle);
...
{
	verbose_class("RectangleClass: %s; SetLineColour", ExternalReference_name(&t->rootClass.inst.ref));
...
{
	verbose_class("RectangleClass: %s; SetFillColour", ExternalReference_name(&t->rootClass.inst.ref));
...
RectangleClass_render(RectangleClass *t, MHEGDisplay *d, XYPosition *pos, OriginalBoxSize *box)
{
	...
	verbose_class("RectangleClass: %s; render", ExternalReference_name(&t->rootClass.inst.ref));
