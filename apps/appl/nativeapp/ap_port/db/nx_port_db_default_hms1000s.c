...
/******************************************************************************/
/**
 * @file	  		nx_prism_db_default_hms1000s.c
 *
 * 	Description:  													\n
 *
 * @author															\n
...
/******************************************************************************/
#define NX_PORT_DB_DEFAULT_INSTALL_PIN_COCE 					"0000"
...
HERROR	NX_PORT_DB_Default(void)
{
	...
	NX_PORT_DB_SetInt(USERDB_RECORDING_TSR_ONOFF, TRUE);
	NX_PORT_DB_SetInt(USERDB_SCREENDISP_INFO_DISP_TIME, 5);
	NX_PORT_DB_SetInt(USERDB_TVTVEPG_LASTUPDATETIME, 0);

	NX_PORT_DB_SetInt(USERDB_SEARCH_OPT_NETWORK_SEARCH, TRUE);
	...
	NX_PORT_DB_SetInt(USERDB_SERIES_PLAYBACK, TRUE);
	NX_PORT_DB_SetInt(USERDB_RECORDING_AUTODELETE_ONOFF, FALSE);
	NX_PORT_DB_SetInt(USERDB_RECORDING_DESCRAMBLE_ONOFF, TRUE);
#endif
	...
	NX_PORT_DB_SetInt(USERDB_HBBTV_ENABLE, TRUE);

	NX_PORT_DB_SetInt(USERDB_IPEPG_ONOFF, TRUE);
