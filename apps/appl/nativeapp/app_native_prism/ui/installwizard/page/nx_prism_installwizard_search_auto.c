...
static Nx_Install_Search_Context_t		s_stInstallSearchAutoContent;

/******************************************************************************/
#define _________Private_Prototype____________________________________________
/******************************************************************************/

static inline Nx_Install_Search_Context_t	*nx_install_search_auto_GetContents(void);
static ONDK_Result_t                        nx_install_search_auto_InitApplication (Nx_Install_Search_Context_t *pstContents, HINT32 p1, HINT32 p2, HINT32 p3);
static ONDK_Result_t                        nx_install_search_auto_UpdateExtendOptBtn(Nx_Install_Search_Context_t *pstContents);
static ONDK_Result_t                        nx_install_search_auto_UpdateOptBtn(Nx_Install_Search_Context_t *pstContents);
static void                                 nx_install_search_auto_DrawExplain(void);
static void                                 nx_install_search_auto_DrawDirectionBtn(void);
static ONDK_Result_t                        nx_install_search_auto_DrawExtendOptBtn(Nx_Install_Search_Context_t *pstContents);
static ONDK_Result_t                        nx_install_search_auto_DrawOptBtn(Nx_Install_Search_Context_t *pstContents);
static ONDK_Result_t                        nx_install_search_auto_DrawSearchTextInfo(void);
static ONDK_Result_t                        nx_install_search_auto_DrawDefaultUI(Nx_Install_Search_Context_t *pstContents);
static ONDK_Result_t                        nx_install_search_auto_DoLoadingDefaultAntena (Nx_Install_Search_Context_t *pstContents);
static ONDK_Result_t                        nx_install_search_auto_DoDiseqSignal(Nx_Install_Search_Context_t *pstContents);
static ONDK_Result_t                        nx_install_search_auto_MsgGwmCreate(Nx_Install_Search_Context_t *pstContents, HINT32 p1, HINT32 p2, HINT32 p3);
static ONDK_Result_t                    	nx_install_search_auto_MsgGwmDestroy(Nx_Install_Search_Context_t *pstContents, HINT32 p1, HINT32 p2, HINT32 p3);
static ONDK_Result_t                    	nx_install_search_auto_MsgGwmHapiMsg(Nx_Install_Search_Context_t *pstContents, Handle_t handle, HINT32 p1, HINT32 p2, HINT32 p3);
static ONDK_Result_t                    	nx_install_search_auto_MsgGwmObjFocusChanged(Nx_Install_Search_Context_t *pstContents, HINT32 p1, HINT32 p2, HINT32 p3);
static ONDK_Result_t                        nx_install_search_auto_MsgGwmKeyDown(Nx_Install_Search_Context_t *pstContents, HINT32 p1, HINT32 p2, HINT32 p3);
static ONDK_Result_t                        nx_install_search_auto_MsgCoreDiseqDetectionUpdate(Nx_Install_Search_Context_t *pstContents, HINT32 p1, HINT32 p2, HINT32 p3);
...
static inline Nx_Install_Search_Context_t	*nx_install_search_auto_GetContents(void)
{
	return	&s_stInstallSearchAutoContent;
}
...
static ONDK_Result_t nx_install_search_auto_InitApplication (Nx_Install_Search_Context_t *pstContents, HINT32 p1, HINT32 p2, HINT32 p3)
{
    ...
    pstContents->ePage = eNxInstallPage_Search_Auto;
...
static ONDK_Result_t	nx_install_search_auto_DrawDefaultUI(Nx_Install_Search_Context_t *pstContents)
{
    ...
    nx_install_search_auto_DrawExplain();

    nx_install_search_auto_DrawSearchTextInfo();

    //dim
    nx_install_ui_SetDimBackgroundUI(FALSE); //For Extend Btn Highlight

    //select btn
    nx_install_search_auto_DrawOptBtn(pstContents);
    nx_install_search_auto_UpdateOptBtn(pstContents);
...
static ONDK_Result_t nx_install_search_auto_DoDiseqSignal(Nx_Install_Search_Context_t *pstContents)
{
    ...
    if(ulAntCount < 1)
    {
        ...
        eResult = nx_install_search_auto_DoLoadingDefaultAntena(pstContents);
...
static ONDK_Result_t	nx_install_search_auto_MsgGwmCreate(Nx_Install_Search_Context_t *pstContents, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	eResult = nx_install_search_auto_InitApplication(pstContents,p1,p2,p3);
	...
	nx_install_search_auto_DrawDefaultUI(pstContents);
    ...
    nx_install_search_auto_DoDiseqSignal(pstContents);
		...
		case KEY_OK:
             {
                ...
                switch(lObjId){
                    ...
                    case NX_PRISM_INSTALL_SEARCH_BTN_AUTO_OPT_ID:
                        ...
                        nx_install_search_auto_UpdateOptBtn(pstContents);
                        nx_install_search_auto_UpdateExtendOptBtn(pstContents);
                        break;
...
/******************************************************************************/
ONDK_Result_t	NX_PRISM_Install_Search_Auto_Proc(HINT32 lMessage, Handle_t handle, HINT32 p1, HINT32 p2, HINT32 p3)
{
	ONDK_Result_t		eResult = ONDK_RET_OK;
	Nx_Install_Search_Context_t	*pstContents = NULL;
	pstContents = nx_install_search_auto_GetContents();
	switch (lMessage)
	{
		case MSG_GWM_CREATE:
			eResult = nx_install_search_auto_MsgGwmCreate(pstContents, p1, p2, p3);
			break;
		...
		case MSG_GWM_KEYDOWN:
			eResult = nx_install_search_auto_MsgGwmKeyDown(pstContents, p1, p2, p3);
			break;

		case MSG_GWM_OBJ_FOCUS_CHANGED:
            nx_install_search_auto_MsgGwmObjFocusChanged(pstContents, p1, p2, p3);
			break;
		case MSG_GWM_TIMER:
		...
		case MSG_GWM_DESTROY:
			eResult = nx_install_search_auto_MsgGwmDestroy(pstContents, p1, p2, p3);
			break;

		case MSG_GWM_HAPI_MESSAGE:
			eResult = nx_install_search_auto_MsgGwmHapiMsg(pstContents, handle, p1, p2, p3);
			break;
		case MSG_CORE_SERVICE_EVT_DISEQCDETECTION:
            HxLOG_Error("MSG_CORE_SERVICE_EVT_DISEQCDETECTION!\n");
            eResult = nx_install_search_auto_MsgCoreDiseqDetectionUpdate(pstContents, p1, p2, p3);
			break;
