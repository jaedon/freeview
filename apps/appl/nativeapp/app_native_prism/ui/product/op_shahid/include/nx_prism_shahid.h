 ...
 **/
/******************************************************************************/
#ifndef __NX_PRISM_SHAHID_H__
#define __NX_PRISM_SHAHID_H__

#if defined (CONFIG_OP_SHAHID_APPS)

typedef struct tagShahidContentsInfo{
	HCHAR	*pszProgramName;
	HCHAR	*pszThumbnailPath;
	HCHAR	*pszThumbnailURL;
	HBOOL	isNew;
	HBOOL	isPlus;
}ContentsInfo_t;
...
ONDK_Result_t   NX_SHAHID_COM_DrawBtnSeeMore(ONDKSurfaceHandle screen, ONDK_Region_t *area, ONDK_Rect_t *rect, ONDK_GWM_GuiObject_t object, void *arg, int bUiTop);
