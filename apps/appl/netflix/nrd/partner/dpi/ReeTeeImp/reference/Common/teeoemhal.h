...
#ifndef __TEEOEMHAL_H__
#define __TEEOEMHAL_H__
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_Initialize();

DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_Deinitialize();

DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_VerifyMessageSignature(
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_SignWithPrivateKey(
    __in                                DRM_VOID                  *f_pOEMContext,
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_VerifyOMAC1Signature(
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_CreateOMAC1Signature(
    __in_bcount( f_cbData )        const DRM_BYTE                   *f_pbData,
    __in                                 DRM_DWORD                   f_cbData,
    __out_bcount_opt( *f_pcbSignature )  DRM_BYTE                   *f_pbSignature,
    __inout                              DRM_DWORD                  *f_pcbSignature,
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_EncryptDataBlock(
...
DRM_API DRM_BOOL DRM_CALL tee_Oem_Hal_IsDevelopmentPlatform();

DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_UnwrapKey(
    __inout_ecount_opt( 1 )                    DRM_CRYPTO_CONTEXT         *f_pCryptoContext,
    __in                                       OEM_HAL_KEY_TYPE            f_eKeyType,
    __in                                       OEM_HAL_KEY_REGISTER_INDEX  f_indexKey,
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_WrapKey(
    __in                                 DRM_VOID                   *f_pOEMContext,
    __inout_ecount_opt( 1 )              DRM_CRYPTO_CONTEXT         *f_pCryptoContext,
    __in                                 OEM_HAL_KEY_TYPE            f_eKeyType,
    __in                                 OEM_HAL_KEY_REGISTER_INDEX  f_indexKey,
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_GenerateKey(
    __in                    DRM_VOID                  *f_pOEMContext,
    __inout_ecount_opt( 1 ) DRM_CRYPTO_CONTEXT        *f_pCryptoContext,
    __in                    OEM_HAL_KEY_TYPE           f_eKeyType,
    __in                    OEM_HAL_KEY_REGISTER_INDEX f_indexKey,
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_DecryptContent(
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_DecryptContentOpaque(
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_CreateSampleEncryptionContext(
    __in            OEM_HAL_KEY_TYPE                f_eKeyType,
    __in            OEM_HAL_KEY_REGISTER_INDEX      f_indexKey,
    __in            OEM_HAL_SAMPLE_ENCRYPTION_MODE  f_eSampleEncryptionMode,
    __out_ecount(1) OEM_ENCRYPTION_HANDLE          *f_phEncryptionContext );

DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_EncryptSampleData(
    __in                           DRM_VOID                 *f_pOEMContext,
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_QuerySampleMetadata(
    __in            OEM_ENCRYPTION_HANDLE    f_hEncryptionContext,
    __out_ecount(1) OEM_HAL_SAMPLE_METADATA *f_pMetadata );

DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_DestroySampleEncryptionContext(
    __in OEM_ENCRYPTION_HANDLE f_hEncryptionContext );

DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_LoadPlayReadyRevocationInfo(
    __inout_ecount_opt( 1 )                 DRM_CRYPTO_CONTEXT         *f_pCryptoContext,
...
DRM_API DRM_RESULT DRM_CALL tee_Oem_Hal_LoadPlayReadyCrl(
    __inout_ecount_opt( 1 )      DRM_CRYPTO_CONTEXT         *f_pCryptoContext,
