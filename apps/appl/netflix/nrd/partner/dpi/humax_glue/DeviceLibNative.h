...
struct referenceDpiConfig {
    ...
    referenceDpiConfig() :
        ...
        language("en"),
        friendlyName("Friendly Netflix Device"),
        hasPointer(false), hasKeyboard(false),
        hasOnScreenKeyboard(false), hasSuspend(true), hasBackground(false),
        hasScreensaver(true),
        supportFrameRateSeamlessSwitch(true),
        supportDrmPlaybackTransition(true),
        supportDrmToDrmTransition(false),
        supportMultipleDrmDecryption(true),
        supportLimitedDurationLicenses(true),
        supportSecureStop(true),
        supportDrmStorageDeletion(true),
  ...
  #endif
        minAudioPtsGap(0),
        videoRendererScreenWidth(1920),
        videoRendererScreenHeight(1080),
        enableSSO(false),
        enableSignup(false),
        tokenUrl(""),
        headerList(""),
...
public:
	...
	shared_ptr<IAudioMixerOutput> getAudioMixerOutput();
