...
public:
	 ...
	 *
	 *********************************************************************/
	static int createContent(std::string &idFilename, std::string &drmDir, DataBuffer &content);
...
private:
	 ...
	 *
	 *********************************************************************/
	static int addNtbaSection( uint8_t **p_data, uint32_t *p_remaining_bytes, std::string &idFilename);
	 ...
	 *
	 *********************************************************************/
	static int addDrmSection( uint8_t **p_data, uint32_t *p_remaining_bytes, std::string &drmDir);

    static int addDrmSectionItem( uint8_t **p_data, uint32_t *p_remaining_bytes, std::string &drmDir, const char *fileName, drm_RO_AgentClientKeys keyId );
