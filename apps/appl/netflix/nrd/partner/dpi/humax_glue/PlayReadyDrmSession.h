...
public:
	...
	bool isset;
	uint32_t base_hdcpisOn ;
	uint32_t base_cgmsStatus ;
...
private:
    ...
    shared_ptr<PlayReadyDrmSystem> mDrmSystem;
    shared_ptr<DRM_APP_CONTEXT> mAppContext;
    shared_ptr<DRM_DECRYPT_CONTEXT> decryptContext_;
