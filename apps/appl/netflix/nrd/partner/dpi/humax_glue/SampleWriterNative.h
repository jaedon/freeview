 ...
 * prohibited.
 */
#ifndef SAMPLEWRITERNATIVE_H
#define SAMPLEWRITERNATIVE_H

/** @file SampleWriterNative.h - Reference implementation of the
 * ISampleWriter interface.
 *
 * SampleWriterNative is the reference application's implementation of the
...
class SampleWriterNative : public ISampleWriter
{
public:
    SampleWriterNative(Format3D format3D, shared_ptr<IESPlayerCallback> callback);
    virtual ~SampleWriterNative();
