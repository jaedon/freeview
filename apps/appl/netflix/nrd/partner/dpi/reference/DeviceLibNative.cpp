...
#if defined(TEXTTOSPEECH_REFERENCE_OSX)
#include "tts/TextToSpeechOSX.h"
#elif defined(TEXTTOSPEECH_REFERENCE_IVONA)
#include "tts/TextToSpeechIvona.h"
#elif defined(TEXTTOSPEECH_REFERENCE_FESTIVAL)
#include "tts/TextToSpeechFestival.h"
#endif
...
#if defined(TEXTTOSPEECH_REFERENCE_OSX)
    textToSpeechPtr_.reset(new TextToSpeechOSX);
#elif defined(TEXTTOSPEECH_REFERENCE_IVONA)
    textToSpeechPtr_.reset(new TextToSpeechIvona);
#elif defined(TEXTTOSPEECH_REFERENCE_FESTIVAL)
    textToSpeechPtr_.reset(new TextToSpeechFestival);
#endif
...
shared_ptr<ITextToSpeech> DeviceLibNative::getTextToSpeech()
{
    return textToSpeechPtr_;
}
...
ConfigurationOptions getDeviceLibOptions()
{
    ...
    options.push_back(ConfigurationOption(0, "dpi-omxil-clock", ConfigurationOption::STRING_ARGUMENT, &sConfiguration->omxilClock, "Component name for clock."));
#endif
#if defined(BUILD_OPENMAXIL_VIDEO_DECODER)
    options.push_back(ConfigurationOption(0, "dpi-omxil-video-decoder", ConfigurationOption::STRING_ARGUMENT, &sConfiguration->omxilVideoDecoder, "Component name for video decoder."));
    options.push_back(ConfigurationOption(0, "dpi-omxil-video-scheduler", ConfigurationOption::STRING_ARGUMENT, &sConfiguration->omxilVideoScheduler, "Component name for video scheduler."));
#endif
#if defined(BUILD_OPENMAXIL_AUDIO_DECODER)
    options.push_back(ConfigurationOption(0, "dpi-omxil-audio-decoder", ConfigurationOption::STRING_ARGUMENT, &sConfiguration->omxilAudioDecoder, "Component name for audio decoder."));
#endif
#if defined(BUILD_OPENMAXIL_AUDIO_RENDERER)
    options.push_back(ConfigurationOption(0, "dpi-omxil-audio-renderer", ConfigurationOption::STRING_ARGUMENT, &sConfiguration->omxilAudioRenderer, "Component name for audio renderer."));
#endif
#if defined(BUILD_OPENMAXIL_VIDEO_RENDERER)
    options.push_back(ConfigurationOption(0, "dpi-omxil-video-renderer", ConfigurationOption::STRING_ARGUMENT, &sConfiguration->omxilVideoRenderer, "Component name for video renderer."));
    options.push_back(ConfigurationOption(0, "dpi-omxil-video-gl-renderer", ConfigurationOption::STRING_ARGUMENT, &sConfiguration->omxilVideoGLRenderer, "Component name for video renderer (GL)."));
#endif
#if defined(BUILD_OPENMAXIL_AUDIO_DECODER)
    options.push_back(ConfigurationOption(0, "dpi-omxil-audio-decoder", ConfigurationOption::STRING_ARGUMENT, &sConfiguration->omxilAudioDecoder, "Component name for audio decoder."));
#endif
