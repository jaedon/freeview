                                        ...
                                        IElementaryStreamPlayer*& pStreamPlayer)
{
    ...
    if(initData.mInitialStreamAttributes == NULL) {
        ...
        deviceSpecificErrorCode = refAppDeviceSpecific_NoInitialStreamAttributes;
        Variant errInfo;
    ...
    if(streamType == AUDIO)
    {
        ...
        {
            // this should be replaced by partner specific error code
            deviceSpecificErrorCode = refAppDeviceSpecific_NoInitialAudioStreamAttributes;
        ...
        {
            // this should be replaced by partner specific error code
            deviceSpecificErrorCode = refAppDeviceSpecific_NoInitialVideoStreamAttributes;
            Variant errInfo;
...
// #define USE_MVC_SPLIT
    ...
    {
        if(streamType == AUDIO){
            deviceSpecificErrorCode = refAppDeviceSpecific_AudioPlayerCreationFailed;
        } else {
            deviceSpecificErrorCode = refAppDeviceSpecific_VideoPlayerCreationFailed;
        }
        Variant errInfo;
