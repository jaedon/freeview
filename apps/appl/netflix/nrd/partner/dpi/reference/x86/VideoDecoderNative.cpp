...
RefAppDeviceSpecificError VideoDecoderNative::decode(const ISampleAttributes *pSampleAttr,
   ...
   // flush processing
    ...
    if(resetCodec)
    {
        if(!resetCodecWithUpdatedExtraData(new_extradata, new_extradata_size,
            ...
            return refAppDeviceSpecific_FfmpegDecoderError;
        }
    }
...
void VideoDecoderNative::imageConvert(
    AVFrame& decodedFrame, VideoRenderer::VideoFrameBuffer& frameBuffer)
{
