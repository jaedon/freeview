...
#ifndef DEVICE_VIDEORENDERERSDL_H
#define DEVICE_VIDEORENDERERSDL_H
...
/**
 * @class VideoRendererSDL VideoRendererSDL.h
 * @brief Implementation of video rendering over SDL.
 */
class VideoRendererSDL : public VideoRenderer
{
public:
    /**
     * Constructor.
     ...
     */
    VideoRendererSDL(const VideoAttributes& attributes,
                     uint32_t maxImageWidth, uint32_t maxImageHeight);

    /**
     * Destructor.
     */
    virtual ~VideoRendererSDL();
...
#endif // DEVICE_VIDEORENDERERSDL_H
