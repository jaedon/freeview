...
DECLARE_THREAD(SKELETON_DPI_VIDEO_DECODER);
DECLARE_THREAD(SKELETON_DPI_AUDIO_DECODER);
...
{
public:
    //  typedef NFErr (PlaybackDeviceNative::*Task)();
    typedef void (ESPlayerNative::*Task)();
     ...
     */
    DeviceThread(ESPlayerNative& esplayer, Task task,
                 ThreadConfig *config);
