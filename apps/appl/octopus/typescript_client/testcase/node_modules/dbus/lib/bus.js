...
var Bus = module.exports = function(dbus, busName, parameter) {
	var self = this;
	...
	case 'open':
		self.connection = dbus._dbus.getBus(2, parameter);
		break;
	}
...
Bus.prototype.reconnect = function(callback) {
	...
	case 'open':
		self.connection = self.dbus._dbus.getBus(2, self.parameter);
		break;
	}
