...
HERROR	local_arabic_ConvertLogicalAraToVisualAra(HUINT16 *pLogStr, HINT32 nUnicodeStrLen, HUINT16 *pVisStr, HINT32 nBufSize, HINT32 *nVisualOrderStrLen)
{
	...
	contextFormStr = (HUINT16 *)AP_Malloc(nBufSize * sizeof(HUINT16));
...
HBOOL ARABIC_SUPPORT_CheckUnicodeArabicCharacterInString(HUINT16 *pStr)
{
...
HxSTR_t *ARABIC_SUPPORT_ConvertLogicalAraToVisualAra(HxSTR_t *pStr)
{
	HINT32 		nByteLen	= 0;
	HINT32		nStrLen 	= 0;
	HINT32		nCharNum 	= 0;
