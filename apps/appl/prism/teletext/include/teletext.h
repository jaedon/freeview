...
/**
	@file     teletext.h
	@brief   EBU Teletext/Subtitle 의 Decoder 와 Rendering 관련 진합

	Module: Teletext
*/
#ifndef ____TELETEXT_H_
#define ____TELETEXT_H_
/*******************************************************************/
/********************      Header Files    *************************/
/*******************************************************************/
#include   <ondk.h>
...
extern ONDK_Result_t	AP_Teletext_Proc(HINT32 message, Handle_t handle, HINT32 p1, HINT32 p2, HINT32 p3);
extern ONDK_Result_t	AP_TtxMenuUi_Proc (HINT32 message, Handle_t handle, HINT32 p1, HINT32 p2, HINT32 p3);

extern void				TTxMenuObject_Create(void);// 리소스를 미리 로드한다.
extern void				Teletext_Init(void);
extern HERROR			Teletext_StartService(void);
extern HERROR			Teletext_StopService(void);
extern void				Teletext_deliveryPacket(HCHAR* datatype, HINT32 len, HUINT8 *p);
extern HERROR			Teletext_Decoding (HUINT8 *pucPES);

extern HERROR			Teletext_SetControl (TTX_Control_t control, HUINT32 ulArg);
extern HERROR			Teletext_GetControl (TTX_Control_t control, void *pvValue);

extern HERROR			Teletext_Show(HUINT8 ucMagNum,HUINT16 usPageNum, HUINT16 usSubcode, HBOOL bSbtl);
extern HERROR			Teletext_Hide(void);
extern HERROR			Teletext_Search (HUINT16 usPageNum, HUINT16 usSubcode, HINT32 offset, HUINT16 *pusPageNum, HUINT16 *pusSubcode );
extern HERROR			Teletext_GetPageAddress (HUINT8 *pucM, HUINT8 *pucX, HUINT16 *pusSubcode);
extern HERROR			Teletext_SetSutitleFontType(HBOOL bVariableFont);
extern HERROR			Teletext_FONT(HBOOL bVariableFont);
extern void				Teletext_SetDataUnitType(HUINT8 EBU);

#if defined(CONFIG_DEBUG)
extern void				Teletext_CMD_Register(HUINT8 *cmdname);
#endif
