...
var config: ifProductSetting = {
    config: {
        model: __DEF__.eProductName.HDFOXIRCONNECT,
        op: __DEF__.eOP.ORF,
        useCAS: __DEF__.eCAS.IR,
        useCasOTA: __DEF__.eCASOTA.IRDETO,
        ...
        useHiddenFunction : 1,
        useHiddenPWReset : 1,
        useDefaultChannels : 0,  // TODO : Check config
        useAlphabetGroup : 1,    // TODO : Check config
        useWakeUpOTA : 1,
        useLiveIPOTA : 0,        // TODO : Check config
        useAutoPowerDown : 1,
        usefrontPanel : 'segment7',
        useMaxScheduleDuration : 1440,
        useDelayedRec: false,
        useWaitBooting: 120,
        use2ndPowerOnOffTimer: true,    // TODO : Check config
        useBackwardEpg: false,
        maxBackwardEpgDuration : 0,
        useRfCRID: false,            // TODO : Check config
        usePrismLiteS: true,
...
*/
        ...
        CPgCasIrUiNotifier :'product/cas_irdeto/page_casIrUiNotifier.js', // for Irdeto
    ...
    settings : {
        ...
        parentalcontrol : [['LOC_PARENTALCONTROL_ID', 'LOC_CHANGE_PASSWORD_ID', 'LOC_BLOCK_SETTINGS_CHANNEL_ID'],
    ...
    bottom_page: [/*'CPgDmrProxy',*/ 'CPgNotAvailable', 'CPgHotkey', 'CPgLive', /*'CPgPlayback',*/ 'CPgNotifier', 'CPgRecControl', 'CPgCasIrUiNotifier'],
