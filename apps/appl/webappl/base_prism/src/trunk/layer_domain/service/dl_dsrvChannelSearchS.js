...
define(["require", "exports", "./dl_kernel"], function (require, exports, __KERNEL__) {
    var cDLCHANNEL_SEARCH_S = (function (_super) {
        __extends(cDLCHANNEL_SEARCH_S, _super);
        function cDLCHANNEL_SEARCH_S(aServiceName) {
        ...
        cDLCHANNEL_SEARCH_S.prototype.init = function () {
        ...
        cDLCHANNEL_SEARCH_S.prototype.setSearchOptionParam = function (param) {
        ...
        cDLCHANNEL_SEARCH_S.prototype.getSearchOptionParam = function () {
            return {
        ...
        cDLCHANNEL_SEARCH_S.prototype.StartChannelScan = function () {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.startDiseqcScan = function () {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getstartDiseqcScanAntennaListCount = function () {
            var that = this, antInfolist, len = 0;
            antInfolist = that._getAllAntennaInfo();
            len = antInfolist.length;
            return len;
        };
        cDLCHANNEL_SEARCH_S.prototype.getstartDiseqcScanAntennaInfo = function (data) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.startAntennaConnection = function (data) {
            var that = this, i;
            hx.logadd('antCon');
        ...
        cDLCHANNEL_SEARCH_S.prototype.antennaConnectionComplete = function (data) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.StartTune = function (data) {
        ...
        cDLCHANNEL_SEARCH_S.prototype.StartTuneWithNotTestAntenna = function (data) {
        ...
        cDLCHANNEL_SEARCH_S.prototype.loadChannelSearchResult = function () {
            var that = this;
            that.oipfChannelConfigObj.controlScan('load');
        };
        cDLCHANNEL_SEARCH_S.prototype.loadChannelSearchResultWithDefCh = function () {
            var that = this;
            that.oipfChannelConfigObj.controlScan('loadDefChannels');
            that.oipfChannelConfigObj.controlScan('load');
        };
        cDLCHANNEL_SEARCH_S.prototype.saveChannelSearchResult = function () {
            var that = this;
            that.oipfChannelConfigObj.controlScan('save');
            that.oipfChannelConfigObj.stopScan();
            that._isStartScan = false;
        };
        cDLCHANNEL_SEARCH_S.prototype.stopScan = function () {
            var that = this;
            that.oipfChannelConfigObj.stopScan();
            that._isStartScan = false;
        };
        cDLCHANNEL_SEARCH_S.prototype.pauseScan = function () {
            var that = this;
            that.oipfChannelConfigObj.controlScan('pause');
        };
        cDLCHANNEL_SEARCH_S.prototype.resumeScan = function () {
            var that = this;
            that.oipfChannelConfigObj.controlScan('resume');
        };
        cDLCHANNEL_SEARCH_S.prototype.updateLcnChannelList = function () {
            var that = this;
            hx.logadd('updateLcnChannelList');
            that.curLcnScanType = that.lcnScanType.UPDATE;
            that._updateChannelList();
        };
        cDLCHANNEL_SEARCH_S.prototype.changeLcnChannelList = function () {
            var that = this;
            hx.logadd('changeLcnChannelList');
            that.curLcnScanType = that.lcnScanType.CHANGE;
            that._changeChannelList();
        };
        cDLCHANNEL_SEARCH_S.prototype.stopLcnUpdate = function () {
            var that = this;
            hx.logadd('stopLcnUpdate');
            hx.log('stopLcnUpdate', 'call oipfHLcnUpdate.stopLcnUpdate()');
            that.oipfHLcnUpdate.stopLcnUpdate();
        };
        cDLCHANNEL_SEARCH_S.prototype.saveLcnUpdate = function (param) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getCurrentLcnListInfo = function () {
            var that = this;
            that._getLcnUpdateInfo();
        };
        cDLCHANNEL_SEARCH_S.prototype.removeCurrentLcnListInfo = function () {
            var that = this;
            that._removeLcnUpdateInfo();
        };
        /////////////////////////*   Channel Scan Control END *//////////////////////////////////////
        ////////////////////////*  Manage Satellite START  */////////////////////////////////////////
        cDLCHANNEL_SEARCH_S.prototype.getSearchTypeFromAnt = function () {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getAntIdListFromLocal = function () {
            var that = this, i;
            var antIdList;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getSatelliteNameById = function (param) {
        ...
        cDLCHANNEL_SEARCH_S.prototype.getAntennaIdByName = function (name) {
        ...
        cDLCHANNEL_SEARCH_S.prototype.setTestSatelliteName = function (param) {
            var that = this;
            var convName = that._SatNameConverter(param.satName).convName;
            that._TestSatelliteName = convName;
        };
        cDLCHANNEL_SEARCH_S.prototype.getTestSatelliteName = function () {
            var that = this;
            return {
        ...
        cDLCHANNEL_SEARCH_S.prototype.setAntennaInfo = function (param) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.saveAntennaInfo = function (param) {
            var that = this, antId;
        ...
        cDLCHANNEL_SEARCH_S.prototype.saveTestAntennaInfo = function (param) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.removeAntennaList = function () {
            var that = this, i;
        ...
        cDLCHANNEL_SEARCH_S.prototype.removeAnt = function () {
            var that = this;
            that._removeAnt(that._curUsingSatelliteIdx);
            that._calcAntlength();
        };
        cDLCHANNEL_SEARCH_S.prototype.updateNumSatelSetting = function (param) {
            var that = this;
            that._curUsingSatelliteIdx = param.numSat;
        };
        cDLCHANNEL_SEARCH_S.prototype.updateNumTpSetting = function (param) {
            var that = this;
            that._curSettingTpIdx = param.numTp;
        };
        cDLCHANNEL_SEARCH_S.prototype.setSatelliteSetting = function (param) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getSatelliteSetting = function () {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getAllSatelliteSetting = function () {
            var that = this, i;
            var searchSatelName = [];
            var antennaJson = [];
            var userlnbFreq = [];
        ...
        cDLCHANNEL_SEARCH_S.prototype.antennaSetting = function () {
            var that = this, i;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getTransponderSelectorAll = function (data) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getTpUserSelector = function () {
        ...
        cDLCHANNEL_SEARCH_S.prototype.getUserSettingTestTp = function () {
            var that = this;
            var i;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getTransponderSelector = function () {
            var that = this, i;
            var allreturnValue = [];
            var returnValue = [];
            var index = 0;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getTestTransponderSelector = function () {
            var that = this;
            var returnValue = [];
            var index = 0;
        ...
        cDLCHANNEL_SEARCH_S.prototype.setUserlnbFreq = function (param) {
            var that = this;
            that._userlnbFreq[that._curUsingSatelliteIdx] = param.userlnbFreq;
            that._userTestlnbFreq = param.userlnbFreq;
        };
        cDLCHANNEL_SEARCH_S.prototype.setUserTPParam = function (param) {
            var that = this;
            var paramToSet;
        ...
        cDLCHANNEL_SEARCH_S.prototype.setUserTestTPParam = function (param) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.setUserTempTPParam = function (param) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getUserTPParam = function () {
            var that = this;
            return {
                tpParam: that._userTPParam[that._curSettingTpIdx]
            };
        };
        cDLCHANNEL_SEARCH_S.prototype.setTpIndex = function (param) {
            var that = this;
            that._tsIndex[that._curSettingTpIdx] = param.tsIndex;
            that._saveTpIdxToLocal(that._curSettingTpIdx);
        };
        cDLCHANNEL_SEARCH_S.prototype.setTestTpIndex = function (param) {
            var that = this;
            that._testtsIndex = param.testtsIndex;
        };
        /////////////////////* Manage Transponder List END *////////////////////////////////////////////
        ///////////////////////////*  SCD Channel Search START *///////////////////////////////
        cDLCHANNEL_SEARCH_S.prototype.setlastSettingTuner = function (param) {
            var that = this;
            that._lastSettingTuner = param.lastSettingTuner;
        };
        cDLCHANNEL_SEARCH_S.prototype.getlastSettingTuner = function () {
            var that = this;
            return that._lastSettingTuner;
        };
        cDLCHANNEL_SEARCH_S.prototype.setScdSetting = function (param) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype.getScdSetting = function () {
            var that = this;
            return {
        ...
        // Private Methods
        /////////////////////////// Initialize START ///////////////////////////////////
        cDLCHANNEL_SEARCH_S.prototype._initializeAntData = function () {
            var that = this, i;
        ...
        cDLCHANNEL_SEARCH_S.prototype._loadTpData = function () {
            var that = this;
            $.ajax({
        ...
        cDLCHANNEL_SEARCH_S.prototype._loadSatPosData = function () {
            var that = this;
            $.ajax({
        ...
        cDLCHANNEL_SEARCH_S.prototype._checkAntennaInformationWithSystemAntennaInformation = function () {
            var that = this;
            ...
            if ((hx.config.useImportExportChannels) && (hx.config.useImportExportChannels === 1)) {
                ...
                var fnSetSearchType = function () {
                    ...
                    if ((searchType === that.HXAntennaType.ETypeLnb) || (searchType === null)) {
                        type = 'lnb';
                    }
                    else if (searchType === that.HXAntennaType.ETypeDiseqc) {
                        type = 'diseqc';
                    }
                    else if (searchType === that.HXAntennaType.ETypeScd) {
                        type = 'scd';
                    }
                    else if (searchType === that.HXAntennaType.ETypeMotor) {
                        type = 'motor';
                    }
        ...
        cDLCHANNEL_SEARCH_S.prototype._initLcnEventHandler = function () {
            var that = this, i;
        ...
        cDLCHANNEL_SEARCH_S.prototype._saveAntIdToLocal = function (curUsingSatelliteIdx) {
            var that = this;
            hx.svc.WEB_STORAGE.saveAntIdToLocal({
        ...
        cDLCHANNEL_SEARCH_S.prototype._saveSearchOptionsToLocal = function () {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype._getSearchOptionsFromLocal = function () {
            var that = this;
            var searchOptions;
        ...
        cDLCHANNEL_SEARCH_S.prototype._getTpIdxListFromLocal = function () {
        ...
        cDLCHANNEL_SEARCH_S.prototype._saveTpIdxToLocal = function (curSettingTpIdx) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype._getTpParamFromLocal = function () {
        ...
        cDLCHANNEL_SEARCH_S.prototype._saveTpParamToLocal = function (curSettingTpIdx) {
            var that = this;
        ...
        ////////////////////// Channel Scan Control START ////////////////////////////////////////////////
        cDLCHANNEL_SEARCH_S.prototype._startScan = function (param) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype._startAntennaConnection = function (param) {
            var that = this;
            if (param.isStartScan) {
                that.oipfChannelConfigObj.stopScan();
            }
        ...
        cDLCHANNEL_SEARCH_S.prototype._startTune = function (param) {
            var that = this;
            if (param.isStartScan) {
                that.oipfChannelConfigObj.stopScan();
            }
        ...
        cDLCHANNEL_SEARCH_S.prototype._disecScanCompleted = function () {
            var that = this;
            that.oipfChannelConfigObj.controlScan('load');
            that.oipfChannelConfigObj.controlScan('save');
            that.oipfChannelConfigObj.stopScan();
        ...
        cDLCHANNEL_SEARCH_S.prototype._save_disecScanCompletedAntenna = function (scanData) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype._updateChannelList = function () {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype._changeChannelList = function () {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype._saveLcnUpdate = function (param) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype._getLcnUpdateInfo = function () {
            var that = this;
            that.oipfHLcnUpdate.getLcnUpdateInfo();
        };
        cDLCHANNEL_SEARCH_S.prototype._removeLcnUpdateInfo = function () {
            var that = this;
            var sync = false;
        ...
        cDLCHANNEL_SEARCH_S.prototype._createChannelScanParamCollectionObject = function () {
            var that = this;
            var scanParamCollection = that.oipfChannelConfigObj.createChannelScanParametersObject();
            return scanParamCollection;
        };
        cDLCHANNEL_SEARCH_S.prototype._addScanParameters = function (freq, sr, polar, fec, modul, searchAntennaId, searchSatelliteName, scanParamCollection) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype._settingChannelScanParameters = function (freq, sr, polar, fec, modul, searchAntennaId, searchSatelliteName, channelParams) {
        ...
        cDLCHANNEL_SEARCH_S.prototype._createChannelScanOptionsObject = function () {
            var that = this;
            var channelScanOptions = that.oipfChannelConfigObj.createChannelScanOptionsObject();
            return channelScanOptions;
        };
        cDLCHANNEL_SEARCH_S.prototype._setScanOptionsChannelType = function (channelType, channelScanOptions) {
            var that = this;
            channelScanOptions.channelType = channelType;
        };
        cDLCHANNEL_SEARCH_S.prototype._setScanOptionsCasType = function (casType, channelScanOptions) {
            var that = this;
            channelScanOptions.casType = casType;
        };
        cDLCHANNEL_SEARCH_S.prototype._setScanOptionsNetwork = function (network, channelScanOptions) {
            var that = this;
            channelScanOptions.enableNetworkScan = network;
        };
        cDLCHANNEL_SEARCH_S.prototype._getTuningInfo = function (satName, type) {
            // type
            // 0 : unused
            // 1 : diseqc detection
        ...
        /////////////////////////// Manage Satellite START //////////////////////////////////////////////
        cDLCHANNEL_SEARCH_S.prototype._antennaSetting = function () {
            var that = this, i;
            var antInfoList = [];
            for (i = 0; i < that.SATELLITE_NUMBER_TO_MAKE; i += 1) {
        ...
        cDLCHANNEL_SEARCH_S.prototype._getAllAntennaInfo = function () {
            var that = this;
            var antInfoLists = that.oipfLocalSystemObj.antennaInfoLists;
            return antInfoLists;
        };
        cDLCHANNEL_SEARCH_S.prototype._getAntennaInfo = function () {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype._doGetCurrentAntInfo = function () {
            var that = this;
            var ret = null;
            var antInfoLists = that.oipfLocalSystemObj.antennaInfoLists;
        ...
        cDLCHANNEL_SEARCH_S.prototype._setAntennaId = function (id, curUsingSatelliteIdx) {
            var that = this;
            that._searchAntennaId[curUsingSatelliteIdx] = id;
        };
        cDLCHANNEL_SEARCH_S.prototype._setTestAntennaId = function (id) {
            var that = this;
            that._testAntennaId = id;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfolnbFreq = function (antInfo, lnbFreq) {
            antInfo.lnbFrequency = lnbFreq;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoantennaType = function (antInfo, antennaType) {
            antInfo.antennaType = antennaType;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoswitchInput = function (antInfo, switchInput) {
            antInfo.switchInput = switchInput;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfodiseqcVersion = function (antInfo, diseqcVersion) {
            antInfo.diseqcVersion = diseqcVersion;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoenable22KHzTone = function (antInfo, enable22KHzTone) {
            antInfo.enable22KHzTone = enable22KHzTone;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoscdBandNo0 = function (antInfo, scdBandNo0) {
            antInfo.scdBandNo0 = scdBandNo0;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoscdBandNo1 = function (antInfo, scdBandNo1) {
            antInfo.scdBandNo1 = scdBandNo1;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoscdBandNo2 = function (antInfo, scdBandNo2) {
            antInfo.scdBandNo2 = scdBandNo2;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoscdBandNo3 = function (antInfo, scdBandNo3) {
            antInfo.scdBandNo3 = scdBandNo3;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoscdBandFreq0 = function (antInfo, scdBandFreq0) {
            antInfo.scdBandFreq0 = scdBandFreq0;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoscdBandFreq1 = function (antInfo, scdBandFreq1) {
            antInfo.scdBandFreq1 = scdBandFreq1;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoscdBandFreq2 = function (antInfo, scdBandFreq2) {
            antInfo.scdBandFreq2 = scdBandFreq2;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoscdBandFreq3 = function (antInfo, scdBandFreq3) {
            antInfo.scdBandFreq3 = scdBandFreq3;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfosatName = function (antInfo, satName) {
            antInfo.satelliteName = satName;
            antInfo.satelliteType = satName;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoposition = function (antInfo, position) {
            antInfo.position = position;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfolongitude = function (antInfo, longitude) {
            antInfo.longitude = longitude;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfolnbVoltage = function (antInfo, lnbVoltage) {
            antInfo.lnbVoltage = lnbVoltage;
        };
        cDLCHANNEL_SEARCH_S.prototype._antInfoCommit = function (antInfo) {
            //hx.logadd('sh');
        ...
        cDLCHANNEL_SEARCH_S.prototype._antInfoListsCommit = function () {
            var that = this;
            var antInfoList = that.oipfLocalSystemObj.antennaInfoLists;
            antInfoList.commit();
        };
        cDLCHANNEL_SEARCH_S.prototype._removeAntennaList = function () {
            var that = this;
            var antInfoLists = that.oipfLocalSystemObj.antennaInfoLists;
        ...
        cDLCHANNEL_SEARCH_S.prototype._removeAnt = function (curUsingSatelliteIdx) {
            var that = this, i;
        ...
        cDLCHANNEL_SEARCH_S.prototype._moveDataFromTo = function (fromSatelliteIdx, toSatelliteIdx) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype._calcAntlength = function () {
            var that = this, i;
            that._antlength = 0;
            for (i = 0; i < that.SATELLITE_NUMBER_TO_MAKE; i += 1) {
        ...
        cDLCHANNEL_SEARCH_S.prototype._makeAntennaWithDefault = function (satName) {
            var that = this;
        ...
        cDLCHANNEL_SEARCH_S.prototype._createAntennaInfo = function () {
            var that = this;
            var antInfoLists = that.oipfLocalSystemObj.antennaInfoLists;
            var antId = 0;
        ...
        cDLCHANNEL_SEARCH_S.prototype._getAntennaInfoFromId = function (antId) {
            var that = this;
            if (antId === 0) {
                return null;
            }
        ...
        cDLCHANNEL_SEARCH_S.prototype._getAntennaInfoWithId = function (antId) {
            var that = this;
            var antInfoLists = that.oipfLocalSystemObj.antennaInfoLists;
            var antInfo;
        ...
        cDLCHANNEL_SEARCH_S.prototype._makeAntennaDefault = function (satName, antInfo) {
            antInfo.satelliteType = satName;
            antInfo.satelliteName = satName;
            antInfo.antennaType = antInfo.TYPE_LNB;
            antInfo.lnbFrequency = antInfo.LNBFREQ_UNIVERSAL;
        };
        cDLCHANNEL_SEARCH_S.prototype._setAntennaInfoWithMenu = function (antInfo, antennaSetJson, satName, userlnbFreq, tuner1Param, tuner2Param, tuner3Param, tuner4Param) {
            var that = this;
            var dInput, i;
        ...
        cDLCHANNEL_SEARCH_S.prototype._convertAntennaData = function (antInfo) {
            var convAntInfo = {
                satelliteName: null,
                satelliteType: null,
                lnbFrequency: null,
        ...
        cDLCHANNEL_SEARCH_S.prototype._SatNameConverter = function (name) {
            var convName = null;
        ...
        cDLCHANNEL_SEARCH_S.prototype._initAllAntennaInfo = function () {
            var that = this;
