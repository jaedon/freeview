...
define(["require", "exports", "./dl_kernel"], function (require, exports, __KERNEL__) {
    var eSVC_SECTION;
    (function (eSVC_SECTION) {
        eSVC_SECTION[eSVC_SECTION["SECTION_DEFAULT"] = 1] = "SECTION_DEFAULT";
        eSVC_SECTION[eSVC_SECTION["SECTION_LCN"] = 2] = "SECTION_LCN";
        eSVC_SECTION[eSVC_SECTION["SECTION_NONE_LCN"] = 16] = "SECTION_NONE_LCN";
    })(eSVC_SECTION || (eSVC_SECTION = {}));
    var cDLCHList = (function (_super) {
        __extends(cDLCHList, _super);
        function cDLCHList(aServiceName) {
        ...
        cDLCHList.prototype._initEventHandler = function () {
         ...
         */
        cDLCHList.prototype.checkChannelChangable = function (data) {
            var a = this;
            return a._checkChannelChangableCL(data.channel);
        };
        cDLCHList.prototype.checkChannelsChangable = function (channels) {
            var a = this;
        ...
        cDLCHList.prototype.getChlist = function (param, aIsHiddenChannelOnly) {
        ...
        cDLCHList.prototype.getCurrentGrpInfo = function (group) {
            var len_grp, a = this, retObj = {}, retGrp;
            var i;
        ...
        cDLCHList.prototype.getAvailableFirstChannel = function (param) {
            var i, len, a = this, tempParam = {}, retObj = {}, channel = null, group;
        ...
        cDLCHList.prototype.getAvailableChannelWithGroup = function (group) {
            var i, len, a = this, param = {}, retObj = {}, channel = null;
        ...
        cDLCHList.prototype.getAvailableGroupForChannel = function (data) {
            var i, len, a = this, param = {}, retObj = {}, group = null, channel = data.channel;
        ...
        cDLCHList.prototype.getAvailableGroupForCcid = function (data) {
            var i, len, a = this, param = {}, retObj = {}, group = null, ccid = data.ccid;
        ...
        cDLCHList.prototype.getChannelCount = function (aParam) {
            if (aParam === void 0) { aParam = {}; }
            var len_grp, a = this, group = '', chCnt = 0, retObj = {};
        ...
        cDLCHList.prototype.getWholeChDB = function (param) {
            var a = this;
            if (param) {
        ...
        cDLCHList.prototype.forceChListUpdate = function () {
            var a = this;
        ...
        cDLCHList.prototype.getChannel = function (param) {
            var that = this;
            var chObj, retObj = {};
            retObj.result = false;
            if (param.group === undefined) {
        ...
        cDLCHList.prototype.getChannels = function (param) {
            var that = this, i, j, index, start, end, length, channel, channel_db, ccid, lastServiceCcid, group, lastGroup, offset, count, channels = [], result = [];
            offset = param.offset;
            count = param.count;
        ...
        cDLCHList.prototype.getNextChannel = function (param) {
            var a = this, i, ccid, group, channel, len_grp, len_list, ret_channel, grpInfo, retObj = {};
            ccid = param.ccid;
            group = param.group;
            retObj.result = false;
        ...
        cDLCHList.prototype.getPrevChannel = function (param) {
            var a = this, ccid, group, channel, len_grp, len_list, ret_channel, grpInfo, retObj = {};
            var i;
            ccid = param.ccid;
            group = param.group;
            retObj.result = false;
        ...
        cDLCHList.prototype.getBackChannel = function (param) {
            var a = this;
            var that = this;
            var retObj = {};
        ...
        cDLCHList.prototype.getCurrentChannel = function (param) {
            var that = this;
            var ccid = null;
            var group = '';
            var retObj = {}, retSvc = {};
        ...
        cDLCHList.prototype.removeWholeChannelList = function () {
            var a = this;
        ...
        cDLCHList.prototype.removeChannel = function (param) {
        ...
        cDLCHList.prototype.updateChannel = function (param) {
            var that = this, chObj, retObj = {}, findObj = {};
        ...
        // Favourite List area.....
        cDLCHList.prototype.updateFavList = function (p) {
            var that = this;
            var FavListIds;
            var favouriteLists = that.channelConfig.favouriteLists;
            /*
        ...
        cDLCHList.prototype.addToFavList = function (params) {
            var that = this;
        ...
        cDLCHList.prototype.getFavListName = function (param) {
            var that = this, favtype = param.favtype, favList = null, InternalParam = {};
            var nameFav;
        ...
        cDLCHList.prototype.removeFromFavList = function (params) {
            var that = this;
            var ccid = params.ccid;
            var favtype = params.favtype;
        ...
        cDLCHList.prototype.renewFavList = function (params) {
        ...
        cDLCHList.prototype.renewPreferList = function (params) {
            // this function for settings>edit favourite list
            // 1. remove all list
            // 2. add all list that from parmas
            var that = this;
        ...
        cDLCHList.prototype.moveChListItem = function (params) {
            var that = this;
            var ccid = params.ccid;
            var favtype = params.favtype;
        ...
        cDLCHList.prototype.moveChListItemWithTargetIdx = function (params) {
            var that = this;
            var ccid = params.ccid;
            var favtype = params.favtype;
            var favList = null, index = -1, insertIdx = -1;
        ...
        cDLCHList.prototype.editChListDoCommit = function (param) {
        ...
        cDLCHList.prototype.outFromEditChannels = function () {
            var that = this;
            that.editTvList = undefined;
            that.editRadioList = undefined;
        };
        cDLCHList.prototype.getChannelByTriplet = function (params) {
        ...
        cDLCHList.prototype.getChannelByTripletExceptALL = function (params) {
            var onid = params.onid;
            var tsid = params.tsid;
            var sid = params.sid;
            hx.log('dsrvChlist', 'onid = ' + onid + ', tsid = ' + tsid + ', sid = ' + sid);
        ...
        cDLCHList.prototype.getChannelByCcidExceptALL = function (param) {
            var i, j, a = this, channel;
            for (i = 0; i < a.channel_db.length; i += 1) {
                for (j = 0; j < a.channel_db[i].list.length; j += 1) {
                    channel = a.channel_db[i].list[j];
        ...
        cDLCHList.prototype.getChannelByCcidInFav = function (param) {
            var i, j, a = this, channel;
            for (i = 0; i < a.channel_db.length; i += 1) {
                for (j = 0; j < a.channel_db[i].list.length; j += 1) {
                    channel = a.channel_db[i].list[j];
        ...
        cDLCHList.prototype.getChannelGroupList = function () {
         ...
         */
        cDLCHList.prototype.removeChannels = function (params) {
            var that = this, chObj, chItem, idx, len_of_list, findObj = {};
         ...
         * It is just for channel list update function via OIFP favourite API..
         */
        cDLCHList.prototype.updateChannels = function (params) {
            var that = this, len_of_list, findObj = {};
        ...
        cDLCHList.prototype._ChReload = function (favouriteLists) {
            var that = this;
            var name, result = [];
            var db;
            var groupIds;
        ...
        cDLCHList.prototype._isLoadedFavList = function (favID) {
            var a = this;
            var i, ret = false;
            for (i = 0; i < a.channel_db.length; i += 1) {
        ...
        cDLCHList.prototype._saveFavID = function (idx, favID) {
        ...
        cDLCHList.prototype._loadFavLists = function (channel_db, favouriteLists) {
        ...
        cDLCHList.prototype._conv_oipf_to_list = function (oChList) {
        ...
        cDLCHList.prototype._loadFavList = function (p, idx, favouriteLists) {
            var that = this;
            var favID = p;
        ...
        cDLCHList.prototype._findChList = function (group) {
            var i, a = this;
         ...
         */
        cDLCHList.prototype._getChannelByCcid = function (param) {
        ...
        cDLCHList.prototype._getChannelByLcn = function (param) {
            var i, j, a = this, channel;
            var lcn = param.lcn;
        ...
        cDLCHList.prototype._removeChannelByCcid = function (group, ccid) {
            var i, j, a = this, channel;
            for (i = 0; i < a.channel_db.length; i += 1) {
        ...
        cDLCHList.prototype._checkChannelChangableCL = function (channel) {
            var ret;
            if (channel) {
        ...
        cDLCHList.prototype._getNextChannel = function (param, direction, grp, count) {
            if (count === void 0) { count = 0; }
            var i, j, a = this, ccid, channel, len_grp, len_list, ret_channel;
            ccid = param.ccid;
        ...
        cDLCHList.prototype._getAlphabetGruop = function (param) {
