...
define(["require", "exports", "./dl_kernel", "../../pages/util/provider"], function (require, exports, __KERNEL__, __PROVIDER__) {
    var cDLSvcEpgCache = (function () {
        function cDLSvcEpgCache() {
            this.tables = [];
        }
        cDLSvcEpgCache.prototype.isHit = function (channel, condition) {
            var that = this;
        ...
        cDLSvcEpgCache.prototype.setRange = function (channel, condition) {
        ...
        cDLSvcEpgCache.prototype.insert = function (programme) {
            var that = this, table;
        ...
        cDLSvcEpgCache.prototype.update = function (programme) {
            var that = this;
        ...
        cDLSvcEpgCache.prototype.remove = function (ccid, condition) {
            var that = this;
        ...
        cDLSvcEpgCache.prototype.select = function (channel, condition) {
            var that = this;
        ...
        cDLSvcEpgCache.prototype.truncate = function () {
            this.tables = [];
        };
        return cDLSvcEpgCache;
    })();
    var cDLSvcEpg = (function (_super) {
        __extends(cDLSvcEpg, _super);
        function cDLSvcEpg(aServiceName) {
            var _this = this;
            _super.call(this, aServiceName);
            this.EpgDatacache = null;
            this.useEventDataCache = false;
            this.listeners = [];
            this.queue = [];
            this._currentSearchIdForUI = null;
            ...
            this._workingQueue = [];
            this._cachedOnAirProgrammes = [];
            this._autoEmptyCacheTimerID = null;
            this._searchOngoing = false;
            this._liveData = TAFFY([]);
            this._liveSearchId = null;
            ...
            hx.svc.CH_LIST.addEventCb("ChannelListUpdate", this, function () {
                if (_this.EpgDatacache) {
                    _this.EpgDatacache.truncate();
                }
         ...
         */
        cDLSvcEpg.prototype.findProgrammes = function (aParam) {
         ...
         */
        cDLSvcEpg.prototype.getProgrammes = function (aParam, range) {
            ...
            if (that.useEventDataCache) {
                ...
                if (that.EpgDatacache && (startTime !== endTime) && aParam.info && (that.cached.indexOf(aParam.info) > -1) && that.EpgDatacache.isHit(channel, isHitParam)) {
        ...
        cDLSvcEpg.prototype.getAllProgrammesOrderByTime = function (view, param, range) {
        ...
        cDLSvcEpg.prototype.retrieveLiveProgrammes = function (param) {
         ...
         */
        cDLSvcEpg.prototype.getLiveProgrammes = function (p) {
            var that = this, now, param, channel, ccid, startTime, endTime, programmes = [], result = [], i, length;
        ...
        cDLSvcEpg.prototype.executeQuery = function (param) {
            var that = this;
            var search, onGoing;
        ...
        cDLSvcEpg.prototype._deleteQueue = function (searchOipfObj) {
        ...
        // ####################################################################################################
        // Event Handlers
        cDLSvcEpg.prototype.onMetadataSearch = function (search, state) {
        ...
        cDLSvcEpg.prototype.onMetadataUpdate = function (action, info, object, type) {
        ...
        // ####################################################################################################
        // Private Methods
        cDLSvcEpg.prototype._doSearch = function (aParam, range) {
            var i, c, length;
            var channel, clause;
            ...
            if (aParam && aParam.channel) {
                aParam.channel = _.compact(aParam.channel);
            }
            if (!aParam.notUI) {
        ...
        cDLSvcEpg.prototype._wrap = function (searchTarget, result, param) {
            var that = this;
        ...
        cDLSvcEpg.prototype._createQuery = function (search, clause) {
            ...
            if (orderBy) {
                ...
                search.orderBy(orderBy.substring(0, clause.indexOf()).trim(), ascending);
            }
            return query;
        };
        cDLSvcEpg.prototype._lazyExecute = function (param, programmes) {
