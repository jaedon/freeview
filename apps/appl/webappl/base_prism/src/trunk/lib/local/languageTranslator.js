...
define(["require", "exports"], function (require, exports) {
    ...
    function load(aLanguageCode, aCallback) {
        var iso639 = toISO639(aLanguageCode);
        require(["text!res/" + iso639 + ".json"], function (aData) {
            /* COMMENT
    ...
    function reload(aLanguage, aCallback) {
    ...
    var CLanguageTranslate = (function () {
        function CLanguageTranslate(aISO639Table) {
            _iso639table = aISO639Table;
            return translateIDtoLangauge;
        }
        return CLanguageTranslate;
    })();
    return CLanguageTranslate;
});
