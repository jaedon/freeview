...
define(["require", "exports", "pages/page_kernel"], function (require, exports, __PAGE_KERNEL__) {
    var cPgInstallLang = (function (_super) {
        __extends(cPgInstallLang, _super);
        function cPgInstallLang() {
            _super.call(this);
        }
        cPgInstallLang.prototype.create = function (aEntity, aPageUrl) {
            var i = 0, arLangStr = [], stLangObj, ulFocusIndex;
        ...
        cPgInstallLang.prototype.destroy = function () {
            if (this.containerEl) {
        ...
        cPgInstallLang.prototype._on_alClicked = function (aParam) {
            var data = aParam.alData, target = data.me;
            var bConsumed = false, lIdx = data.me.getItemFocus();
        ...
        cPgInstallLang.prototype._on_alScrolldown = function (aParam) {
        ...
        cPgInstallLang.prototype._on_alScrollup = function (aParam) {
            var data = aParam.alData, lIdx = data.me.getItemFocus();
            this._szMenuLang = this._convIdxToIso639(lIdx);
            if (ENV.listModel.FVP4000T !== ENV.model) {
                hx.l.reload(this._szMenuLang);
        ...
        cPgInstallLang.prototype._on_alKey = function (aParam) {
            var bConsumed = false;
            switch (aParam.alKey) {
        ...
        cPgInstallLang.prototype._set_List = function () {
        ...
        cPgInstallLang.prototype._fadeOutAni = function (aTargetPage, aIsGoPrev) {
            var _this = this;
            var left;
            if (aIsGoPrev) {
                left = '20px';
        ...
        cPgInstallLang.prototype._convIso639ToIdx = function (aszIso639) {
            var i = 0, ulIndex = 0;
            for (i = 0; i < hx.al.CPgInstall03.items.itemStr.length; i += 1) {
        ...
        cPgInstallLang.prototype._convIdxToIso639 = function (alIdx) {
            var szLangeIsoCode = 'eng';
