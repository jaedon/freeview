...
define(["require", "exports", "pages/page_kernel"], function (require, exports, __PAGE_KERNEL__) {
    var cPgInstallSelRegion = (function (_super) {
        __extends(cPgInstallSelRegion, _super);
        function cPgInstallSelRegion() {
            _super.call(this);
        }
        cPgInstallSelRegion.prototype.create = function (aEntity, aPageUrl) {
            var i = 0, regionStr = [];
            var ulRegionId = 0, ulFocusIndex = 0, regionObj;
        ...
        cPgInstallSelRegion.prototype.destroy = function () {
            if (this._containerEl) {
        ...
        cPgInstallSelRegion.prototype._on_alClicked = function (aParam) {
            var data = aParam.alData, target = data.me, bConsumed = false, ulRegionId = 0;
            //save region set~!!!!
            if (target === this._ul) {
                bConsumed = true;
        ...
        cPgInstallSelRegion.prototype._on_alScrolldown = function (aParam) {
            var data = aParam.alData;
            this._ulMenuRegion = data.index;
            return true;
        };
        cPgInstallSelRegion.prototype._on_alScrollup = function (aParam) {
            var data = aParam.alData;
            this._ulMenuRegion = data.index;
            return true;
        };
        cPgInstallSelRegion.prototype._on_alKey = function (aParam) {
            var bConsumed = false;
            switch (aParam.alKey) {
        ...
        cPgInstallSelRegion.prototype._set_list = function () {
        ...
        cPgInstallSelRegion.prototype._fadeOutAni = function (aTargetPage, aIsGoPrev) {
            var _this = this;
            var left;
            if (aIsGoPrev) {
                left = '20px';
        ...
        cPgInstallSelRegion.prototype._conv_region_to_idx = function (aParamRegion) {
            var i = 0, ulIndex = 0;
            for (i = 0; i < hx.al.CPgInstall03.items.itemStr.length; i += 1) {
        ...
        cPgInstallSelRegion.prototype._conv_idx_to_region = function (aulIdx) {
            var ulRegionPostalCode = 0;
