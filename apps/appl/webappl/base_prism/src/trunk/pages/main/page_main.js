...
define(["require", "exports", "pages/page_kernel", "model/model", "layer_domain/service/dl_dsrvNetflix"], function (require, exports, __PAGE_KERNEL__, __MODEL__, __NETFLIX__) {
    var cPgMain = (function (_super) {
        __extends(cPgMain, _super);
        function cPgMain() {
            _super.call(this);
            this.TPageState = {
                EIdle: 0,
            ...
            this.mCurrentTrickMode = null;
            this.mLastNotiLiveBroadcastTime = null;
            this.mPlayNext = null;
            this.mNetworkAvailable = false;
            this.mOldErrorTime = 0;
            this.mCurrentPositon = 0;
            this.mBlockRecKey = false;
            this.mBlockLive = false;
            this.mForcedBlock = false;
            //mIsStoppingAV = false;
            //mIsRequestStop = false;
            this.mForcePlayToStop = false;
            this.mForcePlayToStopTimer = null;
            this.EREPEAT_ALL = '0';
            this.EREPEAT_NO = '1';
            this.EREPEAT_ONE = '2';
            this._lastToggleTime = 0;
            this._HbbTvAppLoaded = false;
        }
        cPgMain.prototype.create = function () {
            hx.logadd("CPgMain");
            ...
            mainPage.removeLayer = function (fromTo) {
        ...
        cPgMain.prototype.destroy = function () {
            this._mainPage.destroy();
            delete this._mainPage;
        };
        cPgMain.prototype.isActive = function () {
            return true;
        };
        cPgMain.prototype._init = function () {
            var _this = this;
            var that = this;
            ...
            var fnCreateQueryPasswordDlg = function () {
                var passwordDlg = prism.createQueryPasswordDlg(_this._mainPage);
                passwordDlg.setTextHtml(tr('LOC_ENTER_PASSWORD_ID'));
                return passwordDlg;
            };
            var onChannelChangeSucceeded = function (aChannel) {
            ...
            var onChannelChangeError = function (aChannel, aErrorState) {
                if (that.mPlayback) {
                    hx.log('CPgMain', '[onChannelChangeSucceeded] close()');
                    that.mPlayback.close();
                }
            ...
            // dsrvBridge
            var onRequestMusicPlayback = function (aItems, aStartIndex) {
                ...
                musicPlayback.open({
                    ...
                    onClosed: function () {
                        ...
                        if (_this.mPlayback) {
                            _this.mPlayback.removeEventHandler(_this);
                        }
                        that.mPlayback = null;
            ...
            var onRequestVideoPlayback = function (aItems, aStartIndex, aKeyCode) {
                that.mForcePlayToStop = true;
                that.mBlockLive = true;
                var action = 'play';
                var item = aItems[aStartIndex];
                var fnStartPlayback = function (isLastPosition) {
                    ...
                    if (that._$wrap_smt[0].children.length > 1) {
                        that._$wrap_smt[0].children[1].style.opacity = "0";
                    ...
                    videoPlayback.addEventHandler('Show', _this, function () {
                        hx.svc.SETTING_UTIL.doingKeyGrab(true);
                    });
                    videoPlayback.addEventHandler('Hide', _this, function () {
                        hx.svc.SETTING_UTIL.doingKeyGrab(_this.visible());
                    });
                    videoPlayback.createPlayer(item);
                    var saveStatisticLog = function (item) {
                        var code;
                        if (item instanceof CTsrItem) {
                        }
                    ...
                    videoPlayback.open({
                        ...
                        onClosed: function (param) {
                            if (!that.mForcedBlock) {
                                ...
                                if (that._$wrap_smt[0].children.length > 1) {
                                    that._$wrap_smt[0].children[1].style.opacity = "1";
            ...
            var onRequestPhotoPlayback = function (items, startIndex) {
            ...
            var onRequestStopPlayback = function () {
            ...
            // dsrvDial
            var onReqLaunch = function (name, url) {
            ...
            // dsrvDmr
            var onRequestPlay = function (item) {
                that.mForcePlayToStop = true;
            ...
            var onRequestPause = function () {
                hx.log('CPgMain', 'onRequestPause');
                if (that.mPlayback) {
                    that.mPlayback.pause();
                }
            };
            var onRequestResume = function () {
                hx.log('CPgMain', 'onRequestResume');
                if (that.mPlayback) {
                    that.mPlayback.resume();
                }
            };
            var onRequestSetPosition = function (position) {
                hx.log('CPgMain', 'onRequestResume');
                dsrvPlayback.seek({
                    offset: position
                });
            };
            var onRequestSetVolume = function () {
            ...
            var onPlaybackOptionChange = function (item) {
            ...
            var onPlaySpeedsArrayChanged = function (supportedSpeedsArray) {
            ...
            var onPlayPositionChanged = function (position, buffer) {
            ...
            var onEndOfBufferReached = function () {
            ...
            var onPlayStateError = function (error) {
            ...
            var onPlayStatePlaying = function (item) {
            ...
            var onDRMRightsError = function (errorState, trickLimit) {
            ...
            var onBGMListCreated = function (bgmItemList) {
                hx.log('CPgMain', 'onBGMListCreated');
                if (that.mPlayback && that.mPlayback.setBGMList) {
                    that.mPlayback.setBGMList(bgmItemList);
                }
            };
            var onNoValidMusicFile = function () {
                _this._openNotificationDlg(hx.l('LOC_THERE_IS_NO_VALID_MUSIC_FILE_ID'));
            };
            var onAudioOutputRestrict = function () {
                hx.log('CPgMain', hx.util.format('onAudioOutputRestrict'));
                if (that.mPlayback) {
                    that.mPlayback.audioRestrict();
                }
            };
            var onCheckPrivacyVersion = function () {
                hx.log('debug', '[MAIN][onCheckPrivacyVersion]');
                dsrvTVPortal.checkPrivacyVersion(function () {
                    dsrvTVPortal.login({
                        fn: function () {
                        },
                        fnError: function () {
            ...
            // dsrvStorageUtil
            var onPhysicalStorageAttached = function (physicalStorage) {
                        ...
                        if ((interfaceType !== TStorageType.ESata) && (ulusage !== that.THMXPhysicalStorageUsage.EUsagePVR)) {
                            if (physicalStorage.ismount) {
                                ...
                                selectionDlg.open({
                                    dimm: true,
                                    onClosed: function () {
                                        _this.setKeyHookingControl(selectionDlg);
                                    }
                                });
                                hx.svc.SETTING_UTIL.doingKeyGrab(true);
                ...
                hx.svc.AV_CTRL._eventSource._fireEvent("NetworkUriChanged", { 'uri': prefixUrl, 'mode': 'USB' });
                var dsrvTVPortal = hx.svc.TV_PORTAL;
            ...
            var onPhysicalStorageDetached = function (physicalStorage) {
            ...
            var onProgrammesChanged = function (programmes) {
            ...
            var onPlayBufferChanged = function (buffer) {
            ...
            var onRecordingItemAdded = function (item) {
                if (item) {
            ...
            var onRecordingCompleted = function (item) {
                if (!!item) {
            ...
            var onNotiSatIpRequested = function (item) {
                ...
                if ((currentCenterPage !== 'CPgLiveController' && currentCenterPage !== 'CPgGuide' && currentCenterPage !== 'CPgRecordings' && currentCenterPage !== 'CPgVideo' && currentCenterPage !== 'CPgPhoto' && currentCenterPage !== 'CPgMusic' && currentCenterPage !== 'CPgDetailInfo' && currentCenterPage !== 'CPgMediaCenter') || !bPlayPossible) {
            ...
            var onTrickRestrictModeChanged = function (trickMode) {
            ...
            var onChangeCPgLiveController = function (type) {
                // check no service
            ...
            var onShowPWForNetfixLaunch = function (type) {
            ...
            var onHideNetflixPW = function (param) {
            ...
            var onSkipChannels = function (channelCount) {
            ...
            var onChangeChannelByNumber = function (number) {
            ...
            var onChangeChannelByName = function (payloadChannel) {
            ...
            var onTurnOn = function () {
                if (that.getCenterPageName() === 'CPgStandby') {
                    dsrvVA.processData();
                    dsrvVA.publish();
                }
            };
            var onTurnOff = function () {
                if (that.getCenterPageName() !== 'CPgStandby') {
                    dsrvVA.processData();
                    dsrvVA.publish();
                }
            };
            var onSetMute = function () {
                var isMute = false;
            ...
            var onNextMediaPlay = function () {
                var centerPage = _this.getCenterPageName();
                if (centerPage === 'CPgVideo' || centerPage === 'CPgPhoto' || centerPage === 'CPgMusic' || centerPage === 'CPgRecordings') {
                    if (_this.mCurrentPageState === _this.TPageState.EPhotoPlaybackOpened) {
                        ...
                        if (!isSmartSearchEnabled() && !isProgrammeDetailEnabled()) {
                            _this._mainPage.doKey(hx.key.KEY_RIGHT);
                        }
                        dsrvVA.publish();
                    }
                    else {
            ...
            var onPreviousMediaPlay = function () {
                var centerPage = _this.getCenterPageName();
                if (centerPage === 'CPgVideo' || centerPage === 'CPgPhoto' || centerPage === 'CPgMusic' || centerPage === 'CPgRecordings') {
                    if (_this.mCurrentPageState === _this.TPageState.EPhotoPlaybackOpened) {
                        var isSmartSearchEnabled = function () {
                        ...
                        if (!isSmartSearchEnabled() && !isProgrammeDetailEnabled()) {
                            _this._mainPage.doKey(hx.key.KEY_LEFT);
                        }
                        dsrvVA.publish();
                    }
                    else {
            ...
            dsrvBridge.addEventCb('RequestInstanceRecording', this, function (e) {
                onRequestInstanceRecording(e.channel);
            });
            dsrvBridge.addEventCb('RequestStopPlayback', this, function (e) {
                onRequestStopPlayback();
            });
            // dsrvDial
            dsrvDial.addEventCb('ReqLaunch', this, function (e) {
                onReqLaunch(e.name, e.url);
            });
            dsrvDial.start();
            dsrvDial.addEventCb('ReqStop', this, function (e) {
                onReqStop(e.name);
            });
            // dsrvDmr
            dsrvDmr.addEventCb('RequestPlay', this, function (e) {
                var dlnaItem = new CDlnaItem(e.item);
                onRequestPlay(dlnaItem);
            });
            dsrvDmr.addEventCb('RequestStop', this, function (e) {
                onRequestStop();
            });
            dsrvDmr.addEventCb('RequestPause', this, function (e) {
                onRequestPause();
            });
            dsrvDmr.addEventCb('RequestSetVolume', this, function (e) {
                onRequestSetVolume();
            });
            dsrvDmr.addEventCb('RequestMute', this, function (e) {
                onRequestMute();
            });
            dsrvDmr.addEventCb('RequestBringIn', this, function (e) {
                onRequestBringIn();
            });
            // dsrvPlayback
            dsrvPlayback.addEventCb('NoValidMusicFile', this, function (e) {
                onNoValidMusicFile();
            });
            dsrvPlayback.addEventCb('PlaySpeedChanged', this, function (e) {
                onPlaySpeedChanged(e.speed);
            });
            dsrvPlayback.addEventCb('PlaySpeedsArrayChanged', this, function (e) {
                onPlaySpeedsArrayChanged(e.supportedSpeedsArray);
            });
            dsrvPlayback.addEventCb('PlayPositionChanged', this, function (e) {
                onPlayPositionChanged(e.position, e.buffer);
            });
            dsrvPlayback.addEventCb('EndOfBufferReached', this, function (e) {
            ...
            dsrvPlayback.addEventCb('DRMRightsError', this, function (e) {
                onDRMRightsError(e.errorState, e.trickLimit);
            });
            dsrvPlayback.addEventCb('BGMListCreated', this, function (e) {
                onBGMListCreated(e.bgmItemList);
            });
            dsrvPlayback.addEventCb('TrickRestrictModeChanged', this, function (e) {
                onTrickRestrictModeChanged(e.trickMode);
            });
            hx.log('error', 'addEventCb AudioOutputRestrict!!!!!');
            dsrvPlayback.addEventCb('AudioOutputRestrict', this, function (e) {
                onAudioOutputRestrict();
            });
            hx.log('error', 'addEventCb AudioOutputRestrict END!!!!!');
            // dsrvRecordings
            dsrvRecordings.addEventCb('RecordingItemAdded', this, function (e) {
                onRecordingItemAdded(e.item);
            });
            dsrvRecordings.addEventCb('RecordingCompleted', this, function (e) {
                onRecordingCompleted(e.item);
            });
            // dsrvSettingUtil
            dsrvSettingUtil.addEventCb('NetworkAvailableChanged', this, function (networkAvailable) {
                if (!_this.mNetworkAvailable && networkAvailable) {
                ...
                else if (_this.mNetworkAvailable && !networkAvailable) {
                    if (dsrvWebStorage.getAlexaDeviceEnable() === true) {
                        dsrvVA.removeMQTTClient();
                    }
                }
                _this.mNetworkAvailable = networkAvailable;
            });
            dsrvSettingUtil.addEventCb('InternetAvailableChanged', this, function (aInternetAvailable) {
                onInternetAvailableChanged(aInternetAvailable);
            });
            dsrvSettingUtil.addEventCb('ThermalProtectionOccured', this, function (e) {
            ...
            dsrvStorageUtil.addEventCb('PhysicalStorageStatus', this, function (e) {
            ...
            dsrvTsr.addEventCb('PlayPositionChanged', this, function (e) {
                onPlayPositionChanged(e.position, e.buffer);
            });
            dsrvTsr.addEventCb('PlayBufferChanged', this, function (e) {
            ...
            dsrvTsr.addEventCb('TsrPBStarted', this, function (e) {
                onTsrPBStarted();
            });
            dsrvTsr.addEventCb('LiveStopping', this, function (e) {
                onLiveStopping();
            });
            dsrvTsr.addEventCb('ProgrammesChanged', this, function (e) {
                onProgrammesChanged(e.programmes);
            });
            dsrvTsr.addEventCb('ChannelChangeSucceeded', this, function (e) {
                onChannelChangeSucceeded(e.channel);
            });
            dsrvTsr.addEventCb('ChannelChangeError', this, function (e) {
                onChannelChangeError(e.channel, e.errorState);
            });
            dsrvTsr.addEventCb('TrickRestrictModeChanged', this, function (e) {
                onTrickRestrictModeChanged(e.trickMode);
            });
            dsrvTsr.addEventCb('TrickError', this, function (e) {
                onTrickError();
            });
            dsrvSettingUtil.addEventCb('PlaybackOptionChange', this, function (e) {
                onPlaybackOptionChange(e);
            });
            dsrvAppMgr.addEventCb('ApplicationLoadError', this, function (appInfo) {
                onApplicationLoadError(appInfo);
            });
            dsrvAppMgr.addEventCb('ApplicationHide', this, function () {
                hx.svc.SETTING_UTIL.doingKeyGrab(_this.visible());
            });
            dsrvAppMgr.addEventCb('HbbTvAppEnter', this, function () {
            ...
            //    }
            //});
            dsrvAvCtrl.addEventCb('MhegIcsStatus', this, function (bIcsOn) {
                switch (bIcsOn) {
                    case 0:
                        break;
                    case 1:
                        if (_this.mPlayback) {
                            _this.mPlayback.close();
                        }
                        break;
                }
            });
            ...
            // dsrvNetflix
            dsrvNetflix.addEventCb('ChangeCPgLiveController', this, function (e) {
                onChangeCPgLiveController(e);
            });
            dsrvNetflix.addEventCb('ShowNetflixPW', this, function (e) {
                if (!hx.config.useNetflixPW) {
                    return;
                }
            ...
            // dsrvVoiceAssistance
            dsrvVA.addEventCb('SkipChannels', this, function (e) {
                onSkipChannels(e);
            });
            dsrvVA.addEventCb('ChangeChannelByNumber', this, function (e) {
                onChangeChannelByNumber(e);
            });
            dsrvVA.addEventCb('ChangeChannelByName', this, function (e) {
                onChangeChannelByName(e);
            });
            dsrvVA.addEventCb('TurnOn', this, function (e) {
                onTurnOn();
            });
            dsrvVA.addEventCb('TurnOff', this, function (e) {
                onTurnOff();
            });
            dsrvVA.addEventCb('SetMute', this, function (e) {
                onSetMute();
            });
            dsrvVA.addEventCb('Next', this, function (e) {
                onNextMediaPlay();
            });
            dsrvVA.addEventCb('Previous', this, function (e) {
                onPreviousMediaPlay();
            });
            dsrvVA.addEventCb('StartOver', this, function (e) {
                onStartOver();
            });
            ...
            this._doCreateTvOption = function (bMedia) {
                var dsrvSettingUtil = hx.svc.SETTING_UTIL;
                var dsrvWebStorage = hx.svc.WEB_STORAGE;
                var dsrvAvCtrl = hx.svc.AV_CTRL;
                ...
                _this._tvOptionDlg = prism.createSettingDlg(that._mainPage, {
                    timeout: 5000
                });
                ...
                if (bMedia === false) {
                    _this._tvOptionDlg.setTvOptionListItemsByData({
                        avInfo: avInfo,
                ...
                _this._tvOptionDlg.setDrawParam('width', 700);
                _this._tvOptionDlg.setTitleHtml(tr('LOC_SEL_OPTION_VAL_ID'));
                _this._tvOptionDlg.onItemChanged = function (index, settingItem, changedValue) {
                };
                _this._tvOptionDlg.onSettingsItemSelected = function (param, finished) {
                ...
                _this._tvOptionDlg.onOk = function (changedInfoList) {
                ...
                _this._tvOptionDlg.doKeyEscape = function () {
                    return this._tvOptionDlg.doKeyBack();
                }.bind(_this);
                _this._tvOptionDlg.open({
                    transition: {
                        prevLayer: 'moveDown',
                        newLayer: 'moveUp',
                        dontRestore: true
                    ...
                    onClosed: function () {
                        if (_this.mPlayback && _this.mPlayback.resetHidingTimer) {
                            _this.mPlayback.resetHidingTimer();
                        }
                        _this.setKeyHookingControl(_this._tvOptionDlg);
                    }
                });
                _this.setKeyHookingControl(_this._tvOptionDlg);
                return true;
        ...
        cPgMain.prototype._openNotificationDlg = function (aMessage) {
            var _this = this;
        ...
        cPgMain.prototype._doActonPvrPlayKey = function () {
            var bActionPvrPlay = true, bChaseOngoing = false, bIsGetPvrHDD = false;
        ...
        cPgMain.prototype._openNotAvailable = function () {
            this.sendEventToEntity({
                alEvent: 'alMessageToPage',
                target: 'CPgNotAvailable?show'
            });
        };
        cPgMain.prototype._showStatusMsg = function (aMessage) {
            this._hideStatusMsg();
        ...
        cPgMain.prototype._hideStatusMsg = function () {
            if (this._statusMsg !== null) {
                hx.msg.close('status', this._statusMsg);
                this._statusMsg = null;
            }
        };
        cPgMain.prototype._isPlayPossiable = function () {
            var dsrvBridge = hx.svc.BRIDGE;
            var possible = true;
        ...
        cPgMain.prototype._changePage = function (aPageName) {
            var _this = this;
            var that = this;
            var dsrvAppMgr = hx.svc.APP_MGR;
            var dsrvAvCtrl = hx.svc.AV_CTRL;
        ...
        cPgMain.prototype._toggleAudio = function () {
        ...
        cPgMain.prototype._toggleAudioDescription = function () {
        ...
        cPgMain.prototype._toggleSubtitle = function () {
            var dsrvAvCtrl = hx.svc.AV_CTRL;
            var currentTime = new Date().getTime();
            var diff = Math.abs(currentTime - this._lastToggleTime);
            if (diff < 700) {
        ...
        cPgMain.prototype._toggleSubtitleOnOff = function () {
            var dsrvAvCtrl = hx.svc.AV_CTRL;
            var currentTime = new Date().getTime();
            var diff = Math.abs(currentTime - this._lastToggleTime);
            if (diff < 700) {
        ...
        cPgMain.prototype._on_alMessageToPage = function (param) {
            var that = this;
            switch (param.path) {
                case '/hub':
        ...
        cPgMain.prototype._on_alKey = function (e) {
            var _this = this;
            var consumed = false, k = hx.key, kc = e.alKey;
            var CTsrItem = __MODEL__.CTsrItem;
            var dsrvPlayback = hx.svc.PLAYBACK;
            var dsrvRecordings = hx.svc.RECORDINGS;
        ...
        cPgMain.prototype._on_alEndOfRepeatKey = function (e) {
        ...
        cPgMain.prototype.visible = function () {
