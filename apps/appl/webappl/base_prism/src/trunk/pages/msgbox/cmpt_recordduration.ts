...
export class recordDuration extends __COMPONENT_KERNEL__ {
    _p_text: any;
    f_step: string;
    _title: any;
    _text: any;
    ...
    create(aParam) {
        ...
        this.$.append(//
            this._list.append(//
                this._setDurationArrow(this._f_arrow, this._f, this._f_t, this._f_l, this._f_r)) //
        );
        if (this._s_show) {
            this.$.append(//
                this._list.append(//
                    this._setDurationArrow(this._s_arrow, this._s, this._s_t)) //
            );
        }
        this.$.focus(()=> {
            this.setFocus();
    ...
    setListTextArrow(aPosition, aText, aArrow, aTime) {
    ...
    _setDurationArrow(aStatus, _$p, _$text, _$left?, _$right?) {
