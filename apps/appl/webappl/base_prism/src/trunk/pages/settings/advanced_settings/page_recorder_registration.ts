// file name : pages/settings/advanced_settings/recorder_registration.js
/*jslint sloppy:true, nomen:true, vars:true */
///<reference path="../../../def/sugar.d.ts"/>
import __KERNEL_SETTINGS__ = require("pages/settings/kernel_settings");
declare var hx: ifSugar;

class cPgRecorderRegistration extends __KERNEL_SETTINGS__ {
    TMenuList = {
        REGISTRATIONCODE : 0
    };
    ...
    _on_alClicked(aParam): boolean {
        ...
        var tmp: any = null, netConnectedInfo: any = null;
        switch (target) {
    ...
    _tvPortalInitCb (aResult) {
        var that = this, tmp : any;
...
export = cPgRecorderRegistration;