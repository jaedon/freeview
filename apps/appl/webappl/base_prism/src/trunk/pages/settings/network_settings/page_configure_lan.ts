...
class cCPgConfigureLAN extends __KERNEL_SETTINGS__{
    aniConfig : any;
    progressMsg : any;
    $ipAddr : any;
    $pasMulti : any;
    ...
    _isdhcp : boolean = null;
    whereIp : number = 0;
    _confLanMainmenu : any;
    _numdot : any;
    _confLanSubmenu : any;
    _applyBtn : any;
    _$contextMenu : any;
    ...
    create () {
        ...
        this.$menu.ani({
        	...
        	cb : ()=> {
        		this.append(this._confLanMainmenu).append(this._confLanSubmenu).append(this._applyBtn).append(this._numdot._firstNum).append(this._numdot._secondNum).append(this._numdot._thirdNum).append(this._numdot._fourthNum);
    ...
    drawAddress (aRetAddr) {
		var i;
		var type : string = 'DHCP', ipAddr : string = '', netmask : string = '', gateway : string = '', dns1st : string = '', dns2nd : string = '';
		if (aRetAddr) {
    ...
    _on_alClicked (aParam) : boolean {
        var that = this, data : any = aParam.alData, bConsumed : boolean = false, addr : any;
        var i : number;
            	...
            	if (aParam.alData) {
                    ...
                    if (aParam.alData.me === this._confLanSubmenu) {
                    	...
                    	this._$contextMenu.ani({
            				...
            				trans: {dur: 150, delay: 75},
            				cb: ()=> {
            					this._confLanMainmenu.getItem(0).removeClass('his');
