...
define(["require", "exports", "pages/settings/kernel_settings"], function (require, exports, __KERNEL_SETTINGS__) {
    ...
    var cCPgConfigureWiFi = (function (_super) {
        __extends(cCPgConfigureWiFi, _super);
        function cCPgConfigureWiFi() {
            _super.call(this);
        ...
        cCPgConfigureWiFi.prototype.create = function () {
            _super.prototype.create.call(this);
            var that = this;
            var netConnectedInfo;
            $.extend(that, {
                $menu: $('<article>', {
                    'class': 'menu wrap'
                }),
        ...
        cCPgConfigureWiFi.prototype.destroy = function () {
        ...
        cCPgConfigureWiFi.prototype._on_tryConnection = function (aResult) {
            var _this = this;
            if (this.progressMsg) {
                hx.msg.close('progress', this.progressMsg);
                this.progressMsg = null;
        ...
        cCPgConfigureWiFi.prototype._on_eventWifiScanningResult = function (aParam) {
            var apNum, i;
            if (this.apProgressMsg) {
                hx.msg.close('progress', this.apProgressMsg);
                this.apProgressMsg = null;
            ...
            if (aParam.apList.length === 0) {
                ...
                for (i = 0; i < this.apList.length; i += 1) {
                    if (this.apList[i].isConnected === 1) {
        ...
        cCPgConfigureWiFi.prototype._on_wirelessLinkStatus = function (aResult) {
            var conObj;
            var curObj;
            if (this.progressMsg) {
                hx.msg.close('progress', this.progressMsg);
        ...
        cCPgConfigureWiFi.prototype._makeHiddenDlg = function (aParam) {
            var _this = this;
            ...
            this._$setHiddenNetStge.ani({
                ...
                cb: function () {
                    _this.append(_this._securityMenu).append(_this._networkNameInput).append(_this._passwdInput).append(_this._connectBtn).append(_this._cancelBtn);
        ...
        cCPgConfigureWiFi.prototype._on_alClicked = function (aParam) {
            var that = this, data = aParam.alData, bConsumed = false, i = 0;
            var dataList = [];
            var j, len;
            if (data.me === that._backBtn) {
                ...
                if (that.apList[that._currentConn].secure === "true") {
                    that.passwdTmp = hx.msg('passwd', {
                        ...
                        responseText: false,
                        wifi: that.apList[that._currentConn].apname,
                        type: 'password',
                        auto_close: false,
                        dia_class: 'osd',
                        callback_fn: fn,
        ...
        cCPgConfigureWiFi.prototype._on_alKey = function (aParam) {
            var that = this, i, data = aParam.alData, e = aParam.alKey, bConsumed = false;
            switch (e) {
        ...
        cCPgConfigureWiFi.prototype._on_alExit = function (param) {
            var that = this, data = param.alData, bConsumed = false;
            if (data) {
                if (data.me === that._backBtn) {
                    bConsumed = true;
                    that._isChangePageInSetting = true;
        ...
        cCPgConfigureWiFi.prototype._on_alScrollRight = function (aParam) {
        ...
        cCPgConfigureWiFi.prototype._on_alScrollLeft = function (aParam) {
            var data = aParam.alData, target = data.me, bConsumed = false;
            switch (target) {
                case this._connectBtn:
                    bConsumed = true;
        ...
        cCPgConfigureWiFi.prototype._on_alScrollup = function (aParam) {
            var bConsumed = false;
        ...
        cCPgConfigureWiFi.prototype._on_alScrolldown = function (aParam) {
            var bConsumed = false;
        ...
        cCPgConfigureWiFi.prototype._makesubList = function (aApList) {
            var index, subFocusIndex = 0;
            var dataList = aApList;
            //apList;
        ...
        cCPgConfigureWiFi.prototype._makeSecuritySubList = function (aParam) {
            var _this = this;
            var index, subFocusIndex = 0;
            var dataList = [];
