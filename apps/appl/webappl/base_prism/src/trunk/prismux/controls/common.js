...
var setTimeout_w = function (callback, time_sec, time_to_check) {
    ...
    var tick = 0, time_check = typeof time_to_check === 'number' ? time_to_check : 30;
...
(function ($) {
    ...
    $.fn.makeDimm = function (dimmingClass, aPrepend) {
        if (aPrepend === void 0) { aPrepend = false; }
        var target = this;
...
/* create element */
function createElement(aTag, aClass, aParent) {
...
/* showcase */
var TShowcaseGenreIcon;
(function (TShowcaseGenreIcon) {
    TShowcaseGenreIcon[TShowcaseGenreIcon["EFilm"] = 0] = "EFilm"; //0
})(TShowcaseGenreIcon || (TShowcaseGenreIcon = {}));
var TShowcaseIcon;
(function (TShowcaseIcon) {
    TShowcaseIcon[TShowcaseIcon["ERecording"] = 0] = "ERecording";
    TShowcaseIcon[TShowcaseIcon["ESeriesrec"] = 1] = "ESeriesrec";
    TShowcaseIcon[TShowcaseIcon["EReminder"] = 2] = "EReminder";
    TShowcaseIcon[TShowcaseIcon["EPay"] = 3] = "EPay";
    TShowcaseIcon[TShowcaseIcon["ESsound"] = 4] = "ESsound";
    TShowcaseIcon[TShowcaseIcon["EHd"] = 5] = "EHd";
    TShowcaseIcon[TShowcaseIcon["EDolby"] = 6] = "EDolby";
    TShowcaseIcon[TShowcaseIcon["EGuidance"] = 7] = "EGuidance";
    TShowcaseIcon[TShowcaseIcon["ESubtitle"] = 8] = "ESubtitle";
    TShowcaseIcon[TShowcaseIcon["ESigned"] = 9] = "ESigned";
    TShowcaseIcon[TShowcaseIcon["EAd"] = 10] = "EAd";
    TShowcaseIcon[TShowcaseIcon["EThreed"] = 11] = "EThreed";
    TShowcaseIcon[TShowcaseIcon["EHdlinkage"] = 12] = "EHdlinkage";
    TShowcaseIcon[TShowcaseIcon["ESeries"] = 13] = "ESeries";
    TShowcaseIcon[TShowcaseIcon["ESc"] = 14] = "ESc";
    TShowcaseIcon[TShowcaseIcon["EOndemand"] = 15] = "EOndemand";
})(TShowcaseIcon || (TShowcaseIcon = {}));
