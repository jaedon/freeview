...
define(["require", "exports", 'prismux/prism.dlg.playback'], function (require, exports, __PRISM_CPLAYBACKDLG__) {
    ...
    (function (mPrism) {
        ...
        var mMusicOption;
        var CMusicPlaybackDlg = (function (_super) {
            __extends(CMusicPlaybackDlg, _super);
            function CMusicPlaybackDlg(layeredGroupControl) {
                _super.call(this);
                var a = this;
            ...
            CMusicPlaybackDlg.prototype._rearrangeData = function (playMode) {
                var a = this;
            ...
            CMusicPlaybackDlg.prototype.setData = function (items) {
                this._originalItems = items;
                this._items = items;
            };
            CMusicPlaybackDlg.prototype.setStartIndex = function (startIndex) {
                this._selectedIndex = startIndex;
            };
            CMusicPlaybackDlg.prototype.doOpen = function () {
                var a = this;
                var i, length;
                var initialFocus = 1;
                var childControl = [];
            ...
            CMusicPlaybackDlg.prototype.doSetMusicOption = function (aParam) {
                throw "do Implement";
            };
            CMusicPlaybackDlg.prototype.doGetMusicOption = function () {
                throw "do Implement";
                return false;
            };
            CMusicPlaybackDlg.prototype.doKeyStop = function () {
                this.close();
                return true;
            };
            CMusicPlaybackDlg.prototype.doKeyEscape = function () {
                this.close();
                return false;
            };
            CMusicPlaybackDlg.prototype.doHide = function () {
                this.close();
            };
            CMusicPlaybackDlg.prototype.doPlay = function (item) {
                var a = this;
                a._musicPlayer.play(item);
                return false;
            };
            CMusicPlaybackDlg.prototype.doResume = function () {
                var a = this;
                a._musicPlayer.resume();
            };
            CMusicPlaybackDlg.prototype.doPause = function () {
                var a = this;
                a._musicPlayer.pause();
            };
            CMusicPlaybackDlg.prototype.doStop = function () {
                var a = this;
            };
            CMusicPlaybackDlg.prototype.doNext = function () {
                var a = this;
                a._musicPlayer.next();
            };
            CMusicPlaybackDlg.prototype.doPrev = function () {
                var a = this;
                a._musicPlayer.prev();
            };
            CMusicPlaybackDlg.prototype.doFastForward = function () {
                var a = this;
                a._musicSlider.doKeyRight();
                a.play(a._musicSlider.getCurrentItem());
                return true;
            };
            CMusicPlaybackDlg.prototype.doFastRewind = function () {
                var a = this;
                a._musicSlider.doKeyLeft();
                a.play(a._musicSlider.getCurrentItem());
                return true;
            };
            CMusicPlaybackDlg.prototype.setSpeed = function (speed) {
                var a = this;
                a._musicPlayer.setSpeed(speed);
            };
            CMusicPlaybackDlg.prototype.setPosition = function (position) {
                var a = this;
                a._musicPlayer.setStartTime(position);
                a._musicPlayer.setPosition(position);
            };
            CMusicPlaybackDlg.prototype.getPrevPlayItem = function (item) {
                var a = this;
                var finished = false;
                var repeatOption = Number(mMusicOption.repeatOption);
            ...
            CMusicPlaybackDlg.prototype.getNextPlayItem = function (item) {
                var a = this;
                var finished = false;
                var repeatOption = Number(mMusicOption.repeatOption);
                var slider = a._musicSlider;
            ...
            CMusicPlaybackDlg.prototype.audioRestrict = function () {
                var a = this;
                a._musicPlayer.audioRestrict();
            };
            CMusicPlaybackDlg.prototype.updateMusicInfo = function (title, album, artist) {
                var a = this;
                $('.musicSlider .muAnchorItem .title').text(title);
            };
            CMusicPlaybackDlg.prototype.updateAlbumImg = function (path) {
                var a = this;
            ...
            CMusicPlaybackDlg.prototype.isFastPlayAvailable = function () {
                return true;
            };
            return CMusicPlaybackDlg;
        })(__PRISM_CPLAYBACKDLG__.CPlaybackDlg);
        mPrism.CMusicPlaybackDlg = CMusicPlaybackDlg;
        if (!window.prism) {
            window.prism = {};
        }
