...
define(["require", "exports", 'pages/util/controls', 'prismux/prism.dlg'], function (require, exports, __CONTROLS__, __PRISM_CDIALOG__) {
    ...
    (function (mPrism) {
        ...
        var fnDrawCarousel = function (a, param, data, startIndex, textPropertyName, handler) {
            ...
            carousel.setDataDrawer(function (param) {
                ...
                if (!$selectionItem.length) {
                    $selectionItem = $('<div>', { 'class': 'selectionItem' }).append($('<span>', { 'class': 'selectionName' })).appendTo($item);
                }
            ...
            carousel.setAnchorDrawer(function (param) {
                ...
                if (!$selectionAnchorItem.length) {
                    $selectionAnchorItem = $('<div>', { 'class': 'selectionItem' }).append($('<span>', { 'class': 'selectionName' })).appendTo($item);
                }
        ...
        var fnDrawSelectionList = function (a, param) {
            ...
            fnDrawCarousel(a, param, settingItem.config.selectionList, startIndex, 'text', function (param) {
        ...
        var fnDrawChannelList = function (a, param) {
            ...
            fnDrawCarousel(a, param, settingItem.config.channelGroupList, undefined, 'groupName', function (groupSelectedParam) {
                ...
                fnDrawCarousel(a, param, groupSelectedParam.item.channelList, startIndex, ['no', 'name'], function (param) {
                    fnApplyChanged(a, settingItemInfo, settingItem.config.ccid == param.item.ccid, param.item.ccid);
                });
            });
        };
        var fnDrawDateList = function (a, param) {
            ...
            fnDrawCarousel(a, param, dateList, startIndex, 'dateText', function (dateListItem) {
                fnApplyChanged(a, settingItemInfo, fnMatchDate(settingItem.config.date, dateListItem.item.date), dateListItem.item.date);
            });
        };
        ...
        var CSettingDlg = (function (_super) {
            __extends(CSettingDlg, _super);
            function CSettingDlg(layeredGroupControl) {
                _super.call(this, layeredGroupControl);
            }
            CSettingDlg.prototype.init = function (layeredGroupControl) {
                var a = this;
            ...
            CSettingDlg.prototype.destroy = function () {
                var a = this;
                a._timeout = null;
            ...
            CSettingDlg.prototype.setFullPage = function () {
                var a = this;
                a._fullPage = true;
            ...
            CSettingDlg.prototype.setViewPage = function () {
                var a = this;
                a.setFullPage();
                a._$self.addClass('view');
                a._viewPage = true;
            };
            CSettingDlg.prototype.setTitleHtml = function (titleHtml) {
                var a = this;
                if (a._viewPage) {
                    if (!$titleArea) {
                        var $title = $('<div>', {
            ...
            CSettingDlg.prototype.showDateTime = function () {
                var a = this;
                var now = new Date();
            ...
            CSettingDlg.prototype.setDateText = function (text) {
                var a = this;
                a._$date.text(text);
            };
            CSettingDlg.prototype.setTimeText = function (text) {
                var a = this;
                a._$time.text(text);
            };
            CSettingDlg.prototype.setStatusInfoList = function (statusInfoList) {
                var a = this;
                a._statusInfoList = statusInfoList;
            };
            CSettingDlg.prototype.setOnItemSelected = function (fn) {
                var a = this;
                a._onItemSelected = fn;
            };
            CSettingDlg.prototype.setButtonInfoList = function (buttonInfoList) {
                var a = this;
                a._buttonInfoList = buttonInfoList;
            };
            CSettingDlg.prototype.setInfoHtml = function (infoHtml) {
                var a = this;
                if (!a._$infoArea) {
                    var $infoArea = $('<div>', {
                        'class': 'infoArea'
            ...
            CSettingDlg.prototype.setSettingListItems = function (settingListItems) {
                var a = this;
                var i, len;
            ...
            CSettingDlg.prototype.setTvOptionListItemsByData = function (data) {
                var a = this;
            ...
            CSettingDlg.prototype.doOpen = function (param) {
                var a = this;
                var childControl = [];
                var initialFocus = 0;
                ...
                listControl.setDataDrawer(function (param) {
                    ...
                    if ($settingItem.length == 0) {
                        $settingItem = $('<div>', { 'class': 'settingItem' }).append($('<span>', { 'class': 'settingName' })).append($('<span>', { 'class': 'settingValue' }));
            ...
            CSettingDlg.prototype.resetHidingTimer = function () {
                var a = this;
                if (a._timeout) {
            ...
            CSettingDlg.prototype.doKey = function (keyCode) {
                var a = this;
                var consumed = false;
                switch (keyCode) {
            ...
            CSettingDlg.prototype.doKeyRight = function (keyCode) {
                var a = this;
            ...
            CSettingDlg.prototype.doKeyLeft = function (keyCode) {
                var a = this;
                return fnClearSelectionList(a);
            };
            CSettingDlg.prototype.doKeyBack = function (keyCode) {
                var a = this;
            ...
            CSettingDlg.prototype.doKeyRecord = function (keyCode) {
                return true;
            };
            CSettingDlg.prototype.doKeyOption = function (keyCode) {
                var a = this;
                a.close();
                return true;
            };
        ...
        mPrism.CSettingDlg = CSettingDlg;
