...
define(["require", "exports", 'prismux/prism.dlg.playback'], function (require, exports, __PRISM_CPLAYBACKDLG__) {
    ...
    (function (mPrism) {
        ...
        var CVideoPlaybackDlg = (function (_super) {
            __extends(CVideoPlaybackDlg, _super);
            function CVideoPlaybackDlg(layeredGroupControl) {
                _super.call(this);
            ...
            CVideoPlaybackDlg.prototype.setData = function (items) {
                var a = this;
                a._originalItems = items;
                a._items = items;
                a._videoPlayer.setData(items[this._selectedIndex || 0]);
            };
            CVideoPlaybackDlg.prototype.setDuration = function (duration) {
                var a = this;
            ...
            CVideoPlaybackDlg.prototype.getCurrentPosition = function () {
                return this._currentPosition;
            };
            CVideoPlaybackDlg.prototype.setStartIndex = function (startIndex) {
                this._selectedIndex = startIndex;
            };
            CVideoPlaybackDlg.prototype.createPlayer = function (item) {
                var a = this;
                a._item = item;
                a._videoPlayer = prism.createVideoPlayer(item);
            };
            CVideoPlaybackDlg.prototype.doOpen = function () {
                var a = this;
                var i, length;
                var initialFocus = 0;
                var childControl = [];
                ...
                videoPlayer.addEventHandler('SubtitleButtonSelected', videoPlayer, function () {
                    ...
                    var supportedSubtitles = a.doGetSupportedSubtitles();
            ...
            CVideoPlaybackDlg.prototype.isShown = function () {
                var a = this;
                var shown = false;
            ...
            CVideoPlaybackDlg.prototype.doPlay = function (item) {
                var a = this;
                a._videoPlayer.play(item);
                a.resetHidingTimer(TIMEOUT_PLAYBAR_FIRST);
                return false;
            };
            CVideoPlaybackDlg.prototype.doResume = function () {
                var a = this;
                a._videoPlayer.resume();
            };
            CVideoPlaybackDlg.prototype.doPause = function () {
                var a = this;
                a._videoPlayer.pause();
            };
            CVideoPlaybackDlg.prototype.doStop = function () {
                var a = this;
                // a._videoPlayer.stop();
            };
            CVideoPlaybackDlg.prototype.doNext = function () {
                var a = this;
                a._videoPlayer.next();
            };
            CVideoPlaybackDlg.prototype.doPrev = function () {
                var a = this;
                a._videoPlayer.prev();
            };
            CVideoPlaybackDlg.prototype.doSkipForward = function (skipTime, trickRestrictMode) {
                var a = this;
                var duration;
            ...
            CVideoPlaybackDlg.prototype.doSkipRewind = function (skipTime, trickRestrictMode) {
                var a = this;
                var duration;
                if (trickRestrictMode) {
                    if (!a.isSeekAvailable(trickRestrictMode)) {
            ...
            CVideoPlaybackDlg.prototype.moveToCurrentPosition = function () {
                var a = this;
                if (mRequestedSeekPosition) {
                    a.requestSeek(mRequestedSeekPosition);
                }
            };
            CVideoPlaybackDlg.prototype.onKeyUp = function () {
                if (mDelayedAction) {
                    mTryMoving = false;
                    mDelayedAction();
                    mDelayedAction = null;
            ...
            CVideoPlaybackDlg.prototype.doFastForward = function (playSpeedsArray, trickRestrictMode) {
                var a = this;
            ...
            CVideoPlaybackDlg.prototype.doFastRewind = function (playSpeedsArray, trickRestrictMode) {
                var a = this;
                var currentSpeed = a.requestGetSpeed();
                var currentIndex = playSpeedsArray.indexOf(currentSpeed);
                var nextSpeed = playSpeedsArray[currentIndex -= 1];
            ...
            CVideoPlaybackDlg.prototype.setSpeed = function (speed) {
                var a = this;
                a._videoPlayer.setSpeed(speed);
            };
            CVideoPlaybackDlg.prototype.setBuffer = function (buffer) {
                var a = this;
                a._videoPlayer.setBuffer(buffer);
            };
            CVideoPlaybackDlg.prototype.setStartTime = function (startTime) {
                var a = this;
                a._videoPlayer.setStartTime(startTime);
            };
            CVideoPlaybackDlg.prototype.setPosition = function (position) {
                var a = this;
                var movable = false;
            ...
            CVideoPlaybackDlg.prototype.getPrevPlayItem = function (item) {
                var a = this;
                var prevIndex = null;
            ...
            CVideoPlaybackDlg.prototype.getNextPlayItem = function (item) {
                var a = this;
                var nextIndex = null;
            ...
            CVideoPlaybackDlg.prototype.addDivisionPoint = function (programmes) {
                var a = this;
                a._videoPlayer.addDivisionPoint(programmes);
            };
            CVideoPlaybackDlg.prototype.changeToLive = function () {
                this._videoPlayer.changeToLive();
            };
            CVideoPlaybackDlg.prototype.tsrPBStarted = function () {
                this._videoPlayer.tsrPBStarted();
            };
            CVideoPlaybackDlg.prototype.doKeyBack = function () {
                var a = this;
                var shown = a.isShown();
                var consumed = true;
                if (shown) {
            ...
            CVideoPlaybackDlg.prototype.doKeyEscape = function () {
                var a = this;
                var shown = a.isShown();
                var consumed = true;
                if (shown) {
            ...
            CVideoPlaybackDlg.prototype.doKeyStop = function () {
                var a = this;
                a.close();
                this._fireEvent("Hide");
                return true;
            };
            CVideoPlaybackDlg.prototype.doKey = function (keyCode) {
                var a = this;
                a._keyPressed = true;
                var consumed = false;
                if (a.isShown()) {
            ...
            CVideoPlaybackDlg.prototype.doShow = function () {
                var a = this;
                var shown = a.isShown();
                if (!shown) {
                    if (this._videoPlayer instanceof prism.CTsrPlayerControl) {
            ...
            CVideoPlaybackDlg.prototype.doHide = function () {
                var a = this;
                var shown = a.isShown();
                if (shown) {
                    var $layer = a._$self.parent();
            ...
            CVideoPlaybackDlg.prototype.resetHidingTimer = function (aTimeout) {
                var a = this;
            ...
            CVideoPlaybackDlg.prototype.isKeyEnabled = function () {
            ...
            CVideoPlaybackDlg.prototype.isSeekAvailable = function (trickRestrictMode) {
                return ((trickRestrictMode === EDRM_TRICK_NORESTRICT) || (trickRestrictMode === null)) || false;
            };
            CVideoPlaybackDlg.prototype.isTrickAvailable = function (currentSpeed, trickRestrictMode) {
                var bAvailable = true;
            ...
            CVideoPlaybackDlg.prototype.createTrickRestrictMsg = function () {
                var a = this;
            ...
            CVideoPlaybackDlg.prototype.isFastPlayAvailable = function () {
                var a = this;
            ...
            CVideoPlaybackDlg.prototype.createFastPlayRestrictMsg = function () {
                var a = this;
                a.onOpenNotAvailableMsg();
            };
            CVideoPlaybackDlg.prototype.createSeekRestrictMsg = function () {
                var a = this;
            ...
            return CVideoPlaybackDlg;
        })(__PRISM_CPLAYBACKDLG__.CPlaybackDlg);
        mPrism.CVideoPlaybackDlg = CVideoPlaybackDlg;
        if (!window.prism) {
            window.prism = {};
        }
