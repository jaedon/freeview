...
link:
	$(HUMAX_CC) $(HUMAX_GCSECTION) -Wl,--start-group $(sort $(HUMAX_LIB_LIST)) $(HUMAX_LD_LIB_PATH) -L$(AP_STATIC_LIB_DIR) $(APP-LINK-y) -Wl,--end-group -o $(HUMAX_CURMAKE_DIR)/$(HUMAX_APP_NAME)
