...
cd ../platform/sdk/driver/AppLibs/opensource/directfb/bin/DirectFB-1.4.17_multi_debug_build.97344B0/usr/include/directfb
DIRECTFB_DIR=$(pwd)
cd ${BASE_DIR}/device/include
ln -s ${DIRECTFB_DIR} directfb

cd ../platform/sdk/driver/AppLibs/opensource/directfb/build/1.4.17/97344_linuxuser/usr/include
FUSION_DIR=$(pwd)
cd ${BASE_DIR}/device/include
ln -s ${FUSION_DIR} fusion

cd ../platform/sdk/driver/AppLibs/opensource/directfb/bin/DirectFB-1.4.17_multi_debug_build.97344B0/usr/include/sawman
SAWMAN_DIR=$(pwd)
cd ${BASE_DIR}/device/include
