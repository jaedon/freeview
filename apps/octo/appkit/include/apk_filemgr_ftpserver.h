...
#ifndef __APK_FILEMGR_FTPSERVER_H__
#define __APK_FILEMGR_FTPSERVER_H__
...
/********************      Defines         *************************/
/*******************************************************************/
#define APK_FTPS_NAME_LEN		128
#define APK_FTPS_PATH_LEN	 	512
...
typedef enum
{
	eAPK_FILEMGR_FTPS_EVT_SERVER_START = 0,
	eAPK_FILEMGR_FTPS_EVT_SERVER_STOP,
	eAPK_FILEMGR_FTPS_EVT_CONFIG_CHANGE,
	eAPK_FILEMGR_FTPS_EVT_PASSWD_CHANGE,
	eAPK_FILEMGR_FTPS_EVT_PERMISSION_CHANGE,
	eAPK_FILEMGR_FTPS_EVT_STATUS_CHANGE,
	eAPK_FILEMGR_FTPS_EVT_UNKNOWN,
	eAPK_FILEMGR_FTPS_EVT_MAX
} APK_FILEMGR_FTPS_EVT_e;

typedef struct 
{
	HCHAR	szServerName[APK_FTPS_NAME_LEN];
	HINT32	nPort;
} ApkFileMgr_FTPS_CONF_t;

typedef struct 
{
	HINT32 bStarted;
	HINT32 nClientCnt;
	ApkFileMgr_FTPS_CONF_t stConf;
} ApkFileMgr_FTPS_INFO_t;

typedef struct
{
	HCHAR	szName[APK_FTPS_NAME_LEN];
	HCHAR 	szPath[APK_FTPS_PATH_LEN];
	HINT32	nState;
	HBOOL	bWritable;
	HBOOL  	bMounted;
} ApkFileMgr_FTPS_SHARED_t;

typedef	void	(*APK_FILEMGR_FTPSERVER_Notifier_t)(HINT32 eEvent, HINT32 result, void *pvUser);
