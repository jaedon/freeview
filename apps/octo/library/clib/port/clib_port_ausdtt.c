...
/**************************************************************************************************/
#define	CLIB_PORT_AUSDTT_LOGICAL_NUMBER_TV			350
#define	CLIB_PORT_AUSDTT_LOGICAL_NUMBER_RADIO		350
...
/**************************************************************************************************/
HBOOL			CLIB_PORT_FilterInAusDtt(CListAttr_t *pstAttr, DxService_t *pstSvcInfo)
{
...
HINT32			CLIB_PORT_GetServiceNumberAusDtt(CListAttr_t *pstAttr, DxService_t *pstSvcInfo, HINT32 idx)
{
	HINT32	ulLogicalNumber;
	CLibInt_AUSDTT_t	*pstIntInfo;
	...
	{
		pstIntInfo = (CLibInt_AUSDTT_t*)pstAttr->aucData;
		ulLogicalNumber = pstIntInfo->nCurrentLogicalNumber++;
	}
	return ulLogicalNumber;
}

CListAttr_t*		CLIB_PORT_InitSessionAusDtt(HUINT32 ulContentsType, HUINT32 ulOperatorType, HUINT32 ulExt)
{
	CListAttr_t	*pstAttr;
	CLibInt_AUSDTT_t	*pstIntInfo;

	pstAttr = (CListAttr_t*)HLIB_STD_MemCalloc(sizeof(CListAttr_t) + sizeof(CLibInt_AUSDTT_t));
	pstIntInfo = (CLibInt_AUSDTT_t*)pstAttr->aucData;
	if (ulContentsType == CLIB_TYPE_RADIO)
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_AUSDTT_LOGICAL_NUMBER_RADIO;
	}else
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_AUSDTT_LOGICAL_NUMBER_TV;
	}
