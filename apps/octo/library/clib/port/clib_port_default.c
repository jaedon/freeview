...
/**************************************************************************************************/
HBOOL			CLIB_PORT_FilterInDefault(CListAttr_t *pstAttr, DxService_t *pstSvcInfo)
{
...
HINT32			CLIB_PORT_GetServiceNumberDefault(CListAttr_t *pstAttr, DxService_t *pstSvcInfo, HINT32 idx)
{
	HINT32	ulLogicalNumber;
	CLibInt_Default_t	*pstIntInfo;
	...
	{
		pstIntInfo = (CLibInt_Default_t*)pstAttr->aucData;
		ulLogicalNumber = pstIntInfo->nCurrentLogicalNumber++;
	}
	return ulLogicalNumber;
}

CListAttr_t*	CLIB_PORT_InitSessionDefault(HUINT32 ulContentsType, HUINT32 ulOperatorType, HUINT32 ulExt)
{
	CListAttr_t	*pstAttr;
	CLibInt_Default_t	*pstIntInfo;

	pstAttr = (CListAttr_t*)HLIB_STD_MemCalloc(sizeof(CListAttr_t) + sizeof(CLibInt_Default_t));
	pstIntInfo = (CLibInt_Default_t*)pstAttr->aucData;
	pstIntInfo->nCurrentLogicalNumber = 100;
