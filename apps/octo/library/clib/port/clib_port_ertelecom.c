...
/**************************************************************************************************/
HBOOL			CLIB_PORT_FilterInErtelecom(CListAttr_t *pstAttr, DxService_t *pstSvcInfo)
{
...
HINT32			CLIB_PORT_GetServiceNumberErtelecom(CListAttr_t *pstAttr, DxService_t *pstSvcInfo, HINT32 idx)
{
	HINT32	ulLogicalNumber;
	CLibInt_Ertelecom_t	*pstIntInfo;
	...
	{
		pstIntInfo = (CLibInt_Ertelecom_t*)pstAttr->aucData;
		ulLogicalNumber = pstIntInfo->nCurrentLogicalNumber++;
	}
	return ulLogicalNumber;
}

CListAttr_t*		CLIB_PORT_InitSessionErtelecom(HUINT32 ulContentsType, HUINT32 ulOperatorType, HUINT32 ulExt)
{
	CListAttr_t	*pstAttr;
	CLibInt_Ertelecom_t	*pstIntInfo;

	pstAttr = (CListAttr_t*)HLIB_STD_MemCalloc(sizeof(CListAttr_t) + sizeof(CLibInt_Ertelecom_t));
	pstIntInfo = (CLibInt_Ertelecom_t*)pstAttr->aucData;
	if (ulContentsType == CLIB_TYPE_RADIO)
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_ERTELECOM_LOGICAL_NUMBER_RADIO;
	}else
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_ERTELECOM_LOGICAL_NUMBER_TV;
	}
