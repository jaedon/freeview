...
/**************************************************************************************************/
#define	CLIB_PORT_MBC_LOGICAL_NUMBER_TV			1
#define	CLIB_PORT_MBC_LOGICAL_NUMBER_RADIO		1
...
/**************************************************************************************************/
HBOOL			CLIB_PORT_FilterInMBC(CListAttr_t *pstAttr, DxService_t *pstSvcInfo)
{
...
HINT32			CLIB_PORT_GetServiceNumberMBC(CListAttr_t *pstAttr, DxService_t *pstSvcInfo, HINT32 idx)
{
...
CListAttr_t*		CLIB_PORT_InitSessionMBC(HUINT32 ulContentsType, HUINT32 ulOperatorType, HUINT32 ulExt)
{
	CListAttr_t		*pstAttr;
	CLibInt_Mbc_t	*pstIntInfo;

	pstAttr = (CListAttr_t*)HLIB_STD_MemCalloc(sizeof(CListAttr_t) + sizeof(CLibInt_Mbc_t));
	pstIntInfo = (CLibInt_Mbc_t*)pstAttr->aucData;
	
	if (ulContentsType == CLIB_TYPE_RADIO)
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_MBC_LOGICAL_NUMBER_RADIO;
	}else
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_MBC_LOGICAL_NUMBER_TV;
	}
