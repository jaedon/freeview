...
/**************************************************************************************************/
#define	CLIB_PORT_TDC_LOGICAL_NUMBER_TV			1
#define	CLIB_PORT_TDC_LOGICAL_NUMBER_RADIO		1
...
/**************************************************************************************************/
HBOOL			CLIB_PORT_FilterInTDC(CListAttr_t *pstAttr, DxService_t *pstSvcInfo)
{
...
HINT32			CLIB_PORT_GetServiceNumberTDC(CListAttr_t *pstAttr, DxService_t *pstSvcInfo, HINT32 idx)
{
	HINT32	ulLogicalNumber;
//	CLibInt_TDC_t	*pstIntInfo;
...
CListAttr_t*		CLIB_PORT_InitSessionTDC(HUINT32 ulContentsType, HUINT32 ulOperatorType, HUINT32 ulExt)
{
	CListAttr_t	*pstAttr;
	CLibInt_TDC_t	*pstIntInfo;

	pstAttr = (CListAttr_t*)HLIB_STD_MemCalloc(sizeof(CListAttr_t) + sizeof(CLibInt_TDC_t));
	pstIntInfo = (CLibInt_TDC_t*)pstAttr->aucData;
	if (ulContentsType == CLIB_TYPE_RADIO)
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_TDC_LOGICAL_NUMBER_RADIO;
	}else
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_TDC_LOGICAL_NUMBER_TV;
	}
