...
/**************************************************************************************************/
#define	CLIB_PORT_UKDTT_LOGICAL_NUMBER_TV			800
#define	CLIB_PORT_UKDTT_LOGICAL_NUMBER_RADIO		800
...
/**************************************************************************************************/
HBOOL			CLIB_PORT_FilterInUkDtt(CListAttr_t *pstAttr, DxService_t *pstSvcInfo)
{
...
HINT32			CLIB_PORT_GetServiceNumberUkDtt(CListAttr_t *pstAttr, DxService_t *pstSvcInfo, HINT32 idx)
{
	HINT32	ulLogicalNumber;
#if 0

	CLibInt_UKDTT_t	*pstIntInfo;
	...
	{
		pstIntInfo = (CLibInt_UKDTT_t*)pstAttr->aucData;
...
CListAttr_t*		CLIB_PORT_InitSessionUkDtt(HUINT32 ulContentsType, HUINT32 ulOperatorType, HUINT32 ulExt)
{
	CListAttr_t	*pstAttr;
	CLibInt_UKDTT_t	*pstIntInfo;

	pstAttr = (CListAttr_t*)HLIB_STD_MemCalloc(sizeof(CListAttr_t) + sizeof(CLibInt_UKDTT_t));
	pstIntInfo = (CLibInt_UKDTT_t*)pstAttr->aucData;
	if (ulContentsType == CLIB_TYPE_RADIO)
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_UKDTT_LOGICAL_NUMBER_RADIO;
	}else
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_UKDTT_LOGICAL_NUMBER_TV;
	}
