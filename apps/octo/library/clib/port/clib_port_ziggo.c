...
/**************************************************************************************************/
#define	CLIB_PORT_ZIGGO_LOGICAL_NUMBER_TV			1000
#define	CLIB_PORT_ZIGGO_LOGICAL_NUMBER_RADIO		1000
...
/**************************************************************************************************/
HBOOL			CLIB_PORT_FilterInZiggo(CListAttr_t *pstAttr, DxService_t *pstSvcInfo)
{
...
HINT32			CLIB_PORT_GetServiceNumberZiggo(CListAttr_t *pstAttr, DxService_t *pstSvcInfo, HINT32 idx)
{
	HINT32	ulLogicalNumber;
	CLibInt_ZIGGO_t	*pstIntInfo;
	...
	{
		pstIntInfo = (CLibInt_ZIGGO_t*)pstAttr->aucData;
		ulLogicalNumber = pstIntInfo->nCurrentLogicalNumber++;
	}
	return ulLogicalNumber;
}

CListAttr_t*		CLIB_PORT_InitSessionZiggo(HUINT32 ulContentsType, HUINT32 ulOperatorType, HUINT32 ulExt)
{
	CListAttr_t	*pstAttr;
	CLibInt_ZIGGO_t	*pstIntInfo;

	pstAttr = (CListAttr_t*)HLIB_STD_MemCalloc(sizeof(CListAttr_t) + sizeof(CLibInt_ZIGGO_t));
	pstIntInfo = (CLibInt_ZIGGO_t*)pstAttr->aucData;
	if (ulContentsType == CLIB_TYPE_RADIO)
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_ZIGGO_LOGICAL_NUMBER_RADIO;
	}else
	{
		pstIntInfo->nCurrentLogicalNumber = CLIB_PORT_ZIGGO_LOGICAL_NUMBER_TV;
	}
