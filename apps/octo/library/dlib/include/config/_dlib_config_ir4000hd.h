...
#ifndef __DLIB_CONFIG_IR4000HD_H__
#define __DLIB_CONFIG_IR4000HD_H__
...
extern "C" {
	...
	#error ("!!! _dlib_config_ir4000hd.h shall be included only in the dlib_config.h !!!\n");
#endif
...
#endif // __DLIB_CONFIG_IR4000HD_H__
