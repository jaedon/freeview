...
/* *************************************************************************************************** */
HERROR HLIB_CONVERT_ConvertAtoB (HxCnvtEnum32_t *pstEnumCnvtArray, HUINT32 ulArraySize, HUINT32 ulEnumValA, HUINT32 *pulEnumValB)
{
	HUINT32			 ulCnt;

	if ((NULL == pstEnumCnvtArray) || (0 == ulArraySize) || (NULL == pulEnumValB))
	{
		return ERR_FAIL;
	}

	for (ulCnt = 0; ulCnt < ulArraySize; ulCnt++)
	{
		if (pstEnumCnvtArray[ulCnt].ulEnumValA == ulEnumValA)
		{
			*pulEnumValB = pstEnumCnvtArray[ulCnt].ulEnumValB;
			return ERR_OK;
		}
	}
...
HERROR HLIB_CONVERT_ConvertBtoA (HxCnvtEnum32_t *pstEnumCnvtArray, HUINT32 ulArraySize, HUINT32 ulEnumValB, HUINT32 *pulEnumValA)
{
	HUINT32			 ulCnt;

	if ((NULL == pstEnumCnvtArray) || (0 == ulArraySize) || (NULL == pulEnumValA))
	{
		return ERR_FAIL;
	}
	...
	for (ulCnt = 0; ulCnt < ulArraySize; ulCnt++)
	{
		if (pstEnumCnvtArray[ulCnt].ulEnumValB == ulEnumValB)
		{
			*pulEnumValA = pstEnumCnvtArray[ulCnt].ulEnumValA;
			return ERR_OK;
		}
	}
