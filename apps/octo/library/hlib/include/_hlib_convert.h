...
#ifndef	__HLIB_CONVERT_H__
#define	__HLIB_CONVERT_H__
...
/* *************************************************************************************************** */
extern HERROR	HLIB_CONVERT_ConvertAtoB (HxCnvtEnum32_t *pstEnumCnvtArray, HUINT32 ulArraySize, HUINT32 ulEnumValA, HUINT32 *pulEnumValB);
extern HERROR	HLIB_CONVERT_ConvertBtoA (HxCnvtEnum32_t *pstEnumCnvtArray, HUINT32 ulArraySize, HUINT32 ulEnumValB, HUINT32 *pulEnumValA);

/* *************************************************************************************************** */
#define ___DEBUG_FUNCTION_HEADER_________________________________________________________________________
/* *************************************************************************************************** */

#endif //__HLIB_CONVERT_H__
