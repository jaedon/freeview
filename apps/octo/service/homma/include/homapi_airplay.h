...
#ifndef __HOMAPI_AIRPLAY_H__
#define __HOMAPI_AIRPLAY_H__
...
void	HOMAPI_AIRPLAY_RegisterNotifier(HOMAPI_EventCallback pfnEventHandler);
...
#endif //end of __HOMAPI_AIRPLAY_H__
