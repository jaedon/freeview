...
#ifndef __HOMAPI_DMR_H__
#define __HOMAPI_DMR_H__
...
void	HOMAPI_DMR_RegisterNotifier(HOMAPI_EventCallback pfnEventHandler);
void	HOMAPI_DMR_UnRegisterNotifier(void);

HERROR	HOMAPI_DMR_Start(HCHAR *pFriendlyName);
HERROR	HOMAPI_DMR_Stop(void);

HERROR	HOMAPI_DMR_GetDmrDbDefaultFriendlyName(HCHAR* pFriendlyName, HINT32 nLen);
