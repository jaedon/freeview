...
#ifndef __HOMAPI_DMS_H__
#define __HOMAPI_DMS_H__
...
void	HOMAPI_DMS_RegisterNotifier(HOMAPI_EventCallback pfnEventHandler);
...
HERROR		HOMAPI_DMS_GetDmsDbDefaultFriendlyName(HCHAR* pFriendlyName, HINT32 nLen);
