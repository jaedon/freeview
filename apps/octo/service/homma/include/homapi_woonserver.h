...
#ifndef __HOMAPI_WOONSERVER_H__
#define __HOMAPI_WOONSERVER_H__
...
void	HOMAPI_WOONSERVER_RegisterNotifier(HOMAPI_EventCallback pfnEventHandler);
...
#endif //end of __HOM_WOONSERVER_H__
