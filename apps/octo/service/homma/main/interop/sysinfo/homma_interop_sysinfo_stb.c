...
HERROR HOMMA_INTEROP_SYSINFO_STB_Init(void)
{
	return APK_SYSINFO_STB_Init();
}

HERROR HOMMA_INTEROP_SYSINFO_STB_GetManufacturerName(HCHAR *pszManufacturerName, HINT32 nMax)
{
	return APK_SYSINFO_STB_GetManufacturerName(pszManufacturerName, nMax);
}

HERROR HOMMA_INTEROP_SYSINFO_STB_GetModelName(HCHAR *pszModelName, HINT32 nMax)
{
	return APK_SYSINFO_STB_GetModelName(pszModelName, nMax);
}

HERROR HOMMA_INTEROP_SYSINFO_STB_GetSerialNumber(HCHAR *pszSerialNo, HINT32 nMax)
{
	return APK_SYSINFO_STB_GetSerialNumber(pszSerialNo, nMax);
}

HERROR HOMMA_INTEROP_SYSINFO_STB_GetChipId(HCHAR *pszChipId, HINT32 nMax)
{
	return APK_SYSINFO_STB_GetChipId(pszChipId, nMax);
}
...
HERROR HOMMA_INTEROP_SYSINFO_STB_Init(void)
{
	return OAPI_SYSINFO_STB_Init(NULL);
}
