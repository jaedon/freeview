...
#ifndef	__INT_PL_STREAMING_CALLBACK__
#define	__INT_PL_STREAMING_CALLBACK__
...
/* *************************************************************************************************** */
extern 	HOM_Result_e 	PL_Streaming_Callback_Init(void);
extern	void 			PL_Streaming_Callback_DeInit(void);
...
extern	void	HOMMA_CMDRegister_StreamingCallback(const HCHAR *hCmdHandle);

#endif /* __INT_PL_STREAMING_CALLBACK__ */
