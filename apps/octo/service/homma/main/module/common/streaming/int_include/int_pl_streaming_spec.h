...
#ifndef	__INT_PL_STREAMING_MODE_SPEC__
#define	__INT_PL_STREAMING_MODE_SPEC__
...
extern	PLStreaimng_Spec_e 	PL_Streaming_Spec_GetSpec (void);
extern	HINT32 				PL_Streaming_Spec_HLS_GetBufferSize (void);
extern	HINT32 				PL_Streaming_Spec_SATIP_GetBufferSize (void);
extern	HINT32	 			PL_Streaming_Spec_ByPass_GetBufferSize (void);



extern	HOM_Result_e 		PL_Streaming_Spec_Init(PLStreaimng_Spec_e eStreamingUseSpec);
...
#endif /* __INT_PL_STREAMING_MODE_SPEC__ */
