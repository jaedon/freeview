...
#ifndef __OAPI_CAS_IRDETO_H__
#define __OAPI_CAS_IRDETO_H__
...
/********************      Defines         *************************/
/*******************************************************************/
#define RPC_OAPI_CAS_IRDETO_Init							"oapi.cas.irdeto.Init"
#define RPC_OAPI_CAS_IRDETO_SetVirtualSecureCwMode		"oapi.cas.irdeto.SetVirtualSecureCwMode"

#define RPC_OBAMA_CAS_IRDETO_onStatusChanged			"obama.cas.irdeto.onStatusChanged"
...
typedef void (*OxCasIrdeto_Notifier_t)(void);
...
/********************      Functions     ********************/
/*******************************************************************/
HERROR 		OAPI_CAS_IRDETO_Init(OxCasIrdeto_Notifier_t pfListener);
