...
{ /* [WARN] forbid to change a db-saving enum value, [WARN] 절대 ifdef로 추가 하지 말것. 보이면 바로 지울 것임 */
	...
	eSatType_TURKSAT_2A,
	eSatType_VINASAT_1,
	eSatType_HISPASAT_1D,
	eSatType_HISPASAT_1E,
	eSatType_SES_2,
	eSatType_SES_3,
	eSatType_SES_6,
	eSatType_EUTELSAT_5_WEST_A,
	eSatType_EUTELSAT_12_WEST_B,
	eSatType_EUTELSAT_113_WEST_A,
	eSatType_EUTELSAT_117_WEST_A,
	eSatType_EUTELSAT_HOTBIRD_13B,
	eSatType_EUTELSAT_HOTBIRD_13C,
	eSatType_EUTELSAT_HOTBIRD_13D,
	eSatType_INTELSAT_1R,
	eSatType_INTELSAT_11,
	eSatType_INTELSAT_14,
	eSatType_INTELSAT_21,
	eSatType_INTELSAT_23,
	eSatType_INTELSAT_34,
	eSatType_INTELSAT_903,
	eSatType_GALAXY_18,
	eSatType_GALAXY_19,
	eSatType_GALAXY_28,
	eSatType_SPACEWAY_1_AND_DIRECTV_10_02,
	eSatType_AMAZONAS_2,
	eSatType_AMAZONAS_3,
	eSatType_AMC_6,
	eSatType_AMC_8,
	...
	eSatType_AMC_18,
	eSatType_AMC_21,
	eSatType_BSAT_3C_JCSAT_110R,
	eSatType_N_SAT_110,
	eSatType_TELSTAR_12_VANTAGE,
	eSatType_TELSTAR_14R,
	eSatType_ST_2,
	eSatType_SIMON_BOLIVAR,
	eSatType_STAR_ONE_C1,
	eSatType_STAR_ONE_C2,
	eSatType_STAR_ONE_C4,
	eSatType_NSS_10,
...
//	eDEFAULTLCN_RAY_NORMAL				= 1,	// Humax의 Ray UI에서 사용하는 가본 정책
	...
	eDEFAULTLCN_ITADTT					= 21,	// Italy DTT
	eDEFAULTLCN_MAX
} DefaultLcnPolicy_t;
...
typedef struct
{
	...
	HBOOL		bRoundOff;        /* only for Netflix; For getting uppper rounded_ratio_calculation */
	HBOOL		bForceSourceBase; /* only for Netflix; For handling videoResize() under DASH with various source-change */
} PIG_Rect_t;
...
#define	ISO_VIDEO_5				0x24	/** < H265/HEVC video coding */
...
/** format_identifier in Registration descriptor */
#define ISO_REGD_FORMAT_VIDEO_HEVC	0x48455643	/* HEVC */
...
typedef enum
{
	eEsStreamContent_None			= 0x00,
	eEsStreamContent_MPEG2_Video	= 0x01,
	eEsStreamContent_MPEG1_Audio	= 0x02,
	eEsStreamContent_Subtitle		= 0x03,
	eEsStreamContent_AC3_Audio		= 0x04,
	eEsStreamContent_H264_Video		= 0x05,
	eEsStreamContent_Reserved		= 0x06,
	eEsStreamContent_DTS_Audio		= 0x07
} EsStreamContent_t;
...
typedef enum
{
	...
	eVERSION_TYPE_UPGRADER
#if defined(CONFIG_OTA_USE_PKG_VERSION)
	,eVERSION_TYPE_APPL_UI,	// For System Information UI
	eVERSION_TYPE_PACKAGE
#endif
} VersionType_t;
...
typedef enum {
	CRID_TYPE_PROG			= DxCRID_TYPE_PROG,
	CRID_TYPE_SERIES		= DxCRID_TYPE_SERIES,
	CRID_TYPE_RECOMMEND		= DxCRID_TYPE_RECOMMEND,
	CRID_TYPE_ALL			= DxCRID_TYPE_ALL
} CRID_TYPE;
