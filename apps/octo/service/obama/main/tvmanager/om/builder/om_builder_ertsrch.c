...
HERROR om_builder_ertsrch_StartSearch (HUINT32 ulBuilderId)
{
	...
	if (BUS_MGR_Create(NULL, APP_ACTION_PRIORITY, pstContext->pfnSearchProc, hAction, (HINT32)&pstContext->stSearchOption, (HINT32)pstContext->stOption.eOptionType, 0) == ERR_OK)
	{
...
HERROR om_builder_ertsrch_StopSearch (HUINT32 ulBuilderId)
{
	omBldContext_t		*pstContext = om_builder_GetContextByBuilderId (ulBuilderId);
...
BUS_Result_t om_builder_ertsrch_MsgSearchStatusChanged (Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3)
{
...
BUS_Result_t om_builder_ertsrch_MsgSearchFinished (Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3)
{
	HUINT32					ulActionId = SVC_PIPE_GetActionId(hAction);
	omBldContext_t			*pstContext;
	BUS_Result_t			eResult = MESSAGE_PASS;
