...
HINT32 proc_om_media_play_mediapb_Proto (void *pstContext, HINT32 message, Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
	return 0;
}
...
HERROR om_media_play_mediapb_InitAction(void *pstContext)
{
	return ERR_OK;
}

HERROR om_media_play_mediapb_cso_prepareSession(HCHAR* pszUri, HCHAR* pSaveFilePath, void *pMediaInfo)
{
	return ERR_OK;
}
