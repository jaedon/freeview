...
HERROR PAL_CH_SAT_GetTunerCapacity (HUINT32 ulTunerGroupId, PalCh_SatTunerCapacity_t *pstSatTunerCap)
{
	...
	{
		return PAL_CH_EMU_GetSatTunerCapacity(ulTunerGroupId, pstSatTunerCap);
	}
#endif
						...
						)
{
	...
	if (PAL_CH_EMU_CheckIpTuneReady() == TRUE)
	{
		return PAL_CH_EMU_StartTune(DI_CH_TYPE_SAT, ulTunerGroupId, ulRequestId, (void *)&stDiParam);
	}
#endif
...
HERROR PAL_CH_SAT_StopTune(HUINT32 ulTunerGroupId)
{
	...
	if (PAL_CH_EMU_CheckIpTuneReady() == TRUE)
	{
		(void)PAL_CH_EMU_StopTune(DI_CH_TYPE_SAT, ulTunerGroupId);
		return ERR_OK;
	}
#endif
								...
								)
{
	...
	if (PAL_CH_EMU_CheckIpTuneReady() == TRUE)
	{
		return PAL_CH_EMU_GetLockedInfoSat(ulTunerGroupId, ulTpFreq, ulLnbFreq, pulActualTpFreq, pActualPolar, pActualCodeRate, pActualPskMod, pActualPilot);
	}
#endif
						...
						)
{
	...
	pstDiParam = (CH_SAT_TuneParam_t *)OxMW_Malloc (sizeof(CH_SAT_TuneParam_t));
	if (pstDiParam == NULL)
	{
		return ERR_FAIL;
	}
...
HUINT32 PAL_CH_SAT_CountRfInput (void)
{
	...
	if (PAL_CH_EMU_CheckIpTuneReady() == TRUE)
	{
		return PAL_CH_EMU_CountSatRfInput();
	}
#endif
...
HERROR PAL_CH_SAT_GetRfInput (HUINT32 ulRfInputIdx, PalCh_SatRfInput_t *pstRfInput)
{
	...
	if (PAL_CH_EMU_CheckIpTuneReady() == TRUE)
	{
		return PAL_CH_EMU_GetSatRfInput(ulRfInputIdx, pstRfInput);
	}
#endif
...
HERROR PAL_CH_SAT_SetRfInputConnection (HUINT32 ulTunerGroupId, HUINT32 ulRfInputId)
{
	...
	if (PAL_CH_EMU_CheckIpTuneReady() == TRUE)
	{
		return PAL_CH_EMU_SetSatRfInputConnection(ulTunerGroupId, ulRfInputId);
	}
#endif
...
HERROR PAL_CH_SAT_ResetRfInputConnection (HUINT32 ulTunerGroupId)
{
	...
	if (PAL_CH_EMU_CheckIpTuneReady() == TRUE)
	{
		return PAL_CH_EMU_ResetSatRfInputConnection(ulTunerGroupId);
	}
#endif
