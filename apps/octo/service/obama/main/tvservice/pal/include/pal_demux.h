...
typedef struct
{
	...
	HBOOL					bFccMainPcrFilter;
	HBOOL					bFccMainVideoFilter;
	HBOOL					bFccMainAudioFilter;
#endif
...
extern HERROR				PAL_DMX_Init(void);
extern HERROR				PAL_DMX_SetPath(HUINT32 ulDemuxId, PalDmx_Input_e eInType, HUINT32 ulInDvcId, PalDmx_Output_e eOutType, HUINT32 ulGroupId);
extern HERROR				PAL_DMX_ReleasePath(HUINT32 ulDemuxId);
extern HERROR				PAL_DMX_StartAVPid(HUINT32 ulDemuxId, PalDmx_PidInfo_t *pstPidInfo, HBOOL bMainAV);
extern HERROR				PAL_DMX_ChangeAVPid(HUINT32 ulDemuxId, PalDmx_PidInfo_t *pstPidInfo);
extern HERROR				PAL_DMX_StopAllAVPid(HUINT32 ulDemuxId);
extern PalDmx_PidInfo_t*	PAL_DMX_GetAVPidStatus(HUINT32 ulDemuxId);

/* TSC Monitoring */
extern HERROR				PAL_DMX_CheckScrambleBitByPid(HUINT32 ulDemuxId, PalDmx_TsState_e *peState);
extern HBOOL				PAL_DMX_IsSupportScrambleBitChecking(HUINT32 ulDemuxId);

extern HERROR				PAL_DMX_GetPlayBackId(HUINT32 unDmxId, HUINT32 *punPlayBackId);

#if defined(CONFIG_SUPPORT_FCC)
extern HERROR				PAL_DMX_StartAVPrimerPid(HUINT32 ulDemuxId, PalDmx_PidInfo_t *pstPidInfo, HBOOL bMainAV, HUINT32 ulPrimerIdx);
extern HERROR				PAL_DMX_StopAllAVPrimerPid(HUINT32 ulDemuxId, HUINT32 ulPrimerIdx);
extern HERROR				PAL_DMX_ChangePrimerAVPid(HUINT32 ulDemuxId, PalDmx_PidInfo_t *pstPidInfo, HUINT32 ulPrimerIdx);
#endif
