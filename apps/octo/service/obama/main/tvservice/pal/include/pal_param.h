...
typedef enum
{
	...
	ePAL_PARAM_LAUNCH_APP_MODE,			// eSOURCE_NVRAM,	DI_NVRAM_FIELD_DISPLAY_FACTORY_INFO,		ePAL_PARAM_TYPE_INT,	sizeof(HINT32),							<=,										N/A
	...
	ePAL_PARAM_HW_REVISION,				// eSOURCE_SYS,		DI_SYS_HW_REVISION,						ePAL_PARAM_TYPE_INT,	sizeof(HUINT32),						<=,										N/A
	...
	ePAL_PARAM_SYSTEM_PACKAGE_VERSION,			// eSOURCE_NVRAM,	(HUINT32)SYSTEM_PACKAGE_VERSION,					ePAL_PARAM_TYPE_STR,	strlen(SYSTEM_PACKAGE_VERSION),				<=,										N/A
#endif
#if defined(CONFIG_NETFLIX_APP)	
	ePAL_PARAM_NETFLIX_ESN,                 // eSOURCE_NVRAM,	DI_NVRAM_FIELD_NETFLIX_ESN,				ePAL_PARAM_TYPE_STR,	sizeof(HUINT8)*64,		<=,										N/A
#endif
