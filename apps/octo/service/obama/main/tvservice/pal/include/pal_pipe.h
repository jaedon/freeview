...
typedef void (*PalPipe_NotifyCb_t)(HUINT32 ulActionId, void *pvUserData, HUINT32 ulDataSize);
...
extern HERROR			PAL_PIPE_SetTunerResource (HUINT32 ulDemuxId, PalPipe_Input_e eType, HUINT32 ulRscId);
...
extern HBOOL			PAL_PIPE_IsPipeConnected (HUINT32 ulActionId);
extern HERROR			PAL_PIPE_NotifyPipeConnected (HUINT32 ulActionId, PalPipe_NotifyCb_t pfCallback, void *pvUserData, HUINT32 ulUserDataSize);
