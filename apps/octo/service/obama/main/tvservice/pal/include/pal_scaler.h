...
extern HERROR PAL_SCALER_GetOsdDisplayPoint(HUINT32	ulRefWidth,
							HUINT32			ulRefHeight,
							HINT32			nX,
							HINT32			nY,
							HINT32			*pnScaledX,
...
extern HERROR PAL_SCALER_SetSupportVideoFrame(HBOOL	bEnable);

extern HERROR PAL_SCALER_SetCompositorOsdOutput(HBOOL bShow);
