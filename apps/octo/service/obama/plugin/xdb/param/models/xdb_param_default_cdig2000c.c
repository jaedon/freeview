/**
	@file     db_param_default_cdig2000c.c
	@brief    CDIG-2000C project default data

	Description: default db 생성을 위한 default value 모음 (for CONFIG_PROD_CDIG2000C)
	Module: DB/default \n
	Remarks : 										\n
...
STATIC const dbParam_DefaultItem_t	s_astHardCodingSystemItemList_CDIG2000C[] =
{
	{ eDB_PARAM_ITEM_OPERATOR_TYPE,						{ eDxOPERATOR_Telenor,		"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_MAIN,							{ eLangID_Swedish,			"", 0, 0 } },
//	{ eDB_PARAM_ITEM_LANG_EVENT,						{ eLangID_English,			"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_AUDIO0,						{ eLangID_Swedish,			"", 0, 0 } },
	...
	{ eDB_PARAM_ITEM_LANG_SUBTITLE0,					{ eLangID_Swedish,			"", 0, 0 } },
	...
	{ eDB_PARAM_ITEM_LANG_SUBTITLE_DEFAULT,				{ eLangID_Swedish,			"", 0, 0 } },
	...
	{ eDB_PARAM_ITEM_COUNTRY_ID,						{ eCountryID_SWE,			"", 0, 0 } },		// country code는 Germany로 변경
...
//	no one get value from SEARCH_ACN
	...
	/* Favorite Channel List Numbering Mode */
	{ eDB_PARAM_ITEM_FAV_CHNUM_ORDER,					{ TRUE,						"", 0, 0 } },
};

HINT32 xdb_default_GetSystemConfigItemNum_CDIG2000C(void)
{
	return sizeof(s_astHardCodingSystemItemList_CDIG2000C) / sizeof(dbParam_DefaultItem_t);
}

dbParam_DefaultItem_t	*xdb_default_GetSystemConfigItem_CDIG2000C(HUINT32 ulItemIdx)
{
	if (xdb_default_GetSystemConfigItemNum_CDIG2000C() <= ulItemIdx)
		return NULL;

	return (dbParam_DefaultItem_t*)&s_astHardCodingSystemItemList_CDIG2000C[ulItemIdx];
}
