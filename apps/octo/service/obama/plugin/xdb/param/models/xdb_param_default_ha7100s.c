/**
	@file     db_param_default_ha7100s.c
	@brief
...
STATIC  const dbParam_DefaultItem_t	s_astHardCodingSystemItemList_Ha7100s[] =
{
	{ eDB_PARAM_ITEM_OPERATOR_TYPE,					{ eDxOPERATOR_AMX,			"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_MAIN,						{ eLangID_Spanish,			"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_EVENT,					{ eLangID_Spanish,			"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_AUDIO0,					{ eLangID_Spanish,			"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_AUDIO1,					{ eLangID_Spanish,			"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_AUDIO_UNDEFINED,			{ eLangID_Undefined,		"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_AUDIO_ORIGINAL,			{ eLangID_OriginalAudio,	"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_AUDIO_DEFAULT,			{ eLangID_Spanish,			"", 0, 0 } },
	...
	{ eDB_PARAM_ITEM_LANG_SUBTITLE_DEFAULT, 		{ eLangID_Spanish,			"", 0, 0 } },
	...
	{ eDB_PARAM_ITEM_HDMI_AUDIO_FORMAT,				{ 0,						DxSTR_STEREO_SELECT_STEREO, 0, 0 } },
	...
	{ eDB_PARAM_ITEM_LIPSYNC_DELAY, 				{ 0,						"", 0, 0 } },

	{ eDB_PARAM_ITEM_SKIPFORWARDSEC,				{ 0,						"", 0, 0 } },
	{ eDB_PARAM_ITEM_INSTANTREPLAYSEC,				{ 0,						"", 0, 0 } },
	{ eDB_PARAM_ITEM_COUNTRY_ID,					{ eCountryID_GTM,			"", 0, 0 } },		// country code는 Germany로 변경
	...
	{ eDB_PARAM_ITEM_CHANNEL_SETUP_PIN,				{ TRUE,					"", 0, 0 } },
	{ eDB_PARAM_ITEM_GUIDANCE_POLICY, 				{ eDxGUIDANCEPOLICY_OFF,	"", 0, 0 } },
	{ eDB_PARAM_ITEM_SUBTITLE_SETTING,				{ FALSE,					"", 0, 0 } },
	{ eDB_PARAM_ITEM_HDMI_CEC_ENABLE, 				{ FALSE,					"", 0, 0 } },
	{ eDB_PARAM_ITEM_HDMI_CEC_VOLUME_ENABLE,		{ FALSE,					"", 0, 0 } },
	...
	{ eDB_PARAM_ITEM_GMT_OFFSET_MINUTES,			{ -360, 					"", 0, 0 } },
	{ eDB_PARAM_ITEM_TIME_REGION_ID,				{ 0,						"", 0, 0 } },
...
//	no one get value from SEARCH_ACN
	...
	{ eDB_PARAM_ITEM_DESCRAMBLEONOFF,				{ TRUE, 					"", 0, 0 } },
...
HINT32 xdb_default_GetSystemConfigItemNum_Ha7100s(void)
{
	return sizeof(s_astHardCodingSystemItemList_Ha7100s) / sizeof(dbParam_DefaultItem_t);
}

dbParam_DefaultItem_t	*xdb_default_GetSystemConfigItem_Ha7100s(HUINT32 ulItemIdx)
{
	if (xdb_default_GetSystemConfigItemNum_Ha7100s() <= ulItemIdx)
		return NULL;

	return (dbParam_DefaultItem_t*) &s_astHardCodingSystemItemList_Ha7100s[ulItemIdx];
}
