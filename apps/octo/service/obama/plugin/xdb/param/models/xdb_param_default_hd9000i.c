/**
	@file     db_param_default_hd9000i.c
	@brief    hd9000i project default data

	Description: default db 생성을 위한 default value 모음 (for CONFIG_PROD_HD9000I)
	Module: DB/default \n
	Remarks : 										\n
...
STATIC const dbParam_DefaultItem_t	s_astHardCodingSystemItemList_HD9000i[] =
{
	{ eDB_PARAM_ITEM_OPERATOR_TYPE,						{ eDxOPERATOR_ERtelecom,	"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_MAIN,							{ eLangID_Russian,			"", 0, 0 } },
//	{ eDB_PARAM_ITEM_LANG_EVENT,						{ eLangID_English,			"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_AUDIO0,						{ eLangID_Russian,			"", 0, 0 } },
	...
	{ eDB_PARAM_ITEM_COUNTRY_ID,						{ eCountryID_RUS,			"", 0, 0 } },		// country code는 Germany로 변경
...
HINT32 xdb_default_GetSystemConfigItemNum_HD9000i(void)
{
	return sizeof(s_astHardCodingSystemItemList_HD9000i) / sizeof(dbParam_DefaultItem_t);
}

dbParam_DefaultItem_t	*xdb_default_GetSystemConfigItem_HD9000i(HUINT32 ulItemIdx)
{
	if (xdb_default_GetSystemConfigItemNum_HD9000i() <= ulItemIdx)
		return NULL;

	return (dbParam_DefaultItem_t*)&s_astHardCodingSystemItemList_HD9000i[ulItemIdx];
}
