/**
	@file     xdb_param_default_hdneo.c
	@brief
...
STATIC const dbParam_DefaultItem_t	s_astHardCodingSystemItemList_Hdneo[] =
{
...
HINT32 xdb_default_GetSystemConfigItemNum_Hdneo(void)
{
	return sizeof(s_astHardCodingSystemItemList_Hdneo) / sizeof(dbParam_DefaultItem_t);
}

dbParam_DefaultItem_t	*xdb_default_GetSystemConfigItem_Hdneo(HUINT32 ulItemIdx)
{
	if (xdb_default_GetSystemConfigItemNum_Hdneo() <= ulItemIdx)
		return NULL;

	return (dbParam_DefaultItem_t *)&s_astHardCodingSystemItemList_Hdneo[ulItemIdx];
}
...
HERROR xdb_param_GetKeepingConfigItem_Hdneo(dbParam_KeepingItem_t **pastItem, HINT32 *pnItemNum)
{
...
HERROR xdb_param_FreeKeepingConfigItem_Hdneo(dbParam_KeepingItem_t *astItem, HINT32 nItemNum)
{
	return xdb_param_KeepingItemFree(astItem, nItemNum);
}

HBOOL xdb_param_FindKeepingConfigItem_Hdneo(DbParam_Item_e eItem)
{
#if defined(CONFIG_MW_SATRECORD)
