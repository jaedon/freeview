...
STATIC const dbParam_DefaultItem_t	s_astHardCodingSystemItemList_Hgs1000s[] =
{
	...
	{ eDB_PARAM_ITEM_RESOLUTION_SELECT,				{ 0,						DxSTR_RESOLUTION_SELECT_EDID_MAX, 0, 0 } },
...
//	{ eDB_PARAM_ITEM_SEARCH_ACN,					{ eWord_Disable,			"", 0, 0 } },
	...
	/* live streaming */
	{ eDB_PARAM_ITEM_LIVESTREAM_PRIORITY,			{ eDxLsPriority_BELOW_VIEW, "", 0, 0 } },

};

HINT32 xdb_default_GetSystemConfigItemNum_Hgs1000s(void)
{
	return sizeof(s_astHardCodingSystemItemList_Hgs1000s) / sizeof(dbParam_DefaultItem_t);
}

dbParam_DefaultItem_t	*xdb_default_GetSystemConfigItem_Hgs1000s(HUINT32 ulItemIdx)
{
	if (xdb_default_GetSystemConfigItemNum_Hgs1000s() <= ulItemIdx)
		return NULL;

	return (dbParam_DefaultItem_t *)&s_astHardCodingSystemItemList_Hgs1000s[ulItemIdx];
}
...
HERROR xdb_param_GetKeepingConfigItem_Hgs1000s(dbParam_KeepingItem_t **pastItem, HINT32 *pnItemNum)
{
...
HERROR xdb_param_FreeKeepingConfigItem_Hgs1000s(dbParam_KeepingItem_t *astItem, HINT32 nItemNum)
{
	return xdb_param_KeepingItemFree(astItem, nItemNum);
}

HBOOL xdb_param_FindKeepingConfigItem_Hgs1000s(DbParam_Item_e eItem)
{
#if defined(CONFIG_MW_SATRECORD)
