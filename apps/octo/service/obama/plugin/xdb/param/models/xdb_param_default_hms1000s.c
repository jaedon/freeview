/**
	@file     db_param_default_hms1000s.c
	@brief
...
STATIC  const dbParam_DefaultItem_t	s_astHardCodingSystemItemList_Hms1000s[] =
{
...
HINT32 xdb_default_GetSystemConfigItemNum_Hms1000s(void)
{
	return sizeof(s_astHardCodingSystemItemList_Hms1000s) / sizeof(dbParam_DefaultItem_t);
}

dbParam_DefaultItem_t	*xdb_default_GetSystemConfigItem_Hms1000s(HUINT32 ulItemIdx)
{
	if (xdb_default_GetSystemConfigItemNum_Hms1000s() <= ulItemIdx)
		return NULL;

	return (dbParam_DefaultItem_t*) &s_astHardCodingSystemItemList_Hms1000s[ulItemIdx];
}
