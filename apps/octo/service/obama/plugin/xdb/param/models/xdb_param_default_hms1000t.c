...
STATIC const dbParam_DefaultItem_t	s_astHardCodingSystemItemList_Hms1000t[] =
{
	...
	{ eDB_PARAM_ITEM_COUNTRY_ID,					{ eCountryID_AUS,			"", 0, 0 } },
	...
	{ eDB_PARAM_ITEM_GMT_OFFSET_MINUTES,			{ 600,						{0, }, 0, 0 } },	// 호주 +8, +9.5, +10
	{ eDB_PARAM_ITEM_TIME_REGION_ID,				{ 2,						{0, }, 0, 0 } },	//## 7500t에서는 default 2 (NSW/ACT 시드니?)
...
//	{ eDB_PARAM_ITEM_SAT_NETWORK_SRCH,				{ 1,						"", 0, 0 } },
	...
	{ eDB_PARAM_ITEM_TER_SRCH_BANDWIDTH,			{ eDxTER_BANDWIDTH_7M, "", 0, 0 } },				// 7MHz
...
HINT32 xdb_default_GetSystemConfigItemNum_Hms1000t(void)
{
	return sizeof(s_astHardCodingSystemItemList_Hms1000t) / sizeof(dbParam_DefaultItem_t);
}

dbParam_DefaultItem_t	*xdb_default_GetSystemConfigItem_Hms1000t(HUINT32 ulItemIdx)
{
	if (xdb_default_GetSystemConfigItemNum_Hms1000t() <= ulItemIdx)
		return NULL;

	return (dbParam_DefaultItem_t*)&s_astHardCodingSystemItemList_Hms1000t[ulItemIdx];
}
