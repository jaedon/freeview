/**
	@file     xdb_param_default_Hmx4kbbc.c
	@brief    Hmx4kbbc project default data

	Description: default db 생성을 위한 default value 모음 (for CONFIG_PROD_IR4000HD)
	Module: DB/default \n
	Remarks : 										\n
...
STATIC const dbParam_DefaultItem_t	s_astHardCodingSystemItemList_Hmx4kbbc[] =
{
	{ eDB_PARAM_ITEM_OPERATOR_TYPE,						{ eDxOPERATOR_MiddleEast,	"", 0, 0 } },
	...
	{ eDB_PARAM_ITEM_RESOLUTION_SELECT,					{ 0,						DxSTR_RESOLUTION_SELECT_2160P, 0, 0 } },
...
//	no one get value from SEARCH_ACN
	...
	{ eDB_PARAM_ITEM_ANTENNA_POWER,						{ 0,						"", 0, 0 } },
...
HINT32 xdb_default_GetSystemConfigItemNum_Hmx4kbbc(void)
{
	return sizeof(s_astHardCodingSystemItemList_Hmx4kbbc) / sizeof(dbParam_DefaultItem_t);
}

dbParam_DefaultItem_t *xdb_default_GetSystemConfigItem_Hmx4kbbc(HUINT32 ulItemIdx)
{
	if (xdb_default_GetSystemConfigItemNum_Hmx4kbbc() <= ulItemIdx)
		return NULL;

	return (dbParam_DefaultItem_t *)&s_astHardCodingSystemItemList_Hmx4kbbc[ulItemIdx];
}
...
HERROR xdb_param_GetKeepingConfigItem_Hmx4kbbc(dbParam_KeepingItem_t **pastItem, HINT32 *pnItemNum)
{
#if KEEPING_ITEM_TEST
...
HERROR xdb_param_FreeKeepingConfigItem_Hmx4kbbc(dbParam_KeepingItem_t *astItem, HINT32 nItemNum)
{
	return xdb_param_KeepingItemFree(astItem, nItemNum);
}

HBOOL xdb_param_FindKeepingConfigItem_Hmx4kbbc(DbParam_Item_e eItem)
{
#if KEEPING_ITEM_TEST
