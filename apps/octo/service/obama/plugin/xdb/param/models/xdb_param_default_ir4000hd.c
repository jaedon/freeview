/**
	@file     xdb_param_default_ir4000hd.c
...
STATIC const dbParam_DefaultItem_t	s_astHardCodingSystemItemList_Ir4000hd[] =
{
...
//	no one get value from SEARCH_ACN
	...
	{ eDB_PARAM_ITEM_BATUPDATEONOFF,					{ FALSE,					"", 0, 0 } },	/* on/off */
	{ eDB_PARAM_ITEM_NITLCNUPDATEONOFF,					{ FALSE,					"", 0, 0 } },	/* on/off */
};

HINT32 xdb_default_GetSystemConfigItemNum_Ir4000hd(void)
{
	return sizeof(s_astHardCodingSystemItemList_Ir4000hd) / sizeof(dbParam_DefaultItem_t);
}

dbParam_DefaultItem_t *xdb_default_GetSystemConfigItem_Ir4000hd(HUINT32 ulItemIdx)
{
	if (xdb_default_GetSystemConfigItemNum_Ir4000hd() <= ulItemIdx)
		return NULL;

	return (dbParam_DefaultItem_t *)&s_astHardCodingSystemItemList_Ir4000hd[ulItemIdx];
}
...
HERROR xdb_param_GetKeepingConfigItem_Ir4000hd(dbParam_KeepingItem_t **pastItem, HINT32 *pnItemNum)
{
#if KEEPING_ITEM_TEST
...
HERROR xdb_param_FreeKeepingConfigItem_Ir4000hd(dbParam_KeepingItem_t *astItem, HINT32 nItemNum)
{
	return xdb_param_KeepingItemFree(astItem, nItemNum);
}

HBOOL xdb_param_FindKeepingConfigItem_Ir4000hd(DbParam_Item_e eItem)
{
#if KEEPING_ITEM_TEST
