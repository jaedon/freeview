...
STATIC  const dbParam_DefaultItem_t	s_astHardCodingSystemItemList_M1[] =
{
	{ eDB_PARAM_ITEM_OPERATOR_TYPE,					{ eDxOPERATOR_MBC,			"", 0, 0 } },
...
HINT32 xdb_default_GetSystemConfigItemNum_M1(void)
{
	return sizeof(s_astHardCodingSystemItemList_M1) / sizeof(dbParam_DefaultItem_t);
}

dbParam_DefaultItem_t	*xdb_default_GetSystemConfigItem_M1(HUINT32 ulItemIdx)
{
	if (xdb_default_GetSystemConfigItemNum_M1() <= ulItemIdx)
		return NULL;

	return (dbParam_DefaultItem_t*) &s_astHardCodingSystemItemList_M1[ulItemIdx];
}
