/**
	@file     db_param_default_ysr2000.c
	@brief    YSR2000 project default data

	Description: default db 생성을 위한 default value 모음 (for CONFIG_PROD_YSR2000)
	Module: DB/default \n
	Remarks : 										\n
...
STATIC const dbParam_DefaultItem_t	s_astHardCodingSystemItemList_YSR2000[] =
{
	{ eDB_PARAM_ITEM_OPERATOR_TYPE,						{ eDxOPERATOR_Tdc,			"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_MAIN,							{ eLangID_Danish,			"", 0, 0 } },
//	{ eDB_PARAM_ITEM_LANG_EVENT,						{ eLangID_English,			"", 0, 0 } },
	{ eDB_PARAM_ITEM_LANG_AUDIO0,						{ eLangID_Danish,			"", 0, 0 } },
...
HINT32 xdb_default_GetSystemConfigItemNum_YSR2000(void)
{
	return sizeof(s_astHardCodingSystemItemList_YSR2000) / sizeof(dbParam_DefaultItem_t);
}

dbParam_DefaultItem_t	*xdb_default_GetSystemConfigItem_YSR2000(HUINT32 ulItemIdx)
{
	if (xdb_default_GetSystemConfigItemNum_YSR2000() <= ulItemIdx)
		return NULL;

	return (dbParam_DefaultItem_t*)&s_astHardCodingSystemItemList_YSR2000[ulItemIdx];
}
