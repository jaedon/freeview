...
HUINT32 xmgr_action_BatchCount_Base(DxBatchType_e eBatchType)
{
...
MgrAction_BatchInitInfo * xmgr_action_BatchGetProcInfo_Base(DxBatchType_e eBatchType)
{
	if(eBatchType == eDxBAT_TYPE_COLDBOOT)
...
HBOOL xmgr_action_BatchIsSerial_Base(DxBatchType_e eBatchType)
{
	if(eBatchType == eDxBAT_TYPE_COLDBOOT)
		return FALSE;
	else if(eBatchType == eDxBAT_TYPE_USER)
