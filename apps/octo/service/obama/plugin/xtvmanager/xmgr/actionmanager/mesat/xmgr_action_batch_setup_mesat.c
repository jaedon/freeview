/****************************************************************************
*
* File Name   : xmgr_action_batch_setup_mesat.c
*
...
HUINT32 xmgr_action_BatchCount_MeSat(DxBatchType_e eBatchType)
{
...
MgrAction_BatchInitInfo * xmgr_action_BatchGetProcInfo_MeSat(DxBatchType_e eBatchType)
{
	if(eBatchType == eDxBAT_TYPE_COLDBOOT)
...
HBOOL xmgr_action_BatchIsSerial_MeSat(DxBatchType_e eBatchType)
{
	if(eBatchType == eDxBAT_TYPE_COLDBOOT)
		return FALSE;
	else if(eBatchType == eDxBAT_TYPE_USER)
