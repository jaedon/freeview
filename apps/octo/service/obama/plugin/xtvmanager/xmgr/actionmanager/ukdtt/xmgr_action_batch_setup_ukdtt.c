/****************************************************************************
*
* File Name   : xmgr_action_batch_setup_base.c
*
...
/* Private Variables. 														*/
/* ======================================================================== */
// STATIC HUINT8 *s_pszCheckSystem = (HUINT8*)"UPDATING DATA...";
#if defined(CONFIG_PROD_HMS1000S) || defined(CONFIG_PROD_HMSLITE)
#define TEST_DESC_REC_FOR_HMS
#endif
...
STATIC MgrAction_BatchInitInfo s_stBatchInfoUser[] =
{
	...
	#endif
		{eDxBAT_PROC_TIMERECOVERY,	MGR_TIME_GetBatchAllTimeRecoveryCBList, MGR_TIME_GetBatchTimeRecoveryTime},
		{eDxBAT_PROC_MAX,			NULL, NULL}
};
...
STATIC MgrAction_BatchInitInfo s_stBatchInfoStandby[] =
{
		...
		{eDxBAT_PROC_EPGTVTV, 		MGR_EPG_GetBatchEpgCBList, MGR_EPG_GetBatchEpgTime},
	#endif
	#if defined(CONFIG_MW_CI_PLUS)
		#if defined(TEST_DESC_REC_FOR_HMS)
		{eDxBAT_PROC_DESC_REC, 		MGR_SCHEDULE_GetBatchDescrambleRecordCBList, MGR_SCHEDULE_GetBatchDescrambleRecordTime},
		#endif
	#endif
		{eDxBAT_PROC_MAX, 			NULL, NULL}
};

HUINT32 xmgr_action_BatchCount_UkDtt(DxBatchType_e eBatchType)
{
...
MgrAction_BatchInitInfo * xmgr_action_BatchGetProcInfo_UkDtt(DxBatchType_e eBatchType)
{
	if(eBatchType == eDxBAT_TYPE_COLDBOOT)
...
HBOOL xmgr_action_BatchIsSerial_UkDtt(DxBatchType_e eBatchType)
{
	if(eBatchType == eDxBAT_TYPE_COLDBOOT)
		return FALSE;
	else if(eBatchType == eDxBAT_TYPE_USER)
