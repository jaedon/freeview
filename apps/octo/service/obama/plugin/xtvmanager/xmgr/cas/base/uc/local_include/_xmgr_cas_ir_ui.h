...
typedef enum
{
	eCasIrUCMenuGroup_None = 0,
	eCasIrUCMenuGroup_ServiceStatus,
	eCasIrUCMenuGroup_LoaderStatus,
	eCasIrUCMenuGroup_ProductStatus,
	eCasIrUCMenuGroup_ClientStatus,
	eCasIrUCMenuGroup_MailMessages,
	eCasIrUCMenuGroup_MAX
