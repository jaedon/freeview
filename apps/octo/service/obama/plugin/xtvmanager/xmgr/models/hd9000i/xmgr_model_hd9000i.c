...
STATIC void xmgr_hd9000i_OperationFrontControl(void)
{
...
STATIC void xmgr_hd9000i_ShutDownFrontControl(void)
{
	HBOOL				bPowerSavingStandby;
...
STATIC BUS_Result_t xmgr_hd9000i_msgBusCreate (Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
...
STATIC BUS_Result_t proc_hd9000i (HINT32 message, Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	case eMEVT_BUS_CREATE:
		...
		eResult = xmgr_hd9000i_msgBusCreate (hHandle, p1, p2, p3);
		break;
	case eMEVT_BUS_READY_SHUTDOWN :
	case eMEVT_BUS_GO_SHUTDOWN:
	{
		xmgr_hd9000i_ShutDownFrontControl();
		break;
	}
	case eMEVT_BUS_GO_OPERATION:
	{
		xmgr_hd9000i_OperationFrontControl();
		break;
	}
	default:
		break;
...
{
	BUS_MGR_Create (NULL, APP_PORTING_MGR_PRIORITY, proc_hd9000i, 0, 0, 0, 0);
	return ERR_OK;
}
...
HERROR xmgr_model_LiveGetSiSpec_HD9000I (MgrLive_START_t *pstStart, SvcSi_LiveSpec_t *pstSiSpec)
{
	...
	pstSiSpec->ulActionSpec	= eSVCSI_ACT_SPEC_Ertelecom;
...
HERROR xmgr_model_SearchGetLcnPolicy_HD9000I (DefaultLcnPolicy_t *peLcnPolicy, PreProgrammedChNumPolicy_t *pePreProgChNumPolicy)
{
	...
	if (peLcnPolicy != NULL)
	{
		*peLcnPolicy = eDEFAULTLCN_ERTELECOM;
	}
...
HERROR	xmgr_model_SwupInitProduct_HD9000I (void)
{
	...
	HLIB_STD_StrUtf8NCpy(stModuleInfo.szModuleName, "HD9000I_SWUP", SWUPDATE_MODULE_NAME_LEN);
...
HERROR xmgr_model_RecordGetCasTypes_HD9000I (HUINT32 *pulCasTypes)
{
	...
	*pulCasTypes	=	eMgrRec_CasType_Nagra;
