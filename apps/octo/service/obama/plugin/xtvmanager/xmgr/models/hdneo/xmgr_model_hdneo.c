...
STATIC void xmgr_hdneo_OperationFrontControl(void)
{
...
STATIC void xmgr_hdneo_ShutDownFrontControl(void)
{
	HBOOL				bPowerSavingStandby;
...
STATIC BUS_Result_t xmgr_hdneo_msgBusCreate (Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
...
STATIC BUS_Result_t proc_hdneo (HINT32 message, Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	case eMEVT_BUS_CREATE:
		...
		eResult = xmgr_hdneo_msgBusCreate (hHandle, p1, p2, p3);
		break;
	case eMEVT_BUS_READY_SHUTDOWN :
	case eMEVT_BUS_GO_SHUTDOWN:
	{
		xmgr_hdneo_ShutDownFrontControl();
		break;
	}
	case eMEVT_BUS_GO_OPERATION:
	{
		xmgr_hdneo_OperationFrontControl();
		break;
	}
	default:
		break;
...
HERROR	xmgr_model_Init_HDNEO (void)
{
	BUS_MGR_Create (NULL, APP_PORTING_MGR_PRIORITY, proc_hdneo, 0, 0, 0, 0);
	return ERR_OK;
}

#define _____LIVE_SPEC_____
HERROR xmgr_model_GetLiveSpec_HDNEO (XmgrLive_LiveType_InArg_t *pstIn, XmgrLive_LiveType_t *pstOut)
{
...
HERROR xmgr_model_GetLiveSiSpec_HDNEO (MgrLive_START_t *pstStart, SvcSi_LiveSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetSearchSiSpec_HDNEO (SvcSi_SearchOption_t *pstOption, SvcSi_SearchSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetLcnPolicy_HDNEO (DefaultLcnPolicy_t *peLcnPolicy, PreProgrammedChNumPolicy_t *pePreProgChNumPolicy)
{
...
HERROR xmgr_model_GetExtSearchSiSpec_HDNEO (SvcSi_ExtSearchOption_t *pstOption, SvcSi_ExtSearchSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetOtaCheckSiSpec_HDNEO (MgrSwup_InArg_t *pstInArg, SvcSi_SwupCheckSpec_t *pstSiSpec)
{
...
HERROR	xmgr_model_InitSwUpdate_HDNEO (void)
{
	...
	HLIB_STD_StrUtf8NCpy(stModuleInfo.szModuleName, "HDNEO_SWUP", SWUPDATE_MODULE_NAME_LEN);
...
HERROR xmgr_model_GetRecSiSpec_HDNEO (SvcSi_RecSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetPbSiSpec_HDNEO (SvcSi_PbSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetMediaPbSiSpec_HDNEO (SvcSi_MediaPbSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetRecCasTypes_HDNEO (HUINT32 *pulCasTypes)
{
	if (NULL == pulCasTypes)
		return ERR_FAIL;
...
HERROR xmgr_model_GetPbCasTypes_HDNEO (HUINT32 *pulCasTypes)
{
	if (NULL == pulCasTypes)
		return ERR_FAIL;
...
HERROR xmgr_model_GetSatRecSiSpec_HDNEO (SvcSi_SatRecordSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetTimeupdateSiSpec_HDNEO (SvcSi_TimeUpdateSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetMakeSectionSiSpec_HDNEO (SvcSi_MakeSectionSpec_t *pstSiSpec)
{
