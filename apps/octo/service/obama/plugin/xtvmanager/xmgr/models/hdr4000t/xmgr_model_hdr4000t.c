...
STATIC void xmgr_hdr4000t_OperationFrontControl(void)
{
...
STATIC void xmgr_hdr4000t_ShutDownFrontControl(void)
{
	HBOOL				bPowerSavingStandby;
...
STATIC BUS_Result_t xmgr_hdr4000t_msgBusCreate (Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
...
STATIC BUS_Result_t proc_hdr4000t (HINT32 message, Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	case eMEVT_BUS_CREATE:
		...
		eResult = xmgr_hdr4000t_msgBusCreate (hHandle, p1, p2, p3);
		break;
	case eMEVT_BUS_READY_SHUTDOWN :
	case eMEVT_BUS_GO_SHUTDOWN:
	{
		xmgr_hdr4000t_ShutDownFrontControl();
		break;
	}
	case eMEVT_BUS_GO_OPERATION:
	{
		xmgr_hdr4000t_OperationFrontControl();
		break;
	}
...
HERROR	xmgr_model_Init_HDR4000T (void)
{
	BUS_MGR_Create (NULL, APP_DEFAULT_PRIORITY, proc_hdr4000t, 0, 0, 0, 0);
	return ERR_OK;
}

#define _____LIVE_SPEC_____
HERROR xmgr_model_GetLiveSpec_HDR4000T (XmgrLive_LiveType_InArg_t *pstIn, XmgrLive_LiveType_t *pstOut)
{
...
HERROR xmgr_model_LiveGetSiSpec_HDR4000T (MgrLive_START_t *pstStart, SvcSi_LiveSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_SearchGetSiSpec_HDR4000T (SvcSi_SearchOption_t *pstOption, SvcSi_SearchSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_SearchGetLcnPolicy_HDR4000T (DefaultLcnPolicy_t *peLcnPolicy, PreProgrammedChNumPolicy_t *pePreProgChNumPolicy)
{
...
HERROR xmgr_model_SwupGetSiSpec_HDR4000T (MgrSwup_InArg_t *pstInArg, SvcSi_SwupCheckSpec_t *pstSiSpec)
{
...
HERROR	xmgr_model_SwupInitProduct_HDR4000T (void)
{
...
HERROR xmgr_model_RecordGetSiSpec_HDR4000T (SvcSi_RecSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_PlaybackGetSiSpec_HDR4000T (SvcSi_PbSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_MediaplaybackGetSiSpec_HDR4000T  (SvcSi_MediaPbSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_RecordGetCasTypes_HDR4000T (HUINT32 *pulCasTypes)
{
	if (NULL == pulCasTypes)
		return ERR_FAIL;
...
HERROR xmgr_model_PlaybackGetCasTypes_HDR4000T (HUINT32 *pulCasTypes)
{
	if (NULL == pulCasTypes)
		return ERR_FAIL;
...
HERROR xmgr_model_TimeupdateGetSiSpec_HDR4000T (SvcSi_TimeUpdateSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_MakesectionGetSiSpec_HDR4000T (SvcSi_MakeSectionSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetSiEsPriorityTable_HDR4000T (SvcSi_EsPriorityTable_t *pstTable)
{
	STATIC SvcSi_EsTypePriority_t s_astAudioPriorityTable_Hdr4000t[] =
	{
	...
	STATIC SvcSi_EsTypePriority_t s_astSubtitlePriorityTable_Hdr4000t[] =
	{
	...
	pstTable->astAudio 			= s_astAudioPriorityTable_Hdr4000t;
	pstTable->ulItemNumAudio	= sizeof(s_astAudioPriorityTable_Hdr4000t) / sizeof(SvcSi_EsTypePriority_t);

	pstTable->astSubtitle		= s_astSubtitlePriorityTable_Hdr4000t;
	pstTable->ulItemNumSubtitle	= sizeof(s_astSubtitlePriorityTable_Hdr4000t) / sizeof(SvcSi_EsTypePriority_t);
