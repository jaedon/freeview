...
STATIC void xmgr_hms1000s_OperationFrontControl(void)
{
...
STATIC void xmgr_hms1000s_ShutDownFrontControl(void)
{
	HBOOL				bPowerSavingStandby;
...
STATIC BUS_Result_t proc_hms1000s (HINT32 message, Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	{
		xmgr_hms1000s_ShutDownFrontControl();
		break;
	}
	case eMEVT_BUS_GO_OPERATION:
	{
		xmgr_hms1000s_OperationFrontControl();
		break;
	}
	default:
		break;
...
HERROR	xmgr_model_Init_HMS1000S (void)
{
...
HERROR xmgr_model_GetLiveSpec_HMS1000S (XmgrLive_LiveType_InArg_t *pstIn, XmgrLive_LiveType_t *pstOut)
{
...
HERROR xmgr_model_LiveGetSiSpec_HMS1000S (MgrLive_START_t *pstStart, SvcSi_LiveSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_SearchGetSiSpec_HMS1000S (SvcSi_SearchOption_t *pstOption, SvcSi_SearchSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_SearchGetLcnPolicy_HMS1000S (DefaultLcnPolicy_t *peLcnPolicy, PreProgrammedChNumPolicy_t *pePreProgChNumPolicy)
{
...
HERROR xmgr_model_SwupGetSiSpec_HMS1000S (MgrSwup_InArg_t *pstInArg, SvcSi_SwupCheckSpec_t *pstSiSpec)
{
...
HERROR	xmgr_model_SwupInitProduct_HMS1000S (void)
{
...
HERROR xmgr_model_RecordGetSiSpec_HMS1000S (SvcSi_RecSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_PlaybackGetSiSpec_HMS1000S (SvcSi_PbSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_MediaplaybackGetSiSpec_HMS1000S (SvcSi_MediaPbSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_RecordGetCasTypes_HMS1000S (HUINT32 *pulCasTypes)
{
	if (NULL == pulCasTypes)
		return ERR_FAIL;
...
HERROR xmgr_model_PlaybackGetCasTypes_HMS1000S (HUINT32 *pulCasTypes)
{
	if (NULL == pulCasTypes)
		return ERR_FAIL;
...
HERROR xmgr_model_TimeupdateGetSiSpec_HMS1000S (SvcSi_TimeUpdateSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_MakesectionGetSiSpec_HMS1000S (SvcSi_MakeSectionSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetSiEsPriorityTable_HMS1000S (SvcSi_EsPriorityTable_t *pstTable)
{
