...
STATIC void xmgr_ihdr6100c_OperationFrontControl(void)
{
...
STATIC void xmgr_ihdr6100c_ShutDownFrontControl(void)
{
	HBOOL				bPowerSavingStandby;
...
STATIC BUS_Result_t xmgr_ihdr6100c_msgBusCreate (Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
...
STATIC BUS_Result_t proc_ihdr6100c (HINT32 message, Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	case eMEVT_BUS_CREATE:
		...
		eResult = xmgr_ihdr6100c_msgBusCreate (hHandle, p1, p2, p3);
		break;
	case eMEVT_BUS_READY_SHUTDOWN :
	case eMEVT_BUS_GO_SHUTDOWN:
	{
		xmgr_ihdr6100c_ShutDownFrontControl();
		break;
	}
	case eMEVT_BUS_GO_OPERATION:
	{
		xmgr_ihdr6100c_OperationFrontControl();
		break;
	}
	default:
		break;
...
{
	BUS_MGR_Create (NULL, APP_PORTING_MGR_PRIORITY, proc_ihdr6100c, 0, 0, 0, 0);
	return ERR_OK;
}
...
HERROR xmgr_model_LiveGetSiSpec_IHDR6100C (MgrLive_START_t *pstStart, SvcSi_LiveSpec_t *pstSiSpec)
{
	...
	pstSiSpec->ulActionSpec	= eSVCSI_ACT_SPEC_Ziggo;
