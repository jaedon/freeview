...
STATIC void xmgr_m1_OperationFrontControl(void)
{
...
STATIC void xmgr_m1_ShutDownFrontControl(void)
{
	HBOOL				bPowerSavingStandby;
...
STATIC BUS_Result_t xmgr_m1_msgBusCreate (Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
...
STATIC BUS_Result_t proc_m1 (HINT32 message, Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	case eMEVT_BUS_CREATE:
		...
		eResult = xmgr_m1_msgBusCreate (hHandle, p1, p2, p3);
		break;
	case eMEVT_BUS_READY_SHUTDOWN :
	case eMEVT_BUS_GO_SHUTDOWN:
	{
		xmgr_m1_ShutDownFrontControl();
		break;
	}
	case eMEVT_BUS_GO_OPERATION:
	{
		xmgr_m1_OperationFrontControl();
		break;
	}
	default:
		break;
...
HERROR	xmgr_model_Init_M1 (void)
{
	BUS_MGR_Create (NULL, APP_PORTING_MGR_PRIORITY, proc_m1, 0, 0, 0, 0);
	return ERR_OK;
}

#define _____LIVE_SPEC_____
HERROR xmgr_model_GetLiveSpec_M1 (XmgrLive_LiveType_InArg_t *pstIn, XmgrLive_LiveType_t *pstOut)
{
...
HERROR xmgr_model_LiveGetSiSpec_M1 (MgrLive_START_t *pstStart, SvcSi_LiveSpec_t *pstSiSpec)
{
	pstSiSpec->eActionKind	= eSVCSI_ACT_KIND_Live;
	pstSiSpec->ulActionSpec	= eSVCSI_ACT_SPEC_Mbc;
...
HERROR xmgr_model_SearchGetSiSpec_M1 (SvcSi_SearchOption_t *pstOption, SvcSi_SearchSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_SearchGetLcnPolicy_M1 (DefaultLcnPolicy_t *peLcnPolicy, PreProgrammedChNumPolicy_t *pePreProgChNumPolicy)
{
...
HERROR xmgr_model_SwupGetSiSpec_M1 (MgrSwup_InArg_t *pstInArg, SvcSi_SwupCheckSpec_t *pstSiSpec)
{
...
HERROR	xmgr_model_SwupInitProduct_M1 (void)
{
	...
	case eDxSwUpdate_SPEC_DVBSSU :
		HLIB_STD_StrUtf8NCpy(stModuleInfo.szModuleName, "SSU_SWUP", SWUPDATE_MODULE_NAME_LEN);
...
HERROR xmgr_model_RecordGetSiSpec_M1 (SvcSi_RecSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_PlaybackGetSiSpec_M1 (SvcSi_PbSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_MediaplaybackGetSiSpec_M1 (SvcSi_MediaPbSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_RecordGetCasTypes_M1 (HUINT32 *pulCasTypes)
{
	if (NULL == pulCasTypes)
		return ERR_FAIL;
...
HERROR xmgr_model_PlaybackGetCasTypes_M1 (HUINT32 *pulCasTypes)
{
	if (NULL == pulCasTypes)
		return ERR_FAIL;
...
HERROR xmgr_model_TimeupdateGetSiSpec_M1 (SvcSi_TimeUpdateSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_MakesectionGetSiSpec_M1 (SvcSi_MakeSectionSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetSiEsPriorityTable_M1 (SvcSi_EsPriorityTable_t *pstTable)
{
