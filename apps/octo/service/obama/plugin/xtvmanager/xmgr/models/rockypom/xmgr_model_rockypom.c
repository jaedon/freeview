...
STATIC void xmgr_rockypom_OperationFrontControl(void)
{
...
STATIC void xmgr_rockypom_ShutDownFrontControl(void)
{
	HBOOL				bPowerSavingStandby;
...
STATIC BUS_Result_t xmgr_rockypom_msgBusCreate (Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
...
STATIC BUS_Result_t proc_rockypom (HINT32 message, Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	case eMEVT_BUS_CREATE:
		...
		eResult = xmgr_rockypom_msgBusCreate (hHandle, p1, p2, p3);
		break;
	case eMEVT_BUS_READY_SHUTDOWN :
	case eMEVT_BUS_GO_SHUTDOWN:
	{
		xmgr_rockypom_ShutDownFrontControl();
		break;
	}
	case eMEVT_BUS_GO_OPERATION:
	{
		xmgr_rockypom_OperationFrontControl();
		break;
	}
	default:
		break;
...
{
	BUS_MGR_Create (NULL, APP_PORTING_MGR_PRIORITY, proc_rockypom, 0, 0, 0, 0);
	return ERR_OK;
}
...
HERROR	xmgr_model_SwupInitProduct_ROCKYPOM (void)
{
	...
	HLIB_STD_StrUtf8NCpy(stModuleInfo.szModuleName, "ROCKYPOM_SWUP", SWUPDATE_MODULE_NAME_LEN);
