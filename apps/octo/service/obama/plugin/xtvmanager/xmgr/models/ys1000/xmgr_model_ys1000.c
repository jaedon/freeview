...
STATIC void xmgr_ys1000_OperationFrontControl(void)
{
...
STATIC void xmgr_ys1000_ShutDownFrontControl(void)
{
	HBOOL				bPowerSavingStandby;
...
STATIC BUS_Result_t xmgr_ys1000_msgBusCreate (Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
...
STATIC BUS_Result_t proc_ys1000 (HINT32 message, Handle_t hHandle, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	case eMEVT_BUS_CREATE:
		...
		eResult = xmgr_ys1000_msgBusCreate (hHandle, p1, p2, p3);
		break;
	case eMEVT_BUS_READY_SHUTDOWN :
	case eMEVT_BUS_GO_SHUTDOWN:
	{
		xmgr_ys1000_ShutDownFrontControl();
		break;
	}
	case eMEVT_BUS_GO_OPERATION:
	{
		xmgr_ys1000_OperationFrontControl();
		break;
	}
...
HERROR	xmgr_model_Init_YS1000 (void)
{
	BUS_MGR_Create (NULL, APP_PORTING_MGR_PRIORITY, proc_ys1000, 0, 0, 0, 0);
	return ERR_OK;
}

#define _____LIVE_SPEC_____
HERROR xmgr_model_GetLiveSpec_YS1000 (XmgrLive_LiveType_InArg_t *pstIn, XmgrLive_LiveType_t *pstOut)
{
...
HERROR xmgr_model_LiveGetSiSpec_YS1000 (MgrLive_START_t *pstStart, SvcSi_LiveSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_SearchGetSiSpec_YS1000 (SvcSi_SearchOption_t *pstOption, SvcSi_SearchSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_SearchGetLcnPolicy_YS1000 (DefaultLcnPolicy_t *peLcnPolicy, PreProgrammedChNumPolicy_t *pePreProgChNumPolicy)
{
...
HERROR xmgr_model_SwupGetSiSpec_YS1000 (MgrSwup_InArg_t *pstInArg, SvcSi_SwupCheckSpec_t *pstSiSpec)
{
...
HERROR	xmgr_model_SwupInitProduct_YS1000 (void)
{
	MgrSwup_ModuleInfo_t	stModuleInfo;
	MgrSwup_ModuleCb_t	*pstCallback = &stModuleInfo.stCallback;

	HLIB_STD_StrUtf8NCpy(stModuleInfo.szModuleName, "YS1000_SWUP", SWUPDATE_MODULE_NAME_LEN);
...
HERROR xmgr_model_RecordGetSiSpec_YS1000 (SvcSi_RecSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_PlaybackGetSiSpec_YS1000 (SvcSi_PbSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_MediaplaybackGetSiSpec_YS1000 (SvcSi_MediaPbSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_RecordGetCasTypes_YS1000 (HUINT32 *pulCasTypes)
{
	if (NULL == pulCasTypes)
		return ERR_FAIL;
...
HERROR xmgr_model_PlaybackGetCasTypes_YS1000 (HUINT32 *pulCasTypes)
{
	if (NULL == pulCasTypes)
		return ERR_FAIL;
...
HERROR xmgr_model_TimeupdateGetSiSpec_YS1000 (SvcSi_TimeUpdateSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_MakesectionGetSiSpec_YS1000 (SvcSi_MakeSectionSpec_t *pstSiSpec)
{
...
HERROR xmgr_model_GetSiEsPriorityTable_YS1000 (SvcSi_EsPriorityTable_t *pstTable)
{
	STATIC SvcSi_EsTypePriority_t s_astAudioPriorityTable_Ys1000[] =
	{
	...
	STATIC SvcSi_EsTypePriority_t s_astSubtitlePriorityTable_Ys1000[] =
	{
	...
	pstTable->astAudio = s_astAudioPriorityTable_Ys1000;
	pstTable->ulItemNumAudio = sizeof(s_astAudioPriorityTable_Ys1000) / sizeof(SvcSi_EsTypePriority_t);

	pstTable->astSubtitle = s_astSubtitlePriorityTable_Ys1000;
	pstTable->ulItemNumSubtitle = sizeof(s_astSubtitlePriorityTable_Ys1000) / sizeof(SvcSi_EsTypePriority_t);
