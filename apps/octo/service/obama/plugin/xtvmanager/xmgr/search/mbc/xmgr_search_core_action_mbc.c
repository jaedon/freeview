...
STATIC BUS_Result_t xproc_mbcSearch_SatProto_Base(XmgrSearch_SatContents_t *pstContents, HINT32 message, Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3);
...
STATIC INLINE HERROR xmgr_mbcSearch_SatCheckActionId (XmgrSearch_SatContents_t *pstContents, Handle_t hAction);
STATIC INLINE void xmgr_mbcSearch_SatIncreaseSessionVersion (XmgrSearch_SatContents_t *pstContents);
STATIC DbSvc_TuningInfo_t *xmgr_mbcSearch_SatGetCurrentTuningInfo (XmgrSearch_SatContents_t *pstContents);

STATIC HERROR xmgr_mbcSearch_SatInitContents (XmgrSearch_SatContents_t *pstContents, Handle_t hAction, MgrSearch_Option_t *pstOption);
STATIC HERROR xmgr_mbcSearch_SatMakeTpList (XmgrSearch_SatContents_t* pstContents, MgrSearch_Option_t *pstOption);

STATIC HERROR xmgr_mbcSearch_SatSetTuningParamToSearch (XmgrSearch_SatContents_t *pstContents);

STATIC HERROR xmgr_mbcSearch_SatDestroyContents (XmgrSearch_SatContents_t *pstContents);

STATIC HERROR xmgr_mbcSearch_SatTuneSearchTp (XmgrSearch_SatContents_t *pstContents);
STATIC HERROR xmgr_mbcSearch_SatSetNextTpToSearch (XmgrSearch_SatContents_t *pstContents);

STATIC HERROR xmgr_mbcSearch_SatSendUpdateDisplayMsg (Handle_t hAction);
STATIC HERROR xmgr_mbcSearch_SatSendSearchStartedMsg (Handle_t hAction);
STATIC HERROR xmgr_mbcSearch_SatSendSearchFinished (Handle_t hAction);
STATIC HERROR xmgr_mbcSearch_SatSendSearchActionDestroyed (Handle_t hAction);

STATIC HERROR xmgr_mbcSearch_SatRetrieveResults (XmgrSearch_SatContents_t* pstContents);
STATIC HERROR xmgr_mbcSearch_SatAddDeliveryInfoInTpList (XmgrSearch_SatContents_t *pstContents);
STATIC HERROR xmgr_mbcSearch_SatSaveResult (Handle_t hAction, HUINT32 ulParam1, HUINT32 ulParam2, HUINT32 ulParam3);
STATIC HERROR xmgr_mbcSearch_SatMsgAppSearchFinished(XmgrSearch_SatContents_t *pstContents, HINT32 nAppHandle);
STATIC HBOOL xmgr_mbcSearch_SatFilterSameTuningInfo (void *pvItem, void *pvFilter);
STATIC DbSvc_TuningInfo_t *xmgr_mbcSearch_SatAllocTuneInfo (void);
STATIC void xmgr_mbcSearch_SatFreeTuneInfo (void *pvTuneInfo);
STATIC void xmgr_mbcSearch_SatReleaseAction (XmgrSearch_SatContents_t *pstContents);


STATIC HERROR xmgr_mbcSearch_SatMsgGwmCreate (XmgrSearch_SatContents_t *pstContents, Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3);
STATIC HERROR xmgr_mbcSearch_SatMsgGwmDestroyed (XmgrSearch_SatContents_t *pstContents);
STATIC HERROR xmgr_mbcSearch_SatMsgAppSearchActionStart (XmgrSearch_SatContents_t *pstContents, HINT32 nAppHandle);
STATIC HERROR xmgr_mbcSearch_SatMsgAppSearchCancel (XmgrSearch_SatContents_t *pstContents, HINT32 nAppHandle);
STATIC HERROR xmgr_mbcSearch_SatEvtSiSearchDone (XmgrSearch_SatContents_t *pstContents);
STATIC HERROR xmgr_mbcSearch_SatEvtSiSearchFail (XmgrSearch_SatContents_t *pstContents);
STATIC HERROR xmgr_mbcSearch_SatEvtChLocked (XmgrSearch_SatContents_t *pstContents);
STATIC HERROR xmgr_mbcSearch_SatEvtChNoSignal (XmgrSearch_SatContents_t *pstContents);
...
STATIC HERROR xmgr_mbcSearch_SatChangeProgressNumber (XmgrSearch_SatContents_t *pstContents)
{
...
STATIC HERROR xmgr_mbcSearch_SatInitContents (XmgrSearch_SatContents_t *pstContents, Handle_t hAction, MgrSearch_Option_t *pstOption)
{
	...
	xmgr_mbcSearch_SatMakeTpList (pstContents, pstOption);
...
STATIC HERROR xmgr_mbcSearch_SatMakeTpList (XmgrSearch_SatContents_t* pstContents, MgrSearch_Option_t *pstOption)
{
	...
	{
		pstTuneInfo = xmgr_mbcSearch_SatAllocTuneInfo();
		if (NULL != pstTuneInfo)
		{
...
STATIC HERROR xmgr_mbcSearch_SatSetTuningParamToSearch (XmgrSearch_SatContents_t *pstContents)
{
	...
	/* TP Progress Update */
	xmgr_mbcSearch_SatChangeProgressNumber (pstContents);
...
STATIC HERROR xmgr_mbcSearch_SatDestroyContents (XmgrSearch_SatContents_t *pstContents)
{
	...
	MGR_SEARCHDATA_ClearBouquetArray (&(pstContents->stBqArray));
 	...
 	pstContents->pstTpToSearch = UTIL_LINKEDLIST_FreeWholeListItemsFromPointerList (pstContents->pstTpToSearch, xmgr_mbcSearch_SatFreeTuneInfo);
 	pstContents->pstFinishedTps = UTIL_LINKEDLIST_FreeWholeListItemsFromPointerList (pstContents->pstFinishedTps, xmgr_mbcSearch_SatFreeTuneInfo);
...
STATIC HERROR xmgr_mbcSearch_SatTuneSearchTp (XmgrSearch_SatContents_t *pstContents)
{
	...
	while (bRetry == TRUE)
	{
		hErr = xmgr_mbcSearch_SatSetTuningParamToSearch (pstContents);
		if (hErr != ERR_OK)
		{
			LOG ("[xmgr_mbcSearch_SatTuneSearchTp] No Tp left to tune\n");
			pstContents->eAppState = eSearchApp_state_searchend;
			return ERR_BUS_NO_OBJECT;
		}
		...
		if (hErr != ERR_OK)
		{
			LOG ("[xmgr_mbcSearch_SatTuneSearchTp] Tuner Stop Failed\n");
			pstContents->eAppState = eSearchApp_state_searchend;
			return ERR_BUS_NO_OBJECT;
		}

		xmgr_mbcSearch_SatIncreaseSessionVersion (pstContents);			// Tuning 전에 반드시 Action Version을 업데이트해야 한다.
		...
		hErr = xmgr_mbcSearch_SatSetNextTpToSearch (pstContents);
		if (hErr != ERR_OK)
		{
			LOG ("[xmgr_mbcSearch_SatTuneSearchTp] No Next Tp left to tune\n");
			pstContents->eAppState = eSearchApp_state_searchend;
			bRetry = FALSE;
		}
	}
...
STATIC HERROR xmgr_mbcSearch_SatRetrieveResults (XmgrSearch_SatContents_t* pstContents)
{
	...
	HUINT32					 ulBqNum, ulPrvNum, ulGroupNum, ulSvcNum;
	...
	DbSvc_GroupInfo_t		*pstGroupArray = NULL;
	...
	{
		pstCurrTuneInfo = xmgr_mbcSearch_SatGetCurrentTuningInfo (pstContents);
	...
	//------------------------------------------------------------------------------
	// 5. Group Info
	hErr = SVC_SI_CountSearchedResult(pstContents->ulActionId, eSI_SRCH_INFOTYPE_Group, &ulGroupNum);
	if (hErr != ERR_OK)					{ ulGroupNum = 0; }
	if (ulGroupNum > 0)
	{
		pstGroupArray = (DbSvc_GroupInfo_t *)OxAP_Malloc (sizeof(DbSvc_GroupInfo_t) * ulGroupNum);
		if (pstGroupArray != NULL)
		{
			hErr = SVC_SI_GetSearchedResults(pstContents->ulActionId, eSI_SRCH_INFOTYPE_Group, ulGroupNum, &ulInfoNum, (void *)pstGroupArray);
			if (hErr != ERR_OK)
			{
				ulGroupNum = 0;
				OxAP_Free (pstGroupArray);
				pstGroupArray = NULL;
			}
		}
	}
	...
	//------------------------------------------------------------------------------
	// 7. Store the searched results to the contents :
	// 7-1. Network Info
	...
	if (pstBqArray != NULL)
	{
		for (ulIndex = 0; ulIndex < ulBqNum; ulIndex++)
		{
			...
			hErr = DB_SVC_FindBouquetIndexById(pstBqArray[ulIndex].usBouqId, &usBouqIdx);
			if (hErr == ERR_OK)
			{
				DB_SVC_UpdateBouquetInfo (usBouqIdx, &pstBqArray[ulIndex]);
			}
			else
			{
				// 등록되어 있지 않으므로 새로 추가한다.
				DB_SVC_AddBouquetInfo (&pstBqArray[ulIndex], &usBouqIdx);
			}
	...
	if (pstGroupArray != NULL)
	{
		for (ulIndex = 0; ulIndex < ulGroupNum; ulIndex++)
		{
			...
			hErr = DB_SVC_FindGroupIndexByGroupId(pstGroupArray[ulIndex].ulGroupId, &usGroupIdx);
			if (hErr == ERR_OK)
			{
				DB_SVC_UpdateGroupInfo(usGroupIdx, &pstGroupArray[ulIndex]);
			}
			else
			{
				// 등록되어 있지 않으므로 새로 추가한다.
				DB_SVC_AddGroupInfo(&pstGroupArray[ulIndex], &usGroupIdx);
			}
			
			// TODO: MGR_SEARCHDATA_AddGroup 구현 해야 하나....
		}
	}
	...
	//  list변경됐음을 알림
	xmgr_mbcSearch_SatSendUpdateDisplayMsg(pstContents->hAction);
...
STATIC HERROR xmgr_mbcSearch_SatAddDeliveryInfoInTpList (XmgrSearch_SatContents_t *pstContents)
{
	...
	for (ulIndex = 0; ulIndex < ulNumDeliInfo; ulIndex++)
	{
		...
		pstFound = UTIL_LINKEDLIST_FindNthListItemFromPointerList (pstContents->pstFinishedTps, 0,
																xmgr_mbcSearch_SatFilterSameTuningInfo,
		...
		while (pstFound != NULL)
		{
			pstNextTpList = UTIL_LINKEDLIST_DeleteListItemFromPointerList (pstNextTpList, pstFound, xmgr_mbcSearch_SatFreeTuneInfo);
			UTIL_LINKEDLIST_CircularizePointerList (pstNextTpList);
		...
		// 4. Delivery TP를 추가
		pstDeliSvcTuneInfo = xmgr_mbcSearch_SatAllocTuneInfo();
	...
	UTIL_LINKEDLIST_CircularizePointerList (pstContents->pstTpToSearch);
	UTIL_LINKEDLIST_FreeWholeListItemsFromPointerList (pstRest, xmgr_mbcSearch_SatFreeTuneInfo);
...
STATIC void xmgr_mbcSearch_SatReleaseAction (XmgrSearch_SatContents_t *pstContents)
{
	...
	LOG ("called xmgr_mbcSearch_SatReleaseAction()\n");
	hErr = SVC_CH_StopTune (pstContents->hAction, (HUINT16)-1, eSyncMode);
	if (hErr != ERR_OK)
	{
		ERR_LOG ("Error Log !!\n");
...
STATIC HERROR xmgr_mbcSearch_SatMsgGwmCreate (XmgrSearch_SatContents_t *pstContents, Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	xmgr_mbcSearch_SatInitContents (pstContents, hAction, pstOption);
...
STATIC HERROR xmgr_mbcSearch_SatMsgGwmDestroyed (XmgrSearch_SatContents_t *pstContents)
{
	...
	if (pstContents->eAppState != eSearchApp_state_searchend)
	{
		...
		xmgr_mbcSearch_SatReleaseAction (pstContents);
	}
...
//		MWC_PARAM_SetAntennaConnectionType (eDxANTCONN_ONECABLE);
	...
	xmgr_mbcSearch_SatDestroyContents (pstContents);

	// Send the destoyed message to the UI procedure
	xmgr_mbcSearch_SatSendSearchActionDestroyed(pstContents->hAction);
...
STATIC HERROR xmgr_mbcSearch_SatMsgAppSearchActionStart (XmgrSearch_SatContents_t *pstContents, HINT32 nAppHandle)
{
	...
	xmgr_mbcSearch_SatSetTuningParamToSearch(pstContents);
	...
	// Tune the TP
	hErr = xmgr_mbcSearch_SatTuneSearchTp (pstContents);
	if (hErr != ERR_OK)
	{
		LOG ("[xmgr_mbcSearch_SatMsgGwmCreate] No Next Tp left to tune\n");
		pstContents->eAppState = eSearchApp_state_searchend;
	}

	xmgr_mbcSearch_SatSendSearchStartedMsg (pstContents->hAction);

	if (pstContents->eAppState == eSearchApp_state_searchend)
	{
		xmgr_mbcSearch_SatSendSearchFinished(pstContents->hAction);
		xmgr_mbcSearch_SatReleaseAction (pstContents);
	}
...
STATIC HERROR xmgr_mbcSearch_SatSaveResult (Handle_t hAction, HUINT32 ulParam1, HUINT32 ulParam2, HUINT32 ulParam3)
{
	XmgrSearch_SatContents_t	*pstContents;	
	...
	pstContents = (XmgrSearch_SatContents_t *)ulParam1;
	if (pstContents == NULL)
	{
		return ERR_FAIL;
	}
	...
	SVC_SI_PostProcessForSvcNumbering (pstContents->hAction, eLcnPolicy, eDxDELIVERY_TYPE_SAT);
...
STATIC HERROR xmgr_mbcSearch_SatMsgAppSearchFinished(XmgrSearch_SatContents_t *pstContents, HINT32 nAppHandle)
{
	if (pstContents->eAppState == eSearchApp_state_searchend)
	{
		xmgr_mbcSearch_SatSaveResult(pstContents->hAction, (HUINT32)pstContents, 0, 0);
	}
	return ERR_OK;
}
...
STATIC HERROR xmgr_mbcSearch_SatEvtSiSearchDone (XmgrSearch_SatContents_t *pstContents)
{
	...
	case eSearchApp_state_waitingSi:
		...
		{
			hErr = xmgr_mbcSearch_SatRetrieveResults (pstContents);
		}

		if (hErr == ERR_OK && pstContents->bNetworkSearch == TRUE)
		{
			xmgr_mbcSearch_SatAddDeliveryInfoInTpList (pstContents);
		}
		...
		if (hErr != ERR_OK)
		{
			LOG ("[xmgr_mbcSearch_SatEvtSiSearchDone] No Next Tp left to tune\n");
			pstContents->eAppState = eSearchApp_state_searchend;
		}
...
STATIC HERROR xmgr_mbcSearch_SatEvtSiSearchFail (XmgrSearch_SatContents_t *pstContents)
{
	...
	case eSearchApp_state_waitingSi:
		...
		if (hErr != ERR_OK)
		{
			LOG ("[xmgr_mbcSearch_SatEvtSiSearchFail] No Next Tp left to tune\n");
			pstContents->eAppState = eSearchApp_state_searchend;
			break;
		}
	...
	case eSearchApp_state_tryTuning :
		...
		ulNetId = (pstContents->bNetworkSearch == TRUE) ? SvcSi_NETID_SEARCH_NITACT : SvcSi_NETID_SEARCH_NOTNIT;
		{
		    ...
		    else
		    {
			    ...
			    if (hErr != ERR_OK)
			    {
					LOG ("[xmgr_mbcSearch_SatEvtChLocked] No Next Tp left to tune\n");
				    pstContents->eAppState = eSearchApp_state_searchend;
			    }
		    }
		}
...
STATIC HERROR xmgr_mbcSearch_SatEvtChNoSignal (XmgrSearch_SatContents_t *pstContents)
{
	...
	case eSearchApp_state_tryTuning :
		...
		if (hErr != ERR_OK)
		{
			LOG ("[xmgr_mbcSearch_SatEvtChNoSignal] No Next Tp left to tune\n");
			pstContents->eAppState = eSearchApp_state_searchend;
		}
	...
	case eSearchApp_state_waitingSi:
		...
		else
		{
			...
			LOG ("[xmgr_mbcSearch_SatEvtChNoSignal] SI Re-open failed.\n");
			pstContents->eAppState = eSearchApp_state_searchend;
		}
...
STATIC BUS_Result_t			xproc_mbcSearch_SatProto_Base(XmgrSearch_SatContents_t *pstContents, HINT32 message, Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	case eMEVT_BUS_CREATE:
		...
		hErr = xmgr_mbcSearch_SatMsgGwmCreate (pstContents, hAction, p1, p2, p3);
		break;
	...
	case eMEVT_BUS_DESTROY:
		...
		hErr = xmgr_mbcSearch_SatMsgGwmDestroyed (pstContents);
		break;

	case eMEVT_SEARCH_ACTION_START:
		MSG_LOG ("[%s] MSG:eMEVT_SEARCH_ACTION_START hAction=0x%08x, p1=%d, p2=%d, p3=%d \n", BUS_MGR_GetMgrName (BUS_MGR_GetThis()), hAction, p1, p2, p3);
		hErr = xmgr_mbcSearch_SatMsgAppSearchActionStart (pstContents, p1);
		break;

	case eMEVT_SEARCH_CANCEL:
		MSG_LOG ("[%s] MSG:eMEVT_SEARCH_CANCEL hAction=0x%08x, p1=%d, p2=%d, p3=%d \n", BUS_MGR_GetMgrName (BUS_MGR_GetThis()), hAction, p1, p2, p3);
		hErr = xmgr_mbcSearch_SatMsgAppSearchCancel (pstContents, p1);
		break;

	case eMEVT_SEARCH_FINISHED:
		hErr =xmgr_mbcSearch_SatMsgAppSearchFinished (pstContents, p1);
	...
	case eSEVT_SI_SEARCH_DONE:
		...
		hErr = xmgr_mbcSearch_SatCheckActionId (pstContents, hAction);
		if (hErr != MESSAGE_BREAK)
		{
			hErr = xmgr_mbcSearch_SatEvtSiSearchDone (pstContents);
		}
	...
	case eSEVT_SI_SEARCH_FAIL:
		...
		if (hErr != MESSAGE_BREAK)
		{
			hErr = xmgr_mbcSearch_SatEvtSiSearchFail (pstContents);
		}
		break;
	...
	case eSEVT_CH_STARTED:
		...
		if (hErr != MESSAGE_BREAK)
		{
			hErr = xmgr_mbcSearch_SatSendUpdateDisplayMsg(pstContents->hAction); // MOONSG_sss
		}
		break;
	...
	case eSEVT_CH_LOCKED:
		...
		if (hErr != MESSAGE_BREAK)
		{
			hErr = xmgr_mbcSearch_SatEvtChLocked (pstContents);
		}
		break;
	...
	case eSEVT_CH_NO_SIGNAL:
		...
		if (hErr != MESSAGE_BREAK)
		{
			hErr = xmgr_mbcSearch_SatEvtChNoSignal (pstContents);
		}
		break;
...
BUS_Result_t		xproc_search_mbc_Action_0(HINT32 message, Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	return xproc_mbcSearch_SatProto_Base(&(s_SatSrchApp_Contents[0]), message, hAction, p1, p2, p3);
}
...
BUS_Result_t		xproc_search_mbc_Action_1(HINT32 message, Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	return xproc_mbcSearch_SatProto_Base(&(s_SatSrchApp_Contents[1]), message, hAction, p1, p2, p3);
}
