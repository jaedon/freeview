/**
	@file     xmgr_search_ziggo_cab_action.c
...
STATIC BUS_Result_t xproc_search_CabProto_Ziggo(XmgrSearch_CabContents_t *pstContents, HINT32 message, Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3);


#define	_________________________Body___________________________________

STATIC HERROR xmgr_search_ziggo_CabChangeTpText (XmgrSearch_CabContents_t *pstContents, DbSvc_NetInfo_t *pstNetworkInfo);
STATIC HERROR xmgr_search_ziggo_CabChangeProgressNumber (XmgrSearch_CabContents_t *pstContents);

STATIC INLINE HERROR xmgr_search_ziggo_CabCheckActionId (XmgrSearch_CabContents_t *pstContents, Handle_t hAction);
STATIC INLINE void xmgr_search_ziggo_CabIncreaseSessionVersion (XmgrSearch_CabContents_t *pstContents);
STATIC DbSvc_TuningInfo_t *xmgr_search_ziggo_CabGetCurrentTuningInfo (XmgrSearch_CabContents_t *pstContents);

STATIC HERROR xmgr_search_ziggo_CabInitContents (XmgrSearch_CabContents_t *pstContents, Handle_t hAction, MgrSearch_Option_t *pstOption);
STATIC HERROR xmgr_search_ziggo_CabMakeTpList (XmgrSearch_CabContents_t* pstContents, MgrSearch_Option_t *pstOption);
STATIC HERROR xmgr_search_ziggo_CabSetTuningParamToSearch (XmgrSearch_CabContents_t *pstContents);

STATIC HERROR xmgr_search_ziggo_CabDestroyContents (XmgrSearch_CabContents_t *pstContents);

STATIC HERROR xmgr_search_ziggo_CabTuneSearchTp (XmgrSearch_CabContents_t *pstContents);
STATIC HERROR xmgr_search_ziggo_CabSetNextTpToSearch (XmgrSearch_CabContents_t *pstContents);

STATIC HERROR xmgr_search_ziggo_CabSendUpdateDisplayMsg (XmgrSearch_CabContents_t *pstContents);
STATIC HERROR xmgr_search_ziggo_CabSendSearchStartedMsg (Handle_t hAction);
STATIC HERROR xmgr_search_ziggo_CabSendSearchFinished (Handle_t hAction);
STATIC HERROR xmgr_search_ziggo_CabSendSearchSaveFinishedMsg (Handle_t hAction);
STATIC HERROR xmgr_search_ziggo_CabSendSearchActionDestroyed (Handle_t hAction);
STATIC HERROR xmgr_search_ziggo_CabRetrieveResults (XmgrSearch_CabContents_t* pstContents);
STATIC HERROR xmgr_search_ziggo_CabAddDeliveryInfoInTpList (XmgrSearch_CabContents_t *pstContents);
STATIC HERROR xmgr_search_ziggo_CabSaveResult (Handle_t hAction, HUINT32 ulParam1, HUINT32 ulParam2, HUINT32 ulParam3);
STATIC HBOOL xmgr_search_ziggo_CabFilterSameTuningInfo (void *pvItem, void *pvFilter);
STATIC DbSvc_TuningInfo_t *xmgr_search_ziggo_CabAllocTuneInfo (void);
STATIC void xmgr_search_ziggo_CabFreeTuneInfo (void *pvTuneInfo);
STATIC void xmgr_search_ziggo_CabReleaseAction (XmgrSearch_CabContents_t *pstContents);
STATIC HERROR xmgr_search_ziggo_CabGetServiceHandle (HUINT16 usTsIdx, HUINT16 usTsId, HUINT16 usSvcId, HUINT16 usOnId, Handle_t *phSvc);

STATIC HERROR xmgr_search_ziggo_CabMsgGwmCreate (XmgrSearch_CabContents_t *pstContents, Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3);
STATIC HERROR xmgr_search_ziggo_CabMsgGwmDestroyed (XmgrSearch_CabContents_t *pstContents);
STATIC HERROR xmgr_search_ziggo_CabMsgAppSearchActionStart (XmgrSearch_CabContents_t *pstContents, HINT32 nAppHandle);
STATIC HERROR xmgr_search_ziggo_CabMsgAppSearchSaveResult (XmgrSearch_CabContents_t *pstContents, HINT32 nAppHandle);
STATIC HERROR xmgr_search_ziggo_CabMsgAppSearchCancel (XmgrSearch_CabContents_t *pstContents, HINT32 nAppHandle);
STATIC HERROR xmgr_search_ziggo_CabMsgAppBgJobFinished (XmgrSearch_CabContents_t *pstContents, HINT32 nCbPtr, HINT32 nResult);
STATIC HERROR xmgr_search_ziggo_CabMsgAppSearchKillProcesses (XmgrSearch_CabContents_t *pstContents);
STATIC HERROR xmgr_search_ziggo_CabMsgGwmTimer (XmgrSearch_CabContents_t *pstContents, HINT32 nTimerId);
STATIC HERROR xmgr_search_ziggo_CabEvtSiSearchDone (XmgrSearch_CabContents_t *pstContents);
STATIC HERROR xmgr_search_ziggo_CabEvtSiSearchFail (XmgrSearch_CabContents_t *pstContents);
STATIC HERROR xmgr_search_ziggo_CabEvtChLocked (XmgrSearch_CabContents_t *pstContents);
STATIC HERROR xmgr_search_ziggo_CabEvtChNoSignal (XmgrSearch_CabContents_t *pstContents);
...
//			eOperator = MWC_PARAM_GetOperatorType();
	...
	// 5-1. TP List :
	xmgr_search_ziggo_CabMakeTpList(pstContents, pstOption);
	...
	if (pstContents->pstTpToSearch == NULL)
	{
		...
		xmgr_search_ziggo_CabSendUpdateDisplayMsg(pstContents);
...
STATIC HERROR xmgr_search_ziggo_CabMakeTpList (XmgrSearch_CabContents_t* pstContents, MgrSearch_Option_t *pstOption)
{
	...
	{
		HxLOG_Info("xmgr_search_ziggo_CabMakeTpList() invalid argument(ulTpNum:%d). line(%d)\n", pstOption->ulTpNum, __LINE__);

		pstTuneInfo = NULL;
		if(MGR_TPLIST_GetFirstTuneInfo(&pstTuneInfo) != ERR_OK || pstTuneInfo == NULL)
		{
			HxLOG_Error("xmgr_search_ziggo_CabMakeTpList() is null.\n");
			return ERR_FAIL;
		}
		...
		while ((MGR_TPLIST_GetFirstTuneInfo(&pstTuneInfo)) == ERR_OK && pstTuneInfo != NULL)
		{
			...
			HxLOG_Print("[xmgr_search_ziggo_CabMakeTpList] NetID [%d][0x%x]\n",pstTuneInfo->cab.usNetworkId, pstTuneInfo->cab.usNetworkId);
	...
	{
		pstTuneInfo = xmgr_search_ziggo_CabAllocTuneInfo();
		if (NULL != pstTuneInfo)
		{
			*pstTuneInfo = pstOption->pstTpArray[ulCount].stTuningParam;
			...
			{
				xmgr_search_ziggo_CabFreeTuneInfo(pstTuneInfo);
				continue;
			}
			else
			{
...
STATIC HERROR xmgr_search_ziggo_CabSetTuningParamToSearch (XmgrSearch_CabContents_t *pstContents)
{
	...
	/* Tp info 변경 */
	xmgr_search_ziggo_CabChangeTpText (pstContents, NULL);

	/* status bar update */
	xmgr_search_ziggo_CabChangeProgressNumber (pstContents);
...
STATIC HERROR xmgr_search_ziggo_CabDestroyContents (XmgrSearch_CabContents_t *pstContents)
{
	...
	MGR_SEARCHDATA_ClearBouquetArray (&(pstContents->stBqArray));
 	...
 	pstContents->pstTpToSearch = UTIL_LINKEDLIST_FreeWholeListItemsFromPointerList (pstContents->pstTpToSearch, xmgr_search_ziggo_CabFreeTuneInfo);
 	pstContents->pstFinishedTps = UTIL_LINKEDLIST_FreeWholeListItemsFromPointerList (pstContents->pstFinishedTps, xmgr_search_ziggo_CabFreeTuneInfo);
...
STATIC HERROR xmgr_search_ziggo_CabTuneSearchTp (XmgrSearch_CabContents_t *pstContents)
{
	...
	while (bRetry == TRUE)
	{
		hErr = xmgr_search_ziggo_CabSetTuningParamToSearch (pstContents);
		if (hErr != ERR_OK)
		{
			HxLOG_Print("[xmgr_search_ziggo_CabTuneSearchTp] No Tp left to tune\n");
			pstContents->eAppState = eSearchApp_state_searchend;
			return ERR_BUS_NO_OBJECT;
		}
		...
		if (hErr != ERR_OK)
		{
			HxLOG_Print("[xmgr_search_ziggo_CabTuneSearchTp] Tuner Stop Failed\n");
			pstContents->eAppState = eSearchApp_state_searchend;
			return ERR_BUS_NO_OBJECT;
		}
		...
		xmgr_search_ziggo_CabIncreaseSessionVersion (pstContents);			// Tuning 전에 반드시 Action Version을 업데이트해야 한다.
		...
		hErr = xmgr_search_ziggo_CabSetNextTpToSearch (pstContents);
		if (hErr != ERR_OK)
		{
			HxLOG_Print("[xmgr_search_ziggo_CabTuneSearchTp] No Next Tp left to tune\n");
			pstContents->eAppState = eSearchApp_state_searchend;
			bRetry = FALSE;
...
STATIC HERROR xmgr_search_ziggo_CabRetrieveResults (XmgrSearch_CabContents_t* pstContents)
{
	HERROR					hErr;
	HINT32					nTsNumInDb;
	HUINT32					ulIndex, ulSubIndex, ulItemNum;
	HUINT32					ulBqNum, ulPrvNum, ulDeliNum, ulTsNum, ulSvcNum, ulSvcTpNum;
	...
	DbSvc_TsInfo_t			*pstTsInfo = NULL, *pstDeliInfo = NULL;
	DbSvc_NetInfo_t			*pstNetInfo = NULL;
	DbSvc_Info_t			*astSvcArray = NULL, *astSvcTpArray = NULL;
	...
	//------------------------------------------------------------------------------
	// 2. Delivery system info
	hErr = SVC_SI_CountSearchedResult(pstContents->ulActionId, eSI_SRCH_INFOTYPE_Delivery, &ulDeliNum);
	if (hErr != ERR_OK)					{ ulDeliNum = 0; }
	...
	pstDeliInfo = (DbSvc_TsInfo_t *)OxAP_Malloc (sizeof(DbSvc_TsInfo_t) * ulDeliNum);
	if (pstDeliInfo == NULL)
	{
		HxLOG_Critical("\n\n");
		hErr = ERR_BUS_OUT_OF_MEMORY;
	...
	hErr = SVC_SI_GetSearchedResults(pstContents->ulActionId, eSI_SRCH_INFOTYPE_Delivery, ulDeliNum, &ulInfoNum, (void *)pstDeliInfo);
	if (hErr != ERR_OK)
	{
		HxLOG_Critical("\n\n");
		hErr = ERR_BUS_NO_OBJECT;
	...
	pstTsInfo = (DbSvc_TsInfo_t *)OxAP_Malloc (sizeof(DbSvc_TsInfo_t) * ulTsNum);
	if (pstTsInfo == NULL)
	{
		HxLOG_Critical("\n\n");
		hErr = ERR_BUS_OUT_OF_MEMORY;
	...
	hErr = SVC_SI_GetSearchedResults(pstContents->ulActionId, eSI_SRCH_INFOTYPE_Transponder, ulTsNum, &ulInfoNum, (void *)pstTsInfo);
	if (hErr != ERR_OK)
	{
		HxLOG_Critical("\n\n");
		hErr = ERR_BUS_NO_OBJECT;
	...
	{
		pstCurrTuneInfo = NULL;
		// SI에서 올려준 TS Info에 실제 물리적 Tuning Info 등을 추가하여 DB에 저장할 수 있는 data로 변환한다.
		if (pstTsInfo[ulIndex].usTsIdx == 1)
		{
			HxLOG_Print("\n\t ====> Current TS info(0x%x:0x%x) [index=%d]\n", pstTsInfo[ulIndex].usOnId, pstTsInfo[ulIndex].usTsId, ulIndex);
			...
			{
				pstCurrTuneInfo = xmgr_search_ziggo_CabGetCurrentTuningInfo (pstContents);
			}
		}
		else
		{
			HxLOG_Print("\n\t ====> Other TS info(0x%x:0x%x) [index=%d]\n", pstTsInfo[ulIndex].usOnId, pstTsInfo[ulIndex].usTsId, ulIndex);
			for (ulSubIndex = 0; ulSubIndex < ulDeliNum; ulSubIndex++)
			{
				if ( (pstTsInfo[ulIndex].usOnId == pstDeliInfo[ulSubIndex].usOnId)
					&& (pstTsInfo[ulIndex].usTsId == pstDeliInfo[ulSubIndex].usTsId) )
				{
					break;
				}
			}

			if (ulSubIndex < ulDeliNum)
			{
				pstCurrTuneInfo = &(pstDeliInfo[ulSubIndex].stTuningParam);
			}
		}
		...
		HxLOG_Print("\t ====> Tuning info(Net_ID:0x%x, Freq:%d, SR:%d, Spectrum:%d, Constellation:%d)\n",
			pstCurrTuneInfo->cab.usNetworkId, pstCurrTuneInfo->cab.ulFreq, pstCurrTuneInfo->cab.usSR, pstCurrTuneInfo->cab.ucSpec, pstCurrTuneInfo->cab.ucCon);

		// Tuner ID
		pstTsInfo[ulIndex].ucTunerId = (HUINT8)pstContents->ulTunerId;
		// Current TP Info
		HxSTD_memcpy (&(pstTsInfo[ulIndex].stTuningParam), pstCurrTuneInfo, sizeof(DbSvc_TuningInfo_t));

		pstTsInfo[ulIndex].eDeliType = eDxDELIVERY_TYPE_CAB;
	}
	...
	if (pstNetInfo != NULL)
	{
		HxLOG_Print("\n\n\n[xmgr_search_ziggo_CabRetrieveResults] Network Name [%s]\n", pstNetInfo->szNetName);
		...
		if (hErr == ERR_OK)
		{
			if (pstNetInfo->szNetName[0] != '\0')
			{
				...
				{
					HxLOG_Print("[xmgr_search_ziggo_CabRetrieveResults(%04d)] Network Name [%s], Network ID [%d]\n\n\n\n", __LINE__, pstNetInfo->szNetName, pstNetInfo->usNetId);
	...
	for (ulIndex = 0; ulIndex < ulTsNum; ulIndex++)
	{
		pstTsInfo[ulIndex].usNetIdx = (HUINT16)ulTempNetIdx;
		hErr = MGR_SEARCHDATA_AddTs (&(pstContents->stTsArray), &(pstTsInfo[ulIndex]), &ulTempTsIdx);
		if (hErr != ERR_OK)
		{
			HxLOG_Critical("\n\n");
			hErr = ERR_FAIL;
		...
		//------------------------------------------------------------------------------
		if (1) //if (pstTsInfo[ulIndex] != NULL)
		{
			pstTsInfo[ulIndex].usNetIdx = usNetIdx;
			pstTsInfo[ulIndex].eDeliType = eDxDELIVERY_TYPE_CAB;

			// TS Info가 OnId, TsId로 등록되어 있는 지 확인한다.
			DB_SVC_InitTsFindCondition (&stTsCond);
			stTsCond.nDeliType	= eDxDELIVERY_TYPE_CAB;
			stTsCond.nOnId		= (HINT32)pstTsInfo[ulIndex].usOnId;
			stTsCond.nTsId		= (HINT32)pstTsInfo[ulIndex].usTsId;

			bNewTs = TRUE;
			nTsNumInDb = 0;
			pstTsInfoInDb = NULL;

			HxLOG_Print("\n\t ====> Save TS info(0x%x:0x%x) [index=%d]\n", pstTsInfo[ulIndex].usOnId, pstTsInfo[ulIndex].usTsId, ulIndex);
			...
			if (hErr == ERR_OK && nTsNumInDb > 0 && pstTsInfoInDb != NULL)
			{
				...
				if (DB_SVC_UtilCompareDbTuningParam(eDxDELIVERY_TYPE_CAB, &(pstTsInfo[ulIndex].stTuningParam), &(pstTsInfoInDb[0].stTuningParam)) != 0)
				{
					DB_SVC_UpdateTsInfo (usTsIdx, &(pstTsInfo[ulIndex]));
					HxLOG_Print("\t\t= [TS] tempIdx = %d, tsIdx = %d --> update\n", ulTempTsIdx, usTsIdx);
				}
			}

			HxLOG_Print("\t ====> Save Tuning info(Net_ID:0x%x, Freq:%d, SR:%d, Spectrum:%d, Constellation:%d), NewTP(%d)",
						pstTsInfo[ulIndex].stTuningParam.cab.usNetworkId, pstTsInfo[ulIndex].stTuningParam.cab.ulFreq, pstTsInfo[ulIndex].stTuningParam.cab.usSR, pstTsInfo[ulIndex].stTuningParam.cab.ucSpec, pstTsInfo[ulIndex].stTuningParam.cab.ucCon, bNewTs);

			if (bNewTs == TRUE)
			{
				DB_SVC_AddTsInfo (&(pstTsInfo[ulIndex]), &usTsIdx);
				HxLOG_Print("\t\t= [TS] tempIdx = %d, tsIdx = %d --> update\n", ulTempTsIdx, usTsIdx);
			}
		...
		// 6-5. Service Info
		/* TP단위 service gathering */
		ulSvcTpNum = 0;
		for (ulSubIndex = 0; ulSubIndex < ulSvcNum; ulSubIndex++)
		{
			if ( (astSvcArray[ulSubIndex].usOnId == pstTsInfo[ulIndex].usOnId)
				&& (astSvcArray[ulSubIndex].usTsId == pstTsInfo[ulIndex].usTsId) )
			{
				ulSvcTpNum++;
			}
		}
		...
		HxLOG_Print("\t ====> Save Service info [Sub_Total=%d]\n", ulSvcTpNum);
		astSvcTpArray = (DbSvc_Info_t *)OxAP_Malloc (sizeof(DbSvc_Info_t) * ulSvcTpNum);
		if (astSvcTpArray == NULL)
		{
			HxLOG_Critical("\n\n");
			hErr = ERR_BUS_OUT_OF_MEMORY;
			goto ERROR_FAULT_OCCURRED;
		...
		for (ulSubIndex = 0; ulSubIndex < ulSvcNum; ulSubIndex++)
		{
			if ( (astSvcArray[ulSubIndex].usOnId == pstTsInfo[ulIndex].usOnId)
				&& (astSvcArray[ulSubIndex].usTsId == pstTsInfo[ulIndex].usTsId) )
			{
				astSvcTpArray[ulSvcTpNum] = astSvcArray[ulSubIndex];
				ulSvcTpNum++;
			}
		}

		for (ulSubIndex = 0; ulSubIndex < ulSvcTpNum; ulSubIndex++)
		{
			if (MGR_SEARCHUTIL_CompareSearchedSvcType (pstContents->eServiceType, DbSvc_GetSvcType(&astSvcTpArray[ulSubIndex])) == TRUE)
			{
				DbSvc_SetDeliType(astSvcTpArray[ulSubIndex], eDxDELIVERY_TYPE_CAB);
				DbSvc_SetOnId(&astSvcTpArray[ulSubIndex], pstTsInfo[ulIndex].usOnId);
				DbSvc_SetTsId(&astSvcTpArray[ulSubIndex], pstTsInfo[ulIndex].usTsId);
				DbSvc_SetTsIdx(&astSvcTpArray[ulSubIndex], usTsIdx);
				DbSvc_SetPrvIdx(&astSvcTpArray[ulSubIndex], 0);   // TODO
			}
		}

		peSvcFlagArray = (SRCHSVC_AppendFlag_t *)OxAP_Malloc (sizeof(SRCHSVC_AppendFlag_t) * ulSvcTpNum);
		...
		hErr = SVC_SI_SetLcnServiceNumber(pstContents->hAction, bNewTs, ulSvcTpNum, astSvcTpArray, peSvcFlagArray);
		if (hErr != ERR_OK)
		{
			HxLOG_Critical("\n\n");
			hErr = ERR_FAIL;
		...
		for (ulSubIndex = 0; ulSubIndex < ulSvcTpNum; ulSubIndex++)
		{
			switch (peSvcFlagArray[ulSubIndex])
			{
			case eSRCHSVC_ADD:
				HxLOG_Print(">>> ADD    : %04d, [%s]\n", DbSvc_GetLcn(&astSvcTpArray[ulSubIndex]), DbSvc_GetName(&astSvcTpArray[ulSubIndex]));
				DB_SVC_AddServiceInfo (&astSvcTpArray[ulSubIndex], &hSvc);

				// Add the service lists in the GUI :
				DbSvc_SetSvcIdx(&astSvcArray[ulIndex], DB_SVC_GetServiceUID(hSvc));
				MGR_SEARCHRESULT_AddService (pstContents->ulActionId, &astSvcTpArray[ulSubIndex]);
				break;

			case eSRCHSVC_UPDATE:
				HxLOG_Print(">>> UPDATE : %04d, [%s]\n", DbSvc_GetLcn(&astSvcTpArray[ulSubIndex]), DbSvc_GetName(&astSvcTpArray[ulSubIndex]));
				hErr = xmgr_search_ziggo_CabGetServiceHandle (DbSvc_GetTsIdx(&astSvcTpArray[ulSubIndex]), DbSvc_GetTsId(&astSvcTpArray[ulSubIndex]), DbSvc_GetSvcId(&astSvcTpArray[ulSubIndex]), DbSvc_GetOnId(&astSvcTpArray[ulSubIndex]), &hSvc);
				if (hErr == ERR_OK)
				{
					DB_SVC_UpdateServiceInfo (hSvc, &astSvcTpArray[ulSubIndex]);
					DbSvc_SetSvcIdx(&astSvcArray[ulIndex], DB_SVC_GetServiceUID(hSvc));
...
STATIC HERROR xmgr_search_ziggo_CabRetrieveResults (XmgrSearch_CabContents_t* pstContents)
{
	...
	for (ulIndex = 0; ulIndex < ulSvcNum; ulIndex++)
	{
		...
		case eSRCHSVC_UPDATE:
			HxLOG_Print(">>> UPDATE : %04d, [%s]\n", DbSvc_GetLcn(&astSvcArray[ulIndex]), DbSvc_GetName(&astSvcArray[ulIndex]));
			hErr = xmgr_search_ziggo_CabGetServiceHandle (DbSvc_GetTsIdx(&astSvcArray[ulIndex]), DbSvc_GetTsId(&astSvcArray[ulIndex]), DbSvc_GetSvcId(&astSvcArray[ulIndex]), DbSvc_GetOnId(&astSvcArray[ulIndex]), &hSvc);
			if (hErr == ERR_OK)
			{
...
STATIC HERROR xmgr_search_ziggo_CabAddDeliveryInfoInTpList (XmgrSearch_CabContents_t *pstContents)
{
	...
	for (ulIndex = 0; ulIndex < ulNumDeliInfo; ulIndex++)
	{
		...
		pstFound = UTIL_LINKEDLIST_FindNthListItemFromPointerList (pstContents->pstFinishedTps, 0,
																xmgr_search_ziggo_CabFilterSameTuningInfo,
		...
		while (pstFound != NULL)
		{
			pstNextTpList = UTIL_LINKEDLIST_DeleteListItemFromPointerList (pstNextTpList, pstFound, xmgr_search_ziggo_CabFreeTuneInfo);
			UTIL_LINKEDLIST_CircularizePointerList (pstNextTpList);
		...
		// 4. Delivery TP를 추가
		pstDeliSvcTuneInfo = xmgr_search_ziggo_CabAllocTuneInfo();
	...
	UTIL_LINKEDLIST_CircularizePointerList (pstContents->pstTpToSearch);
	UTIL_LINKEDLIST_FreeWholeListItemsFromPointerList (pstRest, xmgr_search_ziggo_CabFreeTuneInfo);
...
STATIC HERROR xmgr_search_ziggo_CabRemoveNearTP(XmgrSearch_CabContents_t *pstContents)
{
	...
	HxLOG_Info("\t[xmgr_search_ziggo_CabRemoveNearTP] ++ \n");
	...
	HxLOG_Info("\t[xmgr_search_ziggo_CabRemoveNearTP] Current Locked TP Freq(%d)  \n", ulLockedFreq);
			...
			&& (pstTraverse != pstSrchTps) )
	{
		...
		{
			HxLOG_Info("\t[xmgr_search_ziggo_CabRemoveNearTP] Remove TP Freq(%d)  \n", pstTuneInfo->cab.ulFreq);
		...
		{
			// finish
			HxLOG_Info("\t[xmgr_search_ziggo_CabRemoveNearTP] Freq check finish \n");
			break;
		}
...
STATIC HERROR xmgr_search_ziggo_CabMsgGwmCreate (XmgrSearch_CabContents_t *pstContents, Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	HxLOG_Info("\t[xmgr_search_ziggo_CabMsgGwmCreate] hAction (%08x)\n", hAction);
	...
	xmgr_search_ziggo_CabInitContents (pstContents, hAction, pstOption);
...
STATIC HERROR xmgr_search_ziggo_CabMsgGwmDestroyed (XmgrSearch_CabContents_t *pstContents)
{
	...
	if (pstContents->eAppState != eSearchApp_state_searchend)
	{
		...
		xmgr_search_ziggo_CabReleaseAction (pstContents);
	}
	...
	xmgr_search_ziggo_CabDestroyContents (pstContents);

	// Send the destoyed message to the UI procedure
	xmgr_search_ziggo_CabSendSearchActionDestroyed(pstContents->hAction);
...
STATIC HERROR xmgr_search_ziggo_CabMsgAppSearchActionStart (XmgrSearch_CabContents_t *pstContents, HINT32 nAppHandle)
{
	...
	xmgr_search_ziggo_CabSetTuningParamToSearch(pstContents);
	...
	// Tune the TP
	hErr = xmgr_search_ziggo_CabTuneSearchTp (pstContents);
	if (hErr != ERR_OK)
	{
		HxLOG_Print("[xmgr_search_ziggo_CabMsgAppSearchActionStart] No Next Tp left to tune\n");
		pstContents->eAppState = eSearchApp_state_searchend;
	}

	xmgr_search_ziggo_CabSendSearchStartedMsg (pstContents->hAction);

	if (pstContents->eAppState == eSearchApp_state_searchend)
	{
		xmgr_search_ziggo_CabSendSearchFinished(pstContents->hAction);
		xmgr_search_ziggo_CabReleaseAction (pstContents);
	}
...
STATIC HERROR xmgr_search_ziggo_CabMsgAppSearchSaveResult (XmgrSearch_CabContents_t *pstContents, HINT32 nAppHandle)
{
	...
	if (pstContents->eAppState == eSearchApp_state_searchend)
	{
		MGR_ACTION_BgJobExecuteFunction (xmgr_search_ziggo_CabSaveResult, pstContents->hAction, (HUINT32)pstContents, 0, 0);
	}
	else
	{
		xmgr_search_ziggo_CabSendSearchSaveFinishedMsg(pstContents->hAction);
	}
...
STATIC HERROR xmgr_search_ziggo_CabMsgAppSearchFinished(XmgrSearch_CabContents_t *pstContents, HINT32 nAppHandle)
{
	if (pstContents->eAppState == eSearchApp_state_searchend)
	{
		xmgr_search_ziggo_CabSendSearchSaveFinishedMsg(pstContents->hAction);
...
STATIC HERROR xmgr_search_ziggo_CabMsgAppSearchSaveFinished(XmgrSearch_CabContents_t *pstContents, HINT32 nAppHandle)
{
	if (pstContents->eAppState == eSearchApp_state_searchend)
	{
		BUS_MGR_Destroy (NULL);
...
STATIC HERROR xmgr_search_ziggo_CabMsgAppBgJobFinished (XmgrSearch_CabContents_t *pstContents, HINT32 nCbPtr, HINT32 nResult)
{
	...
	if (nCbPtr == (HINT32)xmgr_search_ziggo_CabSaveResult)
	{
		xmgr_search_ziggo_CabSendSearchSaveFinishedMsg(pstContents->hAction);
		return MESSAGE_BREAK;
	}
...
STATIC HERROR xmgr_search_ziggo_CabMsgGwmTimer (XmgrSearch_CabContents_t *pstContents, HINT32 nTimerId)
{
	...
	case SEARCH_TIMER_LOCKING_ID:
		...
		if (pstContents->eAppState == eSearchApp_state_tryTuning)
		{
			...
			if (hErr != ERR_OK)
			{
				HxLOG_Print("[xmgr_search_ziggo_CabMsgGwmTimer] No Next Tp left to tune\n");
				pstContents->eAppState = eSearchApp_state_searchend;
			}
		}
	...
	case SEARCH_TIMER_SI_ID:
		...
		if (pstContents->eAppState == eSearchApp_state_waitingSi)
		{
			...
			if (hErr != ERR_OK)
			{
				HxLOG_Print("[xmgr_search_ziggo_CabMsgGwmTimer] Cannot proceed anymore\n");
				pstContents->eAppState = eSearchApp_state_searchend;
			}
		}
...
STATIC HERROR xmgr_search_ziggo_CabEvtSiSearchDone (XmgrSearch_CabContents_t *pstContents)
{
	...
	case eSearchApp_state_waitingSi:
		...
		hErr = xmgr_search_ziggo_CabRetrieveResults (pstContents);
		{
			HERROR		hError;
			...
			xmgr_search_ziggo_CabChangeTpText (pstContents, pstNetInfo);
			xmgr_search_ziggo_CabSendUpdateDisplayMsg(pstContents);
		}

		if (hErr == ERR_OK && pstContents->bNetworkSearch == TRUE)
		{
			xmgr_search_ziggo_CabAddDeliveryInfoInTpList (pstContents);
		}
		...
		if (hErr != ERR_OK)
		{
			HxLOG_Print("[xmgr_search_ziggo_CabEvtSiSearchDone] No Next Tp left to tune\n");
			pstContents->eAppState = eSearchApp_state_searchend;
		}
...
STATIC HERROR xmgr_search_ziggo_CabEvtSiSearchFail (XmgrSearch_CabContents_t *pstContents)
{
	...
	case eSearchApp_state_waitingSi:
		...
		if (hErr != ERR_OK)
		{
			HxLOG_Print("[xmgr_search_ziggo_CabEvtSiSearchFail] No Next Tp left to tune\n");
			pstContents->eAppState = eSearchApp_state_searchend;
			break;
		}
...
STATIC HERROR xmgr_search_ziggo_CabEvtChLocked (XmgrSearch_CabContents_t *pstContents)
{
	...
	case eSearchApp_state_tryTuning :
		...
		HxLOG_Print("[xmgr_search_ziggo_CabEvtChLocked] pstContents->bNetworkSearch [%d] \n", pstContents->bNetworkSearch);
		HxLOG_Print("[xmgr_search_ziggo_CabEvtChLocked] pstContents->usNetworkId [%d][0x%x] \n", pstContents->usNetworkId, pstContents->usNetworkId);
			...
			&& (pstContents->bNetworkSearch == FALSE) )
		{
			...
			hErr = xmgr_search_ziggo_CabRemoveNearTP(pstContents);
			if (hErr != ERR_OK)
			{
				HxLOG_Print("[xmgr_search_ziggo_CabEvtChLocked] xmgr_search_ziggo_CabRemoveNearTP() FAIL \n");
			}
		}

		HxLOG_Print("[xmgr_search_ziggo_CabEvtChLocked] MW_SI_StartSearch() Network ID [%d] \n", ulNetId);
		{
		    ...
		    else
		    {
			    ...
			    if (hErr != ERR_OK)
			    {
				    HxLOG_Print("[xmgr_search_ziggo_CabEvtChLocked] No Next Tp left to tune\n");
				    pstContents->eAppState = eSearchApp_state_searchend;
			    }
		    }
		}
...
STATIC HERROR xmgr_search_ziggo_CabEvtChNoSignal (XmgrSearch_CabContents_t *pstContents)
{
	...
	case eSearchApp_state_tryTuning :
		...
		if (hErr != ERR_OK)
		{
			HxLOG_Print("[xmgr_search_ziggo_CabEvtChNoSignal] No Next Tp left to tune\n");
			pstContents->eAppState = eSearchApp_state_searchend;
		}
	...
	case eSearchApp_state_waitingSi:
		...
		else
		{
			...
			HxLOG_Print("[xmgr_search_ziggo_CabEvtChNoSignal] SI Re-open failed.\n");
			pstContents->eAppState = eSearchApp_state_searchend;
		}
...
__search_time_trace_start__;
		hErr = xmgr_search_ziggo_CabMsgGwmCreate (pstContents, hAction, p1, p2, p3);
		if (hErr == MESSAGE_BREAK)					{ return MESSAGE_BREAK; }
		break;

	case eMEVT_BUS_TIMER:
		HxLOG_Info("\t[eMEVT_BUS_TIMER]\n\n");
		hErr = xmgr_search_ziggo_CabMsgGwmTimer (pstContents, p1);
		if (hErr == MESSAGE_BREAK)					{ return MESSAGE_BREAK; }
		break;

	case eMEVT_BUS_DESTROY:
		HxLOG_Info("\t[eMEVT_BUS_DESTROY]\n\n");
		hErr = xmgr_search_ziggo_CabMsgGwmDestroyed (pstContents);
		if (hErr == MESSAGE_BREAK)					{ return MESSAGE_BREAK; }
		break;

	case eMEVT_SEARCH_ACTION_START:
		HxLOG_Info("\t[eMEVT_SEARCH_ACTION_START]\n\n");
		hErr = xmgr_search_ziggo_CabMsgAppSearchActionStart (pstContents, p1);
		if (hErr == MESSAGE_BREAK)					{ return MESSAGE_BREAK; }
		break;

	case eMEVT_SEARCH_SAVE_RESULT:
		HxLOG_Info("\t[eMEVT_SEARCH_SAVE_RESULT]\n\n");
		hErr = xmgr_search_ziggo_CabMsgAppSearchSaveResult (pstContents, p1);
		if (hErr == MESSAGE_BREAK)					{ return MESSAGE_BREAK; }
		break;

	case eMEVT_SEARCH_CANCEL:
		HxLOG_Info("\t[eMEVT_SEARCH_CANCEL]\n\n");
		hErr = xmgr_search_ziggo_CabMsgAppSearchCancel (pstContents, p1);
		if (hErr == MESSAGE_BREAK)					{ return MESSAGE_BREAK; }
		break;

	case eMEVT_SEARCH_FINISHED:
		HxLOG_Info("\t[eMEVT_SEARCH_FINISHED]\n\n");
		hErr =xmgr_search_ziggo_CabMsgAppSearchFinished (pstContents, p1);
		if (hErr == MESSAGE_BREAK)					{ return MESSAGE_BREAK; }
		break;

	case eMEVT_ACTION_NOTIFY_BGJOB_FINISHED:
		HxLOG_Info("\t[eMEVT_ACTION_NOTIFY_BGJOB_FINISHED]\n\n");
		hErr = xmgr_search_ziggo_CabMsgAppBgJobFinished (pstContents, p1, p2);
		if (hErr == MESSAGE_BREAK)					{ return MESSAGE_BREAK; }
		break;

	case eMEVT_SEARCH_ACTION_KILL:
		HxLOG_Info("\t[eMEVT_SEARCH_ACTION_KILL]\n\n");
		hErr = xmgr_search_ziggo_CabMsgAppSearchKillProcesses (pstContents);
		if (hErr == MESSAGE_BREAK)					{ return MESSAGE_BREAK; }
		break;

	case eSEVT_SI_SEARCH_DONE:
		hErr = xmgr_search_ziggo_CabCheckActionId (pstContents, hAction);
		if (hErr == MESSAGE_BREAK)			{ return MESSAGE_BREAK; }

		HxLOG_Info("\t[eSEVT_SI_SEARCH_DONE]\n\n");

		hErr = xmgr_search_ziggo_CabEvtSiSearchDone (pstContents);
		if (hErr == MESSAGE_BREAK)			{ return MESSAGE_BREAK; }
		break;
	...
	case eSEVT_SI_SEARCH_FAIL:
		...
		hErr = xmgr_search_ziggo_CabEvtSiSearchFail (pstContents);
		if (hErr == MESSAGE_BREAK)			{ return MESSAGE_BREAK; }
		break;
	...
	case eSEVT_CH_LOCKED:
		...
		hErr = xmgr_search_ziggo_CabEvtChLocked (pstContents);
		if (hErr == MESSAGE_BREAK)			{ return MESSAGE_BREAK; }
		break;
	...
	case eSEVT_CH_NO_SIGNAL:
		...
		hErr = xmgr_search_ziggo_CabEvtChNoSignal (pstContents);
		if (hErr == MESSAGE_BREAK)			{ return MESSAGE_BREAK; }
		return MESSAGE_BREAK;
		break;
	...
	case eMEVT_SEARCH_SAVE_FINISHED:
		...
		hErr = xmgr_search_ziggo_CabMsgAppSearchSaveFinished (pstContents, p1);
		if (hErr == MESSAGE_BREAK)					{ return MESSAGE_BREAK; }
		break;
...
BUS_Result_t		xproc_search_CabAction0_Ziggo (HINT32 message, Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	return xproc_search_CabProto_Ziggo(&(s_CabSrchApp_Contents[0]), message, hAction, p1, p2, p3);
}
...
BUS_Result_t		xproc_search_CabAction1_Ziggo (HINT32 message, Handle_t hAction, HINT32 p1, HINT32 p2, HINT32 p3)
{
	...
	return xproc_search_CabProto_Ziggo(&(s_CabSrchApp_Contents[1]), message, hAction, p1, p2, p3);
}
