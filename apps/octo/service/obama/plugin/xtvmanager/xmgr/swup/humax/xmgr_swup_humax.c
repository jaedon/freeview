...
} xmgrSwup_HumaxContents_t;

#define _____Static_Function_____


STATIC HERROR xmgr_swup_MakeEmergencySignalInfo_Humax(SvcSwUpdate_EmergencyUpdateInfo_t *pstEmergeInfo, SvcSwUpdate_DetectResult_t *pstDetectResult)
{
	...
	HxLOG_Print("[%s][%04d] eSource (%d) \n", __FUNCTION__, __LINE__, XMGR_SWUP_GetEnumStrOfSource(pstEmergeInfo->eSource));
#endif
...
// eSWUP_STATE_Init
STATIC HERROR xmgr_swup_EnterActionInit_Humax(Handle_t hSWUpdate, MgrSwup_State_e ePrevState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	HERROR  eRet = ERR_OK;
	...
	xmgrSwup_HumaxContents_t	*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
...
#if defined(CONFIG_DEBUG)
	HxLOG_Print("[%s][%04d] eSource(%s) szDetectUrl (%s) \n", __FUNCTION__, __LINE__, XMGR_SWUP_GetEnumStrOfSource(pstContents->eSource), szDetectUrl);
#endif
	{
		HERROR hErr;
		...
		HxLOG_Print("[%s][%04d] Initialization Emergency Info...\n",__FUNCTION__,__LINE__);
...
// eSWUP_STATE_Connect
STATIC HERROR xmgr_swup_EnterActionConnect_Humax(Handle_t hSWUpdate, MgrSwup_State_e ePrevState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
...
#if defined(CONFIG_DEBUG)
	HxLOG_Print("[%s][%04d]  eSource (%s) \n", __FUNCTION__, __LINE__, XMGR_SWUP_GetEnumStrOfSource(pstContents->eSource));
#endif
...
// eSWUP_STATE_Detect
STATIC HERROR xmgr_swup_EnterActionDetect_Humax(Handle_t hSWUpdate, MgrSwup_State_e ePrevState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t *)pvUserData;
...
#if defined(CONFIG_DEBUG)
	HxLOG_Print("[%s][%04d]  hSwUpHandle(0x%x) eSource(%s) \n", __FUNCTION__, __LINE__, hSWUpdate, XMGR_SWUP_GetEnumStrOfSource(pstContents->eSource));
#endif
...
STATIC HERROR xmgr_swup_EnterActionDownload_Humax(Handle_t hSWUpdate, MgrSwup_State_e ePrevState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
	...
	HxSTD_MemSet(&stOtaInfo, 0, sizeof(stOtaInfo));
...
// eSWUP_STATE_Install
STATIC HERROR xmgr_swup_EnterActionInstall_Humax(Handle_t hSWUpdate, MgrSwup_State_e ePrevState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t			*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
...

	{
		...
		HxLOG_Print("[%s,%d] Initialization Emergency Info...\n",__FUNCTION__,__LINE__);
		// detect 성공시 signaling 정보를 nvram 에 set 해준다.
		HxSTD_MemSet(pstEmergeInfo, 0, sizeof(SvcSwUpdate_EmergencyUpdateInfo_t));
		...
		{
			HxLOG_Print("\n[%s,%d] Emergency Info : RF\n",__FUNCTION__,__LINE__);
			HxLOG_Print("[%s,%d]eSource : 0x%X, DataVersion : %ld, eDeliType : 0x%X, downloadType: 0x%X, usPid : 0x%X \n",
				__FUNCTION__,__LINE__,
	...
	{
		case eDxSWUPDATE_SOURCE_Usb:
			HxLOG_Print("[%s](%d) eDxSWUPDATE_SOURCE_Usb Install....\n", __FUNCTION__, __LINE__);
			pszSourceFile = (HUINT8 *)nParam2;
			break;

		case eDxSWUPDATE_SOURCE_Rf:
			HxLOG_Print("[%s](%d) eDxSWUPDATE_SOURCE_Rf Install....\n", __FUNCTION__, __LINE__);
			pstSourceInfo->unInfo.stRfInfo.eDownloadType = eSWUP_DOWNLOAD_DVBSSU;
			break;

		case eDxSWUPDATE_SOURCE_Ip:
			{
				HxLOG_Print("[%s](%d) eDxSWUPDATE_SOURCE_Ip Install....\n", __FUNCTION__, __LINE__);
...
// eSWUP_STATE_Error
STATIC HERROR xmgr_swup_EnterActionError_Humax(Handle_t hSWUpdate, MgrSwup_State_e ePrevState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
...
// eSWUP_STATE_Finish
STATIC HERROR xmgr_swup_EnterActionFinish_Humax(Handle_t hSWUpdate, MgrSwup_State_e ePrevState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
...
// eSWUP_STATE_Init
STATIC HERROR xmgr_swup_LeaveActionInit_Humax(Handle_t hSWUpdate, MgrSwup_State_e eNextState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
...
// eSWUP_STATE_Connect
STATIC HERROR xmgr_swup_LeaveActionConnect(Handle_t hSWUpdate, MgrSwup_State_e eNextState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
...
// eSWUP_STATE_Detect
STATIC HERROR xmgr_swup_LeaveActionDetect_Humax(Handle_t hSWUpdate, MgrSwup_State_e eNextState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
	...
	if(nMessage == eMEVT_SWUP_NOTIFY_DETECT_SUCCESS)
	{
		...
		// detect 성공시 signaling 정보를 nvram 에 set 해준다.
		HxSTD_MemSet(pstEmergeInfo, 0, sizeof(SvcSwUpdate_EmergencyUpdateInfo_t));
		if (xmgr_swup_MakeEmergencySignalInfo_Humax(pstEmergeInfo, pstDetectResult) == ERR_OK)
		{
			HERROR hErr;
...
// eSWUP_STATE_Download
STATIC HERROR xmgr_swup_LeaveActionDownload_Humax(Handle_t hSWUpdate, MgrSwup_State_e eNextState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
	HERROR						hErr;
	...
	if(nMessage == eMEVT_SWUP_NOTIFY_DOWNLOAD_SUCCESS)
	{
		...
		if (MGR_ACTION_GetState()== eAmState_ACTIVE_STANDBY)
		{
			...
			if (pstDetectResult != NULL)
			{
				...
				if(hErr == ERR_OK)
				{
					...
					pszVersion = xmgr_swup_GetSwUpdateVersionString_Humax(TRUE, TRUE, szCurrentVersion, szNewSWVersion);
		...
		{
			HxLOG_Print("[%s,%d] Current State is eAmState_NORMAL\n",__FUNCTION__,__LINE__);
		}
#endif
	}
...
// eSWUP_STATE_Install
STATIC HERROR xmgr_swup_LeaveActionInstall_Humax(Handle_t hSWUpdate, MgrSwup_State_e eNextState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
...
// eSWUP_STATE_Error
STATIC HERROR xmgr_swup_LeaveActionError_Humax(Handle_t hSWUpdate, MgrSwup_State_e eNextState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
...
// eSWUP_STATE_Finish
STATIC HERROR xmgr_swup_LeaveActionFinish_Humax(Handle_t hSWUpdate, MgrSwup_State_e eNextState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	xmgrSwup_HumaxContents_t		*pstContents = (xmgrSwup_HumaxContents_t*)pvUserData;
...
BUS_Result_t	XMGR_SWUP_EnterAction_Humax(Handle_t hSWUpdate, MgrSwup_State_e eCurrState, MgrSwup_State_e ePrevState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	...
	case eSWUP_STATE_Init:
		hErr = xmgr_swup_EnterActionInit_Humax(hSWUpdate, ePrevState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Connect:
		hErr = xmgr_swup_EnterActionConnect_Humax(hSWUpdate, ePrevState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Detect:
		hErr = xmgr_swup_EnterActionDetect_Humax(hSWUpdate, ePrevState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Download:
		hErr = xmgr_swup_EnterActionDownload_Humax(hSWUpdate, ePrevState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Install:
		hErr = xmgr_swup_EnterActionInstall_Humax(hSWUpdate, ePrevState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Error:
		hErr = xmgr_swup_EnterActionError_Humax(hSWUpdate, ePrevState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Finish:
		hErr = xmgr_swup_EnterActionFinish_Humax(hSWUpdate, ePrevState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	default:
		break;
	}
...
BUS_Result_t	XMGR_SWUP_LeaveAction_Humax(Handle_t hSWUpdate, MgrSwup_State_e eCurrState, MgrSwup_State_e eNextState, void *pvUserData, HINT32 nMessage, Handle_t hAction, HINT32 nParam1, HINT32 nParam2, HINT32 nParam3)
{
	...
	{
	case eSWUP_STATE_Init:
		hErr = xmgr_swup_LeaveActionInit_Humax(hSWUpdate, eNextState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Connect:
		hErr = xmgr_swup_LeaveActionConnect(hSWUpdate, eNextState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Detect:
		hErr = xmgr_swup_LeaveActionDetect_Humax(hSWUpdate, eNextState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Download:
		hErr = xmgr_swup_LeaveActionDownload_Humax(hSWUpdate, eNextState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Install:
		hErr = xmgr_swup_LeaveActionInstall_Humax(hSWUpdate, eNextState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Error:
		hErr = xmgr_swup_LeaveActionError_Humax(hSWUpdate, eNextState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	case eSWUP_STATE_Finish:
		hErr = xmgr_swup_LeaveActionFinish_Humax(hSWUpdate, eNextState, pvUserData, nMessage, hAction, nParam1, nParam2, nParam3);
		break;
	default:
		break;
	}
...
void * XMGR_SWUP_Create_Humax(void *pvUserData, DxBatchType_e eBatchProcess)
{
	...
	xmgrSwup_HumaxContents_t	*pstContents;

	HxLOG_Print("[%s][%04d] ====== (+) \n", __FUNCTION__, __LINE__);

	pstContents = (xmgrSwup_HumaxContents_t*)HLIB_STD_MemCalloc(sizeof(xmgrSwup_HumaxContents_t));
...
HERROR XMGR_SWUP_Destroy_Humax(void *pvContents)
{
	HxLOG_Print("[%s][%04d] ====== (+) \n", __FUNCTION__, __LINE__);
...
HCHAR	*XMGR_SWUP_GetSwUpdateVersionString_Humax (HBOOL bDetected, HBOOL bStandby, HCHAR *pszCurVer, HCHAR *pszFoundVer)
{
	...
	return xmgr_swup_GetSwUpdateVersionString_Humax(bDetected, bStandby, pszCurVer, pszFoundVer);
}
