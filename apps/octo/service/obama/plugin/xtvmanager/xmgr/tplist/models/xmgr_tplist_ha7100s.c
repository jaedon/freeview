...
HERROR	xmgr_tplist_GetSatHomeTuningInfoList_Ha7100s(DbSvc_SatTuningInfo_t **pastList, HINT32 *pnNumList)
{
#if	defined(CONFIG_MW_CH_SATELLITE)
	static DbSvc_SatTuningInfo_t	 s_stTuneInfo_Ha7100s_ASTRA[] =
	{
	...
	*pastList = s_stTuneInfo_Ha7100s_ASTRA;
	*pnNumList = (sizeof(s_stTuneInfo_Ha7100s_ASTRA) / sizeof(DbSvc_SatTuningInfo_t));
	return ERR_OK;
#else
	*pastList = NULL;
	*pnNumList = 0;
...
STATIC HERROR xmgr_tplist_GetHomeTpListOta_Ha7100s (DbSvc_TsInfo_t **ppstTsList, HUINT32 *pulNumTs)
{
	...
	ulNumTs = 0;
#if	defined(CONFIG_MW_CH_SATELLITE)
	hErr = xmgr_tplist_GetSatHomeTuningInfoList_Ha7100s(&astSatList, &nNumList);
...
HERROR xmgr_tplist_GetHomeTpList_Ha7100s (MgrTplist_HomeTsKind_e eHomeTsKind, DbSvc_TsInfo_t **ppstTsList, HUINT32 *pulNumTs)
{
	...
	case eHomeTs_OTA:		hErr = xmgr_tplist_GetHomeTpListOta_Ha7100s(ppstTsList, pulNumTs);		break;
	default:				break;
	}
