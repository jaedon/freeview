...
CALLBACK_HANDLE Callback_CreateList(void)
{
	...
	hList = (CALLBACK_HANDLE)OxCAS_Malloc(sizeof(CALLBACK_LIST));
...
void Callback_DeleteList(CALLBACK_HANDLE hList)
{
	...
	if (hList == NULL)
	{
		HxLOG_Print("Callback_DeleteList : input handle is NULL !!\n");
		return;
	}
...
CALLBACK_HANDLE Callback_AddFunc(CALLBACK_HANDLE hList, void *pFunc)
{
	...
	if (hList == NULL || pFunc == NULL)
	{
		HxLOG_Print("Callback_AddFunc : input handle is NULL !!\n");
		return NULL;
	}
	...
	hNode = (CALLBACK_HANDLE)OxCAS_Malloc(sizeof(CALLBACK_LIST));
...
void Callback_RemoveFunc(CALLBACK_HANDLE hList, void *pFunc)
{
	...
	if (hList == NULL || pFunc == NULL)
	{
		HxLOG_Print("Callback_RemoveFunc : input handle is NULL !!\n");
		return;
	}
...
void Callback_Reset(CALLBACK_HANDLE hList)
{
	...
	if (hList == NULL)
	{
		HxLOG_Print("Callback_Reset : input handle is NULL !!\n");
		return;
	}
...
void *Callback_GetNextFunc(CALLBACK_HANDLE hList)
{
	...
	if (hList == NULL)
	{
		HxLOG_Print("Callback_GetNextFunc : input handle is NULL !!\n");
		return NULL;
	}
...
unsigned char Callback_GetNumFunc(CALLBACK_HANDLE hList)
{
	...
	if (hList == NULL)
	{
		HxLOG_Print("Callback_GetNumFunc : input handle is NULL !!\n");
		return 0;
	}
