...
/* Symbol Definitions                                                       */
/*--------------------------------------------------------------------------*/
#define MAXTCID		2	/* Max count of transport connections */ /* hmkim, 2010-03 : modified. org is 8 */ /* 스펙에선 at least 16 simultaneous transport connections 를 지원해야 한다고 되어 있음 */
#define MAXSSNB	   32	/* Max count of sessions */ /* 스펙에선 at least 128 simultaneous sessions 를 지원해야 한다고 되어 있음 */
...
typedef struct {			/* hmkim, 2010-03 : modified. org is union */
