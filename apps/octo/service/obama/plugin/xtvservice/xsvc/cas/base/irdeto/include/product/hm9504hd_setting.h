...
#define IRPLAT_FN_DDEMM_USER_PAYLOAD_FOR_DIGITURK

/* Followins are only used in octo application but not in loader */
#define FLASH_BASE_ADDR_APPL			0

#define FLASH_APPL_BLOCK_SIZE		(512*1024)
#define FLASH_LOADER_BLOCK_SIZE	(512*1024)
...
#define FLASH_TOTAL_PARTITION_COUNT			82  //for 128 Mb, NAND only, octo 1.0
#define FLASH_TOTAL_SIZE				(41*1024*1024)

//#define IR_FLASH_BBCB_OFFSET	(0x00400000 - IR_BBCB_SIZE)
...
#define IR_PARTITION_IRDETO_SPCB_OFFSET	(IR_PARTITION_IRDETO_BACKUP_OFFSET+IR_PARTITION_IRDETO_BACKUP_SIZE)//0x1400
#define IR_PARTITION_IRDETO_SPCB_SIZE				IR_CPCB_SIZE	//(8*1024)
...
#define IR_PARTITION_LOADER_OFFSET_ucLNBTYPE			17		// (1)	LNB type MDU/MDU2/MDU3/MDU4/MDU5/Universal
