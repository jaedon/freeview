...
#include "irv5_dev.h" // for lch type.

/* Client device type restrictions. */
#if !defined (DVB_CLIENT) && !defined (IP_CLIENT)
    #error "Error pre-compile options, at least one of DVB_CLIENT and IP_CLIENT shall be enabled!"
#endif
 ...
 */
 // TODO: CAUTIONS
 // TODO: by jichoi. we must use only Apis prototypes declarations.
 // TODO:  20160129
 ...
 *     Other The method may return any other errors listed in \ref result "Result Code List".
 */
// TODO:  jichoi. lc_result LoaderCoreAPI_WriteBBCB(lc_bool updateCRC, const lc_bbcb_parameters *pBBCBParameters);
...
// TODO:  jichoi. lc_result LoaderCoreAPI_ReadBBCB(lc_bbcb_parameters *pBBCBParameters, lc_bool *pUpdateCRC);
 ...
 *     Other The method may return any other errors listed in \ref result "Result Code List".
 */
// TODO:  jichoi. lc_result LoaderCoreAPI_WriteDVBSSUParameters(    const lc_dvb_ssu_parameters *pDvbssuParameters,    const lc_buffer_st *pPrivateData);
 ...
 *     Other The method may return any other errors listed in \ref result "Result Code List".
 */
// TODO:  jichoi. lc_result LoaderCoreAPI_ReadDVBSSUParameters( lc_dvb_ssu_parameters *pDvbssuParameters);
...
/** @defgroup IPDownloadAPIs IP Download helper APIs
 *  IP Download helper APIs
 *
 *  These API methods provide helper functions to high level application for IP Download.
 *
 *  @{
 */
...
/**
 * IP multicast parameters structure
 *
 * This structure is used to save IP multicast parameters into NVRAM Loader Partition.
 *
 */
typedef struct _lc_ip_multicast_parameters
{
    /**
     * This 32-bit field contains the IP Address of IP multicast server.
     */
    lc_uint32 ipAddress;

    /**
     * This 16-bit field contains the port number [0, 65535] of IP multicast server.
     */
    lc_uint16 port;

} lc_ip_multicast_parameters;


/**
 * Write IP multicast parameters into NVRAM Loader Partition.
 *
 * This function can be called to write IP multicast parameters into NVRAM Loader Partition.
 *
 * @param[in] pIpMulticastParameters points to the parameters to be written into NVRAM.
 *      Parameters in this structure will be serialized into Loader Partition whose format is defined in the loader spec.
 *
 * @retval
 *    ::LC_SUCCESS
 ...
 *     Other The method may return any other errors listed in \ref result "Result Code List".
 */
lc_result LoaderCoreAPI_WriteIPMulticastParameters( const lc_ip_multicast_parameters *pIpMulticastParameters);

/**
 * Read IP multicast parameters from NVRAM Loader Partition.
 *
 * This function can be called to read IP multicast parameters from NVRAM Loader Partition.
 *
 * @param[out] pIpMulticastParameters saves the parameters that have been read from NVRAM Loader Pt.
 *     When called, this function will de-serialize the byte array from Loader Partition to output all parameters.
 *
 * @retval
 *    ::LC_SUCCESS
 ...
 *     Other The method may return any other errors listed in \ref result "Result Code List".
 */
lc_result LoaderCoreAPI_ReadIPMulticastParameters( lc_ip_multicast_parameters *pIpMulticastParameters);
