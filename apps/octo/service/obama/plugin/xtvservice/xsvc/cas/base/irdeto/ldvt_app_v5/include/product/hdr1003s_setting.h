...
// Live or TSR 둘 중 EMM 을 한번만 Open 하도록 한다.
...
//CRC_Control_Block				from start		// according to Loader configuration define for CRC. If change the memory map, make sure be careful !!!-mhoh
...
#define CCB_Crc32						(IR_CPCB_SIZE - 16)	// (4) CRC Control Block Crc32
#define CCB_Part_One_Crc_Info_Length		(4+16)	// non_MAC_mask(8bits) + partition_length(24bits) + P_MAC (16)
