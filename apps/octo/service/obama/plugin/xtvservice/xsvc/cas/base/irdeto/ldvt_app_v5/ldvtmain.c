...
#if 1 // jichoi.
		HAPI_RegisterAcceptableKey(eAWINDOW_PAMA, DIKS_0, FALSE);
		HAPI_RegisterAcceptableKey(eAWINDOW_PAMA, DIKS_1, FALSE);
		HAPI_RegisterAcceptableKey(eAWINDOW_PAMA, DIKS_2, FALSE);
		HAPI_RegisterAcceptableKey(eAWINDOW_PAMA, DIKS_3, FALSE);
		HAPI_RegisterAcceptableKey(eAWINDOW_PAMA, DIKS_4, FALSE);
		HAPI_RegisterAcceptableKey(eAWINDOW_PAMA, DIKS_5, FALSE);
		HAPI_RegisterAcceptableKey(eAWINDOW_PAMA, DIKS_6, FALSE);
		HAPI_RegisterAcceptableKey(eAWINDOW_PAMA, DIKS_7, FALSE);
		HAPI_RegisterAcceptableKey(eAWINDOW_PAMA, DIKS_8, FALSE);
		HAPI_RegisterAcceptableKey(eAWINDOW_PAMA, DIKS_9, FALSE);
#endif
...
// jichoi.	s_hIrldvtFont = ONDK_FONT_Create(IRDVT_FONT_PATH,fs,fs);
	s_hIrldvtFont = ONDK_FONT_CreateSystemFont(eFont_SystemNormal, fs);
