...
enum
{
	...
	/*Humax added definition */
	,
	SERVICE_PVR_TSR_RECORD        = 33,
	SERVICE_PVR_TSR_PLAYBACK      = 34,

	SERVICE_INVALID      = 0xFF
#endif
...
#if defined(S3_MODIFIED_BY_HUMAX)
	/*Followings are humax internal definition */
	,	RESOURCE_HUMAX_INTERNAL  = 101
#endif
};
...
typedef struct
{
	msg_service_define_data_st		data;
	msg_resource_st					session_management;
	msg_resource_st					crypto_operation;
	msg_crypto_operation_source_st	payload_crypto_operation;
	msg_resource_st					smartcard;
}msg_pvr_service_define_st;
#endif
...
typedef struct
{
	msg_service_define_data_st		data;
	msg_resource_st					session_management;
	msg_sm_drm_define_st			drmdefine;
	msg_sm_drm_define_record_st		drmrecord;

	msg_resource_st					crypto_operation;
	msg_crypto_operation_source_st	payload_crypto_operation;
	msg_resource_st					smartcard;
} msg_pvr_rec_service_define_st;
...
typedef	struct
{
	...
	msg_resource_st					session_management;
	msg_sm_drm_define_st			drmdefine;
	msg_sm_drm_define_playback_st	drmplayback;
	...
	msg_resource_st					copycontrol;
#endif
} msg_pvr_pbservice_define_st;
#endif
