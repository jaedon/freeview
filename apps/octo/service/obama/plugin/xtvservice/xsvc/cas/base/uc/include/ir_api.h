 ...
 ********************************************************************/
#define CONFIG_UNIFIED_CLIENT_ADDFUNCTION // hjlee3
...
#define CONF_IR_UCCA_STATUS_CODE_FULL_SUPPORT	1
...
// to report result of MR configuration query
	...
	IREVT_CLASS_FLEXIFLASH_STATUS_UPDATE = 0x900, // flexiflash

	IREVT_CLASS_SVC_RECORDING_FORCED_STOP =0xA00, // need humax side
...
//733063, Configuring the key management system for digital TV, 9.7 smart card sectors 에 따라, max는 8개.
 //그런데 왜 sector count define을 card의 vendor id 수와 묶어놨는지 알수가 없네....일단 기존 4개에서 8개로 해도 코드상 문제 없으니 사용.
...
// Irdeto Cloaked CA Agent - Device Integration Overview 순이다. Document Number 735209, Date Issued 1 April 2013
typedef enum
{
	IRUC_STATUS_MSG_NONE = 0,
// Messages should not be displayed in the error banner - start
// Status codes not listed in the table should be ignored. from Spec. 아래와 같이 테이블에 없는 에러 코드는 표시되지 않는다.
	IRUC_STATUS_MSG_NOT_DISPLAYED_FIRST, // 처음  Level D
	IRUC_STATUS_MSG_D029_0,
	IRUC_STATUS_MSG_D100_0,
//	IRUC_STATUS_MSG_D101_0, // Spec 2.8에 따라 Display가 되기 위해 아래로 이동 ...
	IRUC_STATUS_MSG_D126_0,
	IRUC_STATUS_MSG_D127_0,
	IRUC_STATUS_MSG_D500_0,
	IRUC_STATUS_MSG_D000_4,
	IRUC_STATUS_MSG_D029_4,
	IRUC_STATUS_MSG_D100_5,
	IRUC_STATUS_MSG_D100_8,
	IRUC_STATUS_MSG_D101_6,
	IRUC_STATUS_MSG_D102_9,
	IRUC_STATUS_MSG_D105_9,
	IRUC_STATUS_MSG_D106_9,
	IRUC_STATUS_MSG_I101_0,
	IRUC_STATUS_MSG_I102_0,
	IRUC_STATUS_MSG_I300_0,
	IRUC_STATUS_MSG_I301_0,
	IRUC_STATUS_MSG_I302_0,
	IRUC_STATUS_MSG_I303_0,
	IRUC_STATUS_MSG_I304_0,
	IRUC_STATUS_MSG_I305_0,
	IRUC_STATUS_MSG_I306_0,
	IRUC_STATUS_MSG_I307_0,
	IRUC_STATUS_MSG_I308_0,
	IRUC_STATUS_MSG_I309_0,
	IRUC_STATUS_MSG_I310_0,
	IRUC_STATUS_MSG_I311_0,
	IRUC_STATUS_MSG_I312_0,
	IRUC_STATUS_MSG_I313_0,
	IRUC_STATUS_MSG_I314_0,
	IRUC_STATUS_MSG_I315_0,
	IRUC_STATUS_MSG_I316_0,
	IRUC_STATUS_MSG_I317_0,
	IRUC_STATUS_MSG_I318_0,
	IRUC_STATUS_MSG_I319_0,
	IRUC_STATUS_MSG_I320_0,
	IRUC_STATUS_MSG_I321_0,
	IRUC_STATUS_MSG_I322_0,
	IRUC_STATUS_MSG_I323_0,
	IRUC_STATUS_MSG_I324_0,
	IRUC_STATUS_MSG_I325_0,
	IRUC_STATUS_MSG_I326_0,
	IRUC_STATUS_MSG_I327_0,
	IRUC_STATUS_MSG_I328_0,
	IRUC_STATUS_MSG_I329_0,
	IRUC_STATUS_MSG_I330_0,
	IRUC_STATUS_MSG_I331_0,
	IRUC_STATUS_MSG_I332_0,
	IRUC_STATUS_MSG_I333_0,
	IRUC_STATUS_MSG_I334_0,
	IRUC_STATUS_MSG_I335_0,
	IRUC_STATUS_MSG_I336_0,
	IRUC_STATUS_MSG_I337_0,
	IRUC_STATUS_MSG_I338_0,
	IRUC_STATUS_MSG_I339_0,
	IRUC_STATUS_MSG_I340_0,
	IRUC_STATUS_MSG_I341_0,
	IRUC_STATUS_MSG_I342_0,
	IRUC_STATUS_MSG_I343_0,
	IRUC_STATUS_MSG_I344_0,
	IRUC_STATUS_MSG_I007_4,
	IRUC_STATUS_MSG_I034_9,
	IRUC_STATUS_MSG_I055_4,
	IRUC_STATUS_MSG_I102_4,
	IRUC_STATUS_MSG_I139_4,
	IRUC_STATUS_MSG_E104_0,/* out of Device Integration overview (rev.34.0) but in UniveralClient_API.h for  2.8.0 libraryspec START : Banner로 띄우지는 않는다. SPEC에 명시된 Error가 아니므로...*/
	IRUC_STATUS_MSG_E150_0,
	IRUC_STATUS_MSG_E151_0,
	IRUC_STATUS_MSG_E501_0,
	IRUC_STATUS_MSG_E502_0,
	IRUC_STATUS_MSG_E503_0,
	IRUC_STATUS_MSG_E504_0,
	IRUC_STATUS_MSG_E505_0,
	IRUC_STATUS_MSG_E506_0,
	IRUC_STATUS_MSG_E507_0,
	IRUC_STATUS_MSG_E508_0,
	IRUC_STATUS_MSG_E509_0,
	IRUC_STATUS_MSG_E510_0,
	IRUC_STATUS_MSG_E511_0,
	IRUC_STATUS_MSG_E512_0,
	IRUC_STATUS_MSG_E513_0,
	IRUC_STATUS_MSG_E514_0,
	IRUC_STATUS_MSG_E515_0,
	IRUC_STATUS_MSG_E516_0,
	IRUC_STATUS_MSG_E517_0,
	IRUC_STATUS_MSG_E518_0,
	IRUC_STATUS_MSG_E519_0,
	IRUC_STATUS_MSG_E520_0,
	IRUC_STATUS_MSG_E521_0, /* out of Device Integration overview (rev.34.0) but in UniveralClient_API.h for  2.8.0 libraryspec END */
	IRUC_STATUS_MSG_NOT_DISPLAYED_LAST, // 마지막 Level D
// Messages should not be displayed in the error banner - end

	IRUC_STATUS_MSG_BANNER_FIRST,	// 처음 에러 배너 ...
	IRUC_STATUS_MSG_D101_0, // Spec 2.8에 따라 Display가 되기 위해 위에서 이동됨. 검증 필요 ...
// 4.3 Error Banner
	IRUC_STATUS_MSG_E016_0, // No permission to view this channel.
	IRUC_STATUS_MSG_E017_0,
	IRUC_STATUS_MSG_E018_0,
	IRUC_STATUS_MSG_E030_0, // Currently unable to view this channel.
	IRUC_STATUS_MSG_E031_0,
	IRUC_STATUS_MSG_E032_0,
	IRUC_STATUS_MSG_E033_0,
	IRUC_STATUS_MSG_E055_0, // No permission to view this channel.
	IRUC_STATUS_MSG_E094_0, // Unable to playback the recording.
	IRUC_STATUS_MSG_E101_0, // Currently unable to view this channel.
	IRUC_STATUS_MSG_E102_0,
	IRUC_STATUS_MSG_E103_0,
	IRUC_STATUS_MSG_E106_0,
	IRUC_STATUS_MSG_E111_0, // No permission to carry out any recording or playback.
	IRUC_STATUS_MSG_E128_0,
	IRUC_STATUS_MSG_E131_0,
	IRUC_STATUS_MSG_E129_0, // Unable to playback the recording.
	IRUC_STATUS_MSG_E130_0, // Currently unable to carry out any recording.
	IRUC_STATUS_MSG_E139_0, // Validating subscription, please wait.
	IRUC_STATUS_MSG_E140_0, // This channel is not available in this location.
	IRUC_STATUS_MSG_E600_0, // Receiver is not enabled yet to view this service.

// 5.2.2. Error Banner
	IRUC_STATUS_MSG_E000_32,	// Service not scrambled.
	IRUC_STATUS_MSG_E004_4,		// Please insert smart card.
	IRUC_STATUS_MSG_E005_4,		// Unknown smart card.
	IRUC_STATUS_MSG_E006_4,		// Smart card Failure.
	IRUC_STATUS_MSG_E016_4,		// No permission to view this channel.
	IRUC_STATUS_MSG_E017_13,	// Service is currently scrambled.
	IRUC_STATUS_MSG_E018_4,		// This channel is not available in this location.
	IRUC_STATUS_MSG_E030_4,		// Currently unable to view this channel.
	IRUC_STATUS_MSG_E032_4,		// Viewing is temporarily blocked, please stay tuned.
	IRUC_STATUS_MSG_E033_4,		// Check if the correct smart card is inserted.
	IRUC_STATUS_MSG_E038_32,	// Service is not currently running.
	IRUC_STATUS_MSG_E045_32,	// Service not allowed.
	IRUC_STATUS_MSG_E080_35,	// Currently unable to view this channel.
	IRUC_STATUS_MSG_E081_35,
	IRUC_STATUS_MSG_E100_4,
	IRUC_STATUS_MSG_E101_4,
	IRUC_STATUS_MSG_E106_9,		// Please insert the correct smart card.
	IRUC_STATUS_MSG_E107_4,		// The smart card is not fully authorized.
	IRUC_STATUS_MSG_E108_4,		// Currently unable to view this channel.
	IRUC_STATUS_MSG_E109_4,
	IRUC_STATUS_MSG_E118_4,
	IRUC_STATUS_MSG_E136_4,		// This channel is age restricted.
	IRUC_STATUS_MSG_E137_4,		// Currently unable to view this channel.
	IRUC_STATUS_MSG_E140_4,		// This channel is not available in this location.
	IRUC_STATUS_MSG_E141_4,		// Currently unable to view this channel.
	IRUC_STATUS_MSG_E142_4,		// Insert the secondary card into the primary decoder to continue
	IRUC_STATUS_MSG_E144_4,		// Please wait. If the problem persists, insert the secondary card into the primary decoder to continue viewing with the secondary decoder.
	IRUC_STATUS_MSG_E152_4,		// Preview time period time out.

	IRUC_STATUS_MSG_E042_32,		// AXI_STATUSCODE_IDX_ParentalControlLockE42,			// Parental Control Lock (and/or Ask for Parental PIN)
	IRUC_STATUS_MSG_E037_32,		// AXI_STATUSCODE_IDX_ServiceUnknownE37, 				// Service Unknown from Humax
	IRUC_STATUS_MSG_E044_32,		// AXI_STATUSCODE_IDX_NoEventInformationE44,			// No Event Information from Humax
	IRUC_STATUS_MSG_E048_32,		// AXI_STATUSCODE_IDX_NoSignalE48,					// No Signal from Humax
	IRUC_STATUS_MSG_E052_32,		// AXI_STATUSCODE_IDX_SearchingForSignalE52,			// Searching for signal from Humax
	IRUC_STATUS_MSG_BANNER_LAST,	// 마지막  에러 배너 ...
	IRUC_STATUS_MSG_E999 ,    // __SOFTCELL_REC_EXCEPTION__
	IRUC_STATUS_MSG_ERR_LAST,
}IRUC_STATUS_CODE;
#else
...
HIR_ERR xsvc_cas_IrSC_Number(HUINT8 ucScSlotId, HUINT8 *pNumber);
