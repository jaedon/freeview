...
#define MULTICAST_DL_ATTEMPT_MAX 3
#endif
...
/** data type of IP download */
typedef enum
{
    /**
     * IP download header packet opcode.
     */
    IP_DLH_ID  = 0x01,

    /**
     * IP module header packet opcode.
     */
    IP_MH_ID   = 0x02,

    /**
     * IP datagram packet opcode.
     */
    IP_DG_ID   = 0x03

} lc_ip_packet_opcode;

/** download format for IP multicast download */
typedef struct _lc_multicast_download_packet
{
    lc_uchar op_code; /**< (1 byte) - variable, refer to lc_ip_packet_opcode */
    lc_uint16 transmission_sequence_number; /**< (2 bytes) - variable, ONLY applicable at op_code = 0x02 */
    lc_uchar *payload;
    lc_uint16 crc16; /**< 2 bytes) - checksum of entire lc_multicast_download_packet (except itself) */

} lc_multicast_download_packet;
...
/**
 * Parse Multicast download packet.
 */
lc_result
