...
/**
 * Indicate the type of the submitted CCIS address to Cloaked CA Agent by the application.
 *
 */
...
{
    /**
     * Whether this strucute contails valid info.
     ...
     * The ith operator's status string is carried inside operatorStatus[i].
     */
 ...
 *
 *     \note 
 *     Suppose an EMM( or ECM) service has been opened and PMT( or CAT) has been notified to the service successfully,
 ...
 *     The uc_extended_service_status::isValid indicates whether this structure contains valid infomation.
