 ...
 *
 * \note ::UniversalClientSPI_Stream_Open is a special SPI. When this SPI is assigned to
 * ::uc_spi_implementation_st::Stream_Open in ::UniversalClientSPI_GetImplementation, and there is a compile warning,
 ...
 *   \b const \b ::uc_stream_open_params \b *pStreamOpenParams, //-----------Here is the difference!\n
 *   ::uc_stream_handle \b *pStreamHandle); \n
 * but not \n
 * ::uc_result ::UniversalClientSPI_Stream_Open( \n
 *       ::uc_connection_stream_type \b streamType, \n
 *       \b void \b *pStreamOpenParams,                         //-----------Here is the difference!\n
 *       ::uc_stream_handle \b *pStreamHandle);\n
 *
 ...
 * \note When streamType is ::UC_CONNECTION_STREAM_TYPE_PVR_RECORD or ::UC_CONNECTION_STREAM_TYPE_PVR_PLAYBACK, the
 *       ::uc_stream_open_params::caStream member in pStreamOpenParams should be ignored.
 *
 * @retval
 *    ::UC_ERROR_SUCCESS
 * @retval
 ...
 *
 * \note ::UniversalClientSPI_Stream_AddComponent is a special SPI. When this SPI is assigned to
 * ::uc_spi_implementation_st::Stream_AddComponent in ::UniversalClientSPI_GetImplementation, and there is a compile warning,
 * please feel free to make a type convertion to remove the warning.
 *
 * \note For DVB client, the correct prototype for this SPI is \n
 * ::uc_result ::UniversalClientSPI_Stream_AddComponent( \n
 *   ::uc_stream_handle \b streamHandle,\n
 *   \b const ::uc_elementary_component \b *pComponent //-----------Here is the difference!\n
 *   ); \n
 * but not \n
 * ::uc_result ::UniversalClientSPI_Stream_AddComponent( \n
 *   ::uc_stream_handle \b streamHandle,\n
 *   \b const ::uc_component \b *pComponent //-----------Here is the difference!\n
 *   ); \n
 *
 ...
 *
 * \note ::UniversalClientSPI_Stream_RemoveComponent is a special SPI. When this SPI is assigned to
 * ::uc_spi_implementation_st::Stream_RemoveComponent in ::UniversalClientSPI_GetImplementation, and there is a compile warning,
 * please feel free to make a type convertion to remove the warning.
 *
 * \note For DVB client, the correct prototype for this SPI is \n
