...
#ifndef __INT_XSVC_VMXDVBMGR_H__
#define __INT_XSVC_VMXDVBMGR_H__
...
void vmx_vr_bc_mgr_SetBoxId(HUINT8* usBoxId);
HERROR vmx_vr_bc_mgr_GetBoxId(HUINT8* pusBoxId);
HBOOL vmx_vr_bc_mgr_SetHandleMsg(Vmx_Msg_t *pstVmxMsg);
#endif 	//#ifndef __INT_XSVC_VMXDVBMGR_H__