...
HERROR xsvc_epg_Init_cdig2000c(void)
{
	HERROR		hErr;
...
HERROR xsvc_epg_InitResource_cdig2000c(void)
{
	...
	{
		HxLOG_Print("[xsvc_epg_InitResource_cdig2000c] EPGDB_CreateSvcSectionManager fail!!\n");
