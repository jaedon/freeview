...
HERROR xsvc_epg_Init_FoxsatHdr2(void)
{
	HERROR		hErr;
	...
	stEpgCb.pfnEpgInitAction	= xsvc_epg_InitAction_FreeSat;
	stEpgCb.pfnEpgStart			= xsvc_epg_Start_FreeSat;
	stEpgCb.pfnEpgStop			= xsvc_epg_Stop_FreeSat;
	stEpgCb.pfnEpgLoadData		= xsvc_epg_LoadData_FreeSat;
	stEpgCb.pfnEpgUnLoadData	= xsvc_epg_UnLoadData_FreeSat;
	stEpgCb.pfnEpgStartContent	= xsvc_epg_StartContent_Base;
	stEpgCb.pfnEpgStopContent	= xsvc_epg_StopContent_Base;

	hErr = SVC_EPG_RegisterCallback(eEPG_KIND_FSAT, &stEpgCb);

	return hErr;
}

HERROR xsvc_epg_InitResource_FoxsatHdr2(void)
{
	...
	{
		HxLOG_Print("[XSVC_EPG_INIT_Resource_Base7356] EPGDB_CreateSvcSectionManager fail!!\n");
