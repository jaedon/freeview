...
HERROR xsvc_epg_Init_Hmx4kbbc(void)
{
	HERROR		hErr;
...
HERROR xsvc_epg_InitResource_Hmx4kbbc(void)
{
	...
	{
		HxLOG_Print("[xsvc_epg_InitResource_JcNgs] EPGDB_CreateSvcSectionManager fail!!\n");
		goto EXIT_EPGMAIN_FUNC;
	}

	hError = SVC_EPGCONTEXT_InitContext((void*)xsvc_epgcontext_PfProcessEitCallBack_Arib,
							(void*)xsvc_epgcontext_PfProcessEitCallBack_Arib,
							(void*)xsvc_epgcontext_SchProcessEitCallBack_Arib,
							(void*)xsvc_epgcontext_SchProcessEitCallBack_Arib);
