...
********************************************************************/
/**
	@file	  xsvc_si_search_amx_cenam.c
	@brief
...
STATIC void xsvc_si_SrchMsgCmdStartSearch_Amx_Cenam (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
...
STATIC void xsvc_si_SrchMsgCmdStopSearch_Amx_Cenam (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
...
STATIC void xsvc_si_SrchMsgEvtPatTable_Amx_Cenam (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
...
STATIC void xsvc_si_SrchMsgEvtPmtTable_Amx_Cenam (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}

STATIC void xsvc_si_SrchMsgEvtSdtTable_Amx_Cenam (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}

STATIC void xsvc_si_SrchMsgEvtNitTable_Amx_Cenam (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}

STATIC void xsvc_si_SrchMsgEvtNitOthTable_Amx_Cenam (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}
...
STATIC void xsvc_si_SrchProcessMsg_Amx_Cenam (SvcSi_Msg_t *pstMsg, void *pvData)
{
	...
	case eSIMSG_CMD_START_SEARCH:
		xsvc_si_SrchMsgCmdStartSearch_Amx_Cenam (pstSrch, pstMsg);
		break;

	case eSIMSG_CMD_STOP_SEARCH:
		xsvc_si_SrchMsgCmdStopSearch_Amx_Cenam (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_PAT_TABLE:
		xsvc_si_SrchMsgEvtPatTable_Amx_Cenam (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_PMT_TABLE:
		xsvc_si_SrchMsgEvtPmtTable_Amx_Cenam (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_SDT_TABLE:
		xsvc_si_SrchMsgEvtSdtTable_Amx_Cenam (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_NIT_TABLE:
		xsvc_si_SrchMsgEvtNitTable_Amx_Cenam (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_NIT_OTH_TABLE:
		xsvc_si_SrchMsgEvtNitOthTable_Amx_Cenam (pstSrch, pstMsg);
		break;
...
SvcSi_ActFunc xsvc_si_SrchGetSearchActionFunc_Amx_Cenam (void)
{
	return xsvc_si_SrchProcessMsg_Amx_Cenam;
}

void *xsvc_si_SrchAllocSearchActionData_Amx_Cenam (void)
{
...
void xsvc_si_SrchFreeSearchActionData_Amx_Cenam (void *pvData)
{
	svcSi_SrchData_t	*pstSrch = (svcSi_SrchData_t *)pvData;
