...
STATIC void xsvc_si_SrchMsgCmdStartSearch_Eudtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
...
STATIC void xsvc_si_SrchMsgCmdStopSearch_Eudtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
...
STATIC void xsvc_si_SrchMsgEvtPatTable_Eudtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
...
STATIC void xsvc_si_SrchMsgEvtPmtTable_Eudtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}

STATIC void xsvc_si_SrchMsgEvtSdtTable_Eudtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}

STATIC void xsvc_si_SrchMsgEvtNitTable_Eudtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}

STATIC void xsvc_si_SrchMsgEvtNitOthTable_Eudtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}
...
STATIC void xsvc_si_SrchProcessMsg_Eudtt (SvcSi_Msg_t *pstMsg, void *pvData)
{
	...
	case eSIMSG_CMD_START_SEARCH:
		xsvc_si_SrchMsgCmdStartSearch_Eudtt (pstSrch, pstMsg);
		break;

	case eSIMSG_CMD_STOP_SEARCH:
		xsvc_si_SrchMsgCmdStopSearch_Eudtt (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_PAT_TABLE:
		xsvc_si_SrchMsgEvtPatTable_Eudtt (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_PMT_TABLE:
		xsvc_si_SrchMsgEvtPmtTable_Eudtt (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_SDT_TABLE:
		xsvc_si_SrchMsgEvtSdtTable_Eudtt (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_NIT_TABLE:
		xsvc_si_SrchMsgEvtNitTable_Eudtt (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_NIT_OTH_TABLE:
		xsvc_si_SrchMsgEvtNitOthTable_Eudtt (pstSrch, pstMsg);
		break;
...
SvcSi_ActFunc xsvc_si_SrchGetSearchActionFunc_Eudtt (void)
{
	return xsvc_si_SrchProcessMsg_Eudtt;
}

void *xsvc_si_SrchAllocSearchActionData_Eudtt (void)
{
...
void xsvc_si_SrchFreeSearchActionData_Eudtt (void *pvData)
{
	svcSi_SrchData_t	*pstSrch = (svcSi_SrchData_t *)pvData;
