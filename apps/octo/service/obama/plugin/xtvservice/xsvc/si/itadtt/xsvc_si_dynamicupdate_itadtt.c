...
********************************************************************/
/**
	@file	  xsvc_si_dynamicupdate_itadtt.c
	@brief
...
STATIC HERROR xsvc_si_DuSetDefaultAuthoriyInNetwork_ItaDtt(HUINT32 ulActionId, SIxTable_PsiTable_t *pstNitTable, DbSvc_NetInfo_t *pstNetInfo)
{
	HUINT8					*pucRawDes;
...
STATIC HERROR xsvc_si_DuSetDefaultAuthoriyInTS_ItaDtt(HUINT32 ulActionId, SIxTable_PsiTable_t *pstNitTable, SIxTable_PsiTable_t *pstSdtTable, DbSvc_TsInfo_t *pstTsInfo)
{
	HUINT8 *pucRawDes;
...
STATIC HERROR xsvc_si_DuSetDefaultAuthoriyInSvc_ItaDtt(HUINT32 ulActionId, SIxTable_PsiTable_t *pstSdtTable, DbSvc_Info_t *pstSvc)
{
	HUINT8 				*pucRawDes;
...
STATIC HERROR xsvc_si_DuCollectServiceDataFromSi_ItaDtt (svcSi_SrchData_t *pstSrch)
{
	...
	if (NULL != pstNitTable)
	{
		...
		xsvc_si_DuSetDefaultAuthoriyInNetwork_ItaDtt(ulActionId, pstNitTable, &stNetInfo);
	}
	...
	if ( (NULL != pstNitTable) && (NULL != pstSdtTable) )
	{
		...
		xsvc_si_DuSetDefaultAuthoriyInTS_ItaDtt(ulActionId, pstNitTable, pstSdtTable, &stTsInfo);
	}
	...
	if (ERR_OK == hErr)
	{
		if (NULL != pstSvcArray)
		{
			...
			for (ulCnt = 0; ulCnt < ulSvcNum; ulCnt++)
			{
				...
				xsvc_si_DuSetDefaultAuthoriyInSvc_ItaDtt(ulActionId, pstSdtTable, pstSvc);
...
STATIC HERROR xsvc_si_DuCheckAndComposeSearchData_ItaDtt (svcSi_SrchData_t *pstSrch)
{
	HINT32			 nMsgType;
	HERROR			 hErr;
	...
	{
		hErr = xsvc_si_DuCollectServiceDataFromSi_ItaDtt (pstSrch);
		if (ERR_OK != hErr)
		{
...
STATIC void xsvc_si_DuMsgCmdStartDynamicUpdate_ItaDtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
...
STATIC void xsvc_si_DuMsgCmdStopDynamicUpdate_ItaDtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)svc_si_DuStopSection (pstSrch);
	(void)svc_si_DuFreeSearchData (pstSrch);
}

STATIC void xsvc_si_DuMsgEvtPatTable_ItaDtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_DuCheckAndComposeSearchData_ItaDtt (pstSrch);
}

STATIC void xsvc_si_DuMsgEvtSdtTable_ItaDtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_DuCheckAndComposeSearchData_ItaDtt (pstSrch);
}

STATIC void xsvc_si_DuMsgEvtNitTable_ItaDtt (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_DuCheckAndComposeSearchData_ItaDtt (pstSrch);
}
...
STATIC void xsvc_si_DuProcessMsg_ItaDtt (SvcSi_Msg_t *pstMsg, void *pvData)
{
	...
	case eSIMSG_CMD_START_DYNAMICUPDATE:
		...
		xsvc_si_DuMsgCmdStartDynamicUpdate_ItaDtt (pstSrch, pstMsg);
		break;

	case eSIMSG_CMD_STOP_DYNAMICUPDATE:
		HxLOG_Debug("eSIMSG_CMD_STOP_DYNAMICUPDATE \n");
		xsvc_si_DuMsgCmdStopDynamicUpdate_ItaDtt (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_PAT_TABLE:
		HxLOG_Debug("eSIMSG_EVT_PAT_TABLE \n");
		xsvc_si_DuMsgEvtPatTable_ItaDtt (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_SDT_TABLE:
		HxLOG_Debug("eSIMSG_EVT_SDT_TABLE \n");
		xsvc_si_DuMsgEvtSdtTable_ItaDtt (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_NIT_TABLE:
		HxLOG_Debug("eSIMSG_EVT_NIT_TABLE \n");
		xsvc_si_DuMsgEvtNitTable_ItaDtt (pstSrch, pstMsg);
		break;
...
SvcSi_ActFunc xsvc_si_DuGetDynamicUpdateActionFunc_ItaDtt (void)
{
	return xsvc_si_DuProcessMsg_ItaDtt;
}

void *xsvc_si_DuAllocDynamicUpdateActionData_ItaDtt (void)
{
...
void xsvc_si_DuFreeDynamicUpdateActionData_ItaDtt (void *pvData)
{
	svcSi_SrchData_t	*pstSrch = (svcSi_SrchData_t *)pvData;
