...
STATIC void xsvc_si_SrchMsgCmdStartSearch_MeSat (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	...
	hErr = xsvc_si_FilterSetTimeout_MeSat(PAL_PIPE_GetActionId(pstSrch->hAction));
	if (hErr != ERR_OK)
	{
...
STATIC void xsvc_si_SrchMsgCmdStopSearch_MeSat (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
...
STATIC void xsvc_si_SrchMsgEvtPatTable_MeSat (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
...
STATIC void xsvc_si_SrchMsgEvtPmtTable_MeSat (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}

STATIC void xsvc_si_SrchMsgEvtSdtTable_MeSat (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}

STATIC void xsvc_si_SrchMsgEvtNitTable_MeSat (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}

STATIC void xsvc_si_SrchMsgEvtNitOthTable_MeSat (svcSi_SrchData_t *pstSrch, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_LibSrchOnSiTableReceived_Base (pstSrch, pstMsg->hAction, &(pstMsg->unArg.stSection));
	(void)xsvc_si_LibSrchCheckAndComposeSearchData (pstSrch);
}

STATIC void xsvc_si_SrchProcessMsg_MeSat (SvcSi_Msg_t *pstMsg, void *pvData)
{
	...
	case eSIMSG_CMD_START_SEARCH:
		xsvc_si_SrchMsgCmdStartSearch_MeSat (pstSrch, pstMsg);
		break;

	case eSIMSG_CMD_STOP_SEARCH:
		xsvc_si_SrchMsgCmdStopSearch_MeSat (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_PAT_TABLE:
		xsvc_si_SrchMsgEvtPatTable_MeSat (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_PMT_TABLE:
		xsvc_si_SrchMsgEvtPmtTable_MeSat (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_SDT_TABLE:
		xsvc_si_SrchMsgEvtSdtTable_MeSat (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_NIT_TABLE:
		xsvc_si_SrchMsgEvtNitTable_MeSat (pstSrch, pstMsg);
		break;

	case eSIMSG_EVT_NIT_OTH_TABLE:
		xsvc_si_SrchMsgEvtNitOthTable_MeSat (pstSrch, pstMsg);
		break;
...
SvcSi_ActFunc xsvc_si_SrchGetSearchActionFunc_MeSat (void)
{
	return xsvc_si_SrchProcessMsg_MeSat;
}

void *xsvc_si_SrchAllocSearchActionData_MeSat (void)
{
...
void xsvc_si_SrchFreeSearchActionData_MeSat (void *pvData)
{
	svcSi_SrchData_t	*pstSrch = (svcSi_SrchData_t *)pvData;
