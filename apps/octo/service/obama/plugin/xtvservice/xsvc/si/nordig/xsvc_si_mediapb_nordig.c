...
STATIC HERROR xsvc_si_MediaPbParseDtcpDesc_Nordig(HUINT32 ulActionId, HUINT8 *pucRawDes)
{
	SIxNordigDtcpDes_t	*pstDesc = NULL;
	...
	pstDesc = (SIxNordigDtcpDes_t *)PAL_SIRAWPOOL_ParseDes (ulActionId, (HUINT8 *)pucRawDes);
	if (pstDesc == NULL)
	{
		HxLOG_Error("SIxNordigDtcpDes_t parse failed..!!  \n");
		return ERR_FAIL;
	}
...
STATIC HERROR xsvc_si_MediaPbCheckDtcpFromPmt_Nordig(HUINT32 ulActionId)
{
	...
	for (pstPmtLoop = pstPmtTable->pstDesLoop; NULL != pstPmtLoop; pstPmtLoop = pstPmtLoop->next)
	{
		...
		if (eSIxDESCTAG_NORDIG_DTCP == *pucRawDes)
		{
			hErr = xsvc_si_MediaPbParseDtcpDesc_Nordig(ulActionId, pucRawDes);
			if (hErr != ERR_OK)
			{
				HxLOG_Error("xsvc_si_MediaPbParseDtcpDesc_Nordig() failed..!! \n");
			}
		}
	}
...
STATIC HERROR xsvc_si_MediapbOnPatReceived_Nordig (svcSi_MediapbData_t *pstMediapb, Handle_t hAction, SvcSi_Arg_SecCb_t *pstSecCb)
{
...
STATIC HERROR xsvc_si_MediapbOnPmtReceived_Nordig (svcSi_MediapbData_t *pstMediapb, Handle_t hAction, SvcSi_Arg_SecCb_t *pstSecCb)
{
	...
	default:
		...
		xsvc_si_MediaPbCheckDtcpFromPmt_Nordig(PAL_PIPE_GetActionId(hAction));
		break;
	}
...
STATIC void xsvc_si_MediapbMsgCmdStartMediapb_Nordig (svcSi_MediapbData_t *pstMediapb, SvcSi_Msg_t *pstMsg)
{
...
STATIC void xsvc_si_MediapbMsgCmdStopMediapb_Nordig (svcSi_MediapbData_t *pstMediapb, SvcSi_Msg_t *pstMsg)
{
	(void)svc_si_MediapbStopSection (pstMediapb);
}

STATIC void xsvc_si_MediapbMsgEvtPatTable_Nordig (svcSi_MediapbData_t *pstMediapb, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_MediapbOnPatReceived_Nordig (pstMediapb, pstMsg->hAction, &(pstMsg->unArg.stSection));
}

STATIC void xsvc_si_MediapbMsgEvtPmtTable_Nordig (svcSi_MediapbData_t *pstMediapb, SvcSi_Msg_t *pstMsg)
{
	(void)xsvc_si_MediapbOnPmtReceived_Nordig (pstMediapb, pstMsg->hAction, &(pstMsg->unArg.stSection));
}

#define _____SI_MSG_PROCESS_FUNCTION_____
STATIC void xsvc_si_MediapbProcessMsg_Nordig (SvcSi_Msg_t *pstMsg, void *pvData)
{
	...
	case eSIMSG_CMD_START_MEDIAPB:
		xsvc_si_MediapbMsgCmdStartMediapb_Nordig (pstMediapb, pstMsg);
		break;

	case eSIMSG_CMD_STOP_MEDIAPB:
		xsvc_si_MediapbMsgCmdStopMediapb_Nordig (pstMediapb, pstMsg);
		break;

	case eSIMSG_EVT_PAT_TABLE:
		xsvc_si_MediapbMsgEvtPatTable_Nordig (pstMediapb, pstMsg);
		break;

	case eSIMSG_EVT_PMT_TABLE:
		xsvc_si_MediapbMsgEvtPmtTable_Nordig (pstMediapb, pstMsg);
		break;
...
SvcSi_ActFunc xsvc_si_MediapbGetMediapbActionFunc_Nordig (void)
{
	return xsvc_si_MediapbProcessMsg_Nordig;
}

void *xsvc_si_MediapbAllocMediapbActionData_Nordig (void)
{
...
void xsvc_si_MediapbFreeMediapbActionData_Nordig (void *pvData)
{
	svcSi_MediapbData_t	*pstMediapb = (svcSi_MediapbData_t *)pvData;
