...
HERROR	xsvc_sys_GetSystemId_Hms1000s(HUINT32 *pulSystemId)
{
	*pulSystemId = 0x809C5010;

	return ERR_OK;
}

HERROR	xsvc_sys_GetModelName_Hms1000s(HUINT8 *pszModelName, HUINT32 ulLength, HBOOL bPanelSizeOn)
{
...
HUINT32	xsvc_sys_UpgradeGetMaxUpgradeSize_Hms1000s(void)
{
