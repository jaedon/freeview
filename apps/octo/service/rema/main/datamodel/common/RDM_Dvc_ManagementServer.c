...
#if 0
//Device.ManagementServer.UpgradesManage의 getter
hCwmpResult_e get_RDM_Dvc_MS_UpgradesManaged(HCWMP_GETTER_PARAM)
{
    //TBD : ACS OTA 진행후
    RemLOG_Debug("[%s] TBD\n", pszParamName);
    return ehCwmp_R_OK;
}
//Device.ManagementServer.UpgradesManage의 setter
hCwmpResult_e set_RDM_Dvc_MS_UpgradesManaged(HCWMP_SETTER_PARAM)
{
    //TBD : ACS OTA 진행후
    RemLOG_Debug("[%s] TBD\n", pszParamName);
    return ehCwmp_R_OK;
