...
APP-LINK-y := -L$(HUMAX_APP_STAG_DIR)/root/lib  -L$(HUMAX_APP_STAG_DIR)/root/usr/lib -L$(AP_STATIC_LIB_DIR) -L$(shell pwd)/../lib
...
APP-LINK-$(CONFIG_NOVA_SATIP_SERVER)+= -lnovaapi
...
APP-LINK-y								+= -pthread -lrt -lssp -lm -lmanifest
