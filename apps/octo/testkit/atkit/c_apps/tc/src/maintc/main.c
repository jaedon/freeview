...
#define ATKIT_MENIFEST_FILE_NAME	"/home/atkit/manifest/maintc.manifest"
#define ATKIT_RESULT_FILE_NAME		"/home/atkit/result/maintc.result"
...
HINT32 local_tc_init(void)
{
	...
	TC_SAMPLE_Init(s_manifest);
	TC_OUTPUT_AUDIO_Init(s_manifest);
