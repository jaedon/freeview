...
#define ATKIT_MENIFEST_FILE_NAME	"/home/atkit/manifest/tc_appkit_dlna.manifest"
#define ATKIT_RESULT_FILE_NAME		"/home/atkit/result/tc_appkit_dlna.result"
