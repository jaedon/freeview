...
#define ATKIT_MENIFEST_FILE_NAME	"/home/atkit/manifest/tc_appkit_power.manifest"
#define ATKIT_RESULT_FILE_NAME		"/home/atkit/result/tc_appkit_power.result"
...
HINT32 local_tc_init(void)
{
	...
	TC_APPKIT_POWER_Init(s_manifest);
...
int main(int argc, char **argv)
{
	...
	printf("#####################################################################################\n");
	printf("Unit Test for appkit power validation!\n");
	printf("#####################################################################################\n");
