...
#define ATKIT_MENIFEST_FILE_NAME	"/home/atkit/manifest/tc_appkit_sysinfo.manifest"
#define ATKIT_RESULT_FILE_NAME		"/home/atkit/result/tc_appkit_sysinfo.result"
...
HINT32 local_tc_init(void)
{
	...
	TC_APPKIT_SYSINFO_Init(s_manifest);
...
int main(int argc, char **argv)
{
	...
	printf("#####################################################################################\n");
	printf("Unit Test for APPKIT SYSINFO validation!\n");
	printf("#####################################################################################\n");
