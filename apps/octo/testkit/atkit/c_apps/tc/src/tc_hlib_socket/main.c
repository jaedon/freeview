...
#define ATKIT_MENIFEST_FILE_NAME	"/home/atkit/manifest/tc_hlib_socket.manifest"
#define ATKIT_RESULT_FILE_NAME		"/home/atkit/result/tc_hlib_socket.result"
...
HINT32 local_tc_init(void)
{
	...
	TC_HLIB_SOCKET_Init(s_manifest);
...
int main(int argc, char **argv)
{
	...
	printf("#####################################################################################\n");
	printf("Unit Test for hlib socket validation!\n");
	printf("#####################################################################################\n");
