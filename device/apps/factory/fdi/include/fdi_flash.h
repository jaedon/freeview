...
* All right reserved
******************************************************************************/
#ifndef _FDI_FLASH_H_
#define _FDI_FLASH_H_
...
* 기타 참고자료 및 파일
*******************************************************************************/
FDI_ERR_CODE FDI_EMMC_Read(unsigned int address, unsigned char *data, unsigned int data_size);
...
* 기타 참고자료 및 파일
*******************************************************************************/
FDI_ERR_CODE FDI_EMMC_Write(unsigned int address, unsigned char *data, unsigned int data_size);
#endif
