...
static void TEST_ETH_SelectTestCase(HUINT32 ulTestNumber);
static void TEST_ETH_Menu(void);




void TEST_DI_ETH(void)
{
	DI_ERR_CODE ulRet = 0;
	HUINT32 ulTestNumber = 0;

    do {
        TEST_ETH_Menu(); /* print menu */
		...
		{
            TEST_ETH_SelectTestCase(ulTestNumber);
        }
        else
        {
