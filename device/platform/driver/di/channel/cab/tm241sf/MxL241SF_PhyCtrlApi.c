...
/* JDCHO - using symbol rate calculation fomula */
  UINT32	ulSymbolRateTemp = 0;
  ...
  {
    ulSymbolRateTemp = (UINT32)0x1000000*(9500.0/SymbolRatePtr->SymbolRate)*3/4.0;
  }
