...
)
{
	...
	CH_DI_Print(4, ("[CalculateBer] => fBer: (%3.2e)  \n", fBer ));
	...
	HUINT32 ulSnr )
{
	...
	if(etSatMode == NEXUS_FrontendSatelliteMode_eDvb)
	{
		...
		{
			CH_DI_Print(0, ("[CalculateEbNo] ERR! Dvb Unknown code rate..."));
		}
	...
	else if(etSatMode == NEXUS_FrontendSatelliteMode_eQpskLdpc)
	{
		...
		{
			CH_DI_Print(0, ("[CalculateEbNo] ERR! QpskLdpc Unknown code rate..."));
		}
	...
	else if(etSatMode == NEXUS_FrontendSatelliteMode_e8pskLdpc)
	{
		...
		{
			CH_DI_Print(0, ("[CalculateEbNo] ERR! 8pskLdpc Unknown code rate..."));
		}
	...
	{
		CH_DI_Print(0, ("[CalculateEbNo] ERR! Unknown mode..."));
	}

	CH_DI_Print(4, (" fEbNo [%f] \n",  fEbNo));
...
#if defined(CONFIG_SUPPORT_ADVANCED_SIGNALINFO)
	CH_DI_Print(3, ("----------------------------------------------------------------------------------------\n"));
	CH_DI_Print(3, ("pstSignalInfo->fSnr      =(%f)\n", pstSignalInfo->fSnr));
	CH_DI_Print(3, ("pstSignalInfo->fBer      =(%3.2e)\n", pstSignalInfo->fBer));
	CH_DI_Print(3, ("pstSignalInfo->fEbNo     =(%f)\n", pstSignalInfo->fEbNo));
	CH_DI_Print(3, ("----------------------------------------------------------------------------------------\n"));
#endif
	return DI_CH_OK;
}
