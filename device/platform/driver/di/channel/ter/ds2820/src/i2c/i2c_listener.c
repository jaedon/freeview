...
#if defined _MSC_VER
/* MS Windows safe VK_snprintf and VK_strncat */
#define sony_dvb_snprintf sprintf_s
#define sony_dvb_strncat(dest,dest_len,src,src_len) strncat_s((dest),(dest_len),(src),(src_len))
#else
/* Other safe VK_snprintf and VK_strncat */
#define sony_dvb_snprintf VK_snprintf
#define sony_dvb_strncat(dest,dest_len,src,src_len) VK_strncat((dest),(src),(src_len))
#endif
...
i2c_listener_t* i2c_listener_Create (sony_dvb_i2c_listener_log_t logger,
                                     ...
                                     void* user)
{
    i2c_listener_t* pListener = DD_MEM_Alloc (sizeof(i2c_listener_t));
    if (pListener == NULL) {
        return pListener ;
    }
    ...
    VK_memset (pListener->buf, 0, MAX_LOG_BUF);
    pListener->user = user ;
