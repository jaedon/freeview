...
/*============================================================================*/
	...
	typedef struct _tmbslFrontEndIoFunc_t
    {
        ...
        /** Write hardware register, 8bit aligned function */
        tmErrorCode_t   (*Write)(tmUnitSelect_t tUnit, UInt32 AddrSize, UInt8* pAddr, UInt32 WriteLen, UInt8* pData);
        /** Write hardware register w/no ACK, 8bit aligned function : HUMAX_PLATFORM_BASE */
        tmErrorCode_t   (*WriteNoAck)(tmUnitSelect_t tUnit, UInt32 AddrSize, UInt8* pAddr, UInt32 WriteLen, UInt8* pData);
...
/* : HUMAX_PLATFORM_BASE */
#define FUNC_SIO_WRITE_NOACK(_FUNC)                   FUNC_SIO(_FUNC).WriteNoAck
#define P_FUNC_SIO_WRITE_NOACK(_PFUNC)                P_FUNC_SIO(_PFUNC).WriteNoAck
...
/* : HUMAX_PLATFORM_BASE */
#define FUNC_SIO_WRITE_NOACK_VALID(_FUNC)             (FUNC_SIO_WRITE_NOACK(_FUNC) != Null)
#define P_FUNC_SIO_WRITE_NOACK_VALID(_PFUNC)          (P_FUNC_SIO_WRITE_NOACK(_PFUNC) != Null)
