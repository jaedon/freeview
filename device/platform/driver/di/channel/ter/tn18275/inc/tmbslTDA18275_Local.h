...
/* Version is different from Quad_TDA18275_v1.0.2_20131204 */
...
#define TDA18275_MINOR_VER 0  /* Software update - No protocol change - No specification change required */
...
/* : HUMAX_PLATFORM_BASE */
#define P_SIO_WRITE_NOACK                       P_SIO.WriteNoAck
#define P_SIO_READ_VALID                        (P_OBJ_VALID && (P_SIO_READ != Null))
#define P_SIO_WRITE_VALID                       (P_OBJ_VALID && (P_SIO_WRITE != Null))
/* : HUMAX_PLATFORM_BASE */
#define P_SIO_WRITE_NOACK_VALID                       (P_OBJ_VALID && (P_SIO_WRITE_NOACK != Null))
