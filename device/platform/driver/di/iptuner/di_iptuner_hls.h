...
#define HLS_CONFIG_TEMP_CACHE "/home/hls-cache"
#define HLS_CONFIG_TEMP_PATH "/tmp/hls-cache"
...
#define HLS_CONST_MAX_TIMEGAP_FOR_LIVE		(60.0)
#define HLS_CONST_URL_LENGTH (IPTUNER_CONST_URL_LENGTH)
...
HINT8* DI_STREAM_HLS_InitSegUrl(void);
...
void DI_STREAM_HLS_StopBufferingTask(void);

void DI_STREAM_HLS_RegisterCallback (void);
void DI_STREAM_HLS_UnregisterCallback (void);
...
int DI_STREAM_HLS_CloseController(void);
int DI_STREAM_HLS_CreateLiveUpdateTask (void);
int DI_STREAM_HLS_DestroyLiveUpdateTask (void);

int DI_STREAM_HLS_PreBuffering (DI_IPTUNER_Index_e nTunerIndex);
HBOOL DI_STREAM_HLS_isChangedTs(void);
...
#endif
/*CONFIG_HLS_UNDERFLOW_MONITORING_FOR_BBC_CATAL*/
