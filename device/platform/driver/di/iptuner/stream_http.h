...
typedef struct
{
	...
	/* */
	int        i_code;
#if 0 /* Cause many warnings: cast discards qualifiers from pointer target type */
	...
	int			i_icy_br;
	int			i_icy_pub;
	DI_MEDIA_AUDIO_FORMAT_e			e_icy_codec;
#endif
	...
	int			i_redirect_count;
	int			i_connect_retry_count;
	char * cookies;
} HTTP_ACCESS_SYS_t;
