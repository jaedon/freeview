...
/* Reference above net_SockAddrIsMulticast (const struct sockaddr *addr, ...)  */
HBOOL net_HostAddrIsMulticast(const char *hostIP) /* hostIP: dot string IPv4 address, (not IPv6) */
{
	HBOOL isMulticast = FALSE;
	HINT32 nret = 0;
