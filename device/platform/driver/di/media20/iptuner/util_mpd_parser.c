...
/************************* File Description ************************/
/*******************************************************************/
/* File Name:       $Workfile:   util_mpd_parser.c  $
 * Version:         $Revision:   $
 ...
 *---------------------------------------------------------------------------------------------*/
/* Start #define */
//#define UTIL_MPD_PARSER

#ifdef IPTUNER_ALL_DEBUG	/* DEBUG Define */

#ifdef UTIL_MPD_PARSER
...
#if MPD_CONFIG_NOT_USE_VK
#define VK_MEM_Alloc VK_malloc
#define VK_MEM_Memset VK_memset
#define VK_strncpy VK_strncpy
#define VK_MEM_Free VK_free
...
mpdErr_e local_mpdparser_parse_mpdRoot(mpdData_t *mpdData, mpdElement_Root_t *mpdRoot)
{
	...
	char szBuf[MPD_CONST_ATTR_BUFSIZE]={0}; // check buffer size

	/* Parse MPD root tag "MPD" */

	/* Parse "type" */
	VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
  	errCode = local_mpdparser_get_attr_value(mpdRoot,(xmlChar*)MPD_ATTR_TYPE_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
	...
	errCode = local_mpdparser_get_attr_value(mpdRoot,(xmlChar*)MPD_ATTR_MEDIAPRESENTDURATION_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
	if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
	{
	...
	errCode = local_mpdparser_get_attr_value(mpdRoot,(xmlChar*)MPD_ATTR_MINBUFFERTIME_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
	if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
	{
	...
	/* Parse "baseURL" */
	VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
	errCode = local_mpdparser_get_attr_value(mpdRoot,(xmlChar*)MPD_ATTR_BASEURL_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
	if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
	{
...
mpdErr_e local_mpdparser_parse_SegInfoDef(mpdPeriod_t *mpdPeriod, mpdElement_Period_t *periodElement)
{
	...
	if(element != NULL)
	{
		...
		/* Parse "duration" */
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(element,(xmlChar*)MPD_ATTR_DURATION_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
		...
		/* Parse "startIndex" */
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(element,(xmlChar*)MPD_ATTR_STARTINDEX_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
		...
		/* Parse "baseURL" */
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(element,(xmlChar*)MPD_ATTR_BASEURL_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
		...
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(element,(xmlChar*)MPD_ATTR_SRCURLTEMPLATEPERIOD_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
...
mpdErr_e local_mpdparser_parse_period(mpdData_t *mpdData, mpdElement_Root_t *mpdRoot)
{
	...
	for(i = 0 ; i < mpdData->nTotalPeriod && period != NULL ; i++)
	{
		...
		/* Parse "start" */
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(period,(xmlChar*)MPD_ATTR_PERIODSTARTTIME_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
		...
		/* Parse "id" */
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(period,(xmlChar*)MPD_ATTR_ID_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
		...
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(period,(xmlChar*)MPD_ATTR_SEGALIGNFLAG_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
		...
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(period,(xmlChar*)MPD_ATTR_BITSTREAMSWITCHFLAG_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
...
mpdErr_e local_mpdparser_parse_represent(mpdPeriod_t *mpdPeriod, mpdElement_Period_t *periodElement)
{
	...
	for(i = 0 ; i < mpdPeriod->nTotalRepresent && represent != NULL ; i++)
	{
		...
		/* Parse "id" */
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(represent,(xmlChar*)MPD_ATTR_ID_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
		...
		/* Parse "bandwidth" */
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(represent,(xmlChar*)MPD_ATTR_BANDWIDTH_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_OK)
		{
		...
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(represent,(xmlChar*)MPD_ATTR_QUALITYRANK_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
		...
		/* Parse "duration" */
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(segInfo,(xmlChar*)MPD_ATTR_DURATION_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
		...
		/* Parse "startIndex" */
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(segInfo,(xmlChar*)MPD_ATTR_STARTINDEX_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
		...
		/* Parse "baseURL" */
		VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
		errCode = local_mpdparser_get_attr_value(segInfo,(xmlChar*)MPD_ATTR_BASEURL_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
		if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
		{
		...
		else
		{
			...
			/* Parse "sourceURL" */
			VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
			errCode = local_mpdparser_get_attr_value(element,(xmlChar*)MPD_ATTR_SOURCEURL_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
			if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
			{
			...
			/* Parse "range" */
			VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
			errCode = local_mpdparser_get_attr_value(element,(xmlChar*)MPD_ATTR_RANGE_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
			if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
			{
		...
		else
		{
			...
			/* Parse "sourceURL" */
			VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
			errCode = local_mpdparser_get_attr_value(urlTemplate,(xmlChar*)MPD_ATTR_SOURCEURL_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
			if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
			{
				(mpdPeriod->representSet+i)->segInfo.urlTemplate.pSrcUrl = NULL;
			}
			...
			/* Parse "endIndex" */
			VK_MEM_Memset(szBuf, 0x00, MPD_CONST_ATTR_BUFSIZE);
			errCode = local_mpdparser_get_attr_value(urlTemplate,(xmlChar*)MPD_ATTR_ENDINDEX_NAME,szBuf,MPD_CONST_ATTR_BUFSIZE);
			if(errCode == MPD_ERR_FAIL_ATTR_NOTFOUND)
			{
				(mpdPeriod->representSet+i)->segInfo.urlTemplate.endIndex = 0;
			}
...
mpdErr_e util_mpdparser_parse(mpdParser_t *parser)
{
	int i = 0;
	mpdErr_e errCode = MPD_ERR_OK;
 	// char szBuf[MPD_CONST_ATTR_BUFSIZE]; // check buffer size
