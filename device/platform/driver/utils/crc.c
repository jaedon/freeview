 ...
 *********************************************************************/
const unsigned long	s_aulCrc32Tbl[256] =
{
...
const unsigned short s_ausCrc16Tbl[256] =
{
...
unsigned long DRV_UTIL_GetCrc32(void *pvBuf, unsigned long n)
{
	...
	unsigned char		*p = (unsigned char *)pvBuf;

	crc = -1;
	tbl = (unsigned long *)s_aulCrc32Tbl;
	while (n--)
	{
...
{
	register unsigned short	crc, *tbl;
	unsigned char		*p = (unsigned char *)pvBuf;

	crc = 0;
	tbl = (unsigned short *)s_ausCrc16Tbl;
	while (n--)
	{
