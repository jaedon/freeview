 ...
 * $Revision: 1.23 $
 * $Id: appdefs.h,v 1.23 2006/02/21 19:59:29 dmounday Exp $
 *----------------------------------------------------------------------*/
/* Buffer sizes */
#ifndef BSTD_UNUSED
...
#define PARAMLISTSZ (30000*2)    /*size of built-up parameter lists */
#define XMLBUFSZ    (35000*2)    /*size of complete SOAP message */
...
#define ACSDOMAIN   "/"
#define ACS_URL         "http://10.13.135.248:7547/acs"
#define ACSCONNPATH "/"
