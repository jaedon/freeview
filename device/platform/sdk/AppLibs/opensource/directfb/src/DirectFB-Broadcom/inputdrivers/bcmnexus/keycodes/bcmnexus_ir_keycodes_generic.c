 ...
 *  ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: bcmnexus_ir_keycodes_generic.c $
 * $brcm_Revision: DirectFB_1_4_14_Port/1 $
 *
 * [File Description:]
 *
 * Revision History:
 * $brcm_Log: /AppLibs/opensource/directfb/src/broadcom_files/private/DirectFB/1.4.5/inputdrivers/bcmnexus/keycodes/bcmnexus_ir_keycodes_generic.c $
 * 
 ...
 * 
 * DirectFB_1_4_Port/3   3/14/11 4:58p robertwm
...
#include "bcmnexus_ir_keycodes_generic.h"

DFB_BCMNEXUS_IR_KEYCODES(generic)
