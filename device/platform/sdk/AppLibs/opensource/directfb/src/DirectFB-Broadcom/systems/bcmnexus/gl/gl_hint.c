 ...
 * Revision History:
 *
 * $brcm_Log: /AppLibs/opensource/directfb/src/broadcom_files/private/DirectFB/1.4.5/systems/bcmnexus/gl/gl_hint.c $
 * 
	...
	GLenum mode )
{
	...
	if( target == GL_GENERATE_MIPMAP_HINT )
		pContext->bGenerateMipmaps = (mode == GL_NICEST) ? GL_TRUE : GL_FALSE;
}
