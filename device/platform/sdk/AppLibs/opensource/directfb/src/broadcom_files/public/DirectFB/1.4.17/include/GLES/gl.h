...
/* GN - ADDED SCREEN ALIGNED RECTANGLE POLYGON */
#define GL_RECTANGLES                     0x0010
...
/* GN - ADDED FOR VIDEO AND SWIZZLED TEXTURES */
#define GL_TEXTURE_VIDEO                  0x0DF0
#define GL_TEXTURE_SWIZZLE                0x0DF1
...
/* GN - ADDED FOR VIDEO TEXTURES */
#define GL_YCBCR                          0x1920
/* GN - ADDED ARGB TEXTURES */
#define GL_ARGB                           0x1921
...
/* GN - ADDED TO SUPPORT PX3D SCREEN ALIGNED RECTANGLES */
GLAPI void APIENTRY glDrawAlignedRectangle( const GLfloat *v, const GLfloat *t, GLuint ulColor );
...
GLAPI void APIENTRY glQueryMatrixf( const GLfloat **m );
