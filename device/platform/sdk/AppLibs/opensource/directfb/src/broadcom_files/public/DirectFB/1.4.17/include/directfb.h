...
typedef enum {
     ...
     DLCAPS_FOLLOW_VIDEO      = 0x04000000,  /* Supports using video metadata for z depth on layers with
                                                DLOP_LR_MONO or DLOP_STEREO. */

     DLCAPS_ALL               = 0x0773FFFF
...
typedef enum {
     ...
     DFXL_FILLTRIANGLES  = 0x00000080,  /* FillTriangles() is accelerated. */
     ...
     DFXL_ALL            = 0x010F009F,  /* All drawing/blitting functions. */
     DFXL_ALL_DRAW       = 0x0000009F,  /* All drawing functions. */
...
typedef enum {
     ...
     DFFA_NOBITMAP       = 0x00000020,  /* ignore bitmap strikes; for
                                           ...
                                           ignored */
     DFFA_ITALIC         = 0x00000040,  /* Force italic font display */
     DFFA_REVERSE_ITALIC = 0x00000080,  /* Force reverse italic font display */
     DFFA_OUTLINED       = 0x00001000,  /* Force outline font display */
     DFFA_BOLD           = 0x00002000,  /* Force bold font display */
     DFFA_AUTOHINTING    = 0x00004000,  /* prefer auto-hinter over the font's
                                           native hinter */
     DFFA_SOFTHINTING    = 0x00008000   /* use a lighter hinting algorithm
...
typedef enum {
     ...
     DSPF_LUT4      = DFB_SURFACE_PIXELFORMAT( 37,  4, 0, 1, 4, 0, 1, 0, 0, 1, 0 ),

     /* 32 bit  ABGR (4 byte, alpha 8@24, blue 8@16, green 8@8, red 8@0) */
     DSPF_ABGR      = DFB_SURFACE_PIXELFORMAT( 38, 24, 8, 1, 0, 4, 0, 0, 0, 0, 0 ),

     /*  16 bit   LUT (1 byte alpha and 8 bit color lookup from palette) */
     DSPF_ALUT8     = DFB_SURFACE_PIXELFORMAT( 39,  8, 8, 1, 0, 2, 0, 0, 0, 1, 0 ),
...
typedef enum {
     ...
     DSECAPS_FRAMING      = 0x00008000, /* Can specify HDMI picture framing mode */
     DSECAPS_ASPECT_RATIO = 0x00010000, /* Can specify display aspect ratio */

     DSECAPS_ALL          = 0x00017f3f
