 ...
 */
#define D_RESULT_TYPE_BASE( a,b,c )     ((((unsigned)(a)&0x7f) * 0x01000000) + \
                                         (((unsigned)(b)&0x7f) * 0x00020000) + \
                                         (((unsigned)(c)&0x7f) * 0x00000400))

/*
 * Generate result code maximum for API 'A','B','C', e.g. 'D','F','B'.
 */
#define D_RESULT_TYPE_MAX( a,b,c )      (D_RESULT_TYPE_BASE(a,b,c) + 0x3ff)
