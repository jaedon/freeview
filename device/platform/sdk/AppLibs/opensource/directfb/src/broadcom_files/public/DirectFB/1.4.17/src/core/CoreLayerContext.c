...
DFBResult
CoreLayerContext_GetStereoDepth(
                    CoreLayerContext                          *obj,
...
)
{
    ...
    switch (CoreDFB_CallMode( core_dfb )) {
        case COREDFB_CALL_DIRECT:{
            Core_PushCalling();
            ret=  ILayerContext_Real__GetStereoDepth( obj, ret_follow_video, ret_z );
            Core_PopCalling();
        ...
        case COREDFB_CALL_INDIRECT: {
            Core_PushCalling();
            ret = ILayerContext_Requestor__GetStereoDepth( obj, ret_follow_video, ret_z );
            Core_PopCalling();
...
)
{
    ...
    switch (CoreDFB_CallMode( core_dfb )) {
        case COREDFB_CALL_DIRECT:{
            Core_PushCalling();
            ret = ILayerContext_Real__SetStereoDepth( obj, follow_video, z );
            Core_PopCalling();
        ...
        case COREDFB_CALL_INDIRECT: {
            Core_PushCalling();
            ret = ILayerContext_Requestor__SetStereoDepth( obj, follow_video, z );
            Core_PopCalling();
...
DFBResult ILayerContext_Requestor__GetStereoDepth( CoreLayerContext *obj,
                    bool                                      *ret_follow_video,
                    s32                                       *ret_z )
{
    DFBResult           ret;
    CoreLayerContextGetStereoDepth       *block = (CoreLayerContextGetStereoDepth*) alloca( sizeof(CoreLayerContextGetStereoDepth) );
    CoreLayerContextGetStereoDepthReturn  return_block;

    D_DEBUG_AT( DirectFB_CoreLayerContext, "ILayerContext_Requestor::%s()\n", __FUNCTION__ );


    ret = (DFBResult) CoreLayerContext_Call( obj, FCEF_NONE, _CoreLayerContext_GetStereoDepth, block, sizeof(CoreLayerContextGetStereoDepth), &return_block, sizeof(return_block), NULL );
    if (ret) {
        D_DERROR( ret, "%s: CoreLayerContext_Call( CoreLayerContext_GetStereoDepth ) failed!\n", __FUNCTION__ );
        return ret;
    }

    if (return_block.result) {
         D_DERROR( return_block.result, "%s: CoreLayerContext_GetStereoDepth failed!\n", __FUNCTION__ );
         return return_block.result;
    }

    *ret_follow_video =  return_block.follow_video;
    *ret_z = return_block.z;

    return DFB_OK;
}

DFBResult
ILayerContext_Requestor__SetStereoDepth( CoreLayerContext *obj,
                    bool                                       follow_video,
                    s32                                        z
)
{
    DFBResult           ret;
    CoreLayerContextSetStereoDepth       *block = (CoreLayerContextSetStereoDepth*) alloca( sizeof(CoreLayerContextSetStereoDepth) );
    CoreLayerContextSetStereoDepthReturn  return_block;

    D_DEBUG_AT( DirectFB_CoreLayerContext, "ILayerContext_Requestor::%s()\n", __FUNCTION__ );


    block->follow_video = follow_video;
    block->z = z;

    ret = (DFBResult) CoreLayerContext_Call( obj, FCEF_NONE, _CoreLayerContext_SetStereoDepth, block, sizeof(CoreLayerContextSetStereoDepth), &return_block, sizeof(return_block), NULL );
    if (ret) {
    ...
    if (return_block.result) {
         D_DERROR( return_block.result, "%s: CoreLayerContext_SetStereoDepth failed!\n", __FUNCTION__ );
         return return_block.result;
    }
