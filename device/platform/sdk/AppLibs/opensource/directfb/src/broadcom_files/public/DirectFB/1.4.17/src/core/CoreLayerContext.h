...
DFBResult CoreLayerContext_GetStereoDepth(
                    CoreLayerContext                          *obj,
...
typedef enum {
    ...
    _CoreLayerContext_GetStereoDepth = 13,
    _CoreLayerContext_SetStereoDepth = 14,
    _CoreLayerContext_SetFieldParity = 15,
    _CoreLayerContext_SetClipRegions = 16,
    _CoreLayerContext_CreateWindow = 17,
    _CoreLayerContext_FindWindow = 18,
    _CoreLayerContext_FindWindowByResourceID = 19,
 ...
 */
typedef struct {
} CoreLayerContextGetStereoDepth;

typedef struct {
    DFBResult                                  result;
    bool                                       follow_video;
    s32                                        z;
} CoreLayerContextGetStereoDepthReturn;
...
DFBResult ILayerContext_Real__GetStereoDepth( CoreLayerContext *obj,
                    bool                                      *ret_follow_video,
                    s32                                       *ret_z );

DFBResult ILayerContext_Real__SetStereoDepth( CoreLayerContext *obj,
                    bool                                       follow_video,
                    s32                                        z);
...
DFBResult ILayerContext_Requestor__SetStereoDepth( CoreLayerContext *obj,
                    bool                                       follow_video,
                    s32                                        z);
