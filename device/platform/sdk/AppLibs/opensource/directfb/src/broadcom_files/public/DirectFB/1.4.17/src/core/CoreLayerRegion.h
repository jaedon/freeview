...
typedef enum {
    ...
    _CoreLayerRegion_FlipUpdateStereo = 3,
} CoreLayerRegionCall;
...
DFBResult ILayerRegion_Real__FlipUpdateStereo( CoreLayerRegion *obj,
                    const DFBRegion                           *left,
                    const DFBRegion                           *right,
                    DFBSurfaceFlipFlags                        flags );
...
DFBResult ILayerRegion_Requestor__FlipUpdateStereo( CoreLayerRegion *obj,
                    const DFBRegion                           *left,
                    const DFBRegion                           *right,
                    DFBSurfaceFlipFlags                        flags );
