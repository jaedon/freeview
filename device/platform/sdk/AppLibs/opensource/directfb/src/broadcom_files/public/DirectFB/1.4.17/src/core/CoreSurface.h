...
DFBResult CoreSurface_GetStereoEye(
                    CoreSurface                               *obj,
                    DFBSurfaceStereoEye                       *ret_eye);

DFBResult CoreSurface_SetStereoEye(
                    CoreSurface                               *obj,
                    DFBSurfaceStereoEye                        eye);
...
typedef enum {
    ...
    _CoreSurface_GetStereoEye = 11,
    _CoreSurface_SetStereoEye = 12,
} CoreSurfaceCall;
 ...
 */
typedef struct {
    bool                                       dummy; /* stop compile warning */
 ...
 */
typedef struct {
    u32                                        dummy; /* stop compile warning */
} CoreSurfaceGetStereoEye;

typedef struct {
    DFBResult                                  result;
    DFBSurfaceStereoEye                        eye;
} CoreSurfaceGetStereoEyeReturn;
...
typedef struct {
    DFBSurfaceStereoEye                        eye;
} CoreSurfaceSetStereoEye;

typedef struct {
    DFBResult                                  result;
} CoreSurfaceSetStereoEyeReturn;
...
DFBResult ISurface_Real__GetStereoEye( CoreSurface *obj,
                    DFBSurfaceStereoEye                       *ret_eye );

DFBResult ISurface_Real__SetStereoEye( CoreSurface *obj,
                    DFBSurfaceStereoEye                        eye );
...
DFBResult ISurface_Requestor__GetStereoEye( CoreSurface *obj,
                    DFBSurfaceStereoEye                       *ret_eye );

DFBResult ISurface_Requestor__SetStereoEye( CoreSurface *obj,
                    DFBSurfaceStereoEye                        eye );
