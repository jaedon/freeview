               ...
               IDirectFBSurface      **ret_surface )
{
     ...
     surface->Clear( surface, 0x00, 0xa0, 0xc0, 0xd0 );

     surface->SetColor( surface, 0x00, 0x40, 0xe0, 0xff );
...
main( int argc, char *argv[] )
{
     ...
     printf( "Configured encoder to STEREO.\n" );
     sleep( 1 );
     ...
     printf( "Configured layer to STEREO.\n" );
     sleep( 5 );
     ...
     printf( "Created second window.\n" );
     sleep( 5 );


     while (true) {
          ret = window2->SetStereoDepth( window2, -10 );
          if (ret) {
