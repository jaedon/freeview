...
#if defined(CONFIG_NETFLIX_SUPPORT) /* HUMAX_PLATFORM_BASE : NRD4.2.2 requires upsized FUSION_MAX_PACKET_SIZE for font drawing */
#define FUSION_MAX_PACKET_SIZE	32768
#else
