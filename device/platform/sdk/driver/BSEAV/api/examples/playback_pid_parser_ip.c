 ...
 *  ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: playback_pid_parser_ip.c $
 * $brcm_Revision: 6 $
 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/api/examples/playback_pid_parser_ip.c $
 * 
...
int main(void) {
	...
	playback = bplayback_ip_open();

	bstream_mpeg_init(&mpeg);
	mpeg.video[0].pid = 220;
	mpeg.audio[0].pid = 230;
	mpeg.pcr_pid = 220;
	...
	strcpy(socket_params.open_params.ip_addr,"224.0.0.10");
