 ...
 *  ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: streamer_desecb.c $
 * $brcm_Revision: 5 $
 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/api/examples/streamer_desecb.c $
 * 
 ...
 * 
 * This specific example demonstrates DES ECB decryption.
 * 
...
int main(void) {
	...
	/* Assumes des_ecb_56_bit_spider.ts */
	...
	encryption.type = bencryption_type_des;
	encryption.blockmode = bcrypto_blockmode_ecb;
	encryption.residue = bencryption_residue_none;
