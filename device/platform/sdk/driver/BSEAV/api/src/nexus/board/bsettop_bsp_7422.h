 ...
 *
 * $brcm_Workfile: bsettop_bsp_7422.h $
 * $brcm_Revision: 2 $
 * $brcm_Date: 2/15/11 2:08p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /BSEAV/api/src/nexus/board/bsettop_bsp_7422.h $
 * 
 * 2   2/15/11 2:08p nickh
 * SW7422-213: Add SVC/MVC support
 * 
 * 1   10/20/10 4:37p nickh
