 ...
 *
 * $brcm_Workfile: bsettop_bsp_7552.h $
 * $brcm_Revision: 3 $
 * $brcm_Date: 7/7/11 2:28p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /BSEAV/api/src/nexus/board/bsettop_bsp_7552.h $
 * 
 * 3   7/7/11 2:28p xhuang
 * SW7552-34: enable DTS/AC3 encode
 * 
 * 2   6/1/11 8:43p xhuang
 * SW7552-34: Bringup frontend in Brutus
 * 
 * 1   2/15/11 11:18a xhuang
