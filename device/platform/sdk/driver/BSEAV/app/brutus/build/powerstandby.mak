...
# $brcm_Revision: 13 $
# $brcm_Date: 7/26/11 10:55a $
#
# Module Description:
#
# Revision History:
#
# $brcm_Log: /BSEAV/app/brutus/build/powerstandby.mak $
# 
# 13   7/26/11 10:55a mward
# SW7420-2006: Rename for pmlib-2631.h,c pmlib-263x.h,c for wider 2.6.3x
# kernel support.
# 
# 12   4/6/11 2:30p gmohile
...
# 2.6.31
APP_OBJECTS += pmlib-263x.o
else                                    # if kernel < 2.6.30
# 2.6.18
$(error Power Standby is not supported for kernel version below 2.6.30)
endif
endif
