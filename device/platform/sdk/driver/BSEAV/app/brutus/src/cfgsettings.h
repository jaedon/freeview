 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/app/brutus/src/cfgsettings.h $
 * 
 * 87   3/19/12 6:44p erickson
 * SW7425-2664: purge old code
 * 
 * 86   1/12/12 10:14a jrubio
 * SW7346-400: add silver remote
 * 
 * 85   4/8/11 4:20p ahulse
 * SW7405-5212: Add cfg to force aspect ratio on composite output for a 3d
 * to 2d converted source
 * 
...
/* Here's the dual-purpose code */
    ...
    DECLARE(NEC_REMOTE, bool, "NEC IR remote (Broadcom silver remote)"),
    ...
    DECLARE(FORCE_COMPOSITE_OUTPUT_AR_FOR_3D_TO_2D,  bool, "Force composite output to have 16:9 aspect ratio for 3D SBS to 2D conversion"),
