 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/app/splash/splashgen/93556/bsplash_board.h $
 * 
 * 3   5/7/10 2:26p randyjew
 * SW7468-227:Add SPLASH_NUM_XXX_OUTPUTS defines to be compatible with
 * splash_setup_vdc.c
 * 
 * 2   5/11/09 5:30p shyam
 * PR53637 : Fix reg ranges to use bchp_common.h
 * 
 * 1   5/11/09 12:49p shyam
 * PR53637 : Add splash support for 93556
 * 
...
#define BSPLASH_REGDUMP_EXCLUDE(addr)   ( \
        ...
        BSPLASH_ADDRESS_IN_RANGE(addr, BCHP_EBI_REG_START, BCHP_EBI_REG_END) || \
