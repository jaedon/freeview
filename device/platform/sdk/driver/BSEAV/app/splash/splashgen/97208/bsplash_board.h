 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/app/splash/splashgen/97208/bsplash_board.h $
 * 
 * 3   12/20/11 4:51p randyjew
 * SW7208-176:Change Hdmi Output Format default to RGB from YCrCb.
 * 
 * 2   11/14/11 11:59a randyjew
 * SW7468-6: Exclude Clkgen registers. Update to use 480p for hdmi
 * 
 * 1   4/30/10 4:40p randyjew
...
/* Some Hdmi Tv's don't support YCbCr
  * 1= BHDM_OutputFormat_eHDMIMode(YCrCb) : 0=  BHDM_OutputFormat_eDVIMode(RGB)
  */
#define SPLASH_HDMI_OUTPUTFORMAT_YCrCb 0
