 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/app/splash/splashgen/97231/bsplash_board.h $
 * 
 * 5   9/26/12 4:31p randyjew
 * SW7425-3872: Fix 7231 exclude AVS registers
 * 
 * 4   9/26/12 4:28p randyjew
 * SW7425-3872: Fix 7231 exclude AVS registers
 * 
 * 3   9/26/12 4:26p randyjew
 * SW7425-3872: Exclude AVS registers
 * 
 * 2   3/22/12 3:51p katrep
 * SW7231-737:add comment to enable 720 splash
 * 
...
for resolution higher than 480p, need to disable secondary display 
#define SPLASH_CMP_1_PATH_DISPLAY   -1
*/
...
#else
#define SPLASH_CMP_0_PATH_DISPLAY   BFMT_VideoFmt_e480p  /*  BFMT_VideoFmt_e720p */
#define SPLASH_CMP_1_PATH_DISPLAY   BFMT_VideoFmt_eNTSC  /*  -1 */
#endif
