 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/app/splash/splashgen/97335/bsplash_board.h $
 * 
 * 6   5/7/10 2:27p randyjew
 * SW7468-227:Add SPLASH_NUM_XXX_OUTPUTS defines to be compatible with
 * splash_setup_vdc.c
 * 
 * 5   11/30/09 3:17p jrubio
 * SW7335-627: fix Splash
 * 
 * 4   4/27/09 6:24p jrubio
 * PR44849: add 7325 support
 * 
 * 3   4/27/09 6:13p jrubio
 * PR44849: fix splash for 7335/7325
 * 
 * 2   4/8/09 5:22p shyam
...
#define BSPLASH_REGDUMP_EXCLUDE(addr)	( \
        ...
        BSPLASH_ADDRESS_IN_RANGE(addr, BCHP_MEMC_0_L2_REG_START, BCHP_MEMC_0_L2_REG_END) || \
        BSPLASH_ADDRESS_IN_RANGE(addr, BCHP_MEMC_1_L2_REG_START, BCHP_MEMC_1_L2_REG_END) \
        )
