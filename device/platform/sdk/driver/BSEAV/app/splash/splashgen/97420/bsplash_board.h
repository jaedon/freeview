 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/app/splash/splashgen/97420/bsplash_board.h $
 * 
 * 3   5/7/10 2:29p randyjew
 * SW7468-227:Add SPLASH_NUM_XXX_OUTPUTS defines to be compatible with
 * splash_setup_vdc.c
 * 
 * 2   9/24/09 11:39p nickh
 * SW7420-351: Change pixel surface type for CFE build
 * 
 * 1   9/21/09 5:07p nickh
...
#define BSPLASH_REGDUMP_EXCLUDE(addr)	( \
		...
		BSPLASH_ADDRESS_IN_RANGE(addr, BCHP_RFM_L2_REG_START, BCHP_RFM_BBE_L2_REG_END) || \
		...
		BSPLASH_ADDRESS_IN_RANGE(addr, BCHP_MEMC_GEN_1_ARC_0_CNTRL, BCHP_MEMC_GEN_1_ARC_3_VIOLATION_INFO_CMD) || \
		...
		BSPLASH_ADDRESS_IN_RANGE(addr, BCHP_MEMC_L2_1_REG_START, BCHP_MEMC_L2_1_REG_END) \
		)
