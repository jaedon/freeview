 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/app/splash/splashgen/97550/bsplash_board.h $
 * 
 * 4   5/7/10 1:57p randyjew
 * SW7550-284: Add splash num compoents to 1
 * 
 * 3   5/7/10 1:51p randyjew
 * SW7550-284: Add SPLASH_NUM_XXX_OUTPUTS defines to be compatible with
 * splash_setup_vdc.c
 * 
...
#define SPLASH_CMP_0_PATH_DISPLAY   BFMT_VideoFmt_ePAL_G
#else
#define SPLASH_CMP_0_PATH_DISPLAY	BFMT_VideoFmt_e480p 
#endif
#define SPLASH_CMP_1_PATH_DISPLAY	((BFMT_VideoFmt)-1)  /* use only one display path on 7550 */
