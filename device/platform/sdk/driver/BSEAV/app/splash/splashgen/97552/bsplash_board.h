 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/app/splash/splashgen/97552/bsplash_board.h $
 * 
 * 3   10/25/12 6:47p xhuang
 * SW7552-373: update splash header file
 * 
 * 2   12/8/11 5:28p xhuang
 * SW7552-169: merge to main for B0
 * 
 * SW7552-169/1   12/7/11 1:59p jianweiz
 * SW7552-169: Add support for B0
 * 
