...
//
//****************************************************************************
//  $Id: IpAddressCommandParameter.h 1.5 2004/01/05 14:21:00Z dpullen Release $
//
//  Filename:       IpAddressCommandParameter.h
//  Author:         David Pullen
//  Creation Date:  Feb 23, 2001
//
//****************************************************************************

#ifndef IPADDRESSCOMMANDPARAMETER_H
#define IPADDRESSCOMMANDPARAMETER_H
...
/** \ingroup BfcConsole
*
*      This is the derived class for IP Address parameters.  It handles
...
*             pointers are stored!
*/
class BcmIpAddressCommandParameter : public BcmCommandParameter
{
public:
    ...
    ///
    /// If pParameterName is NULL, "IpAddress" will be used.
    ///
    /// \param
    ...
    ///
    BcmIpAddressCommandParameter(unsigned int clientId = 0, 
    ...
    /// state.
    ///
    virtual ~BcmIpAddressCommandParameter();
...
private:
    ...
    BcmIpAddressCommandParameter(const BcmIpAddressCommandParameter &otherInstance);

    /// Assignment operator.  Not supported.
    BcmIpAddressCommandParameter & operator = (const BcmIpAddressCommandParameter &otherInstance);
...
///
inline ostream & operator << (ostream &outputStream, const BcmIpAddressCommandParameter &commandParameter)
{
