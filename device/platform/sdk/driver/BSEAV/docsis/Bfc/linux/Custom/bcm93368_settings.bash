...
# Setup script specific to the bcm93368 reference design, but independent of
...
echo "Setting build options from Bfc/linux/Custom/bcm93368_settings.bash"

#TODO:  ADD EJTAG SUPPORT - FOR NOW DISABLED ON LINUX BUILD
# Now add target-specific options.
app_options="${app_options} 3368 fpm nofpm_descr_only noejtag"
