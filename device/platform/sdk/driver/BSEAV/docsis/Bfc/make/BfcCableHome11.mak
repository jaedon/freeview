...
#
##############################################################################
#  $Id: BfcCableHome11.mak 1.17 2007/02/14 21:00:44Z koneal Release $
#
#  Filename:       BfcCableHome11.mak
#  Author:         John McQueen
...
BFC_CABLEHOME11_OBJECTS  += \
        PsDevHttpIpServiceAppIf.o \
        CableHomeDisabledModeLanAccessSnoop.o
        

BFC_CABLEHOME11_QOS_OBJECTS += \
        ChQosTrafficClassTableEntry.o \
        ChPriorityQosPsIfAttribEntry.o \
        ChQosSnoop.o \
        CableHomeQosIpServiceAppIf.o \
        Cqp2NonVolSettings.o
        
BFC_CABLHOME11_SNMP_OBJECTS = \
        chDocsDevFilterMib.o \
        chDocsDevFilterBridge.o \
        IpTrafficBridge.o \
        PsDevSnmpIf.o \
        QosSnmpIf.o \
        chQos2Bridge.o \
...
BFC_CABLHOME11_FACTORY_OBJECTS =

BFC_CABLHOME11_BRCM_SNMP_OBJECTS = \
        brcmCablehomeMgmtBridge.o \
        brcmCablehomeMgmtMib.o

BFC_CABLEHOME11_CONSOLE_SNMP_OBJECTS += \
        Cqp2NonVolSettingsCommandTable.o 
...
BFC_OBJECTS += $(BFC_CABLHOME11_SNMP_OBJECTS) $(BFC_CABLEHOME11_QOS_OBJECTS) 

        # Add CableHome console components, if support for Console are both included.
        ifeq ($(BFC_INCLUDE_CONSOLE_SUPPORT), 1)
        
            BFC_OBJECTS += $(BFC_CABLEHOME11_CONSOLE_SNMP_OBJECTS)
        ...
        ifeq ($(BFC_INCLUDE_BRCM_FACTORY_MIB_SUPPORT), 1)
            ...
            BFC_OBJECTS += $(BFC_CABLHOME11_FACTORY_OBJECTS)
        ...
        ifeq ($(BFC_INCLUDE_BRCM_RUNTIME_MIB_SUPPORT), 1)
            ...
            BFC_OBJECTS += $(BFC_CABLHOME11_BRCM_SNMP_OBJECTS)
...
BFC_OBJECTS += $(BFC_CABLEHOME11_OBJECTS)  

BFC_COMPILER_DEFINES += $(BFC_CABLEHOME11_DEFINES)
