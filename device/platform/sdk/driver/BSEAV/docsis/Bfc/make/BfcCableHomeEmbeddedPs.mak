...
#
##############################################################################
#  $Id: BfcCableHomeEmbeddedPs.mak 1.6 2004/07/21 13:30:47Z koneal Release $
#
#  Filename:       BfcCablehomeEmbeddedPs.mak
#  Author:         John McQueen
...
#  Description:
#
# 	This file contains the build components for CableHome Embedded Ps.
#
##############
#
...
BFC_CABLEHOME_EMBEDDED_PS_DIR = $(BFC_CABLEHOME_DIR)
...
BFC_CABLEHOME_EMBEDDED_PS_OBJECTS += \
        EpsCableHomeCtlThread.o \
        CableHomeCtrlThreadCmDocsisStatusClientACT.o \
        CableHomeAppFactoryCmMibs.o \
        DocsisModeDhcpServerIpServiceAppIf.o \
        DocsisModeDhcpServerDocsisStatusClientEventACT.o \
        esafeMib.o \
        esafeBridge.o \
        esafePsMib.o \
        esafePsBridge.o
...
BFC_CABLEHOME_EMBEDDED_PS_DEFINES = CABLEHOME_EMBEDDED_PS=1
...
BFC_CABLEHOME_EMBEDDED_PS_INCLUDE_DIRS = $(BFC_CABLEHOME_EMBEDDED_PS_DIR) \
        $(BFC_EDOCSIS_DIR)
...
BFC_CABLEHOME_EMBEDDED_PS_SOURCE_DIRS = $(BFC_CABLEHOME_EMBEDDED_PS_DIR) \
        $(BFC_EDOCSIS_DIR)
...
BFC_OBJECTS += $(BFC_CABLEHOME_EMBEDDED_PS_OBJECTS) 

BFC_INCLUDE_DIRS += $(BFC_CABLEHOME_EMBEDDED_PS_INCLUDE_DIRS)

BFC_SOURCE_DIRS += $(BFC_CABLEHOME_EMBEDDED_PS_SOURCE_DIRS)

BFC_COMPILER_DEFINES += $(BFC_CABLEHOME_EMBEDDED_PS_DEFINES)
