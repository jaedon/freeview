...
#
##############################################################################
#  $Id: BfcCableHomeStandalonePs.mak 1.22 2005/10/26 18:29:56Z czacker-atl Release $
#
#  Filename:       BfcCableHomeStandalonePs.mak
#  Author:         John McQueen
...
#  Description:
#
# 	This file contains the build components for CableHome Standalone Ps.
#
##############
#
...
BFC_CABLEHOME_STANDALONE_PS_DIR = $(BFC_CABLEHOME_DIR)/Standalone

ifeq ($(BFC_INCLUDE_OPENSSL098), 1)
BFC_CABLEHOME_STANDALONE_PS_DIR += Bfc/LibSupport/OpenSSL098/include/openssl Bfc/LibSupport/OpenSSL098/include
else
BFC_CABLEHOME_STANDALONE_PS_DIR += Bfc/LibSupport/OpenSSL/include/openssl Bfc/LibSupport/OpenSSL/include
endif 
BFC_DOCSIS_DIR = Docsis

BFC_DOCSIS_BPI_DIR = $(BFC_DOCSIS_DIR)/BaselinePrivacy

BFC_DOCSIS_OSS_DIR = $(BFC_DOCSIS_DIR)/Oss
...
#BFC_CABLEHOME_STANDALONE_PS_OBJECTS += EcosTimeOfDay.o


ifneq ($(BFC_TARGET_OS), Win32)

    BFC_CABLEHOME_STANDALONE_PS_OBJECTS += OpenSSLCryptoApi.o
     
# openSSL 0.9.8 support
ifeq ($(BFC_INCLUDE_OPENSSL098), 1)            
    BFC_CABLEHOME_STANDALONE_PS_DEFINES += BFC_INCLUDE_OPENSSL098=1
endif
 

endif

BFC_CABLEHOME_STANDALONE_PS_SNMP_OBJECTS += \
        CableHomeSpsSnmpNonVolSettings.o \
        CableHomeSpsCspNonVolSettings.o \
        CableHomeBpiPlusBridge.o \
	CableHomeBpiPlusMib.o \
        chDocsDevBridge.o \
        Snmp3KickstartValue.o \
        Snmp3NotifyReceiver.o \
        DigiCertificate.o \
        CableHomeSpsSecureDownload.o \
        CmDownloadParseTlv.o \
        CableHomeSpsCVC.o \
        ParseAsn1.o \
        CableHomeSpsCodeSignerInfo.o \
        CableHomeStandalonePsThread.o \
        CableHomeStandalonePsThreadStatusClientACT.o 
        
                   
BFC_CABLEHOME_STANDALONE_PS_SNMP_CONSOLE_OBJECTS = \
	CableHomeSpsSnmpNonVolSettingsCommandTable.o \
	CableHomeSpsCspNonVolSettingsCommandTable.o 

        
BFC_FACTORY_CABLEHOME_STANDALONE_PS_OBJECTS = \
        SpsCabledataFactoryBridge.o

ifeq ($(BCM_SNTP_SUPPORT),1)
BFC_CABLEHOME_STANDALONE_PS_OBJECTS += HttpFormHandlerRgTime.o HttpExportHandlerRgTime.o
endif
...
BFC_CABLEHOME_STANDALONE_PS_DEFINES += CABLEHOME_STANDALONE_PS=1


ifneq ($(BFC_TARGET_OS), Win32)

    BFC_CABLEHOME_STANDALONE_PS_DEFINES += SOFTWARE_CRYPTO_LIB=1 OPENSSL=1 GLOBAL_FUNCTION_POINTERS=1 \
                      SOFTWARE_CRYPTO_LIB_INCLUDED=1 INCLUDE_SECURE_DOWNLOAD=1
...
BFC_CABLEHOME_STANDALONE_PS_INCLUDE_DIRS = \
        $(BFC_CABLEHOME_STANDALONE_PS_DIR) \
        $(BFC_DOCSIS_DIR) $(BFC_DOCSIS_OSS_DIR) $(BFC_DOCSIS_BPI_DIR) 
...
BFC_CABLEHOME_STANDALONE_PS_SOURCE_DIRS = \
        $(BFC_CABLEHOME_STANDALONE_PS_DIR) \
        $(BFC_DOCSIS_DIR) $(BFC_DOCSIS_OSS_DIR) $(BFC_DOCSIS_BPI_DIR)
...
ifeq ($(BFC_INCLUDE_OPENSSL098), 1)
    BFC_CABLEHOME_STANDALONE_PS_LIBRARIES += \
        Bfc/LibSupport/OpenSSL098/libOpenSSLecos.a \
        Bfc/LibSupport/OpenSSL/SecLibecos.a
else
    BFC_CABLEHOME_STANDALONE_PS_LIBRARIES += \
        Bfc/LibSupport/OpenSSL/libOpenSSLecos.a \
        Bfc/LibSupport/OpenSSL/SecLibecos.a
endif
...
ifeq ($(BFC_INCLUDE_SNMP_SUPPORT), 1)
        ...
        BFC_OBJECTS += $(BFC_CABLEHOME_STANDALONE_PS_SNMP_OBJECTS)
        
        ifeq ($(BFC_INCLUDE_BRCM_FACTORY_MIB_SUPPORT), 1)
        
                BFC_OBJECTS += $(BFC_FACTORY_CABLEHOME_STANDALONE_PS_OBJECTS) 
        endif
        ...
        ifeq ($(BFC_CONFIG_MINIMAL_CONSOLE), 0)
                ...
                BFC_OBJECTS += $(BFC_CABLEHOME_STANDALONE_PS_SNMP_CONSOLE_OBJECTS)
...
BFC_OBJECTS += $(BFC_CABLEHOME_STANDALONE_PS_OBJECTS) 

BFC_INCLUDE_DIRS += $(BFC_CABLEHOME_STANDALONE_PS_INCLUDE_DIRS)

BFC_SOURCE_DIRS += $(BFC_CABLEHOME_STANDALONE_PS_SOURCE_DIRS)

BFC_COMPILER_DEFINES += $(BFC_CABLEHOME_STANDALONE_PS_DEFINES)

BFC_LIBRARIES += $(BFC_CABLEHOME_STANDALONE_PS_LIBRARIES)
