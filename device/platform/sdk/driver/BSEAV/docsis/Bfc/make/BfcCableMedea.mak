...
#
##############################################################################
#  $Id: BfcCableMedea.mak 1.4 2004/02/04 16:17:51Z jmcqueen-atl Release $
#
#  Filename:       BfcCableMedea.mak
#  Author:         John McQueen
...
#  Description:
#
# 	This file contains the build components for CableMedea.
#
##############
#
...
BFC_CABLEMEDEA_COMPILER_DEFINES += BCM_OLD_BOARDREV=$(BCM_OLD_BOARDREV)
...
BFC_CABLEMEDEA_INCLUDE_DIRS = $(BFC_CABLEMEDEA_DIR) 
...
BFC_CABLEMEDEA_SOURCE_DIRS = $(BFC_CABLEMEDEA_DIR) 
...
include $(BFC_MAKE_DIR)/BfcResidentialGateway.mak


############################################################################
## CableHome 1.0 & 1.1 Support
############################################################################

include $(BFC_MAKE_DIR)/BfcCableHome.mak
...
ifeq ($(BCM_HTTPS_SUPPORT),1)
   include $(BFC_MAKE_DIR)/BfcHttpServer.mak
endif


############################################################################
## Rules for building CableHome library targets.  These must come after other
## CableHome definitions.
############################################################################

#include $(BFC_MAKE_DIR)/BfcCableHomeRules.inc


BFC_COMPILER_DEFINES += $(BFC_CABLEMEDEA_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_CABLEMEDEA_INCLUDE_DIRS)

BFC_SOURCE_DIRS += $(BFC_CABLEMEDEA_SOURCE_DIRS)
