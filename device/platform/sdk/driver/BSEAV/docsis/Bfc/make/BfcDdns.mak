...
#
##############################################################################
#  $Id: BfcDdns.mak 1.5 2004/11/10 22:09:20Z twhite Release $
#
#  Filename:       BfcDdns.mak
#  Author:         Tyler White
...
#  Description:
#
# 	This file contains the build components for Dynamic DNS.
#
##############
#
...
BFC_DDNS_OBJECTS += DynamicDnsClientThread.o \
        DynamicDnsStatusClientACT.o \
        DynamicDnsCableHomeStatusClientACT.o \
        DynamicDnsIpServiceAppIf.o
...
BFC_DDNS_DEFINES = BCM_DDNS_SUPPORT=1 
...
BFC_COMPILER_DEFINES += $(BFC_DDNS_DEFINES)

BFC_OBJECTS += $(BFC_DDNS_OBJECTS) 
