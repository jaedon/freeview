...
# Core STB objects
BFC_DSG_30_OBJECTS = Dsg30DsgDaToDsidAssociationsList.o \
		     DsgDaToDsidAssociationSettings.o \
		     Dsg30EcmHelper.o
...
BFC_DSG_30_DEFINES += BFC_DSG_30_SUPPORT=1
...
BFC_DSG_30_INCLUDE_DIRS = $(BFC_STB_DIR) 
...
BFC_DSG_30_SOURCE_DIRS = $(BFC_STB_DIR)
...
ifeq ($(BFC_DSG_30_SUPPORT), 1)

	# Add STB components, if included by BfcSystemConfig.mak.
	BFC_OBJECTS += $(BFC_DSG_30_OBJECTS) 

	BFC_COMPILER_DEFINES += $(BFC_DSG_30_DEFINES)

	BFC_INCLUDE_DIRS += $(BFC_DSG_30_INCLUDE_DIRS)

	BFC_SOURCE_DIRS += $(BFC_DSG_30_SOURCE_DIRS)
