...
BFC_ESTB_DHCPv4_OBJECTS += IpHelperDhcpClientEventACT.o \
                           #GenericDhcpV4ClientIf.o \                           
...
BFC_ESTB_DHCPV4_DEFINES += BFC_INCLUDE_DHCPV4_SUPPORT=1
...
ifeq ($(BFC_INCLUDE_DHCPV4_SUPPORT), 1)
	...
	BFC_OBJECTS += $(BFC_ESTB_DHCPv4_OBJECTS) 

	BFC_COMPILER_DEFINES += $(BFC_ESTB_DHCPV4_DEFINES)

	BFC_INCLUDE_DIRS += $(BFC_ESTB_DHCPv4_INCLUDE_DIRS)

	BFC_SOURCE_DIRS += $(BFC_ESTB_DHCPv4_SOURCE_DIRS)

	BFC_LIBRARIES += $(BFC_ESTB_DHCPv4_LIBRARIES)
