...
BFC_ESTB_API_DIR = Stb/StbDocsisApi/Dsg 
...
ifeq ($(BFC_INCLUDE_DHCPV6_SUPPORT), 1)
	...
	BFC_INCLUDE_DIRS += $(BFC_ESTB_DHCPv6_INCLUDE_DIRS) $(BFC_ESTB_API_DIR)

	BFC_SOURCE_DIRS += $(BFC_ESTB_DHCPv6_SOURCE_DIRS) $(BFC_ESTB_API_DIR)
