...
#  Description:
#
# 	This file contains the build components for Firewall.
#
##############
#
...
BFC_FIREWALL_DIR = $(BFC_RESIDENTIAL_GATEWAY_DIR)/Firewall

BFC_CABLEHOME_CSP_DIR = CableHome/Csp
...
BFC_FIREWALL_OBJECTS += \
        ContentFilterSnoop.o \
        HttpContentFilterSnoop.o \
        FirewallSnoop.o \
        FirewallRule.o \
        FirewallNonVolSettings.o \
        FirewallThreadCableHomeStatusClientACT.o \
        FirewallMatch.o \
        FwAhProtoMatch.o \
        FwEspProtoMatch.o \
        FwIcmpProtoMatch.o \
        ...
        FwIpOptionMatch.o \
        FwLimitMatch.o \
	FwLimitMatchSimple.o \
	FwLimitMatchBlacklist.o \
        FwMacSrcMatch.o \
        FwPortMatch.o \
        FwStateMatch.o \
        FwTcpProtoMatch.o \
        ...
        FwPortScanAlert.o \
        ChIpFilterEntry.o \
        ChLocalIpFilterEntry.o \
        bcmFirewallApi.o \
        FirewallIpServiceAppIf.o \
        ChFwLogEntry.o

ifeq ($(BFC_INCLUDE_HTTP_SERVER_SUPPORT),1)        
        BFC_FIREWALL_OBJECTS += \
                HttpFormHandlerRgContentFilter.o \
                HttpFormHandlerRgFirewallEL.o \
                HttpFormHandlerRgFirewallRL.o \
                HttpFormRegistrarFirewall.o 
endif

ifeq ($(BFC_CABLEHOME_STANALONE_PS),1)
else
        BFC_FIREWALL_OBJECTS += FirewallThreadCmDocsisStatusClientACT.o 
endif
    

# Optional console support files.
BFC_FIREWALL_CONSOLE_OBJECTS = FirewallNonVolSettingsCommandTable.o
...
BFC_FIREWALL_DEFINES = BCM_FIREWALL_ENABLED=1
...
BFC_FIREWALL_INCLUDE_DIRS = $(BFC_FIREWALL_DIR) $(BFC_CABLEHOME_CSP_DIR) $(BFC_PARENTAL_CONTROL_DIR) 
...
BFC_FIREWALL_SOURCE_DIRS = $(BFC_FIREWALL_DIR) $(BFC_CABLEHOME_CSP_DIR) $(BFC_PARENTAL_CONTROL_DIR)
...
BFC_OBJECTS += $(BFC_FIREWALL_SNMP_OBJECTS)

endif


BFC_OBJECTS += $(BFC_FIREWALL_OBJECTS)
...
ifeq ($(BFC_INCLUDE_CONSOLE_SUPPORT), 1)
        ...
        BFC_OBJECTS += $(BFC_FIREWALL_CONSOLE_OBJECTS)
        
        endif
endif

BFC_INCLUDE_DIRS += $(BFC_FIREWALL_INCLUDE_DIRS)

BFC_SOURCE_DIRS += $(BFC_FIREWALL_SOURCE_DIRS)

BFC_COMPILER_DEFINES += $(BFC_FIREWALL_DEFINES)
