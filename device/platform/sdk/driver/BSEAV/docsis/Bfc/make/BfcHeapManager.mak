...
#
##############################################################################
#  $Id: BfcHeapManager.mak 1.5 2004/10/01 21:19:46Z msieweke Release $
#
#  Filename:       BfcHeapManager.mak
#  Author:         David Pullen
...
#  Description:
#
# 	Component makefile for the Broadcom HeapManager component.
#
##############
#
...
BFC_HEAP_MANAGER_DIR = Bfc/BcmHeapManager


# For VxWorks, we have hacked the memory lib files to let us override malloc,
# etc.
BFC_HEAP_MANAGER_VXWORKS_OBJS_DIR = $(BFC_ROOT_DIR)/Bfc/vxWorks/patches/Tornado20/added_objs
...
BFC_HEAP_MANAGER_OBJECTS = BcmHeapManager.o

BFC_HEAP_MANAGER_CONSOLE_OBJECTS = HeapManagerCommandTable.o


# OS-specific files.
BFC_HEAP_MANAGER_VxWorks_OBJECTS = \
        BcmHeapManagerMutexApiVxWorks.o \
        $(BFC_HEAP_MANAGER_VXWORKS_OBJS_DIR)/memPartLib.o \
        $(BFC_HEAP_MANAGER_VXWORKS_OBJS_DIR)/memLib.o

BFC_HEAP_MANAGER_Ecos_OBJECTS = BcmHeapManagerMutexApiEcos.o

BFC_HEAP_MANAGER_Win32_OBJECTS = BcmHeapManagerMutexApiWin32.o

# BFC_HEAP_MANAGER_Qnx6_OBJECTS = BcmHeapManagerMutexApiQnx.o
...
BFC_HEAP_MANAGER_DEFINES = BCM_HEAPMANAGER_SUPPORT=1 \
                           BFC_INCLUDE_HEAP_MANAGER_SUPPORT=$(BFC_INCLUDE_HEAP_MANAGER_SUPPORT)
...
BFC_HEAP_MANAGER_INCLUDE_DIRS = $(BFC_HEAP_MANAGER_DIR)
...
BFC_HEAP_MANAGER_SOURCE_DIRS = $(BFC_HEAP_MANAGER_DIR)
...
ifeq ($(BFC_INCLUDE_HEAP_MANAGER_SUPPORT), 1)

    BFC_OBJECTS += $(BFC_HEAP_MANAGER_OBJECTS) $(BFC_HEAP_MANAGER_$(BFC_TARGET_OS)_OBJECTS)

    ifeq ($(BFC_INCLUDE_CONSOLE_SUPPORT), 1)

        BFC_OBJECTS += $(BFC_HEAP_MANAGER_CONSOLE_OBJECTS)

    endif

    BFC_COMPILER_DEFINES += $(BFC_HEAP_MANAGER_DEFINES)

    BFC_INCLUDE_DIRS += $(BFC_HEAP_MANAGER_INCLUDE_DIRS)

    BFC_SOURCE_DIRS += $(BFC_HEAP_MANAGER_SOURCE_DIRS)

    BFC_LIBRARIES += $(BFC_HEAP_MANAGER_LIBRARIES)
