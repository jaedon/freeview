...
#
##############################################################################
#  $Id: BfcHeapMonitor.mak 1.3 2004/08/16 19:06:29Z dpullen Release $
#
#  Filename:       BfcHeapMonitor.mak
#  Author:         David Pullen
...
#  Description:
#
# 	This file contains the build "stuff" for the Heap Monitor, which is a
#	debug aid that shows when the amount of memory on the heap changes.  It
#	can be used to debug memory leaks, memory fragmentation, etc.
#
##############
#
...
BFC_HEAP_MONITOR_DIR = Bfc/OperatingSystem
...
BFC_HEAP_MONITOR_OBJECTS = HeapMonitorThread.o
...
BFC_HEAP_MONITOR_INCLUDE_DIRS = $(BFC_HEAP_MONITOR_DIR)
...
BFC_HEAP_MONITOR_SOURCE_DIRS = $(BFC_HEAP_MONITOR_DIR)
...
ifeq ($(BFC_INCLUDE_HEAP_MONITOR_SUPPORT), 1)

    BFC_OBJECTS += $(BFC_HEAP_MONITOR_OBJECTS)

    BFC_COMPILER_DEFINES += $(BFC_HEAP_MONITOR_DEFINES)

    BFC_INCLUDE_DIRS += $(BFC_HEAP_MONITOR_INCLUDE_DIRS)

    BFC_SOURCE_DIRS += $(BFC_HEAP_MONITOR_SOURCE_DIRS)

    BFC_LIBRARIES += $(BFC_HEAP_MONITOR_LIBRARIES)
