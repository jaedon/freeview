...
#
##############################################################################
#  $Id: BfcHttpWebUibcm93368wvgComcast.mak 1.1 2006/04/26 22:53:48Z twhite Release $
#
#  Filename:       BfcHttpWebUibcm93368wvgComcast.mak
#  Author:         Tyler White
...
# trw - for now, all this file does is include the normal UI makefile, and add some additional
# compile-time flags, plus POTD support.  It is TBD whether the comcast-specific EMTA pages need
# to be merged with the existing RG pages
...
#		 if necessary.
BFC_OBJECTS +=  HttpPasswordOfTheDay.o \
...
BFC_COMPILER_DEFINES += BCM_HTTP_FORM_AUTHORIZATION=1 BCM_TELNET_SSH_POTD=1
