...
#  $Id$
#
#  Filename:       BfcIgmpV3.mak
#  Author:         Rich Schwartz
#  Creation Date:  October 23, 20036#
##############################################################################
#  Description:
#
# 	This file contains the build components for IgmpV3.
#
##############
#
...
BFC_IGMPV3_DIR = Bfc/Networking/IgmpV3
...
BFC_IGMPV3_OBJECTS += \
        IgmpV3GroupList.o  IgmpV3MulticastEntry.o  IgmpV3SrcMacMulticastEntry.o IgmpV3Message.o IgmpErouterThread.o IgmpErouterGroup.o\
	ErouterPacketSwitchBridgingHalIf.o IgmpV3MemberShipReportList.o IgmpV3MemberShipReport.o
...
BFC_IGMPV3_INCLUDE_DIRS = $(BFC_IGMPV3_DIR) 
...
BFC_IGMPV3_SOURCE_DIRS = $(BFC_IGMPV3_DIR)
...
BFC_OBJECTS += $(BFC_IGMPV3_OBJECTS) 

BFC_INCLUDE_DIRS += $(BFC_IGMPV3_DIR)

BFC_SOURCE_DIRS += $(BFC_IGMPV3_SOURCE_DIRS)

BFC_COMPILER_DEFINES += $(BFC_IGMPV3_COMPILER_DEFINES)
