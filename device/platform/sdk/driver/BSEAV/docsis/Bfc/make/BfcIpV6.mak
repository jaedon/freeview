...
BFC_IPV6_DIR = Bfc/IpHelpers/IPv6
...
# Modules for IPv6 Neighbor Discovery

ifeq ($(BCM_STANDALONE_DHCP_CLIENT), 1)
BFC_NEIGHBOR_DISCOVERY_OBJECTS = NeighborDiscoveryThread.o \
                                 NeighborCache.o NeighborCacheEntry.o \
                                 PrefixList.o PrefixEntry.o \
                                 DefaultRouterList.o RouterEntry.o \
                                 NeighborDiscoveryACT.o \
                                 IPv6RouterConfigurationVariables.o
else
BFC_NEIGHBOR_DISCOVERY_OBJECTS = NeighborDiscoveryThread.o \
                                 NeighborCache.o NeighborCacheEntry.o \
                                 PrefixList.o PrefixEntry.o \
...
ifeq ($(BFC_INCLUDE_IPV6_SUPPORT), 1)
	BFC_IPV6_DEFINES = BCM_IPV6_SUPPORT=1 
endif
...
BFC_IPV6_INCLUDE_DIRS = $(BFC_IPV6_DIR)
...
BFC_IPV6_SOURCE_DIRS = $(BFC_IPV6_DIR)

# Add IPV6 components, if included by BfcSystemConfig.mak.

ifeq ($(BFC_INCLUDE_IPV6_SUPPORT), 1)
BFC_OBJECTS += $(BFC_NEIGHBOR_DISCOVERY_OBJECTS) 
endif
 
ifeq ($(BFC_INCLUDE_IPV6_SERVER_SUPPORT), 1)
    BFC_OBJECTS += $(BFC_IPV6_SERVER_OBJECTS)
endif

BFC_COMPILER_DEFINES += $(BFC_IPV6_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_IPV6_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_IPV6_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_IPV6_LIBRARIES)
