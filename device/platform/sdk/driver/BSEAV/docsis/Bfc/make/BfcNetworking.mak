...
BFC_NETWORKING_OBJECTS = \
    EthernetPacket.o        InterfaceCounters.o \
    HalIfFactory.o          HalIf.o \
    HalIfNonVolSettings.o   NiHalIf.o \
    Snoop.o                 PacketLoggingSnoop.o \
...
BFC_NETWORKING_CONSOLE_OBJECTS = ForwarderCommandTable.o SnoopCommandTable.o \
...
BFC_NETWORKING_DEFINES += BFC_INCLUDE_DHCPV4_SUPPORT=1

ifeq ($(BFC_INCLUDE_IPV6_SUPPORT), 1)
BFC_NETWORKING_DEFINES += BFC_INCLUDE_DHCPV6_SUPPORT=1 BCM_IPV6_NEIGHBOR_DISCOVERY_SUPPORT=1
endif
...
ifeq ($(BFC_INCLUDE_NETWORKING_SUPPORT), 1)
    ...
    ifeq ($(BFC_INCLUDE_CONSOLE_SUPPORT), 1)
        ...
        ifeq ($(BFC_CONFIG_MINIMAL_CONSOLE), 0)
            ...
            BFC_OBJECTS += $(BFC_NETWORKING_CONSOLE_OBJECTS)
