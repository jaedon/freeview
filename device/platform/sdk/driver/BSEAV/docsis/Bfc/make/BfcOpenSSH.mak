...
#  Description:
#
# 	This file contains the build components for openSSH.
#
##############
#
...
BFC_OPENSSH_INC = Bfc/IpHelpers/OpenSSH
...
BFC_OPENSSH_DIR =  Bfc/IpHelpers/OpenSSH
...
BFC_OPENSSH_OBJECTS +=  SshThread.o \
				SshThreadIpStackEventACT.o
                                                
BFC_OPENSSH_SNMP_OBJECTS = 

BFC_OPENSSH_FACTORY_OBJECTS = 

BFC_OPENSSH_BRCM_SNMP_OBJECTS = brcmSshMgmtBridge.o brcmSshMgmtMib.o \
                           brcmSshMgmtTrap.o \
                           brcmSshMgmtSshEventACT.o
...
BFC_OPENSSH_COMPILER_DEFINES = BCM_SSH_SUPPORT=1 
...
BFC_LIBRARIES += Bfc/LibSupport/OpenSSH/libOpenSSHecos.a
...
ifeq ($(BFC_INCLUDE_SNMP_SUPPORT), 1)
    ...
    ifeq ($(BFC_INCLUDE_BRCM_RUNTIME_MIB_SUPPORT), 1)
        ...
        BFC_OBJECTS += $(BFC_OPENSSH_BRCM_SNMP_OBJECTS)
    
    endif

endif

BFC_INCLUDE_DIRS += $(BFC_OPENSSH_INC) 

BFC_SOURCE_DIRS += $(BFC_OPENSSH_DIR)

BFC_COMPILER_DEFINES += $(BFC_OPENSSH_COMPILER_DEFINES)  
