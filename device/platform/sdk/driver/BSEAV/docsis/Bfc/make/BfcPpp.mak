...
#
##############################################################################
#  $Id: BfcPpp.mak 1.6 2005/06/16 17:41:05Z jmcqueen-atl Release $
#
#  Filename:       BfcPpp.mak
#  Author:         John McQueen
...
#  Description:
#
# 	This file contains the build components for Ppp.
#
##############
#
...
BFC_PPP_DIR = $(BFC_RESIDENTIAL_GATEWAY_DIR)/Ppp/src $(BFC_RESIDENTIAL_GATEWAY_DIR)/Ppp/tests
BFC_MPPE_DIR = $(BFC_RESIDENTIAL_GATEWAY_DIR)/Ppp/Mppe
...
ifeq ($(BFC_INCLUDE_CONSOLE_SUPPORT), 1)
        ...
        BFC_PPP_OBJECTS += PppNonVolSettingsCommandTable.o
        
        endif
        
endif	     

BFC_PPP_OBJECTS += PppSessionTable.o PppConnection.o PppUserPassword.o PppUserPasswordList.o \
                   PppTunnelSnoop.o PppNonVolSettings.o

BFC_PPP_OBJECTS += auth.o \
                   bsd_comp.o \
                   cbcp.o \
                   ccp.o \
                   chap.o \
...
BFC_MPPE_OBJECTS += ppp_mppe.o sha1key.o
...
BFC_PPP_DEFINES = BCM_PPP_SUPPORT=1 CHAPMS=1 MPPE_SUPPORTED=0
...
BFC_PPP_INCLUDE_DIRS = $(BFC_PPP_DIR) $(BFC_RESIDENTIAL_GATEWAY_DIR)/Ppp/include
BFC_MPPE_INCLUDE_DIRS = $(BFC_MPPE_DIR)
...
BFC_PPP_SOURCE_DIRS = $(BFC_PPP_DIR) $(BFC_MPPE_DIR)
BFC_MPPE_SOURCE_DIRS = $(BFC_MPPE_DIR)
...
ifeq ($(BCM_PPP_SUPPORT), 1)

BFC_COMPILER_DEFINES += $(BFC_PPP_DEFINES)

BFC_OBJECTS += $(BFC_PPP_OBJECTS) $(BFC_MPPE_OBJECTS)

endif

BFC_INCLUDE_DIRS += $(BFC_PPP_INCLUDE_DIRS) $(BFC_MPPE_INCLUDE_DIRS)

BFC_SOURCE_DIRS += $(BFC_PPP_SOURCE_DIRS) $(BFC_MPPE_SOURCE_DIRS)
