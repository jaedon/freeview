...
BFC_PPPOE_DIR = $(BFC_RESIDENTIAL_GATEWAY_DIR)/Pppoe $(BFC_RESIDENTIAL_GATEWAY_DIR)/Ppp
...
BFC_PPPOE_OBJECTS += \
        PppoeThread.o PppoeSnoop.o PppoeLanBlockSnoop.o PppoeDialOnDemandSnoop.o PppoeServiceAppIf.o \
        PppoeIf.o PppoePacket.o PppoeSession.o PppoeConnection.o
        

BFC_PPPOE_CONSOLE_OBJECTS += PppoeCommandTable.o
...
BFC_PPPOE_DEFINES = BCM_PPPOE_SUPPORT=1
...
BFC_PPPOE_INCLUDE_DIRS = $(BFC_PPPOE_DIR) 
...
BFC_PPPOE_SOURCE_DIRS = $(BFC_PPPOE_DIR)
...
ifeq ($(BCM_PPPOE_SUPPORT), 1)

BFC_COMPILER_DEFINES += $(BFC_PPPOE_DEFINES)

BFC_OBJECTS += $(BFC_PPPOE_OBJECTS) 
...
ifeq ($(BFC_INCLUDE_CONSOLE_SUPPORT), 1) 
        ...
        BFC_OBJECTS += $(BFC_PPPOE_CONSOLE_OBJECTS)
        
        endif        
        
endif

BFC_INCLUDE_DIRS += $(BFC_PPPOE_INCLUDE_DIRS)

BFC_SOURCE_DIRS += $(BFC_PPPOE_SOURCE_DIRS)
