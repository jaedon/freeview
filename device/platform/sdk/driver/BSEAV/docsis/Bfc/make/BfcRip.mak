...
#
##############################################################################
#  $Id: BfcRip.mak 1.5 2006/09/20 19:43:26Z jmcqueen-atl Release $
#
#  Filename:       BfcRip.mak
#  Author:         John McQueen
...
#  Description:
#
# 	This file contains the build components for Rip.
#
##############
#
...
BFC_RIP_DIR = $(BFC_RESIDENTIAL_GATEWAY_DIR)/Rip
...
BFC_RIP_OBJECTS += \
        ...
        RipMd5RouteEntry.o \
        RipMd5Packet.o \
        RipRouteTableStatusClientACT.o \
        RipIpServiceAppIf.o \
        RgRipIpServiceAppIf.o \
        Rip2IfConfTableEntry.o \
        RipDatabaseApi.o \
        RipDatabaseFactory.o 


ifeq ($(BCM_CABLEHOME_SUPPORT), 1)

BFC_RIP_SNMP_OBJECTS = \
        RipSnmpIf.o \
        rip2mibMib.o \
        rip2mibBridge.o \
        CsaRipIpServiceAppIf.o 
endif        
         
        
BFC_RIP_CONSOLE_OBJECTS += RipCommandTable.o
...
BFC_RIP_DEFINES += BCM_RIP_SUPPORT=1
...
BFC_RIP_INCLUDE_DIRS = $(BFC_RIP_DIR) 
...
BFC_RIP_SOURCE_DIRS = $(BFC_RIP_DIR)
...
BFC_OBJECTS += $(BFC_RIP_OBJECTS)

ifeq ($(BFC_INCLUDE_SNMP_SUPPORT), 1)

BFC_OBJECTS += $(BFC_RIP_SNMP_OBJECTS) 
...
ifeq ($(BFC_INCLUDE_CONSOLE_SUPPORT), 1) 
    ...
    ifeq ($(BFC_CONFIG_MINIMAL_CONSOLE), 0)
        ...
        BFC_OBJECTS += $(BFC_RIP_CONSOLE_OBJECTS)
    
    endif
        
endif 

BFC_COMPILER_DEFINES += $(BFC_RIP_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_RIP_INCLUDE_DIRS)

BFC_SOURCE_DIRS += $(BFC_RIP_SOURCE_DIRS)
