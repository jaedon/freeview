...
#
##############################################################################
#  $Id: BfcSessionTracking.mak 1.1 2003/11/26 21:25:06Z jmcqueen-atl Release $
#
#  Filename:       BfcSessionTracking.mak
#  Author:         John McQueen
...
#  Description:
#
# 	This file contains the build components for Session Tracking.
#
##############
#
...
BFC_SESSION_TRACKING_DIR = $(BFC_RESIDENTIAL_GATEWAY_DIR)/SessionTracking
...
BFC_SESSION_TRACKING_OBJECTS += \
        StSessionTrackTuple.o \
        StProtocolHandlerFactory.o \
        StProtocolHandlerGeneric.o \
        StProtocolHandlerIcmp.o \
        StProtocolHandlerIpsec.o \
        StProtocolHandler.o \
        StProtocolHandlerTcp.o \
        StProtocolHandlerUdp.o \
        StSessionTrackEntry.o	\
        StSessionTrackThread.o \
        StProtocolHandlerGre.o
...
BFC_SESSION_TRACKING_INCLUDE_DIRS = $(BFC_SESSION_TRACKING_DIR) 
...
BFC_SESSION_TRACKING_SOURCE_DIRS = $(BFC_SESSION_TRACKING_DIR)
...
BFC_OBJECTS += $(BFC_SESSION_TRACKING_OBJECTS) 

BFC_INCLUDE_DIRS += $(BFC_SESSION_TRACKING_INCLUDE_DIRS)

BFC_SOURCE_DIRS += $(BFC_SESSION_TRACKING_SOURCE_DIRS)
