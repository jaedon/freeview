...
#############################################################################
#
#  Filename:       BfcSingleIp.mak
#  Author:         Maurice Turcotte
#  Creation Date:  4 SEP 09
#
##############################################################################
#  Description:
#
# 	This file contains the build directives for an STB with a single IP
#       address, which resides on the eCM.
#
##############
#
...
BFC_SINGLE_IP_DIR = Bfc/IpHelpers/NAT
...
# Core STB objects
BFC_SINGLE_IP_OBJECTS = cmNatSnoop.o estbNatSnoop.o
...
BFC_SINGLE_IP_DEFINES += BFC_SINGLE_IP_SUPPORT=1
...
BFC_SINGLE_IP_INCLUDE_DIRS = $(BFC_SINGLE_IP_DIR) 
...
BFC_SINGLE_IP_SOURCE_DIRS = $(BFC_SINGLE_IP_DIR)
...
# Add Single IP components.

	# Add STB components, if included by BfcSystemConfig.mak.
	BFC_OBJECTS += $(BFC_SINGLE_IP_OBJECTS) 

	BFC_COMPILER_DEFINES += $(BFC_SINGLE_IP_DEFINES)

	BFC_INCLUDE_DIRS += $(BFC_SINGLE_IP_INCLUDE_DIRS)

	BFC_SOURCE_DIRS += $(BFC_SINGLE_IP_SOURCE_DIRS)
