...
#
##############################################################################
#  $Id: BfcSmtp.mak 1.1 2003/11/26 21:25:06Z jmcqueen-atl Release $
#
#  Filename:       BfcSmtp.mak
#  Author:         John McQueen
...
#  Description:
#
# 	This file contains the build components for Smtp.
#
##############
#
...
BFC_SMTP_DIR = $(BFC_RESIDENTIAL_GATEWAY_DIR)/Smtp
...
BFC_SMTP_DEFINES = BCM_SMTP_SUPPORT=1
...
BFC_SMTP_INCLUDE_DIRS = $(BFC_SMTP_DIR) 
...
BFC_SMTP_SOURCE_DIRS = $(BFC_SMTP_DIR)
...
BFC_OBJECTS += $(BFC_SMTP_OBJECTS) 

BFC_INCLUDE_DIRS += $(BFC_SMTP_INCLUDE_DIRS)

BFC_SOURCE_DIRS += $(BFC_SMTP_SOURCE_DIRS)

BFC_COMPILER_DEFINES += $(BFC_SMTP_DEFINES)
