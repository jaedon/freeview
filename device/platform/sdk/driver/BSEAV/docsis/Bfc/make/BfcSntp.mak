...
#
##############################################################################
#  $Id: BfcSntp.mak 1.6 2005/01/21 15:01:14Z sdunlap Release $
#
#  Filename:       BfcSntp.mak
#  Author:         John McQueen
#  Creation Date:  June 20, 2004
#
##############################################################################
#  Description:
#
# 	This file contains the build components for Sntp.
#
##############
#
...
BFC_SNTP_DIR = ResidentialGateway/Sntp 
...
BFC_SNTP_OBJECTS += \
        SntpThread.o SntpServiceAppIf.o SntpSnoop.o TimeServer.o TimeServerList.o 
...
BFC_SNTP_DEFINES = BCM_SNTP_SUPPORT=1
...
BFC_SNTP_INCLUDE_DIRS = $(BFC_SNTP_DIR) 
...
BFC_SNTP_SOURCE_DIRS = $(BFC_SNTP_DIR)
...
BFC_INCLUDE_DIRS += $(BFC_SNTP_INCLUDE_DIRS)

BFC_OBJECTS += $(BFC_SNTP_OBJECTS) 

BFC_SOURCE_DIRS += $(BFC_SNTP_SOURCE_DIRS)

ifeq ($(BCM_SNTP_SUPPORT), 1)

BFC_COMPILER_DEFINES += $(BFC_SNTP_DEFINES)
