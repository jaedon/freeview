...
##############################################################################
#
#  Filename:       BfcStbCommonDload.mak
...
#  Description:
#
# 	This file contains the build "stuff" for the Stb Common Dload subsystem.
#
##############
#
...
BFC_STB_COMMON_DOWNLOAD_DIR = Stb/CommonDownload
...
BFC_STB_COMMON_DOWNLOAD_OBJECTS += StbCommonDownloadBridge.o OpenCableSecureDownloadNonVolSettingsCommandTable.o \
                                   OpenCableSecureDownloadNonVolSettings.o OpenCableSecureDownloadCVC.o OpenCableSecureDownload.o \
				   OpenCableSecureDownloadCodeSignerInfo.o OpenCableSecureDownloadBridge.o
...
BFC_STB_COMMON_DOWNLOAD_DEFINES = COMMON_DOWNLOAD_SUPPORT=1

ifeq ($(BCM_OPENCABLE_BRCM_CLCVC_SUPPORT), 1) 
	BFC_STB_COMMON_DOWNLOAD_DEFINES += BCM_OPENCABLE_BRCM_CLCVC_SUPPORT=1
endif
...
BFC_STB_COMMON_DOWNLOAD_INCLUDE_DIRS += $(BFC_STB_COMMON_DOWNLOAD_DIR)
...
BFC_STB_COMMON_DOWNLOAD_SOURCE_DIRS += $(BFC_STB_COMMON_DOWNLOAD_DIR)
...
#			   add local console files and defines).
	...
	BFC_OBJECTS += $(BFC_STB_COMMON_DOWNLOAD_OBJECTS)

	BFC_INCLUDE_DIRS += $(BFC_STB_COMMON_DOWNLOAD_INCLUDE_DIRS)

	BFC_SOURCE_DIRS += $(BFC_STB_COMMON_DOWNLOAD_SOURCE_DIRS)

	BFC_COMPILER_DEFINES += $(BFC_STB_COMMON_DOWNLOAD_DEFINES)
