...
#  Description:
#
# 	This file contains the build "stuff" for the ESTB Rmagnum subsystem.
#
##############
#
...
BFC_RMAGNUM_DIR = Stb/Rmagnum

BFC_STB_IPTV_DIR = Stb/IPTV

BFC_STB_IPTV_OBJECTS += IptvOffloadSnoop.o 
...
BFC_RMAGNUM_OBJECTS += StbDownstreamControlThread.o StbRmagnumServerThread.o StbRmagnumHelperThread.o \
                       StbDsStatusACT.o StbCableCardControl.o \
                       RpcMessage.o RpcReqMsg.o RpcRspMsg.o \
                       RpcAckMsg.o RpcNotificationMsg.o AdsAcquireReqMsg.o \
			AdsCloseChReqMsg.o AdsEnPwrSaverReqMsg.o AdsGetLockStatusReqMsg.o \
			AdsGetSoftDecisionReqMsg.o AdsGetStatusReqMsg.o AdsGetTotalChReqMsg.o \
			AdsGetVerReqMsg.o AdsOpenChReqMsg.o RpcInitSessionReqMsg.o TnrCloseReqMsg.o \
			TnrGetVerReqMsg.o TnrOpenReqMsg.o TnrSetFreqReqMsg.o RpcMsgFactory.o \
			StbRmagnumServer.o \
			CableCardControlCardOutReqMsg.o CableCardControlCardInReqMsg.o CableCardControlCardInStartReqMsg.o \
			CableCardControlApplyPowerReqMsg.o TnrGetAgcReqMsg.o TnrEnPwrSaverReqMsg.o TnrGetPwrSaverReqMsg.o \
			AdsGetBondingCapabilityReqMsg.o AdsReserveChReqMsg.o CmGetStatusReqMsg.o

ifeq ($(BFC_INCLUDE_STB_OOB_SUPPORT), 1) 
BFC_RMAGNUM_OBJECTS +=	StbOOBTuner.o StbOOBUpstream.o \
			TnrOobOpenReqMsg.o TnrOobCloseReqMsg.o TnrOobSetRfFreqReqMsg.o \
			QamOobOpenReqMsg.o QamOobCloseReqMsg.o \
			QamOobAcquireReqMsg.o QamOobGetStatusReqMsg.o QamOobGetLockStatusReqMsg.o \
			QusOobOpenReqMsg.o QusOobCloseReqMsg.o \
			QusOobGetDefaultSettingsReqMsg.o \
			QusOobSetOperationModeReqMsg.o QusOobGetOperationModeReqMsg.o \
			QusOobSetSymbolRateReqMsg.o QusOobGetSymbolRateReqMsg.o \
			QusOobSetRfFreqReqMsg.o QusOobGetRfFrequencyReqMsg.o \
			QusOobSetPreamblePatternReqMsg.o QusOobSetBurstProfileReqMsg.o \
			QusOobSetPowerLevelReqMsg.o QusOobGetPowerLevelReqMsg.o \
			QusOobPSetRawPowerReqMsg.o QusOobPGetRawPowerLevelReqMsg.o \
			QusOobGetStatusReqMsg.o QamOobSetSpectrumReqMsg.o \
			StbOOBUsLegacyStarvueMsg.o QusOobSetTransmitModeReqMsg.o \
			QusOobGetTransmitModeReqMsg.o 
endif			
...
BFC_RMAGNUM_DEFINES = BCM_RMAGNUM_SUPPORT=1 BCM_IPTV_OFFLOAD_SUPPORT=1

ifeq ($(BFC_USE_ESTB_PRIVATENET), 1) 
      BFC_RMAGNUM_DEFINES += USE_PRIVATE_NETWORK=1 BCM_DSG_DUAL_PROCESSOR_INTERFACE=1
endif

ifeq ($(BFC_INCLUDE_STB_OOB_SUPPORT), 1) 
      BFC_RMAGNUM_DEFINES += BCM_STB_OOB_SUPPORT=1
endif

ifeq ($(BFC_INCLUDE_STB_QAM128_SUPPORT), 1) 
      BFC_RMAGNUM_DEFINES += BCM_SUPPORTS_ANNEXA_QAM_128=1
endif
...
BFC_RMAGNUM_INCLUDE_DIRS += $(BFC_RMAGNUM_DIR)

##############################################################################
#
# Source path - This is the list of paths that will be used by make and/or the
#               compiler to find the source code (.c, .o, etc) associated with
#               this component.


BFC_RMAGNUM_SOURCE_DIRS += $(BFC_RMAGNUM_DIR)
...
#			   add local console files and defines).
	...
	BFC_OBJECTS += $(BFC_RMAGNUM_OBJECTS) $(BFC_STB_IPTV_OBJECTS)

	BFC_INCLUDE_DIRS += $(BFC_RMAGNUM_INCLUDE_DIRS) $(BFC_STB_IPTV_DIR)

	BFC_SOURCE_DIRS += $(BFC_RMAGNUM_SOURCE_DIRS) $(BFC_STB_IPTV_DIR)

	BFC_COMPILER_DEFINES += $(BFC_RMAGNUM_DEFINES)
