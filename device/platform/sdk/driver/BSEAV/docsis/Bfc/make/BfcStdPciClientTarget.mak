...
ifeq ($(BFC_INCLUDE_SPI_FLASH_SUPPORT), 0)
...
BFC_STD_EMBEDDED_TARGET_FLASH_OBJECTS += SpiFlashDevice.o GenericSpiFlashDevice.o \
										 FlashDeviceDriver.o \
										 FlashDriverCommandTable.o \
										 FlashBlock.o FlashDevice.o FlashRegion.o
		
BFC_INCLUDE_SPI_FLASH_SUPPORT=1
BFC_SPLIT_BOOT_BLOCK_DEFAULT=0
endif
...
BFC_STD_EMBEDDED_TARGET_DEFINES += BFC_INCLUDE_PCI_CLIENT_SUPPORT=1
...
ifeq ($(BCM_TWODS_CORE), 1)
    BFC_STD_EMBEDDED_TARGET_DEFINES += BCM_TWODS_CORE=1
endif
