...
#
##############################################################################
#  $Id: BfcTraceRoute.mak 1.1 2005/04/13 16:59:26Z jmcqueen-atl Release $
#
#  Filename:       BfcTraceroute.mak
#  Author:         John McQueen
...
#  Description:
#
# 	This file contains the build components for Traceroute.
#
##############
#
...
BFC_TRACEROUTE_DIR = $(BFC_RESIDENTIAL_GATEWAY_DIR)/Traceroute
...
BFC_TRACEROUTE_OBJECTS += Traceroute.o TracerouteThread.o TracerouteParameters.o
...
BFC_TRACEROUTE_DEFINES = BCM_TRACEROUTE_SUPPORT=1
...
BFC_TRACEROUTE_INCLUDE_DIRS = $(BFC_TRACEROUTE_DIR) 
...
BFC_TRACEROUTE_SOURCE_DIRS = $(BFC_TRACEROUTE_DIR)
...
BFC_OBJECTS += $(BFC_TRACEROUTE_OBJECTS) 

BFC_INCLUDE_DIRS += $(BFC_TRACEROUTE_INCLUDE_DIRS)

BFC_SOURCE_DIRS += $(BFC_TRACEROUTE_SOURCE_DIRS)

BFC_COMPILER_DEFINES += $(BFC_TRACEROUTE_DEFINES)
