...
#  $Id$
#
#  Filename:       Broadcom_bcm93349.mak
#  Author:         David Pullen
...
BFC_BRCM_BCM93349_DIR = Cm/CmExtensionApi/Broadcom/bcm93349
...
ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)
	...
	BFC_BRCM_BCM93349_OBJECTS = LedController80211Factory.o

endif
BFC_BRCM_BCM93349_OBJECTS = Bcm93349dcmLedController.o Bcm3349LedController.o LedControllerFactory.o \
...
BFC_BRCM_BCM93349_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93349_INCLUDE_DIRS = $(BFC_BRCM_BCM93349_DIR)
...
BFC_BRCM_BCM93349_SOURCE_DIRS = $(BFC_BRCM_BCM93349_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM93349_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93349_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93349_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93349_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93349_LIBRARIES)
