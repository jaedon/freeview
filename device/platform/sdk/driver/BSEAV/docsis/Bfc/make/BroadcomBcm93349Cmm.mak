...
#
##############################################################################
#  $Id: BroadcomBcm93349Cmm.mak 1.5 2005/05/17 18:39:51Z sdunlap Release $
#
#  Filename:       BroadcomBcm93349Cmm.mak
#  Author:         David Pullen
...
#       Extension for the bcm93349cmm module and fixture
#
##############
#
...
# This pull in the bcm93349cmm-specific directory.
BFC_BRCM_BCM93349CMM_DIR = Cm/CmExtensionApi/Broadcom/bcm93349cmm
...
BFC_BRCM_BCM93349CMM_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93349CMM_INCLUDE_DIRS = $(BFC_BRCM_BCM93349CMM_DIR)
...
BFC_BRCM_BCM93349CMM_SOURCE_DIRS = $(BFC_BRCM_BCM93349CMM_DIR)
...
BFC_BRCM_BCM93349CMM_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93349CMM_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93349CMM_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93349CMM_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93349CMM_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93349CMM_LIBRARIES)
