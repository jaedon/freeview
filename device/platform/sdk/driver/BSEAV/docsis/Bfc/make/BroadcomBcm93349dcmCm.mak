...
#
##############################################################################
#  $Id: BroadcomBcm93349dcmCm.mak 1.1 2006/11/07 20:15:26Z msieweke Release $
#
#  Filename:       BroadcomBcm93349dcmCm.mak
#  Author:         Mike Sieweke
...
#       Extension for the bcm93349dcm board (Visualization LED stuff).
#
#	PR5299
#
##############
...
# This pull in the bcm93349dcm-specific directory.
BFC_BRCM_BCM93349dcm_DIR = Cm/CmExtensionApi/Broadcom/bcm93349dcm
...
BFC_BRCM_BCM93349dcm_OBJECTS = Bcm93349dcmLedController.o LedControllerFactory.o \
                              LedController.o LedControllerCmStatusACT.o \
                              CmVendorLedControllerThread.o

# PR7112 and PR7114 - refactored 3349 LED control to a common object that can be
# used across platforms more easily.
BFC_BRCM_BCM93349dcm_OBJECTS += Bcm3349LedController.o

ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)

        BFC_BRCM_BCM93349dcm_OBJECTS += LedControllerBatteryStatusACT.o
...
BFC_BRCM_BCM93349dcm_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93349dcm_INCLUDE_DIRS = $(BFC_BRCM_BCM93349dcm_DIR)
...
BFC_BRCM_BCM93349dcm_SOURCE_DIRS = $(BFC_BRCM_BCM93349dcm_DIR)
...
BFC_BRCM_BCM93349dcm_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93349dcm_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93349dcm_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93349dcm_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93349dcm_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93349dcm_LIBRARIES)
