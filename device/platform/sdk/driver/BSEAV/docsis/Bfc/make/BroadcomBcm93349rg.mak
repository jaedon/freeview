...
#  $Id$
#
#  Filename:       BroadcomBcm93349rg.mak
#  Author:         Tyler White
...
BFC_BRCM_BCM93349rg_DIR = CableHome/ChExtensionApi/Broadcom/bcm93349rg
...
BFC_BRCM_BCM93349rg_OBJECTS = Bcm93349rgLedController.o LedControllerFactory.o \
                                LedController.o LedControllerCmStatusACT.o \
                                CmVendorLedControllerThread.o \
...
ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)
	...
	BFC_BRCM_BCM93349rg_OBJECTS += LedController80211Factory.o
...
BFC_BRCM_BCM93349rg_DEFINES = VENDOR_LED_CONTROL=1 \
...
ifeq ($(BFC_INCLUDE_RESET_STANDBY_SWITCH_SUPPORT), 1)
    BFC_BRCM_BCM93349rg_DEFINES += BFC_CM_VENDOR_SUPPORT=1 BFC_INCLUDE_RESET_STANDBY_SWITCH_SUPPORT=$(BFC_INCLUDE_RESET_STANDBY_SWITCH_SUPPORT)
else
        ifeq ($(BFC_INCLUDE_RESET_SES_SWITCH_SUPPORT), 1)
                BFC_BRCM_BCM93349rg_DEFINES += BFC_CM_VENDOR_SUPPORT=1 BFC_INCLUDE_RESET_SES_SWITCH_SUPPORT=$(BFC_INCLUDE_RESET_SES_SWITCH_SUPPORT)
        else
                ifeq ($(BFC_INCLUDE_RESET_STANDBY_SES_SWITCH_SUPPORT), 1)
                        BFC_BRCM_BCM93349rg_DEFINES += BFC_CM_VENDOR_SUPPORT=1 BFC_INCLUDE_RESET_STANDBY_SES_SWITCH_SUPPORT=$(BFC_INCLUDE_RESET_STANDBY_SES_SWITCH_SUPPORT)
                endif
        endif
endif
...
BFC_BRCM_BCM93349rg_INCLUDE_DIRS = $(BFC_BRCM_BCM93349rg_DIR)
...
BFC_BRCM_BCM93349rg_SOURCE_DIRS = $(BFC_BRCM_BCM93349rg_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM93349rg_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93349rg_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93349rg_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93349rg_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93349rg_LIBRARIES)
