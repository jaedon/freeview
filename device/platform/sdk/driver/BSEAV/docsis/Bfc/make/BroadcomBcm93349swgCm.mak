...
#
##############################################################################
#  $Id: BroadcomBcm93349swgCm.mak 1.5 2005/05/17 18:39:55Z sdunlap Release $
#
#  Filename:       BroadcomBcm93349swgCm.mak
#  Author:         David Pullen
#  Creation Date:  April 29, 2004
#
##############################################################################
#  Description:
#
# 	This file contains the build "stuff" for the Broadcom CM Vendor
#       Extension for the bcm93349swg board (Visualization LED and switch stuff).
#
#	PR7114
#
##############
...
# This pull in the bcm93349swg-specific directory.
BFC_BRCM_BCM93349swg_DIR = Cm/CmExtensionApi/Broadcom/bcm93349swg
...
BFC_BRCM_BCM93349swg_OBJECTS = Bcm93349swgLedController.o LedControllerFactory.o \
...
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)
        ...
        BFC_BRCM_BCM93349swg_OBJECTS += LedControllerBatteryStatusACT.o
...
BFC_BRCM_BCM93349swg_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93349swg_INCLUDE_DIRS = $(BFC_BRCM_BCM93349swg_DIR)
...
BFC_BRCM_BCM93349swg_SOURCE_DIRS = $(BFC_BRCM_BCM93349swg_DIR)
...
BFC_BRCM_BCM93349swg_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93349swg_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93349swg_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93349swg_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93349swg_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93349swg_LIBRARIES)
