...
#
##############################################################################
#  $Id: BroadcomBcm93349v1Cm.mak 1.6 2005/05/17 18:39:58Z sdunlap Release $
#
#  Filename:       BroadcomBcm93349v1Cm.mak
#  Author:         David Pullen
...
#       Extension for the bcm93349v1 board (Visualization LED stuff).
#
#	PR5299
#
##############
...
# This pull in the bcm93349v1-specific directory.
BFC_BRCM_BCM93349v1_DIR = Cm/CmExtensionApi/Broadcom/bcm93349v1
...
BFC_BRCM_BCM93349v1_OBJECTS = Bcm93349v1LedController.o LedControllerFactory.o \
...
BFC_BRCM_BCM93349v1_OBJECTS += Bcm3349LedController.o

ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)

        BFC_BRCM_BCM93349v1_OBJECTS += LedControllerBatteryStatusACT.o
...
BFC_BRCM_BCM93349v1_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93349v1_INCLUDE_DIRS = $(BFC_BRCM_BCM93349v1_DIR)
...
BFC_BRCM_BCM93349v1_SOURCE_DIRS = $(BFC_BRCM_BCM93349v1_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM93349v1_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93349v1_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93349v1_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93349v1_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93349v1_LIBRARIES)
