...
#
##############################################################################
#  $Id: BroadcomBcm93349vbcmCm.mak 1.7 2006/12/11 14:48:56Z llong Release $
#
#  Filename:       BroadcomBcm93349vbcmCm.mak
#  Author:         David Pullen
#  Creation Date:  May 1, 2004
#
##############################################################################
#  Description:
#
# 	This file contains the build "stuff" for the Broadcom CM Vendor
#       Extension for the bcm93349vbcm board (Visualization LED and switch stuff).
#
#	PR7114
#
##############
...
# This pull in the bcm93349vbcm-specific directory.
BFC_BRCM_BCM93349vbcm_DIR = Cm/CmExtensionApi/Broadcom/bcm93349vbcm
...
BFC_BRCM_BCM93349vbcm_OBJECTS = Bcm93349vbcmLedController.o LedControllerFactory.o \
...
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)
        ...
        BFC_BRCM_BCM93349vbcm_OBJECTS += LedControllerBatteryStatusACT.o
...
BFC_BRCM_BCM93349vbcm_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93349vbcm_INCLUDE_DIRS = $(BFC_BRCM_BCM93349vbcm_DIR)
...
BFC_BRCM_BCM93349vbcm_SOURCE_DIRS = $(BFC_BRCM_BCM93349vbcm_DIR)
...
BFC_BRCM_BCM93349vbcm_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93349vbcm_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93349vbcm_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93349vbcm_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93349vbcm_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93349vbcm_LIBRARIES)
