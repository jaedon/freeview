...
#  $Id$
#
#  Filename:       BroadcomBcm93361Eps.mak
#  Author:         John McQueen
...
# This pull in the bcm93361-specific directory.
BFC_BRCM_BCM93361_DIR = CableHome/ChExtensionApi/Broadcom/bcm93361
...
ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)
	...
	BFC_BRCM_BCM93361_OBJECTS = Controller80211Factory.o LedController80211Factory.o 
...
BFC_BRCM_BCM93361_INCLUDE_DIRS = $(BFC_BRCM_BCM93361_DIR)
...
BFC_BRCM_BCM93361_SOURCE_DIRS = $(BFC_BRCM_BCM93361_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM93361_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93361_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93361_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93361_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93361_LIBRARIES)
