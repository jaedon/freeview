...
#  $Id$
#
#  Filename:       BroadcomBcm93361wrgCm.mak
#  Author:         John McQueen
...
#       Extension for the bcm93361wrg board (Visualization LED and switch stuff).
#
#
##############
#
...
# This pull in the bcm93361wrg-specific directory.
BFC_BRCM_BCM93361wrg_DIR = Cm/CmExtensionApi/Broadcom/bcm93361wrg
...
BFC_BRCM_BCM93361wrg_OBJECTS = Bcm93361wrgLedController.o LedControllerFactory.o \
                               LedController.o LedControllerCmStatusACT.o \
                               Bcm3361LedController.o ResetStandbySwitchThread.o \
                               CmVendorLedControllerThread.o 
                                
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)

        BFC_BRCM_BCM93361wrg_OBJECTS += LedControllerBatteryStatusACT.o

endif

ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)

        BFC_BRCM_BCM93361wrg_OBJECTS += Controller80211Factory.o LedController80211Factory.o
...
BFC_BRCM_BCM93361wrg_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93361wrg_INCLUDE_DIRS = $(BFC_BRCM_BCM93361wrg_DIR)
...
BFC_BRCM_BCM93361wrg_SOURCE_DIRS = $(BFC_BRCM_BCM93361wrg_DIR)
...
BFC_BRCM_BCM93361wrg_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93361wrg_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93361wrg_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93361wrg_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93361wrg_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93361wrg_LIBRARIES)
