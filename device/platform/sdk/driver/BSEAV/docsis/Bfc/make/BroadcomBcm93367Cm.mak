...
#
##############################################################################
#  $Id: BroadcomBcm93367Cm.mak 1.1 2006/06/19 22:19:46Z msieweke Release $
#
#  Filename:       Broadcom_bcm93367.mak
#  Author:         Mike Sieweke
#  Creation Date:  December 2, 2004
#
##############################################################################
#  Description:
#
...
# This pull in the bcm93367-specific directory.
BFC_BRCM_BCM93367_DIR = Cm/CmExtensionApi/Broadcom/bcm93367
...
BFC_BRCM_BCM93367_INCLUDE_DIRS = $(BFC_BRCM_BCM93367_DIR)
...
BFC_BRCM_BCM93367_SOURCE_DIRS = $(BFC_BRCM_BCM93367_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM93367_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93367_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93367_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93367_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93367_LIBRARIES)
