...
#
##############################################################################
#  $Id: BroadcomBcm93367vcmCm.mak 1.2 2006/06/20 15:16:56Z msieweke Release $
#
#  Filename:       BroadcomBcm93367vcmCm.mak
#  Author:         Sean Dunlap
...
#       Extension for the bcm93367vcm board (Visualization LED and switch stuff).
#
#	PR7114
#
##############
...
# This pull in the bcm93367vcm-specific directory.
BFC_BRCM_BCM93367vcm_DIR = Cm/CmExtensionApi/Broadcom/bcm93367vcm
...
BFC_BRCM_BCM93367vcm_OBJECTS = Bcm93367vcmLedController.o LedControllerFactory.o \
...
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)
        ...
        BFC_BRCM_BCM93367vcm_OBJECTS += LedControllerBatteryStatusACT.o
...
BFC_BRCM_BCM93367vcm_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93367vcm_INCLUDE_DIRS = $(BFC_BRCM_BCM93367vcm_DIR)
...
BFC_BRCM_BCM93367vcm_SOURCE_DIRS = $(BFC_BRCM_BCM93367vcm_DIR)
...
BFC_BRCM_BCM93367vcm_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93367vcm_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93367vcm_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93367vcm_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93367vcm_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93367vcm_LIBRARIES)
