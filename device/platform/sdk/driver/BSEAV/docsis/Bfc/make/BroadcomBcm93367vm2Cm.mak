...
#
##############################################################################
#  $Id: BroadcomBcm93367vm2Cm.mak 1.2 2006/06/20 15:16:56Z msieweke Release $
#
#  Filename:       BroadcomBcm93367vm2Cm.mak
#  Author:         Sean Dunlap
...
#       Extension for the bcm93367vm2 board (Visualization LED and switch stuff).
#
#	PR7114
#
##############
...
# This pull in the bcm93367vm2-specific directory.
BFC_BRCM_BCM93367vm2_DIR = Cm/CmExtensionApi/Broadcom/bcm93367vm2
...
BFC_BRCM_BCM93367vm2_OBJECTS = Bcm93367vm2LedController.o LedControllerFactory.o \
...
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)
        ...
        BFC_BRCM_BCM93367vm2_OBJECTS += LedControllerBatteryStatusACT.o
...
BFC_BRCM_BCM93367vm2_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93367vm2_INCLUDE_DIRS = $(BFC_BRCM_BCM93367vm2_DIR)
...
BFC_BRCM_BCM93367vm2_SOURCE_DIRS = $(BFC_BRCM_BCM93367vm2_DIR)
...
BFC_BRCM_BCM93367vm2_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93367vm2_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93367vm2_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93367vm2_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93367vm2_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93367vm2_LIBRARIES)
