...
#  $Id$
#
#  Filename:       BroadcomBcm93368Eps.mak
#  Author:         John McQueen
#  Creation Date:  Jun 2, 2005
#
##############################################################################
#  Description:
#
...
# This pull in the bcm93368-specific directory.
BFC_BRCM_BCM93368_DIR = CableHome/ChExtensionApi/Broadcom/bcm93368
...
ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)
	...
	BFC_BRCM_BCM93368_OBJECTS = Controller80211Factory.o LedController80211Factory.o
...
BFC_BRCM_BCM93368_INCLUDE_DIRS = $(BFC_BRCM_BCM93368_DIR)
...
BFC_BRCM_BCM93368_SOURCE_DIRS = $(BFC_BRCM_BCM93368_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM93368_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93368_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93368_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93368_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93368_LIBRARIES)
