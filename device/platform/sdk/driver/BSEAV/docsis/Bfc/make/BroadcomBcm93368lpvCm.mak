...
#  $Id$
#
#  Filename:       BroadcomBcm93368lpvCm.mak
#  Author:         Mike Sieweke
...
#       Extension for the bcm93368lpv board (Visualization LED and switch stuff).
#
##############
#
...
# This pull in the bcm93368lpv-specific directory.
BFC_BRCM_BCM93368lpv_DIR = Cm/CmExtensionApi/Broadcom/bcm93368lpv
...
BFC_BRCM_BCM93368lpv_OBJECTS = Bcm93368lpvLedController.o LedControllerFactory.o \
                                LedController.o LedControllerCmStatusACT.o \
                                Bcm3368LedController.o ResetStandbySwitchThread.o \
                                CmVendorLedControllerThread.o LedControllerMtaStatusACT.o

                                
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)

        BFC_BRCM_BCM93368lpv_OBJECTS += LedControllerBatteryStatusACT.o

endif

ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)

        BFC_BRCM_BCM93368lpv_OBJECTS += Controller80211Factory.o LedController80211Factory.o
...
BFC_BRCM_BCM93368lpv_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93368lpv_INCLUDE_DIRS = $(BFC_BRCM_BCM93368lpv_DIR)
...
BFC_BRCM_BCM93368lpv_SOURCE_DIRS = $(BFC_BRCM_BCM93368lpv_DIR)
...
BFC_BRCM_BCM93368lpv_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93368lpv_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93368lpv_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93368lpv_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93368lpv_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93368lpv_LIBRARIES)
