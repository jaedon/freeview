...
#  $Id$
#
#  Filename:       BroadcomBcm93368vcmCm.mak
#  Author:         Sean Dunlap
...
#       Extension for the bcm93368vcm board (Visualization LED and switch stuff).
#
#	PR7114
#
##############
...
# This pull in the bcm93368vcm-specific directory.
BFC_BRCM_BCM93368vcm_DIR = Cm/CmExtensionApi/Broadcom/bcm93368vcm
...
BFC_BRCM_BCM93368vcm_OBJECTS = Bcm93368vcmLedController.o LedControllerFactory.o \
...
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)
        ...
        BFC_BRCM_BCM93368vcm_OBJECTS += LedControllerBatteryStatusACT.o

endif

ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)

        BFC_BRCM_BCM93368vcm_OBJECTS += Controller80211Factory.o LedController80211Factory.o
...
BFC_BRCM_BCM93368vcm_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93368vcm_INCLUDE_DIRS = $(BFC_BRCM_BCM93368vcm_DIR)
...
BFC_BRCM_BCM93368vcm_SOURCE_DIRS = $(BFC_BRCM_BCM93368vcm_DIR)
...
BFC_BRCM_BCM93368vcm_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93368vcm_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93368vcm_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93368vcm_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93368vcm_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93368vcm_LIBRARIES)
