...
#  $Id$
#
#  Filename:       BroadcomBcm93368vm2Cm.mak
#  Author:         Sean Dunlap
...
#       Extension for the bcm93368vm2 board (Visualization LED and switch stuff).
#
#	PR7114
#
##############
...
# This pull in the bcm93368vm2-specific directory.
BFC_BRCM_BCM93368vm2_DIR = Cm/CmExtensionApi/Broadcom/bcm93368vm2
...
BFC_BRCM_BCM93368vm2_OBJECTS = Bcm93368vm2LedController.o LedControllerFactory.o \
...
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)
        ...
        BFC_BRCM_BCM93368vm2_OBJECTS += LedControllerBatteryStatusACT.o

endif

ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)

        BFC_BRCM_BCM93368vm2_OBJECTS += Controller80211Factory.o LedController80211Factory.o
...
BFC_BRCM_BCM93368vm2_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93368vm2_INCLUDE_DIRS = $(BFC_BRCM_BCM93368vm2_DIR)
...
BFC_BRCM_BCM93368vm2_SOURCE_DIRS = $(BFC_BRCM_BCM93368vm2_DIR)
...
BFC_BRCM_BCM93368vm2_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93368vm2_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93368vm2_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93368vm2_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93368vm2_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93368vm2_LIBRARIES)
