...
#  $Id$
#
#  Filename:       BroadcomBcm93368vm4Cm.mak
#  Author:         Sean Dunlap
...
#       Extension for the bcm93368vm4 board (Visualization LED and switch stuff).
#
#	PR7114
#
##############
...
# This pull in the bcm93368vm4-specific directory.
BFC_BRCM_BCM93368vm4_DIR = Cm/CmExtensionApi/Broadcom/bcm93368vm4
...
BFC_BRCM_BCM93368vm4_OBJECTS = Bcm93368vm4LedController.o LedControllerFactory.o \
...
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)
        ...
        BFC_BRCM_BCM93368vm4_OBJECTS += LedControllerBatteryStatusACT.o

endif

ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)

        BFC_BRCM_BCM93368vm4_OBJECTS += Controller80211Factory.o LedController80211Factory.o
...
BFC_BRCM_BCM93368vm4_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93368vm4_INCLUDE_DIRS = $(BFC_BRCM_BCM93368vm4_DIR)
...
BFC_BRCM_BCM93368vm4_SOURCE_DIRS = $(BFC_BRCM_BCM93368vm4_DIR)
...
BFC_BRCM_BCM93368vm4_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93368vm4_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93368vm4_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93368vm4_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93368vm4_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93368vm4_LIBRARIES)
