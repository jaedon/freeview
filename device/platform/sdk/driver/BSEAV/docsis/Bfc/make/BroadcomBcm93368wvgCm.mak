...
#  $Id$
#
#  Filename:       BroadcomBcm93368wvgCm.mak
#  Author:         Sean Dunlap
...
#       Extension for the bcm93368wvg board (Visualization LED and switch stuff).
#
#
##############
#
...
# This pull in the bcm93368wvg-specific directory.
BFC_BRCM_BCM93368wvg_DIR = Cm/CmExtensionApi/Broadcom/bcm93368wvg
...
BFC_BRCM_BCM93368wvg_OBJECTS = Bcm93368wvgLedController.o LedControllerFactory.o \
...
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)
        ...
        BFC_BRCM_BCM93368wvg_OBJECTS += LedControllerBatteryStatusACT.o

endif

ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)

        BFC_BRCM_BCM93368wvg_OBJECTS += Controller80211Factory.o LedController80211Factory.o
...
BFC_BRCM_BCM93368wvg_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93368wvg_INCLUDE_DIRS = $(BFC_BRCM_BCM93368wvg_DIR)
...
BFC_BRCM_BCM93368wvg_SOURCE_DIRS = $(BFC_BRCM_BCM93368wvg_DIR)
...
BFC_BRCM_BCM93368wvg_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93368wvg_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93368wvg_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93368wvg_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93368wvg_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93368wvg_LIBRARIES)
