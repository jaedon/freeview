...
#  $Id$
#
#  Filename:       Broadcom_bcm93378.mak
#  Author:         Mike Sieweke
...
# This pull in the bcm93378-specific directory.
BFC_BRCM_BCM93378_DIR = $(BFC_VENDOR_DIR)/Cm/CmExtensionApi/Broadcom/bcm93378
...
ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)
	...
	BFC_BRCM_BCM93378_OBJECTS = Controller80211Factory.o LedController80211Factory.o 
...
BFC_BRCM_BCM93378_INCLUDE_DIRS = $(BFC_BRCM_BCM93378_DIR)
...
BFC_BRCM_BCM93378_SOURCE_DIRS = $(BFC_BRCM_BCM93378_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM93378_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93378_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93378_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93378_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93378_LIBRARIES)
