...
#  $Id$
#
#  Filename:       BroadcomBcm93378vmlCm.mak
#  Author:         Mike Sieweke
...
#       Extension for the bcm93378vml board (Visualization LED and switch stuff).
#
##############
#
...
# This pull in the bcm93378vml-specific directory.
BFC_BRCM_BCM93378vml_DIR = Cm/CmExtensionApi/Broadcom/bcm93378vml
...
BFC_BRCM_BCM93378vml_OBJECTS = \
        Bcm93378vmlLedController.o \
        LedControllerFactory.o \
        LedController.o \
        LedControllerCmStatusACT.o \
        Bcm3378LedController.o \
        CmVendorLedControllerThread.o \
        LedControllerMtaStatusACT.o
...
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)
    BFC_BRCM_BCM93378vml_OBJECTS += \
        LedControllerBatteryStatusACT.o
endif

ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)
    BFC_BRCM_BCM93378vml_OBJECTS += \
        Controller80211Factory.o \
        LedController80211Factory.o
endif
...
BFC_BRCM_BCM93378vml_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93378vml_INCLUDE_DIRS = $(BFC_BRCM_BCM93378vml_DIR)
...
BFC_BRCM_BCM93378vml_SOURCE_DIRS = $(BFC_BRCM_BCM93378vml_DIR)
...
BFC_BRCM_BCM93378vml_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93378vml_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93378vml_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93378vml_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93378vml_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93378vml_LIBRARIES)
