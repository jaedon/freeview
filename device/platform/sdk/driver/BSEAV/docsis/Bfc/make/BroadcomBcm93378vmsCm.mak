...
#  $Id$
#
#  Filename:       BroadcomBcm93378vmsCm.mak
#  Author:         Mike Sieweke
...
#       Extension for the bcm93378vms board (Visualization LED and switch stuff).
#
##############
#
...
# This pull in the bcm93378vms-specific directory.
BFC_BRCM_BCM93378vms_DIR = Cm/CmExtensionApi/Broadcom/bcm93378vms
...
BFC_BRCM_BCM93378vms_OBJECTS = \
        Bcm93378vmsLedController.o \
...
BFC_BRCM_BCM93378vms_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93378vms_INCLUDE_DIRS = $(BFC_BRCM_BCM93378vms_DIR)
...
BFC_BRCM_BCM93378vms_SOURCE_DIRS = $(BFC_BRCM_BCM93378vms_DIR)
...
BFC_BRCM_BCM93378vms_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93378vms_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93378vms_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93378vms_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93378vms_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93378vms_LIBRARIES)
