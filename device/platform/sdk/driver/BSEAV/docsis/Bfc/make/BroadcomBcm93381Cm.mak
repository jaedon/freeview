...
# This pulls in the bcm93381-specific directory.
BFC_BRCM_BCM93381_DIR = Cm/CmExtensionApi/Broadcom/bcm93381
...
BFC_BRCM_BCM93381_OBJECTS =  Bcm3381LedController.o LedControllerFactory.o \
                             LedController.o LedControllerCmStatusACT.o \
                             CmVendorLedControllerThread.o ResetStandbySwitchThread.o

ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)

        BFC_BRCM_BCM93381_OBJECTS += Controller80211Factory.o LedController80211Factory.o
...
BFC_BRCM_BCM93381_DEFINES =  VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM93381_INCLUDE_DIRS = $(BFC_BRCM_BCM93381_DIR)
...
BFC_BRCM_BCM93381_SOURCE_DIRS = $(BFC_BRCM_BCM93381_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM93381_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93381_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93381_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93381_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93381_LIBRARIES)
