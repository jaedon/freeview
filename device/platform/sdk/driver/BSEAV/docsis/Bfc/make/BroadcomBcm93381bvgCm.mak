...
#  $Id$
#
#  Filename:       BroadcomBcm93381bvgCm.mak
#  Author:         Sean Dunlap
...
#       Extension for the bcm93381bvg board (Visualization LED and switch stuff).
#
#
##############
#
...
# This pull in the bcm93381bvg-specific directory.
BFC_BRCM_BCM93381bvg_DIR = Cm/CmExtensionApi/Broadcom/bcm93381bvg
...
BFC_BRCM_BCM93381bvg_OBJECTS = Bcm93381bvgLedController.o Bcm3381LedController.o \
...
ifeq ($(BFC_INCLUDE_BATTERY_SUPPORT), 1)
        ...
        BFC_BRCM_BCM93381bvg_OBJECTS += LedControllerBatteryStatusACT.o

endif

ifeq ($(BFC_INCLUDE_WIFI80211_SUPPORT), 1)

        BFC_BRCM_BCM93381bvg_OBJECTS += Controller80211Factory.o LedController80211Factory.o
...
BFC_BRCM_BCM93381bvg_DEFINES = VENDOR_LED_CONTROL=1 \
			       BCM3381BVG_LED_CONTROL=1 \
...
BFC_BRCM_BCM93381bvg_INCLUDE_DIRS = $(BFC_BRCM_BCM93381bvg_DIR)
...
BFC_BRCM_BCM93381bvg_SOURCE_DIRS = $(BFC_BRCM_BCM93381bvg_DIR)
...
BFC_BRCM_BCM93381bvg_LIBRARIES = 
...
BFC_OBJECTS += $(BFC_BRCM_BCM93381bvg_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM93381bvg_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM93381bvg_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM93381bvg_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM93381bvg_LIBRARIES)
