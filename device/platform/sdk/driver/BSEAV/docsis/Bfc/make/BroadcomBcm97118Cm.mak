...
#  $Id$
#
#  Filename:       Broadcom_bcm97118.mak
#  Author:         kenny Lee
...
# This pulls in the bcm97118-specific directory.
BFC_BRCM_BCM97118_DIR = Cm/CmExtensionApi/Broadcom/bcm97118
...
BFC_BRCM_BCM97118_OBJECTS = Ecm3418FeDownstreamCalibrationNonVolSettings.o
...
BFC_BRCM_BCM97118_DEFINES = BCM_STB_DHCP_SERVER_NONVOL_CONTROL=1 INCLUDE_BRCM_LNA
...
BFC_BRCM_BCM97118_INCLUDE_DIRS = $(BFC_BRCM_BCM97118_DIR)
...
BFC_BRCM_BCM97118_SOURCE_DIRS = $(BFC_BRCM_BCM97118_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM97118_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM97118_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM97118_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM97118_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM97118_LIBRARIES)
