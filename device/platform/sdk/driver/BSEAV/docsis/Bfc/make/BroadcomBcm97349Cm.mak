...
#  $Id$
#
#  Filename:       Broadcom_bcm97349.mak
#  Author:         kenny Lee
...
# This pulls in the bcm97349-specific directory.
BFC_BRCM_BCM97349_DIR = Cm/CmExtensionApi/Broadcom/bcm97349
...
BFC_BRCM_BCM97349_OBJECTS = ChinaCmDownstreamScanThread.o LedController.o \
                                Bcm3249LedController.o LedControllerFactory.o \
                                CmVendorLedControllerThread.o LedControllerCmStatusACT.o 
...
BFC_BRCM_BCM97349_DEFINES = VENDOR_LED_CONTROL=1 \
...
BFC_BRCM_BCM97349_INCLUDE_DIRS = $(BFC_BRCM_BCM97349_DIR)
...
BFC_BRCM_BCM97349_SOURCE_DIRS = $(BFC_BRCM_BCM97349_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM97349_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM97349_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM97349_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM97349_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM97349_LIBRARIES)
