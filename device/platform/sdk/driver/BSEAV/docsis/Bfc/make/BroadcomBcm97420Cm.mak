...
##############################################################################
#
#  Filename:       Broadcom_bcm97420.mak
#  Author:         Kenny Lee
#  Creation Date:  February 3rd, 2009
#
##############################################################################
#  Description:
#
...
BFC_BRCM_BCM97420_DIR = Cm/CmExtensionApi/Broadcom/bcm97420
...
BFC_BRCM_BCM97420_DEFINES = INCLUDE_BRCM_LNA
...
BFC_BRCM_BCM97420_INCLUDE_DIRS = $(BFC_BRCM_BCM97420_DIR)
...
BFC_BRCM_BCM97420_SOURCE_DIRS = $(BFC_BRCM_BCM97420_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM97420_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM97420_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM97420_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM97420_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM97420_LIBRARIES)
