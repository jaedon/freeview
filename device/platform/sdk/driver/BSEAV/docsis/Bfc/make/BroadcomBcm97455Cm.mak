...
#
##############################################################################
#  $Id: BroadcomBcm97455Cm.mak 1.1 2005/11/29 17:04:26Z kennylee Release $
#
#  Filename:       Broadcom_bcm97455.mak
#  Author:         kenny Lee
...
# This pulls in the bcm97455-specific directory.
BFC_BRCM_BCM97455_DIR = Cm/CmExtensionApi/Broadcom/bcm97455
...
BFC_BRCM_BCM97455_INCLUDE_DIRS = $(BFC_BRCM_BCM97455_DIR)
...
BFC_BRCM_BCM97455_SOURCE_DIRS = $(BFC_BRCM_BCM97455_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM97455_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM97455_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM97455_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM97455_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM97455_LIBRARIES)
