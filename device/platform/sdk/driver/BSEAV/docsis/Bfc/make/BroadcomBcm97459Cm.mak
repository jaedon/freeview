...
##############################################################################
#
#  Filename:       Broadcom_bcm97459.mak
#  Author:         Karthik Balasubramanian
#  Creation Date:  August 7th, 2008
#
##############################################################################
#  Description:
#
...
BFC_BRCM_BCM97459_DIR = Cm/CmExtensionApi/Broadcom/bcm97459
...
BFC_BRCM_BCM97459_INCLUDE_DIRS = $(BFC_BRCM_BCM97459_DIR)
...
BFC_BRCM_BCM97459_SOURCE_DIRS = $(BFC_BRCM_BCM97459_DIR)
...
BFC_OBJECTS += $(BFC_BRCM_BCM97459_OBJECTS)

BFC_COMPILER_DEFINES += $(BFC_BRCM_BCM97459_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_BRCM_BCM97459_INCLUDE_DIRS)
    
BFC_SOURCE_DIRS += $(BFC_BRCM_BCM97459_SOURCE_DIRS)
    
BFC_LIBRARIES += $(BFC_BRCM_BCM97459_LIBRARIES)
