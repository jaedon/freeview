...
#
##############################################################################
#  $Id: Template.mak 1.3 2004/08/16 19:09:25Z dpullen Release $
#
#  Filename:       Template.mak
#  Author:         David Pullen
...
#include $(BFC_ROOT_DIR)/AppDir/make/Whatever.mak
...
BFC_template_OBJECTS = 

BFC_template_CONSOLE_OBJECTS =

BFC_template_NONVOL_OBJECTS =

BFC_template_NONVOL_CONSOLE_OBJECTS =
...
BFC_template_INCLUDE_DIRS = $(BFC_template_DIR)
...
BFC_template_SOURCE_DIRS = $(BFC_template_DIR)
...
BFC_OBJECTS += $(BFC_template_OBJECTS)

ifeq ($(BFC_INCLUDE_CONSOLE_SUPPORT), 1)

    BFC_OBJECTS += $(BFC_template_CONSOLE_OBJECTS)

endif

BFC_COMPILER_DEFINES += $(BFC_template_DEFINES)

BFC_INCLUDE_DIRS += $(BFC_template_INCLUDE_DIRS)

BFC_SOURCE_DIRS += $(BFC_template_SOURCE_DIRS)

BFC_LIBRARIES += $(BFC_template_LIBRARIES)
