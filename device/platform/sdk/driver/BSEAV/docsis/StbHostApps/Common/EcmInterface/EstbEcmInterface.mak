...
#############################################################################
#
#  Filename:       BfcEstbEcmInterface.mak
...
BCM_STB_DOCSIS_API_DIR =   	Stb/StbDocsisApi/Dsg
BCM_ESTB_ECM_INTERFACE_DIR =   	StbHostApps/Common/EcmInterface
...
BCM_ESTB_ECM_INTERFACE_OBJECTS +=	EstbRemoteIfHelperThread.o \
					StubInterface.o \
...
BCM_ESTB_ECM_INTERFACE_DEFINES += BCM_ESTB_ECM_INTERFACE_INCLUDED=1 \
...
BCM_ESTB_ECM_INTERFACE_INCLUDE_DIRS += 	$(BCM_ESTB_ECM_INTERFACE_DIR) \
					$(BCM_ESTB_ECM_INTERFACE_SUB_DIR) \
					$(BCM_STB_DOCSIS_API_DIR) \							 
...
BCM_ESTB_ECM_INTERFACE_SOURCE_DIRS += 	$(BCM_ESTB_ECM_INTERFACE_DIR) \
					$(BCM_ESTB_ECM_INTERFACE_SUB_DIR) \
					$(BCM_STB_DOCSIS_API_DIR)
...
ifeq ($(BCM_ESTB_ECM_INTERFACE_INCLUDED), 1)

	BFC_OBJECTS += $(BCM_ESTB_ECM_INTERFACE_OBJECTS) 

	BFC_COMPILER_DEFINES += $(BCM_ESTB_ECM_INTERFACE_DEFINES)

	BFC_INCLUDE_DIRS += $(BCM_ESTB_ECM_INTERFACE_INCLUDE_DIRS) 

	BFC_SOURCE_DIRS += $(BCM_ESTB_ECM_INTERFACE_SOURCE_DIRS) 
