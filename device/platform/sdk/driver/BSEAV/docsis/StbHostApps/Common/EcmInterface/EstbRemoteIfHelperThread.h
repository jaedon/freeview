...
//****************************************************************************
//
//  Filename:       EstbRemoteIfHelperThread.h
...
#ifndef ESTBREMOTEIFHELPERTHREAD_H
#define ESTBREMOTEIFHELPERTHREAD_H
...
class BcmEstbRemoteIfHelperThread : public BcmThread
{
public:
    ...
    // Returns:  N/A
    //
	BcmEstbRemoteIfHelperThread( BcmOperatingSystem::ThreadPriority initialPriority);//, BcmDsgClientCtlThread* pDsgClientCtlThread);
    ...
    // Returns:  N/A
    //
    virtual ~BcmEstbRemoteIfHelperThread();

	//void SetEstbIpAddress(BcmIpAddress &eStbIpAddress);

    static BcmEstbRemoteIfHelperThread *GetSingletonInstance(void);
...
private:
    ...
    // Returns:  N/A
    //
    BcmEstbRemoteIfHelperThread(const BcmEstbRemoteIfHelperThread &otherInstance);
    ...
    //
    BcmEstbRemoteIfHelperThread & operator = (const BcmEstbRemoteIfHelperThread &otherInstance);
