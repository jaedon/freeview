...
//****************************************************************************
//
//  Filename:       CmDavicApiCommandTable.h
//  Author:         Pinar Taskiran-Cyr
//  Creation Date:  July 22, 2011
//
//****************************************************************************
//  Description:
//      Sub-command table for testing of DAVIC API.
//
//****************************************************************************

#ifndef CMDAVICAPI_COMMANDTABLE_H
#define CMDAVICAPI_COMMANDTABLE_H
...
class BcmDavicApiCommandTable : public BcmCommandTable
{
public:
    ...
    // Returns:  N/A
    //
    virtual ~BcmDavicApiCommandTable();	
...
private:
	...
	static void DavicSetConfigTest(unsigned int checkProviderId);
...
private:
    ...
    // Returns:  N/A
    //
    BcmDavicApiCommandTable(const BcmDavicApiCommandTable &otherInstance);
    ...
    //
    BcmDavicApiCommandTable & operator = (const BcmDavicApiCommandTable &otherInstance);
