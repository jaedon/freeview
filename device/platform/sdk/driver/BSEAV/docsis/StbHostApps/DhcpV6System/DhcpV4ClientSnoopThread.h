...
#ifndef DHCPV4CLIENTSNOOPTHREAD_H
#define DHCPV4CLIENTSNOOPTHREAD_H
...
class BcmDhcpV4ClientSnoopThread : public BcmThread
{
public:
    ...
    // Returns:  N/A
    //
	BcmDhcpV4ClientSnoopThread( BcmOperatingSystem::ThreadPriority initialPriority);//, BcmDsgClientCtlThread* pDsgClientCtlThread);
    ...
    // Returns:  N/A
    //
    virtual ~BcmDhcpV4ClientSnoopThread();

    static BcmDhcpV4ClientSnoopThread *GetSingletonInstance(void);
...
private:
    ...
    // Returns:  N/A
    //
    BcmDhcpV4ClientSnoopThread(const BcmDhcpV4ClientSnoopThread &otherInstance);
    ...
    //
    BcmDhcpV4ClientSnoopThread & operator = (const BcmDhcpV4ClientSnoopThread &otherInstance);
