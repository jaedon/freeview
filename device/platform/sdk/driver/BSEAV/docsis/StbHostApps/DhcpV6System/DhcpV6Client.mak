...
BCM_ESTB_DHCPv6_DIR =   StbHostApps/DhcpV6System              
...
BCM_ESTB_DHCPv6_OBJECTS +=	EstbIpThread.o DhcpV6ClientSnoopThread.o \
				DhcpV6ClientInit.o

ifeq ($(BFC_INCLUDE_DHCPV4_SUPPORT), 1)
BCM_ESTB_DHCPv4_OBJECTS += DhcpV4ClientSnoopThread.o GenericDhcpV4ClientIf.o \
				LnxNetLinkSocket.o 
endif
...
BCM_ESTB_DHCPv6_OBJECTS +=	DhcpV6ClientEventDispatcherACT.o
...
BCM_ESTB_DHCPv6_DEFINES += BCM_STANDALONE_DHCP_CLIENT=1 \
...
BCM_ESTB_DHCPv6_INCLUDE_DIRS += $(BCM_ESTB_DHCPv6_DIR)  		      
...
BCM_ESTB_DHCPv6_SOURCE_DIRS += 	$(BCM_ESTB_DHCPv6_DIR)
...
ifeq ($(BCM_STANDALONE_DHCP_CLIENT), 1)
	...
	BFC_OBJECTS += $(BCM_ESTB_DHCPv6_OBJECTS)
	
 	BFC_OBJECTS += $(BCM_ESTB_DHCPv4_OBJECTS)
	 
	BFC_COMPILER_DEFINES += $(BCM_ESTB_DHCPv6_DEFINES)

	BFC_INCLUDE_DIRS += $(BCM_ESTB_DHCPv6_INCLUDE_DIRS) 

	BFC_SOURCE_DIRS += $(BCM_ESTB_DHCPv6_SOURCE_DIRS) 
