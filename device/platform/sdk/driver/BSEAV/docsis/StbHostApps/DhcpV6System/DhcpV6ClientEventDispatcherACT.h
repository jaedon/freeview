...
//****************************************************************************
//
//  Filename:       DhcpV6ClientEventDispatcherACT.h
//  Author:         Pinar Taskiran-Cyr
//  Creation Date:  July 11, 2009
//
//****************************************************************************
#ifndef DHCPv6CLIENT_EVENTDISPATCHER_ACT_H
#define DHCPv6CLIENT_EVENTDISPATCHER_ACT_H
...
class BcmDhcpV6ClientEventDispatcherACT : public BcmMsgACT
{
public:
 
    // Constructor. 
    //
    BcmDhcpV6ClientEventDispatcherACT( BcmEstbIpThread *pEstbProvisioningThread, BcmOctetBuffer *pMsgObuf = NULL );

    // Destructor.  
    //
    virtual ~BcmDhcpV6ClientEventDispatcherACT();
...
protected:
    // pointer to client object...whatever that might be...
	BcmEstbIpThread *pfEstbIpThread;
    
};

inline ostream& operator<<( ostream& ostrm, const BcmDhcpV6ClientEventDispatcherACT& rhs )
{
