...
#ifndef DHCPV6CLIENTSNOOPTHREAD_H
#define DHCPV6CLIENTSNOOPTHREAD_H
...
class BcmDhcpV6ClientSnoopThread : public BcmThread
{
public:
    ...
    // Returns:  N/A
    //
	BcmDhcpV6ClientSnoopThread( BcmOperatingSystem::ThreadPriority initialPriority);//, BcmDsgClientCtlThread* pDsgClientCtlThread);
    ...
    // Returns:  N/A
    //
    virtual ~BcmDhcpV6ClientSnoopThread();

    static BcmDhcpV6ClientSnoopThread *GetSingletonInstance(void);
...
private:
    ...
    // Returns:  N/A
    //
    BcmDhcpV6ClientSnoopThread(const BcmDhcpV6ClientSnoopThread &otherInstance);
    ...
    //
    BcmDhcpV6ClientSnoopThread & operator = (const BcmDhcpV6ClientSnoopThread &otherInstance);
