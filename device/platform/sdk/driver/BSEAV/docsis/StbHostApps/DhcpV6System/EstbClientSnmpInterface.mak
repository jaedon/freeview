...
BCM_ESTB_SNMP_DIR =  StbHostApps/EstbSnmpAgent/EstbSnmp
...
BCM_ESTB_SNMP_INTERFACE_OBJECTS += 
...
BCM_ESTB_SNMP_INTERFACE_DEFINES += BCM_ESTB_CLIENT_SNMP_INTERFACE_INCLUDED=1
...
BCM_ESTB_SNMP_INTERFACE_INCLUDE_DIRS += $(BCM_ESTB_SNMP_DIR) \
...
BCM_ESTB_SNMP_INTERFACE_SOURCE_DIRS +=    
...
ifeq ($(BCM_ESTB_CLIENT_SNMP_INTERFACE_INCLUDED), 1)

	BFC_OBJECTS += $(BCM_ESTB_SNMP_INTERFACE_OBJECTS) 

	BFC_COMPILER_DEFINES += $(BCM_ESTB_SNMP_INTERFACE_DEFINES)

	BFC_INCLUDE_DIRS += $(BCM_ESTB_SNMP_INTERFACE_INCLUDE_DIRS) 

	BFC_SOURCE_DIRS += $(BCM_ESTB_SNMP_INTERFACE_SOURCE_DIRS) 

	BFC_LIBRARIES += $(BCM_ESTB_SNMP_INTERFACE_LIBS)
