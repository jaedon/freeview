...
BCM_EVD_INTERFACE_DIR =  StbHostApps/DhcpV6System/EventDispatcherIf

BCM_EV_DISPATCHER_DIR = StbHostApps/EcmEventDispatcher
BCM_EV_DISPATCHER_COMMON_DIR = $(BCM_EV_DISPATCHER_DIR)/Common
BCM_EV_DISPATCHER_RPC_CLIENT_IF_DIR = $(BCM_EV_DISPATCHER_DIR)/RpcInterface/Client
...
BCM_EVD_INTERFACE_DEFINES += BCM_EVD_INTERFACE_INCLUDED=1
...
BCM_EVD_INTERFACE_INCLUDE_DIRS += 	$(BCM_EVD_INTERFACE_DIR) \
					$(BCM_EV_DISPATCHER_COMMON_DIR) \
					$(BCM_EV_DISPATCHER_DIR)
...
ifeq ($(BCM_EVD_INTERFACE_INCLUDED), 1)
	...
	BFC_OBJECTS += $(BCM_EVD_INTERFACE_OBJECTS) 

	BFC_COMPILER_DEFINES += $(BCM_EVD_INTERFACE_DEFINES)

	BFC_INCLUDE_DIRS += $(BCM_EVD_INTERFACE_INCLUDE_DIRS) 

	BFC_SOURCE_DIRS += $(BCM_EVD_INTERFACE_SOURCE_DIRS) 

	BFC_LIBRARIES += $(BCM_EVD_INTERFACE_LIBS)
