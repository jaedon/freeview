...
#############################################################################
#
#  Filename:       EstbRpcClientInterface.mak.mak
...
BCM_DHCPv6CL_RPC_CLIENT_INTERFACE_DIR =  StbHostApps/DhcpV6System/EventDispatcherIf/RpcInterface
BCM_DHCPv6_CL_RPC_CLIENT_CUSTOM_INTERFACE_DIR =  $(BCM_DHCPv6CL_RPC_CLIENT_INTERFACE_DIR)/Custom

BCM_COMMON_RPC_INTERFACE_DIR =   StbHostApps/Common/RpcInterface
BCM_COMMON_RPC_CLIENT_INTERFACE_DIR =   $(BCM_COMMON_RPC_INTERFACE_DIR)/DsgClient
BCM_COMMON_RPC_INTERFACE_COMMON_DIR =   $(BCM_COMMON_RPC_INTERFACE_DIR)/Common

BCM_EV_DISPATCHER_RPC_CLIENT_IF_DIR = StbHostApps/EcmEventDispatcher/RpcInterface/Client
...
BCM_DHCPv6CL_RPC_INTERFACE_OBJECTS += dhcpV6EvdClient.o EvDispatcherClientIf.o
...
BCM_DHCPv6CL_RPC_INTERFACE_DEFINES += BCM_EVD_RPCCL_INTERFACE_INCLUDED=1
...
BCM_RPC_INTERFACE_INCLUDE_DIRS += 	$(BCM_COMMON_RPC_INTERFACE_DIR) \
					$(BCM_COMMON_RPC_CLIENT_INTERFACE_DIR) \
					$(BCM_COMMON_RPC_INTERFACE_COMMON_DIR) \
					$(BCM_EV_DISPATCHER_RPC_CLIENT_IF_DIR) \
					$(BCM_DHCPv6_CL_RPC_CLIENT_CUSTOM_INTERFACE_DIR) \
					$(BCM_DHCPv6CL_RPC_CLIENT_INTERFACE_DIR) 					
...
BCM_RPC_INTERFACE_SOURCE_DIRS += 	$(BCM_COMMON_RPC_INTERFACE_DIR) \
					$(BCM_COMMON_RPC_CLIENT_INTERFACE_DIR) \
					$(BCM_COMMON_RPC_INTERFACE_COMMON_DIR) \
					$(BCM_DHCPv6_CL_RPC_CLIENT_CUSTOM_INTERFACE_DIR) \
					$(BCM_DHCPv6CL_RPC_CLIENT_INTERFACE_DIR) \
...
BCM_RPC_INTERFACE_LIBS += $(BCM_RPC_CLIENT_INTERFACE_DIR)/rpccllib.a 
...
# Add RPC interface components, if included by BfcSystemConfig.mak.
ifeq ($(BCM_EVD_RPCCL_INTERFACE_INCLUDED), 1)

	BFC_OBJECTS += $(BCM_RPC_INTERFACE_OBJECTS) 

	BFC_COMPILER_DEFINES += $(BCM_RPC_INTERFACE_DEFINES)

	BFC_INCLUDE_DIRS += $(BCM_RPC_INTERFACE_INCLUDE_DIRS) 

	BFC_SOURCE_DIRS += $(BCM_RPC_INTERFACE_SOURCE_DIRS) 

	BFC_LIBRARIES += $(BCM_RPC_INTERFACE_LIBS)
