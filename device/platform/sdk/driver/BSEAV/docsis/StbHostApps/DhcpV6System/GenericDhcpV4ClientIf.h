...
//  $Id$
//
//  Filename:       GenericDhcpV4ClientIf.h
//  Author:         Henry Shi	
//  Creation Date:  Aug 16, 2009
//
//****************************************************************************

#ifndef GenericDhcpV4ClientIf_H
#define GenericDhcpV4ClientIf_H
...
*/
class BcmGenericDhcpV4ClientIf : public BcmDhcpClientIf
{
public:
    ...
    ///
#if IPHALIF_ENABLED
    BcmGenericDhcpV4ClientIf(BcmBaseIpHalIf &ipHalIf);
    //BcmGenericDhcpV4ClientIf(BcmLnxIpStackIf &ipHalIf);
#else
	BcmGenericDhcpV4ClientIf(uint32 &dummy);
#endif
    //// Destructor.  Frees up any memory/objects allocated, cleans up internal
    /// state.
    ///
    ~BcmGenericDhcpV4ClientIf();
...
private:
    ...
    BcmGenericDhcpV4ClientIf(void);

    /// Copy Constructor.  Not supported.
    BcmGenericDhcpV4ClientIf(const BcmGenericDhcpV4ClientIf &otherInstance);

    /// Assignment operator.  Not supported.
    BcmGenericDhcpV4ClientIf & operator = (const BcmGenericDhcpV4ClientIf &otherInstance);
...
///    cout << clientIf << endl;
///
inline ostream & operator << (ostream &outputStream, const BcmGenericDhcpV4ClientIf &clientIf)
{
