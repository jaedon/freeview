...
//****************************************************************************
//
//  Filename:       IpHelperDhcpClientEventACT.cpp
//  Author:         David Pullen
...
// Returns:  N/A
//
BcmIpHelperDhcpClientEventACT::BcmIpHelperDhcpClientEventACT(BcmEstbIpThread *pIpThread) :
...
// Returns:  N/A
//
BcmIpHelperDhcpClientEventACT::~BcmIpHelperDhcpClientEventACT()
{
...
// Returns:  Nothing.
//
void BcmIpHelperDhcpClientEventACT::HandleEvent(const BcmCompletionEvent &eventCode)
{
    // Make sure somebody was registered with me.
    if (pfIpThread != NULL)
    {
        pfIpThread->ProcessDhcpEvent(eventCode);
    }
}
