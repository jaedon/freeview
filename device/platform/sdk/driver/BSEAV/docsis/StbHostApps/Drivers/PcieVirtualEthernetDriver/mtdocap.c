...
STATIC unsigned int bootldr[5] = { -1};
STATIC int bootldrCount = 0;
module_param_array(bootldr, int, &bootldrCount, 0000);
...
ocap_partition ocap_devs[MAX_DEVS] = { /* name, devnum, start, physical_size, size, optional, fops */
    ...
    {"bootldr", -1, 0, 0, 0, 0, 1, &bootldrCount, bootldr, &mtdocap_fops_normal}
};
