...
//  $Id$
//
//  Filename:       CmAppNonVolSettings.cpp
//  Author:         David Pullen
...
BcmCmAppNonVolSettings *BcmCmAppNonVolSettings::pfSingletonInstance = NULL;
    ...
    BcmNonVolSettings("CM Application NonVol Settings")
{
    ...
    {
        gInfoMsg(fMessageLogSettings, "BcmCmAppNonVolSettings")
            << "Setting up the singleton pointer." << endl;
        pfSingletonInstance = this;
    }
    else
    {
        gWarningMsg(fMessageLogSettings, "BcmCmAppNonVolSettings")
...
// Returns:  N/A
//
BcmCmAppNonVolSettings::~BcmCmAppNonVolSettings()
{
...
// Returns:  Nothing.
//
void BcmCmAppNonVolSettings::ResetDefaults(NonVolSection section)
{
...
//
BcmCmAppNonVolSettings *BcmCmAppNonVolSettings::GetSingletonInstance(void)
{
    if (pfSingletonInstance == NULL)
    {
        gLogMessageRaw
            << "BcmCmAppNonVolSettings::GetSingletonInstance:  WARNING - the singleton instance is NULL, and someone is accessing it!" << endl;
    }
...
//
bool BcmCmAppNonVolSettings::WriteToImpl(BcmOctetBuffer &outputBuffer,
...
//
bool BcmCmAppNonVolSettings::ReadFromImpl(const BcmOctetBuffer &inputBuffer, 
...
//
ostream & BcmCmAppNonVolSettings::PrintImpl(ostream & outputStream) const
{
