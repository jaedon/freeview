...
//  $Id$
//
//  Filename:       CmAppNonVolSettings.h
//  Author:         David Pullen
//  Creation Date:  Feb 10, 2000
//
//****************************************************************************
//  Description:
//      These are the Non-Volatile settings for the DOCSIS 1.0 Cable Modem
...
#ifndef CMAPPNONVOLSETTINGS_H
#define CMAPPNONVOLSETTINGS_H
...
class BcmCmAppNonVolSettings : public BcmNonVolSettings
{
public:
    ...
    // Returns:  N/A
    //
    virtual ~BcmCmAppNonVolSettings();
    ...
    //
    static BcmCmAppNonVolSettings *GetSingletonInstance(void);
...
private:
    ...
    static BcmCmAppNonVolSettings *pfSingletonInstance;
...
private:
    ...
    // Returns:  N/A
    //
    BcmCmAppNonVolSettings(const BcmCmAppNonVolSettings &otherInstance);
    ...
    //
    BcmCmAppNonVolSettings & operator = (const BcmCmAppNonVolSettings &otherInstance);
...
//      false if disabled.
//
inline bool BcmCmAppNonVolSettings::AutoStopAtConsole(void) const
{
...
inline void BcmCmAppNonVolSettings::AutoStopAtConsole(bool enable)
{
    if (enable)
    {
...
//      false if disabled.
//
inline bool BcmCmAppNonVolSettings::DriverInitPrompt(void) const
{
...
inline void BcmCmAppNonVolSettings::DriverInitPrompt(bool enable)
{
...
//      false if disabled.
//
inline bool BcmCmAppNonVolSettings::StopAtConsolePrompt(void) const
{
    // This is a disable bit, so I return the opposite.
...
inline void BcmCmAppNonVolSettings::StopAtConsolePrompt(bool enable)
{
    // This is a disable bit, so I set the opposite.
    if (enable == false)
    {
...
//
inline ostream & operator << (ostream &outputStream, const BcmCmAppNonVolSettings &settingsInstance)
{
