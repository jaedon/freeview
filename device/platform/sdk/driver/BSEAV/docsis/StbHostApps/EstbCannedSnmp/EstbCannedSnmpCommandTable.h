...
//****************************************************************************
//
//  Filename:       EstbCannedSnmpCommandTable.h
...
#ifndef ESTB_CANNEDSNMP_CMDTABLE_H
#define ESTB_CANNEDSNMP_CMDTABLE_H
...
class BcmEstbCannedSnmpCommandTable : public BcmCommandTable
{
public:
    ...
    // Returns:  N/A
    //
    BcmEstbCannedSnmpCommandTable(void);
    ...
    // Returns:  N/A
    //
    virtual ~BcmEstbCannedSnmpCommandTable();
...
private:
    ...
    // Returns:  N/A
    //
    BcmEstbCannedSnmpCommandTable(const BcmEstbCannedSnmpCommandTable &otherInstance);
    ...
    //
    BcmEstbCannedSnmpCommandTable & operator = (const BcmEstbCannedSnmpCommandTable &otherInstance);
};
