...
//  $Id$
//
//  Filename:       NullTerminalConsoleThread.h
...
#ifndef NULLTERMINALCONSOLETHREAD_H
#define NULLTERMINALCONSOLETHREAD_H
...
class BcmNullTerminalConsoleThread : public BcmTerminalConsoleThread
{
public:
    ...
    // Returns:  N/A
    //
    BcmNullTerminalConsoleThread(bool startSuspended = false,
    ...
    // Returns:  N/A
    //
    virtual ~BcmNullTerminalConsoleThread();
...
private:
    ...
    // Returns:  N/A
    //
    BcmNullTerminalConsoleThread(const BcmNullTerminalConsoleThread &otherInstance);
    ...
    //
    BcmNullTerminalConsoleThread & operator = (const BcmNullTerminalConsoleThread &otherInstance);
