...
//  $Id$
//
//  Filename:       EstbSnmpNonVolSettings.h
...
#ifndef ESTBSNMPNONVOLSETTINGS_H
#define ESTBSNMPNONVOLSETTINGS_H
...
#define ESTB_SNMP_INTERFACE_NAME_LEN 16 // length of the interface name, like eth0 or lan0
...
public:
    ...
    void InterfaceName(const char *pString);
    const char *InterfaceName(void) const;
...
private:
    ...
    // Local copy of the eSTB SNMP Agent interface Name
    char fInterfaceName[ESTB_SNMP_INTERFACE_NAME_LEN];
