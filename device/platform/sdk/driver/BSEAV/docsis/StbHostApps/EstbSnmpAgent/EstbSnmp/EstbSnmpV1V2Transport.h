...
//  $Id$
//
//  Filename:       EstbSnmpV1V2Transport.h
//  Author:         Maurice Turcotte
//  Creation Date:  05 DEC 2006
//
//****************************************************************************
//  Description:
//      Class BcmSnmpV1V2Transport encapsulates subId 53.2 of the
//      eSTB TLV type 53 configuration file setting.  
//
//****************************************************************************

#ifndef ESTBSNMPV1V2TRANSPORT_H
#define ESTBSNMPV1V2TRANSPORT_H
...
public:
    ...
    //
	BcmSnmpV1V2Transport( const BcmSnmpV1V2Transport& rhs );
    ...
    //
    BcmSnmpV1V2Transport& operator=( const BcmSnmpV1V2Transport& rhs );
    ...
    //      called.  
    //
	bool operator==( const BcmSnmpV1V2Transport& rhs ) const;
	...
	bool operator<( const BcmSnmpV1V2Transport& rhs ) const
   {
    ...
    // Type 53.2.1: Transport Address
    BcmOctetBuffer fTransportAddress;
    
    // Type 53.2.2: Transport Address Mask
    BcmOctetBuffer fTransportAddressMask;
    bool fTransportAddressMaskSpecified;
    
};

inline ostream& operator<<( ostream& ostrm, const BcmSnmpV1V2Transport& rhs )
{
