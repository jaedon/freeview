...
//  $Id$
//
//  Filename:       TrapHandlerCommandTable.h
...
#ifndef TRAPHANDLERCOMMANDTABLE_H
#define TRAPHANDLERCOMMANDTABLE_H
...
class BcmTrapHandlerCommandTable : public BcmCommandTable
{
public:
    ...
    // Returns:  N/A
    //
    BcmTrapHandlerCommandTable(void);
    ...
    // Returns:  N/A
    //
    virtual ~BcmTrapHandlerCommandTable();
...
private:
    ...
    // Returns:  N/A
    //
    BcmTrapHandlerCommandTable(const BcmTrapHandlerCommandTable &otherInstance);
    ...
    //
    BcmTrapHandlerCommandTable & operator = (const BcmTrapHandlerCommandTable &otherInstance);
