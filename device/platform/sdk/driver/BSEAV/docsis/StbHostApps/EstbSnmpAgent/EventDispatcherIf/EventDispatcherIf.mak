...
#############################################################################
#
#  Filename:       EventDispatcherIf.mak
#  Author:         Pinar Taskiran
#  Creation Date:  Dec 11, 2008
#
##############################################################################
#  Description:
#
...
BCM_ESTBSNMPAGENT_EVD_INTERFACE_DIR =  ../../../EventDispatcherIf

BCM_ESTBSNMPAGENT_EV_DISPATCHER_DIR = ../../../../../StbHostApps/EcmEventDispatcher
BCM_ESTBSNMPAGENT_EV_DISPATCHER_COMMON_DIR = $(BCM_ESTBSNMPAGENT_EV_DISPATCHER_DIR)/Common
...
BCM_ESTBSNMPAGENT_EVD_INTERFACE_OBJECTS += 
...
BCM_ESTBSNMPAGENT_EVD_INTERFACE_DEFINES += -DBCM_EVD_INTERFACE_INCLUDED=1
...
BCM_ESTBSNMPAGENT_EVD_INTERFACE_INCLUDE_DIRS += -I$(BCM_ESTBSNMPAGENT_EVD_INTERFACE_DIR) \
                                                -I$(BCM_ESTBSNMPAGENT_EV_DISPATCHER_DIR) \
						-I$(BCM_ESTBSNMPAGENT_EV_DISPATCHER_COMMON_DIR) 
...
BCM_ESTBSNMPAGENT_EVD_INTERFACE_SOURCE_DIRS +=         			       
...
BCM_ESTBSNMPAGENT_EVD_INTERFACE_LIBS += 
...
ifeq ($(BCM_EVD_INTERFACE_INCLUDED), 1)
	...
	MACH_EXTRA += $(BCM_ESTBSNMPAGENT_EVD_INTERFACE_OBJECTS) 

	ADDED_CFLAGS += $(BCM_ESTBSNMPAGENT_EVD_INTERFACE_DEFINES)

	EXTRA_INCLUDE += $(BCM_ESTBSNMPAGENT_EVD_INTERFACE_INCLUDE_DIRS) 

	VPATH += $(BCM_ESTBSNMPAGENT_EVD_INTERFACE_SOURCE_DIRS) 
