...
#define MoCA_PSS_IE_ENABLE               0
#define MoCA_PSS_IE_DISABLE              1
...
#define MoCA_CFG_NON_LAB_PARAM_ALL_MASK 			  0x03FBFFFEELL	/* Due to issue with OutOfOrderLmo and
																	 core trace control */
#define MoCA_CFG_DEF_PARAM_MASK 					  0x03FFFEF0ELL  /* Parameters for which the defaults exist */
...
#define MoCA_CFG_PARAM_LAB_PILOTS_MASK				  0x40000000LL
   UINT8				pilots [8] ;
#define MoCA_CFG_PARAM_IQ_DIAGRAM_SET_MASK			  0x80000000LL
   MoCAIqDiagramSet 	iq ;
#define MoCA_CFG_PARAM_SNR_GRAPH_SET_MASK			  0x100000000LL
   UINT32				MoCASnrGraphSetNodeId ;
#define MoCA_CFG_PARAM_LAB_REG_MEM_MASK 			  0x200000000LL
   MoCALabRegMem		RegMem ;
#define MoCA_CFG_PARAM_LAB_CALL_FUNC_MASK			  0x400000000LL
   MoCALabCallFunc		callFunc ;
#define MoCA_CFG_PARAM_LAB_TPCAP_MASK				  0x800000000LL
   MoCALabTPCAP 		labTPCAP ;
#define MoCA_CFG_PARAM_FREQ_SHIFT_MASK				 0x1000000000LL
...
typedef struct _MoCANodeStatisticsExtEntry {
   UINT32		  nodeId ;
   UINT8		  rxUcCrcError ;
   UINT8		  rxUcTimeoutError ;
   UINT8		  rxBcCrcError ;
   UINT8		  rxBcTimeoutError ;
   UINT8		  rxMapCrcError ;
   UINT8		  rxMapTimeoutError ;
   UINT8		  rxBeaconCrcError ;
   UINT8		  rxBeaconTimeoutError ;
   UINT8		  rxRrCrcError ;
   UINT8		  rxRrTimeoutError ;
   UINT8		  rxLcCrcError ;
   UINT8		  rxLcTimeoutError ;
   UINT8		  rxP1Error ;
   UINT8		  rxP2Error ;
   UINT8		  rxP3Error ;
   UINT8		  rxP1GcdError ;
