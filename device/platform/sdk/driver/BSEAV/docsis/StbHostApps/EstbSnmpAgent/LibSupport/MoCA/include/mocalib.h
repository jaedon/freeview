...
#define MoCA_CONT_RX_LO_ON              4  /* ICAP.105 mode */
#define MOCA_CONT_TX_CW                 5
#define MOCA_CONT_TX_TONE               6
#define MOCA_CONT_TX_TONE_SC            7
#define MOCA_CONT_TX_DUAL_TONE_SC       8
#define MOCA_CONT_TX_BAND               9
...
struct moca_init_time {
	...
	uint32_t		reserved_init_0;
	uint32_t		bo_mode;
	uint32_t		rf_type;
	uint32_t		terminal_intermediate_device;
	uint32_t		pns_freq_mask;
	uint32_t		beacon_channel;
	...
	uint32_t		flow_control_en;
	uint32_t		mtm_en;
	uint32_t		qam1024_en;
	uint32_t		t50_time_min;
	uint32_t		t50_time_max;
	...
	uint32_t		const_tx_band0;
	uint32_t		const_tx_band1;
	uint32_t		const_tx_band2;
	uint32_t		const_tx_band3;
	uint32_t		const_tx_band4;
	uint32_t		const_tx_band5;
	uint32_t		const_tx_band6;
	uint32_t		const_tx_band7;
...
struct moca_ext_stats {
	...
	uint32_t		rx_lc_adm_req_crc_error;
} __attribute__((packed,aligned(4)));
...
struct moca_pqos_table {
	uint32_t		flow_id_hi;
	uint32_t		flow_id_lo;
	uint32_t		packet_da_hi;
	uint32_t		packet_da_lo;
	uint32_t		talker_hi;
	uint32_t		talker_lo;
	uint32_t		lease_time;
	uint32_t		vlan_prio;
...
struct moca_lmo_info {
	...
	uint32_t		cpu_usage;
	uint32_t		cpu_overload;
	uint32_t		rx_uc_nbas;
	uint32_t		rx_uc_payload_cp;
	uint32_t		rx_uc_backoff;
	uint32_t		rx_uc_en_high_throughput;
	uint32_t		rx_uc_agc_init_gain_adr;
	uint32_t		rx_uc_hw_rssi;
	uint32_t		rx_uc_cc_delay_offset;
	uint32_t		rx_uc_ac_delay_offset;
	uint32_t		rx_uc_turbo;
	uint32_t		tx_uc_nbas;
	uint32_t		tx_uc_payload_cp;
	uint32_t		tx_uc_backoff;
	uint32_t		tx_uc_en_high_throughput;
	uint32_t		tx_uc_turbo;
	uint32_t		bc_nbas;
	uint32_t		bc_payload_cp;
	uint32_t		bc_backoff;
	uint32_t		rx_bc_agc_init_gain_adr;
	uint32_t		rx_bc_hw_agc_addr;
	uint32_t		rx_bc_gw_rssi;
	uint32_t		rx_bc_rx_ac_delay_offset;
	uint32_t		map_rx_cc_delay_offset;
	uint32_t		map_rx_ac_delay_offset;
} __attribute__((packed,aligned(4)));
