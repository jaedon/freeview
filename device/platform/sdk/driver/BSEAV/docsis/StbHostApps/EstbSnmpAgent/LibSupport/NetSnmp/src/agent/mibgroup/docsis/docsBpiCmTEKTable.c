...
#include "docsBpiCmTEKTable.h"

/** Initialize the docsBpiCmTEKTable table by defining its contents and how it's structured */
void
initialize_table_docsBpiCmTEKTable(void)
{
    static oid      docsBpiCmTEKTable_oid[] =
     ...
     */
    my_handler = netsnmp_create_handler_registration("docsBpiCmTEKTable",
                                                     docsBpiCmTEKTable_handler,
                                                     docsBpiCmTEKTable_oid,
                                                     OID_LENGTH
                                                     (docsBpiCmTEKTable_oid),
                                                     HANDLER_CAN_RWRITE);
    ...
    if (my_handler) {
        if (netsnmp_register_handler(my_handler)) {
            DEBUGMSGTL(("initialize_table_docsBpiCmTEKTable",
...
/** Initializes the docsBpiCmTEKTable module */
void
init_docsBpiCmTEKTable(void)
{

    /*
     * here we initialize all the tables we're planning on supporting 
     */
    initialize_table_docsBpiCmTEKTable();
}

/** handles requests for the docsBpiCmTEKTable table */
int
docsBpiCmTEKTable_handler(netsnmp_mib_handler *handler,
    ...
    for (request = requests; request; request = request->next) {
        ...
        case MODE_GET:
            ...
            if (retVal == SNMP_ERR_NOERROR) {
                ...
                case COLUMN_DOCSBPICMTEKPRIVACYENABLE:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKSTATE:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKEXPIRESOLD:
                    snmp_set_var_typed_value(var, ASN_OCTET_STR,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKEXPIRESNEW:
                    snmp_set_var_typed_value(var, ASN_OCTET_STR,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKKEYREQUESTS:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKKEYREPLIES:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKKEYREJECTS:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKINVALIDS:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKAUTHPENDS:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKKEYREJECTERRORCODE:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKKEYREJECTERRORSTRING:
                    snmp_set_var_typed_value(var, ASN_OCTET_STR,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKINVALIDERRORCODE:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSBPICMTEKINVALIDERRORSTRING:
                    snmp_set_var_typed_value(var, ASN_OCTET_STR,
                                             (u_char *) tmpVal, tmpValLen);
                    break;
                ...
                default:
                     ...
                     */
                    snmp_log(LOG_ERR,
                             "problem encountered in docsBpiCmTEKTable_handler: unknown column\n");
                }
            } else {
            ...
            break;
        case MODE_GETNEXT:
            DEBUGMSGTL(("docsBpiCmTEKTable_handler", "GETNEXT\n"));
            /*
            ...
            if ((netsnmp_oid_is_subtree
                ...
                DEBUGMSGTL(("docsBpiCmTEKTable_handler",
                ...
                if ((retVal == SNMP_ERR_NOSUCHNAME)
                    && (tmpOid[reginfo->rootoid_len + 1] < 13)) {
                    /*
                     * more columns to try 
                     */
        ...
        default:
            snmp_log(LOG_ERR,
                     "problem encountered in docsBpiCmTEKTable_handler: unsupported mode\n");
        }
    }
    return retVal;
}
