...
initialize_table_docsDevEventTable(void)
{
     ...
     */
    my_handler = netsnmp_create_handler_registration("docsDevEventTable",
    ...
    if (my_handler) {
        if (netsnmp_register_handler(my_handler)) {
            DEBUGMSGTL(("initialize_table_docsDevEventTable",
...
/** Initializes the docsDevEventTable module */
void
...
/** handles requests for the docsDevEventTable table */
int
                          ...
                          netsnmp_request_info *requests)
{
    ...
    for (request = requests; request; request = request->next) {
        ...
        case MODE_GET:
            ...
            if (retVal == SNMP_ERR_NOERROR) {
                ...
                default:
                     ...
                     */
                    snmp_log(LOG_ERR,
                             "problem encountered in docsDevEventTable_handler: unknown column\n");
                }
            } else {
            ...
            break;
        case MODE_GETNEXT:
            DEBUGMSGTL(("docsDevEventTable_handler", "GETNEXT\n"));
            /*
            ...
            if ((netsnmp_oid_is_subtree
                ...
                DEBUGMSGTL(("docsDevEventTable_handler",
        ...
        default:
            snmp_log(LOG_ERR,
                     "problem encountered in docsDevEventTable_handler: unsupported mode\n");
        }
    }
    return retVal;
}
