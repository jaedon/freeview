...
#include "docsDevFilterPolicyTable.h"

/** Initialize the docsDevFilterPolicyTable table by defining its contents and how it's structured */
void
initialize_table_docsDevFilterPolicyTable(void)
{
    static oid      docsDevFilterPolicyTable_oid[] =
     ...
     */
    my_handler =
        netsnmp_create_handler_registration("docsDevFilterPolicyTable",
                                            docsDevFilterPolicyTable_handler,
                                            docsDevFilterPolicyTable_oid,
                                            OID_LENGTH
                                            (docsDevFilterPolicyTable_oid),
                                            HANDLER_CAN_RWRITE);
    ...
    if (my_handler) {
        if (netsnmp_register_handler(my_handler)) {
            DEBUGMSGTL(("initialize_table_docsDevFilterPolicyTable",
...
/** Initializes the docsDevFilterPolicyTable module */
void
init_docsDevFilterPolicyTable(void)
{

    /*
     * here we initialize all the tables we're planning on supporting 
     */
    initialize_table_docsDevFilterPolicyTable();
}

/** handles requests for the docsDevFilterPolicyTable table */
int
docsDevFilterPolicyTable_handler(netsnmp_mib_handler *handler,
    ...
    for (request = requests; request; request = request->next) {
        ...
        case MODE_GET:
            ...
            if (retVal == SNMP_ERR_NOERROR) {
                ...
                case COLUMN_DOCSDEVFILTERPOLICYID:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSDEVFILTERPOLICYSTATUS:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSDEVFILTERPOLICYPTR:
                ...
                default:
                     ...
                     */
                    snmp_log(LOG_ERR,
                             "problem encountered in docsDevFilterPolicyTable_handler: unknown column\n");
                }
            } else {
            ...
            break;
        case MODE_GETNEXT:
            DEBUGMSGTL(("docsDevFilterPolicyTable_handler", "GETNEXT\n"));
            /*
            ...
            if ((netsnmp_oid_is_subtree
                ...
                DEBUGMSGTL(("docsDevFilterPolicyTable_handler",
        ...
        case MODE_SET_RESERVE1:
            printf
                ("docsDevFilterPolicyTable_handler: Mode = MODE_SET_RESERVE\n");
            switch (var->name[reginfo->rootoid_len + 1]) {
            case COLUMN_DOCSDEVFILTERPOLICYID:
            ...
            case COLUMN_DOCSDEVFILTERPOLICYSTATUS:
                ...
                break;
            case COLUMN_DOCSDEVFILTERPOLICYPTR:
                if (requests->requestvb->type != ASN_OBJECT_ID) {
                    netsnmp_set_request_error(reqinfo, requests,
                                              SNMP_ERR_WRONGTYPE);
                    retVal = SNMP_ERR_WRONGTYPE;
                } else {
        ...
        case MODE_SET_COMMIT:
            printf
                ("docsDevFilterPolicyTable_handler: Mode = MODE_SET_COMMIT\n");
            /*
             * really do the set! 
             */
            switch (var->name[reginfo->rootoid_len + 1]) {
