...
#include "docsDevNmAccessTable.h"

/** Initialize the docsDevNmAccessTable table by defining its contents and how it's structured */
void
initialize_table_docsDevNmAccessTable(void)
{
    static oid      docsDevNmAccessTable_oid[] =
        { 1, 3, 6, 1, 2, 1, 69, 1, 2 };
     ...
     */
    my_handler =
        netsnmp_create_handler_registration("docsDevNmAccessTable",
                                            docsDevNmAccessTable_handler,
                                            docsDevNmAccessTable_oid,
                                            OID_LENGTH
                                            (docsDevNmAccessTable_oid),
                                            HANDLER_CAN_RWRITE);
    ...
    if (my_handler) {
        if (netsnmp_register_handler(my_handler)) {
            DEBUGMSGTL(("initialize_table_docsDevNmAccessTable",
...
/** Initializes the docsDevNmAccessTable module */
void
init_docsDevNmAccessTable(void)
{

    /*
     * here we initialize all the tables we're planning on supporting 
     */
    initialize_table_docsDevNmAccessTable();
}

/** handles requests for the docsDevNmAccessTable table */
int
docsDevNmAccessTable_handler(netsnmp_mib_handler *handler,
    ...
    for (request = requests; request; request = request->next) {
        ...
        case MODE_GET:
            ...
            if (retVal == SNMP_ERR_NOERROR) {
                ...
                case COLUMN_DOCSDEVNMACCESSIP:
                    snmp_set_var_typed_value(var, ASN_IPADDRESS,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSDEVNMACCESSIPMASK:
                    snmp_set_var_typed_value(var, ASN_IPADDRESS,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSDEVNMACCESSCOMMUNITY:
                    snmp_set_var_typed_value(var, ASN_OCTET_STR,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSDEVNMACCESSCONTROL:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSDEVNMACCESSINTERFACES:
                    snmp_set_var_typed_value(var, ASN_OCTET_STR,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSDEVNMACCESSSTATUS:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;
                ...
                default:
                     ...
                     */
                    snmp_log(LOG_ERR,
                             "problem encountered in docsDevNmAccessTable_handler: unknown column\n");
                }
            } else {
            ...
            break;
        case MODE_GETNEXT:
            DEBUGMSGTL(("docsDevNmAccessTable_handler", "GETNEXT\n"));
            /*
            ...
            if ((netsnmp_oid_is_subtree
                ...
                DEBUGMSGTL(("docsDevNmAccessTable_handler",
        ...
        case MODE_SET_RESERVE1:
            printf
                ("docsDevNmAccessTable_handler: Mode = MODE_SET_RESERVE\n");
            switch (var->name[reginfo->rootoid_len + 1]) {
            case COLUMN_DOCSDEVNMACCESSIP:
        ...
        case MODE_SET_COMMIT:
            printf
                ("docsDevNmAccessTable_handler: Mode = MODE_SET_COMMIT\n");
            /*
             * really do the set! 
             */
            switch (var->name[reginfo->rootoid_len + 1]) {
