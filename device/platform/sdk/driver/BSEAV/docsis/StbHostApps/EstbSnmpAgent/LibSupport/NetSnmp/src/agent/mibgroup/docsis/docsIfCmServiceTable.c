...
#include "docsIfCmServiceTable.h"

/** Initialize the docsIfCmServiceTable table by defining its contents and how it's structured */
void
initialize_table_docsIfCmServiceTable(void)
{
    static oid      docsIfCmServiceTable_oid[] =
     ...
     */
    my_handler =
        netsnmp_create_handler_registration("docsIfCmServiceTable",
                                            docsIfCmServiceTable_handler,
                                            docsIfCmServiceTable_oid,
                                            OID_LENGTH
                                            (docsIfCmServiceTable_oid),
                                            HANDLER_CAN_RWRITE);
    ...
    if (my_handler) {
        if (netsnmp_register_handler(my_handler)) {
            DEBUGMSGTL(("initialize_table_docsIfCmServiceTable",
...
/** Initializes the docsIfCmServiceTable module */
void
init_docsIfCmServiceTable(void)
{

    /*
     * here we initialize all the tables we're planning on supporting 
     */
    initialize_table_docsIfCmServiceTable();
}

/** handles requests for the docsIfCmServiceTable table */
int
docsIfCmServiceTable_handler(netsnmp_mib_handler *handler,
    ...
    for (request = requests; request; request = request->next) {
        ...
        case MODE_GET:
            ...
            if (retVal == SNMP_ERR_NOERROR) {
                ...
                case COLUMN_DOCSIFCMSERVICEQOSPROFILE:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFCMSERVICETXSLOTSIMMED:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFCMSERVICETXSLOTSDED:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFCMSERVICETXRETRIES:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFCMSERVICETXEXCEEDEDS:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFCMSERVICERQRETRIES:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFCMSERVICERQEXCEEDEDS:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;
                ...
                default:
                     ...
                     */
                    snmp_log(LOG_ERR,
                             "problem encountered in docsIfCmServiceTable_handler: unknown column\n");
                }
            } else {
            ...
            break;
        case MODE_GETNEXT:
            DEBUGMSGTL(("docsIfCmServiceTable_handler", "GETNEXT\n"));
            /*
            ...
            if ((netsnmp_oid_is_subtree
                ...
                DEBUGMSGTL(("docsIfCmServiceTable_handler",
        ...
        default:
            snmp_log(LOG_ERR,
                     "problem encountered in docsIfCmServiceTable_handler: unsupported mode\n");
        }
    }
    return retVal;
}
