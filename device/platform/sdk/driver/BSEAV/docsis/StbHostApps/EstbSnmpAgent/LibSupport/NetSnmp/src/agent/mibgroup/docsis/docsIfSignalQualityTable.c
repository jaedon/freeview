...
#include "docsIfSignalQualityTable.h"

/** Initialize the docsIfSignalQualityTable table by defining its contents and how it's structured */
void
initialize_table_docsIfSignalQualityTable(void)
{
    static oid      docsIfSignalQualityTable_oid[] =
     ...
     */
    my_handler =
        netsnmp_create_handler_registration("docsIfSignalQualityTable",
                                            docsIfSignalQualityTable_handler,
                                            docsIfSignalQualityTable_oid,
                                            OID_LENGTH
                                            (docsIfSignalQualityTable_oid),
                                            HANDLER_CAN_RWRITE);
    ...
    if (my_handler) {
        if (netsnmp_register_handler(my_handler)) {
            DEBUGMSGTL(("initialize_table_docsIfSignalQualityTable",
...
/** Initializes the docsIfSignalQualityTable module */
void
init_docsIfSignalQualityTable(void)
{

    /*
     * here we initialize all the tables we're planning on supporting 
     */
    initialize_table_docsIfSignalQualityTable();
}

/** handles requests for the docsIfSignalQualityTable table */
int
docsIfSignalQualityTable_handler(netsnmp_mib_handler *handler,
    ...
    for (request = requests; request; request = request->next) {
        ...
        case MODE_GET:
            ...
            if (retVal == SNMP_ERR_NOERROR) {
                ...
                case COLUMN_DOCSIFSIGQINCLUDESCONTENTION:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFSIGQUNERROREDS:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFSIGQCORRECTEDS:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFSIGQUNCORRECTABLES:
                    snmp_set_var_typed_value(var, ASN_COUNTER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFSIGQSIGNALNOISE:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFSIGQMICROREFLECTIONS:
                    snmp_set_var_typed_value(var, ASN_INTEGER,
                                             (u_char *) tmpVal, tmpValLen);
                    break;

                case COLUMN_DOCSIFSIGQEQUALIZATIONDATA:
                ...
                default:
                     ...
                     */
                    snmp_log(LOG_ERR,
                             "problem encountered in docsIfSignalQualityTable_handler: unknown column\n");
                }
            } else {
            ...
            break;
        case MODE_GETNEXT:
            DEBUGMSGTL(("docsIfSignalQualityTable_handler", "GETNEXT\n"));
            /*
            ...
            if ((netsnmp_oid_is_subtree
                ...
                DEBUGMSGTL(("docsIfSignalQualityTable_handler",
                ...
                if ((retVal == SNMP_ERR_NOSUCHNAME)
                    && (tmpOid[reginfo->rootoid_len + 1] < 7)) {
                    /*
                     * more columns to try 
                     */
        ...
        default:
            snmp_log(LOG_ERR,
                     "problem encountered in docsIfSignalQualityTable_handler: unsupported mode\n");
        }
    }
    return retVal;
}
