...
init_snmp_mib(void)
{
// BRCM PR 8383: don't register for the SNMP MIB unless explicitly
// instructed to do so by way of register_snmp_mib call, above.
#if 0
    /*
     * register ourselves with the agent to handle our mib tree 
     */
           ...
           size_t var_val_len, u_char * statP, oid * name, size_t name_len)
{
    ...
    case FREEx:                 /* Free any resources allocated */
        break;
    }
