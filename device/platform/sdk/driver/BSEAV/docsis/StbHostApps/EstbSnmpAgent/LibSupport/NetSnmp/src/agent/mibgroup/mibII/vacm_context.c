...
register_vacm_context(void)
{
    ...
    /*
    {
      ...
      printf ("init_vacm_context\n");
      printf ("table_info = %p\n", table_info);
      if (table_info)
      {
        printf ("table_info->indexes = %p\n", table_info->indexes);
        if (table_info->indexes)
        {
          for (Loop = 0; Loop < table_info->indexes->name_length; Loop++)
            printf (".%d", table_info->indexes->name[Loop]);
          printf ("\n");
        }
      }
    }
...
{
    #if 0 // moved to register_vacm_context()
    /*
     * table vacm_context
     */
    netsnmp_handler_registration *my_handler;
