 ...
 */
/* BRCM_MOD - removed static so we can use this struct elsewhere */
...
send_notifications(int major, int minor, void *serverarg, void *clientarg)
{
    ...
    printf("XXXXX The real send_notifications I want to know if we get here! XXX\n"); 
    // we should never get here, we have our own version of this function
                                   ...
                                   void *serverarg, void *clientarg)
{
    ...
    brcm_mod moe: replace above line with below two lines*/
    ptr->tAddress = (char *) malloc(ptr->tAddressLen);
    memcpy(ptr->tAddress, t->remote, ptr->tAddressLen);
...
//                 snmpNotifyTable_variables_oid);
    ...
    /* TRC 6/14/04 these are the wrong callbacks.  We will install the correct ones on our side. */
                            ...
                            u_char * statP, oid * name, size_t name_len)
{
    ...
    case RESERVE2:
        ...
        if (value != SNMP_STORAGE_OTHER 
        &&  value != SNMP_STORAGE_VOLATILE
        &&  value != SNMP_STORAGE_NONVOLATILE) {
            return SNMP_ERR_WRONGVALUE;
        }
        
        // BRCM_MOD: only accept VOLATILE per DOCSIS requirements
        if (value != SNMP_STORAGE_VOLATILE) {
                          ...
                          u_char * statP, oid * name, size_t name_len)
{
    ...
    case RESERVE1:
        ...
        if (StorageTmp == NULL &&
             ...
             * default values 
             */
            // BRCM_MOD: default to VOLATILE per DOCSIS requirements.
            StorageNew->snmpNotifyStorageType = ST_VOLATILE; //ST_NONVOLATILE;
