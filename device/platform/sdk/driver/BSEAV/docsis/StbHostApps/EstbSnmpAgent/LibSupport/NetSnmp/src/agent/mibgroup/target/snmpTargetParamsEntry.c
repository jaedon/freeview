...
struct targetParamTable_struct *aPTable = 0;
...
void
register_snmpTargetParamsEntry(void)
{
...
init_snmpTargetParamsEntry(void)
{
    ...
    // BRCM_MOD PR7207: don't do this here, only if an explicit call is
    // made to register_snmpTargetParamsEntry, above.
//  REGISTER_MIB("target/snmpTargetParamsEntry",
//               snmpTargetParamsEntry_variables, variable2,
//               snmpTargetParamsEntry_variables_oid);
