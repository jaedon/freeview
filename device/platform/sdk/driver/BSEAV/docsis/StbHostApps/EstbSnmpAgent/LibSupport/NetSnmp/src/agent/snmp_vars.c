...
///# include <sys/socketvar.h> #ifdef NOT_FOR_ECOS
#endif
...
init_agent(const char *app)
{
    ...
    //printf(" BRCM_MOD don't call init_agent_read_config\n");
    ...
    //printf("BRCM_MOD don't call  netsnmp_udp_agent_config_tokens_register\n");
