    ...
    *engine_time = *engineboot = 0;
    ...
    if (timediff > (int) (ENGINETIME_MAX - *engine_time)) {
        *engine_time = (timediff - (ENGINETIME_MAX - *engine_time));
        ...
        //note: engine_time is the time when the engine was last set.  timediff is the time since then.
        //printf("engine time <%d>, timediff <%d>, total time <%d> \n",*engine_time,timediff, *engine_time+timediff);
