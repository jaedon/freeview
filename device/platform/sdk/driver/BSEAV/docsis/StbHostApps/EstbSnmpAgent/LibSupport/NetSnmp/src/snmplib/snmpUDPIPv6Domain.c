...
//BRCM_MOD remove static - need to call from other places
/*static*/char *
...
netsnmp_udp6_transport(struct sockaddr_in6 *addr, int local)
{
    ...
    printf(" WARNING netsnmp_udp6_transport starting. \n");
                     ...
                     const char *inpeername, int remote_port)
{
    ...
    // printf("copy a pton to addr ---------------------\n");
    // inet_pton(AF_INET6,"fec0:a:18:5e:210:18ff:fe29:3939",&(addr->sin6_addr));
...
{
    printf("WARNING: ADDING the standard v6 domain   netsnmp_udp6_ctor\n");
