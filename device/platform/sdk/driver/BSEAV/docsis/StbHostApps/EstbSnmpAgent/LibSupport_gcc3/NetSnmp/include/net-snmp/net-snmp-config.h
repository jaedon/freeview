...
#define DEFAULT_MIBS "IP-MIB:IF-MIB:TCP-MIB:UDP-MIB:SNMPv2-MIB:RFC1213-MIB:NOTIFICATION-LOG-MIB:SNMP-TARGET-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:SNMP-FRAMEWORK-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM"
...
/* brcm_mod  #define PERSISTENT_MASK 077 */
...
#define CONFIGURE_OPTIONS "\" --disable-shared --target=mipsel-linux --with-cc=/opt/toolchains/uclibc-crosstools_linux-2.6.12.0_gcc-3.4.2_uclibc-20050502-20050915/bin/mipsel-linux-gcc '--with-cflags=-mgp32 -mips2 -G 0 -O2 ' --with-endianness=little '--with-out-transports=TCP Unix' --without-ucd-snmp-compatibility '--with-out-mib-modules=ucd_snmp agent_mibs agentx utilities examples host ' --with-mib-modules=bcmV2\""
