 ...
 *  ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: indexfromoffset_test.cpp $
 * $brcm_Revision: 2 $
 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/lib/bcmplayer/tests/indexfromoffset_test.cpp $
 * 
...
int main(int argc, char **argv) {
	if (argc < 3) {
		printf("Usage: ./indexfromoffset_test INDEXFILE HEXOFFSET\n");
		exit(1);
	}

	const char *indexfile = argv[1];
	unsigned long offsetlo;
	offsetlo = strtoul(argv[2], NULL, 16);
	...
	long index = BNAV_Player_FindIndexFromOffset(bcmp, 0, offsetlo);
