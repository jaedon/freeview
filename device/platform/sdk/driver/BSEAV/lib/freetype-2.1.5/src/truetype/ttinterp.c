...
#define ARRAY_BOUND_ERROR                   \
  ...
  /* Stack:        uint32 --> f26.6                                        */
  /*                                                                       */
  /* BAD: Measures from the original glyph must be taken along the    */
  ...
  /*                                                                       */
  /* BAD: Measure taken in the original glyph must be along the dual  */
  /*           projection vector.                                          */
  /*                                                                       */
  /* Second BAD: Flag attributes are inverted!                        */
