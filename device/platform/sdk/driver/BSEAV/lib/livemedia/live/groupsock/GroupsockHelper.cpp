...
#include <hostLib.h>
 ...
 /*Starting replacement for gethostbyname*/
 memset(&hints, 0, sizeof(hints));
    ...
    if (getaddrinfo(hostname, NULL, &hints, &addrInfo) != 0) {
      ...
      if (addrInfo == NULL /*|| addrInfo->ai_addrlen != 4*/) {
	env.setResultErrMsg("initial getaddrinfo() failed");
	break;
      }
...
#endif
      fromAddr.sin_addr.s_addr = ((struct sockaddr_in *)(addrInfo->ai_addr))->sin_addr.s_addr;
    } while (0);
