...
#ifdef MSDRM_PRELOAD_LICENSE
/* For memory based file access */
typedef struct drmFile FILE;
#else
typedef void* FILE;
#endif

#if 0
#ifndef KERNEL_TIME_DEFINE 
/*Some Kernel have this struct defined in linux/time.h and some dont. 
Please modify this flag based on the kernel you are using*/
struct tm
{
	int tm_mon;
	int tm_mday;
