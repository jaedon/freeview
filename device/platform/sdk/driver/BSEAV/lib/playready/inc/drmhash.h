...
#ifdef __KERNEL__
#if DRM_SHA1_DIGEST_LEN > SHA256_DIGEST_SIZE_IN_BYTES
#define DRM_SHA_DIGEST_LEN_MAX    DRM_SHA1_DIGEST_LEN 
#else
#define DRM_SHA_DIGEST_LEN_MAX    SHA256_DIGEST_SIZE_IN_BYTES
#endif
#if DRM_SHA1_BLOCK_SIZE > SHA256_BLOCK_SIZE_IN_BYTES
#define DRM_SHA_BLOCK_SIZE_MAX    DRM_SHA1_BLOCK_SIZE 
#else
#define DRM_SHA_BLOCK_SIZE_MAX    SHA256_BLOCK_SIZE_IN_BYTES 
#endif
#else
