...
)
{
    ...
    */
    ...
    if ( f_pData->wSignatureType == DRM_BCERT_SIGNATURE_TYPE_P256 )
    {
        ...
        /*
        ** If non-vault signing is not supported:
        ...
        */
        ...
        ChkDR( DRM_BBX_SignWithCertKeys( f_pOEMContext,
                                         ...
                                         fUsePrivKey ? (DRM_BYTE*)f_pData->pPrivateKey : NULL,
                                         f_cbAmountToSign,
...
**
** Arguments:   [f_pbBuffer]            : The address at which to start writing these data
**              [f_SecurityVersionData] : The SecurityVersion data
...
static DRM_RESULT _addCertSecurityVersion(
            DRM_BYTE                        *f_pbBuffer,
   __in     DRM_BCERT_SECURITY_VERSION_DATA  f_SecurityVersionData,
...
)
{
    ...
    ChkArg( f_pbBuffer != NULL );
    ChkArg( f_SecurityVersionData.fValid );
    ChkArg(f_HeaderType == DRM_BCERT_OBJTYPE_SECURITY_VERSION || f_HeaderType == DRM_BCERT_OBJTYPE_SECURITY_VERSION_2);

    ChkBOOL( f_SecurityVersionData.dwSecurityVersion != 0, DRM_E_BCERT_INVALID_SECURITY_VERSION );
    ...
    ** Add the Security Version
    */
    DWORD_TO_NETWORKBYTES( f_pbBuffer, iBuffer, f_SecurityVersionData.dwSecurityVersion );
    iBuffer += SIZEOF( DRM_DWORD );

    /*
    ** Add the Platform Identifier
    */
    DWORD_TO_NETWORKBYTES( f_pbBuffer, iBuffer, f_SecurityVersionData.dwPlatformIdentifier );
