...
**
**********************************************************************/
static DRM_RESULT _CalculateBlobHash(
    ...
    __out_bcount( __CB_DECL( DRM_SHA1_DIGEST_LEN ) )
                  DRM_BYTE       *f_pbPassword,
    __out_bcount( __CB_DECL( DRM_ID_SIZE ) )
                  DRM_BYTE       *f_pbHashValue ) DRM_NO_INLINE_ATTRIBUTE;
                  ...
                  DRM_BYTE       *f_pbHashValue )
{
    ...
    */
    ...
    {
        DRM_BYTE bTmp = GET_BYTE( f_pbHashValue, i ) ^
    ...
    __out       DRM_BOOL             *f_pfResult )
{
    ...
    */
    ...
    if ( dr == DRM_E_DSTSLOTNOTFOUND || dr == DRM_E_BUFFERTOOSMALL )
    {
        /*
