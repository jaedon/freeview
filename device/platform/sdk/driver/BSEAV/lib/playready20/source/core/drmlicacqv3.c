...
** Returns:                 DRM_SUCCESS on success.
**                          DRM_E_INVALIDARG if the arguments are invalid.
**                          DRM_E_DEVCERTEXCEEDSIZELIMIT if size of scratch
    ...
    __inout         DRM_BCERT_CLIENT_ID     *f_poClientId )
{
    ...
    ChkDR( DRM_SOAPXML_GetDeviceCert( f_poBlackBoxContext->pKeyFileContext,
                                      ...
                                      NULL,
                                      &cbDeviceCert ) );
    ChkBOOL( cbDeviceCert < f_cbScratchBCertBuffer, DRM_E_DEVCERTEXCEEDSIZELIMIT );
    ...
    __in    DRM_SUBSTRING           *f_pdasstrResponse )
{
    ...
    */
    dr = DRM_SOAPXML_ValidateProtocolSignature(
        (DRM_BYTE *)f_pdastrResponse->pszString,
    ...
    */
    ...
    {
        ChkDR( DRM_E_INVALID_LICENSE_RESPONSE_RESPONSEID );
    }
...
static DRM_RESULT _ExtractLicensesFromLicenseResponse(
    ...
    __in                                                   DRM_ANSI_CONST_STRING  *f_pdastrResponse,
    __in                                                   DRM_SUBSTRING          *f_pdasstrResponse,
    __in_opt                                               DRM_SLKDATA            *f_pSLKData,
    ...
    __inout                             DRM_DWORD              *f_pcbChallenge )
{
    ...
    */
    ...
    MEMCPY( f_pbChallenge, dastrXML.pszString, dastrXML.cchString + 1);
