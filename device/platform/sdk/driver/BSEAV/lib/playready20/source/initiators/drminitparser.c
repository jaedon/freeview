...
/* "Metering" */
const DRM_WCHAR g_rgwchMeteringInitiator [] =
{
    ONE_WCHAR( 'M', '\0' ), ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 't', '\0' ), ONE_WCHAR( 'e', '\0' ),
...
/* "JoinDomain" */
const DRM_WCHAR g_rgwchJoinDomainInitiator [] =
{
    ONE_WCHAR( 'J', '\0' ), ONE_WCHAR( 'o', '\0' ), ONE_WCHAR( 'i', '\0' ), ONE_WCHAR( 'n', '\0' ),
    ONE_WCHAR( 'D', '\0' ), ONE_WCHAR( 'o', '\0' ), ONE_WCHAR( 'm', '\0' ), ONE_WCHAR( 'a', '\0' ),
    ONE_WCHAR( 'i', '\0' ), ONE_WCHAR( 'n', '\0' ), ONE_WCHAR( '\0', '\0' )
};
const DRM_CONST_STRING g_dstrJoinDomainInitiator = CREATE_DRM_STRING( g_rgwchJoinDomainInitiator );

/* "LeaveDomain" */
const DRM_WCHAR g_rgwchLeaveDomainInitiator [] =
{
    ONE_WCHAR( 'L', '\0' ), ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 'a', '\0' ), ONE_WCHAR( 'v', '\0' ),
    ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 'D', '\0' ), ONE_WCHAR( 'o', '\0' ), ONE_WCHAR( 'm', '\0' ),
    ONE_WCHAR( 'a', '\0' ), ONE_WCHAR( 'i', '\0' ), ONE_WCHAR( 'n', '\0' ), ONE_WCHAR( '\0', '\0' )
};
const DRM_CONST_STRING g_dstrLeaveDomainInitiator = CREATE_DRM_STRING( g_rgwchLeaveDomainInitiator );

/* "LicenseAcquisition" */
const DRM_WCHAR g_rgwchLicenseAcquisitionInitiator [] =
{
    ONE_WCHAR( 'L', '\0' ), ONE_WCHAR( 'i', '\0' ), ONE_WCHAR( 'c', '\0' ), ONE_WCHAR( 'e', '\0' ),
    ONE_WCHAR( 'n', '\0' ), ONE_WCHAR( 's', '\0' ), ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 'A', '\0' ),
    ONE_WCHAR( 'c', '\0' ), ONE_WCHAR( 'q', '\0' ), ONE_WCHAR( 'u', '\0' ), ONE_WCHAR( 'i', '\0' ),
    ONE_WCHAR( 's', '\0' ), ONE_WCHAR( 'i', '\0' ), ONE_WCHAR( 't', '\0' ), ONE_WCHAR( 'i', '\0' ),
    ONE_WCHAR( 'o', '\0' ), ONE_WCHAR( 'n', '\0' ), ONE_WCHAR( '\0', '\0' )
};
const DRM_CONST_STRING g_dstrLicenseAcquisitionInitiator = CREATE_DRM_STRING( g_rgwchLicenseAcquisitionInitiator );

/* "CustomData" */
const DRM_WCHAR g_rgwchCustomDataInitiatorTag [] =
{
    ONE_WCHAR( 'C', '\0' ), ONE_WCHAR( 'u', '\0' ), ONE_WCHAR( 's', '\0' ), ONE_WCHAR( 't', '\0' ),
    ONE_WCHAR( 'o', '\0' ), ONE_WCHAR( 'm', '\0' ), ONE_WCHAR( 'D', '\0' ), ONE_WCHAR( 'a', '\0' ),
    ONE_WCHAR( 't', '\0' ), ONE_WCHAR( 'a', '\0' ), ONE_WCHAR( '\0', '\0' )
};
const DRM_CONST_STRING g_dstrCustomDataInitiatorTag = CREATE_DRM_STRING( g_rgwchCustomDataInitiatorTag );

/* "PlayReadyInitiator" */
const DRM_WCHAR g_rgwchPRInitiatorTag[] =  
{
    ONE_WCHAR( 'P', '\0' ), ONE_WCHAR( 'l', '\0' ), ONE_WCHAR( 'a', '\0' ), ONE_WCHAR( 'y', '\0' ),
    ONE_WCHAR( 'R', '\0' ), ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 'a', '\0' ), ONE_WCHAR( 'd', '\0' ),
    ONE_WCHAR( 'y', '\0' ), ONE_WCHAR( 'I', '\0' ), ONE_WCHAR( 'n', '\0' ), ONE_WCHAR( 'i', '\0' ),
    ONE_WCHAR( 't', '\0' ), ONE_WCHAR( 'i', '\0' ), ONE_WCHAR( 'a', '\0' ), ONE_WCHAR( 't', '\0' ),
    ONE_WCHAR( 'o', '\0' ), ONE_WCHAR( 'r', '\0' ), ONE_WCHAR( '\0', '\0' )
};
const DRM_CONST_STRING g_dstrPRInitiatorTag = CREATE_DRM_STRING( g_rgwchPRInitiatorTag );

/* "CertificateServer" */
const DRM_WCHAR g_rgwchCertificateServerTag [] =
{
    ONE_WCHAR( 'C', '\0' ), ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 'r', '\0' ), ONE_WCHAR( 't', '\0' ),
    ONE_WCHAR( 'i', '\0' ), ONE_WCHAR( 'f', '\0' ), ONE_WCHAR( 'i', '\0' ), ONE_WCHAR( 'c', '\0' ),
    ONE_WCHAR( 'a', '\0' ), ONE_WCHAR( 't', '\0' ), ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 'S', '\0' ),
    ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 'r', '\0' ), ONE_WCHAR( 'v', '\0' ), ONE_WCHAR( 'e', '\0' ),
...
/* "MeteringID" */
const DRM_WCHAR g_rgwchMeteringIDTag [] =
{
    ONE_WCHAR( 'M', '\0' ), ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 't', '\0' ), ONE_WCHAR( 'e', '\0' ),
    ONE_WCHAR( 'r', '\0' ), ONE_WCHAR( 'i', '\0' ), ONE_WCHAR( 'n', '\0' ), ONE_WCHAR( 'g', '\0' ),
...
/* "MaxPackets" */
const DRM_WCHAR g_rgwchMaxPacketsTag [] =
{
    ONE_WCHAR( 'M', '\0' ), ONE_WCHAR( 'a', '\0' ), ONE_WCHAR( 'x', '\0' ), ONE_WCHAR( 'P', '\0' ),
    ONE_WCHAR( 'a', '\0' ), ONE_WCHAR( 'c', '\0' ), ONE_WCHAR( 'k', '\0' ), ONE_WCHAR( 'e', '\0' ),
    ONE_WCHAR( 't', '\0' ), ONE_WCHAR( 's', '\0' ), ONE_WCHAR( '\0', '\0' )
};
const DRM_CONST_STRING g_dstrMaxPacketsTag = CREATE_DRM_STRING( g_rgwchMaxPacketsTag );

/* "DomainController" */
const DRM_WCHAR g_rgwchDomainControllerTag [] =
{
    ONE_WCHAR( 'D', '\0' ), ONE_WCHAR( 'o', '\0' ), ONE_WCHAR( 'm', '\0' ), ONE_WCHAR( 'a', '\0' ),
    ONE_WCHAR( 'i', '\0' ), ONE_WCHAR( 'n', '\0' ), ONE_WCHAR( 'C', '\0' ), ONE_WCHAR( 'o', '\0' ),
    ONE_WCHAR( 'n', '\0' ), ONE_WCHAR( 't', '\0' ), ONE_WCHAR( 'r', '\0' ), ONE_WCHAR( 'o', '\0' ),
    ONE_WCHAR( 'l', '\0' ), ONE_WCHAR( 'l', '\0' ), ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 'r', '\0' ),
    ONE_WCHAR( '\0', '\0' )
};
const DRM_CONST_STRING g_dstrDomainControllerTag = CREATE_DRM_STRING( g_rgwchDomainControllerTag );

/* "DS_ID" */
const DRM_WCHAR g_rgwchServiceIDTag [] =
{
    ONE_WCHAR( 'D', '\0' ), ONE_WCHAR( 'S', '\0' ), ONE_WCHAR( '_', '\0' ), ONE_WCHAR( 'I', '\0' ),
    ONE_WCHAR( 'D', '\0' ), ONE_WCHAR( '\0', '\0' )
};
const DRM_CONST_STRING g_dstrServiceIDTag = CREATE_DRM_STRING( g_rgwchServiceIDTag );

/* "AccountID" */
const DRM_WCHAR g_rgwchAccountIDTag [] =
{
    ONE_WCHAR( 'A', '\0' ), ONE_WCHAR( 'c', '\0' ), ONE_WCHAR( 'c', '\0' ), ONE_WCHAR( 'o', '\0' ),
    ONE_WCHAR( 'u', '\0' ), ONE_WCHAR( 'n', '\0' ), ONE_WCHAR( 't', '\0' ), ONE_WCHAR( 'I', '\0' ),
    ONE_WCHAR( 'D', '\0' ), ONE_WCHAR( '\0', '\0' )
};
const DRM_CONST_STRING g_dstrAccountIDTag = CREATE_DRM_STRING( g_rgwchAccountIDTag );

/* "Content" */
const DRM_WCHAR g_rgwchContentURLTag [] =
{
...
/* "Header" */
const DRM_WCHAR g_rgwchHeaderTag [] =
{
    ONE_WCHAR( 'H', '\0' ), ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 'a', '\0' ), ONE_WCHAR( 'd', '\0' ),
    ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 'r', '\0' ), ONE_WCHAR( '\0', '\0' )
};
const DRM_CONST_STRING g_dstrHeaderTag = CREATE_DRM_STRING( g_rgwchHeaderTag );

/* "WMConvert" */
const DRM_WCHAR g_rgwchWMConvertTag [] =
{
    ONE_WCHAR( 'W', '\0' ), ONE_WCHAR( 'M', '\0' ), ONE_WCHAR( 'C', '\0' ), ONE_WCHAR( 'o', '\0' ),
    ONE_WCHAR( 'n', '\0' ), ONE_WCHAR( 'v', '\0' ), ONE_WCHAR( 'e', '\0' ), ONE_WCHAR( 'r', '\0' ), 
    ...
    __out DRM_INIT_DOMAIN_DATA *f_poData )
{
    ...
    ** <DomainController>
    */    
    dr = DRM_XML_GetSubNodeByPath( (DRM_CONST_STRING*) f_pdstrXML,
...
static DRM_RESULT _ParseLicAcqInitiator(
    __in    DRM_CONST_STRING     *f_pdstrLicAcqXML,
    ...
    )
{
    ...
    dr = DRM_XML_GetSubNodeByPath( (DRM_CONST_STRING*) f_pdstrLicAcqXML,
                                    &g_dstrHeaderTag,
                                    NULL,
                                    NULL,
                                    NULL,
...
static DRM_RESULT _ParseMeteringInitiator(
    __in    DRM_CONST_STRING       *f_pdstrMeteringInitiatorXML,
    __inout DRM_INIT_METERING_DATA *f_poData )
{
    ...
    ** <CertificateServer>
    */    
    dr = DRM_XML_GetSubNodeByPath( (DRM_CONST_STRING*) f_pdstrMeteringInitiatorXML,
    ...
    __inout_opt DRM_INITIATOR_DATA          *f_poInitiatorData )
{
    ...
    */
    ...
    if ( DRM_UTL_DSTRStringsEqual( (DRM_CONST_STRING*)&dstrTagName, &g_dstrMeteringInitiator ) )
    {
        eType = DRM_INIT_METERING;
    }
    else if( DRM_UTL_DSTRStringsEqual( (DRM_CONST_STRING*)&dstrTagName, &g_dstrJoinDomainInitiator ) )
    {
        eType = DRM_INIT_JOINDOMAIN;
    }
    else if( DRM_UTL_DSTRStringsEqual( (DRM_CONST_STRING*)&dstrTagName, &g_dstrLeaveDomainInitiator ) )
    {
        eType = DRM_INIT_LEAVEDOMAIN;
    }
    else if( DRM_UTL_DSTRStringsEqual( (DRM_CONST_STRING*)&dstrTagName, &g_dstrLicenseAcquisitionInitiator ) )
    {
