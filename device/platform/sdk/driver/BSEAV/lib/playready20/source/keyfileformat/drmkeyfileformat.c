...
const static DRM_XB_ENTRY_DESCRIPTION s_kf3EntryDescriptions[KF3_ENTRY_TYPE_COUNT] =
{
    ...
    { KF_ENTRY_TYPE_SIGNATURE_OBJECT,                   XB_FLAGS_MUST_UNDERSTAND,                       XB_OBJECT_GLOBAL_HEADER,                FALSE, FALSE, XB_DECLARE_OFFSET_AND_SIZE      ( DRM_KEYFILE,      Signature        ), 17,       XB_USE_DESCRIPTOR(s_kfSignatureObject) },
};
...
const static DRM_XB_ENTRY_DESCRIPTION s_kf1HeaderEntryDescription =
{
    0, 0, 0,  FALSE, FALSE, DRM_OFFSET_OF( DRM_KEYFILE, HeaderExtra ),        SIZEOF(KF_HEADER_EXTRA_DATA_V1),       0,       XB_USE_DESCRIPTOR(s_kfHeaderExtraDataDescription),
                                                                 ...
                                                                 /* DWORD identifier                          version,                extra data */
const static DRM_XB_HEADER_DESCRIPTION s_kf1HeaderDescription = { XB_DEFINE_FORMAT_ID( 'P', 'R', 'K', 'F' ),  KEYFILE_VERSION_1,      DRM_OFFSET_OF(KF_HEADER_EXTRA_DATA_V1,dwLength), &s_kf1HeaderEntryDescription };
const static DRM_XB_HEADER_DESCRIPTION s_kf2HeaderDescription = { XB_DEFINE_FORMAT_ID( 'P', 'R', 'K', 'F' ),  KEYFILE_VERSION_2,      NULL,                                             0 };
const static DRM_XB_HEADER_DESCRIPTION s_kf3HeaderDescription = { XB_DEFINE_FORMAT_ID( 'P', 'R', 'K', 'F' ),  KEYFILE_VERSION_3,      NULL,                                             0 };
...
const static DRM_XB_HEADER_DESCRIPTION s_ad1HeaderDescription = { XB_DEFINE_FORMAT_ID( 'P', 'R', 'A', 'D' ),  ACTIVATION_DATA_VERSION_1, NULL, 0 };
...
{
    DRM_RESULT dr = DRM_SUCCESS;
    DRM_XB_BUILDER_CONTEXT_INTERNAL *pbuilderInternal =
...
DRM_RESULT _ValidateKeyFileAssumptions(
...
DRM_RESULT _PerformVersionFixups(
                                 __in                             DRM_KEYFILE             *f_pKeyFile )
{
    if( f_pKeyFile->dwVersion == KEYFILE_VERSION_1 )
    {
