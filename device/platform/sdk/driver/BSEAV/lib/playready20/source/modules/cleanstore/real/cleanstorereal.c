    ...
    __inout_ecount_opt( 1 )     DRM_CLEANUP_CALLBACK_INFO   *f_pCleanupCallback )
{
    ...
    DRM_REMOVAL_DATE_ENTRY  *pLicenseToRemove      = NULL;
        ...
        */
        if ( dwRemovalDate <= f_dwRemovalDate )
        {
            ...
            */
            ...
            {
                pLicenseToRemove = (DRM_REMOVAL_DATE_ENTRY*) &f_pbBuffer[ dwIdx * SIZEOF( DRM_REMOVAL_DATE_ENTRY ) ];
                ...
                rgLicensesToRemove[cLicensesToRemove].oKID      = KID;
                rgLicensesToRemove[cLicensesToRemove].oLID      = pLicenseToRemove->lid;
