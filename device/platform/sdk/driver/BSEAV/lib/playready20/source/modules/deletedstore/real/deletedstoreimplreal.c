...
static DRM_RESULT DRM_CALL DRM_RCX_OpenStore(
    IN  DRM_DST                         *f_pDataStoreIn,
    OUT DRM_RECENTEXPIRED_CONTEXT       *f_pcontextRCX )
{
...
static DRM_RESULT DRM_CALL DRM_RCX_CloseStore(
    IN  DRM_RECENTEXPIRED_CONTEXT       *f_pcontextRCX )
{
    DRM_RECENTEXPIRED_CONTEXT_PRIVATE *pcontextRCX = (DRM_RECENTEXPIRED_CONTEXT_PRIVATE *) f_pcontextRCX;
    DRM_RESULT  dr = DRM_SUCCESS;
...
/**********************************************************************
** Function: DRM_RCX_GetKIDStoreData
**
...
static DRM_RESULT DRM_CALL DRM_RCX_GetKIDStoreData(
    IN       DRM_RECENTEXPIRED_CONTEXT      *f_pcontextRCX,
    IN const DRM_KID                        *f_pkid,
       OUT   DRM_RECENTEXPIRED_DATA         *f_pdata)
{
    DRM_RECENTEXPIRED_CONTEXT_PRIVATE *pcontextRCX = (DRM_RECENTEXPIRED_CONTEXT_PRIVATE*) f_pcontextRCX;
...
ErrorExit:
    ...
    return dr;
} /* DRM_RCX_GetKIDStoreData */

/**********************************************************************
** Function: DRM_RCX_SetKIDStoreData
**
...
static DRM_RESULT DRM_CALL DRM_RCX_SetKIDStoreData(
    IN       DRM_RECENTEXPIRED_CONTEXT      *f_pcontextRCX,
    IN const DRM_KID                        *f_pkid,
    IN const DRM_RECENTEXPIRED_DATA         *f_pdata,
...
ErrorExit:
    ...
    return dr;
} /* DRM_RCX_SetKIDStoreData */

/*********************************************************************
** Function: DRM_RCX_DeleteKID
**
...
static DRM_RESULT DRM_CALL DRM_RCX_DeleteKID(
    IN       DRM_RECENTEXPIRED_CONTEXT *f_pcontextRCX,
    IN const DRM_KID                   *f_pkid )
{
    DRM_RESULT dr = DRM_SUCCESS;
...
DRM_API DRM_RESULT DRM_CALL DRM_DELETEDSTORE_UpdateRecentExpired(
    ...
    IN       DRM_KID            *pKID ) DRM_NO_INLINE_ATTRIBUTE;
