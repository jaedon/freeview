...
static DRM_NO_INLINE DRM_RESULT DRM_CALL _ParseJoinDomainChallengeQueryData(
    ...
    IN     const DRM_BYTE        *f_pbChallenge )
{
    DRM_RESULT dr = DRM_SUCCESS;
...
static DRM_NO_INLINE DRM_RESULT _DomainStore_SetAndGetDomainSavedDateTime(
    ...
    IN                                 const DRM_UINT64              *f_pui64GlobalSavedTime,
    OUT                                      DRM_UINT64              *f_pui64SavedTime )
{
    DRM_RESULT                       dr                                                 = DRM_SUCCESS;
    ...
    ChkBOOL( token.TokenType == TOKEN_DATETIME, DRM_E_WRONGTOKENTYPE );
    ...
    __out   DRM_BOOL            *f_pfDisabled )
{
    CLAW_AUTO_RANDOM_CIPHER
    DRM_RESULT         dr               = DRM_SUCCESS;
    DRM_XMR_DOMAIN_ID *pLicenseDomainId = NULL;
