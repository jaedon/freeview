    ...
    __out       DRM_EST_SLOT_CONTEXT      *f_pContextSlot )
{
    ...
    */
    ...
    ChkBOOL( f_pContextEST->m_cbUnused >=
             PADDED_LEN(f_cbSize) + DRM_EST_SLOTHEADER_LEN, DRM_E_DSTSTOREFULL );
    ...
    __in     DRM_DWORD              f_cbSize )
{
    ...
    poESTContext->m_ibUnused = ( DRM_LONG )poESTContext->m_ibUnused + nPaddedDiff;
    poESTContext->m_cbUnused = ( DRM_LONG )poESTContext->m_cbUnused - nPaddedDiff;
    DRMASSERT( poESTContext->m_ibUnused + poESTContext->m_cbUnused ==
               poESTContext->m_cbEmbeddedStore );
