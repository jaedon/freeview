    ...
    __in                      const DRM_DWORD f_cbResponse )
{
    ...
    ChkDR( f_pbResponse != NULL );
    ChkDR( f_cbResponse > 0 );
...
**                          DRM_E_DEVCERTEXCEEDSIZELIMIT if the device cert is too big.
    ...
    __inout                             DRM_DWORD         *f_pcbChallenge )
{
    ...
    */
    ...
    else
    {
        ...
        ChkBOOL( cbDeviceCert < cbLicenseBuffer, DRM_E_DEVCERTEXCEEDSIZELIMIT );
