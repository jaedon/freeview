...
static DRM_NO_INLINE DRM_BOOL DRM_CALL _IsCachedEvent(
    ...
    OUT       DRM_LONG         *f_piEvent ) DRM_NO_INLINE_ATTRIBUTE;
...
static DRM_NO_INLINE DRM_RESULT DRM_CALL _Eval(
    ...
    OUT      DRM_BOOL            *f_pfExisted ) DRM_NO_INLINE_ATTRIBUTE;
                                                ...
                                                1 ) ) )
        {
            ...
            */
                                                          ...
                                                          &dstrVerifiedCk ) ) )
            {
                ...
                ChkDR( DRM_UTL_StringToGuid( &dstrVerifiedCk, &oVerifiedCKGuid ) );
    ...
    else
    {
        ...
        */
          ...
          || ( eStatus == DRM_SYMMOPT_STATUS_PARTIAL && !f_fVerifiedCk ) )
        {
            ...
            ChkBOOL( f_pslk == NULL, DRM_E_INVALIDLICENSE );
            goto ErrorExit;
        }
    ...
    __in_opt const DRM_SLK             *f_pslk )
{
    ...
    */
    ...
    dr = DRM_WMDRM_LIC_GetAttribute( (DRM_CONST_STRING*)f_pdstrLicense,
                                      NULL,
