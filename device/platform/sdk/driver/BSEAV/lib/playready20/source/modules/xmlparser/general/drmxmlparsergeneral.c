...
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_XML_GetNodeA(
    ...
    __in                                                     const DRM_ANSI_CONST_STRING *f_pdasstrAttrValue,
    __in                                                     const DRM_DWORD              f_iNode,               /* nth occurence of the node in the xml stirng, start from 0 */
    __out                                                          DRM_SUBSTRING         *f_pdasstrXmlNode,      /* either of these 2 parameter can be NULL but not both */
    __out                                                          DRM_SUBSTRING         *f_pdasstrXmlNodeData ) /* data enclosed by the immediate <tag>...</tag> in the given XML string */
{
...
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_XML_GetSubNodeA(
    ...
    __in                                                     const DRM_ANSI_CONST_STRING *f_pdasstrAttrValue,
    __in                                                     const DRM_DWORD              f_iNode,           /* nth occurence of the node in the xml stirng, start from 0 */
    __out                                                          DRM_SUBSTRING         *f_pdasstrNode,     /* these two parameters can either be NULL but not both */
    __out                                                          DRM_SUBSTRING         *f_pdasstrNodeData,
    __in                                                           DRM_DWORD              f_iLayer )         /* outermost layer is 0 */
{
    DRM_RESULT    dr        = DRM_SUCCESS;
...
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_XML_GetSubNodeByPath(
    ...
    __out      DRM_CONST_STRING *f_pdstrXMLNodeOut,
    __out      DRM_CONST_STRING *f_pdstrXMLDataOut,
...
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_XML_EnumNextNodeA(
    ...
    __out                                                          DRM_SUBSTRING *f_pdasstr1stAttrName,    /* optional */
    __out                                                          DRM_SUBSTRING *f_pdasstr1stAttrValue )  /* set to TRUE of the returned node is a leaf node */
{
    DRM_RESULT    dr = DRM_E_NOXMLOPENTAG;
...
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_XML_CountMatchingNodesA(
    __in_ecount( f_pdasstrXML->m_ich + f_pdasstrXML->m_cch ) const DRM_CHAR              *f_pszBase,
    __in                                                     const DRM_SUBSTRING         *f_pdasstrXML,
    __in                                                     const DRM_ANSI_CONST_STRING *f_pdastrTag,          /* optional */
    __in                                                     const DRM_ANSI_CONST_STRING *f_pdastr1stAttrName,  /* optional */
    __in                                                     const DRM_ANSI_CONST_STRING *f_pdastr1stAttrValue, /* optional */
