...
**          DRM_E_FILEREADERROR        -- If there is a problem reading the file
**
**********************************************************************/
static DRM_RESULT _ReadASFObjectBasicInfo( IN OUT DRM_TOOLS_ASF_CONTEXT *f_poAsfContext )
{
...
**
**********************************************************************/
static DRM_RESULT _SkipData( IN OUT DRM_TOOLS_ASF_CONTEXT *f_poAsfContext, IN DRM_UINT64 f_qwSkip )
{
    DRM_RESULT      dr               = DRM_SUCCESS;
    ...
    */
    ...
    {
        ChkBOOL( Oem_File_SetFilePointer( f_poAsfContext->hFileIn, LONG_MAX, OEM_FILE_CURRENT, NULL ), DRM_E_FILEREADERROR );
    ...
    ChkBOOL( Oem_File_SetFilePointer( f_poAsfContext->hFileIn, DRM_UI64Low32( f_qwSkip ), OEM_FILE_CURRENT, NULL ), DRM_E_FILEREADERROR );
...
**
**********************************************************************/
static DRM_RESULT _SkipASFObject( IN OUT DRM_TOOLS_ASF_CONTEXT *f_poAsfContext )
{
    DRM_RESULT      dr               = DRM_SUCCESS;
...
**
**********************************************************************/
static DRM_RESULT _ReadASFHeaderObjectInExtension( IN OUT DRM_TOOLS_ASF_CONTEXT *f_poAsfContext )
{
    DRM_RESULT          dr              = DRM_SUCCESS;
...
**
**********************************************************************/
static DRM_RESULT _ReadASFHeaderExtensionObject( IN OUT DRM_TOOLS_ASF_CONTEXT *f_poAsfContext )
{
    DRM_RESULT          dr              = DRM_SUCCESS;
    DRM_DWORD           cbRead          = 0;
...
**
**********************************************************************/
static DRM_RESULT _ReadASFContentEncryptionObject( IN OUT DRM_TOOLS_ASF_CONTEXT *f_poAsfContext )
{
    DRM_RESULT          dr                   = DRM_SUCCESS;
    DRM_DWORD           cbRead               = 0;
...
**
**********************************************************************/
static DRM_RESULT _ReadASFFilePropertiesObject( IN OUT DRM_TOOLS_ASF_CONTEXT *f_poAsfContext )
{
    DRM_RESULT          dr                  = DRM_SUCCESS;
    DRM_DWORD           cbRead              = 0;
...
static DRM_RESULT _ReadASFStreamPropertiesObject( IN OUT DRM_TOOLS_ASF_CONTEXT *f_poAsfContext )
{
    DRM_RESULT dr                    = DRM_SUCCESS;
    ...
    */
    ...
    {
        f_poAsfContext->rgoEncryptedStreams[f_poAsfContext->dwNumEncryptedStreams].bStreamID = ( wFlags & wMaxStreamNumber );
    ...
    __in                                DRM_DWORD              f_cbDRMHeaderData )
{
    ...
    else if ( MEMCMP( &(f_poAsfContext->guidCurObjectID), &(g_guidASFV4ContentEncryptionObject), SIZEOF( DRM_GUID ) ) == 0 )
    {
        if ( f_poAsfContext->fVerbose )
        {
