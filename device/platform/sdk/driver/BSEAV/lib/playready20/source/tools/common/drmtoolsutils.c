    ...
    __in                             DRM_DWORD                          f_cbPrivKey )
{
    ...
    DRM_BYTE         rgbBuffer3[__CB_DECL( OAEP_CB_ENCRYPTED_MSG_MAX )]         = { 0 };
    ...
    */
    ...
    case eDRM_RSA:
        ...
        cbClear     = DRM_RSA_CB_MAX_PLAINTEXT_MAX;
        cbSignature = DRM_RSA_CB_MODULUS_MAX;
        break;
    default:
        ChkArg( FALSE );
    }
    ...
    __out       DRM_DWORD           *f_cbData )
{
    ...
    ChkBOOL( cbFile != 0, DRM_E_FILEREADERROR );
...
**          DRM_E_FILEWRITEERROR       -- If there is a problem writing to the file
**
**********************************************************************/
    ...
    IN DRM_RESULT dr )
{
    ...
    case DRM_E_LICENSEEXPIRED:
        printf( "DRM_E_LICENSEEXPIRED : License expired 0x%X\n", (DRM_DWORD)dr );
        break;
    ...
    case DRM_E_NO_CLK_SUPPORTED:
        ...
        break;
    case DRM_E_RIGHTSNOTAVAILABLE:
        printf( "DRM_E_RIGHTSNOTAVAILABLE : The rights the app has requested are not available in the license  0x%X\n", (DRM_DWORD)dr );
        break;
    case DRM_E_HEADER_NOT_SET:
        printf( "DRM_E_HEADER_NOT_SET : A v2 content header is not set 0x%X\n", (DRM_DWORD)dr );
        break;
    case DRM_E_CONDITIONNOTSUPPORTED:
        printf( "DRM_E_CONDITIONNOTSUPPORTED : A condition in the license is not supported by this verison of DRM 0x%X\n", (DRM_DWORD)dr );
        break;
    case DRM_E_INVALIDLICENSE:
        printf( "DRM_E_INVALIDLICENSE : The license is invalid 0x%X\n", (DRM_DWORD)dr );
        break;
    case DRM_E_LICENSENOTFOUND:
        printf( "DRM_E_LICENSENOTFOUND : No license found 0x%X\n", (DRM_DWORD)dr );
        break;
...
{
    DRM_RESULT dr = DRM_SUCCESS;
    DRM_PLAY_OPL_EX *oplPlay = NULL;
    DRM_COPY_OPL *oplCopy = NULL;
    ...
    switch( f_dwCallbackType )
    {
        case DRM_PLAY_OPL_CALLBACK:
            ...
            oplPlay = (DRM_PLAY_OPL_EX*)f_pvPolicyCallbackData;
        ...
        case DRM_COPY_OPL_CALLBACK:
            ...
            ChkArg( f_pvPolicyCallbackData != NULL );
            oplCopy = (DRM_COPY_OPL*)f_pvPolicyCallbackData;
        ...
        case DRM_EXTENDED_RESTRICTION_QUERY_CALLBACK:
            {
                DRM_EXTENDED_RESTRICTION_CALLBACK_STRUCT *pExtCallback = (DRM_EXTENDED_RESTRICTION_CALLBACK_STRUCT*)f_pvPolicyCallbackData;
                DRM_DWORD i = 0;
