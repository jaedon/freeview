...
static DRM_VOID _PrintUsage(
    IN const DRM_WCHAR * f_pwszAppName )
{
...
**
**********************************************************************/
static DRM_RESULT _VerifyHeader( IN DRM_BYTE          *pbXMLHeader,
                                 IN DRM_DWORD         cbXMLHeader,
                                 IN DRM_BOOL          fIsV4,
                                 IN DRM_BOOL          fVerbose )
{
    ...
    dstrHeader.pwszString = (DRM_WCHAR *)pbXMLHeader;
...
**
**********************************************************************/
static DRM_RESULT _CheckForLicenses( IN OUT DRM_ASFVERIFYCONTEXT *poToolContext )
{
...
**
**********************************************************************/
static DRM_RESULT _ReadProtectedContent( IN DRM_CONST_STRING *f_pdstrContentFile,
                                         IN OUT DRM_ASFVERIFYCONTEXT *poToolContext )
{
    DRM_RESULT          dr                 = DRM_SUCCESS;
