    ...
    if ( argc < 2 || argv[1] != NULL )
    {
        ...
        if ( argc > 1 && strncmp( argv[1], "NORMAL", 6 ) != 0 )
        {
            ...
            */
            ...
            {
                TST_UTL_mbstowcs( ( DRM_WCHAR * )pbStoreData, argv[1], *pcbStoreData + 1 );
            }
            else
            {
...
DRM_RESULT DRM_CALL TestDatastoreOpenNamespace ( long argc, __in_ecount( argc ) char **argv )
{
    ...
    */
    if ( argv[0] != NULL )
    {
        MEMCPY( &oNS, argv[0], min( ( DRM_DWORD )strlen( argv[0] ), SIZEOF( DRM_DST_NAMESPACE ) ) );
        poNS = &oNS;
    }
...
DRM_RESULT DRM_CALL TestDatastoreOpenSlot ( long argc, __in_ecount( argc ) char **argv )
{
    ...
    */
    if ( argc > 3 )
    {
        ...
        {
            pKey1 = &oKey1;
            MEMCPY( pKey1, argv[3], min( ( DRM_DWORD )strlen( argv[3] ), SIZEOF( DRM_DST_KEY ) ) );
        }
    }
    ...
    */
    if ( argc > 4 )
    {
        ...
        {
            pKey2 = &oKey2;
            MEMCPY( pKey2, argv[4], min( ( DRM_DWORD )strlen( argv[4] ), SIZEOF( DRM_DST_KEY ) ) );
        }
    }
...
DRM_RESULT DRM_CALL TestDatastoreDeleteSlot ( long argc, __in_ecount( argc ) char **argv )
{
    ...
    */
    if ( argc > 2 )
    {
        ...
        {
            pKey1 = &oKey1;
            MEMCPY( pKey1, argv[2], min( ( DRM_DWORD )strlen( argv[2] ), SIZEOF( DRM_DST_KEY ) ) );
        }
    }
    ...
    */
    if ( argc > 3 )
    {
        ...
        {
            pKey2 = &oKey2;
            MEMCPY( pKey2, argv[3], min( ( DRM_DWORD )strlen( argv[3] ), SIZEOF( DRM_DST_KEY ) ) );
        }
    }
...
DRM_RESULT DRM_CALL TestDatastoreSlotEnumNext ( long argc, __in_ecount( argc ) char **argv )
{
    ...
    */
    ...
    {
        MEMCPY( &oKey1Expected, argv[3], min( ( DRM_DWORD )strlen( argv[3] ), SIZEOF( DRM_DST_KEY ) ) );
    }
    ...
    */
    ...
    {
        MEMCPY( &oKey2Expected, argv[4], min( ( DRM_DWORD )strlen( argv[4] ), SIZEOF( DRM_DST_KEY ) ) );
    }
...
DRM_RESULT DRM_CALL TestDatastoreSlotRead ( long argc, __in_ecount( argc ) char **argv )
{
    ...
    */
    if ( argc > 1 && argv[1] != NULL )
    {
        cbData = min( cbData, ( DRM_DWORD )strtoul( argv[1], NULL, 0 ) );
    }
...
DRM_RESULT DRM_CALL TestDatastoreCheckESTDirtyBit( long argc, __in_ecount(argc) char **argv )
{
    ...
    pEST = (DRM_EST_CONTEXT *) pDST->poContextDST;
