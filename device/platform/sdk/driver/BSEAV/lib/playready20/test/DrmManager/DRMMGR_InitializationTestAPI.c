...
DRM_RESULT DRM_CALL TestManagerReinitialize( long argc, __in_ecount( argc ) char **argv )
{
    ...
    if( fDoReset || 0 == strncmp( argv[0], "AppContext", 10 ) )
    {
        ...
        */
        ...
        ChkDR( Drm_GetOpaqueBuffer( poManagerContext, &pbOpaqueBuffer ) );
    ...
    if( fDoReset || 0 == strncmp( argv[0], "DecryptContext", 14 )  )
    {
        ...
        /*
        ** Zero out shared decrypt context
        */
        MEMSET( poDecryptContext, 0, SIZEOF( DRM_DECRYPT_CONTEXT ) );
    }
...
DRM_RESULT DRM_CALL TestManagerInitialize( long argc, __in_ecount( argc ) char **argv )
{
    ...
    if ( argv[0] == NULL )
    {
        ...
        */
        poManagerContext = NULL;
           ...
           && argv[1] != NULL )
    {
        ChkBOOL( DRMCRT_strlen( argv[1] ) < NO_OF( rgwcDevCert ), DRM_E_BUFFERTOOSMALL );
        ...
        */
        ChkDR( DRM_STR_UTF8toUTF16( ( DRM_CHAR* )( argv[1] ), 0, DRMCRT_strlen( argv[1] ), ( DRM_WCHAR * )dstrDevCert.pwszString, &dstrDevCert.cchString ) );
      ...
      && argv[2] != NULL )
    {
        ...
        ** Convert to UTF-16 (DRM string)
        */
        ChkDR( DRM_STR_UTF8toUTF16( ( DRM_CHAR* ) argv[2], 0, DRMCRT_strlen( argv[2] ), ( DRM_WCHAR * )dstrGroupCert.pwszString, &dstrGroupCert.cchString ) );
        ...
        ** Convert to UTF-16 (DRM string)
        */
        ChkDR( DRM_STR_UTF8toUTF16( ( DRM_CHAR* ) argv[3], 0, DRMCRT_strlen( argv[3] ), ( DRM_WCHAR * )dstrZGPriv.pwszString, &dstrZGPriv.cchString ) );
      ...
      && argv[4] != NULL )
    {
        ...
        ** Convert to UTF-16 (DRM string)
        */
        ChkDR( DRM_STR_UTF8toUTF16( ( DRM_CHAR* ) argv[4], 0, DRMCRT_strlen( argv[4] ), ( DRM_WCHAR * )dstrGroupCert.pwszString, &dstrGroupCert.cchString ) );
        dstrGroupCert.cchString--; /* remove NULL terminator */
        ...
        ** Convert to UTF-16 (DRM string)
        */
        ChkDR( DRM_STR_UTF8toUTF16( ( DRM_CHAR* ) argv[5], 0, DRMCRT_strlen( argv[5] ), ( DRM_WCHAR * )dstrZGPriv.pwszString, &dstrZGPriv.cchString ) );
        dstrZGPriv.cchString--; /* remove NULL terminator */
        ...
        && argv[7] != NULL )
    {
        ...
        */
        ...
        ChkBOOL( DRMCRT_strlen( argv[7] ) < NO_OF( rgwcKeyfile ), DRM_E_BUFFERTOOSMALL );
        ...
        ** Convert to UTF-16 (DRM string)
        */
        ChkDR( DRM_STR_UTF8toUTF16( ( DRM_CHAR* ) argv[7], 0, DRMCRT_strlen( argv[7] ), ( DRM_WCHAR * )dstrKeyfile.pwszString, &dstrKeyfile.cchString ) );
