...
DRM_BOOL DRM_CALL tFileTimeToDWORD(
    IN DRMFILETIME *f_pfiletime,
    OUT DRM_DWORD  *f_pdwTime );
...
DRM_RESULT DRM_CALL CalculateCheckSum(DRM_BYTE *pbData, DRM_DWORD cbData, DRM_BYTE *pCheckSum, DRM_DWORD cbCheckSum, DRM_KID *pKID);
...
DRM_LONG DRM_CALL TST_UTL_CompareSystemTime(
    __in DRMSYSTEMTIME *f_pLeftTime,
...
DRM_RESULT DRM_CALL TST_UTL_CopyFileToDRMDirectoryA( __in_z DRM_CHAR *f_szFile );
DRM_RESULT DRM_CALL TST_UTL_CopyFileFromDRMDirectoryA( __in_z DRM_CHAR *f_szFile );
