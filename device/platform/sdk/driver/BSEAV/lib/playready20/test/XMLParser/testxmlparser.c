...
DRM_RESULT DRM_CALL TestXMLPUtilGetXMLNode(long argc, __in_ecount(argc) char **argv)
{
    ...
    if(argv[2]!=NULL){
         TST_UTL_mbstowcs(szArrayXMLTag, argv[2], strlen(argv[2])+1);
    ...
    if(argv[4]!=NULL){
         TST_UTL_mbstowcs(szArrayAttrName, argv[4], strlen(argv[4])+1);
    ...
    if(argv[6]!=NULL){
         TST_UTL_mbstowcs(szArrayAttrValue, argv[6], strlen(argv[6])+1);
...
DRM_RESULT DRM_CALL TestXMLPUtilGetXMLNodeAttribute(long argc, __in_ecount(argc) char **argv)
{
    ...
    if(iOption&4){
        ...
        if(argv[0]!=NULL){
            if(strcmp(argv[0], "nullstring")){
                    TST_UTL_mbstowcs(szArrayXMLNode, argv[0], strlen(argv[0])+1);
                 g_dstrXMLNode.pwszString=szArrayXMLNode;
                g_dstrXMLNode.cchString=(DRM_DWORD)DRMCRT_wcslen(szArrayXMLNode);
            }
         }
        else
            iNodeNullFlag=1;
    ...
    if(argv[2]!=NULL){
        if(strcmp(argv[2], "nullstring")){ 
            TST_UTL_mbstowcs(szArrayAttrName, argv[2], strlen(argv[2])+1);
            szAttrName.pwszString=szArrayAttrName;
        }
    }
    else{
    ...
    if(argv[4]!=NULL){
         TST_UTL_mbstowcs(szArrayAttrValue, argv[4], strlen(argv[4])+1);
        szAttrValue.pwszString=szArrayAttrValue;
    }
    else{
    ...
    if(argv[6]!=NULL){
        TST_UTL_mbstowcs(szVerifyArrayAttrValue, argv[6], strlen(argv[6])+1);
...
DRM_RESULT DRM_CALL TestXMLPUtilGetXMLNodeA(long argc, __in_ecount(argc) char **argv)
{
    ...
    if(argv[2]!=NULL){
         memcpy(szArrayXMLTag, argv[2], min( strlen(argv[2])+1, SIZEOF( szArrayXMLTag ) ) );
    ...
    if(argv[4]!=NULL){
         memcpy(szArrayAttrName, argv[4], min( strlen(argv[4])+1, SIZEOF( szArrayAttrName ) ) );
    ...
    if(argv[6]!=NULL){
         memcpy(szArrayAttrValue, argv[6], min( strlen(argv[6])+1, SIZEOF( szArrayAttrValue ) ) );
...
DRM_RESULT DRM_CALL TestXMLPUtilGetXMLNodeAttributeA(long argc, __in_ecount(argc) char **argv)
{
    ...
    if(iOption&4){
        ...
        if(argv[0])
        {
            g_dastrXML.cchString = ( DRM_DWORD ) min( SIZEOF( szArrayXMLNode ) - 1, strlen( argv[0] ) );
...
#pragma prefast(pop)
    ...
    if(argv[2])
    {   
        DRM_DWORD cAttr = ( DRM_DWORD ) min( SIZEOF( szArrayAttrName ) - 1, strlen( argv[2] ) );
...
#pragma prefast(pop)
    ...
    if(argv[6]){
        ChkArg(szAttrValue.m_cch == strlen(argv[6]));
...
DRM_RESULT DRM_CALL TestXMLPUtilGetXMLNodeCData(long argc, __in_ecount(argc) char **argv)
{
    ...
    if(argv[2]!=NULL){
         TST_UTL_mbstowcs(szArrayCData, argv[2], strlen(argv[2])+1);
    ...
    /*verify the CData*/
    if(argv[4]!=NULL){
        TST_UTL_mbstowcs(szVerifyArrayCData, argv[4], strlen(argv[4])+1);
    ...
    __in_ecount(argc) char **argv )
{
    ...
    if ( iOption & 4 )
    {
        ...
        if( argv[0] != NULL )
        {
            if( strcmp( argv[0], "nullstring" ) )
            {
                g_dastrXML.cchString = ( DRM_DWORD ) min( SIZEOF( szXMLData ) - 1, strlen( argv[0] ) );
...
#pragma prefast(pop)
                ...
                g_dasstrNode.m_ich = 0;
                g_dasstrNode.m_cch = ( DRM_DWORD ) strlen( argv[0] );
    ...
    */
    if ( argv[4] != NULL )
    {
        DRM_DWORD cVerifyString = ( DRM_DWORD ) min( strlen( argv[4] ), SIZEOF( szVerifyArrayCData ) - 1 );
...

{
    ...
    if ( strcmp( argv[0], "nullstring" ) )
    {
        ChkArg( strlen( argv[0] ) + 1 <= NO_OF( wszXMLData ) );
        TST_UTL_mbstowcs( wszXMLData, argv[0], strlen( argv[0]) + 1 );
        g_dstrXML.pwszString = wszXMLData;
        g_dstrXML.cchString = (DRM_DWORD)DRMCRT_wcslen( wszXMLData );
    }
    else
    {
    ...
    iLevel =(long)atol(argv[1]);
    
    if ( strcmp( argv[2], "nullstring" ) )
    {
        ChkArg( strlen( argv[2] ) + 1 <= NO_OF( wszTagName ) );
        TST_UTL_mbstowcs( wszTagName, argv[2], strlen( argv[2] ) + 1 );
        dstrExpectedTagName.pwszString = wszTagName;
        dstrExpectedTagName.cchString = (DRM_DWORD)DRMCRT_wcslen( wszTagName );
    }
    else
    {
    ...
    {
        ChkArg( strlen( argv[3] ) + 1 <= NO_OF( wszNodeData ) );
        TST_UTL_mbstowcs( wszNodeData, argv[3], strlen( argv[3] ) + 1 );
        g_dstrXMLNodeData.pwszString = wszNodeData;
        g_dstrXMLNodeData.cchString = (DRM_DWORD)DRMCRT_wcslen( wszNodeData );
    }
    else
    {
    ...
    {
        ChkArg( strlen( argv[4] ) + 1 <= NO_OF( wszAttrName ) );
        TST_UTL_mbstowcs( wszAttrName, argv[4], strlen( argv[4] ) + 1 );
        dstrExpectedAttrName.pwszString = wszAttrName;
        dstrExpectedAttrName.cchString = (DRM_DWORD)DRMCRT_wcslen( wszAttrName );
    }
    else
    {
    ...
    {
        ChkArg( strlen( argv[5] ) + 1 <= NO_OF( wszAttrValue ) );
        TST_UTL_mbstowcs( wszAttrValue, argv[5], strlen( argv[5] ) + 1 );
        dstrExpectedAttrValue.pwszString = wszAttrValue;
        dstrExpectedAttrValue.cchString = (DRM_DWORD)DRMCRT_wcslen( wszAttrValue );
    }
    else
    {
                              ...
                              __in_ecount(argc) char **argv )
{
    ...
    */
    ...
    {
        ChkArg( strlen( argv[1] ) + 1 <= NO_OF( wszNodePath ) );
        TST_UTL_mbstowcs( wszNodePath, argv[1], strlen( argv[1]) + 1 );
        dstrNodePath.pwszString = wszNodePath;
        dstrNodePath.cchString = (DRM_DWORD)DRMCRT_wcslen( wszNodePath );
    }
    else 
    {
    ...
    if ( strcmp( argv[2], "nullstring" ) )
    {
        ChkArg( strlen( argv[2] ) + 1 <= NO_OF( wszAttrName ) );
        TST_UTL_mbstowcs( wszAttrName, argv[2], strlen( argv[2]) + 1 );
        dstrAttrName.pwszString = wszAttrName;
        dstrAttrName.cchString = (DRM_DWORD)DRMCRT_wcslen( wszAttrName );
    }
    else 
    {
    ...
    if ( strcmp( argv[3], "nullstring" ) )
    {
        ChkArg( strlen( argv[3] ) + 1 <= NO_OF( wszAttrValue ) );
        TST_UTL_mbstowcs( wszAttrValue, argv[3], strlen( argv[3]) + 1 );
        dstrAttrValue.pwszString = wszAttrValue;
        dstrAttrValue.cchString = (DRM_DWORD)DRMCRT_wcslen( wszAttrValue );
    }
    else 
    {
...
#pragma prefast(pop)
    ...
    if( strcmp( argv[1], "nullstring" ) )
    {
        dastrNodePath.cchString = ( DRM_DWORD ) min( SIZEOF( szNodePath ) - 1, strlen( argv[1] ) );
...
#pragma prefast(pop)
    ...
    if( strcmp( argv[2], "nullstring" ) )
    {
        dastrAttrName.cchString = ( DRM_DWORD ) min( SIZEOF( szAttrName ) - 1, strlen( argv[2] ) );
...
#pragma prefast(pop)
    ...
    if( strcmp( argv[3], "nullstring" ) )
    {
        dastrAttrValue.cchString = ( DRM_DWORD ) min( SIZEOF( szAttrValue ) - 1, strlen( argv[3] ) );
...
#pragma prefast(pop)
    ...
    */
    ...
    {
        DRM_DWORD cVerification = ( DRM_DWORD ) min( SIZEOF( szVerification ) - 1, strlen( argv[4] ) );
