...
static DRM_RESULT _ParseRSAPrivateKey(
    __in  DRM_CONST_STRING    *f_pdstrPrivateKey,
    __out DRM_RSA_PRIVATE_KEY *f_poPrivateKey )
{
    DRM_RESULT       dr                      = DRM_SUCCESS;
...
static DRM_RESULT _CreateCompanyTemplate(
    __in    DRM_ANSI_CONST_STRING  *f_pdastrSecurityLevel,
    __in    DRM_ANSI_CONST_STRING  *f_pdastrManufName,
    ...
    __in_ecount( argc ) char **argv )
{
    ...
    DRM_RSA_PRIVATE_KEY oRSACompanyPrivKey  = { 0 };
    DRM_RSA_PRIVATE_KEY oRSAModelPrivKey = { 0 };
    DRM_RSA_PUBLIC_KEY  oRSAModelPubKey  = { 0 };
    ...
    ChkDR( OEM_RSA_ParsePublicKey( &oRSAModelPubKey,
                                   NULL,
                                   NULL,
                                   NULL,
                                   &cbModulus,
    ...
    __in_ecount( argc ) char **argv )
{
    ...
    DRM_RSA_PRIVATE_KEY oRSARootPrivKey = { 0 };
    DRM_RSA_PRIVATE_KEY oRSACompanyPrivKey = { 0 };
    DRM_RSA_PUBLIC_KEY  oRSACompanyPubKey = { 0 };
    ...
    ChkDR( OEM_RSA_ParsePublicKey( &oRSACompanyPubKey,
                                   NULL,
                                   NULL,
                                   NULL,
                                   &cbModulus,
