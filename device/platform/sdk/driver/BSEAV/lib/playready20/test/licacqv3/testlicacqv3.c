...
DRM_ANSI_CONST_STRING g_dastrLicenseChallenge;
DRM_ANSI_CONST_STRING g_dastrLicenseAcknowledgement;
...
**
**********************************************************************/
DRM_RESULT DRM_CALL _GenerateLicAcqChallenge( IN DRM_CHAR *f_pszServiceID )
{
    DRM_RESULT dr = DRM_SUCCESS;
    DRM_BYTE *pbChallenge = NULL;
    DRM_DWORD cbChallenge = 0;
...
**/
    ...
    dastrDecryptXmlData.pszString = (DRM_CHAR *) pData;
...
**/
    ...
    dastrDecryptXmlData.pszString = (DRM_CHAR *) pbData;
...
**/
    ...
    ChkDR( TST_UTL_GetPlayReadyCert(pbCert, &cbCert, &cryptoCtx) );
...
DRM_RESULT DRM_CALL _GenerateAck( )
{
    ...
    g_dastrLicenseAcknowledgement.pszString = (DRM_CHAR*)pbChallenge;
    ...
    IN const char *strTCName )
{
    ...
    if( g_oBBContextLicAqV3.pKeyFileContext == NULL )
    {
        ...
        ChkDR( DRM_BBX_SetupSecureStoreKey( g_oBBContextLicAqV3.pKeyFileContext, NULL ) );
