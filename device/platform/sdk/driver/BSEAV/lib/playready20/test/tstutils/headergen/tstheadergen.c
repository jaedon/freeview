                                                    ...
                                                    __inout                         DRM_DWORD       *f_pcbPRO )
{
    ...
    if( f_dwTestParams == TEST_PRO_NoSpecialTestcases ) /* no special cases, create PRO with WRMHeader in it */
    {
        ...
        dstrHeader.pwszString = (DRM_WCHAR*)f_pbWRMHeader;
        ...
        {
            dr = DRM_PRO_Create( &dstrHeader, NULL, &dwPROSize );
        }
        ...
        ChkDR( DRM_PRO_Create( &dstrHeader, *f_ppbPRO, &dwPROSize ) );
...
**            f_pdstrLID    - string containing GUID for LID, see DRM_UTL_StringToGuid() for string format
                                                               ...
                                                               __in                          const DRM_DWORD   f_cbPROBuffer )
{
    ...
    ChkDR( DRM_UTL_StringToGuid( f_pdstrLID, ( DRM_GUID * )oLID.rgb ) );
    ...
    */
    ChkDR( DRM_DST_Init ( eDRM_DST_EMBEDDED, &oDSTContext, DRM_EST_CONTEXT_LEN, &oDatastoreEST ) );
