    ...
    )
{
    ...
    */
    ...
    if ( bRSAPrivateKey )
    {
        ChkMem( pbAesKey = (DRM_BYTE *)Oem_MemAlloc( __CB_DECL( DRM_RSA_CB_MAX_PLAINTEXT_MAX ) ) );
        cbAesKey = DRM_RSA_CB_MAX_PLAINTEXT_MAX;

        dr = OEM_RSA_OaepDecrypt((DRM_RSA_PRIVATE_KEY *)pbDecryptionKey,
...
_InternalDrmXmrUnpackLicense(
    IN DRM_BOOL bChainedLicense,
    IN DRM_BOOL bLeafLicense,
    IN XMR_ROOT_LICENSE_INFO *pRootLicenseInfo,
    IN DRM_BYTE *pbDecryptionKey,
    IN DRM_BYTE *Message,
    ...
    )
{
    ...
    return _InternalDrmXmrUnpackLicense(TRUE,
                                        TRUE,
                                        &XmrRootLicenseInfo,
                                        (DRM_BYTE *)XmrRootLicenseInfo.pAesContentKey,
                                        Message,
                                        MessageSize,
                                        ppXmrLicense);
