...
*/
DRM_RESULT DRM_CALL CalculateCheckSum( __in DRM_BYTE *pbData, __in DRM_DWORD cbData, __out DRM_BYTE *pbCheckSum, __in DRM_DWORD cbCheckSum, __in DRM_KID *pKID)
{
