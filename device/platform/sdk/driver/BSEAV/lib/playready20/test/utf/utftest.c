    ...
    IN __in_ecount(argc) char **argv )
{
    ...
    ChkBOOL( LoadTestFile( argv[0], argv[1], &pbBufferUTF8, &dwSizeUTF8 ), DRM_E_FILEREADERROR );

    dr = DRM_STR_UTF8toUTF16( (DRM_CHAR*)pbBufferUTF8, 0, dwSizeUTF8, NULL, &dwSizeUTF16 );
    if( dr != DRM_E_BUFFERTOOSMALL )
    {
        if( DRM_SUCCEEDED( dr ) ) 
        {
    ...
    ChkBOOL( SaveToFileW( dstrOutFilename.pwszString, (DRM_BYTE *)pwchBufferUTF16, (dwSizeUTF16-1) * SIZEOF(DRM_WCHAR) ), DRM_E_FILEWRITEERROR );
    ...
    IN __in_ecount(argc) char **argv )
{
    ...
    ChkBOOL( LoadTestFile( argv[0], argv[1], (DRM_BYTE**)&pwchBufferUTF16, &dwSizeUTF16 ), DRM_E_FILEREADERROR );
    ...
    ChkBOOL( SaveToFileW( dstrOutFilename.pwszString, pbBufferUTF8, dwSizeUTF8-1 ), DRM_E_FILEWRITEERROR );
    ...
    IN __in_ecount(argc) char **argv )
{
    ...
    ChkBOOL( SaveToFileW( dstrOutFilename.pwszString, (DRM_BYTE*)pwch32BufferUTF32, (dwSizeUTF32-1) * SIZEOF(DRM_WCHAR32) ), DRM_E_FILEWRITEERROR );
    ...
    IN __in_ecount(argc) char **argv )
{
    ...
    ChkBOOL( LoadTestFile( argv[0], argv[1], (DRM_BYTE**)&pwch32BufferUTF32, &dwSizeUTF32 ), DRM_E_FILEREADERROR );
    ...
    IN __in_ecount(argc) char **argv )
{
    ...
    ChkBOOL( LoadTestFile( argv[0], argv[1], &pbBuffer, &dwSize ), DRM_E_FILEREADERROR );
    ...
    ChkDR( TST_UTL_MakePathString( NULL, argv[2], &dstrOutFilename ) );
    /* Save the UTF16 string without NULL terminator*/
    ChkBOOL( SaveToFileW( dstrOutFilename.pwszString, (DRM_BYTE *)dstrUTF16_1.pwszString, dwSize * SIZEOF(DRM_WCHAR) ), DRM_E_FILEWRITEERROR );
    ...
    IN __in_ecount(argc) char **argv )
{
    ...
    ChkBOOL( LoadTestFile( argv[0], argv[1], (DRM_BYTE**)&pbBuffer1, &dwSize ), DRM_E_FILEREADERROR );
    ChkBOOL( dwSize % SIZEOF(DRM_WCHAR) == 0, DRM_E_FILEREADERROR ); 
    ...
    ChkBOOL( SaveToFileW( dstrOutFilename.pwszString, pbBuffer1, dwSize ), DRM_E_FILEWRITEERROR );
