...
#*
#* Note:
#*   ANY platform flag entry which IS met causes the dir to be built.
#*   Contrast this with how feature flags work in DrmFeatureComposeDirsTargets.mk.
#*   (i.e. ANY platform must be met)
#*
#*********************************************************************/
...
#==============================================================================
# Convert from SKIP/BUILD to PLATFORMSKIP/PLATFORMBUILD
#==============================================================================
_DRM_DIRS_TARGETS=$(_DRM_DIRS_TARGETS:TARGET.SKIP=TARGET.PLATFORMSKIP)
_DRM_DIRS_TARGETS=$(_DRM_DIRS_TARGETS:TARGET.BUILD=TARGET.PLATFORMBUILD)
