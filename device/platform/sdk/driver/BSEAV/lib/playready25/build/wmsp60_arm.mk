...
#
# This allows user to perform magic like DLLDEF_OBJECTS = lib\*\foo.lib and
...
#---------------------------------------------------
DLLDEF_OBJECTS=$(DLLDEF_OBJECTS:*=wmsp60_arm)
...
#   -NODEFAULTLIB:oldnames - Work around documented behavior in VS2005. The
#       oldnames.lib library does not exist for WinMobile, only desktop.
#       But, it is getting implicitly included in the build and
