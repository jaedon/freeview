...
const DRM_WCHAR g_rgwchRootTag                     [] = { WCHAR_CAST('P'), WCHAR_CAST('A'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('A'), WCHAR_CAST('G'), WCHAR_CAST('E'), WCHAR_CAST('P'), WCHAR_CAST('A'), WCHAR_CAST('R'), WCHAR_CAST('A'), WCHAR_CAST('M'), WCHAR_CAST('S'), WCHAR_CAST('\0')}; /* "PACKAGEPARAMS" */
const DRM_WCHAR g_rgwchKeySeedTag                  [] = { WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('S'), WCHAR_CAST('E'), WCHAR_CAST('E'), WCHAR_CAST('D'), WCHAR_CAST('\0')}; /* "KEYSEED" */
const DRM_WCHAR g_rgwchSigningKey                  [] = { WCHAR_CAST('S'), WCHAR_CAST('I'), WCHAR_CAST('G'), WCHAR_CAST('N'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('G'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "SIGNINGKEY" */
const DRM_WCHAR g_rgwchLaInfoTag                   [] = { WCHAR_CAST('L'), WCHAR_CAST('A'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('F'), WCHAR_CAST('O'), WCHAR_CAST('\0')}; /* "LAINFO" */
const DRM_WCHAR g_rgwchCustomData                  [] = { WCHAR_CAST('C'), WCHAR_CAST('U'), WCHAR_CAST('S'), WCHAR_CAST('T'), WCHAR_CAST('O'), WCHAR_CAST('M'), WCHAR_CAST('_'), WCHAR_CAST('D'), WCHAR_CAST('A'), WCHAR_CAST('T'), WCHAR_CAST('A'), WCHAR_CAST('\0')}; /* "CUSTOM_DATA" */
const DRM_WCHAR g_rgwchEncBlkSize                  [] = { WCHAR_CAST('B'), WCHAR_CAST('L'), WCHAR_CAST('O'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('S'), WCHAR_CAST('I'), WCHAR_CAST('Z'), WCHAR_CAST('E'), WCHAR_CAST('\0')}; /* "BLOCKSIZE" */
const DRM_WCHAR g_rgwchCID                         [] = { WCHAR_CAST('C'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('\0')}; /* "CID" */
const DRM_WCHAR g_rgwchVerifyKey                   [] = { WCHAR_CAST('V'), WCHAR_CAST('E'), WCHAR_CAST('R'), WCHAR_CAST('I'), WCHAR_CAST('F'), WCHAR_CAST('Y'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "VERIFYKEY" */
const DRM_WCHAR g_rgwchDefaultURL                  [] = { WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('t'), WCHAR_CAST('p'), WCHAR_CAST(':'), WCHAR_CAST('/'), WCHAR_CAST('/'), WCHAR_CAST('b'), WCHAR_CAST('a'), WCHAR_CAST('d'), WCHAR_CAST('.'), WCHAR_CAST('c'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('t'), WCHAR_CAST('o'), WCHAR_CAST('s'), WCHAR_CAST('o'), WCHAR_CAST('.'), WCHAR_CAST('c'), WCHAR_CAST('o'), WCHAR_CAST('m'), WCHAR_CAST('/'), WCHAR_CAST('g'), WCHAR_CAST('e'), WCHAR_CAST('t'), WCHAR_CAST('v'), WCHAR_CAST('2'), WCHAR_CAST('l'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('.'), WCHAR_CAST('a'), WCHAR_CAST('s'), WCHAR_CAST('p'), WCHAR_CAST('\0')}; /* "http://bad.contoso.com/getv2lic.asp" */
const DRM_WCHAR g_rgwchDefaultBlksize              [] = { WCHAR_CAST('2'), WCHAR_CAST('0'), WCHAR_CAST('4'), WCHAR_CAST('8'), WCHAR_CAST('\0')}; /* "2048" */
const DRM_WCHAR g_rgwchDefaultFilename             [] = { WCHAR_CAST('c'), WCHAR_CAST(':'), WCHAR_CAST('\\'), WCHAR_CAST('W'), WCHAR_CAST('M'), WCHAR_CAST('D'), WCHAR_CAST('R'), WCHAR_CAST('M'), WCHAR_CAST('P'), WCHAR_CAST('D'), WCHAR_CAST('\\'), WCHAR_CAST('P'), WCHAR_CAST('k'), WCHAR_CAST('g'), WCHAR_CAST('I'), WCHAR_CAST('n'), WCHAR_CAST('i'), WCHAR_CAST('t'), WCHAR_CAST('.'), WCHAR_CAST('x'), WCHAR_CAST('m'), WCHAR_CAST('l'), WCHAR_CAST('\0')}; /* "c:\\WMDRMPD\\PkgInit.xml" */
const DRM_WCHAR g_rgwchContents                    [] = { WCHAR_CAST('C'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('t'), WCHAR_CAST('s'), WCHAR_CAST('\0')}; /* "Contents" */
const DRM_WCHAR g_rgwchSerial                      [] = { WCHAR_CAST('S'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('i'), WCHAR_CAST('a'), WCHAR_CAST('l'), WCHAR_CAST('\0')}; /* "Serial" */
const DRM_WCHAR g_rgwchTagPrivkey                  [] = { WCHAR_CAST('P'), WCHAR_CAST('R'), WCHAR_CAST('I'), WCHAR_CAST('V'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "PRIVKEY" */
const DRM_WCHAR g_rgwchTagKeypair                  [] = { WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('P'), WCHAR_CAST('A'), WCHAR_CAST('I'), WCHAR_CAST('R'), WCHAR_CAST('\0')}; /* "KEYPAIR" */
const DRM_WCHAR g_rgwchTagExpression               [] = { WCHAR_CAST('E'), WCHAR_CAST('X'), WCHAR_CAST('P'), WCHAR_CAST('R'), WCHAR_CAST('\0')}; /* "EXPR" */

const DRM_WCHAR g_rgwchTagRequestDAC               [] = { WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('q'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('s'), WCHAR_CAST('t'), WCHAR_CAST('D'), WCHAR_CAST('A'), WCHAR_CAST('C'), WCHAR_CAST('\0')}; /* "RequestDAC" */
const DRM_WCHAR g_rgwchTagDAC                      [] = { WCHAR_CAST('D'), WCHAR_CAST('A'), WCHAR_CAST('C'), WCHAR_CAST('\0')}; /* "DAC" */
const DRM_WCHAR g_rgwchTagDAC_WMDRM_MD             [] = { WCHAR_CAST('P'), WCHAR_CAST('l'), WCHAR_CAST('a'), WCHAR_CAST('y'), WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('a'), WCHAR_CAST('d'), WCHAR_CAST('y'), WCHAR_CAST('\0')}; /* "PlayReady" */
const DRM_WCHAR g_rgwchTagDAC_WMDRM_ND             [] = { WCHAR_CAST('W'), WCHAR_CAST('M'), WCHAR_CAST('D'), WCHAR_CAST('R'), WCHAR_CAST('M'), WCHAR_CAST('N'), WCHAR_CAST('D'), WCHAR_CAST('\0')}; /* "WMDRMND" */
const DRM_WCHAR g_rgwchTagDACResponse              [] = { WCHAR_CAST('D'), WCHAR_CAST('a'), WCHAR_CAST('c'), WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('s'), WCHAR_CAST('p'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "DacResponse" */
const DRM_WCHAR g_rgwchTagManufName                [] = { WCHAR_CAST('M'), WCHAR_CAST('a'), WCHAR_CAST('n'), WCHAR_CAST('u'), WCHAR_CAST('f'), WCHAR_CAST('a'), WCHAR_CAST('c'), WCHAR_CAST('t'), WCHAR_CAST('u'), WCHAR_CAST('r'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('N'), WCHAR_CAST('a'), WCHAR_CAST('m'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "ManufacturerName" */
...
**  XPaths
*/
const DRM_WCHAR g_rgwchXPathDACPubKey                [] = { WCHAR_CAST('D'), WCHAR_CAST('A'), WCHAR_CAST('C'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('U'), WCHAR_CAST('B'), WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "DAC/PUBLICKEY" */
const DRM_WCHAR g_rgwchXPathFallbackPubKey           [] = { WCHAR_CAST('F'), WCHAR_CAST('A'), WCHAR_CAST('L'), WCHAR_CAST('L'), WCHAR_CAST('B'), WCHAR_CAST('A'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('U'), WCHAR_CAST('B'), WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "FALLBACK/PUBLICKEY" */
const DRM_WCHAR g_rgwchXPathWMDRM_MDPubKey           [] = { WCHAR_CAST('P'), WCHAR_CAST('l'), WCHAR_CAST('a'), WCHAR_CAST('y'), WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('a'), WCHAR_CAST('d'), WCHAR_CAST('y'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('U'), WCHAR_CAST('B'), WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "PlayReady/PUBLICKEY" */
const DRM_WCHAR g_rgwchXPathWMDRMNDPubKeyModulus     [] = { WCHAR_CAST('W'), WCHAR_CAST('M'), WCHAR_CAST('D'), WCHAR_CAST('R'), WCHAR_CAST('M'), WCHAR_CAST('N'), WCHAR_CAST('D'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('U'), WCHAR_CAST('B'), WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('/'), WCHAR_CAST('M'), WCHAR_CAST('o'), WCHAR_CAST('d'), WCHAR_CAST('u'), WCHAR_CAST('l'), WCHAR_CAST('u'), WCHAR_CAST('s'), WCHAR_CAST('\0')}; /* "WMDRMND/PUBLICKEY/Modulus" */
const DRM_WCHAR g_rgwchXPathWMDRMNDPubKeyExponent    [] = { WCHAR_CAST('W'), WCHAR_CAST('M'), WCHAR_CAST('D'), WCHAR_CAST('R'), WCHAR_CAST('M'), WCHAR_CAST('N'), WCHAR_CAST('D'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('U'), WCHAR_CAST('B'), WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('/'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('p'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('t'), WCHAR_CAST('\0')}; /* "WMDRMND/PUBLICKEY/Exponent" */
const DRM_WCHAR g_rgwchXPathPlayReadyNDPubKeyModulus [] = { WCHAR_CAST('P'), WCHAR_CAST('l'), WCHAR_CAST('a'), WCHAR_CAST('y'), WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('a'), WCHAR_CAST('d'), WCHAR_CAST('y'), WCHAR_CAST('N'), WCHAR_CAST('D'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('U'), WCHAR_CAST('B'), WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('/'), WCHAR_CAST('M'), WCHAR_CAST('o'), WCHAR_CAST('d'), WCHAR_CAST('u'), WCHAR_CAST('l'), WCHAR_CAST('u'), WCHAR_CAST('s'), WCHAR_CAST('\0')}; /* "PlayReadyND/PUBLICKEY/Modulus" */
const DRM_WCHAR g_rgwchXPathPlayReadyNDPubKeyExponent[] = { WCHAR_CAST('P'), WCHAR_CAST('l'), WCHAR_CAST('a'), WCHAR_CAST('y'), WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('a'), WCHAR_CAST('d'), WCHAR_CAST('y'), WCHAR_CAST('N'), WCHAR_CAST('D'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('U'), WCHAR_CAST('B'), WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('/'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('p'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('t'), WCHAR_CAST('\0')}; /* "PlayReadyND/PUBLICKEY/Exponent" */


const DRM_WCHAR g_rgwchXPathDACPrivKey             [] = { WCHAR_CAST('D'), WCHAR_CAST('A'), WCHAR_CAST('C'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('R'), WCHAR_CAST('I'), WCHAR_CAST('V'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "DAC/PRIVKEY" */
const DRM_WCHAR g_rgwchXPathFallbackPrivKey        [] = { WCHAR_CAST('F'), WCHAR_CAST('A'), WCHAR_CAST('L'), WCHAR_CAST('L'), WCHAR_CAST('B'), WCHAR_CAST('A'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('R'), WCHAR_CAST('I'), WCHAR_CAST('V'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "FALLBACK/PRIVKEY" */
const DRM_WCHAR g_rgwchXPathWMDRMPrivKey           [] = { WCHAR_CAST('P'), WCHAR_CAST('l'), WCHAR_CAST('a'), WCHAR_CAST('y'), WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('a'), WCHAR_CAST('d'), WCHAR_CAST('y'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('R'), WCHAR_CAST('I'), WCHAR_CAST('V'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "PlayReady/PRIVKEY" */
const DRM_WCHAR g_rgwchXPathWMDRMPubKey            [] = { WCHAR_CAST('P'), WCHAR_CAST('l'), WCHAR_CAST('a'), WCHAR_CAST('y'), WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('a'), WCHAR_CAST('d'), WCHAR_CAST('y'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('U'), WCHAR_CAST('B'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "PlayReady/PUBKEY" */
const DRM_WCHAR g_rgwchXPathFallbackSecVer         [] = { WCHAR_CAST('F'), WCHAR_CAST('A'), WCHAR_CAST('L'), WCHAR_CAST('L'), WCHAR_CAST('B'), WCHAR_CAST('A'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('/'), WCHAR_CAST('S'), WCHAR_CAST('E'), WCHAR_CAST('C'), WCHAR_CAST('U'), WCHAR_CAST('R'), WCHAR_CAST('I'), WCHAR_CAST('T'), WCHAR_CAST('Y'), WCHAR_CAST('V'), WCHAR_CAST('E'), WCHAR_CAST('R'), WCHAR_CAST('S'), WCHAR_CAST('I'), WCHAR_CAST('O'), WCHAR_CAST('N'), WCHAR_CAST('\0')}; /* "FALLBACK/SECURITYVERSION" */

/* generateDAC */

const DRM_WCHAR g_rgwchTagDataSecurityVersionValue [] = { WCHAR_CAST('2'), WCHAR_CAST('.'), WCHAR_CAST('3'), WCHAR_CAST('.'), WCHAR_CAST('0'), WCHAR_CAST('.'), WCHAR_CAST('2'), WCHAR_CAST('\0')}; /* "2.3.0.2" */
const DRM_WCHAR g_rgwchAuthorizationIDDAC          [] = { WCHAR_CAST('4'), WCHAR_CAST('2'), WCHAR_CAST('\0')}; /* "42" */
const DRM_WCHAR g_rgwchAuthIDDACRoot               [] = { WCHAR_CAST('1'), WCHAR_CAST('\0')}; /* "1" */
const DRM_WCHAR g_rgwchTagSecurityLevelValue       [] = { WCHAR_CAST('2'), WCHAR_CAST('0'), WCHAR_CAST('0'), WCHAR_CAST('0'), WCHAR_CAST('\0')}; /* "2000" */

/* metering tools */

const DRM_WCHAR g_rgwchCertMetercert               [] = { WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('E'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('D'), WCHAR_CAST('g'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('B'), WCHAR_CAST('1'), WCHAR_CAST('7'), WCHAR_CAST('b'), WCHAR_CAST('f'), WCHAR_CAST('g'), WCHAR_CAST('!'), WCHAR_CAST('c'), WCHAR_CAST('q'), WCHAR_CAST('D'), WCHAR_CAST('L'), WCHAR_CAST('B'), WCHAR_CAST('2'), WCHAR_CAST('c'), WCHAR_CAST('l'), WCHAR_CAST('H'), WCHAR_CAST('G'), WCHAR_CAST('U'), WCHAR_CAST('7'), WCHAR_CAST('P'), WCHAR_CAST('6'), WCHAR_CAST('z'), WCHAR_CAST('k'), WCHAR_CAST('r'), WCHAR_CAST('O'), WCHAR_CAST('C'), WCHAR_CAST('V'), WCHAR_CAST('U'), WCHAR_CAST('d'), WCHAR_CAST('d'), WCHAR_CAST('X'), WCHAR_CAST('9'), WCHAR_CAST('5'), WCHAR_CAST('U'), WCHAR_CAST('Y'), WCHAR_CAST('k'), WCHAR_CAST('q'), WCHAR_CAST('p'), WCHAR_CAST('j'), WCHAR_CAST('q'), WCHAR_CAST('v'), WCHAR_CAST('o'), WCHAR_CAST('I'), WCHAR_CAST('r'), WCHAR_CAST('4'), WCHAR_CAST('e'), WCHAR_CAST('z'), WCHAR_CAST('q'), WCHAR_CAST('w'), WCHAR_CAST('2'), WCHAR_CAST('z'), WCHAR_CAST('g'), WCHAR_CAST('w'), WCHAR_CAST('f'), WCHAR_CAST('r'), WCHAR_CAST('v'), WCHAR_CAST('K'), WCHAR_CAST('R'), WCHAR_CAST('1'), WCHAR_CAST('d'), WCHAR_CAST('q'), WCHAR_CAST('!'), WCHAR_CAST('E'), WCHAR_CAST('z'), WCHAR_CAST('d'), WCHAR_CAST('G'), WCHAR_CAST('D'), WCHAR_CAST('8'), WCHAR_CAST('N'), WCHAR_CAST('D'), WCHAR_CAST('2'), WCHAR_CAST('I'), WCHAR_CAST('h'), WCHAR_CAST('k'), WCHAR_CAST('n'), WCHAR_CAST('0'), WCHAR_CAST('O'), WCHAR_CAST('P'), WCHAR_CAST('E'), WCHAR_CAST('o'), WCHAR_CAST('W'), WCHAR_CAST('Z'), WCHAR_CAST('Z'), WCHAR_CAST('K'), WCHAR_CAST('C'), WCHAR_CAST('w'), WCHAR_CAST('g'), WCHAR_CAST('i'), WCHAR_CAST('d'), WCHAR_CAST('p'), WCHAR_CAST('7'), WCHAR_CAST('Y'), WCHAR_CAST('5'), WCHAR_CAST('S'), WCHAR_CAST('H'), WCHAR_CAST('R'), WCHAR_CAST('!'), WCHAR_CAST('N'), WCHAR_CAST('F'), WCHAR_CAST('J'), WCHAR_CAST('J'), WCHAR_CAST('a'), WCHAR_CAST('z'), WCHAR_CAST('d'), WCHAR_CAST('P'), WCHAR_CAST('W'), WCHAR_CAST('f'), WCHAR_CAST('B'), WCHAR_CAST('Q'), WCHAR_CAST('E'), WCHAR_CAST('B'), WCHAR_CAST('B'), WCHAR_CAST('4'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('B'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('Q'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('E'), WCHAR_CAST('='), WCHAR_CAST('\0')}; /* "AAEAADgAAAB17bfg!cqDLB2clHGU7P6zkrOCVUddX95UYkqpjqvoIr4ezqw2zgwfrvKR1dq!EzdGD8ND2Ihkn0OPEoWZZKCwgidp7Y5SHR!NFJJazdPWfBQEBB4AAAABAAAAAQAAAAE=" */

/* secure clock */

const DRM_WCHAR g_rgwchCertSecureClock             [] = { WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('E'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('D'), WCHAR_CAST('g'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('C'), WCHAR_CAST('5'), WCHAR_CAST('z'), WCHAR_CAST('9'), WCHAR_CAST('y'), WCHAR_CAST('i'), WCHAR_CAST('h'), WCHAR_CAST('d'), WCHAR_CAST('T'), WCHAR_CAST('T'), WCHAR_CAST('D'), WCHAR_CAST('j'), WCHAR_CAST('6'), WCHAR_CAST('g'), WCHAR_CAST('W'), WCHAR_CAST('u'), WCHAR_CAST('C'), WCHAR_CAST('2'), WCHAR_CAST('h'), WCHAR_CAST('o'), WCHAR_CAST('v'), WCHAR_CAST('Q'), WCHAR_CAST('Q'), WCHAR_CAST('i'), WCHAR_CAST('L'), WCHAR_CAST('z'), WCHAR_CAST('A'), WCHAR_CAST('x'), WCHAR_CAST('N'), WCHAR_CAST('d'), WCHAR_CAST('j'), WCHAR_CAST('i'), WCHAR_CAST('u'), WCHAR_CAST('p'), WCHAR_CAST('l'), WCHAR_CAST('d'), WCHAR_CAST('!'), WCHAR_CAST('0'), WCHAR_CAST('6'), WCHAR_CAST('z'), WCHAR_CAST('j'), WCHAR_CAST('V'), WCHAR_CAST('y'), WCHAR_CAST('J'), WCHAR_CAST('C'), WCHAR_CAST('P'), WCHAR_CAST('S'), WCHAR_CAST('j'), WCHAR_CAST('O'), WCHAR_CAST('L'), WCHAR_CAST('w'), WCHAR_CAST('j'), WCHAR_CAST('k'), WCHAR_CAST('I'), WCHAR_CAST('5'), WCHAR_CAST('S'), WCHAR_CAST('m'), WCHAR_CAST('q'), WCHAR_CAST('r'), WCHAR_CAST('n'), WCHAR_CAST('E'), WCHAR_CAST('D'), WCHAR_CAST('j'), WCHAR_CAST('o'), WCHAR_CAST('2'), WCHAR_CAST('H'), WCHAR_CAST('!'), WCHAR_CAST('K'), WCHAR_CAST('J'), WCHAR_CAST('V'), WCHAR_CAST('4'), WCHAR_CAST('q'), WCHAR_CAST('k'), WCHAR_CAST('2'), WCHAR_CAST('C'), WCHAR_CAST('Q'), WCHAR_CAST('0'), WCHAR_CAST('g'), WCHAR_CAST('M'), WCHAR_CAST('w'), WCHAR_CAST('y'), WCHAR_CAST('u'), WCHAR_CAST('r'), WCHAR_CAST('m'), WCHAR_CAST('C'), WCHAR_CAST('1'), WCHAR_CAST('o'), WCHAR_CAST('O'), WCHAR_CAST('V'), WCHAR_CAST('c'), WCHAR_CAST('1'), WCHAR_CAST('u'), WCHAR_CAST('T'), WCHAR_CAST('6'), WCHAR_CAST('4'), WCHAR_CAST('v'), WCHAR_CAST('Q'), WCHAR_CAST('!'), WCHAR_CAST('u'), WCHAR_CAST('o'), WCHAR_CAST('H'), WCHAR_CAST('o'), WCHAR_CAST('b'), WCHAR_CAST('i'), WCHAR_CAST('F'), WCHAR_CAST('e'), WCHAR_CAST('g'), WCHAR_CAST('2'), WCHAR_CAST('N'), WCHAR_CAST('j'), WCHAR_CAST('D'), WCHAR_CAST('B'), WCHAR_CAST('8'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('B'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('Q'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('A'), WCHAR_CAST('E'), WCHAR_CAST('='), WCHAR_CAST('\0')}; /* "AAEAADgAAAC5z9yihdTTDj6gWuC2hovQQiLzAxNdjiupld!06zjVyJCPSjOLwjkI5SmqrnEDjo2H!KJV4qk2CQ0gMwyurmC1oOVc1uT64vQ!uoHobiFeg2NjDB8AAAABAAAAAQAAAAE=" */

/* XML utils */

const DRM_WCHAR g_rgwchTestTemplate                [] = { WCHAR_CAST('<'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('C'), WCHAR_CAST('L'), WCHAR_CAST('U'), WCHAR_CAST('D'), WCHAR_CAST('E'), WCHAR_CAST('S'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('C'), WCHAR_CAST('L'), WCHAR_CAST('U'), WCHAR_CAST('D'), WCHAR_CAST('E'), WCHAR_CAST('>'), WCHAR_CAST('x'), WCHAR_CAST('y'), WCHAR_CAST('z'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('C'), WCHAR_CAST('L'), WCHAR_CAST('U'), WCHAR_CAST('D'), WCHAR_CAST('E'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('C'), WCHAR_CAST('L'), WCHAR_CAST('U'), WCHAR_CAST('D'), WCHAR_CAST('E'), WCHAR_CAST('S'), WCHAR_CAST('>'), WCHAR_CAST('\0')}; /* "<INCLUDES><INCLUDE>xyz</INCLUDE></INCLUDES>" */
const DRM_WCHAR g_rgwchXMLTree1                    [] = { WCHAR_CAST('<'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('C'), WCHAR_CAST('L'), WCHAR_CAST('U'), WCHAR_CAST('D'), WCHAR_CAST('E'), WCHAR_CAST('S'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('C'), WCHAR_CAST('L'), WCHAR_CAST('U'), WCHAR_CAST('D'), WCHAR_CAST('E'), WCHAR_CAST('1'), WCHAR_CAST('>'), WCHAR_CAST('a'), WCHAR_CAST('b'), WCHAR_CAST('c'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('C'), WCHAR_CAST('L'), WCHAR_CAST('U'), WCHAR_CAST('D'), WCHAR_CAST('E'), WCHAR_CAST('1'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('C'), WCHAR_CAST('L'), WCHAR_CAST('U'), WCHAR_CAST('D'), WCHAR_CAST('E'), WCHAR_CAST('>'), WCHAR_CAST('x'), WCHAR_CAST('y'), WCHAR_CAST('x'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('C'), WCHAR_CAST('L'), WCHAR_CAST('U'), WCHAR_CAST('D'), WCHAR_CAST('E'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('I'), WCHAR_CAST('N'), WCHAR_CAST('C'), WCHAR_CAST('L'), WCHAR_CAST('U'), WCHAR_CAST('D'), WCHAR_CAST('E'), WCHAR_CAST('S'), WCHAR_CAST('>'), WCHAR_CAST('\0')}; /* "<INCLUDES><INCLUDE1>abc</INCLUDE1><INCLUDE>xyx</INCLUDE></INCLUDES>" */
const DRM_WCHAR g_rgwchXMLTree2                    [] = { WCHAR_CAST('<'), WCHAR_CAST('D'), WCHAR_CAST('A'), WCHAR_CAST('T'), WCHAR_CAST('A'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('K'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('a'), WCHAR_CAST('b'), WCHAR_CAST('c'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('K'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('p'), WCHAR_CAST('q'), WCHAR_CAST('r'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('M'), WCHAR_CAST('E'), WCHAR_CAST('T'), WCHAR_CAST('A'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('U'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('x'), WCHAR_CAST('y'), WCHAR_CAST('z'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('U'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('L'), WCHAR_CAST('G'), WCHAR_CAST('P'), WCHAR_CAST('U'), WCHAR_CAST('B'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('>'), WCHAR_CAST('s'), WCHAR_CAST('f'), WCHAR_CAST('s'), WCHAR_CAST('d'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('L'), WCHAR_CAST('G'), WCHAR_CAST('P'), WCHAR_CAST('U'), WCHAR_CAST('B'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('M'), WCHAR_CAST('E'), WCHAR_CAST('T'), WCHAR_CAST('A'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('D'), WCHAR_CAST('A'), WCHAR_CAST('T'), WCHAR_CAST('A'), WCHAR_CAST('>'), WCHAR_CAST('\0')}; /* "<DATA><KID>abc</KID><LID>pqr</LID><META><UID>xyz</UID><LGPUBKEY>sfsd</LGPUBKEY></META></DATA>" */
const DRM_WCHAR g_rgwchXMLTree3                    [] = { WCHAR_CAST('<'), WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('p'), WCHAR_CAST('q'), WCHAR_CAST('r'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('M'), WCHAR_CAST('E'), WCHAR_CAST('T'), WCHAR_CAST('A'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('U'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('x'), WCHAR_CAST('y'), WCHAR_CAST('z'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('U'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('M'), WCHAR_CAST('E'), WCHAR_CAST('T'), WCHAR_CAST('A'), WCHAR_CAST('>'), WCHAR_CAST('\0')}; /* "<LID>pqr</LID><META><UID>xyz</UID></META>" */
const DRM_WCHAR g_rgwchXMLTree4                    [] = { WCHAR_CAST('<'), WCHAR_CAST('K'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('a'), WCHAR_CAST('b'), WCHAR_CAST('c'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('K'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('M'), WCHAR_CAST('E'), WCHAR_CAST('T'), WCHAR_CAST('A'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('U'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('x'), WCHAR_CAST('y'), WCHAR_CAST('z'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('U'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('>'), WCHAR_CAST('<'), WCHAR_CAST('/'), WCHAR_CAST('M'), WCHAR_CAST('E'), WCHAR_CAST('T'), WCHAR_CAST('A'), WCHAR_CAST('>'), WCHAR_CAST('\0')}; /* "<KID>abc</KID><META><UID>xyz</UID></META>" */
...
const DRM_CONST_STRING  g_dstrTagDAC_WMDRM_ND                   = CREATE_DRM_STRING(g_rgwchTagDAC_WMDRM_ND);
...
const DRM_CONST_STRING  g_dstrXPathWMDRMNDPubKeyModulus         = CREATE_DRM_STRING(g_rgwchXPathWMDRMNDPubKeyModulus);
const DRM_CONST_STRING  g_dstrXPathWMDRMNDPubKeyExponent        = CREATE_DRM_STRING(g_rgwchXPathWMDRMNDPubKeyExponent);
...
const DRM_WCHAR g_rgwchVersion                           [] = { WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "version" */
const DRM_WCHAR g_rgwchCertType                          [] = { WCHAR_CAST('t'), WCHAR_CAST('y'), WCHAR_CAST('p'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "type" */
const DRM_WCHAR g_rgwchValue                             [] = { WCHAR_CAST('v'), WCHAR_CAST('a'), WCHAR_CAST('l'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "value" */
const DRM_WCHAR g_rgwchDevice                            [] = { WCHAR_CAST('d'), WCHAR_CAST('e'), WCHAR_CAST('v'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "device" */
const DRM_WCHAR g_rgwchPC                                [] = { WCHAR_CAST('p'), WCHAR_CAST('c'), WCHAR_CAST('\0')}; /* "pc" */
const DRM_WCHAR g_rgwchExtendedData                      [] = { WCHAR_CAST('e'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('d'), WCHAR_CAST('e'), WCHAR_CAST('d'), WCHAR_CAST('d'), WCHAR_CAST('a'), WCHAR_CAST('t'), WCHAR_CAST('a'), WCHAR_CAST('\0')}; /* "extendeddata" */
const DRM_WCHAR g_rgwchExtendedDataSigningKey            [] = { WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('g'), WCHAR_CAST('k'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('\0')}; /* "signingkey" */
const DRM_WCHAR g_rgwchExtendedDataSigningKeyPublicKey   [] = { WCHAR_CAST('p'), WCHAR_CAST('u'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('k'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('\0')}; /* "publickey" */
const DRM_WCHAR g_rgwchExtendedDataSigningKeyPrivateKey  [] = { WCHAR_CAST('p'), WCHAR_CAST('r'), WCHAR_CAST('i'), WCHAR_CAST('v'), WCHAR_CAST('a'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('k'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('\0')}; /* "privatekey" */
const DRM_WCHAR g_rgwchExtendedDataRecord                [] = { WCHAR_CAST('d'), WCHAR_CAST('a'), WCHAR_CAST('t'), WCHAR_CAST('a'), WCHAR_CAST('r'), WCHAR_CAST('e'), WCHAR_CAST('c'), WCHAR_CAST('o'), WCHAR_CAST('r'), WCHAR_CAST('d'), WCHAR_CAST('\0')}; /* "datarecord" */
const DRM_WCHAR g_rgwchDomain                            [] = { WCHAR_CAST('d'), WCHAR_CAST('o'), WCHAR_CAST('m'), WCHAR_CAST('a'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "domain" */
const DRM_WCHAR g_rgwchSilverLight                       [] = { WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('l'), WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('l'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('\0')}; /* "silverlight" */
const DRM_WCHAR g_rgwchApplication                       [] = { WCHAR_CAST('a'), WCHAR_CAST('p'), WCHAR_CAST('p'), WCHAR_CAST('l'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('a'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "application" */
const DRM_WCHAR g_rgwchMeteringCertType                  [] = { WCHAR_CAST('m'), WCHAR_CAST('e'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('g'), WCHAR_CAST('\0')}; /* "metering" */
const DRM_WCHAR g_rgwchServerCertType                    [] = { WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "server" */
const DRM_WCHAR g_rgwchIssuer                            [] = { WCHAR_CAST('i'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "issuer" */
const DRM_WCHAR g_rgwchService                           [] = { WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('v'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "service" */
const DRM_WCHAR g_rgwchCRLSigner                         [] = { WCHAR_CAST('c'), WCHAR_CAST('r'), WCHAR_CAST('l'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "crlsigner" */
const DRM_WCHAR g_rgwchKeyFileSigner                     [] = { WCHAR_CAST('k'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('f'), WCHAR_CAST('i'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "keyfilesigner" */
const DRM_WCHAR g_rgwchLicenseSigner                     [] = { WCHAR_CAST('l'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "licensesigner" */
const DRM_WCHAR g_rgwchBasicInfo                         [] = { WCHAR_CAST('b'), WCHAR_CAST('a'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('f'), WCHAR_CAST('o'), WCHAR_CAST('\0')}; /* "basicinfo" */
const DRM_WCHAR g_rgwchSecurityLevel                     [] = { WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('c'), WCHAR_CAST('u'), WCHAR_CAST('r'), WCHAR_CAST('i'), WCHAR_CAST('t'), WCHAR_CAST('y'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('l'), WCHAR_CAST('\0')}; /* "securitylevel" */
const DRM_WCHAR g_rgwchClientID                          [] = { WCHAR_CAST('c'), WCHAR_CAST('l'), WCHAR_CAST('i'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('d'), WCHAR_CAST('\0')}; /* "clientid" */
const DRM_WCHAR g_rgwchExpiration                        [] = { WCHAR_CAST('e'), WCHAR_CAST('x'), WCHAR_CAST('p'), WCHAR_CAST('i'), WCHAR_CAST('r'), WCHAR_CAST('a'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "expiration" */
const DRM_WCHAR g_rgwchWarningDays                       [] = { WCHAR_CAST('W'), WCHAR_CAST('a'), WCHAR_CAST('r'), WCHAR_CAST('n'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('g'), WCHAR_CAST('D'), WCHAR_CAST('a'), WCHAR_CAST('y'), WCHAR_CAST('s'), WCHAR_CAST('\0')}; /* "WarningDays" */
const DRM_WCHAR g_rgwchServiceID                         [] = { WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('v'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('i'), WCHAR_CAST('d'), WCHAR_CAST('\0')}; /* "serviceid" */
const DRM_WCHAR g_rgwchAccountID                         [] = { WCHAR_CAST('a'), WCHAR_CAST('c'), WCHAR_CAST('c'), WCHAR_CAST('o'), WCHAR_CAST('u'), WCHAR_CAST('n'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('d'), WCHAR_CAST('\0')}; /* "accountid" */
const DRM_WCHAR g_rgwchRevision                          [] = { WCHAR_CAST('r'), WCHAR_CAST('e'), WCHAR_CAST('v'), WCHAR_CAST('i'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "revision" */
const DRM_WCHAR g_rgwchUrl                               [] = { WCHAR_CAST('u'), WCHAR_CAST('r'), WCHAR_CAST('l'), WCHAR_CAST('\0')}; /* "url" */
const DRM_WCHAR g_rgwchSecurityVersion                   [] = { WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('c'), WCHAR_CAST('u'), WCHAR_CAST('r'), WCHAR_CAST('i'), WCHAR_CAST('t'), WCHAR_CAST('y'), WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "securityversion" */
const DRM_WCHAR g_rgwchExtendedDataRecordFlags           [] = { WCHAR_CAST('f'), WCHAR_CAST('l'), WCHAR_CAST('a'), WCHAR_CAST('g'), WCHAR_CAST('s'), WCHAR_CAST('\0')}; /* "flags" */
const DRM_WCHAR g_rgwchExtendedDataRecordMaxLength       [] = { WCHAR_CAST('m'), WCHAR_CAST('a'), WCHAR_CAST('x'), WCHAR_CAST('L'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('g'), WCHAR_CAST('t'), WCHAR_CAST('h'), WCHAR_CAST('B'), WCHAR_CAST('y'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('s'), WCHAR_CAST('\0')}; /* "maxLengthBytes" */
const DRM_WCHAR g_rgwchSecurityVersionSeperator          [] = { WCHAR_CAST('.'), WCHAR_CAST('\0')}; /* "." */
const DRM_WCHAR g_rgwchTransmitter                       [] = { WCHAR_CAST('T'), WCHAR_CAST('r'), WCHAR_CAST('a'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('m'), WCHAR_CAST('i'), WCHAR_CAST('t'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "Transmitter" */
const DRM_WCHAR g_rgwchReceiver                          [] = { WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('i'), WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "Receiver" */
const DRM_WCHAR g_rgwchSharedCertificate                 [] = { WCHAR_CAST('S'), WCHAR_CAST('h'), WCHAR_CAST('a'), WCHAR_CAST('r'), WCHAR_CAST('e'), WCHAR_CAST('d'), WCHAR_CAST('C'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('f'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('a'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "SharedCertificate" */
const DRM_WCHAR g_rgwchSecureClock                       [] = { WCHAR_CAST('S'), WCHAR_CAST('e'), WCHAR_CAST('c'), WCHAR_CAST('u'), WCHAR_CAST('r'), WCHAR_CAST('e'), WCHAR_CAST('C'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('c'), WCHAR_CAST('k'), WCHAR_CAST('\0')}; /* "SecureClock" */
const DRM_WCHAR g_rgwchSampleProtection                  [] = { WCHAR_CAST('E'), WCHAR_CAST('n'), WCHAR_CAST('c'), WCHAR_CAST('r'), WCHAR_CAST('y'), WCHAR_CAST('p'), WCHAR_CAST('t'), WCHAR_CAST('K'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('S'), WCHAR_CAST('a'), WCHAR_CAST('m'), WCHAR_CAST('p'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('P'), WCHAR_CAST('r'), WCHAR_CAST('o'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('c'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "EncryptKeySampleProtection" */
const DRM_WCHAR g_rgwchRollbackClock                     [] = { WCHAR_CAST('A'), WCHAR_CAST('n'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('r'), WCHAR_CAST('o'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('b'), WCHAR_CAST('a'), WCHAR_CAST('c'), WCHAR_CAST('k'), WCHAR_CAST('C'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('c'), WCHAR_CAST('k'), WCHAR_CAST('\0')}; /* "AntirollbackClock" */
const DRM_WCHAR g_rgwchMetering                          [] = { WCHAR_CAST('M'), WCHAR_CAST('e'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('g'), WCHAR_CAST('\0')}; /* "Metering" */
const DRM_WCHAR g_rgwchLicenseSync                       [] = { WCHAR_CAST('L'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('S'), WCHAR_CAST('y'), WCHAR_CAST('n'), WCHAR_CAST('c'), WCHAR_CAST('\0')}; /* "LicenseSync" */
const DRM_WCHAR g_rgwchSymmOpt                           [] = { WCHAR_CAST('S'), WCHAR_CAST('y'), WCHAR_CAST('m'), WCHAR_CAST('m'), WCHAR_CAST('O'), WCHAR_CAST('p'), WCHAR_CAST('t'), WCHAR_CAST('\0')}; /* "SymmOpt" */
const DRM_WCHAR g_rgwchSupportCRL                        [] = { WCHAR_CAST('S'), WCHAR_CAST('u'), WCHAR_CAST('p'), WCHAR_CAST('p'), WCHAR_CAST('o'), WCHAR_CAST('r'), WCHAR_CAST('t'), WCHAR_CAST('C'), WCHAR_CAST('R'), WCHAR_CAST('L'), WCHAR_CAST('\0')}; /* "SupportCRL" */

/* Server SKUification feature flags */
const DRM_WCHAR g_rgwchServerBasicEdition                [] = { WCHAR_CAST('S'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('B'), WCHAR_CAST('a'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('E'), WCHAR_CAST('d'), WCHAR_CAST('i'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "ServerBasicEdition" */
const DRM_WCHAR g_rgwchServerStandardEdition             [] = { WCHAR_CAST('S'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('S'), WCHAR_CAST('t'), WCHAR_CAST('a'), WCHAR_CAST('n'), WCHAR_CAST('d'), WCHAR_CAST('a'), WCHAR_CAST('r'), WCHAR_CAST('d'), WCHAR_CAST('E'), WCHAR_CAST('d'), WCHAR_CAST('i'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "ServerStandardEdition" */
const DRM_WCHAR g_rgwchServerPremiumEdition              [] = { WCHAR_CAST('S'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('P'), WCHAR_CAST('r'), WCHAR_CAST('e'), WCHAR_CAST('m'), WCHAR_CAST('i'), WCHAR_CAST('u'), WCHAR_CAST('m'), WCHAR_CAST('E'), WCHAR_CAST('d'), WCHAR_CAST('i'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "ServerPremiumEdition" */

const DRM_WCHAR g_rgwchCertFeatures                      [] = { WCHAR_CAST('F'), WCHAR_CAST('E'), WCHAR_CAST('A'), WCHAR_CAST('T'), WCHAR_CAST('U'), WCHAR_CAST('R'), WCHAR_CAST('E'), WCHAR_CAST('S'), WCHAR_CAST('\0')}; /* "FEATURES" */
const DRM_WCHAR g_rgwchCertManufacturer                  [] = { WCHAR_CAST('m'), WCHAR_CAST('a'), WCHAR_CAST('n'), WCHAR_CAST('u'), WCHAR_CAST('f'), WCHAR_CAST('a'), WCHAR_CAST('c'), WCHAR_CAST('t'), WCHAR_CAST('u'), WCHAR_CAST('r'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "manufacturer" */
const DRM_WCHAR g_rgwchManufacturerName                  [] = { WCHAR_CAST('n'), WCHAR_CAST('a'), WCHAR_CAST('m'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "name" */
const DRM_WCHAR g_rgwchMake                              [] = { WCHAR_CAST('M'), WCHAR_CAST('A'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('\0')}; /* "MAKE" */
const DRM_WCHAR g_rgwchModelName                         [] = { WCHAR_CAST('m'), WCHAR_CAST('o'), WCHAR_CAST('d'), WCHAR_CAST('e'), WCHAR_CAST('l'), WCHAR_CAST('n'), WCHAR_CAST('a'), WCHAR_CAST('m'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "modelname" */
const DRM_WCHAR g_rgwchModelNumber                       [] = { WCHAR_CAST('m'), WCHAR_CAST('o'), WCHAR_CAST('d'), WCHAR_CAST('e'), WCHAR_CAST('l'), WCHAR_CAST('n'), WCHAR_CAST('u'), WCHAR_CAST('m'), WCHAR_CAST('b'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "modelnumber" */
const DRM_WCHAR g_rgwchLimits                            [] = { WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('M'), WCHAR_CAST('I'), WCHAR_CAST('T'), WCHAR_CAST('S'), WCHAR_CAST('\0')}; /* "LIMITS" */
const DRM_WCHAR g_rgwchCertKey                           [] = { WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('t'), WCHAR_CAST('k'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('\0')}; /* "certkey" */
const DRM_WCHAR g_rgwchCertKeyType                       [] = { WCHAR_CAST('t'), WCHAR_CAST('y'), WCHAR_CAST('p'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "type" */
const DRM_WCHAR g_rgwchCertKeys                          [] = { WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('t'), WCHAR_CAST('k'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('s'), WCHAR_CAST('\0')}; /* "certkeys" */
const DRM_WCHAR g_rgwchCertECC256                        [] = { WCHAR_CAST('E'), WCHAR_CAST('C'), WCHAR_CAST('C'), WCHAR_CAST('-'), WCHAR_CAST('2'), WCHAR_CAST('5'), WCHAR_CAST('6'), WCHAR_CAST('\0')}; /* "ECC-256" */
const DRM_WCHAR g_rgwchCertKeyUsages                     [] = { WCHAR_CAST('k'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('u'), WCHAR_CAST('s'), WCHAR_CAST('a'), WCHAR_CAST('g'), WCHAR_CAST('e'), WCHAR_CAST('s'), WCHAR_CAST('\0')}; /* "keyusages" */
const DRM_WCHAR g_rgwchCertKeyUsageSign                  [] = { WCHAR_CAST('S'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "Sign" */
const DRM_WCHAR g_rgwchCertKeyUsageEncryptKey            [] = { WCHAR_CAST('E'), WCHAR_CAST('n'), WCHAR_CAST('c'), WCHAR_CAST('r'), WCHAR_CAST('y'), WCHAR_CAST('p'), WCHAR_CAST('t'), WCHAR_CAST('K'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('\0')}; /* "EncryptKey" */
const DRM_WCHAR g_rgwchCertKeyUsageSignCRL               [] = { WCHAR_CAST('S'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('C'), WCHAR_CAST('R'), WCHAR_CAST('L'), WCHAR_CAST('\0')}; /* "SignCRL" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerAll             [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('\0')}; /* "IssuerAll" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerIndiv           [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('I'), WCHAR_CAST('n'), WCHAR_CAST('d'), WCHAR_CAST('i'), WCHAR_CAST('v'), WCHAR_CAST('\0')}; /* "IssuerIndiv" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerDevice          [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('D'), WCHAR_CAST('e'), WCHAR_CAST('v'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "IssuerDevice" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerLink            [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('L'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('k'), WCHAR_CAST('\0')}; /* "IssuerLink" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerDomain          [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('D'), WCHAR_CAST('o'), WCHAR_CAST('m'), WCHAR_CAST('a'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "IssuerDomain" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerSilverLight     [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('S'), WCHAR_CAST('i'), WCHAR_CAST('l'), WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('L'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('\0')}; /* "IssuerSilverLight" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerApplication     [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('A'), WCHAR_CAST('p'), WCHAR_CAST('p'), WCHAR_CAST('l'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('a'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "IssuerApplication" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerCRLSigner       [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('C'), WCHAR_CAST('R'), WCHAR_CAST('L'), WCHAR_CAST('S'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "IssuerCRLSigner" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerMetering        [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('M'), WCHAR_CAST('e'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('g'), WCHAR_CAST('\0')}; /* "IssuerMetering" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerKeyFileSigner   [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('K'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('F'), WCHAR_CAST('i'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('S'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "IssuerKeyFileSigner" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerLicenseSigner   [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('L'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('S'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "IssuerLicenseSigner" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerServer          [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('S'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "IssuerServer" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerIndivWindows    [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('I'), WCHAR_CAST('n'), WCHAR_CAST('d'), WCHAR_CAST('i'), WCHAR_CAST('v'), WCHAR_CAST('W'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('d'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('s'), WCHAR_CAST('\0')}; /* "IssuerIndivWindows" */
const DRM_WCHAR g_rgwchCertKeyUsageIssuerIndivOsx        [] = { WCHAR_CAST('I'), WCHAR_CAST('s'), WCHAR_CAST('s'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('I'), WCHAR_CAST('n'), WCHAR_CAST('d'), WCHAR_CAST('i'), WCHAR_CAST('v'), WCHAR_CAST('O'), WCHAR_CAST('s'), WCHAR_CAST('x'), WCHAR_CAST('\0')}; /* "IssuerIndivOsx" */
const DRM_WCHAR g_rgwchCertKeyUsageSignKeyFile           [] = { WCHAR_CAST('S'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('K'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('F'), WCHAR_CAST('i'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "SignKeyFile" */
const DRM_WCHAR g_rgwchCertKeyUsageSignLicense           [] = { WCHAR_CAST('S'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('L'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "SignLicense" */
const DRM_WCHAR g_rgwchCertKeyUsageSignResponse          [] = { WCHAR_CAST('S'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('s'), WCHAR_CAST('p'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "SignResponse" */
const DRM_WCHAR g_rgwchCertSigningKey                    [] = { WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('n'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('g'), WCHAR_CAST('k'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('\0')}; /* "signingkey" */
const DRM_WCHAR g_rgwchCertSigningKeyValue               [] = { WCHAR_CAST('v'), WCHAR_CAST('a'), WCHAR_CAST('l'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "value" */
const DRM_WCHAR g_rgwchPlatformIdentifier                [] = { WCHAR_CAST('p'), WCHAR_CAST('l'), WCHAR_CAST('a'), WCHAR_CAST('t'), WCHAR_CAST('f'), WCHAR_CAST('o'), WCHAR_CAST('r'), WCHAR_CAST('m'), WCHAR_CAST('i'), WCHAR_CAST('d'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('f'), WCHAR_CAST('i'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "platformidentifier" */
const DRM_WCHAR g_rgwchMeteringID                        [] = { WCHAR_CAST('m'), WCHAR_CAST('e'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('i'), WCHAR_CAST('n'), WCHAR_CAST('g'), WCHAR_CAST('i'), WCHAR_CAST('d'), WCHAR_CAST('\0')}; /* "meteringid" */
const DRM_WCHAR g_rgwchOne                               [] = { WCHAR_CAST('1'), WCHAR_CAST('\0')}; /* "1" */
const DRM_WCHAR g_rgwchSigningKeyPrivKeyXPath            [] = { WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('t'), WCHAR_CAST('k'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('/'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('P'), WCHAR_CAST('A'), WCHAR_CAST('I'), WCHAR_CAST('R'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('R'), WCHAR_CAST('I'), WCHAR_CAST('V'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "certkey/KEYPAIR/PRIVKEY" */
const DRM_WCHAR g_rgwchSigningKeyPubKeyXPath             [] = { WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('t'), WCHAR_CAST('k'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('/'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('P'), WCHAR_CAST('A'), WCHAR_CAST('I'), WCHAR_CAST('R'), WCHAR_CAST('/'), WCHAR_CAST('P'), WCHAR_CAST('U'), WCHAR_CAST('B'), WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('\0')}; /* "certkey/KEYPAIR/PUBKEY" */
const DRM_WCHAR g_rgwchSecurityVersionObject             [] = { WCHAR_CAST('s'), WCHAR_CAST('e'), WCHAR_CAST('c'), WCHAR_CAST('u'), WCHAR_CAST('r'), WCHAR_CAST('i'), WCHAR_CAST('t'), WCHAR_CAST('y'), WCHAR_CAST('v'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('\0')}; /* "securityversion" */
const DRM_WCHAR g_rgwchSecurityVersionObjectPlatformId   [] = { WCHAR_CAST('p'), WCHAR_CAST('l'), WCHAR_CAST('a'), WCHAR_CAST('t'), WCHAR_CAST('f'), WCHAR_CAST('o'), WCHAR_CAST('r'), WCHAR_CAST('m'), WCHAR_CAST('_'), WCHAR_CAST('i'), WCHAR_CAST('d'), WCHAR_CAST('\0')}; /* "platform_id" */
const DRM_WCHAR g_rgwchSecurityVersionObjectNumber       [] = { WCHAR_CAST('n'), WCHAR_CAST('u'), WCHAR_CAST('m'), WCHAR_CAST('b'), WCHAR_CAST('e'), WCHAR_CAST('r'), WCHAR_CAST('\0')}; /* "number" */
...
/* WMDRMND/PRIVKEY/Prime0 */
const DRM_WCHAR g_rgwchWMDRMNDPRIVKEYPrime0 [] =  {
    WCHAR_CAST( 'W'), WCHAR_CAST( 'M'), WCHAR_CAST( 'D'), WCHAR_CAST( 'R'),
    WCHAR_CAST( 'M'), WCHAR_CAST( 'N'), WCHAR_CAST( 'D'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'P'), WCHAR_CAST( 'R'), WCHAR_CAST( 'I'), WCHAR_CAST( 'V'),
    WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'P'), WCHAR_CAST( 'r'), WCHAR_CAST( 'i'), WCHAR_CAST( 'm'),
    WCHAR_CAST( 'e'), WCHAR_CAST( '0'), WCHAR_CAST( '\0')
};
const DRM_CONST_STRING g_dstrWMDRMNDPRIVKEYPrime0 = CREATE_DRM_STRING( g_rgwchWMDRMNDPRIVKEYPrime0 );

/* WMDRMND/PRIVKEY/Prime1 */
const DRM_WCHAR g_rgwchWMDRMNDPRIVKEYPrime1 [] =  {
    WCHAR_CAST( 'W'), WCHAR_CAST( 'M'), WCHAR_CAST( 'D'), WCHAR_CAST( 'R'),
    WCHAR_CAST( 'M'), WCHAR_CAST( 'N'), WCHAR_CAST( 'D'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'P'), WCHAR_CAST( 'R'), WCHAR_CAST( 'I'), WCHAR_CAST( 'V'),
    WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'P'), WCHAR_CAST( 'r'), WCHAR_CAST( 'i'), WCHAR_CAST( 'm'),
    WCHAR_CAST( 'e'), WCHAR_CAST( '1'), WCHAR_CAST( '\0')
};
const DRM_CONST_STRING g_dstrWMDRMNDPRIVKEYPrime1 = CREATE_DRM_STRING( g_rgwchWMDRMNDPRIVKEYPrime1 );

/* WMDRMND/PRIVKEY/CRTExponent0 */
const DRM_WCHAR g_rgwchWMDRMNDPRIVKEYCRTExponent0 [] =  {
    WCHAR_CAST( 'W'), WCHAR_CAST( 'M'), WCHAR_CAST( 'D'), WCHAR_CAST( 'R'),
    WCHAR_CAST( 'M'), WCHAR_CAST( 'N'), WCHAR_CAST( 'D'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'P'), WCHAR_CAST( 'R'), WCHAR_CAST( 'I'), WCHAR_CAST( 'V'),
    WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'C'), WCHAR_CAST( 'R'), WCHAR_CAST( 'T'), WCHAR_CAST( 'E'),
    WCHAR_CAST( 'x'), WCHAR_CAST( 'p'), WCHAR_CAST( 'o'), WCHAR_CAST( 'n'),
    WCHAR_CAST( 'e'), WCHAR_CAST( 'n'), WCHAR_CAST( 't'), WCHAR_CAST( '0'),
    WCHAR_CAST( '\0')
};
const DRM_CONST_STRING g_dstrWMDRMNDPRIVKEYCRTExponent0 = CREATE_DRM_STRING( g_rgwchWMDRMNDPRIVKEYCRTExponent0 );

/* WMDRMND/PRIVKEY/CRTExponent1 */
const DRM_WCHAR g_rgwchWMDRMNDPRIVKEYCRTExponent1 [] =  {
    WCHAR_CAST( 'W'), WCHAR_CAST( 'M'), WCHAR_CAST( 'D'), WCHAR_CAST( 'R'),
    WCHAR_CAST( 'M'), WCHAR_CAST( 'N'), WCHAR_CAST( 'D'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'P'), WCHAR_CAST( 'R'), WCHAR_CAST( 'I'), WCHAR_CAST( 'V'),
    WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'C'), WCHAR_CAST( 'R'), WCHAR_CAST( 'T'), WCHAR_CAST( 'E'),
    WCHAR_CAST( 'x'), WCHAR_CAST( 'p'), WCHAR_CAST( 'o'), WCHAR_CAST( 'n'),
    WCHAR_CAST( 'e'), WCHAR_CAST( 'n'), WCHAR_CAST( 't'), WCHAR_CAST( '1'),
    WCHAR_CAST( '\0')
};
const DRM_CONST_STRING g_dstrWMDRMNDPRIVKEYCRTExponent1 = CREATE_DRM_STRING( g_rgwchWMDRMNDPRIVKEYCRTExponent1 );

/* WMDRMND/PRIVKEY/IQMP */
const DRM_WCHAR g_rgwchWMDRMNDPRIVKEYIQMP [] =  {
    WCHAR_CAST( 'W'), WCHAR_CAST( 'M'), WCHAR_CAST( 'D'), WCHAR_CAST( 'R'),
    WCHAR_CAST( 'M'), WCHAR_CAST( 'N'), WCHAR_CAST( 'D'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'P'), WCHAR_CAST( 'R'), WCHAR_CAST( 'I'), WCHAR_CAST( 'V'),
    WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'I'), WCHAR_CAST( 'Q'), WCHAR_CAST( 'M'), WCHAR_CAST( 'P'),
    WCHAR_CAST( '\0')
};
const DRM_CONST_STRING g_dstrWMDRMNDPRIVKEYIQMP = CREATE_DRM_STRING( g_rgwchWMDRMNDPRIVKEYIQMP );

/* DAC160Key/PUBKEY */
const DRM_WCHAR g_rgwchDAC160KeyPUBKEY [] =  {
    WCHAR_CAST( 'D'), WCHAR_CAST( 'A'), WCHAR_CAST( 'C'), WCHAR_CAST( '1'),
    WCHAR_CAST( '6'), WCHAR_CAST( '0'), WCHAR_CAST( 'K'), WCHAR_CAST( 'e'),
    WCHAR_CAST( 'y'), WCHAR_CAST( '/'), WCHAR_CAST( 'P'), WCHAR_CAST( 'U'),
    WCHAR_CAST( 'B'), WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'),
    WCHAR_CAST( '\0')
};
...
const DRM_WCHAR g_rgwchMSBinCert256KeyPUBKEY [] =  {
    WCHAR_CAST( 'M'), WCHAR_CAST( 'S'), WCHAR_CAST( 'B'), WCHAR_CAST( 'i'),
    WCHAR_CAST( 'n'), WCHAR_CAST( 'C'), WCHAR_CAST( 'e'), WCHAR_CAST( 'r'),
    WCHAR_CAST( 't'), WCHAR_CAST( '2'), WCHAR_CAST( '5'), WCHAR_CAST( '6'),
    WCHAR_CAST( 'K'), WCHAR_CAST( 'e'), WCHAR_CAST( 'y'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'P'), WCHAR_CAST( 'U'), WCHAR_CAST( 'B'), WCHAR_CAST( 'K'),
    WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'), WCHAR_CAST( '\0')
};
...
const DRM_WCHAR g_rgwchMSRSA1024CertKeyPUBKEYModulus [] =  {
    WCHAR_CAST( 'M'), WCHAR_CAST( 'S'), WCHAR_CAST( 'R'), WCHAR_CAST( 'S'),
    WCHAR_CAST( 'A'), WCHAR_CAST( '1'), WCHAR_CAST( '0'), WCHAR_CAST( '2'),
    WCHAR_CAST( '4'), WCHAR_CAST( 'C'), WCHAR_CAST( 'e'), WCHAR_CAST( 'r'),
    WCHAR_CAST( 't'), WCHAR_CAST( 'K'), WCHAR_CAST( 'e'), WCHAR_CAST( 'y'),
    WCHAR_CAST( '/'), WCHAR_CAST( 'P'), WCHAR_CAST( 'U'), WCHAR_CAST( 'B'),
    WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'M'), WCHAR_CAST( 'o'), WCHAR_CAST( 'd'), WCHAR_CAST( 'u'),
    WCHAR_CAST( 'l'), WCHAR_CAST( 'u'), WCHAR_CAST( 's'), WCHAR_CAST( '\0')
};
...
const DRM_WCHAR g_rgwchMSRSA1024CertKeyPUBKEYExponent [] =  {
    ...
    WCHAR_CAST( '/'), WCHAR_CAST( 'P'), WCHAR_CAST( 'U'), WCHAR_CAST( 'B'),
    WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'E'), WCHAR_CAST( 'x'), WCHAR_CAST( 'p'), WCHAR_CAST( 'o'),
    WCHAR_CAST( 'n'), WCHAR_CAST( 'e'), WCHAR_CAST( 'n'), WCHAR_CAST( 't'),
    WCHAR_CAST( '\0')
};
...
const DRM_WCHAR g_rgwchDAC160KeyPRIVKEY [] =  {
    WCHAR_CAST( 'D'), WCHAR_CAST( 'A'), WCHAR_CAST( 'C'), WCHAR_CAST( '1'),
    WCHAR_CAST( '6'), WCHAR_CAST( '0'), WCHAR_CAST( 'K'), WCHAR_CAST( 'e'),
    WCHAR_CAST( 'y'), WCHAR_CAST( '/'), WCHAR_CAST( 'P'), WCHAR_CAST( 'R'),
    WCHAR_CAST( 'I'), WCHAR_CAST( 'V'), WCHAR_CAST( 'K'), WCHAR_CAST( 'E'),
    WCHAR_CAST( 'Y'), WCHAR_CAST( '\0')
};
...
const DRM_WCHAR g_rgwchMS160KeyPRIVKEY [] =  {
    WCHAR_CAST( 'M'), WCHAR_CAST( 'S'), WCHAR_CAST( '1'), WCHAR_CAST( '6'),
    WCHAR_CAST( '0'), WCHAR_CAST( 'K'), WCHAR_CAST( 'e'), WCHAR_CAST( 'y'),
    WCHAR_CAST( '/'), WCHAR_CAST( 'P'), WCHAR_CAST( 'R'), WCHAR_CAST( 'I'),
    WCHAR_CAST( 'V'), WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'),
    WCHAR_CAST( '\0')
};
...
const DRM_WCHAR g_rgwchMSBinCert256KeyPRIVKEY [] =  {
    ...
    WCHAR_CAST( 'K'), WCHAR_CAST( 'e'), WCHAR_CAST( 'y'), WCHAR_CAST( '/'),
    WCHAR_CAST( 'P'), WCHAR_CAST( 'R'), WCHAR_CAST( 'I'), WCHAR_CAST( 'V'),
    WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'), WCHAR_CAST( '\0')
};
...
const DRM_WCHAR g_rgwchMSRSA1024CertKeyPRIVKEYPrime0 [] =  {
    ...
    WCHAR_CAST( 'V'), WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'),
    WCHAR_CAST( '/'), WCHAR_CAST( 'P'), WCHAR_CAST( 'r'), WCHAR_CAST( 'i'),
    WCHAR_CAST( 'm'), WCHAR_CAST( 'e'), WCHAR_CAST( '0'), WCHAR_CAST( '\0')
};
...
const DRM_WCHAR g_rgwchMSRSA1024CertKeyPRIVKEYPrime1 [] =  {
    ...
    WCHAR_CAST( 'V'), WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'),
    WCHAR_CAST( '/'), WCHAR_CAST( 'P'), WCHAR_CAST( 'r'), WCHAR_CAST( 'i'),
    WCHAR_CAST( 'm'), WCHAR_CAST( 'e'), WCHAR_CAST( '1'), WCHAR_CAST( '\0')
};
...
const DRM_WCHAR g_rgwchMSRSA1024CertKeyPRIVKEYCRTExponent0 [] =  {
    ...
    WCHAR_CAST( '/'), WCHAR_CAST( 'P'), WCHAR_CAST( 'R'), WCHAR_CAST( 'I'),
    WCHAR_CAST( 'V'), WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'),
    WCHAR_CAST( '/'), WCHAR_CAST( 'C'), WCHAR_CAST( 'R'), WCHAR_CAST( 'T'),
    WCHAR_CAST( 'E'), WCHAR_CAST( 'x'), WCHAR_CAST( 'p'), WCHAR_CAST( 'o'),
    WCHAR_CAST( 'n'), WCHAR_CAST( 'e'), WCHAR_CAST( 'n'), WCHAR_CAST( 't'),
    WCHAR_CAST( '0'), WCHAR_CAST( '\0')
};
...
const DRM_WCHAR g_rgwchMSRSA1024CertKeyPRIVKEYIQMP [] =  {
    ...
    WCHAR_CAST( '/'), WCHAR_CAST( 'P'), WCHAR_CAST( 'R'), WCHAR_CAST( 'I'),
    WCHAR_CAST( 'V'), WCHAR_CAST( 'K'), WCHAR_CAST( 'E'), WCHAR_CAST( 'Y'),
    WCHAR_CAST( '/'), WCHAR_CAST( 'I'), WCHAR_CAST( 'Q'), WCHAR_CAST( 'M'),
    WCHAR_CAST( 'P'), WCHAR_CAST( '\0')
};
...
*/
const DRM_WCHAR      g_rgwchTagV24LAURL     [] =  { WCHAR_CAST('L'), WCHAR_CAST('A'), WCHAR_CAST('_'), WCHAR_CAST('U'), WCHAR_CAST('R'), WCHAR_CAST('L'), WCHAR_CAST('\0')}; /* "LA_URL" */
const DRM_WCHAR      g_rgwchTagV24LUIURL    [] =  { WCHAR_CAST('L'), WCHAR_CAST('U'), WCHAR_CAST('I'), WCHAR_CAST('_'), WCHAR_CAST('U'), WCHAR_CAST('R'), WCHAR_CAST('L'), WCHAR_CAST('\0')}; /* "LUI_URL" */
...
DRM_SCOPE g_Scopes[] =
{
    ...
    {"DRM_BBX_Legacy_SymmetricCipher", PERF_SCOPE_ID(PERF_MOD_BLACKBOX, PERF_FUNC_DRM_BBX_Legacy_SymmetricCipher, 1), 0, 0},
    ...
    {"DRM_WMDRMDLA_CreateChallenge", PERF_SCOPE_ID(PERF_MOD_DRMLICACQREQ, PERF_FUNC_DRM_LA_CreateChallenge, 1), 0, 0},
    {"DRM_WMDRMDLA_GetClientInfo", PERF_SCOPE_ID(PERF_MOD_DRMLICACQREQ, PERF_FUNC_DRM_LA_GetClientInfo, 1), 0, 0},
    ...
    {"DRM_ACT_GenerateChallengeInternal", PERF_SCOPE_ID( PERF_MOD_ACTIVATION, PERF_FUNC_DRM_ACT_GenerateChallengeInternal, 1), 0, 0},
    {"DRM_ACT_ProcessWSDLResponseInternal", PERF_SCOPE_ID( PERF_MOD_ACTIVATION, PERF_FUNC_DRM_ACT_ProcessWSDLResponseInternal, 1), 0, 0},
    ...
    /* RSA */
    /* oem\common\RSA\... */
    {"OEM_RSA_OaepDecrypt_2048BIT", PERF_SCOPE_ID(PERF_MOD_RSA, PERF_FUNC_OEM_RSA_OaepDecrypt_2048BIT, 1), 0, 0},
    {"OEM_RSA_OaepDecrypt_4096BIT", PERF_SCOPE_ID(PERF_MOD_RSA, PERF_FUNC_OEM_RSA_OaepDecrypt_4096BIT, 1), 0, 0},
    {"OEM_RSA_OaepEncrypt_2048BIT", PERF_SCOPE_ID(PERF_MOD_RSA, PERF_FUNC_OEM_RSA_OaepEncrypt_2048BIT, 1), 0, 0},
    {"OEM_RSA_OaepEncrypt_4096BIT", PERF_SCOPE_ID(PERF_MOD_RSA, PERF_FUNC_OEM_RSA_OaepEncrypt_4096BIT, 1), 0, 0},
    {"OEM_RSA_PssSign_2048BIT", PERF_SCOPE_ID(PERF_MOD_RSA, PERF_FUNC_OEM_RSA_PssSign_2048BIT, 1), 0, 0},
    {"OEM_RSA_PssSign_4096BIT", PERF_SCOPE_ID(PERF_MOD_RSA, PERF_FUNC_OEM_RSA_PssSign_4096BIT, 1), 0, 0},
    {"OEM_RSA_PssVerify_2048BIT", PERF_SCOPE_ID(PERF_MOD_RSA, PERF_FUNC_OEM_RSA_PssVerify_2048BIT, 1), 0, 0},
    {"OEM_RSA_PssVerify_4096BIT", PERF_SCOPE_ID(PERF_MOD_RSA, PERF_FUNC_OEM_RSA_PssVerify_4096BIT, 1), 0, 0},
    ...
    { "OEM_RSA_SetPublicKey_2048BIT", PERF_SCOPE_ID( PERF_MOD_RSA, PERF_FUNC_OEM_RSA_SetPublicKey_2048BIT, 1 ), 0, 0 },
    { "OEM_RSA_SetPrivateKey_2048BIT", PERF_SCOPE_ID( PERF_MOD_RSA, PERF_FUNC_OEM_RSA_SetPrivateKey_2048BIT, 1 ), 0, 0 },
    { "OEM_RSA_ParsePublicKey_2048BIT", PERF_SCOPE_ID( PERF_MOD_RSA, PERF_FUNC_OEM_RSA_ParsePublicKey_2048BIT, 1 ), 0, 0 },
    { "OEM_RSA_ZeroPublicKey_2048BIT", PERF_SCOPE_ID( PERF_MOD_RSA, PERF_FUNC_OEM_RSA_ZeroPublicKey_2048BIT, 1 ), 0, 0 },
    { "OEM_RSA_ZeroPrivateKey_2048BIT", PERF_SCOPE_ID( PERF_MOD_RSA, PERF_FUNC_OEM_RSA_ZeroPrivateKey_2048BIT, 1 ), 0, 0 },
    { "_ModularExponentiate", PERF_SCOPE_ID( PERF_MOD_RSA, PERF_FUNC__ModularExponentiate, 1 ), 0, 0 },
    { "OEM_RSA_Decrypt_2048BIT", PERF_SCOPE_ID( PERF_MOD_RSA, PERF_FUNC_OEM_RSA_Decrypt_2048BIT, 1 ), 0, 0 },
...
const                DRM_WCHAR      g_rgwchTagOEMPrivateKeys                     [] =  { WCHAR_CAST('O'), WCHAR_CAST('E'), WCHAR_CAST('M'), WCHAR_CAST('P'), WCHAR_CAST('r'), WCHAR_CAST('i'), WCHAR_CAST('v'), WCHAR_CAST('a'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('K'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('s'), WCHAR_CAST('\0')}; /* "OEMPrivateKeys" */
const                DRM_WCHAR      g_rgwchTagKeyValue                           [] =  { WCHAR_CAST('K'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('V'), WCHAR_CAST('a'), WCHAR_CAST('l'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "KeyValue" */
const                DRM_WCHAR      g_rgwchTagRSAKeyValue                        [] =  { WCHAR_CAST('R'), WCHAR_CAST('S'), WCHAR_CAST('A'), WCHAR_CAST('K'), WCHAR_CAST('e'), WCHAR_CAST('y'), WCHAR_CAST('V'), WCHAR_CAST('a'), WCHAR_CAST('l'), WCHAR_CAST('u'), WCHAR_CAST('e'), WCHAR_CAST('\0')}; /* "RSAKeyValue" */
const                DRM_WCHAR      g_rgwchVersion_1_0                           [] =  { WCHAR_CAST('1'), WCHAR_CAST('.'), WCHAR_CAST('0'), WCHAR_CAST('\0')}; /* "1.0" */
const                DRM_WCHAR      g_rgwchTagFallback                           [] =  { WCHAR_CAST('F'), WCHAR_CAST('A'), WCHAR_CAST('L'), WCHAR_CAST('L'), WCHAR_CAST('B'), WCHAR_CAST('A'), WCHAR_CAST('C'), WCHAR_CAST('K'), WCHAR_CAST('\0')}; /* "FALLBACK" */
const                DRM_WCHAR      g_rgwchTagDNIUniqueID                        [] =  { WCHAR_CAST('U'), WCHAR_CAST('N'), WCHAR_CAST('I'), WCHAR_CAST('Q'), WCHAR_CAST('U'), WCHAR_CAST('E'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('\0')}; /* "UNIQUEID" */
const                DRM_WCHAR      g_rgwchDeviceRevocationList                  [] =  { WCHAR_CAST('D'), WCHAR_CAST('e'), WCHAR_CAST('v'), WCHAR_CAST('i'), WCHAR_CAST('c'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('v'), WCHAR_CAST('o'), WCHAR_CAST('c'), WCHAR_CAST('a'), WCHAR_CAST('t'), WCHAR_CAST('i'), WCHAR_CAST('o'), WCHAR_CAST('n'), WCHAR_CAST('L'), WCHAR_CAST('i'), WCHAR_CAST('s'), WCHAR_CAST('t'), WCHAR_CAST('\0')}; /* "DeviceRevocationList" */
const                DRM_WCHAR      g_rgwchPFRootTag                             [] =  { WCHAR_CAST('K'), WCHAR_CAST('E'), WCHAR_CAST('Y'), WCHAR_CAST('D'), WCHAR_CAST('A'), WCHAR_CAST('T'), WCHAR_CAST('A'), WCHAR_CAST('\0')}; /* "KEYDATA" */
const                DRM_WCHAR      g_rgwchTagSecurityLevel                      [] =  { WCHAR_CAST('S'), WCHAR_CAST('E'), WCHAR_CAST('C'), WCHAR_CAST('U'), WCHAR_CAST('R'), WCHAR_CAST('I'), WCHAR_CAST('T'), WCHAR_CAST('Y'), WCHAR_CAST('L'), WCHAR_CAST('E'), WCHAR_CAST('V'), WCHAR_CAST('E'), WCHAR_CAST('L'), WCHAR_CAST('\0')}; /* "SECURITYLEVEL" */
const                DRM_WCHAR      g_rgwchTagDataId                             [] =  { WCHAR_CAST('A'), WCHAR_CAST('U'), WCHAR_CAST('T'), WCHAR_CAST('H'), WCHAR_CAST('_'), WCHAR_CAST('I'), WCHAR_CAST('D'), WCHAR_CAST('\0')}; /* "AUTH_ID" */
const                DRM_WCHAR      g_rgwchManufacturer                          [] =  { WCHAR_CAST('M'), WCHAR_CAST('A'), WCHAR_CAST('N'), WCHAR_CAST('U'), WCHAR_CAST('F'), WCHAR_CAST('A'), WCHAR_CAST('C'), WCHAR_CAST('T'), WCHAR_CAST('U'), WCHAR_CAST('R'), WCHAR_CAST('E'), WCHAR_CAST('R'), WCHAR_CAST('\0')}; /* "MANUFACTURER" */
const                DRM_WCHAR      g_rgwchModel                                 [] =  { WCHAR_CAST('M'), WCHAR_CAST('O'), WCHAR_CAST('D'), WCHAR_CAST('E'), WCHAR_CAST('L'), WCHAR_CAST('\0')}; /* "MODEL" */
const                DRM_WCHAR      g_rgwchUnsignedtemplate                      [] =  { WCHAR_CAST('U'), WCHAR_CAST('N'), WCHAR_CAST('S'), WCHAR_CAST('I'), WCHAR_CAST('G'), WCHAR_CAST('N'), WCHAR_CAST('E'), WCHAR_CAST('D'), WCHAR_CAST('T'), WCHAR_CAST('E'), WCHAR_CAST('M'), WCHAR_CAST('P'), WCHAR_CAST('L'), WCHAR_CAST('A'), WCHAR_CAST('T'), WCHAR_CAST('E'), WCHAR_CAST('\0')}; /* "UNSIGNEDTEMPLATE" */
const                DRM_WCHAR      g_rgwchTagDataSecVerNumber                   [] =  { WCHAR_CAST('N'), WCHAR_CAST('U'), WCHAR_CAST('M'), WCHAR_CAST('B'), WCHAR_CAST('E'), WCHAR_CAST('R'), WCHAR_CAST('\0')}; /* "NUMBER" */
const                DRM_WCHAR      g_rgwchLicenseTag                            [] =  { WCHAR_CAST('L'), WCHAR_CAST('I'), WCHAR_CAST('C'), WCHAR_CAST('E'), WCHAR_CAST('N'), WCHAR_CAST('S'), WCHAR_CAST('E'), WCHAR_CAST('\0')}; /* "LICENSE" */
const                DRM_WCHAR      g_rgwchTagName                               [] =  { WCHAR_CAST('N'), WCHAR_CAST('A'), WCHAR_CAST('M'), WCHAR_CAST('E'), WCHAR_CAST('\0')}; /* "NAME" */
