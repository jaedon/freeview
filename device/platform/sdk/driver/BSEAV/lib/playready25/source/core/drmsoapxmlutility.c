...
#define DRM_BUILDING_DRMSOAPXMLUTILITY_C
#include <drmtypes.h>
    ...
    if ( f_fB64Encoded )
    {
         ...
         */
         ...
         else
         {
             ...
             dr = DRM_B64_EncodeA( (const DRM_BYTE *)f_pchDeviceCert,
                                   cbBuffer,
    ...
    __inout  DRM_CRYPTO_CONTEXT   *f_pCryptoCtx )
{
    ...
    */
    ...
    OEM_SECURE_MEMCPY( f_poXMLKey->m_oAESKey.m_oClearAESKey.m_rgbPaddedAESKey,
    ...
    __inout     DRM_CRYPTO_CONTEXT      *f_pCryptoCtx )
{
    ...
    */
    OEM_SECURE_MEMCPY( oPlainText.m_rgbPlaintext,
    ...
    OEM_SECURE_MEMCPY( f_poXMLKey->m_oAESKey.m_rgbCipherAESKey,
    ...
    __inout                                DRM_DWORD  *f_pcchDataString )
{
    ...
    const DRM_ANSI_CONST_STRING *pdastrDataStringPath = NULL;
    ...
    */
    ...
    switch ( f_dwDataType )
    {
        case DRM_GARD_REDIRECT_URL:
            pdastrDataStringPath = &g_dastrSOAPGARDRedirectUrlPath;
            break;

        case DRM_GARD_SERVICE_ID:
            pdastrDataStringPath = &g_dastrSOAPGARDServiceIdPath;
            break;

        case DRM_GARD_ACCOUNT_ID:
            pdastrDataStringPath = &g_dastrSOAPGARDAccountIdPath;
            break;
    ...
    __inout                             DRM_DWORD           *f_pdwProtocolType )
{
    ...
    OEM_SECURE_MEMSET( &oParsedPubKey, 0, SIZEOF(oParsedPubKey) ); 
                ...
                if ( DRM_SUCCEEDED( dr ) )
                {
                    ...
                    ChkDR( DRM_BCert_GetPublicKeyByUsage(
                        ...
                        *f_pdwProtocolType == DRM_SOAPXML_PROTOCOL_LIC_ACQ_RESPONSE || *f_pdwProtocolType == DRM_SOAPXML_PROTOCOL_DOMAIN_JOIN_RESPONSE ?
                            (DRM_DWORD)DRM_BCERT_KEYUSAGE_SIGN_RESPONSE :
                            (DRM_DWORD)DRM_BCERT_KEYUSAGE_UNKNOWN,
                        &oParsedPubKey,
                        NULL,
                        NULL,
                        NULL ) );
...
**
**********************************************************************/
DRM_API DRM_NO_INLINE DRM_DWORD DRM_CALL DRM_SOAPXML_CalcClientInfo(
