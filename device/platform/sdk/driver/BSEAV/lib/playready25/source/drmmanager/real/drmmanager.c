...
#define DRM_BUILDING_DRMMANAGER_C
...
static DRMFORCEINLINE DRM_VOID _drmapp_casserts( DRM_VOID )
{
    ...
    __in           DRM_DST         *f_pDatastore )
{
    ...
    ChkDR( DRM_SizeTToDWord( DRMCRT_wcslen( f_pwszDeviceStoreName ) * SIZEOF( DRM_WCHAR ), &cbLen ) );
    ...
    dr = DRM_DST_CreateStore( f_pOEMContext,
                              ( const DRM_BYTE * )f_pwszDeviceStoreName,
                              cbLen,
                              dwHDSBlockSize,
...
ErrorExit:
    ...
    if( DRM_FAILED( dr ) )
    {
        TRACE( ( "_CreateDeviceStore(): Device store cannot be created.  dr=0x%x\n", dr ) );
    }
...
static DRM_BOOL _IsEmptyV41Header(
    ...
    __out       DRM_BOOL                  *f_pfEmptyV41Header )
{
    DRM_RESULT dr = DRM_SUCCESS;
    ...
    __in DRM_APP_CONTEXT_INTERNAL *f_poAppContextInternal )
{
    ...
    ChkDR( DRM_DDC_GetXMLDeviceCertificate(
                ...
                f_poAppContextInternal->pKeyFileContext,
...
** Returns:                 DRM_SUCCESS on success.
**                          DRM_E_INVALIDARG if the arguments are invalid.
**                          DRM_E_SYNC_ENTRY_NOT_FOUND if content header
**                          cannot be found.
**
**********************************************************************/
    ...
    __in DRM_APP_CONTEXT *f_poAppContext )
{
    ...
    if( DRM_SNC_IsLicenseSyncSupported() )
    {
        ...
        if ( cchHeader == 0 )
        {
            ...
            ChkDR( DRM_E_SYNC_ENTRY_NOT_FOUND );
        }
        ...
        dstrHeader.pwszString = ( const DRM_WCHAR * )poAppContextInternal->pbDRMHeaderData;
...
static DRM_BOOL _IsV2LicenseResponse(
    __in_ecount(f_cbResponse) DRM_BYTE *f_pbResponse,
    ...
    __in                            DRM_DWORD                    f_cbOpaqueBuffer )
{
    ...
    __analysis_assume( f_poAppContextInternal != NULL );
...
#define DRM_NONVAULTSIGNING_IsNonVaultSigningUnsupported() FALSE
#else   /* DRM_SUPPORT_NONVAULTSIGNING */
#define DRM_NONVAULTSIGNING_IsNonVaultSigningUnsupported() TRUE
#endif  /* DRM_SUPPORT_NONVAULTSIGNING */

static DRM_RESULT _VerifySupportedFeatureConsistency()
{
    DRM_RESULT dr = DRM_SUCCESS;

    /* Activation support blocks these features */
    AssertChkFeature( DRM_ACTIVATION_IsActivationUnsupported() || DRM_DDC_IsDevCertKeyGenUnsupported() );
    AssertChkFeature( DRM_ACTIVATION_IsActivationUnsupported() || DRM_CERTPARSERCACHE_IsCertParserCacheUnsupported() );
    AssertChkFeature( DRM_ACTIVATION_IsActivationUnsupported() || DRM_WMDRM_IsWMDRMUnsupported() );
    AssertChkFeature( DRM_ACTIVATION_IsActivationUnsupported() || DRM_NONVAULTSIGNING_IsNonVaultSigningUnsupported() );

    /* View rights support is required for these features */
    AssertChkFeature( DRM_VIEWRIGHTS_IsViewRightsSupported() || DRM_SNC_IsLicenseSyncUnsupported() );
    AssertChkFeature( DRM_VIEWRIGHTS_IsViewRightsSupported() || DRM_DELETEDSTORE_IsDeletedStoreUnsupported() );

    /* WMDRM support is required for these features */
    AssertChkFeature( DRM_WMDRM_IsWMDRMSupported() || DRM_WMDRMDLA_IsWMDRMDLAUnsupported() );
    AssertChkFeature( DRM_WMDRM_IsWMDRMSupported() || DRM_CONTENTREVOCATION_IsContentRevocationUnsupported() );
    AssertChkFeature( DRM_WMDRM_IsWMDRMSupported() || DRM_CERTPARSERCACHE_IsCertParserCacheUnsupported() );

    /* Lic gen support requires these features */
    AssertChkFeature( DRM_LICGEN_IsLicGenUnsupported() || DRM_PRND_IsPRNDTransmitterSupported() );

    /* PRND Transmitter support requires these features */
    AssertChkFeature( DRM_PRND_IsPRNDTransmitterUnsupported() || ( DRM_ARCLK_IsAntirollbackClockSupported() || DRM_CLK_IsSecureClockSupported() ) );

    /* Secure Clock Extern support blocks these features */
    AssertChkFeature( DRM_CLK_IsSecureClockExternUnsupported() || DRM_WMDRM_IsWMDRMUnsupported() );

    /* Device asset support is required for these features */
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_ACTIVATION_IsActivationUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_ARCLK_IsAntirollbackClockUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_APPP_IsAppPolicyUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_CERTCACHE_IsCertCacheUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_DDC_IsDevCertKeyGenUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_DVS_IsDeviceStoreUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_DOMAIN_IsDomainUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_SNC_IsLicenseSyncUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_METERING_IsMeteringUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_MOVE_IsMoveUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_PRND_IsPRNDReceiverUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || ( DRM_CLK_IsSecureClockUnsupported() || DRM_CLK_IsSecureClockExternSupported() ) );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_SYMOPT_IsSymOptUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_VIEWRIGHTS_IsViewRightsUnsupported() );
    AssertChkFeature( DRM_DEVICEASSETS_IsDeviceAssetsSupported() || DRM_WMDRM_IsWMDRMUnsupported() );

    /* Legacy crypto is required for these features */
    AssertChkFeature( DRM_BBX_IsLegacyCryptoSupported() || DRM_WMDRM_IsWMDRMUnsupported() );

#if DRM_SUPPORT_SECUREOEMHAL
    /* None of these features are compatible with a secure HAL */
    AssertChkFeature( DRM_WMDRM_IsWMDRMUnsupported() );
    AssertChkFeature( DRM_BBX_IsLegacyCryptoUnsupported() );
    AssertChkFeature( DRM_BBX_IsSlkCryptoUnsupported() );
    AssertChkFeature( DRM_SYMOPT_IsSymOptUnsupported() );
#endif /* DRM_SUPPORT_SECUREOEMHAL */

#if DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY
#if !DRM_SUPPORT_SECUREOEMHAL
#error "DRM_SUPPORT_SECUREOEMHAL_PLAY_ONLY requires DRM_SUPPORT_SECUREOEMHAL."
#endif  /* !DRM_SUPPORT_SECUREOEMHAL */
    /* None of these features are compatible with a play-only PK */
    AssertChkFeature( DRM_CERTPARSERCACHE_IsCertParserCacheUnsupported() );
    AssertChkFeature( DRM_SNC_IsLicenseSyncUnsupported() );
    AssertChkFeature( DRM_LICGEN_IsLicGenUnsupported() );
    AssertChkFeature( DRM_M2TS_IsM2TSEncryptorUnsupported() );
    AssertChkFeature( DRM_PRND_IsPRNDTransmitterUnsupported() );
    AssertChkFeature( DRM_SYMOPT_IsSymOptUnsupported() );
    AssertChkFeature( DRM_WMDRMNET_IsWmdrmnetUnsupported() );
...
#ifdef TEE
DRM_RESULT DRM_CALL _InitTeeState()
{
    DRM_RESULT dr = DRM_SUCCESS;

    if (Drm_SupportSecureStop() && Drm_IsSecureStopOn()) {
        DRM_BYTE state[TEE_MAX_STATE_SIZE];
        DRM_DWORD stateLen = TEE_MAX_STATE_SIZE;
        if (Oem_ReadTeeState(state, &stateLen) == DRM_SUCCESS) {
            ChkDR(TEE_Initialize(state, stateLen));
        } else {
            ChkDR(TEE_Initialize(NULL, 0));
        }
        unsigned char ids[TEE_MAX_NUM_SECURE_STOPS][TEE_SESSION_ID_LEN];
        DRM_DWORD num = TEE_MAX_NUM_SECURE_STOPS;
        ChkDR(TEE_GetSecureStopIds(ids, &num));
    } else {
        ChkDR(TEE_Initialize(NULL, 0));
    }
...
{
    DRM_RESULT dr = DRM_SUCCESS;
    DRMASSERT( f_pdstrDeviceStoreName != NULL );
    ...
    __out_bcount( SHA256_DIGEST_SIZE_IN_BYTES ) DRM_BYTE *f_pbSecureStoreHash )
{
    DRM_RESULT dr = DRM_SUCCESS;
    DRMASSERT( f_pdstrDeviceStoreName != NULL );
    DRMASSERT( f_pbSecureStoreHash != NULL );
    if ( !Oem_File_GetHash( f_pdstrDeviceStoreName->pwszString, f_pbSecureStoreHash ) )
    {
...
DRM_API DRM_RESULT DRM_CALL Drm_GetKeyStoreHash( __out_bcount( SHA256_DIGEST_SIZE_IN_BYTES ) DRM_BYTE *f_pbKeyFileHash )
{
    DRM_RESULT dr = DRM_SUCCESS;
    DRMASSERT( f_pbKeyFileHash != NULL );
    ChkDR( Oem_Keyfile_GetHash( f_pbKeyFileHash ) );
ErrorExit:
    return dr;
}
#endif //TEE
...
**
** Returns:                 DRM_SUCCESS on success.
**                          DRM_E_NEED_DEVCERT_INDIV if the device needs to be
**                              individualized.
**                          DRM_E_INVALIDARG if any parameter is incorrect.
**                          DRM_E_BCERT_INVALID_FEATURE if the Porting Kit
**                              was linked with mutually incompatible features
**                              or features incompatible with the certificate.
    ...
    __in                              const DRM_CONST_STRING    *f_pdstrDeviceStoreName )
{
    ...
    ChkDR( _VerifySupportedFeatureConsistency() );
    ...
    **
    */
    ChkDR( DRM_BBX_Initialize( f_pOEMContext, &poAppContextInternal->oBlackBoxContext ) );
    ...
    if( DRM_DEVICEASSETS_IsDeviceAssetsSupported() )
    {
        ChkDR( Oem_Keyfile_Initialize( poAppContextInternal ) );
        ChkDR( DRM_KF_Initialize( f_pOEMContext, poAppContextInternal->pKeyFileContext ) );
        poAppContextInternal->oBlackBoxContext.pKeyFileContext = poAppContextInternal->pKeyFileContext;
    }
    ...
    */
    ...
    {
        ChkDR( DRM_CLK_CheckSecureClock( poAppContextInternal ) );
    }
	...
	DRM_BYTE hash[SHA256_DIGEST_SIZE_IN_BYTES];
	ChkDR( Drm_GetSecureStoreHash(f_pdstrDeviceStoreName, hash) );
	_print_hex("Secure Store Hash", hash, SHA256_DIGEST_SIZE_IN_BYTES);
	ChkDR( Drm_GetKeyStoreHash(hash) );
	_print_hex("Key    Store Hash", hash, SHA256_DIGEST_SIZE_IN_BYTES);
	ChkDR(_InitTeeState());
...
** [f_pcbOpaqueBuffer]      -- OpaqueBuffer size set when calling Drm_Initialize or Drm_ResizeOpaqueBuffer
**
** Returns:                 DRM_SUCCESS on success or failed with.
**                          DRM_E_INVALIDARG if any parameter is incorrect.
**
    ...
    __out                                   DRM_DWORD           *f_pcbOpaqueBuffer )
{
    ...
    ChkArg( f_pcbOpaqueBuffer != NULL );

    *f_ppbOpaqueBuffer = poAppContextInternal->pbOpaqueBuffer;
    *f_pcbOpaqueBuffer = poAppContextInternal->cbOpaqueBuffer;
    ...
    __in DRM_APP_CONTEXT *f_poAppContext )
{
    DRM_RESULT                dr                   = DRM_SUCCESS;
    DRM_APP_CONTEXT_INTERNAL *poAppContextInternal = ( DRM_APP_CONTEXT_INTERNAL * )f_poAppContext;
    const DRM_VOID           *pOEMContext          = NULL;

    DRM_PROFILING_ENTER_SCOPE( PERF_MOD_DRM_APP, PERF_FUNC_Drm_Uninitialize );

#ifdef TEE
	ChkDR(TEE_Uninitialize());
#endif


    ChkArg( f_poAppContext != NULL );

    pOEMContext = poAppContextInternal->pOEMContext;
    ...
    {
        ( DRM_VOID )Drm_Prnd_Receiver_EndSession( f_poAppContext );
    }

    if ( DRM_PRND_IsPRNDTransmitterSupported() )
    {
        ( DRM_VOID )Drm_Prnd_Transmitter_EndSession( f_poAppContext );
    }

    if ( DRM_LICGEN_IsLicGenSupported() )
    {
        ( DRM_VOID )DRM_LOCALLICENSE_CleanCache( f_poAppContext );
    }

    /* returns void */
    DRM_PRND_ClosePRNDStore(
        &poAppContextInternal->oLSTContextPRNDRxStore,
        &poAppContextInternal->oDSTContextPRNDRxStore,
        &poAppContextInternal->oESTContextPRNDRxStore,
        poAppContextInternal->rgbPRNDRxStore,
        SIZEOF( poAppContextInternal->rgbPRNDRxStore ),
        &poAppContextInternal->fPRNDRxLSTOpened );
    ...
    ( DRM_VOID )DRM_KF_Uninitialize( poAppContextInternal->pKeyFileContext );
    ...
    ( DRM_VOID )Oem_Keyfile_Uninitialize( poAppContextInternal );

    ( DRM_VOID )DRM_BBX_Shutdown( &poAppContextInternal->oBlackBoxContext );
...
ErrorExit:
    ...
    Oem_CodeCoverage_FlushData( pOEMContext );
...
static DRM_RESULT _AutoDetectHeader(
    __in_ecount(f_cbPropertyData) const DRM_BYTE                 *f_pbPropertyData,
    __in                                DRM_DWORD                 f_cbPropertyData,
    __out                               DRM_CONTENT_SET_PROPERTY *f_peProperty )
{
    DRM_RESULT          dr                            = DRM_S_FALSE;
    DRM_CONST_STRING    dstrHeader                    = EMPTY_DRM_STRING;
    eDRM_HEADER_VERSION eHeaderVersion                = DRM_HEADER_VERSION_UNKNOWN;
    DRM_DWORD           dwRecordTypes                 = 0;
    ...
    *f_peProperty = DRM_CSP_HEADER_NOT_SET;
    ...
    if ( f_cbPropertyData == CCH_BASE64_EQUIV( SIZEOF( DRM_GUID ) ) * SIZEOF( DRM_WCHAR ) )
    {
        if( CCH_BASE64_EQUIV( SIZEOF( DRM_GUID ) ) * SIZEOF( DRM_WCHAR ) == SIZEOF( DRM_CSP_V1_HEADER_DATA ) )
        {
            ...
            dstrKID.pwszString = (const DRM_WCHAR*)f_pbPropertyData;
    ...
    if (      ( DRM_PRO_IsValidObject( f_pbPropertyData, f_cbPropertyData, &dwRecordTypes ) == DRM_SUCCESS )
           && ( dwRecordTypes != 0 ) )
    {
    ...
    {
        const DRM_CSP_PLAYREADY_OBJ_WITH_KID_DATA *pPROWithKID  = (const DRM_CSP_PLAYREADY_OBJ_WITH_KID_DATA*) f_pbPropertyData;

        if   ( pPROWithKID->cbKeyID == CCH_BASE64_EQUIV( SIZEOF( DRM_GUID ) ) * SIZEOF( DRM_WCHAR )
          && ( DRM_PRO_IsValidObject( pPROWithKID->pbHeaderData, pPROWithKID->cbHeaderData, &dwRecordTypes ) == DRM_SUCCESS )
          && ( dwRecordTypes != 0 ) )
        {
    ...
    if ( f_cbPropertyData % SIZEOF( DRM_WCHAR ) == 0 )
    {
        ...
        {
            dstrHeader.pwszString = ( const DRM_WCHAR * ) f_pbPropertyData;
    ...
    __in                                      DRM_DWORD                 f_cbPropertyData )
{
    ...
    {
        const DRM_CSP_V1_HEADER_DATA *pHeaderData = ( const DRM_CSP_V1_HEADER_DATA * )f_pbPropertyData;
PREFAST_PUSH_DISABLE_EXPLAINED(__WARNING_NONCONST_LOCAL, "Local is modified and can not be const.  Prefast is incorrect.")
...
PREFAST_POP
    ...
    {
        const DRM_CSP_PLAYREADY_OBJ_WITH_KID_DATA *pHeaderData = ( const DRM_CSP_PLAYREADY_OBJ_WITH_KID_DATA*) f_pbPropertyData;
    ...
    else if ( eProperty == DRM_CSP_HEADER_COMPONENTS )
    {
        ...
        const DRM_CSP_HEADER_COMPONENTS_DATA *pHeaderData = ( const DRM_CSP_HEADER_COMPONENTS_DATA*) f_pbPropertyData;
...
static DRM_RESULT _GetUplinkState(
    ...
    __in       DRM_DWORD                f_iKID,
    __inout    DRM_LICENSE_CHALLENGE   *f_plicensechallenge,
    __in       DRM_VIEW_RIGHTS_CONTEXT *f_pcontextVR,
    __in       DRM_DST                 *f_pDatastore )
{
    DRM_RESULT              dr                 = DRM_SUCCESS;
...
static DRM_RESULT _GenerateLicenseChallengeV2(
    __in                                    DRM_APP_CONTEXT   *f_poAppContext,
    __in_opt const                          DRM_CONST_STRING **f_ppdstrRights, /* Array of DRM_CONST_STRING pointers */
    ...
    __inout                                 DRM_DWORD         *f_pcchChallenge )
{
    ...
    */
    ...
    dr = DRM_WMDRMDLA_CreateChallenge( &poAppContextInternal->licensechallenge,
                                        NULL,
                                       &cbChallenge );
    ...
    ChkDR( DRM_WMDRMDLA_CreateChallenge( &poAppContextInternal->licensechallenge,
                                          f_pszChallenge,
                                         &cbChallenge ) );
...
static DRM_RESULT _GetLicenseState(
    ...
    __in                         DRM_DWORD                f_cRights,
    __in                   const DRM_STRING              *f_pdstrKID,
    __in                         DRM_VIEW_RIGHTS_CONTEXT *f_poViewRightsContext,
    __in                         DRM_DST                 *f_poDatastore,
    __out                        DRM_LICENSE_STATE_DATA  *f_poLicStateData )
{
    DRM_RESULT dr = DRM_SUCCESS;
    ...
    __in                         DRM_DWORD               f_cRights )
{
    ...
    */
    if ( !fUplinkAvailable )
    {
        const DRM_XMR_LICENSE      *pXmrLicense = NULL;
...
static DRM_RESULT _PrepareLicenseChallenge(
    ...
    __out                                  DRM_LICCHLG_CONTEXT_V3 *f_poLicChlgContext )
{
    DRM_RESULT                dr                   = DRM_SUCCESS;
    DRM_APP_CONTEXT_INTERNAL *poAppContextInternal = ( DRM_APP_CONTEXT_INTERNAL * )f_poAppContext;
...
**                             and f_pcchSilentURL should be NULL too.  If this
**                             parameter is NULL and f_pcchSilentURL is non-NULL,
**                             the size is returned in *f_pcchSilentURL and
**                             the function returns DRM_E_BUFFERTOOSMALL.
...
**                             URL to be parsed out, this parameter should be NULL
**                             and f_pcchNonSilentURL should be NULL too.  If this
**                             parameter is NULL and f_pcchSilentURL is non-NULL,
**                             the size is returned in *f_pcchNonSilentURL and
**                             the function returns DRM_E_BUFFERTOOSMALL.
    ...
    __inout                                       DRM_DWORD        *f_pcbChallenge )
{
    ...
    DRM_DWORD                 i                                         = 0;
#ifdef TEE
	int teeSessionStatus = 0;
	DRM_RESULT dr3 = DRM_SUCCESS;
#endif
    ...
    */
    ...
    if (  f_poDomainID == NULL
       || DRM_SOAPXML_IsBlankGUID( &f_poDomainID->m_oServiceID ) )
    {
...
#ifdef TEE
	if (Drm_IsSecureStopOn()) {
		if (dr != DRM_SUCCESS && teeSessionStatus == 1) {
			dr3 = TEE_CancelSession(( DRM_BYTE * )&oLicChlgContext.m_oNonce);
			if (dr3 != DRM_SUCCESS) {
				dr = dr3;
			}
		}
...
{
    DRM_RESULT                      dr                   = DRM_SUCCESS;
    const DRM_APP_CONTEXT_INTERNAL *poAppContextInternal = ( const DRM_APP_CONTEXT_INTERNAL * )f_poAppContext;
    ...
    {
#if defined(HUMAX_PLATFORM_BASE) // "SECURESTOP" customdata is set in the outside of PlayReady Library (In the Netflix DrmManager(dpi), "SECURESTOP" customdata is set).

#else /* HUMAX_PLATFORM_BASE */
#ifdef TEE
		// yes, including SECURESTOP custom data only indicates that secure stop is supported, not that it's turned On
		if (Drm_SupportSecureStop()) {
			f_pchCustomData = "SECURESTOP";
			f_cchCustomData = 10;
		}
#endif /* TEE */
    ...
    __inout                             DRM_DWORD               *f_pcbProperty )
{
    ...
    switch( f_eProperty )
    {
        case DRM_DGP_CLIENT_INFO:
            ...
            dr = DRM_WMDRMDLA_GetClientInfo( &poAppContextInternal->licensechallenge.clientid,
                                              poAppContextInternal->licensechallenge.rgbStack,
                                             &cchEncoded,
                                             &g_dstrReqTagWMDRMPDClientVersionData,
                                             &dstrScratch,
            ...
            ChkDR( DRM_WMDRMDLA_GetClientInfo( &poAppContextInternal->licensechallenge.clientid,
                                                poAppContextInternal->licensechallenge.rgbStack,
                                               &cchEncoded,
    ...
    __inout                                DRM_DWORD                *f_pcbPropertyData )
{
    ...
    switch( f_eProperty )
    {
        case DRM_CGP_HEADER_KID:
            ...
            {
                const DRM_V1Header *pV1Header = (const DRM_V1Header*)poAppContextInternal->pbDRMHeaderData ;
    ...
    __inout                           DRM_DWORD                     *f_pcLicAcks )
{
    ...
    dr = DRM_LA_ProcessResponseV3( f_poAppContext,
                                   &oLicRespContext,
                                   f_pdastrResponse,
                                   f_pbTransactionID,
                                   f_pcbTransactionID,
...
#ifdef TEE
	MEMCPY( f_pbSessionID, oLicRespContext.licenseNonce.rgb, SIZEOF( DRM_KID ) );
#endif
...
{
    DRM_RESULT dr = DRM_SUCCESS;
	DRM_BYTE	f_pbSessionID[DRM_ID_SIZE]={0,};
	...
	OEM_SECURE_ZERO_MEMORY( f_poLicenseResponse, SIZEOF( DRM_LICENSE_RESPONSE ) );
    ...
    else
    {
		...
		if (Drm_IsSecureStopOn()) {
			DRM_DWORD licNum;
			for (licNum = 0; licNum < f_poLicenseResponse->m_cAcks; licNum++) {
				DRM_LICENSE_ACK *ack = &f_poLicenseResponse->m_rgoAcks[licNum];
				if ( DRM_SUCCEEDED( ack->m_dwResult) ) {
					ChkDR(TEE_BindLicense(f_pbSessionID, ack->m_oKID.rgb));
				}
			}
		}
#endif
...
{
    DRMASSERT( f_poAppContextInternal != NULL );
    if( f_poAppContextInternal == NULL )
    {
        return TRUE;
    }

    if( DRM_CLK_IsSecureClockUnsupported() && DRM_ARCLK_IsAntirollbackClockUnsupported() )
    {
        return TRUE;
    }

    if( DRM_CLK_IsSecureClockSupported() && !f_poAppContextInternal->fClockSet )
    {
        return TRUE;
    }

    if( DRM_DEVICEASSETS_IsDeviceAssetsSupported()
     && ( ( f_poAppContextInternal->oBlackBoxContext.cachedCertValues.dwFeatureFlags & DRM_FEATURE_SECURE_CLOCK        ) == 0 )
     && ( ( f_poAppContextInternal->oBlackBoxContext.cachedCertValues.dwFeatureFlags & DRM_FEATURE_ANTI_ROLLBACK_CLOCK ) == 0 ) )
    {
        return TRUE;
    }
...
**                             Must be NULL if attempting to bind to a root
**                             license for the purpose of rebinding in PRND.
**                             May be NULL if the decrypt context is not needed.
**
** Returns:     DRM_SUCCESS on success.
...
**              DRM_E_LICENSE_NOT_FOUND if a usuable license could not be found.
**              DRM_E_LICENSE_EXPIRED if the only available license was expired.
...
**              key decryption.
**              DRM_E_DRM_NOT_INITIALIZED if the DRM_APP_CONTEXT was not initialized.
...
**              required in advance.
**
** Notes:    1) When it is no longer needed, f_pcontextDCRY must be passed to
**              Drm_Reader_Close() in order to free any associated resources
**           2) If Drm_Reader_Bind fails with DRM_E_LICENSE_NOT_FOUND the caller
    ...
    __out_opt                      DRM_DECRYPT_CONTEXT  *f_pcontextDCRY )
{
    ...
    ChkBOOL( poAppContextInternal->fStoreOpened, DRM_E_DRM_NOT_INITIALIZED );
    ...
    if( f_pcontextDCRY != NULL )
    {
        OEM_SECURE_ZERO_MEMORY( f_pcontextDCRY, SIZEOF( DRM_CIPHER_CONTEXT ) );
        ((DRM_CIPHER_CONTEXT*)f_pcontextDCRY)->ui64RealTimeExpiration = DRM_UI64HL(MAX_UNSIGNED_TYPE(DRM_DWORD),MAX_UNSIGNED_TYPE(DRM_DWORD));
        ((DRM_CIPHER_CONTEXT*)f_pcontextDCRY)->ui64cbProcessed        = DRM_UI64( 0 );
    }
    ...
    */
    ...
    /*
    ** There are maximum DRM_LICSTORE_MAX_STORES (4) license stores being used
    ** for search at any time.
    **
    ** Set up the array of license stores to search with the following order:
    ** 1. Nonce store (if the header in context is a KID or V2_4 or V4 or V4_1 or PlayReady object [optionally with kid]).
    ** 2. Embedded store (if the header in context is a PlayReady object [optionally with kid]).
    ** 3. PRND receiver store (if the header in context is a V1 or KID or V2_4 or V4 or V4_1 or PlayReady object [optionally with kid]).
    ** 4. XMR store (if the header in context is a V1 or KID or V2_4 or V4 or V4_1 or PlayReady object [optionally with kid]).
    ** 5. XML store (if the header in context is a V1 or V2 or KID or V2_4 or V4 or V4_1).
    **
    ** Note that #2 and #5 are mutually exclusive, so that's why DRM_LICSTORE_MAX_STORES is not one larger.
    **
    */
    if (   (   poAppContextInternal->eHeaderInContext == DRM_CSP_KID
            || poAppContextInternal->eHeaderInContext == DRM_CSP_V2_4_HEADER
        ...
        && poAppContextInternal->oFFLicense.cLicStores < DRM_LICSTORE_MAX_STORES )
    {
        ...
        poAppContextInternal->oFFLicense.pLicStoreNST                                                = &poAppContextInternal->oLicStoreContextNST;
    }
                                             ...
                                             &poAppContextInternal->oDatastoreEST ) ) )
    {
        ...
        poAppContextInternal->oFFLicense.pLicStoreEST                                                = &poAppContextInternal->oLicStoreContextEmbedded;
    ...
    if (   (   poAppContextInternal->eHeaderInContext == DRM_CSP_V1_HEADER
        ...
        && poAppContextInternal->oFFLicense.cLicStores < DRM_LICSTORE_MAX_STORES )
    {
        poAppContextInternal->oFFLicense.rgpLicStores[poAppContextInternal->oFFLicense.cLicStores++]  = &poAppContextInternal->oLSTContextPRNDRxStore;
        poAppContextInternal->poPrndReceiverContext->pLSTContextPRNDStore                             = &poAppContextInternal->oLSTContextPRNDRxStore;
        poAppContextInternal->oFFLicense.pLicStorePRND                                                = &poAppContextInternal->oLSTContextPRNDRxStore;
    }
    ...
    while ( !fBound )
    {
        ...
        */
        if ( poAppContextInternal->oFFLicense.rgpLicStoreCurrent[ 0 ] == &poAppContextInternal->oLicStoreContextXML )
        {
            ...
            poAppContextInternal->oFFLicense.rgfLicenseFromPRND[0] = FALSE;
            poAppContextInternal->oFFLicense.rgfLicenseFromEST[0] = FALSE;
        }
        /*
        ** XMR license search (HDS, embedded, nonce, or PRND store)
        */
        else
        {
            ...
            poAppContextInternal->oFFLicense.rgfLicenseFromPRND[0] =
                ( poAppContextInternal->oFFLicense.rgpLicStoreCurrent[ 0 ] == poAppContextInternal->oFFLicense.pLicStorePRND );
            poAppContextInternal->oFFLicense.rgfLicenseFromEST[0] =
                ( poAppContextInternal->oFFLicense.rgpLicStoreCurrent[ 0 ] == poAppContextInternal->oFFLicense.pLicStoreEST );
        }

        poAppContextInternal->oLicEvalContext.fIgnoreTimeBoundLicense = _BlockTimeBoundLicenses( poAppContextInternal );
        ...
        */
        ...
        dr = DRM_LIC_CompleteLicenseChain(  poAppContextInternal->pOEMContext,
                                            ( DRM_CIPHER_CONTEXT * ) f_pcontextDCRY,
                                           &poAppContextInternal->oFFLicense,
                                            f_rgpdstrRights,
                                            f_cRights,
        ...
        */
...
#ifdef TEE
			if (Drm_IsSecureStopOn()) {
				DRM_CIPHER_CONTEXT *cipherCtx = (DRM_CIPHER_CONTEXT *)f_pcontextDCRY;
				ChkDR(TEE_BindSession(((DRM_BB_KEY_REGISTER_ENTRY*)cipherCtx->cipher.cipherAES.hAesKey)->indexKeyRegister, (DRM_BYTE *)&poAppContextInternal->KID.rgb));
			}
#endif
        ...
        else
        {
            ...
            else if( dr == DRM_E_UPLINK_LICENSE_NOT_FOUND )  /* DRM_E_UPLINK_LICENSE_NOT_FOUND supercedes DRM_E_LICENSE_EXPIRED or DRM_E_RIGHTS_NOT_AVAILABLE. */
            {
                if( DRM_SUCCEEDED( dr2 ) )  /* Don't overwite any cached error code. */
                {
                    dr2 = DRM_E_UPLINK_LICENSE_NOT_FOUND;
                }
            }
            else if ( poAppContextInternal->oLicEvalContext.lReasonForFail == LR_LICENSE_EXPIRED )
            {
                dr2 = DRM_E_LICENSE_EXPIRED;
            }
            else if ( poAppContextInternal->oLicEvalContext.lReasonForFail == LR_LICENSE_NOTENABLED )
            {
                dr2 = DRM_E_RIGHTS_NOT_AVAILABLE;
            }
                   ...
                   && DRM_SUCCEEDED( dr2 ) ) /* Don't overwite any cached error code. */
            {
                ...
                */
                ...
                for ( i = 0; i < poAppContextInternal->dwChainDepth; i++ )
                {
                    ...
                    else if ( drOrig == DRM_E_RIGHTS_NOT_AVAILABLE )
                    {
                        dr2 = DRM_E_RIGHTS_NOT_AVAILABLE;
                    }
                }
    ...
    if ( dr == DRM_E_LICENSE_NOT_FOUND )
    {
        ...
        else if( DRM_SNC_IsLicenseSyncSupported() )
        {
            ...
            */
            ...
            ChkBOOL( !fExpired, DRM_E_LICENSE_EXPIRED );
...
ErrorExit:
    ...
    {
        if( f_pcontextDCRY != NULL
         && ( ( DRM_CIPHER_CONTEXT* )f_pcontextDCRY )->fInited == TRUE )
        {
            DRM_BBX_CPHR_Uninitialize( ( ( DRM_CIPHER_CONTEXT* )f_pcontextDCRY ) );
        }
        ...
        else if( DRM_FAILED( dr2 ) && dr == DRM_E_LICENSE_NOT_FOUND )
        {
            dr = dr2;
        }
    }
...
/**********************************************************************
**
** Function:    Drm_LicenseAcq_ProcessResponse_TEE
**
** Synopsis:    API that processes a response from a license server.
**              Usually this is a series of licenses that will
**              ultimately be stored in the device license store. This
...
**
**********************************************************************/
DRM_API DRM_RESULT DRM_CALL Drm_LicenseAcq_ProcessResponse_TEE(
    __in                        DRM_APP_CONTEXT                *f_poAppContext,
    __in                        DRM_PROCESS_LIC_RESPONSE_FLAG   f_dwFlags,
    __in_opt                    pfnLicenseResponseCallback      f_pfnCallback,
    __in_opt                    DRM_VOID                       *f_pvCallbackContext,
...
/*****************************************************************************
** Function: Drm_Reader_Unbind
**
** Synopsis: Destroy content decryption context and all associated TEE resources
**
** Arguments:
**
** [f_poAppContext]         -- Opaque DRM Application context initialized
    ...
    DRM_DECRYPT_CONTEXT  *f_pcontextDCRY )
{
    ...
    //_info("****** Drm_Reader_Unbind: Enter\n");
    Drm_Reader_Close(f_pcontextDCRY);
    if (Drm_IsSecureStopOn()) {
        DRM_BYTE state[TEE_MAX_STATE_SIZE];
        DRM_DWORD stateLen = TEE_MAX_STATE_SIZE;
        ChkDR(TEE_GetState(state, &stateLen));
        ChkDR(Oem_WriteTeeState(state, stateLen));
    }
ErrorExit:
    //_info("****** Drm_Reader_Unbind: Exit\n");
    return dr;
}

DRM_API DRM_BOOL DRM_CALL Drm_IsSecureStopOn( DRM_VOID ) {
    DRM_BOOL isSecureStopOn = FALSE;

    if (Drm_SupportSecureStop()) {
        TEE_IsSecureStopOn(&isSecureStopOn);
    }
    return isSecureStopOn;
}
...
DRM_API DRM_RESULT DRM_CALL Drm_TurnSecureStop( DRM_BOOL f_OnOff ) {
    DRM_RESULT dr = DRM_SUCCESS;
	printf(" ########### Function = %s, Line = %d , onoff = %d\n", __FUNCTION__, __LINE__, f_OnOff);
    ChkBOOL( Drm_SupportSecureStop(), DRM_E_FAIL );
    ChkDR( TEE_TurnSecureStop(f_OnOff) );
    ChkDR(_InitTeeState());
...
/*****************************************************************************
** Function: Drm_GetSecureStopIds
**
** Synopsis: returns secure stop IDs for all outstanding (i.e. ready to be signed and sent) secure stops
**
** Arguments:
**
** [f_poAppContext] -- Opaque DRM Application context initialized by a call to Drm_Initialize().
**
** [f_pbSessionIDs] -- An array of 16-byte secure stop IDs
**
** [f_count]        -- The number of returned secure stop IDs
**
** Returns:     DRM_SUCCESS on success.
**              DRM_E_INVALIDARG if some arguments are invalid.
**
*****************************************************************************/

DRM_API DRM_RESULT DRM_CALL Drm_GetSecureStopIds(
                                    DRM_APP_CONTEXT * f_poAppContext,   /* application context */
    __out                           DRM_BYTE          f_pbSessionIDs[TEE_MAX_NUM_SECURE_STOPS][TEE_SESSION_ID_LEN],
    __out                           DRM_DWORD       * f_count
    )
{
    DRM_RESULT dr = DRM_SUCCESS;
    ChkBOOL( Drm_IsSecureStopOn(), DRM_E_FAIL );
    ChkArg( f_poAppContext != NULL );
    ChkArg( f_pbSessionIDs  != NULL );
    ChkArg( f_count != NULL );

    DRM_DWORD count = 0;
    ChkDR(TEE_GetSecureStopIds(f_pbSessionIDs, &count));
    *f_count = count;
...
/*****************************************************************************
** Function: Drm_GetSecureStop
**
** Synopsis: returns secure stop for a given session ID
**
** Arguments:
**
** [f_poAppContext]         -- Opaque DRM Application context initialized
**                             by a call to Drm_Initialize().
**
** [f_pbSessionID]          -- A 16-byte session ID
**
** [f_pbSecureStop]         -- Opaque output buffer for writing secure stop data
**
** [f_cbSecureStop]         -- Size of the buffer allocated for writing secure stop data
**                          -- Overwritten with the actual size of the data written
**                          -- If size is too small, is overwritten with the size required for the data to be written
**
** Returns:     DRM_SUCCESS on success.
**              DRM_E_INVALIDARG if some arguments are invalid.
**              DRM_E_BUFFERTOOSMALL if the secure stop buffer size is too small and cannot fit secure stop data
**
*****************************************************************************/

DRM_API DRM_RESULT DRM_CALL Drm_GetSecureStop(
                                    DRM_APP_CONTEXT *f_poAppContext,   /* application context */
    __in_bcount( 16 )               DRM_BYTE        *f_pbSessionID,    /* expected length 16 */
    ...
    )
{
    ...
    ChkArg( f_poAppContext != NULL );
    ChkArg( f_pbSessionID  != NULL );
    ChkArg( f_pbSecureStop != NULL );
    ChkArg( f_cbSecureStop != NULL );

    TEE_SIGNATURE sig;

    DRM_APP_CONTEXT_INTERNAL *poAppContextInternal = ( DRM_APP_CONTEXT_INTERNAL * )f_poAppContext;

    // First, find out the size of TBS (to-be-signed) part of secure stop
    DRM_DWORD tbsLen = 0; // length of TBS (to-be-signed) part of secure stop
    dr = DRM_BBX_GetSecureStop(&poAppContextInternal->oBlackBoxContext, f_pbSessionID, f_pbSecureStop, &tbsLen, &sig);
    if (dr != DRM_E_BUFFERTOOSMALL) { // should never happen
        ChkDR( dr );
    }

    // Second, find out the size of the signature
    DRM_DWORD sigLen = 64; // ECDSA-SHA256

    // Second, find out the size of certificate chain
    DRM_DWORD certLen = 0;
    DRM_BOOL b64encoded = FALSE;
    dr = DRM_SOAPXML_GetDeviceCert( poAppContextInternal->oBlackBoxContext.pKeyFileContext, b64encoded, NULL, &certLen );
    if (dr != DRM_E_BUFFERTOOSMALL) { // should never happen
        ChkDR( dr );
    }

    // Third, compute the total size required for secure stop, including DER overhead
    DRM_DWORD tbsHeaderLen = DER_GetHeaderLen(tbsLen);
    DRM_DWORD certHeaderLen = DER_GetHeaderLen(certLen);
    DRM_DWORD sigHeaderLen = DER_GetHeaderLen(sigLen);
    DRM_DWORD tbsCertLen = tbsHeaderLen + tbsLen + sigHeaderLen + sigLen + certHeaderLen + certLen;
    DRM_DWORD topHeaderLen = DER_GetHeaderLen(tbsCertLen);
    DRM_DWORD secStopLen = topHeaderLen + tbsCertLen;

    // Finally, check if secure stop output buffer is big enough
    if (secStopLen > *f_cbSecureStop) {
        *f_cbSecureStop = secStopLen;
        ChkDR( DRM_E_BUFFERTOOSMALL );
    }

    // secure stop buffer is sufficient - do  it for real now

    DRM_BYTE * p = f_pbSecureStop;
    p = DER_WriteHeader(f_pbSecureStop, DER_SEQUENCE, tbsCertLen); // write top DER SEQUENCE header

    p = DER_WriteHeader(p, DER_OCTETS, tbsLen); // write TBS header
    ChkDR(DRM_BBX_GetSecureStop(&poAppContextInternal->oBlackBoxContext, f_pbSessionID, p, &tbsLen, &sig)); // write TBS part
    p += tbsLen; // advance by TBS length

    p = DER_WriteHeader(p, DER_OCTETS, sig.length); // write signature header
    _print_hex("Signature", sig.data, sig.length);
    MEMCPY(p, sig.data, sig.length); // write signature part
    p += sig.length; // advance by signature length

    p = DER_WriteHeader(p, DER_OCTETS, certLen); // write certificate chain header
    ChkDR(DRM_SOAPXML_GetDeviceCert( poAppContextInternal->oBlackBoxContext.pKeyFileContext, b64encoded, (char *)p, &certLen )); // write certs
    _print_hex("CertChain", p, certLen);
    p += certLen; // advance by cert length - just for offset verification

    if ( (DRM_BYTE *)p != (f_pbSecureStop + secStopLen) ) {
        _info("PANIC!!! Secure Stop Algorithm ERROR!!! %d EXTRA BYTES\n", (DRM_BYTE *)p - (f_pbSecureStop + secStopLen));
        *f_cbSecureStop = 0;
        ChkDR( DRM_E_FAIL );
    }
    ...
    *f_cbSecureStop = secStopLen;
    ...
    _print_hex("FullSecureStop", f_pbSecureStop, *f_cbSecureStop);

    {
        char ub64encoded[4096];
        size_t ub64encodedlen = sizeof(ub64encoded);
        base64encode(f_pbSecureStop, *f_cbSecureStop, ub64encoded, ub64encodedlen);
        _dbg("Secure Stop UrlBase64Encoded:\n%s\n", ub64encoded);
    }
...
/*
 * Delete secure stop with the given id
 */
    ...
    )
{
    ...
    DRM_BYTE state[TEE_MAX_STATE_SIZE];
    DRM_DWORD stateLen = TEE_MAX_STATE_SIZE;
    ChkDR(TEE_CommitSecureStop(f_pbSessionID, state, &stateLen));
    ChkDR(Oem_WriteTeeState(state, stateLen));
...
/*
 * Delete all secure stops - use carefully! Useful when app and playready get out-of-sync.
 */
    ...
    )
{
    ...
    DRM_BYTE state[TEE_MAX_STATE_SIZE];
    DRM_DWORD stateLen = TEE_MAX_STATE_SIZE;
    DRM_DWORD outCount = 0;

    ChkDR(TEE_ResetSecureStops(state, &stateLen, &outCount));
    ChkDR(Oem_WriteTeeState(state, stateLen));
...
/**********************************************************************
**
** Function:    Drm_Reader_Close
**
** Synopsis:    Releases any resources associated with the decrypt context.
**
** Arguments:
**
** [f_pcontextDCRY]      -- Opaque DRM decrypt context
**
** Notes:                   None.
**
**********************************************************************/
...
**                          buffer is too small.
**                          DRM_E_LICENSE_NOT_BOUND if license hasn't been bound
...
**                             __out: one or two MIDs         ExtraData struct.
** DRM_LGP_HAS_INCLUSION_GUID  DRM_LGP_HAS_INCLUSION_GUID_EXTRA_DATA    Bool: 0 if the GUID
**                             __in : the GUID to query       was not found, non-zero if it was.
    ...
    __out                                       DRM_DWORD                 *f_pdwOutputData )
{
    ...
    {
        ChkArg( f_pdwOutputData != NULL );
        *f_pdwOutputData = (DRM_DWORD)poAppContextInternal->oFFLicense.fBlockNDT;
    }
...
**                          DRM_E_INVALIDARG if the arguement is invalid.
**                          Any other return code as defined in drmresults.h.
**                          DRM_E_UNSUPPORTED_ALGORITHM if non WMDRM cipher
**
    ...
    __in                                                               DRM_DWORD            f_cbData )
{
    ...
    ChkBOOL( pCipherContext->fInited, DRM_E_CIPHER_NOT_INITIALIZED );
...
static DRMFORCEINLINE DRM_RESULT _EvaluateRealTimeExpiration(
    __inout DRM_CIPHER_CONTEXT  *f_pCipherContext,
    __in    DRM_DWORD            f_cbData ) DRM_ALWAYS_INLINE_ATTRIBUTE;
static DRMFORCEINLINE DRM_RESULT _EvaluateRealTimeExpiration(
    __inout DRM_CIPHER_CONTEXT  *f_pCipherContext,
    __in    DRM_DWORD            f_cbData )
{
    ...
    DRM_PERF_LogMicrosecondCount( eDRM_PERF_LogTag_Enter, eDRM_PERF_LogFunction__EvaluateRealTimeExpiration );

    ChkArg( f_pCipherContext != NULL );

    if( !DRM_UI64Eql( f_pCipherContext->ui64RealTimeExpiration, DRM_UI64HL(MAX_UNSIGNED_TYPE(DRM_DWORD),MAX_UNSIGNED_TYPE(DRM_DWORD)) ) )
    {
		if( DRM_UI64Eql( f_pCipherContext->ui64RealTimeExpiration, DRM_UI64( 0 ) ) )
        {
            f_pCipherContext->ui64RealTimeExpiration = DRM_UI64HL(MAX_UNSIGNED_TYPE(DRM_DWORD),MAX_UNSIGNED_TYPE(DRM_DWORD));
        }
        else
        {
            f_pCipherContext->ui64cbProcessed = DRM_UI64Add( f_pCipherContext->ui64cbProcessed, DRM_UI64( f_cbData ) );
            if( DRM_UI64Les( DRM_UI64( DRM_REAL_TIME_EXPIRATION_CHECK_BYTE_COUNT ), f_pCipherContext->ui64cbProcessed ) )
            {
                DRMFILETIME ftCurrent   = {0};
                DRM_UINT64  ui64Current = DRM_UI64LITERAL( 0, 0 );

                f_pCipherContext->ui64cbProcessed = DRM_UI64( 0 );

                Oem_Clock_GetSystemTimeAsFileTime( f_pCipherContext->pOEMContext, &ftCurrent );
                FILETIME_TO_UI64( ftCurrent, ui64Current );
                if( !DRM_UI64Les( ui64Current, f_pCipherContext->ui64RealTimeExpiration ) )
                {
					/* The cipher context self-destructs when it expires! */
                    DRM_BBX_CPHR_Uninitialize( f_pCipherContext );

                    ChkDR( DRM_E_LICENSE_REALTIME_EXPIRED );
                }
            }
        }
    }
...
ErrorExit:
    DRM_PERF_LogMicrosecondCount( eDRM_PERF_LogTag_Exit, eDRM_PERF_LogFunction__EvaluateRealTimeExpiration );
    return dr;
}
    ...
    __in                       DRM_DWORD                     f_cbData )
{
    ...
    dr = _EvaluateRealTimeExpiration( pCipherContext, f_cbData );
    ...
    {
        if (Drm_IsSecureStopOn()) {
            if (pCipherContext->cipher.cipherAES.secureStopUpdated) {
                DRM_BYTE state[TEE_MAX_STATE_SIZE];
                DRM_DWORD stateLen = TEE_MAX_STATE_SIZE;
                ChkDR(TEE_GetState(state, &stateLen));
                ChkDR(Oem_WriteTeeState(state, stateLen));
...
/******************************************************************************
**
** Function:    Drm_Reader_DecryptOpaque
**
** Synopsis:    Decrypts part of the encrypted content using opaque buffers.
**              Only AES CTR mode decryption is supported.
**
** Arguments:
**
** [f_pDecryptContext]      -- Pointer to a DRM_DECRYPT_CONTEXT structure
...
**                             Drm_Reader_Bind().
** [f_pCtrContext]          -- Sets and maintains the initialization vector and
**                             counter for AES CTR mode.
** [f_hInBuf]               -- Pointer to an opaque buffer that contains data to be decrypted.
** [f_hOutBuf]              -- Pointer to an opaque buffer that contains decrypted (clear) data.
** [f_cbData]               -- Byte count of the data to be decrypted.
**
** Returns:                 DRM_SUCCESS on success.
**                          DRM_E_INVALIDARG if the arguement is invalid.
**                          Any other return code as defined in drmresults.h.
**
** Notes :                  Content is decrypted from f_hInBuf to f_hOutBuf.
**                          Clear output is the same length as the encrypted input.
**
******************************************************************************/
    ...
    __in                       DRM_DWORD                     f_cbData )
{
    ...
    if( DRM_SUCCEEDED( dr ) )
    {
        dr = DRM_BBX_CPHR_DecryptOpaque( pCipherContext,
                                         f_pCtrContext,
                                         f_hInBuf,
                                         f_hOutBuf,
                                         f_cbData );
...
**                          DRM_E_INVALIDARG if any parameter is invalid.
**                          DRM_E_BUFFERTOOSMALL if the output buffer is too small.
**                          DRM_E_PRIVKEY_READ_ERROR if an error occurred reading the device private key.
**                          DRM_E_DEVCERT_READ_ERROR if an error occurred reading the device certificate.
**                          DRM_E_INVALID_DEVCERT_TEMPLATE if the specified device certificate
**                                                                 template is invalid.
**
** Notes:                   To get the minimum size required, first call with
...
ErrorExit:
    ...
    Drm_Reader_Close( &oUnusedDecyrptContext );
...
static DRM_RESULT _DeleteLicenses(
    __in        DRM_APP_CONTEXT_INTERNAL *f_poAppContextInternal,
    __in  const DRM_CONST_STRING         *f_pdstrLGPubKey,
    __in  const DRM_KID                  *f_pKID,
    __out       DRM_DWORD                *f_pcLicDeleted )
{
    DRM_RESULT       dr           = DRM_SUCCESS;
...
static DRM_RESULT _ProcessLicenseRevocationList(
    __in                  DRM_APP_CONTEXT_INTERNAL *f_poAppContextInternal,
    __in                  DRM_DWORD                 f_iKids,
    __in                  DRM_DWORD                 f_cKids,
    __in_ecount(f_cbList) DRM_BYTE                 *f_pbList,
    __in                  DRM_DWORD                 f_cbList,
    __out                 DRM_DWORD                *f_piKids,
    __out                 DRM_DWORD                *f_pcLicDeleted )
{
    DRM_DWORD        iKids      = 0;
...
**                          DRM_E_PRIVKEY_READ_ERROR if BB context not initialized.
    ...
    switch ( f_dwOperationCode )
    {
        case OpGetVersion:
            ...
            *f_pdwResponseResult2 = g_dwWMDRMPDVersionMinor;
            if( f_pdwResponseResult3 != NULL )
            {
                *f_pdwResponseResult3 = g_dwWMDRMPDVersionBuild;
            }
            if( f_pdwResponseResult4 != NULL )
            {
    ...
    __inout      DRM_ENVELOPED_FILE_CONTEXT *f_pEnvFile )
{
    ...
    */
    ChkBOOL( poAppContextInternal->cbPROData == oCompareHeader.cbDrmHeaderLen, DRM_E_FILE_READ_ERROR );
    ChkBOOL( Oem_File_Write( f_pEnvFile->pEnvFileHandle,
                             poAppContextInternal->pbDRMHeaderData,
                             poAppContextInternal->cbPROData,
                            &cbWritten ), DRM_E_FILE_WRITE_ERROR );
    ChkBOOL( cbWritten == poAppContextInternal->cbPROData, DRM_E_FILE_WRITE_ERROR );
    ...
    __out          DRM_ENVELOPED_FILE_CONTEXT *f_pNewHandle )
{
    ...
    {
        DRM_LONG lFileStart = 0;
        ChkDR( DRM_DWordToLong( f_pNewHandle->dwFileDataStart, &lFileStart ) );
...
** [f_pDecrypt]             -- An initialized decrypt context.
**
** Returns:                 DRM_SUCCESS on success.
**                          DRM_E_INVALIDARG if any parameter is invalid.
    ...
    __in DRM_DECRYPT_CONTEXT        *f_pDecrypt )
{
    ...
    ChkDR( DRM_BBX_CPHR_Duplicate( ( DRM_CIPHER_CONTEXT* )f_pDecrypt, &f_pEnvFile->oDecrypt ) );
...
ErrorExit:
    if( DRM_FAILED( dr ) )
    {
        ...
        {
            DRM_BBX_CPHR_Uninitialize( &f_pEnvFile->oDecrypt );
        }
    }
    ...
    __inout                                     DRM_DWORD                  *f_pcchOriginalFilename )
{
    ...
    ChkBOOL( Oem_File_SetFilePointer(  f_pEnvFile->pEnvFileHandle,
                                       0,
                                       OEM_FILE_CURRENT,
                                      &dwOriginalFilePointer ), DRM_E_FILE_SEEK_ERROR );
    ...
    ChkBOOL( Oem_File_Read(  f_pEnvFile->pEnvFileHandle,
                             ...
                             f_pEnvFile->oEnvHeader.cbOriginalFilename,
                            &cbRead ) &&
             cbRead == f_pEnvFile->oEnvHeader.cbOriginalFilename, DRM_E_FILE_READ_ERROR );

    {
        DRM_LONG lOriginalFilePointer = 0;
        ChkDR( DRM_DWordToLong( dwOriginalFilePointer, &lOriginalFilePointer ) );
        ChkBOOL( Oem_File_SetFilePointer( f_pEnvFile->pEnvFileHandle,
                                          lOriginalFilePointer,
                                          OEM_FILE_BEGIN, NULL ), DRM_E_FILE_SEEK_ERROR );
    }
...
**              opaque buffer size and the size of the decrypt context and
**              optionally the transmitter and receiver context.
**
** Arguments:
**
...
** [f_pdwTramsnitterContextSize] -- Returns the size of Transmitter context.
** [f_pdwReceiverContextSize]    -- Returns the size of Receiver context.
**
** Returns:                 DRM_SUCCESS on success.
**                          DRM_E_INVALIDARG if any parameter is invalid.
**
    ...
    __out_opt DRM_DWORD *f_pdwReceiverContextSize )
{
    ...
    *f_pdwDecryptContextSize = SIZEOF(DRM_DECRYPT_CONTEXT);
    ...
    if (f_pdwTransmitterContextSize != NULL)
    {
        *f_pdwTransmitterContextSize = SIZEOF(DRM_PRND_TRANSMITTER_CONTEXT);
    }

    if (f_pdwReceiverContextSize != NULL)
    {
        *f_pdwReceiverContextSize = SIZEOF(DRM_PRND_RECEIVER_CONTEXT);
    }
    ...
    __out_ecount(1) DRM_DECRYPT_CONTEXT *f_pDecryptContextOut )
{
    ...
    ChkDR( DRM_BBX_CPHR_Duplicate( ( DRM_CIPHER_CONTEXT* )f_pDecryptContextIn,
                                   ( DRM_CIPHER_CONTEXT* )f_pDecryptContextOut ) );
