...
DRM_API DRM_RESULT DRM_CALL DRM_ACT_LoadAndVerifyKeyfile(
        __inout_ecount(1) DRM_KEYFILE_CONTEXT * f_pKeyFileContext )
{
    UNREFERENCED_PARAMETER(f_pKeyFileContext);
