...
#define DRM_BUILDING_CONTENTREVOCATIONLEVLREAL_C
...
static DRM_RESULT DRM_CALL _GetContentRevocationInStore(
    ...
    __in  const DRM_CONST_STRING    *f_pdstrContentOwnerPubKey,
    __out       DRM_CONST_STRING    *f_pdstrContentRevocation,
...
static DRM_RESULT DRM_CALL _SetContentRevocationInStore(
    __in    const DRM_LICEVAL_CONTEXT *f_pcontextLicEval,
    __in    const DRM_CONST_STRING    *f_pdstrContentOwnerPubKey,
    __in    const DRM_CONST_STRING    *f_pdstrContentRevocation,
