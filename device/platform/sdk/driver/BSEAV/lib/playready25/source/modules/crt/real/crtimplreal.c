...
#if DRM_BUILD_PROFILE == DRM_BUILD_PROFILE_WP8 || DRM_BUILD_PROFILE == DRM_BUILD_PROFILE_XBOX
#ifdef DRMCRT_memcpy
#undef DRMCRT_memcpy
#endif
#ifdef DRMCRT_memset
...
#endif /* DRM_BUILD_PROFILE == DRM_BUILD_PROFILE_WP8 || DRM_BUILD_PROFILE == DRM_BUILD_PROFILE_XBOX */
...
DRM_API DRM_WCHAR DRM_CALL DRMCRT_towlower (DRM_WCHAR wch)
{
    ...
    {
        DRM_WCHAR wchTemp = (DRM_WCHAR)( NATIVE_WCHAR(g_wcha) - NATIVE_WCHAR(g_wchA) );
        wch = (DRM_WCHAR)( NATIVE_WCHAR(wch) + wchTemp );
        wch = (DRM_WCHAR)WCHAR_CAST( wch );
    }
