...
#define DRM_BUILDING_DRMDATASTORE_C
    ...
    __out                             DRM_DWORD             *f_pcbData )
{
    ...
    ChkArg( f_pDST != NULL );
    ChkBOOL( f_pDST->oDataStoreInterface.pfnSlotReadPtr != NULL, DRM_E_INVALIDARG );
    ChkDR( f_pDST->oDataStoreInterface.pfnSlotReadPtr( f_pContextSlot,
                                                       f_ppbData,
                                                       f_pcbData ) );
