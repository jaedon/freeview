...
#define DRM_BUILDING_DRMDLAIMPLREAL_C
#include <drmdla.h>
...
static DRM_DWORD _RequiredCharsForRequest (__in DRM_LICENSE_CHALLENGE *f_plicensechallenge)
{
    DRM_DWORD cchRequired = 0;
...
static DRM_RESULT _WriteUplinkNode (__in DRM_LICENSE_CHALLENGE *f_plicensechallenge)
{
    DRM_DWORD iUplink = 0;
...
static DRM_RESULT _WriteActionsNode (__in DRM_LICENSE_CHALLENGE *f_plicensechallenge)
{
    DRM_DWORD  iRight = 0;
    DRM_RESULT dr     = DRM_SUCCESS;
...
static DRM_RESULT _AddClientInfo (__in DRM_LICENSE_CHALLENGE *f_plicensechallenge)
{
    DRM_RESULT       dr           = DRM_SUCCESS;
    ...
    ChkDR( DRM_WMDRMDLA_GetClientInfo(&f_plicensechallenge->clientid,
...
/**************************************************************************
**                  PUBLIC FUNCTION DRM_WMDRMDLA_CreateChallenge
***************************************************************************/
...
/**************************************************************************
**                  PUBLIC FUNCTION DRM_WMDRMDLA_GetClientInfo
***************************************************************************/
