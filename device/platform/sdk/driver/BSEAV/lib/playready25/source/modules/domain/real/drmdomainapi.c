...
#define DRM_BUILDING_DRMDOMAINAPI_C
#include <drmtypes.h>
#include <drmhds.h>
...
**                          DRM_E_DEVCERT_EXCEEDS_SIZE_LIMIT if the device certificate
**                          is too big.
    ...
    __inout                                    DRM_DWORD       *f_pcbChallenge )
{
    ...
    */
    if ( cbDeviceCert > poAppContextInternal->cbDRMLicense )
    {
        ...
        */
        ChkDR( DRM_E_DEVCERT_EXCEEDS_SIZE_LIMIT );
    }
    ...
    __in DRM_ANSI_CONST_STRING        *f_pdastrResponse )
{
    ...
    ** Validate signature.
    */
    dr = DRM_SOAPXML_ValidateProtocolSignature( (const DRM_BYTE *)f_pdastrResponse->pszString,
