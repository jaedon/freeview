...
#define DRM_BUILDING_DRMDOMAINSTORE_C
#include <drmtypes.h>
...
static DRM_NO_INLINE DRM_RESULT _DomainStore_AddData(
    ...
    __in     const DRM_GUID                *f_poTypeID,
    __in_opt const DRM_GUID                *f_poServiceID,
...
static DRM_NO_INLINE DRM_RESULT _DomainStore_GetData(
    ...
    __out_ecount_opt(*f_pcbData)       DRM_BYTE                *f_pbData,
...
static DRM_NO_INLINE DRM_RESULT _DomainStore_EnumNextData(
    ...
    __out_opt DRM_GUID                     *f_poAccountID,
    __out_opt DRM_GUID                     *f_poTypeID,
    __out_opt DRM_GUID                     *f_poServiceID,
    ...
    __in const DRM_GUID                *f_poAccountID )
{
    ...
    const DRM_DOMAINSTORE_CONTEXT_PRIVATE *poDomainStoreContextPrivate =
        ( const DRM_DOMAINSTORE_CONTEXT_PRIVATE * )f_poDomainStoreContext;
    ...
    __out_opt           DRM_DWORD                    *f_pcbData )
{
    ...
    {
        NETWORKBYTES_TO_DWORD_SECURE( *f_pdwRevision, ( DRM_BYTE * )&oTypeID, 0 );
    }
