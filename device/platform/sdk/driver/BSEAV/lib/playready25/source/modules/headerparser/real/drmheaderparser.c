...
#define DRM_BUILDING_DRMHEADERPARSER_C
...
static DRM_RESULT DRM_CALL _VerifyLegacyHeader(
    ...
    __in_opt const DRM_CONST_STRING   *f_pdstrPubKey,
    __in_opt       DRM_CRYPTO_CONTEXT *f_pContext )
{
...
**              DRM_E_INVALID_XML_TAG          if XML error is detected
**
**********************************************************************/
...
**              DRM_E_INVALID_XML_TAG     if XML error in content header is detected
**
**********************************************************************/
