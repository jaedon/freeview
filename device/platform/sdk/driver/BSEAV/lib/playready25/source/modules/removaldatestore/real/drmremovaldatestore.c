...
#define DRM_BUILDING_DRMREMOVALDATESTORE_C
...
**
**********************************************************************/
static DRM_NO_INLINE DRM_RESULT DRM_CALL _RemoveLID(
        ...
        */
        ...
        ChkDR( DRM_DST_SlotRead( pRemovalDateContext->pDatastore,
                                &pRemovalDateContext->contextDSTSlot,
                                 ...
                                 &cbIO ) );
        ChkBOOL( cbIO == SIZEOF( DRM_REMOVAL_DATE_ENTRY ), DRM_E_FILE_READ_ERROR );
        ...
        else
        {
            if ( fLicenseRemoved )
            {
                ...
                ChkBOOL( cbIO == SIZEOF( DRM_REMOVAL_DATE_ENTRY ), DRM_E_FILE_WRITE_ERROR );
            }
...
**
**********************************************************************/
static DRM_NO_INLINE DRM_RESULT DRM_CALL _SetRemovalDateStoreData(
    ...
    __in                       DRM_BOOL                   f_fCreateIfNotExisting )
{
    ...
    */
    ChkDR( DRM_DST_SlotSeek( pcontextRemovalDate->pDatastore,
                             &pcontextRemovalDate->contextDSTSlot,
                             (DRM_LONG)( DRM_REMOVAL_DATE_LICENSE_ENTRY_SIZE * ( dwNumLicensesInSlot - 1) ),
                             eDRM_DST_SEEKCUR,
                             NULL ) );
    ...
    ChkBOOL( cbIO == SIZEOF( DRM_LID ), DRM_E_FILE_WRITE_ERROR );
    ...
    */
    ...
    ChkBOOL( cbIO == SIZEOF( DRM_DST_SLOT_HINT ), DRM_E_FILE_WRITE_ERROR );
...
**
**********************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_RDS_EnumDeleteCurrent (
...
**
**********************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_RDS_DeleteLicenseEntry(
...
**
**********************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_RDS_Delete(
...
**
**********************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_RDS_OpenStore(
    __inout_ecount( 1 )  DRM_DST                  *f_pDatastore,
...
**
**********************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_RDS_CloseStore(
    __inout_ecount( 1 )  DRM_REMOVAL_DATE_CONTEXT *f_pcontextRemovalDate)
{
    DRM_RESULT                        dr                  = DRM_SUCCESS;
    DRM_REMOVAL_DATE_CONTEXT_PRIVATE *pcontextRemovalDate = (DRM_REMOVAL_DATE_CONTEXT_PRIVATE *) f_pcontextRemovalDate;
...
**
**********************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_RDS_InitEnum(
    __inout_ecount( 1 )  DRM_REMOVAL_DATE_CONTEXT    *f_pcontextRemovalDate,
...
**
**********************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_RDS_EnumNext(
    __inout_ecount( 1 )   DRM_REMOVAL_DATE_ENUM    *f_pcontextRemovalDateEnum,
    ...
    */
    ...
    if (f_pcLicenses != NULL )
    {
        ...
        */
        ...
        ChkBOOL( cbRead == SIZEOF( DRM_DWORD), DRM_E_FILE_READ_ERROR );
    }
...
**
**********************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_RDS_AddRemovalDate(
    __inout_ecount( 1 )        DRM_DST                    *f_pDatastore,
...
**
**********************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_RDS_GetRemovalDateEntry   (
   __inout_ecount( 1 )            DRM_REMOVAL_DATE_CONTEXT *f_pcontextRemovalDate,
   __in                           DRM_DWORD                 f_dwRemovalDate,
   __in_ecount( 1 )         const DRM_KID                  *f_pKID,
   __in_ecount_opt( 1 )           DRM_DST_SLOT_HINT        *f_pslotHint,
   ...
   __out_ecount( 1 )              DRM_DWORD                *f_pcEntries )
{
    ...
    */
    ...
    ChkBOOL( cbRead == cbLicenseData, DRM_E_FILE_READ_ERROR );
    *f_pcbData = cbLicenseData;
...
**
***********************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_RDS_GetLicenseCount(
    __inout_ecount( 1 )         DRM_DST     *f_pDatastore,
