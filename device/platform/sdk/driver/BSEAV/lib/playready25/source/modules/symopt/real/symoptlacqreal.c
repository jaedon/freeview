...
#define DRM_BUILDING_SYMOPTLACQREAL_C
#include <drmsymopt.h>
    ...
    __inout                             DRM_SLKDATA         *f_pslkdata )
{
                                    ...
                                    g_wchForwardSlash ) ) )
    {
        ...
        {
            *f_pfSLKValid = DRM_SYMOPT_LA_PrepareSLKFromLicense( f_pDatastore, f_pcontextLEVL, (const DRM_CHAR*)f_pbResponse, f_pdasstrLicenseList, f_pslkdata );
