...
#define DRM_BUILDING_DRMWMDRMLICACQRESPREAL_C
#include <drmwmdrm.h>
#include <drmlicacq.h>
#include <drmsymopt.h>
    ...
    __out_opt                          DRM_LONG                             *f_plReason )
{
    ...
    for (iNode = 0; ; iNode++)
    {
...
#endif
        dr = DRM_XML_GetNodeA((const DRM_CHAR*) f_pbResponse,
                             &dasstrLicenseList,
                             &g_dastrTagLicense,
                              NULL,
                              NULL,
        ...
        if (DRM_SUCCEEDED(dr))
        {
            ...
            dr = DRM_XML_GetNodeAttributeA((const DRM_CHAR*) f_pbResponse,
                                           &dasstrTagData,
            ...
            {
                {
                    ...
                    */
                    ...
                    drReason = DRM_B64_DecodeA((const DRM_CHAR *) f_pbResponse,
                                                &dasstrNodeData,
                                                &cbVersionLicense,
                                                 NULL,
                    ...
                    if(  DRM_FAILED( dr )
                     || !DRM_UTL_DASSTRStringsEqual((const DRM_CHAR *) f_pbResponse,
                                                    &dasstrVersionLicense,
...

                    {
                        ...
                        ChkDRContinue( DRM_WMDRM_LIC_GetAttribute( &f_pcontextLEVL->dstrContentLicense,
                                                                   ...
                                                                   &dstrKID,
                                                                    0 ) );
                        ChkDRContinue( DRM_UTL_StringToLittleEndianGuid( &dstrKID, (DRM_GUID*)f_pcontextLEVL->LID.rgb ) );
