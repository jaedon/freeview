...
#define DRM_BUILDING_DRMNDDEVICECERT_C
#include <ndtnetmsg.h>
#include <drmndr.h>
...
static DRM_RESULT _VerifyRSACertCollectionOnDevice(
    __in        const DRM_ANSI_CONST_STRING *f_pdastrCertCollection,
...
static DRM_RESULT _GetModelRSAPrivKeyOnDevice(
    ...
    __out                         DRM_RSA_PRIVATE_KEY_2048BIT *f_poRSAPrivKey )
{
    DRM_RESULT       dr                      = DRM_SUCCESS;
    ...
    dstrPrivKeyData.pwszString = (const DRM_WCHAR*)f_pbBuffer;
...
static DRM_RESULT _UpdateDeviceCertificateProperties(
    ...
    __in    const DRM_ANSI_CONST_STRING *f_pdastrModelCertificate )
{
    DRM_RESULT             dr                 = DRM_SUCCESS;
...
)
{
    ...
    if( DRM_SUCCEEDED( dr ) )
    {
        ...
        dr = _VerifyRSACertCollectionOnDevice( (const DRM_ANSI_CONST_STRING*) f_pdastrBuffer,
                                               f_pCryptoCtx,
                                               NULL,
                                               NULL );
    ...
    ChkBOOL( f_dwFlags & DRM_DCP_CREATE_DEVCERT_IF_NOT_EXISTING, DRM_E_DEVCERT_READ_ERROR );
    ...
    */
...

    {
        ...
        ChkBOOL( dr != DRM_E_BUFFERTOOSMALL, DRM_E_INVALID_DEVCERT_TEMPLATE );
    }
