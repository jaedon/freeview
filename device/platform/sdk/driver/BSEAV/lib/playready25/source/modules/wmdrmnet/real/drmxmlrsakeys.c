...
ErrorExit:
    if ( DRM_FAILED( dr ) && f_pdastr != NULL )
    {
...
**              DRM_RSA_CB_MODULUS_MAX_2048BIT
**
******************************************************************************/
    ...
    )
{
    ...
    DRM_BYTE  rgbBuffer [__CB_DECL( DRM_RSA_CB_MODULUS_MAX_2048BIT ) ] = { 0 };
    ...
    AssertChkArg( BITS_TO_BYTES( cbitBuffer ) <= DRM_RSA_CB_MODULUS_MAX_2048BIT );
    ...
    )
{
    ...
    __analysis_assume( f_pcDigit != NULL );
...
{
    const INTERNAL_DRM_RSA_PUBLIC_KEY_2048BIT *pRSAPubKeyInternal = (const INTERNAL_DRM_RSA_PUBLIC_KEY_2048BIT*)f_pKeyRSAPublic;

    DRMASSERT( f_pKeyRSAPublic != NULL );
    __analysis_assume( f_pKeyRSAPublic != NULL );
   ...
   __in     const DRM_RSA_PUBLIC_KEY_2048BIT    *f_pKeyRSAPublic )
{
    ...
    ChkArg( f_pXMLCtxA != NULL );
    ChkArg( f_pKeyRSAPublic != NULL );

    dastrModulus.cchString = CCH_BASE64_EQUIV( DRM_RSA_CB_MODULUS_MAX_2048BIT );
    ...
    ChkDR( OEM_RSA_ParsePublicKey_2048BIT(  f_pKeyRSAPublic,
                                           &eKeyLength,
                                           &cbExponent,
                                            rgbExponent,
                                           &cbModulus,
   ...
   __in     const DRM_RSA_PUBLIC_KEY_2048BIT *f_pKeyRSAPublic )
{
    ...
    DRM_WCHAR  rgwchModulusB64[__CB_DECL( CCH_BASE64_EQUIV( DRM_RSA_CB_MODULUS_MAX_2048BIT ) )] = { 0 };
    ...
    ChkArg( f_pXMLCtx != NULL );
    ChkArg( f_pKeyRSAPublic != NULL );

    dstrModulus.cchString = CCH_BASE64_EQUIV( DRM_RSA_CB_MODULUS_MAX_2048BIT );
    ...
    __inout       DRM_RSA_PUBLIC_KEY_2048BIT *f_pKeyRSAPublic )
{
    ...
    DRM_RSA_SUPPORTED_KEY_LENGTHS_2048BIT   eRSAKeyLength         = eDRM_RSA_KEY_LENGTH_UNKNOWN_2048BIT;
    ...
    ChkDR( OEM_RSA_GetKeyLengthFromModulusLength_2048BIT( dastrPubKeyModulus.cchString, &eRSAKeyLength ) );

    ChkDR( OEM_RSA_ZeroPublicKey_2048BIT( f_pKeyRSAPublic ) );
    if( fDefaultPubExp )
    {
        ChkDR( OEM_RSA_SetPublicKey_2048BIT( eRSAKeyLength,
                                             DRM_RSA_CB_PUBEXP,
...
ErrorExit:
    ...
    {
        OEM_RSA_ZeroPublicKey_2048BIT( f_pKeyRSAPublic );
    }
    ...
    __inout       DRM_RSA_PUBLIC_KEY_2048BIT    *f_pKeyRSAPublic )
{
    ...
    DRM_BYTE   rgbModulus [ __CB_DECL( DRM_RSA_CB_MODULUS_MAX_2048BIT ) ] = { 0 };
    DRM_BYTE   rgbExponent[ __CB_DECL( DRM_RSA_CB_PUBEXP ) ]      = { 0 };
    DRM_DWORD  cchModulus  = DRM_RSA_CB_MODULUS_MAX_2048BIT;
    ...
    ZEROMEM( rgbModulus, DRM_RSA_CB_MODULUS_MAX_2048BIT );
    ...
    ChkDR( OEM_RSA_GetKeyLengthFromModulusLength_2048BIT( cchModulus, &eRSAKeyLength ) );
    ...
    __in     const DRM_RSA_PRIVATE_KEY_2048BIT *f_pKeyRSAPrivate )
{
    ...
    DRM_WCHAR  rgwchPrime0B64      [__CB_DECL( CCH_BASE64_EQUIV( DRM_RSA_CB_PRIME_MAX_2048BIT ) )]   = { 0 };
    DRM_WCHAR  rgwchPrime1B64      [__CB_DECL( CCH_BASE64_EQUIV( DRM_RSA_CB_PRIME_MAX_2048BIT ) )]   = { 0 };
    DRM_WCHAR  rgwchCRTExponent0B64[__CB_DECL( CCH_BASE64_EQUIV( DRM_RSA_CB_PRIVEXP_MAX_2048BIT ) )] = { 0 };
    DRM_WCHAR  rgwchCRTExponent1B64[__CB_DECL( CCH_BASE64_EQUIV( DRM_RSA_CB_PRIVEXP_MAX_2048BIT ) )] = { 0 };
    DRM_WCHAR  rgwchIQMPB64        [__CB_DECL( CCH_BASE64_EQUIV( DRM_RSA_CB_MODULUS_MAX_2048BIT ) )] = { 0 };
    ...
    const INTERNAL_DRM_RSA_PRIVATE_KEY_2048BIT *pPvtKey = ( const INTERNAL_DRM_RSA_PRIVATE_KEY_2048BIT * )f_pKeyRSAPrivate;

    DRM_PROFILING_ENTER_SCOPE( PERF_MOD_NDCERT, PERF_FUNC_DRM_XML_RSA_WritePrivateKeyNode );

    ChkArg( f_pXMLCtx != NULL );
    ChkArg( f_pKeyRSAPrivate != NULL );

    dstrPrime0.cchString        = CCH_BASE64_EQUIV( DRM_RSA_CB_PRIME_MAX_2048BIT );
    dstrPrime0.pwszString       = rgwchPrime0B64;
    dstrPrime1.cchString        = CCH_BASE64_EQUIV( DRM_RSA_CB_PRIME_MAX_2048BIT );
    dstrPrime1.pwszString       = rgwchPrime1B64;
    dstrCRTExponent0.cchString  = CCH_BASE64_EQUIV( DRM_RSA_CB_PRIME_MAX_2048BIT );
    dstrCRTExponent0.pwszString = rgwchCRTExponent0B64;
    dstrCRTExponent1.cchString  = CCH_BASE64_EQUIV( DRM_RSA_CB_PRIME_MAX_2048BIT );
    dstrCRTExponent1.pwszString = rgwchCRTExponent1B64;
    dstrIQMP.cchString          = CCH_BASE64_EQUIV( DRM_RSA_CB_PRIME_MAX_2048BIT );
    ...
    __inout       DRM_RSA_PRIVATE_KEY_2048BIT *f_pKeyRSAPrivate )
{
    ...
    INTERNAL_DRM_RSA_PRIVATE_KEY_2048BIT *pPrivKey = ( INTERNAL_DRM_RSA_PRIVATE_KEY_2048BIT * )f_pKeyRSAPrivate;
    ...
    ChkDR( OEM_RSA_ZeroPrivateKey_2048BIT( f_pKeyRSAPrivate ) );

    pPrivKey->cdPrimes[0] = CDIGITS_MODULUS_MAX_2048BIT * SIZEOF(digit_t);
    ...
    pPrivKey->cdPrimes[1] = CDIGITS_MODULUS_MAX_2048BIT * SIZEOF(digit_t);
    ...
    dwTempSize = CDIGITS_MODULUS_MAX_2048BIT * SIZEOF(digit_t);
    ...
    ChkDR( OEM_RSA_GetKeyLengthFromModulusLength_2048BIT( ( pPrivKey->cdPrimes[0] + pPrivKey->cdPrimes[1] ) * SIZEOF(digit_t),
                                                          &pPrivKey->eKeyLength ) );
ErrorExit:
    if ( DRM_FAILED( dr ) && f_pKeyRSAPrivate != NULL )
    {
        OEM_RSA_ZeroPrivateKey_2048BIT( f_pKeyRSAPrivate );
    }
