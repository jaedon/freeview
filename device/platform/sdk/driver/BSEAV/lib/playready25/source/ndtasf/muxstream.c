...
#define DRM_BUILDING_MUXSTREAM_C
...
)
{
    ...
    __analysis_assume( NULL != f_pAsfMuxStreamContext );
    __analysis_assume( NULL != f_ppMuxQueueObject );
    __analysis_assume( NULL != f_pcQueueObjects );
...
DRM_VOID ASFMuxStream_Uninitialize(
    __inout_opt ASF_MUX_STREAM_CONTEXT * const pAsfMuxStreamContext
)
{
...
)
{
    ...
    DRMASSERT( NULL != f_pcQueueObjects );
    __analysis_assume( NULL != f_pAsfMuxStreamContext );
    __analysis_assume( NULL != f_pISample );
    __analysis_assume( NULL != f_ppMuxQueueObjects );
    __analysis_assume( NULL != f_pcQueueObjects );
