...
static DRM_RESULT _GetCertificateAttributes(
    ...
    __out      DRM_RSA_PUBLIC_KEY_2048BIT        **f_ppDevicePublicKey,
...
)
{
    ...
    *f_pdwFeatures = 0;
    for(iFeature = 0; iFeature < cAttrEntries; iFeature++ )
    {
        ...
        else ChkDR( DRM_E_INVALID_DEVICE_CERTIFICATE );
    }
    ...
    */
    ...
    ChkMem( *f_ppDevicePublicKey = (DRM_RSA_PUBLIC_KEY_2048BIT*)Oem_MemAlloc( SIZEOF( DRM_RSA_PUBLIC_KEY_2048BIT ) ) );
...
ErrorExit:
    ...
    if( pContentIntegrityKey != NULL ) {
        ...
        SAFE_OEM_FREE( pContentIntegrityKey );
    }
