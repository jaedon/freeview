...
DRM_API DRM_NO_INLINE DRM_VOID Aes_CreateKey128(
    ...
    __in_bcount( DRM_AES_KEYSIZE_128 ) const DRM_BYTE      f_rgbKey[__CB_DECL( DRM_AES_KEYSIZE_128 )] ) DRM_NO_INLINE_ATTRIBUTE;
    ...
    __in_bcount( DRM_AES_KEYSIZE_128 ) const DRM_BYTE      f_rgbKey[__CB_DECL( DRM_AES_KEYSIZE_128 )] )
{
    ...
    */
    ...
    for( j = KC; j > 0; j-- )
    {
        OEM_SECURE_MEMCPY( ( DRM_BYTE * )&tk[j-1], &f_rgbKey[4 * ( j - 1 )], SIZEOF( DRM_DWORD ) );
    }
    ...
    */
    ...
    OEM_SECURE_MEMCPY( ( DRM_BYTE * )( f_pKeyTable->keytabdec[0] ),
    ...
    __in_ecount( DRM_AES_ROUNDS_128+1 ) const DRM_DWORD  f_rgbKeys[DRM_AES_ROUNDS_128+1][4] )
{
    ...
    OEM_SECURE_MEMCPY( ( DRM_BYTE * )temp, f_rgbClear, DRM_AES_KEYSIZE_128 );
    ...
    */
    ...
    OEM_SECURE_MEMCPY( f_rgbEncrypted, c, SIZEOF( c ) );
    ...
    __in_ecount( DRM_AES_ROUNDS_128+1 ) const DRM_DWORD  f_rgbKeys[DRM_AES_ROUNDS_128+1][4] )
{
    ...
    OEM_SECURE_MEMCPY( ( DRM_BYTE * )temp, f_rgbEncrypted, DRM_AES_KEYSIZE_128 );
    ...
    ** last round is special
    */
    OEM_SECURE_MEMCPY( ( DRM_BYTE * )temp, ( DRM_BYTE * )c, DRM_AES_KEYSIZE_128 );
    ...
    OEM_SECURE_MEMCPY( f_rgbClear, ( DRM_BYTE * )c, DRM_AES_KEYSIZE_128 );
