...
*/
    ...
    else
    {
        ...
        if (dtemps == NULL) {
            ...
            OEM_SECURE_ZERO_MEMORY(Uout,( lng)*SIZEOF( digit_t ));  // U = 0
        } else {
            ...
            OEM_SECURE_DIGITTCPY( Vout,C1,lng);                         // V = C1
            OEM_SECURE_DIGITTCPY( Uout,modulo->one,lng);                // U = 1
