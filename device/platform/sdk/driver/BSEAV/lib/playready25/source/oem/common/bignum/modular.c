...
*/
{
    ...
    if (dtemps_shortterm == NULL || dtemps_longterm == NULL) {
        ...
        OEM_SECURE_DIGITTCPY( pmodulo->modulus,a,lnga);
...
*/
            ...
            pmodulo->scaling_power2 = (DRM_LONG)(RADIX_BITS*lnga);
...
*/
                ...
                OEM_SECURE_DIGITTCPY(pmodulo->multiplier_first, mptmp1 + lngred2, lnga);
...
*/
{
    ...
    if (a != b) OEM_SECURE_DIGITTCPY( b,a,lng);
    ...
    while (OK && shift_remaining > 0) {          /* Do left shift, if any */
        const DRM_LONG shift_now = MIN(shift_remaining, RADIX_BITS);
