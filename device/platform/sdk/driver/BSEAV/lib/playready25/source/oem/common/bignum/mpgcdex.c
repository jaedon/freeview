...
/****************************************************************************/
DRM_NO_INLINE DRM_DWORD DRM_CALL mp_invert_ntemps(const DRM_DWORD lng)
...
*/
{
    ...
    if (!OK) {
        ...
        if (temps_next != tempinfo.address + tempinfo.nelmt) {
            ...
            OEM_SECURE_DIGITTCPY( ab[0],a,( lnga_sig));
            OEM_SECURE_DIGITTCPY( ab[1],b,( lngb_sig));
...
*/
        if (!OK) {
            ...
            if (OK) {
                ...
                OEM_SECURE_DIGITTCPY( ab[ibig],temps_prod,( lngab[ibig]));
    ...
    if (OK) {
        ...
        lgcd = lngab[igcd];
        OEM_SECURE_DIGITTCPY( gcd,ab[igcd],( lgcd));
        ...
        if (!OK) {
            ...
            OEM_SECURE_DIGITTCPY( ainvmodb,temps_mul[0],( lngb));
        } else {
...
*/
    ...
    */
            ...
            if (!OK) {
                ...
                OEM_SECURE_DIGITTCPY( binvmoda,temps_quot,lnga);
...
/*
     ...
     supplied_temps may be NULL or have length mp_invert_ntemps(lng)
*/
{
    DRM_BOOL OK = TRUE;
    digit_tempinfo_t tempinfo;
    ...
    tempinfo.address = supplied_temps;
    tempinfo.need_to_free = FALSE;
    tempinfo.nelmt = mp_invert_ntemps(lng);
