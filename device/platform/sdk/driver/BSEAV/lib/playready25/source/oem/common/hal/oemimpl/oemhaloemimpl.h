...
typedef struct __tagOEM_HAL_AES_KEY_PAIR
{
    ...
    DRM_DWORD                    dwRIVRequiredToWrapThisKey;
...
typedef struct __tagOEM_HAL_ECC256_PUBLIC_KEY
{
    ...
    DRM_DWORD                               dwFullCertKeyUsageBitmap;
    DRM_BOOL                                fRootKey;
...
typedef enum
{
    eOEM_HAL_CRYPTO_TYPE_INVALID                = 0,
    eOEM_HAL_CRYPTO_TYPE_DEFAULT                = 1,
    eOEM_HAL_CRYPTO_TYPE_DERIVED_SYMMETRIC_KEY  = 2,
    eOEM_HAL_CRYPTO_TYPE_AES_KEY_PAIR           = 3,
    eOEM_HAL_CRYPTO_TYPE_TWO_STAGE_ECB          = 4,
    eOEM_HAL_CRYPTO_TYPE_CHAINED_LICENSE_ECC256 = 5,
    eOEM_HAL_CRYPTO_TYPE_SIMPLE_LICENSE_ECC256  = 6,
    eOEM_HAL_CRYPTO_TYPE_AES_ECB                = 7,
    eOEM_HAL_CRYPTO_TYPE_AES_CBC                = 8,
    eOEM_HAL_CRYPTO_TYPE_AES_PADDED_KEY         = 9,
    eOEM_HAL_CRYPTO_TYPE_ECC256_PUBLIC_KEY      = 10,
    eOEM_HAL_CRYPTO_TYPE_ECC256_PRIVATE_KEY     = 11,
...
#define OEM_HAL_RAW_KEY_REGISTER_INVALID { eOEM_HAL_KEYREGISTER_TYPE_INVALID, NULL }
...
#define OEM_HAL_UNWRAP_CONTEXT_INVALID { eOEM_HAL_KEYDATA_TYPE_INVALID, eOEM_HAL_CRYPTO_TYPE_INVALID, OEM_HAL_RAW_KEY_REGISTER_INVALID, OEM_HAL_RAW_KEY_REGISTER_INVALID }
...
#define OEM_HAL_WRAP_CONTEXT_INVALID { eOEM_HAL_CRYPTO_TYPE_INVALID, OEM_HAL_RAW_KEY_REGISTER_INVALID, OEM_HAL_RAW_KEY_REGISTER_INVALID }
