...
#else
DRM_RESULT _GetHWID(__in DRM_BYTE *SerialNumber,
    __out_bcount(DRM_SHA1_DIGEST_LEN) DRM_BYTE *shaOut );
#endif
...
/**********************************************************************
** Function:    Oem_File_Unlink
** Synopsis:    Delete a name and possibly the file it refers to.
** Arguments:   [f_pwszFileName]--Pointer to DRM_WCHAR buffer holding File
**              name.
...
/*****************************************************************************
** Function:    _EncryptAndWriteToFile
**
** Synopsis:    Encrypt a buffer and writes it into the the specified file.
**
** Arguments:   [f_pOEMContext] : A pointer to the OEM context; may be NULL
**              [f_eIDType]     : Device ID Type
**              [f_pbBuffer]    : Buffer pointer in which to store the file contents; may be NULL
**              [f_pcbBuffer]   : A pointer to the buffer size (in bytes)
**              [f_pwszPath]    : The full path to the file to write into.
**
...
/*****************************************************************************
** Function:    _ReadAndDecryptFromFile
**
** Synopsis:    Reads the file specified into the provided buffer and decrypt it.
...
** Synopsis:    Initializes the oemtime module.
**              'time delta' will be updated.
** Arguments:   N/A
***********************************************************************/
...
** Synopsis:    Unitializes the oemtime module.
**              'time delta' file will be updated.
** Arguments:   N/A
***********************************************************************/
