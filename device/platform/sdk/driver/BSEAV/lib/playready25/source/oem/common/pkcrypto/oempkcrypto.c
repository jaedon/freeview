...
#define DRM_BUILDING_OEMPKCRYPTO_C
    ...
    __out_bcount( *f_pcbPrivateKey )DRM_BYTE                              *f_pbPrivateKey )
{
    ...
    case eDRM_RSA:
        ...
        ChkArg( f_eRSAKeyLength == eDRM_RSA_KEY_LENGTH_1024_2048BIT || f_eRSAKeyLength == eDRM_RSA_KEY_LENGTH_2048_2048BIT );
        ChkBOOL( *f_pcbPublicKey  >= DRM_RSA_CB_PUBKEY_2048BIT , DRM_E_BUFFERTOOSMALL );
        ChkBOOL( *f_pcbPrivateKey >= DRM_RSA_CB_PRIVKEY_2048BIT, DRM_E_BUFFERTOOSMALL );
        ChkDR( OEM_RSA_GenerateKeyPair_2048BIT(  f_eRSAKeyLength,
                                     ( DRM_RSA_PRIVATE_KEY_2048BIT * )f_pbPrivateKey,
                                     ( DRM_RSA_PUBLIC_KEY_2048BIT * )f_pbPublicKey,
                                     ( DRM_CRYPTO_CONTEXT * )f_pContext ) );
        *f_pcbPublicKey  = DRM_RSA_CB_PUBKEY_2048BIT;
        *f_pcbPrivateKey = DRM_RSA_CB_PRIVKEY_2048BIT;
        break;
    default:
    ...
    __out_bcount( *f_pcbCipherText )   DRM_BYTE                           *f_pbCipherText )
{
    ...
    case eDRM_RSA:
        ChkArg( f_pContext != NULL );
        ChkArg( f_cbPublicKey == SIZEOF( DRM_RSA_PUBLIC_KEY_2048BIT ) );

        ChkDR( OEM_RSA_OaepEncrypt_2048BIT(                               f_pOEMContext,
                                    ( const DRM_RSA_PUBLIC_KEY_2048BIT * )f_pbPublicKey,
                                                                          f_cbPlainText,
                                                                          f_pbPlainText,
                                                                          f_pcbCipherText,
                                                                          f_pbCipherText,
    ...
    __out_bcount( *f_pcbPlainText )     DRM_BYTE                           *f_pbPlainText )
{
    ...
    case eDRM_RSA:
        ChkArg( f_pContext != NULL );
        ChkArg( f_cbPrivateKey == SIZEOF( DRM_RSA_PRIVATE_KEY_2048BIT ) );

        ChkDR( OEM_RSA_OaepDecrypt_2048BIT( ( const DRM_RSA_PRIVATE_KEY_2048BIT * )f_pbPrivateKey,
                                                                                   f_cbCipherText,
                                                                                   f_pbCipherText,
                                                                                   f_pcbPlainText,
                                                                                   f_pbPlainText,
    ...
    __out_bcount( *f_pcbSignature )     DRM_BYTE                           *f_pbSignature )
{
    ...
    case eDRM_RSA:
        ...
        ChkDR( OEM_RSA_PssSign_2048BIT( ( const DRM_RSA_PRIVATE_KEY_2048BIT * )f_pbPrivateKey,
                                                                               f_cbData,
                                                                               f_pbData,
                                                                               0,
                                                                               f_pcbSignature,
    ...
    __in_bcount( f_cbSignature ) const DRM_BYTE                           *f_pbSignature )
{
    ...
    case eDRM_RSA:
        ...
        ChkDR( OEM_RSA_PssVerify_2048BIT( ( const DRM_RSA_PUBLIC_KEY_2048BIT * )f_pbPublicKey,
                                                                                f_cbData,
                                                                                f_pbData,
                                                                                0,
                                                                                f_cbSignature,
