...
static DRM_RESULT DRM_CALL _OpenEnvelope(
    ...
    __out                               DRM_DWORD                   *f_pibDRMHeaderOffsetInFile,
    ...
    __in                                DRM_DWORD                    f_cbDRMHeaderData )
{
    ...
    */
    *f_pibDRMHeaderOffsetInFile = (DRM_DWORD)( f_pEnvFile->oEnvHeader.cbOriginalFilename + DRM_ENVELOPE_MINIMUM_HEADER_SIZE );
    ...
    */
    ...
    {
        DRM_LONG lFileDataStart = 0;
        ChkDR( DRM_DWordToLong( f_pEnvFile->dwFileDataStart, &lFileDataStart ) );
        ChkBOOL( Oem_File_SetFilePointer( f_pEnvFile->pEnvFileHandle,
                                          lFileDataStart,
    ...
    __inout DRM_MEDIA_FILE_CONTEXT *f_poMediaFile )
{
    ...
    Drm_Reader_Close( &f_poMediaFile->oDecryptContext );
    ...
    __in DRM_MEDIA_FILE_CONTEXT *f_poMediaFile )
{
    ...
    ChkBOOL( !f_poMediaFile->fReadOnly, DRM_E_FILE_WRITE_ERROR );
    ...
    {
        DRM_LONG lOffset = 0;
        ChkDR( DRM_DWordToLong( f_poMediaFile->ibDRMHeaderOffsetInFile, &lOffset ) );
        ChkBOOL( Oem_File_SetFilePointer( fp, lOffset, OEM_FILE_BEGIN, NULL ), DRM_E_FAIL );
    }
