...
**
**********************************************************************/
static DRM_VOID _PrintUsage( __in const DRM_WCHAR * f_pwszAppName )
{
...
**                          DRM_E_FILE_READ_ERROR if file read fails.
**                          DRM_E_FILE_WRITE_ERROR if file read fails.
**
**********************************************************************/
static DRM_RESULT _GenerateChallenge(
    __in const DRM_CONST_STRING *f_pdstrContentFile,
    __in const DRM_CONST_STRING *f_pdstrHeaderFile,
    __in const DRM_CONST_STRING *f_pdstrOutputFile,
    __in const DRM_CONST_STRING *f_pdstrURLFile,
    __in const DRM_CONST_STRING *f_pdstrDataStoreFile,
    __in       DRM_BOOL          f_fEnvelope,
    __in       DRM_BOOL          f_fSOAP )
{
