...
#define DRM_BUILDING_DRMXMRPARSER_C
...
static const XMR_PARSER_INTERNAL_DEFINES g_xmrParserDefines[XMR_OBJECT_TYPE_MAXIMUM_DEFINED+1] =
{
    ...
    { DRM_XMR_Parse_Invalid,                                       { FALSE, FALSE, FALSE } },   /* Deprecated: XMR_OBJECT_TYPE_INVALID_RESERVED_53 (0x0053) was documented in PlayReady 2.0 CHM for Content Boundary Identification Object */
    { DRM_XMR_Parse_UnknownObject,                                 { FALSE, FALSE,  TRUE } },   /* XMR_OBJECT_TYPE_APPLICATION_ID_LIST */
    { DRM_XMR_Parse_Empty,                                         { FALSE, FALSE,  TRUE } },   /* XMR_OBJECT_TYPE_REAL_TIME_EXPIRATION */
    { DRM_XMR_Parse_NDTXAuthContainer,                             { FALSE, FALSE,  TRUE } },   /* XMR_OBJECT_TYPE_ND_TX_AUTH_CONTAINER */
    { DRM_XMR_Parse_NDTXAuthObject,                                { FALSE, FALSE,  TRUE } },   /* XMR_OBJECT_TYPE_ND_TX_AUTH_OBJECT */
};
    ...
    __inout       DRM_VOID                    *f_pvObject )
{
    ...
    pContainer->containerNDTxAuth.fValid                = FALSE;
    ...
    while ( iCurrent < f_iObject + f_cbObject )
    {
        ...
        switch ( wType )
        {
            ...
            case XMR_OBJECT_TYPE_PLAYBACK_POLICY_CONTAINER:
                ChkBOOL( !pContainer->containerPlaybackPolicies.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_COPY_POLICY_2_CONTAINER:
                ChkBOOL( !pContainer->containerCopyPolicies.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
                ...
                pContainer->containerCopyPolicies.dwVersion =
                    ( wType == XMR_OBJECT_TYPE_COPY_POLICY_CONTAINER ) ? (DRM_DWORD)1 : (DRM_DWORD)2;
                ...
                ChkBOOL(
                 ...
                 || pContainer->containerCopyPolicies.dwVersion == pContainer->containerCopyPolicies.CopyCount.dwVersion, DRM_E_INVALID_LICENSE );

                break;

            case XMR_OBJECT_TYPE_COPY_TO_PC_CONTAINER:
                ChkBOOL( !pContainer->containerCopyToPCPolicies.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_ALLOW_PLAYLISTBURN_POLICY_CONTAINER:
                ChkBOOL( !pContainer->containerPlaylistBurnPolicies.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_REVOCATION_CONTAINER:
                ChkBOOL( !pContainer->containerRevocation.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_GENERATION_NUMBER_OBJECT:
                ChkBOOL( !pContainer->generationNumber.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_ND_TX_AUTH_CONTAINER:
                ChkBOOL( !pContainer->containerNDTxAuth.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
                                                         &pContainer->containerNDTxAuth ) );
                break;
        ...
        switch ( wType )
        {
            ...
            case XMR_OBJECT_TYPE_SECURITY_LEVEL:
                ...
                pcontainerGlobal->MinimumEnvironment.dwVersion =
                    ( wType == XMR_OBJECT_TYPE_MINIMUM_ENVIRONMENT_OBJECT ) ? (DRM_DWORD)1 : (DRM_DWORD)2;
                break;
            case XMR_OBJECT_TYPE_SERIAL_NUMBER_OBJECT:
                ChkBOOL( !pcontainerGlobal->SerialNumber.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_PRIORITY_OBJECT:
                ChkBOOL( !pcontainerGlobal->Priority.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_EXPIRATION_OBJECT:
                ChkBOOL( !pcontainerGlobal->Expiration.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
                ...
                break;
            case XMR_OBJECT_TYPE_REAL_TIME_EXPIRATION:
                ChkBOOL( !pcontainerGlobal->RealTimeExpiration.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
                                                         &pcontainerGlobal->RealTimeExpiration ) );
                break;
            case XMR_OBJECT_TYPE_ISSUEDATE_OBJECT:
                ChkBOOL( !pcontainerGlobal->IssueDate.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_REMOVAL_DATE_OBJECT:
                ChkBOOL( !pcontainerGlobal->RemovalDate.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_GRACE_PERIOD_OBJECT:
                ChkBOOL( !pcontainerGlobal->GracePeriod.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_EXPIRATION_AFTER_FIRSTPLAY_OBJECT:
                ChkBOOL( !pcontainerGlobal->ExpirationAfterUse.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
                ...
                pcontainerGlobal->ExpirationAfterUse.dwVersion =
                    ( wType == XMR_OBJECT_TYPE_EXPIRATION_AFTER_FIRSTUSE_OBJECT ) ? (DRM_DWORD)1 : (DRM_DWORD)2;
                break;
            case XMR_OBJECT_TYPE_EXPIRATION_AFTER_FIRSTSTORE_OBJECT:
                ChkBOOL( !pcontainerGlobal->ExpirationAfterStore.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_METERING_OBJECT:
                ChkBOOL( !pcontainerGlobal->Metering.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_SOURCEID_OBJECT:
                ChkBOOL( !pcontainerGlobal->SourceID.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_RESTRICTED_SOURCEID_OBJECT:
                ChkBOOL( !pcontainerGlobal->RestrictedSourceID.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_INCLUSION_LIST_OBJECT:
                ChkBOOL( !pcontainerGlobal->InclusionList.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_DOMAIN_ID_OBJECT:
                ChkBOOL( !pcontainerGlobal->DomainID.fValid, DRM_E_INVALID_LICENSE);
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_EMBEDDING_BEHAVIOR_OBJECT:
                ChkBOOL( !pcontainerGlobal->EmbeddingBehavior.fValid, DRM_E_INVALID_LICENSE);
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            default:
                ...
                */
                ChkBOOL( ( wFlags & XMR_FLAGS_MUST_UNDERSTAND ) == 0
                       || ( ( wFlags & XMR_FLAGS_ALLOW_EXTERNAL_PARSE ) != 0 && ( wFlags & XMR_FLAGS_CONTAINER ) == 0 ), DRM_E_INVALID_LICENSE );
    ...
    while ( iCurrent < f_iObject + f_cbObject )
    {
        ...
        switch ( wType )
        {
            case XMR_OBJECT_TYPE_PLAYCOUNT_OBJECT:
                ChkBOOL( !pcontainer->PlayCount.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_OUTPUT_PROTECTION_OBJECT:
                ChkBOOL( !pcontainer->opl.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_EXPLICIT_ANALOG_VIDEO_OUTPUT_PROTECTION_CONTAINER:
                ChkBOOL( !pcontainer->containerExplicitAnalogVideoProtection.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_EXPLICIT_DIGITAL_AUDIO_OUTPUT_PROTECTION_CONTAINER:
                ChkBOOL( !pcontainer->containerExplicitDigitalAudioProtection.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_PLAY_ENABLER_CONTAINER:
                ChkBOOL( ( wFlags & XMR_FLAGS_MUST_UNDERSTAND ) == 0, DRM_E_INVALID_LICENSE );
                ChkBOOL( ( wFlags & XMR_FLAGS_CONTAINER ) != 0, DRM_E_INVALID_LICENSE );
...
** Arguments :
**      [f_pStack]    : Stack for intermediate usage
**      [f_pbBuffer] : Base address in license
**      [f_iObject]   : Index marking beginning of object in the buffer
**      [f_cbObject]  : Size of serialized object
**      [f_pvObject]  : Actual object returned as void
**
    ...
    __inout       DRM_VOID                    *f_pvObject )
{
    ...
    pcontainer->pbRawData = f_pbBuffer;
    ...
    __inout       DRM_VOID                    *f_pvObject )
{
    ...
    pListNode->MetadataObject.pMetadataTypeGuidBuffer = ( DRM_BYTE * )f_pbBuffer;
    ...
    pListNode->MetadataObject.pbPolicyDataBuffer      = ( DRM_BYTE * )f_pbBuffer;
    ...
    while ( iCurrent < f_iObject + f_cbObject )
    {
        ...
        switch ( wType )
        {
            ...
            case XMR_OBJECT_TYPE_RSA_LICENSE_GRANTER_KEY_OBJECT:
                ChkBOOL( !pcontainer->RsaLicenseGranterKey.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_USERID_OBJECT:
                ChkBOOL( !pcontainer->UserID.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
    ...
    while ( iCurrent < f_iObject + f_cbObject )
    {
        ...
        switch ( wType )
        {
            ...
            case XMR_OBJECT_TYPE_COPYCOUNT_2_OBJECT:
                ChkBOOL( !pcontainer->CopyCount.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
                ...
                pcontainer->CopyCount.dwVersion =
                    ( wType == XMR_OBJECT_TYPE_COPYCOUNT_OBJECT ) ? (DRM_DWORD)1 : (DRM_DWORD)2;
                break;

            case XMR_OBJECT_TYPE_COPY_PROTECTION_OBJECT:
                ChkBOOL( !pcontainer->CopyProtectionLevel.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
            ...
            case XMR_OBJECT_TYPE_MOVE_ENABLER_OBJECT:
                ChkBOOL( !pcontainer->MoveEnabler.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
    ...
    while ( iCurrent < f_iObject + f_cbObject )
    {
        ...
        switch ( wType )
        {
            case XMR_OBJECT_TYPE_PLAYLISTBURN_COUNT_OBJECT:
                ChkBOOL( !pcontainer->Restrictions.fValid, DRM_E_INVALID_LICENSE );
                ChkDR( g_xmrParserDefines[wType].fnParse( f_pStack,
                                                          f_pbBuffer,
                                                          iCurrent,
                                                          cbChild,
    ...
    __inout       DRM_VOID                    *f_pvObject )
{
    ...
    ChkArg( f_pvObject != NULL );
    ChkArg( f_pbBuffer != NULL );
    ChkBOOL( f_cbObject >= XMR_BASE_OBJECT_LENGTH + SIZEOF( DRM_WORD ), DRM_E_INVALID_LICENSE );
    ChkOverflow( f_iObject + XMR_BASE_OBJECT_LENGTH, f_iObject );
    ...
    __inout       DRM_VOID                    *f_pvObject )
{
    ...
    ChkArg( f_pvObject != NULL );
    ChkArg( f_pbBuffer != NULL );
    ChkBOOL( f_cbObject >= XMR_BASE_OBJECT_LENGTH + SIZEOF( DRM_GUID ), DRM_E_INVALID_LICENSE );
    ChkOverflow( f_iObject + XMR_BASE_OBJECT_LENGTH, f_iObject );
    ...
    __inout       DRM_VOID                    *f_pvObject )
{
    ...
    pcontainer->fValid            = TRUE;
    NETWORKBYTES_TO_WORD( pcontainer->wFlags, f_pbBuffer, f_iObject );
    NETWORKBYTES_TO_WORD( pcontainer->wType, f_pbBuffer, f_iObject + SIZEOF( DRM_WORD ) );
    ...
    while ( iCurrent < f_iObject + f_cbObject )
    {
        ...
        */
        ChkBOOL( ( wFlags & XMR_FLAGS_MUST_UNDERSTAND ) == 0
               || ( ( wFlags & XMR_FLAGS_ALLOW_EXTERNAL_PARSE ) != 0 ), DRM_E_INVALID_LICENSE );
    ...
    __inout       DRM_VOID                    *f_pvObject )
{
    ...
    ChkArg( f_pvObject != NULL );
    ChkArg( f_pbBuffer != NULL );
    ChkBOOL( f_cbObject == XMR_BASE_OBJECT_LENGTH + SIZEOF( DRM_DWORD ) * 5, DRM_E_INVALID_LICENSE );
    ChkOverflow( iObject, f_iObject );
...
/******************************************************************************
**
** Function :   DRM_XMR_Parse_NDTXAuthContainer
**
** Synopsis :   Parses the ND TX Authorization Container
**
** Arguments :
**      [f_pStack]   : Stack for intermediate usage
**      [f_pbBuffer] : Object Buffer
...
**
******************************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_XMR_Parse_NDTXAuthContainer(
    __in          DRM_STACK_ALLOCATOR_CONTEXT *f_pStack,
    __in    const DRM_BYTE                    *f_pbBuffer,
    __in          DRM_DWORD                    f_iObject,
    __in          DRM_DWORD                    f_cbObject,
    __inout       DRM_VOID                    *f_pvObject )
{
    ...
    DRM_WORD                      wType       = 0;
    DRM_DWORD                     cbChild     = 0;
    DRM_XMR_ND_TX_AUTH_OBJECT    *pNDTxObject = NULL;
    DRM_XMR_ND_TX_AUTH_CONTAINER *pcontainer  = ( DRM_XMR_ND_TX_AUTH_CONTAINER * )f_pvObject;
    ...
    while ( iCurrent < f_iObject + f_cbObject )
    {
        ...
        ** parse the object then we may be able to continue
        */
        ChkBOOL( wType == XMR_OBJECT_TYPE_ND_TX_AUTH_OBJECT, DRM_E_INVALID_LICENSE );
        ChkBOOL( ( wFlags & XMR_FLAGS_CONTAINER) == 0, DRM_E_INVALID_LICENSE );

        /* Parse the object if any */
        /* Alloc space and add to linked list */
        ChkDR( DRM_STK_Alloc_Aligned( f_pStack,
                                      SIZEOF( DRM_XMR_ND_TX_AUTH_OBJECT ),
                                      SIZEOF( DRM_DWORD ),
                                      NULL,
                                      ( DRM_VOID ** ) &pNDTxObject ) );

        ZEROMEM( pNDTxObject, SIZEOF( DRM_XMR_ND_TX_AUTH_OBJECT ) );
        ...
        pNDTxObject->pNext = pcontainer->pAuthObject;
        pcontainer->pAuthObject = pNDTxObject;
...
/******************************************************************************
**
** Function :   DRM_XMR_Parse_NDTXAuthObject
**
** Synopsis :   Parse an ND Transmitter Athorization Object
**
** Arguments :
**      [f_pStack]   : Stack for intermediate usage
**      [f_pbBuffer] : Object Buffer
...
**
******************************************************************************/
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_XMR_Parse_NDTXAuthObject(
    __in          DRM_STACK_ALLOCATOR_CONTEXT *f_pStack,
    __in    const DRM_BYTE                    *f_pbBuffer,
    __in          DRM_DWORD                    f_iObject,
    __in          DRM_DWORD                    f_cbObject,
    __inout       DRM_VOID                    *f_pvObject )
{
    DRM_RESULT dr       = DRM_SUCCESS;
    DRM_DWORD  iObject  = f_iObject;
    DRM_XMR_ND_TX_AUTH_OBJECT *pAuthObject =
            ( DRM_XMR_ND_TX_AUTH_OBJECT * )f_pvObject;
    ...
    NETWORKBYTES_TO_WORD( pAuthObject->wVersion, f_pbBuffer, iObject );

    ChkOverflow( iObject + SIZEOF( DRM_WORD ), iObject );
    iObject += SIZEOF( DRM_WORD );

    ChkBOOL( f_cbObject >= XMR_BASE_OBJECT_LENGTH +
                           SIZEOF( DRM_WORD ) + SIZEOF( DRM_DWORD ),
             DRM_E_INVALID_LICENSE );

    NETWORKBYTES_TO_DWORD( pAuthObject->cbDataClient, f_pbBuffer, iObject );

    ChkOverflow( iObject + SIZEOF( DRM_DWORD ), iObject );
    iObject += SIZEOF( DRM_DWORD );

    ChkBOOL( f_cbObject >= XMR_BASE_OBJECT_LENGTH +
                           SIZEOF( DRM_WORD ) + SIZEOF( DRM_DWORD ) + pAuthObject->cbDataClient,
             DRM_E_INVALID_LICENSE );

    pAuthObject->pbBufferClient = (DRM_BYTE*)f_pbBuffer;
    pAuthObject->ibDataClient   = iObject;

    ChkOverflow( iObject + pAuthObject->cbDataClient, iObject );
    iObject += pAuthObject->cbDataClient;


    ChkBOOL( f_cbObject >= XMR_BASE_OBJECT_LENGTH +
                           SIZEOF( DRM_WORD ) + SIZEOF( DRM_DWORD ) + pAuthObject->cbDataClient + SIZEOF(DRM_DWORD),
             DRM_E_INVALID_LICENSE );

    NETWORKBYTES_TO_DWORD( pAuthObject->cbDataService, f_pbBuffer, iObject );

    ChkOverflow( iObject + SIZEOF( DRM_DWORD ), iObject );
    iObject += SIZEOF( DRM_DWORD );

    ChkBOOL( f_cbObject >= XMR_BASE_OBJECT_LENGTH +
                           SIZEOF( DRM_WORD ) + SIZEOF( DRM_DWORD ) + pAuthObject->cbDataClient + SIZEOF(DRM_DWORD) + pAuthObject->cbDataService,
             DRM_E_INVALID_LICENSE );

    pAuthObject->pbBufferService = (DRM_BYTE*)f_pbBuffer;
    pAuthObject->ibDataService   = iObject;

    ChkOverflow( iObject + pAuthObject->cbDataService, iObject );
    iObject += pAuthObject->cbDataService;

    pAuthObject->fValid = TRUE;
    ...
    __out                            DRM_XMR_LICENSE             *f_pXmrLicense )
{
    ...
    ChkDR( DRM_XMR_GetContainer( f_pbBuffer,
                                 f_cbLicense,
...
#define VALIDATE_UNKNOWN_OBJECTS_ARE_V2( pXmrLicense, IS_VALID_MACRO, ObjPath )     \
    ChkBOOL(                                                                        \
     ...
     || ( (pXmrLicense)->dwVersion >= XMR_VERSION_2 ), DRM_E_INVALID_LICENSE )
        ...
        {                                                                                                                   \
            ...
            {                                                                                                               \
                ...
                {                                                                                                           \
                    ...
                    {                                                                                                       \
                        ChkBOOL( pXmrLicense->dwVersion >= XMR_VERSION_2, DRM_E_INVALID_LICENSE );                           \
                    }                                                                                                       \
                }                                                                                                           \
    ...
    __in const DRM_XMR_LICENSE *f_pXmrLicense )
{
    ...
    if( XMR_IS_MINIMUM_ENVIRONMENT_VALID( f_pXmrLicense ) )
    {
        ...
        {
        case XMR_VERSION_1:
            ChkBOOL( f_pXmrLicense->containerOuter.containerGlobalPolicies.MinimumEnvironment.dwVersion == 1, DRM_E_INVALID_LICENSE );
            break;
        case XMR_VERSION_3:
            ChkBOOL( f_pXmrLicense->containerOuter.containerGlobalPolicies.MinimumEnvironment.dwVersion == 2, DRM_E_INVALID_LICENSE );
            break;
        default:
    ...
    if( XMR_IS_EXPIRATION_AFTER_FIRST_USE_VALID( f_pXmrLicense ) )
    {
        ...
        case XMR_VERSION_1:
            ChkBOOL( f_pXmrLicense->containerOuter.containerGlobalPolicies.ExpirationAfterUse.dwVersion == 1
                  || f_pXmrLicense->containerOuter.containerGlobalPolicies.ExpirationAfterUse.dwVersion == 2, DRM_E_INVALID_LICENSE );
            break;
        case XMR_VERSION_3:
            ChkBOOL( f_pXmrLicense->containerOuter.containerGlobalPolicies.ExpirationAfterUse.dwVersion == 2, DRM_E_INVALID_LICENSE );
            break;
        default:
            AssertChkArg( FALSE ); /* Should never be reached - checked previously */
            break;
    ...
    if( XMR_IS_REVOCATION_INFORMATION_VERSION_VALID( f_pXmrLicense ) )
    {
        ...
        {
        case XMR_VERSION_1:
            ChkBOOL( f_pXmrLicense->containerOuter.containerGlobalPolicies.RevocationInformationVersion.dwVersion == 1, DRM_E_INVALID_LICENSE );
            break;
        case XMR_VERSION_3:
            ChkBOOL( f_pXmrLicense->containerOuter.containerGlobalPolicies.RevocationInformationVersion.dwVersion == 2, DRM_E_INVALID_LICENSE );
            break;
        default:
            AssertChkArg( FALSE ); /* Should never be reached - checked previously */
            break;
    ...
    if( XMR_IS_UPLINK_KID_VALID( f_pXmrLicense ) )
    {
        ...
        {
        case XMR_VERSION_1:
            ChkBOOL( f_pXmrLicense->containerOuter.containerKeys.UplinkKid.dwVersion == 1, DRM_E_INVALID_LICENSE );
            ChkBOOL( f_pXmrLicense->containerOuter.containerKeys.UplinkKid.wChecksumType == XMR_UPLINK_CHECKSUM_TYPE_XMRV1, DRM_E_INVALID_LICENSE );
            break;
        case XMR_VERSION_3:
            ChkBOOL( f_pXmrLicense->containerOuter.containerKeys.UplinkKid.dwVersion == 2, DRM_E_INVALID_LICENSE );
            ChkBOOL( f_pXmrLicense->containerOuter.containerKeys.UplinkKid.wChecksumType == XMR_UPLINK_CHECKSUM_TYPE_AESOMAC1, DRM_E_INVALID_LICENSE );
            break;
        default:
            AssertChkArg( FALSE ); /* Should never be reached - checked previously */
            break;
    ...
    if( XMR_IS_COPY_VALID( f_pXmrLicense ) )
    {
        ...
        case XMR_VERSION_1:
            ...
            ChkBOOL( f_pXmrLicense->containerOuter.containerCopyPolicies.dwVersion == 1
                  || f_pXmrLicense->containerOuter.containerCopyPolicies.dwVersion == 2, DRM_E_INVALID_LICENSE );
            break;
        case XMR_VERSION_3:
            ChkBOOL( f_pXmrLicense->containerOuter.containerCopyPolicies.dwVersion == 2, DRM_E_INVALID_LICENSE );
            break;
        default:
            AssertChkArg( FALSE ); /* Should never be reached - checked previously */
            break;
    ...
    if( XMR_IS_COPYCOUNT_VALID( f_pXmrLicense ) )
    {
        ...
        case XMR_VERSION_1:
            ...
            ChkBOOL( f_pXmrLicense->containerOuter.containerCopyPolicies.CopyCount.dwVersion == 1
                  || f_pXmrLicense->containerOuter.containerCopyPolicies.CopyCount.dwVersion == 2, DRM_E_INVALID_LICENSE );
            break;
        case XMR_VERSION_3:
            ChkBOOL( f_pXmrLicense->containerOuter.containerCopyPolicies.CopyCount.dwVersion == 2, DRM_E_INVALID_LICENSE );
            break;
        default:
            AssertChkArg( FALSE ); /* Should never be reached - checked previously */
            break;
...
{
    DRM_RESULT                          dr                             = DRM_SUCCESS;
    const DRM_XMR_UNKNOWN_CONTAINER    *pUnknownContainer              = NULL;
    ...
    */
    ...
    VALIDATE_OPTIONAL_OBJECT( f_pXmrLicense, XMR_IS_REAL_TIME_EXPIRATION_VALID,             XMR_OBJECT_TYPE_REAL_TIME_EXPIRATION );
    ...
    ChkBOOL(
     ...
     || ( f_pXmrLicense->dwVersion >= XMR_VERSION_2 ), DRM_E_INVALID_LICENSE ); /* Unknown objects are V2 and up */
       ...
       || ( f_pXmrLicense->containerOuter.containerCopyPolicies.dwVersion == 2 ) ) )
    {
        ...
        */
            ...
            if( pUnknownContainer->wType == XMR_OBJECT_TYPE_COPY_ENABLER_CONTAINER )
            {
                ...
                while( ( pUnknownObject != NULL ) && pUnknownObject->fValid )
                {
                    if( pUnknownObject->wType == XMR_OBJECT_TYPE_COPY_ENABLER_OBJECT )
                    {
                        ...
                        */
                        ChkBOOL( SIZEOF(DRM_GUID) == (pUnknownObject->cbData), DRM_E_INVALID_LICENSE );
        ...
        ChkBOOL( fHasCopyEnabler, DRM_E_INVALID_LICENSE );
    }
    ...
    if( XMR_IS_DOMAIN_ID_VALID( f_pXmrLicense ) )
    {
        ...
        */
        ChkBOOL( !fHasDomainInvalidCopyEnabler, DRM_E_INVALID_LICENSE );

        /*
        ** Make sure the license doesn't have an uplink KID or uplinkX, because leaf
        ** licenses cannot be domain-bound
        */
        ChkBOOL( !XMR_IS_UPLINK_KID_VALID( f_pXmrLicense ), DRM_E_INVALID_LICENSE );
        ChkBOOL( !XMR_IS_UPLINKX_VALID( f_pXmrLicense ), DRM_E_INVALID_LICENSE );
    }
    ...
    {
        ChkBOOL( f_pXmrLicense->containerOuter.containerGlobalPolicies.MinimumEnvironment.dwMinimumAppRevocationListVersion     == 0, DRM_E_INVALID_LICENSE );
        ChkBOOL( f_pXmrLicense->containerOuter.containerGlobalPolicies.MinimumEnvironment.dwMinimumDeviceRevocationListVersion  == 0, DRM_E_INVALID_LICENSE );
    }
...
DRM_API DRM_NO_INLINE DRM_RESULT DRM_CALL DRM_XMR_UpdateLicenseSizeForSymmKey(
    __inout_bcount( f_cbLicense )     DRM_BYTE                      *f_pbBuffer,
    __in                              DRM_DWORD                      f_cbLicense,
    ...
    __in                              DRM_DWORD                     *f_pdwInsertionPoint )
{
    ...
    */
    WORD_TO_NETWORKBYTES( f_pbBuffer, *f_pdwInsertionPoint, 0 );
    *f_pdwInsertionPoint += SIZEOF( DRM_WORD );
    WORD_TO_NETWORKBYTES( f_pbBuffer, *f_pdwInsertionPoint, XMR_OBJECT_TYPE_OPTIMIZED_CONTENT_KEY_OBJECT );
    *f_pdwInsertionPoint += SIZEOF( DRM_WORD );
    DWORD_TO_NETWORKBYTES( f_pbBuffer, *f_pdwInsertionPoint, DRM_XMR_SYMMETRIC_CONTENT_KEY_AES_SIZE );
    *f_pdwInsertionPoint += SIZEOF( DRM_DWORD );
    WORD_TO_NETWORKBYTES( f_pbBuffer, *f_pdwInsertionPoint, XMR_SYMMETRIC_KEY_ENCRYPTION_TYPE_AES_128_ECB );
    *f_pdwInsertionPoint += SIZEOF( DRM_WORD );
    WORD_TO_NETWORKBYTES ( f_pbBuffer, *f_pdwInsertionPoint, DRM_AES_BLOCKLEN * 2 );
    *f_pdwInsertionPoint += SIZEOF( DRM_WORD );
    DRM_BYT_SetBytes( f_pbBuffer,
                      *f_pdwInsertionPoint,
                      DRM_AES_BLOCKLEN * 2,
                      0x00 );
    ...
    *f_pdwInsertionPoint += 2 * SIZEOF( DRM_WORD ); /* Insert size after flags, object type */
    ...
    NETWORKBYTES_TO_DWORD( cbObject, f_pbBuffer, *f_pdwInsertionPoint );
    cbObject += DRM_XMR_SYMMETRIC_CONTENT_KEY_AES_SIZE;
    DWORD_TO_NETWORKBYTES( f_pbBuffer, *f_pdwInsertionPoint, cbObject );
