...
extern const DRM_BYTE g_rgbRSAModulus1024[__CB_DECL( DRM_RSA_CB_MODULUS( eDRM_RSA_KEY_LENGTH_1024_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAPrivExp1024[__CB_DECL( DRM_RSA_CB_PRIVEXP( eDRM_RSA_KEY_LENGTH_1024_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAPrimes1024[2][__CB_DECL( DRM_RSA_CB_PRIME( eDRM_RSA_KEY_LENGTH_1024_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAKnownPlaintext1024[2][__CB_DECL( DRM_RSA_CB_MODULUS( eDRM_RSA_KEY_LENGTH_1024_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAKnownCiphertext1024[2][__CB_DECL( DRM_RSA_CB_MODULUS( eDRM_RSA_KEY_LENGTH_1024_4096BIT ) )];

extern const DRM_BYTE g_rgbRSAModulus2048[__CB_DECL( DRM_RSA_CB_MODULUS( eDRM_RSA_KEY_LENGTH_2048_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAPrivExp2048[__CB_DECL( DRM_RSA_CB_PRIVEXP( eDRM_RSA_KEY_LENGTH_2048_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAPrimes2048[2][__CB_DECL( DRM_RSA_CB_PRIME( eDRM_RSA_KEY_LENGTH_2048_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAKnownPlaintext2048[2][__CB_DECL( DRM_RSA_CB_MODULUS( eDRM_RSA_KEY_LENGTH_2048_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAKnownCiphertext2048[2][__CB_DECL( DRM_RSA_CB_MODULUS( eDRM_RSA_KEY_LENGTH_2048_4096BIT ) )];

extern const DRM_BYTE g_rgbRSAModulus4096[__CB_DECL( DRM_RSA_CB_MODULUS( eDRM_RSA_KEY_LENGTH_4096_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAPrivExp4096[__CB_DECL( DRM_RSA_CB_PRIVEXP( eDRM_RSA_KEY_LENGTH_4096_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAPrimes4096[2][__CB_DECL( DRM_RSA_CB_PRIME( eDRM_RSA_KEY_LENGTH_4096_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAKnownPlaintext4096[2][__CB_DECL( DRM_RSA_CB_MODULUS( eDRM_RSA_KEY_LENGTH_4096_4096BIT ) )];
extern const DRM_BYTE g_rgbRSAKnownCiphertext4096[2][__CB_DECL( DRM_RSA_CB_MODULUS( eDRM_RSA_KEY_LENGTH_4096_4096BIT ) )];

extern DRM_RSA_PUBLIC_KEY_4096BIT   g_RsaPubKey;
extern DRM_RSA_PRIVATE_KEY_4096BIT  g_RsaPrivKey;
extern DRM_DWORD                    g_cbRsaCiphertext;
extern DRM_BYTE                     g_rgbRSACiphertext[__CB_DECL( DRM_RSA_CB_MODULUS_MAX_4096BIT )];
extern DRM_BYTE                     g_rgbRSAPlaintext[__CB_DECL( DRM_RSA_CB_MODULUS_MAX_4096BIT )];
