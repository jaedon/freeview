    ...
    */
    if ( argc >= 3 && argv[2] != NULL )
    {
        ...
        */
        ...
        DRM_DWORD     cbTemp     = 0;
        ChkDR( DRM_SizeTToDWord( DRMCRT_strlen( argv[2] ), &cbTemp ) );
    ...
    else if ( strncmp( argv[0], "AES", 3 ) == 0 )
    {
        ...
        */
        if ( argc >= 4 && argv[3] != NULL )
        {
            ...
            ChkDR( TST_UTL_AtoUI64( argv[3], cch, &(pAesCtrContext->qwInitializationVector) ) );
        }
        else
        {
        ...
        if ( argc >= 5 && argv[4] != NULL )
        {
            ...
            ChkDR( TST_UTL_AtoUI64( argv[4], cch, &(pAesCtrContext->qwBlockOffset) ) );
        }
        else
        {
