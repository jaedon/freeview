...
#define HDS_FILE_NAME_SIZE      DRM_MAX_PATH

DRM_SIZE_T localmin( DRM_SIZE_T a, DRM_SIZE_T b ) { return MIN(a,b); }
...
DRM_RESULT DRM_CALL TestHdsCreateStore(long argc, __in_ecount(argc) char **argv)
{
    ...
    DRM_WCHAR                    wszHdsName[HDS_FILE_NAME_SIZE] = {0};
    ...
    if( iOption&HDS_CONTEXT_FLAG )
    {
        ...
        */
        if( argv[3] != NULL )
        {
            ...
            MEMCPY( pLocalHdsContext->rgbOpaqueData, argv[3], localmin( DRMCRT_strlen( argv[3] ) + 1, SIZEOF( DRM_DST_CONTEXT ) ) );
        }
    }
    else
    {
    ...
    ** block size
    */
    wBlockSize = (DRM_DWORD)atol( argv[1] );
    ...
    */
    if( argv[0] != NULL )
    {
        cbLen = HDS_FILE_NAME_SIZE;
        ChkDR( TST_UTL_MakePathA( NULL, argv[0], &pszHdsName, &cbLen, 0 ) );    /* Note: Will not allocate because pszHdsName != NULL. */
        TST_UTL_mbstowcs( wszHdsName, pszHdsName, cbLen + 1 );
    }
    else
    {
        iHdsNameNull = 1;
    ...
    */
    ...
    ChkDR( DRM_SizeTToDWord( iHdsNameNull > 0 ? 0 : DRMCRT_wcslen( wszHdsName ), &cbLen ) );
    ...
    */
    if( iOption&HDS_CONTEXT_FLAG )
    {
        ...
        */
        ...
        {
            ChkMem( pLocalHdsContext = (DRM_DST_CONTEXT*)Oem_MemAlloc( SIZEOF( DRM_DST_CONTEXT ) ) );
            MEMCPY( pLocalHdsContext->rgbOpaqueData, argv[1], localmin( DRMCRT_strlen( argv[1] ) + 1, SIZEOF( DRM_DST_CONTEXT ) ) );
        }
    }
    else
    {
    ...
    */
    if( iOption&HDS_CONTEXT_FLAG )
    {
        ...
        */
        ...
        {
            ChkMem( pLocalHdsContext = (DRM_DST_CONTEXT*)Oem_MemAlloc( SIZEOF( DRM_DST_CONTEXT ) ) );
            MEMCPY( pLocalHdsContext->rgbOpaqueData, argv[0], localmin( DRMCRT_strlen( argv[0] ) + 1, SIZEOF( DRM_DST_CONTEXT ) ) );
        }
    }
    else
    {
...
DRM_RESULT DRM_CALL TestHdsOpenNamespace(long argc, __in_ecount(argc) char **argv)
{
    ...
    */
    if( argv[1] != NULL )
    {
        MEMCPY( HdsNamespace.rgbOpaqueData, argv[1], localmin( strlen( argv[1] ) + 1, DRM_HDS_NSNAME_SIZE ) );
    }
    else
    {
        iHdsNamespaceNull = 1;
    ...
    */
    ...
    if( argv[4] != NULL )
    {
         MEMCPY( pNsContext->rgbOpaqueData, argv[4], localmin( DRMCRT_strlen( argv[4] ) + 1, SIZEOF( DRM_DST_NAMESPACE_CONTEXT ) ) );
    }
    else
    {
        iNsContextNull = 1;
    ...
    if( iOption&HDS_NAMESPACE_CONTEXT_FLAG )
    {
        ...
        */
        if( argv[0] != NULL )
        {
            ...
            MEMCPY( pLocalNsContext->rgbOpaqueData, argv[0], localmin( DRMCRT_strlen( argv[0] ) + 1, SIZEOF( DRM_DST_NAMESPACE_CONTEXT ) ) );
        }
        else
        {
            iNsContextNull = 1;
...
DRM_RESULT DRM_CALL TestHdsOpenSlot(long argc, __in_ecount(argc) char **argv)
{
    ...
    */
    if( argv[2] != NULL )
    {
        MEMCPY( HashKey.rgb, argv[2], localmin( strlen( argv[2] ) + 1, DRM_ID_SIZE ) );
    }
    else
    {
        iHashKeyNull = 1;
    ...
    */
    if( argv[3] != NULL )
    {
        MEMCPY( UniqueKey.rgb, argv[3], localmin( strlen( argv[3] ) + 1, DRM_ID_SIZE ) );
    }
    else
    {
        iUniqueKeyNull=1;
    ...
    */
    if( argv[4] != NULL )
    {
        cbSlotSize = (DRM_DWORD)atol( argv[4] );
    }
    else
    {
        iSizeNull = 1;
    ...
    */
    if( argv[5] != NULL )
    {
         MEMCPY( pSlotContext->rgbOpaqueData, argv[5], localmin( DRMCRT_strlen( argv[5] ) + 1, SIZEOF( DRM_DST_SLOT_CONTEXT ) ) );
    }
    else
    {
        pSlotContext = NULL;
...
DRM_RESULT DRM_CALL TestHdsCloseSlot(long argc, __in_ecount(argc) char **argv)
{
    ...
    if( iOption&HDS_SLOT_CONTEXT_FLAG )
    {
        ...
        */
        if( argv[0] != NULL )
        {
            ...
            MEMCPY( pLocalSlotContext->rgbOpaqueData, argv[0], localmin( DRMCRT_strlen( argv[0] ) + 1, SIZEOF( DRM_DST_SLOT_CONTEXT ) ) );
        }
    }
    else
    {
    ...
    */
    ...
    else
    {
        ...
        */
        AssertChkArg( pInternalSlotCtx != NULL );
...
DRM_RESULT DRM_CALL TestHdsDeleteSlot(long argc, __in_ecount(argc) char **argv)
{
    ...
    */
    if( argv[1] != NULL )
    {
         MEMCPY( HashKey.rgb, argv[1], localmin( strlen( argv[1] ) + 1, DRM_ID_SIZE ) );
    }
    else
    {
        iHashKeyNull = 1;
    ...
    */
    if( argv[2] != NULL )
    {
         MEMCPY( UniqueKey.rgb, argv[2], localmin( strlen( argv[2] ) + 1, DRM_ID_SIZE ) );
    }
    else
    {
        iUniqueKeyNull = 1;
...
DRM_RESULT DRM_CALL TestHdsInitSlotEnum(long argc, __in_ecount(argc) char **argv)
{
    ...
    */
    if( argv[3] != NULL )
    {
         MEMCPY( pLocalEnumContext->rgbOpaqueData, argv[3], localmin( DRMCRT_strlen( argv[3] ) + 1, SIZEOF( DRM_DST_ENUM_CONTEXT ) ) );
    }
    else
    {
...
DRM_RESULT DRM_CALL TestHdsSlotEnumNext(long argc, __in_ecount(argc) char **argv)
{
        ...
        if( argv[0] != NULL )
        {
            ...
            if( 0 == strncmp( argv[0], "BAD_ENUM_CONTEXT", 16 ) )
            {
                ...
                */
                ...
                (&pBadEnumContext->oCurrBlock)->File._image.nParentBlockNum = MAX_UNSIGNED_TYPE(DRM_DWORD);
            ...
            {
                MEMCPY( pLocalEnumContext->rgbOpaqueData, argv[0], localmin( DRMCRT_strlen( argv[0] ) + 1, SIZEOF( DRM_DST_ENUM_CONTEXT ) ) );
            }
        }
    }
    else
    ...
    */
    if( argv[1] != NULL )
    {
         MEMCPY( pSlotContext->rgbOpaqueData + SIZEOF(DRM_DWORD), argv[1], localmin( strlen( argv[1] ) + 1,  SIZEOF( DRM_DST_SLOT_CONTEXT ) - SIZEOF(DRM_DWORD) ) );
    }
    else
    {
        pSlotContext = NULL;
...
DRM_RESULT DRM_CALL TestHdsSlotSeek(long argc, __in_ecount(argc) char **argv)
{
    ...
    */
    if( argv[3] != NULL )
    {
         wSeekPointer = (DRM_DWORD)atol( argv[3] );
    }
    else
    {
        iSeekPointerNull=1;
...
DRM_RESULT DRM_CALL TestHdsSlotWrite(long argc, __in_ecount(argc) char **argv)
{
    ...
    */
    if( argv[3] != NULL )
    {
         cbWritten = (DRM_DWORD)atol( argv[3] );
    }
    else
    {
        iWrittenNull = 1;
    ...
    {
        cbWriteExpected = (DRM_DWORD)atol( argv[5] );
    }
    else
    {
...
**
** Synopsis:    This function tests the DRM_HDS_BlockScanDelete function.
**
...
DRM_RESULT DRM_CALL TestHdsBlockScanDelete(long argc, __in_ecount(argc) char **argv)
{
    ...
    ** unique key. e,g, MID
    */
    MEMCPY( UniqueKey.rgb, argv[0], localmin( strlen( argv[0] ) + 1, DRM_ID_SIZE ) );
    ...
    */
    for( i = 0; i < nKID; i++ )
    {
        MEMCPY( HashKeys[i].rgb, argv[3+i], localmin( strlen( argv[3+i] ) + 1, DRM_ID_SIZE ) );
    }
...
{
    DRM_RESULT   dr             = DRM_SUCCESS;
    DRM_CHAR    *pszFileName    = NULL;
    DRM_DWORD    cbLen          = 0;

    ChkArg( argc    == 1 )
    ChkArg( argv[0] != NULL );

    ChkDR( TST_UTL_MakePathA( NULL, argv[0], &pszFileName, &cbLen, 0 ) );

    if DRM_FAILED( tRemoveFile( pszFileName ) )
    {
        Log( "TestDeleteFile", "TestDeleteFile: Warning - Could not delete the file named \"%s\" at path \"%s\", continuing test case\n", argv[0], pszFileName );
    }
ErrorExit:
    SAFE_OEM_FREE( pszFileName );
    return dr;
}
    ...
    */
    if( iOption&HDS_SLOT_CONTEXT_FLAG )
    {
        ...
        */
        ...
        {
            ChkMem( pLocalSlotContext = (DRM_DST_SLOT_CONTEXT*)Oem_MemAlloc( SIZEOF( DRM_DST_SLOT_CONTEXT ) ) );
            MEMCPY( pLocalSlotContext->rgbOpaqueData, argv[1], localmin( DRMCRT_strlen( argv[1] ) + 1, SIZEOF( DRM_DST_SLOT_CONTEXT ) ) );
        }
    }
    else
    {
...
DRM_RESULT DRM_CALL MODULE_PRETESTCASE(HDS)(long lTCID, const char *strTCName)
{
    ...
    */
    ...
    MAP_TO_GLOBAL_TEST_VAR_Alloc( pszHdsName, HDS_NAME_VAR, HDS_FILE_NAME_SIZE * SIZEOF( DRM_CHAR ) );
