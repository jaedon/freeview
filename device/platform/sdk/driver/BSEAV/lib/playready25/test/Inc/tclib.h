...
***************/
extern void DRM_CALL Log( __in const char *szTag, __in const char *szMessageFmt, ...);
...
#else
#define BEGIN_TEST_MAIN(AreaName) \
DRM_LONG DRM_CALL DRM_Main( __in DRM_LONG argc, __in_ecount_opt(argc) DRM_WCHAR **argv)\
{                                                                           \
    DRM_CHAR szAreaName[] = #AreaName;
