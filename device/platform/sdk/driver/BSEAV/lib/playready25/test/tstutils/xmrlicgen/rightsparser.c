...
/* AllowExecute */
static const DRM_WCHAR g_wszAllowExecute[]             = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('e'), WCHAR_CAST('c'), WCHAR_CAST('u'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x41 */
static const DRM_WCHAR g_wszAllowExtensibleRight0x41[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('1'), WCHAR_CAST('\0') };
/* AllowRead */
static const DRM_WCHAR g_wszAllowRead[]                = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('R'), WCHAR_CAST('e'), WCHAR_CAST('a'), WCHAR_CAST('d'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x42 */
static const DRM_WCHAR g_wszAllowExtensibleRight0x42[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('2'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x43 */
static const DRM_WCHAR g_wszAllowExtensibleRight0x43[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('3'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x44 */
static const DRM_WCHAR g_wszAllowExtensibleRight0x44[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('4'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x45 */
static const DRM_WCHAR g_wszAllowExtensibleRight0x45[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('5'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x46 */
static const DRM_WCHAR g_wszAllowExtensibleRight0x46[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('6'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x47 */
static const DRM_WCHAR g_wszAllowExtensibleRight0x47[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('7'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x48 */
static const DRM_WCHAR g_wszAllowExtensibleRight0x48[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('8'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x49 */
static const DRM_WCHAR g_wszAllowExtensibleRight0x49[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('9'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x4A */
static const DRM_WCHAR g_wszAllowExtensibleRight0x4A[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('A'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x4B */
static const DRM_WCHAR g_wszAllowExtensibleRight0x4B[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('B'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x4C */
static const DRM_WCHAR g_wszAllowExtensibleRight0x4C[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('C'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x4D */
static const DRM_WCHAR g_wszAllowExtensibleRight0x4D[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('D'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x4E */
static const DRM_WCHAR g_wszAllowExtensibleRight0x4E[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('E'), WCHAR_CAST('\0') };
/* AllowExtensibleRight0x4F */
static const DRM_WCHAR g_wszAllowExtensibleRight0x4F[] = { WCHAR_CAST('A'), WCHAR_CAST('l'), WCHAR_CAST('l'), WCHAR_CAST('o'), WCHAR_CAST('w'), WCHAR_CAST('E'), WCHAR_CAST('x'), WCHAR_CAST('t'), WCHAR_CAST('e'), WCHAR_CAST('n'), WCHAR_CAST('s'), WCHAR_CAST('i'), WCHAR_CAST('b'), WCHAR_CAST('l'), WCHAR_CAST('e'), WCHAR_CAST('R'), WCHAR_CAST('i'), WCHAR_CAST('g'), WCHAR_CAST('h'), WCHAR_CAST('t'), WCHAR_CAST('0'), WCHAR_CAST('x'), WCHAR_CAST('4'), WCHAR_CAST('F'), WCHAR_CAST('\0') };

/*
** Declared in tRightsParser.h
*/
const XMRLicGenExtensiblePolicyMapEntry g_XMRLicGenExtensiblePolicyMap[g_cdwExtensiblePolicyMapMax] =
{
    { 0x003F, CREATE_DRM_STRING(g_wszAllowExecute) },
    { 0x0041, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x41) },
    { 0x0041, CREATE_DRM_STRING(g_wszAllowRead) },
    { 0x0042, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x42) },
    { 0x0043, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x43) },
    { 0x0044, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x44) },
    { 0x0045, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x45) },
    { 0x0046, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x46) },
    { 0x0047, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x47) },
    { 0x0048, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x48) },
    { 0x0049, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x49) },
    { 0x004A, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x4A) },
    { 0x004B, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x4B) },
    { 0x004C, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x4C) },
    { 0x004D, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x4D) },
    { 0x004E, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x4E) },
    { 0x004F, CREATE_DRM_STRING(g_wszAllowExtensibleRight0x4F) },
};
...
DRM_RESULT _GetTestCaseNode(const DRM_CONST_STRING *pdstrFile, const DRM_WCHAR *pTestCaseID, DRM_CONST_STRING *pdstrCaseNode)
{
    ...
    DRMCASSERT( g_cdwExtensiblePolicyMapMax == ( SIZEOF( g_XMRLicGenExtensiblePolicyMap ) / SIZEOF( XMRLicGenExtensiblePolicyMapEntry ) ) );

    lenID = (DRM_DWORD)DRMCRT_wcslen( pTestCaseID );

    ChkMem( pch = (DRM_CHAR*)Oem_MemAlloc( lenID + 1 ) );
    ZEROMEM( pch, SIZEOF(DRM_CHAR) * ( lenID + 1 ) );
    DRM_UTL_DemoteUNICODEtoASCII( pTestCaseID, pch, lenID );
...
ErrorExit:
    if( DRM_FAILED(dr) && pTestCaseID && pch )
    {
        Log( "Error ", " Unable to find RightsID node \"%s\"", pch );
    }
    SAFE_OEM_FREE( pch );
    return dr;
}
...
DRM_RESULT _GetRights(const DRM_CONST_STRING *dstrNode, LICENSERIGHTS **ppRetRights, DRM_CONST_STRING dstrRIV)
{
    DRM_RESULT dr = DRM_SUCCESS;
    ...
    *************************************************************************************************/
    ...
    if (DRM_SUCCESS == dr )
    {
        DRM_CONST_STRING dstrDomainData = EMPTY_DRM_STRING;

        ChkDR( CopyDRMString( &pRights->DomainID, &dstrDomainID ) );
        /* Get the AccountID attribute if it exists */
        dr = DRM_XML_GetNodeAttribute( &dstrDomainID, &g_dstrAttribAccountID, &dstrDomainData );
        if ( dr != DRM_SUCCESS && dr != DRM_E_INVALID_XML_TAG )
        {
            ChkDR( dr );
        }
        ChkDR( CopyDRMString( &pRights->DomainAccountID, &dstrDomainData ) );

        /* Get the Revision attribute if it exists */
        dr = DRM_XML_GetNodeAttribute( &dstrDomainID, &g_dstrAttribRevision, &dstrDomainData );
        if ( dr != DRM_SUCCESS && dr != DRM_E_INVALID_XML_TAG )
        {
            ChkDR( dr );
        }
        ChkDR( CopyDRMString( &pRights->DomainRevision, &dstrDomainData ) );
    }
...
static DRM_RESULT _GetGroupRights(const DRM_CONST_STRING *pdstrPool, const DRM_WCHAR *pTestCaseID, LICENSERIGHTS **ppLicenseRights, DRM_CONST_STRING dstrRIV)
{
    DRM_RESULT dr = DRM_SUCCESS;
...
DRM_RESULT GetLicenseRightsAndSetRIV(const DRM_WCHAR *pRightsPool, const DRM_WCHAR *pTestCaseID, LICENSERIGHTS **ppLicenseRights, DRM_CONST_STRING dstrRIV)
{
    ...
    dstrFile.cchString = (DRM_DWORD)DRMCRT_wcslen(pRightsPool);
...
DRM_RESULT GetRevInfo(const DRM_WCHAR* pwszRevInfoPool, const DRM_WCHAR* pwszRevInfoID, DRM_CONST_STRING* pdstrRevInfo)
{
    ...
    dstrFile.cchString = (DRM_DWORD)DRMCRT_wcslen(pwszRevInfoPool);
    ...
    if (dr != DRM_SUCCESS)
    {
        ...
        dstrRevInfoPool.cchString = (DRM_DWORD)DRMCRT_wcslen( pwszRevInfoPool );
    }

    dstrRevInfoID.pwszString = pwszRevInfoID;
    dstrRevInfoID.cchString = (DRM_DWORD)DRMCRT_wcslen( pwszRevInfoID );
...
DRM_RESULT _tGetKIDsFromLicenseRightsNode(const DRM_WCHAR *pNode, const DRM_WCHAR **ppwszKID, const DRM_WCHAR **ppwszRootKID)
{
    ...
    *ppwszKID = dstrTemp.pwszString;
    ...
    else if (dr == DRM_E_INVALID_XML_TAG)
    {   /* not a fatal error */
        dr = DRM_SUCCESS;
    }
