 ...
 *  ANY LIMITED REMEDY.
 * 
 * $brcm_Workfile: bcrypt_aesecb_sw.h $
 * $brcm_Revision: 1 $
 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/lib/security/bcrypt/include/bcrypt_aesecb_sw.h $
 * 
 ...
 * 
 * Hydra_Software_Devel/2   2/20/07 3:32p alirezah
 * PR 25461: Update the BCRYPT API documentation for 7440 and 7401.
 * 
 * Hydra_Software_Devel/1   11/6/06 3:32p alirezah
 * PR 24954: Add BCRYPT support for 7440A0.
 * 
 * Hydra_Software_Devel/1   9/13/06 2:58p alirezah
 * PR 24240: Prepare 7401 BCRYPT library.
 * 
 * Hydra_Software_Devel/1   5/5/06 4:39p qiangye
 * PR19086:added for aescbc test
 *
 ***************************************************************************/
