 ...
 *  ANY LIMITED REMEDY.
 * 
 * $brcm_Workfile: bcrypt_descbc_sw.h $
 * $brcm_Revision: 1 $
 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/lib/security/bcrypt/include/bcrypt_descbc_sw.h $
 * 
 ...
 * 
 * Hydra_Software_Devel/2   2/20/07 4:10p alirezah
 * PR 25461: Update the BCRYPT API documentation for 7440 and 7401.
 * 
 * Hydra_Software_Devel/1   11/6/06 4:25p alirezah
 * PR 24954: Add BCRYPT support for 7440A0.
 * 
 * Hydra_Software_Devel/1   9/13/06 3:47p alirezah
 * PR 24240: Prepare 7401 BCRYPT library.
 * 
 * Hydra_Software_Devel/1   2/2/06 4:23p qiangye
 * PR19086:descbc sw implementation.
 *
 ***************************************************************************/
