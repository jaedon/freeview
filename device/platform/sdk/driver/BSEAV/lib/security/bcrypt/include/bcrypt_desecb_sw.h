 ...
 *  ANY LIMITED REMEDY.
 * 
 * $brcm_Workfile: bcrypt_desecb_sw.h $
 * $brcm_Revision: 1 $
 * $brcm_Date: 5/23/12 2:24p $
 *
 * File Description: openssl based sw implementation of DES ECB
 *
 * Revision History:
 *
 * $brcm_Log: /BSEAV/lib/security/bcrypt/include/bcrypt_desecb_sw.h $
 * 
 ...
 * 
 * Hydra_Software_Devel/2   2/20/07 4:16p alirezah
 * PR 25461: Update the BCRYPT API documentation for 7440 and 7401.
 * 
 * Hydra_Software_Devel/1   11/6/06 4:28p alirezah
 * PR 24954: Add BCRYPT support for 7440A0.
 * 
 * Hydra_Software_Devel/1   9/13/06 3:50p alirezah
 * PR 24240: Prepare 7401 BCRYPT library.
 * 
 * Hydra_Software_Devel/1   8/31/06 4:23p alirezah
 * desecb sw implementation.
 *
 ***************************************************************************/
#ifndef BCRYPT_DESECB_SW_H__
#define BCRYPT_DESECB_SW_H__
...
/***************************************************************************
Summary:
Parameters for the SW DES algorithm in the ECB mode of operation.


Description:
This Structure defines the parameters for the SW DES algorithm for the ECB 
...
****************************************************************************/
typedef struct BCRYPT_S_DESECBSwCtrl{
...
/*****************************************************************************
Summary:
This function implements the DES algorithm in the ECB mode of operation in SW.


Description:
This function implements the DES algorithm in the ECB mode of operation in software. It is 
based on the DES implementation of the openssl code. The binaries of the openssl library is 
already included into the build environment. Since this is a software implementation for the 
DES algorithm in the ECB mode of operation, it can only be used with the clear key. 
...
inoutp_DESECBSwCtrl - BCRYPT_S_DESECBSwCtrl_t, a ref/pointer to the parameters 
		for the SW implementation of the DES algorithm in the ECB mode of operation. 
