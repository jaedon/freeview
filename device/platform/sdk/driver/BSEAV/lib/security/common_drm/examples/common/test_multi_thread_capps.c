 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: test_multi_thread_capps.c $
 * $brcm_Revision: 2 $
 * $brcm_Date: 5/15/12 3:51p $
 * 
 * Module Description:
 * 
 * Revision History:
 * 
 * $brcm_Log: /BSEAV/lib/security/common_drm/examples/common/test_multi_thread_capps.c $
 * 
...
static void test_start_loop();
static void test_partial_sha1();
