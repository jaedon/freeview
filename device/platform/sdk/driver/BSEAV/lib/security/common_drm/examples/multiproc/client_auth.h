 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/lib/security/common_drm/examples/multiproc/client_auth.h $
 * 
...
#ifndef CLIENT_AUTH_H_
#define CLIENT_AUTH_H_
...
AuthenticateClient(void)
{
        ...
        simple_client_init(0, NULL, &authSettings, NULL);
...
#define DismissClient(x) simple_client_shutdown()

#endif /* CLIENT_AUTH_H_ */
