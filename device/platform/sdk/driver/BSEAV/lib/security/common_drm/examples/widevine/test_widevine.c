 ...
 * Revision History:
 * 
 * $brcm_Log: /BSEAV/lib/security/common_drm/examples/widevine/test_widevine.c $
 * 
 * 3   4/24/12 4:21p cdisc
...
test_fixed_decryption(uint8_t *pEcm, uint8_t* pData, uint32_t size)
{
	int i = 0;
