 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: drm_dtcp_ip_vendor.h $
 * $brcm_Revision: 1 $
 * $brcm_Date: 4/19/12 9:48a $
 *
 * Module Description:
 *
 * Revision History:
 *
 *****************************************************************************/
#ifndef DRM_DTCP_IP_VENDOR_H_
#define DRM_DTCP_IP_VENDOR_H_
...
/**********************************************************************************************
DRM_DtcpIp_Vendor_GetData

Retrieve the DTLA data
