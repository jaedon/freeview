...
*/
#define BCM7420_MCIF_MANAGED_BITS (0x03E3F800)

void bcm7420_mcif_l2share_func(int irq, unsigned long *triggeredInts)
{
    volatile unsigned long *l2_status = (volatile unsigned long *)0xB0407080;
    volatile unsigned long *l2_mask = (volatile unsigned long *)0xB0407090;
    unsigned long status = l2_status[0], mask = l2_mask[0];
    
    *triggeredInts = status & ~mask & BCM7420_MCIF_MANAGED_BITS;

    /* Mask all triggered interrupts */
    if (*triggeredInts) {
        l2_mask[0] = mask | *triggeredInts;
    }
    /* interrupts will be unmasked in BINT_isr() */
}
...
void bcm7420_mcif_l2mask_func(int irq, unsigned long *unused)
{
    ...
    l2_mask[0] = l2_mask[0] | BCM7420_MCIF_MANAGED_BITS;
}
...
s_InteruptTable interruptName7420[] = {
    ...
    {"EXT_IRQ_0_CPU_INTR",       INT_ENABLE_MASK}, /* 4, 3112 */
    {"EXT_IRQ_1_CPU_INTR",       INT_ENABLE_MASK}, /* 5, 3112 */
    {"EXT_IRQ_2_CPU_INTR",       INT_ENABLE_MASK}, /* 6, 3112 */
    {"EXT_IRQ_3_CPU_INTR",       INT_ENABLE_MASK}, /* 7, 3112 */
#else
    ...
    {"EXT_IRQ_13_CPU_INTR",      INT_ENABLE_MASK}, /* 18, 3512 */
