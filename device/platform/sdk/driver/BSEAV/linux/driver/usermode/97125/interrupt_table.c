 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/linux/driver/usermode/97125/interrupt_table.c $
 * 
 * 7   5/2/11 3:50p mward
 * SW7125-930:  Support stblinux-2.6.37.
 * 
 * 6   6/21/10 10:25a mward
 * SW7125-35:  Enable control of EXT_IRQ_12_CPU_INTR and
 * EXT_IRQ_13_CPU_INTR, corresponding to gpio_26/IRQ0 and gpio_27/IRQ1.
 * 
 * 5   6/10/10 6:30p mward
 * SW7125-35: Enable EXT_IRQ_xx_CPU_INTRs.
 * 
 * 4   10/14/09 1:28p mward
 * SW7125-26: CLONE -remove old shared UPG_CPU L2 interrupt code from
 * usermode driver interrupt_table.c
 * 
 * 3   8/28/09 2:16p mward
 * SW7125-4: Corrected int register base address.
 * 
 * 2   8/27/09 7:57p mward
 * SW7125-4: Avoid kernel warning, don't share the MC_CPU_INTR
 * 
 * 1   8/18/09 6:56p mward
 * PR55545: Add 7125 interrupt table.
 * 
 ***************************************************************************/
