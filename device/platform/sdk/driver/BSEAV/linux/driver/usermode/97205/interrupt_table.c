 ...
 * $brcm_Revision: 5 $
 * $brcm_Date: 4/7/11 7:50p $
 *
 * Module Description:
 * This file contains the platform specific interrupt tables 
 * Revision History:
 *
 * $brcm_Log: /BSEAV/linux/driver/usermode/97205/interrupt_table.c $
 * 
 * 5   4/7/11 7:50p katrep
 * SW7405-5229:add support multipe heaps
 * 
 * 4   4/9/10 10:38a katrep
 * SW7405-4176:Fixed issue with 2631-1.2 kernel build
 * 
 ...
 * 
 * 2   3/5/09 3:19p katrep
 * PR52599: More support for 7205
 * 
 * 1   3/2/09 10:31a katrep
 * PR52599: Add support for 7205
 * 
 * 1   12/19/08 7:39p katrep
