 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/linux/driver/usermode/97231/interrupt_table.c $
 * 
 * 7   12/2/11 3:48p gmohile
 * SW7231-506 : Do not enable SYS_PM interrupt
 * 
 * 6   4/27/11 2:39p katrep
 * SW7231-4:add support for 2637 kernel
 * 
 * 5   12/25/10 4:04p katrep
 * SW7231-4:updated for bringup
 * 
 * 4   12/16/10 11:15a katrep
 * SW7405-4:add correct HIF start adddress
 * 
 * 3   12/16/10 11:09a katrep
 * SW7405-4:add correct HIF start adddress
 * 
 * 2   12/6/10 5:05p katrep
 * SW7231-4:fixed compilation issue
 * 
 * 1   12/6/10 2:37p katrep
 * SW7231-4:initial 7231 support
 * 
 * 
 *
 ***************************************************************************/
