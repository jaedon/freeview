 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/linux/driver/usermode/97346/interrupt_table.c $
 * 
 * 5   12/2/11 3:48p gmohile
 * SW7231-506 : Do not enable SYS_PM interrupt
 * 
 * 4   9/2/11 5:44p vishk
 * SW7346-301: Nexus Frontend 7346 needs to support both internal and
 * external (BCM3445) LNAs
 * 
 * 3   4/28/11 5:02p randyjew
 * SW7344-9: Add 2637 support
 * 
 * 2   12/10/10 11:03a jrubio
 * SW7344-9: put correct start of HIF address
 * 
 * 1   12/8/10 5:06p jrubio
 * SW7344-9: interrupt file
 * 
 * 
 *
 ***************************************************************************/
...
s_InteruptTable interruptName7346[] = {
    ...
    {"EXT_IRQ_09_CPU_INTR",      INT_ENABLE_MASK}, /* 17 */
    ...
    {"SDS0_AFEC_CPU_INTR",         INT_ENABLE_MASK }, /* 9 */
    {"SDS0_RCVR_0_CPU_INTR",          INT_ENABLE_MASK}, /* 10 */
    {"SDS0_RCVR_1_CPU_INTR",          INT_ENABLE_MASK}, /* 11 */
    {"SDS0_TFEC_CPU_INTR",          INT_ENABLE_MASK}, /* 12 */
    {"SDS1_AFEC_CPU_INTR",         INT_ENABLE_MASK }, /* 13 */
    {"SDS1_RCVR_0_CPU_INTR",          INT_ENABLE_MASK}, /* 14 */
    {"SDS1_RCVR_1_CPU_INTR",          INT_ENABLE_MASK}, /* 15 */
    {"SDS1_TFEC_CPU_INTR",          INT_ENABLE_MASK}, /* 16 */
...
s_ChipConfig  g_sChipConfig ={ "7346",interruptName7346, 0xb0411400, sizeof(interruptName7346)/sizeof(s_InteruptTable),NUM_INTC_WORDS};
