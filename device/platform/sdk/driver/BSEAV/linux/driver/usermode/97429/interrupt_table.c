 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/linux/driver/usermode/97429/interrupt_table.c $
 * 
 * 4   12/2/11 3:48p gmohile
 * SW7231-506 : Do not enable SYS_PM interrupt
 * 
 * 3   11/23/11 4:34p mward
 * SW7429-1: update SOFT_MODEM_CPU_INTR and UPG_MC_CPU_INTR to match
 * bint_7429.c
 * 
 * 2   10/3/11 3:40p katrep
 * SW7429-1:fixed  build
 * 
 * 1   9/22/11 6:09p katrep
