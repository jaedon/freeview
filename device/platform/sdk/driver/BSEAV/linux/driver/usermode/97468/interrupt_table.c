 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/linux/driver/usermode/97468/interrupt_table.c $
 * 
 * 4   5/9/11 12:16p randyjew
 * SW7335-549: Disable management of UPG_UART1_CPU interrupt
 * 
 * 3   12/13/09 8:50p randyjew
 * SW7468-6:Update Interrupt table genet/uart0/usb/mc to no
 * int_enable_mask
 * 
 * 2   12/13/09 2:28p randyjew
 * SW7468-6:Update intcAddr for g_sChipConfig
 * 
 * 1   9/28/09 10:59a lwhite
 * SW7468-6: Support for 97468
 * 
 ***************************************************************************/
