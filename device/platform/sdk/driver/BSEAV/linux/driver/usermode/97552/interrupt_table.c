 ...
 * Revision History:
 *
 * $brcm_Log: X:/win_views/97552/BSEAV/linux/driver/usermode/97552/interrupt_table.c $
 * 
 * 5   12/20/11 2:45p vishk
 * SW7552-148: 7552B0: Add 3128 support over MTSIF for 7552B0 SVB board
 * 
 * 4   11/17/11 5:18p xhuang
 * SW7552-9: disable SYS_PM L1 interrupt since kernel want to control it
 * 
 * 3   5/25/11 6:11p xhuang
 * SW7552-34: correct 7552 interrupt table
 * 
 * 2   4/28/11 6:43p xhuang
 * SW7552-27: update interrupt table
 * 
 * 2   4/28/11 6:42p xhuang
 * SW7552-27: update interrupt table
 * 
 * 1   11/23/10 11:02a xhuang
 * SW7552-16: Add support for 97552
 * 
 *
 ***************************************************************************/
...
s_InteruptTable interruptName7552[] = {
    ...
    {"EXT_IRQ_02_CPU_INTR",      INT_ENABLE_MASK},/* 10  EXT_IRQ2*/
    ...
    {"SDS0_AFEC_CPU_INTR",       0}, /* 7 */
    {"SDS0_RCVR_0_CPU_INTR",     0}, /* 8 */
    {"SDS0_RCVR_1_CPU_INTR",     0}, /* 9 */
    {"SDS0_TFEC_CPU_INTR",       0}, /* 10 */
    ...
    {"THD_A_CPU_INTR",           INT_ENABLE_MASK}, /* 24 */    
    {"THD_B_CPU_INTR",           INT_ENABLE_MASK}, /* 25 */    
    {"UFE_CPU_INTR",             INT_ENABLE_MASK}, /* 26 */    
...
s_ChipConfig  g_sChipConfig ={ "7552",interruptName7552, 0xb0411400, sizeof(interruptName7552)/sizeof(s_InteruptTable),NUM_INTC_WORDS};
