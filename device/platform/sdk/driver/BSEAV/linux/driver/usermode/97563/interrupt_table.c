 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/linux/driver/usermode/97563/interrupt_table.c $
 * 
 * 1   9/21/12 5:22p randyjew
...
s_InteruptTable interruptName7563[] = {
    ...
    {"SPARE_01_CPU_INTR",        0}, /* 26 */    
    {"SPARE_02_CPU_INTR",        0}, /* 27 */    
    ...
    {"SPARE_03_CPU_INTR",        0}, /* 3 */    
    {"NMI_PIN_CPU_INTR",         INT_ENABLE_MASK}, /* 4 */
    {"RAAGA_CPU_INTR",       	 INT_ENABLE_MASK}, /* 5 */
    {"RAAGA_FW_CPU_INTR",        INT_ENABLE_MASK}, /* 6 */
    {"SPARE_04_CPU_INTR",        0}, /* 7 */
    {"SPARE_05_CPU_INTR",        0}, /* 8 */
    {"SPARE_06_CPU_INTR",        0}, /* 9 */
    {"SPARE_07_CPU_INTR",        0}, /* 10 */
    {"T2_BICM_0_CPU_INTR",       INT_ENABLE_MASK}, /* 11 */    
    {"T2_BICM_1_CPU_INTR",       INT_ENABLE_MASK}, /* 12 */    
    {"T2_RCVR_CPU_INTR",         INT_ENABLE_MASK}, /* 13 */    
    {"T2_RCVR_OI_CPU_INTR",      INT_ENABLE_MASK}, /* 14 */    
    {"SPARE_08_CPU_INTR",        0}, /* 15 */
    {"SYS_CPU_INTR",       		 INT_ENABLE_MASK}, /* 16 */
    {"SYS_AON_CPU_INTR",         INT_ENABLE_MASK}, /* 17 */
    {"SYS_PM_CPU_INTR",       	 0}, /* 18 */
    {"SPARE_09_CPU_INTR",        0}, /* 19 */    
    {"SPARE_10_CPU_INTR",        0}, /* 20 */    
    ...
    {"SPARE_11_CPU_INTR",        0}, /* 3 */    
    {"SPARE_12_CPU_INTR",        0}, /* 4 */    
    {"SPARE_13_CPU_INTR",        0}, /* 5 */    
    {"SPARE_14_CPU_INTR",        0}, /* 6 */    
    {"SPARE_15_CPU_INTR",        0}, /* 7 */    
    {"SPARE_16_CPU_INTR",        0}, /* 8 */    
    {"SPARE_17_CPU_INTR",        0}, /* 9 */    
    ...
    {"SPARE_18_CPU_INTR",        0}, /* 21 */    
    {"SPARE_19_CPU_INTR",        0}, /* 22 */    
    {"SPARE_20_CPU_INTR",             0}, /* 23*/    
    {"SPARE_21_CPU_INTR",           0}, /* 24 */    
    {"SPARE_22_CPU_INTR",           0}, /* 25 */    
    {"UFE_CPU_INTR",             0}, /* 26 */    
    {"SPARE_23_CPU_INTR",            0}, /* 27 */    
    {"SPARE_24_CPU_INTR",        0}, /* 28 */    
    {"SPARE_25_CPU_INTR",        0}, /* 29 */    
    {"SPARE_26_CPU_INTR",            0}, /* 30 */    
    {" LEAP_CPU_INTR",      	 INT_ENABLE_MASK}, /* 31 */
};


s_ChipConfig  g_sChipConfig ={ "7563",interruptName7563, 0xb0411400, sizeof(interruptName7563)/sizeof(s_InteruptTable),NUM_INTC_WORDS};
