 ...
 * Revision History:
 *
 * $brcm_Log: /BSEAV/linux/driver/usermode/97584/interrupt_table.c $
 * 
 * 1   4/18/12 4:21p chengs
 * SW7584-3: Add initial 97584 interrupt table.
 * 
 *
 ***************************************************************************/
...
s_InteruptTable interruptName7584[] = {
    ...
    {"SATA_AHCI_CPU_INTR",       0}, /* 7 */
    {"SATA_GRB_CPU_INTR",        0}, /* 8 */
    {"SID_CPU_INTR",             INT_ENABLE_MASK}, /* 9 */
    {"SPARE_01_CPU_INTR",        0}, /* 10 */
    {"SPARE_02_CPU_INTR",        0}, /* 11 */
    {"SPARE_03_CPU_INTR",        0}, /* 12 */
    {"SPARE_04_CPU_INTR",        0}, /* 13 */
    {"SPARE_05_CPU_INTR",        0}, /* 14 */
    ...
    {"SPARE_06_CPU_INTR",        0}, /* 19 */
    {"SPARE_07_CPU_INTR",        0}, /* 20 */
    ...
    {"USB_BRIDGE_CPU_INTR",      0 | INT_REG_WRAP }, /* 0 */
    {"USB_EHCI_0_CPU_INTR",      0}, /* 1 */
    {"USB_OHCI_0_CPU_INTR",      0}, /* 2 */
    {"USB_EHCI_1_CPU_INTR",      0}, /* 3 */
    {"USB_OHCI_1_CPU_INTR",      0}, /* 4 */
    {"SPARE_08_CPU_INTR",        0}, /* 5 */
    {"SPARE_09_CPU_INTR",        0}, /* 6 */    
    {"SPARE_10_CPU_INTR",        0}, /* 7 */    
    {"SPARE_11_CPU_INTR",        0}, /* 8 */    
    {"SPARE_12_CPU_INTR",        0}, /* 9 */
    ...
    {"SDIO1_0_CPU_INTR",         0}, /* 19 */
    {"AVD0_0_CPU_INTR",      	 INT_ENABLE_MASK}, /* 20 */    
    {"SPARE_13_CPU_INTR",        0}, /* 21 */    
    {"SPARE_14_CPU_INTR",        0}, /* 22 */    
    {"RFM_CPU_INTR",             INT_ENABLE_MASK}, /* 23*/        
    {"SPARE_15_CPU_INTR",        0}, /* 24 */    
    {"SPARE_16_CPU_INTR",        0}, /* 25 */    
    {"DS_0_WFE_CPU_INTR",        INT_ENABLE_MASK}, /* 26 */
    {"DS_0_CPU_INTR",            INT_ENABLE_MASK}, /* 27 */
    {"DS_0_OOB_0_CPU_INTR",      INT_ENABLE_MASK}, /* 28 */    
    {"DS_0_OOB_1_CPU_INTR",      INT_ENABLE_MASK}, /* 29 */
    {"MCIF_CPU_INTR",            INT_ENABLE_MASK}, /* 30 */    
    {"LEAP_CPU_INTR",            INT_ENABLE_MASK} /* 31 */    
};

s_ChipConfig  g_sChipConfig ={ "7584", interruptName7584, 0xb0411400, sizeof(interruptName7584)/sizeof(s_InteruptTable), NUM_INTC_WORDS};
