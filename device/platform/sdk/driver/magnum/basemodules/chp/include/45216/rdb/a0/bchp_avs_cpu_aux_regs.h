 ...
 ***************************************************************************/
#define BCHP_AVS_CPU_AUX_REGS_STATUS             0x0690a000 /* Auxiliary Register STATUS */
#define BCHP_AVS_CPU_AUX_REGS_SEMAPHORE          0x0690a004 /* Inter-process/Host semaphore register */
#define BCHP_AVS_CPU_AUX_REGS_LP_START           0x0690a008 /* Loop start address (32-bit) */
#define BCHP_AVS_CPU_AUX_REGS_LP_END             0x0690a00c /* Loop end address (32-bit) */
#define BCHP_AVS_CPU_AUX_REGS_IDENTITY           0x0690a010 /* Processor Identification register */
#define BCHP_AVS_CPU_AUX_REGS_DEBUG              0x0690a014 /* Debug register */
#define BCHP_AVS_CPU_AUX_REGS_PC                 0x0690a018 /* Program Counter register (32-bit) */
#define BCHP_AVS_CPU_AUX_REGS_STATUS32           0x0690a028 /* Status register (32-bit) */
#define BCHP_AVS_CPU_AUX_REGS_STATUS32_L1        0x0690a02c /* Status register save for level 1 interrupts */
#define BCHP_AVS_CPU_AUX_REGS_STATUS32_L2        0x0690a030 /* Status register save for level 2 interrupts */
#define BCHP_AVS_CPU_AUX_REGS_AUX_DCCM           0x0690a060 /* Status register save for level 2 interrupts */
#define BCHP_AVS_CPU_AUX_REGS_TIMER0_CONTROL     0x0690a084 /* Processor Timer0 Count value */
#define BCHP_AVS_CPU_AUX_REGS_TIMER0_COUNT       0x0690a088 /* Processor Timer0 Control value */
#define BCHP_AVS_CPU_AUX_REGS_TIMER0_LIMIT       0x0690a08c /* Processor Timer0 Limit value */
#define BCHP_AVS_CPU_AUX_REGS_INT_VEC_BASE       0x0690a094 /* Interrupt Vector Base address */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IRQ_LV12       0x0690a10c /* Interrupt Level Status */
#define BCHP_AVS_CPU_AUX_REGS_CRC_BUILD_BCR      0x0690a188 /* Build configuration register for CRC instruction. */
#define BCHP_AVS_CPU_AUX_REGS_DVBF_BUILD         0x0690a190 /* Build configuration register for dual viterbi butterfly instruction. */
#define BCHP_AVS_CPU_AUX_REGS_EXT_ARITH_BUILD    0x0690a194 /* Build configuration register to specify that the processor has the extended arithmetic instructions. */
#define BCHP_AVS_CPU_AUX_REGS_DATASPACE          0x0690a198 /* Build configuration register for dataspace. */
#define BCHP_AVS_CPU_AUX_REGS_MEMSUBSYS          0x0690a19c /* Build configuration register for memory subsytem. */
#define BCHP_AVS_CPU_AUX_REGS_VECBASE_AC_BUILD   0x0690a1a0 /* Build configuration register for ARC600 interrupt vector base address. */
#define BCHP_AVS_CPU_AUX_REGS_P_BASE_ADDR        0x0690a1a4 /* Build configuration register for peripheral base address. */
#define BCHP_AVS_CPU_AUX_REGS_MPU_BUILD          0x0690a1b4 /* Build configuration register for memory protection unit. */
#define BCHP_AVS_CPU_AUX_REGS_RF_BUILD           0x0690a1b8 /* Build configuration register for register file. */
#define BCHP_AVS_CPU_AUX_REGS_D_CACHE_BUILD      0x0690a1c8 /* Build configuration register for data cache. */
#define BCHP_AVS_CPU_AUX_REGS_MADI_BUILD         0x0690a1cc /* Build configuration register for multiple ARC debug interface. */
#define BCHP_AVS_CPU_AUX_REGS_DCCM_BUILD         0x0690a1d0 /* Build configuration register for data closely coupled memory. */
#define BCHP_AVS_CPU_AUX_REGS_TIMER_BUILD        0x0690a1d4 /* Build configuration register for timers. */
#define BCHP_AVS_CPU_AUX_REGS_AP_BUILD           0x0690a1d8 /* Build configuration register for actionpoints. */
#define BCHP_AVS_CPU_AUX_REGS_I_CACHE_BUILD      0x0690a1dc /* Build configuration register for instruction cache. */
#define BCHP_AVS_CPU_AUX_REGS_ICCM_BUILD         0x0690a1e0 /* Build configuration register for instruction closely coupled memory. */
#define BCHP_AVS_CPU_AUX_REGS_DSPRAM_BUILD       0x0690a1e4 /* Build configuration register for XY memory. */
#define BCHP_AVS_CPU_AUX_REGS_MAC_BUILD          0x0690a1e8 /* Build configuration register for Xmac. */
#define BCHP_AVS_CPU_AUX_REGS_MULTIPLY_BUILD     0x0690a1ec /* Build configuration register for instruction closely coupled memory. */
#define BCHP_AVS_CPU_AUX_REGS_SWAP_BUILD         0x0690a1f0 /* Build configuration register for swap instruction. */
#define BCHP_AVS_CPU_AUX_REGS_NORM_BUILD         0x0690a1f4 /* Build configuration register for normalise instruction. */
#define BCHP_AVS_CPU_AUX_REGS_MINMAX_BUILD       0x0690a1f8 /* Build configuration register for min/max instruction. */
#define BCHP_AVS_CPU_AUX_REGS_BARREL_BUILD       0x0690a1fc /* Build configuration register for barrel shifter. */
#define BCHP_AVS_CPU_AUX_REGS_ARC600_BUILD       0x0690a304 /* Build configuration register for ARC 600. */
#define BCHP_AVS_CPU_AUX_REGS_AUX_SYSTEM_BUILD   0x0690a308 /* Build configuration register for AS221BD. */
#define BCHP_AVS_CPU_AUX_REGS_MCD_BCR            0x0690a310 /* MCD configuration register for AS221BD. */
#define BCHP_AVS_CPU_AUX_REGS_IFETCHQUEUE_BUILD  0x0690a3f8 /* Build configuration register for the InstructionFetchQueue component. */
#define BCHP_AVS_CPU_AUX_REGS_TIMER1_CONTROL     0x0690a400 /* Processor Timer 1 Count value */
#define BCHP_AVS_CPU_AUX_REGS_TIMER1_COUNT       0x0690a404 /* Processor Timer 1 Control value */
#define BCHP_AVS_CPU_AUX_REGS_TIMER1_LIMIT       0x0690a408 /* Processor Timer 1 Limit value */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IRQ_LEV        0x0690a800 /* Interrupt Level Programming */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IRQ_HINT       0x0690a804 /* Software Triggered Interrupt */
#define BCHP_AVS_CPU_AUX_REGS_AUX_ALIGN_CTRL     0x0690a808 /* Memory Alignment Detection Control */
#define BCHP_AVS_CPU_AUX_REGS_AUX_ALIGN_ADDR     0x0690a80c /* Memory Alignment Detected Address */
#define BCHP_AVS_CPU_AUX_REGS_AUX_ALIGN_SIZE     0x0690a810 /* Memory Alignment Detected Size */
#define BCHP_AVS_CPU_AUX_REGS_AUX_INTER_CORE_INTERRUPT 0x0690aa00 /* Inter-core Interrupt Register */
#define BCHP_AVS_CPU_AUX_REGS_AX_IPC_SEM_N       0x0690aa04 /* Inter-core Sempahore Register */
#define BCHP_AVS_CPU_AUX_REGS_AUX_INTER_CORE_ACK 0x0690aa08 /* Inter-core Interrupt Acknowledge Register */
#define BCHP_AVS_CPU_AUX_REGS_ERET               0x0690b000 /* Exception Return Address */
#define BCHP_AVS_CPU_AUX_REGS_ERBTA              0x0690b004 /* Exception Return Branch Target Address */
#define BCHP_AVS_CPU_AUX_REGS_ERSTATUS           0x0690b008 /* Exception Return Status */
#define BCHP_AVS_CPU_AUX_REGS_ECR                0x0690b00c /* Exception Cause Register */
#define BCHP_AVS_CPU_AUX_REGS_EFA                0x0690b010 /* Exception Fault Address */
#define BCHP_AVS_CPU_AUX_REGS_ICAUSE1            0x0690b028 /* Level 1 Interrupt Cause Register */
#define BCHP_AVS_CPU_AUX_REGS_ICAUSE2            0x0690b02c /* Level 2 Interrupt Cause Register */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IENABLE        0x0690b030 /* Interrupt Mask Programming */
#define BCHP_AVS_CPU_AUX_REGS_AUX_ITRIGGER       0x0690b034 /* Interrupt Sensitivity Programming */
#define BCHP_AVS_CPU_AUX_REGS_BTA                0x0690b048 /* Branch Target Address */
#define BCHP_AVS_CPU_AUX_REGS_BTA_L1             0x0690b04c /* Level 1 Return Branch Target */
#define BCHP_AVS_CPU_AUX_REGS_BTA_L2             0x0690b050 /* Level 2 Return Branch Target */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IRQ_PULSE_CANCEL 0x0690b054 /* Interrupt Pulse Cancel */
#define BCHP_AVS_CPU_AUX_REGS_AUX_IRQ_PENDING    0x0690b058 /* Interrupt Pending Register */
