 ...
 ***************************************************************************/
#define BCHP_AVS_UART_UARTDR                     0x06910000 /* Data register (12 or 8 bits) */
#define BCHP_AVS_UART_UARTRSR                    0x06910004 /* Receive status register/error clear register */
#define BCHP_AVS_UART_UARTFR                     0x06910018 /* Flag register */
#define BCHP_AVS_UART_UARTILPR                   0x06910020 /* IrDA low-power counter register */
#define BCHP_AVS_UART_UARTIBRD                   0x06910024 /* Integer baud rate register */
#define BCHP_AVS_UART_UARTFBRD                   0x06910028 /* Fractional baud rate register */
#define BCHP_AVS_UART_UARTLCR_H                  0x0691002c /* Line control register */
#define BCHP_AVS_UART_UARTCR                     0x06910030 /* Control register */
#define BCHP_AVS_UART_UARTIFLS                   0x06910034 /* Interrupt FIFO level select register */
#define BCHP_AVS_UART_UARTIMSC                   0x06910038 /* Interrupt mask set/clear register */
#define BCHP_AVS_UART_UARTRIS                    0x0691003c /* Raw interrupt status register */
#define BCHP_AVS_UART_UARTMIS                    0x06910040 /* Masked interrupt status register */
#define BCHP_AVS_UART_UARTICR                    0x06910044 /* Interrupt clear register */
#define BCHP_AVS_UART_UARTDMACR                  0x06910048 /* DMA control register */
#define BCHP_AVS_UART_UARTPERIPHID0              0x06910fe0 /* UARTPeriphID0 */
#define BCHP_AVS_UART_UARTPERIPHID1              0x06910fe4 /* UARTPeriphID1 */
#define BCHP_AVS_UART_UARTPERIPHID2              0x06910fe8 /* UARTPeriphID2 */
#define BCHP_AVS_UART_UARTPERIPHID3              0x06910fec /* UARTPeriphID3 */
#define BCHP_AVS_UART_UARTPCELLID0               0x06910ff0 /* UARTPCellID0 */
#define BCHP_AVS_UART_UARTPCELLID1               0x06910ff4 /* UARTPCellID1 */
#define BCHP_AVS_UART_UARTPCELLID2               0x06910ff8 /* UARTPCellID2 */
#define BCHP_AVS_UART_UARTPCELLID3               0x06910ffc /* UARTPCellID3 */
