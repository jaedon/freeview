 ...
 *  ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: bchp_7231.h $
 * $brcm_Revision: Hydra_Software_Devel/1 $
 * $brcm_Date: 11/3/10 5:41p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7231/bchp_7231.h $
 * 
...
#ifndef BCHP_7231_H__
#define BCHP_7231_H__
...
/***************************************************************************
Summary:
    Open a chip handle for Bcm7231 chip

Description:
    This function open a chip handle for Bcm7231 chip.

Input:
    hRegister - A valid Bcm7231 register handle previous open using BREG_Open.
