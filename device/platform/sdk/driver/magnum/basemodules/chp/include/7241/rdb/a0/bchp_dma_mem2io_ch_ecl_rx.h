 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7429/rdb/a0/bchp_dma_mem2io_ch_ecl_rx.h $
 * 
 ...
 ***************************************************************************/
#define BCHP_DMA_MEM2IO_CH_ECL_RX_LLM_CMD_ADDR   0x00bed800 /* LLM Command Address */
#define BCHP_DMA_MEM2IO_CH_ECL_RX_DESC_BASE_ADDR 0x00bed804 /* The physical base address of the descriptors in memory */
#define BCHP_DMA_MEM2IO_CH_ECL_RX_BUFF_BASE_ADDR 0x00bed808 /* The physical base address of the buffers in  memory */
#define BCHP_DMA_MEM2IO_CH_ECL_RX_CH_CONTROL     0x00bed80c /* Channel Control Register */
#define BCHP_DMA_MEM2IO_CH_ECL_RX_LLM_CMD        0x00bed810 /* "LLM Command Register.,Contains set of commands/parameters DMA should pass to LLM while issuing various LLM commands." */
#define BCHP_DMA_MEM2IO_CH_ECL_RX_DEBUG_REG1     0x00bed814 /* Debug Register #1 */
#define BCHP_DMA_MEM2IO_CH_ECL_RX_DEBUG_REG2     0x00bed818 /* Debug Register #2 */
#define BCHP_DMA_MEM2IO_CH_ECL_RX_DEBUG_REG3     0x00bed81c /* Debug Register #3 */
#define BCHP_DMA_MEM2IO_CH_ECL_RX_DEBUG_REG4     0x00bed820 /* "Debug Register #4,Reflects parameters of fetched descriptor" */
#define BCHP_DMA_MEM2IO_CH_ECL_RX_DEBUG_REG5     0x00bed824 /* "Debug Register #5,Reflects parameters of fetched descriptor" */
#define BCHP_DMA_MEM2IO_CH_ECL_RX_DEBUG_REG6     0x00bed828 /* "Debug Register #6,Reflects parameters of fetched descriptor" */
