 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7429/rdb/a0/bchp_moca_timer.h $
 * 
 ...
 ***************************************************************************/
#define BCHP_MOCA_TIMER_TMR_VALUE_0              0x00bfe400 /* Timer Up Counter State , register set index 0. */
#define BCHP_MOCA_TIMER_TMR_VALUE_1              0x00bfe420 /* Timer Up Counter State , register set index 1. */
#define BCHP_MOCA_TIMER_TMR_VALUE_2              0x00bfe440 /* Timer Up Counter State , register set index 2. */
#define BCHP_MOCA_TIMER_TMR_VALUE_3              0x00bfe460 /* Timer Up Counter State , register set index 3. */
#define BCHP_MOCA_TIMER_TMR_VALUE_4              0x00bfe480 /* Timer Up Counter State , register set index 4. */
#define BCHP_MOCA_TIMER_TMR_VALUE_5              0x00bfe4a0 /* Timer Up Counter State , register set index 5. */
#define BCHP_MOCA_TIMER_TMR_VALUE_6              0x00bfe4c0 /* Timer Up Counter State , register set index 6. */
#define BCHP_MOCA_TIMER_TMR_VALUE_7              0x00bfe4e0 /* Timer Up Counter State , register set index 7. */
#define BCHP_MOCA_TIMER_REFERENCE_0              0x00bfe404 /* reference value for one shot and periodic mode , register set index 0. */
#define BCHP_MOCA_TIMER_REFERENCE_1              0x00bfe424 /* reference value for one shot and periodic mode , register set index 1. */
#define BCHP_MOCA_TIMER_REFERENCE_2              0x00bfe444 /* reference value for one shot and periodic mode , register set index 2. */
#define BCHP_MOCA_TIMER_REFERENCE_3              0x00bfe464 /* reference value for one shot and periodic mode , register set index 3. */
#define BCHP_MOCA_TIMER_REFERENCE_4              0x00bfe484 /* reference value for one shot and periodic mode , register set index 4. */
#define BCHP_MOCA_TIMER_REFERENCE_5              0x00bfe4a4 /* reference value for one shot and periodic mode , register set index 5. */
#define BCHP_MOCA_TIMER_REFERENCE_6              0x00bfe4c4 /* reference value for one shot and periodic mode , register set index 6. */
#define BCHP_MOCA_TIMER_REFERENCE_7              0x00bfe4e4 /* reference value for one shot and periodic mode , register set index 7. */
#define BCHP_MOCA_TIMER_CTRL_0                   0x00bfe408 /* Contains the control bits of the counter , register set index 0. */
#define BCHP_MOCA_TIMER_CTRL_1                   0x00bfe428 /* Contains the control bits of the counter , register set index 1. */
#define BCHP_MOCA_TIMER_CTRL_2                   0x00bfe448 /* Contains the control bits of the counter , register set index 2. */
#define BCHP_MOCA_TIMER_CTRL_3                   0x00bfe468 /* Contains the control bits of the counter , register set index 3. */
#define BCHP_MOCA_TIMER_CTRL_4                   0x00bfe488 /* Contains the control bits of the counter , register set index 4. */
#define BCHP_MOCA_TIMER_CTRL_5                   0x00bfe4a8 /* Contains the control bits of the counter , register set index 5. */
#define BCHP_MOCA_TIMER_CTRL_6                   0x00bfe4c8 /* Contains the control bits of the counter , register set index 6. */
#define BCHP_MOCA_TIMER_CTRL_7                   0x00bfe4e8 /* Contains the control bits of the counter , register set index 7. */
#define BCHP_MOCA_TIMER_RESTART_0                0x00bfe40c /* Restart the counter , register set index 0. */
#define BCHP_MOCA_TIMER_RESTART_1                0x00bfe42c /* Restart the counter , register set index 1. */
#define BCHP_MOCA_TIMER_RESTART_2                0x00bfe44c /* Restart the counter , register set index 2. */
#define BCHP_MOCA_TIMER_RESTART_3                0x00bfe46c /* Restart the counter , register set index 3. */
#define BCHP_MOCA_TIMER_RESTART_4                0x00bfe48c /* Restart the counter , register set index 4. */
#define BCHP_MOCA_TIMER_RESTART_5                0x00bfe4ac /* Restart the counter , register set index 5. */
#define BCHP_MOCA_TIMER_RESTART_6                0x00bfe4cc /* Restart the counter , register set index 6. */
#define BCHP_MOCA_TIMER_RESTART_7                0x00bfe4ec /* Restart the counter , register set index 7. */
