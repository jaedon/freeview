 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7429/rdb/b0/bchp_xpt_xmemif.h $
 * 
 * Hydra_Software_Devel/1   6/14/12 3:27p pntruong
...
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PSUB      0x00200184 /* SCB Read Client select register for PSUB */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_MODE          0x0020018c /* SCB Write Client Arbiter Mode Control */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_MODE          0x00200190 /* SCB Read Client Arbiter Mode Control */
#define BCHP_XPT_XMEMIF_INTR_STATUS_REG          0x00200194 /* Interrupt Status Register */
#define BCHP_XPT_XMEMIF_INTR_STATUS_REG_EN       0x00200198 /* Interrupt Status Enable Register */
...
#define BCHP_XPT_XMEMIF_WR_DEBUG                 0x002001a4 /* Debug and Test register for XMEMIF write */
#define BCHP_XPT_XMEMIF_RD_DEBUG0                0x002001a8 /* Debug and Test register for XMEMIF read */
#define BCHP_XPT_XMEMIF_RD_DEBUG1                0x002001ac /* Debug and Test register for XMEMIF read */
#define BCHP_XPT_XMEMIF_WR_RDY_ACCEPT_STATUS     0x002001b0 /* Ready Accept Status On the Wr XMEM interface */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_STATUS_CL0_6 0x002001b4 /* Ready Accept Status On the RD XMEM interface for CL0_6 */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_PB_LCTOXMEM 0x002001b8 /* Ready Accept Status on the RD XMEM interface for Playback LC to xmem */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_PB_XMEMTOLC 0x002001bc /* Ready Accept Status On the RD XMEM interface for Playback xmem to LC */
