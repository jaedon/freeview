 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7346/rdb/b0/bchp_xpt_xmemif.h $
 * 
...
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_RSBUFF_MPOD 0x00a00118 /* SCB Read Client select register for RSBUFF */
...
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB0       0x00a0012c /* SCB Read Client select register for Playback0 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB1       0x00a00130 /* SCB Read Client select register for Playback1 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB2       0x00a00134 /* SCB Read Client select register for Playback2 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB3       0x00a00138 /* SCB Read Client select register for Playback3 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB4       0x00a0013c /* SCB Read Client select register for Playback4 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB5       0x00a00140 /* SCB Read Client select register for Playback5 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB6       0x00a00144 /* SCB Read Client select register for Playback6 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB7       0x00a00148 /* SCB Read Client select register for Playback7 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB8       0x00a0014c /* SCB Read Client select register for Playback8 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB9       0x00a00150 /* SCB Read Client select register for Playback9 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB10      0x00a00154 /* SCB Read Client select register for Playback10 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB11      0x00a00158 /* SCB Read Client select register for Playback11 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB12      0x00a0015c /* SCB Read Client select register for Playback12 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB13      0x00a00160 /* SCB Read Client select register for Playback13 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB14      0x00a00164 /* SCB Read Client select register for Playback14 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB15      0x00a00168 /* SCB Read Client select register for Playback15 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PSUB      0x00a0016c /* SCB Read Client select register for PSUB */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_MODE          0x00a00170 /* SCB Write Client Arbiter Mode Control */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_MODE          0x00a00174 /* SCB Read Client Arbiter Mode Control */
#define BCHP_XPT_XMEMIF_WR_DEBUG                 0x00a00178 /* Debug and Test register for XMEMIF write */
#define BCHP_XPT_XMEMIF_RD_DEBUG0                0x00a0017c /* Debug and Test register for XMEMIF read */
#define BCHP_XPT_XMEMIF_RD_DEBUG1                0x00a00180 /* Debug and Test register for XMEMIF read */
#define BCHP_XPT_XMEMIF_INTR_STATUS_REG          0x00a00184 /* Interrupt Status Register */
#define BCHP_XPT_XMEMIF_INTR_STATUS_REG_EN       0x00a00188 /* Interrupt Status Enable Register */
#define BCHP_XPT_XMEMIF_WR_RDY_ACCEPT_STATUS     0x00a0018c /* Ready Accept Status On the Wr XMEM interface */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_STATUS_CL0_6 0x00a00190 /* Ready Accept Status On the RD XMEM interface for CL0_6 */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_PB_LCTOXMEM 0x00a00194 /* Ready Accept Status on the RD XMEM interface for Playback LC to xmem */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_PB_XMEMTOLC 0x00a00198 /* Ready Accept Status On the RD XMEM interface for Playback xmem to LC */
#define BCHP_XPT_XMEMIF_SEC_REGION_LO            0x00a0019c /* DRAM Secured Address Range Low */
#define BCHP_XPT_XMEMIF_SEC_REGION_HI            0x00a001a0 /* DRAM Secured Address Range High */
