 ...
 *
 *
 * Date:           Generated on         Mon Jul 23 12:05:42 2007
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7400/rdb/d0/bchp_int_id_xpt_bus_if.h $
 * 
 * Hydra_Software_Devel/1   7/23/07 3:14p maivu
...
#define BCHP_INT_ID_RMX0_PKT_GEN1_DONE_INTR   BCHP_INT_ID_CREATE(BCHP_XPT_BUS_IF_INTR_STATUS_REG, BCHP_XPT_BUS_IF_INTR_STATUS_REG_RMX0_PKT_GEN1_DONE_INTR_SHIFT)
#define BCHP_INT_ID_RMX0_PKT_GEN2_DONE_INTR   BCHP_INT_ID_CREATE(BCHP_XPT_BUS_IF_INTR_STATUS_REG, BCHP_XPT_BUS_IF_INTR_STATUS_REG_RMX0_PKT_GEN2_DONE_INTR_SHIFT)
#define BCHP_INT_ID_RMX0_TS_RANGE_ERROR       BCHP_INT_ID_CREATE(BCHP_XPT_BUS_IF_INTR_STATUS_REG, BCHP_XPT_BUS_IF_INTR_STATUS_REG_RMX0_TS_RANGE_ERROR_SHIFT)
#define BCHP_INT_ID_RMX1_PKT_GEN1_DONE_INTR   BCHP_INT_ID_CREATE(BCHP_XPT_BUS_IF_INTR_STATUS_REG, BCHP_XPT_BUS_IF_INTR_STATUS_REG_RMX1_PKT_GEN1_DONE_INTR_SHIFT)
#define BCHP_INT_ID_RMX1_PKT_GEN2_DONE_INTR   BCHP_INT_ID_CREATE(BCHP_XPT_BUS_IF_INTR_STATUS_REG, BCHP_XPT_BUS_IF_INTR_STATUS_REG_RMX1_PKT_GEN2_DONE_INTR_SHIFT)
#define BCHP_INT_ID_RMX1_TS_RANGE_ERROR       BCHP_INT_ID_CREATE(BCHP_XPT_BUS_IF_INTR_STATUS_REG, BCHP_XPT_BUS_IF_INTR_STATUS_REG_RMX1_TS_RANGE_ERROR_SHIFT)
