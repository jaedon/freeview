 ...
 *
 *
 * Date:           Generated on         Thu Oct 27 17:19:11 2011
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7425/rdb/b1/bchp_mspi.h $
 * 
 * Hydra_Software_Devel/1   10/27/11 11:57p vanessah
 ...
 *MSPI - Master SPI
 ***************************************************************************/
#define BCHP_MSPI_SPCR0_LSB                      0x00409200 /* SPCR0_LSB REGISTER */
#define BCHP_MSPI_SPCR0_MSB                      0x00409204 /* SPCR0_MSB Register */
#define BCHP_MSPI_SPCR1_LSB                      0x00409208 /* SPCR1_LSB REGISTER */
#define BCHP_MSPI_SPCR1_MSB                      0x0040920c /* SPCR1_MSB REGISTER */
#define BCHP_MSPI_NEWQP                          0x00409210 /* NEWQP REGISTER */
#define BCHP_MSPI_ENDQP                          0x00409214 /* ENDQP REGISTER */
#define BCHP_MSPI_SPCR2                          0x00409218 /* SPCR2 REGISTER */
#define BCHP_MSPI_MSPI_STATUS                    0x00409220 /* MSPI STATUS REGISTER */
#define BCHP_MSPI_CPTQP                          0x00409224 /* CPTQP REGISTER */
#define BCHP_MSPI_SPCR3                          0x00409228 /* SPCR3 REGISTER */
#define BCHP_MSPI_TXRAM00                        0x00409240 /* Most significant byte of TXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_TXRAM01                        0x00409244 /* Least significant byte of TXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_TXRAM02                        0x00409248 /* Most significant byte of TXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_TXRAM03                        0x0040924c /* Least significant byte of TXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_TXRAM04                        0x00409250 /* Most significant byte of TXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_TXRAM05                        0x00409254 /* Least significant byte of TXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_TXRAM06                        0x00409258 /* Most significant byte of TXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_TXRAM07                        0x0040925c /* Least significant byte of TXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_TXRAM08                        0x00409260 /* Most significant byte of TXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_TXRAM09                        0x00409264 /* Least significant byte of TXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_TXRAM10                        0x00409268 /* Most significant byte of TXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_TXRAM11                        0x0040926c /* Least significant byte of TXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_TXRAM12                        0x00409270 /* Most significant byte of TXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_TXRAM13                        0x00409274 /* Least significant byte of TXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_TXRAM14                        0x00409278 /* Most significant byte of TXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_TXRAM15                        0x0040927c /* Least significant byte of TXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_TXRAM16                        0x00409280 /* Most significant byte of TXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_TXRAM17                        0x00409284 /* Least significant byte of TXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_TXRAM18                        0x00409288 /* Most significant byte of TXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_TXRAM19                        0x0040928c /* Least significant byte of TXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_TXRAM20                        0x00409290 /* Most significant byte of TXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_TXRAM21                        0x00409294 /* Least significant byte of TXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_TXRAM22                        0x00409298 /* Most significant byte of TXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_TXRAM23                        0x0040929c /* Least significant byte of TXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_TXRAM24                        0x004092a0 /* Most significant byte of TXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_TXRAM25                        0x004092a4 /* Least significant byte of TXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_TXRAM26                        0x004092a8 /* Most significant byte of TXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_TXRAM27                        0x004092ac /* Least significant byte of TXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_TXRAM28                        0x004092b0 /* Most significant byte of TXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_TXRAM29                        0x004092b4 /* Least significant byte of TXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_TXRAM30                        0x004092b8 /* Most significant byte of TXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_TXRAM31                        0x004092bc /* Least significant byte of TXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_RXRAM00                        0x004092c0 /* Most significant byte of RXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_RXRAM01                        0x004092c4 /* Least significant byte of RXRAM[0] (queue pointer = 0) */
#define BCHP_MSPI_RXRAM02                        0x004092c8 /* Most significant byte of RXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_RXRAM03                        0x004092cc /* Least significant byte of RXRAM[1] (queue pointer = 1) */
#define BCHP_MSPI_RXRAM04                        0x004092d0 /* Most significant byte of RXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_RXRAM05                        0x004092d4 /* Least significant byte of RXRAM[2] (queue pointer = 2) */
#define BCHP_MSPI_RXRAM06                        0x004092d8 /* Most significant byte of RXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_RXRAM07                        0x004092dc /* Least significant byte of RXRAM[3] (queue pointer = 3) */
#define BCHP_MSPI_RXRAM08                        0x004092e0 /* Most significant byte of RXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_RXRAM09                        0x004092e4 /* Least significant byte of RXRAM[4] (queue pointer = 4) */
#define BCHP_MSPI_RXRAM10                        0x004092e8 /* Most significant byte of RXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_RXRAM11                        0x004092ec /* Least significant byte of RXRAM[5] (queue pointer = 5) */
#define BCHP_MSPI_RXRAM12                        0x004092f0 /* Most significant byte of RXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_RXRAM13                        0x004092f4 /* Least significant byte of RXRAM[6] (queue pointer = 6) */
#define BCHP_MSPI_RXRAM14                        0x004092f8 /* Most significant byte of RXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_RXRAM15                        0x004092fc /* Least significant byte of RXRAM[7] (queue pointer = 7) */
#define BCHP_MSPI_RXRAM16                        0x00409300 /* Most significant byte of RXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_RXRAM17                        0x00409304 /* Least significant byte of RXRAM[8] (queue pointer = 8) */
#define BCHP_MSPI_RXRAM18                        0x00409308 /* Most significant byte of RXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_RXRAM19                        0x0040930c /* Least significant byte of RXRAM[9] (queue pointer = 9) */
#define BCHP_MSPI_RXRAM20                        0x00409310 /* Most significant byte of RXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_RXRAM21                        0x00409314 /* Least significant byte of RXRAM[10] (queue pointer = 10) */
#define BCHP_MSPI_RXRAM22                        0x00409318 /* Most significant byte of RXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_RXRAM23                        0x0040931c /* Least significant byte of RXRAM[11] (queue pointer = 11) */
#define BCHP_MSPI_RXRAM24                        0x00409320 /* Most significant byte of RXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_RXRAM25                        0x00409324 /* Least significant byte of RXRAM[12] (queue pointer = 12) */
#define BCHP_MSPI_RXRAM26                        0x00409328 /* Most significant byte of RXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_RXRAM27                        0x0040932c /* Least significant byte of RXRAM[13] (queue pointer = 13) */
#define BCHP_MSPI_RXRAM28                        0x00409330 /* Most significant byte of RXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_RXRAM29                        0x00409334 /* Least significant byte of RXRAM[14] (queue pointer = 14) */
#define BCHP_MSPI_RXRAM30                        0x00409338 /* Most significant byte of RXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_RXRAM31                        0x0040933c /* Least significant byte of RXRAM[15] (queue pointer = 15) */
#define BCHP_MSPI_CDRAM00                        0x00409340 /* 8-bit command (queue pointer = 0) */
#define BCHP_MSPI_CDRAM01                        0x00409344 /* 8-bit command (queue pointer = 1) */
#define BCHP_MSPI_CDRAM02                        0x00409348 /* 8-bit command (queue pointer = 2) */
#define BCHP_MSPI_CDRAM03                        0x0040934c /* 8-bit command (queue pointer = 3) */
#define BCHP_MSPI_CDRAM04                        0x00409350 /* 8-bit command (queue pointer = 4) */
#define BCHP_MSPI_CDRAM05                        0x00409354 /* 8-bit command (queue pointer = 5) */
#define BCHP_MSPI_CDRAM06                        0x00409358 /* 8-bit command (queue pointer = 6) */
#define BCHP_MSPI_CDRAM07                        0x0040935c /* 8-bit command (queue pointer = 7) */
#define BCHP_MSPI_CDRAM08                        0x00409360 /* 8-bit command (queue pointer = 8) */
#define BCHP_MSPI_CDRAM09                        0x00409364 /* 8-bit command (queue pointer = 9) */
#define BCHP_MSPI_CDRAM10                        0x00409368 /* 8-bit command (queue pointer = a) */
#define BCHP_MSPI_CDRAM11                        0x0040936c /* 8-bit command (queue pointer = b) */
#define BCHP_MSPI_CDRAM12                        0x00409370 /* 8-bit command (queue pointer = c) */
#define BCHP_MSPI_CDRAM13                        0x00409374 /* 8-bit command (queue pointer = d) */
#define BCHP_MSPI_CDRAM14                        0x00409378 /* 8-bit command (queue pointer = e) */
#define BCHP_MSPI_CDRAM15                        0x0040937c /* 8-bit command (queue pointer = f) */
