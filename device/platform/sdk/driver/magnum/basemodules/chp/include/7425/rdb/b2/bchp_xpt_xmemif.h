 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7425/rdb/b2/bchp_xpt_xmemif.h $
 * 
 * Hydra_Software_Devel/1   1/17/12 6:38p vanessah
 ...
 ***************************************************************************/
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_SEL_RSBUFF    0x00900100 /* SCB Write Client select register for RSBUFF */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_SEL_XCBUFF    0x00900104 /* SCB Write Client select register for XCBUFF */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_SEL_RAVE_CDB  0x00900108 /* SCB Write Client select register for RAVE CDB */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_SEL_RAVE_ITB  0x0090010c /* SCB Write Client select register for RAVE ITB */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_SEL_MSG       0x00900110 /* SCB Write Client select register for MESSAGE */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_RSBUFF    0x00900114 /* SCB Read Client select register for RSBUFF */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_RSBUFF_MPOD 0x00900118 /* SCB Read Client select register for RSBUFF */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_XCBUFF_RAVE 0x0090011c /* SCB Read Client select register for XCBUFF RAVE */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_XCBUFF_RMX0 0x00900120 /* SCB Read Client select register for XCBUFF RMX0 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_XCBUFF_RMX1 0x00900124 /* SCB Read Client select register for XCBUFF RMX1 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_XCBUFF_MSG 0x00900128 /* SCB Read Client select register for XCBUFF MSG */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB0       0x0090012c /* SCB Read Client select register for Playback0 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB1       0x00900130 /* SCB Read Client select register for Playback1 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB2       0x00900134 /* SCB Read Client select register for Playback2 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB3       0x00900138 /* SCB Read Client select register for Playback3 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB4       0x0090013c /* SCB Read Client select register for Playback4 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB5       0x00900140 /* SCB Read Client select register for Playback5 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB6       0x00900144 /* SCB Read Client select register for Playback6 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB7       0x00900148 /* SCB Read Client select register for Playback7 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB8       0x0090014c /* SCB Read Client select register for Playback8 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB9       0x00900150 /* SCB Read Client select register for Playback9 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB10      0x00900154 /* SCB Read Client select register for Playback10 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB11      0x00900158 /* SCB Read Client select register for Playback11 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB12      0x0090015c /* SCB Read Client select register for Playback12 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB13      0x00900160 /* SCB Read Client select register for Playback13 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB14      0x00900164 /* SCB Read Client select register for Playback14 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PB15      0x00900168 /* SCB Read Client select register for Playback15 */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_SEL_PSUB      0x0090016c /* SCB Read Client select register for PSUB */
#define BCHP_XPT_XMEMIF_SCB_WR_ARB_MODE          0x00900170 /* SCB Write Client Arbiter Mode Control */
#define BCHP_XPT_XMEMIF_SCB_RD_ARB_MODE          0x00900174 /* SCB Read Client Arbiter Mode Control */
#define BCHP_XPT_XMEMIF_WR_DEBUG                 0x00900178 /* Debug and Test register for XMEMIF write */
#define BCHP_XPT_XMEMIF_RD_DEBUG0                0x0090017c /* Debug and Test register for XMEMIF read */
#define BCHP_XPT_XMEMIF_RD_DEBUG1                0x00900180 /* Debug and Test register for XMEMIF read */
#define BCHP_XPT_XMEMIF_INTR_STATUS_REG          0x00900184 /* Interrupt Status Register */
#define BCHP_XPT_XMEMIF_INTR_STATUS_REG_EN       0x00900188 /* Interrupt Status Enable Register */
#define BCHP_XPT_XMEMIF_WR_RDY_ACCEPT_STATUS     0x0090018c /* Ready Accept Status On the Wr XMEM interface */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_STATUS_CL0_6 0x00900190 /* Ready Accept Status On the RD XMEM interface for CL0_6 */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_PB_LCTOXMEM 0x00900194 /* Ready Accept Status on the RD XMEM interface for Playback LC to xmem */
#define BCHP_XPT_XMEMIF_RD_RDY_ACCEPT_PB_XMEMTOLC 0x00900198 /* Ready Accept Status On the RD XMEM interface for Playback xmem to LC */
#define BCHP_XPT_XMEMIF_SEC_REGION_LO            0x0090019c /* DRAM Secured Address Range Low */
#define BCHP_XPT_XMEMIF_SEC_REGION_HI            0x009001a0 /* DRAM Secured Address Range High */
 ...
 ***************************************************************************/
/* XPT_XMEMIF :: RD_DEBUG0 :: reserved0 [31:23] */
#define BCHP_XPT_XMEMIF_RD_DEBUG0_reserved0_MASK                   0xff800000
#define BCHP_XPT_XMEMIF_RD_DEBUG0_reserved0_SHIFT                  23
 ...
 ***************************************************************************/
/* XPT_XMEMIF :: RD_DEBUG1 :: reserved0 [31:23] */
#define BCHP_XPT_XMEMIF_RD_DEBUG1_reserved0_MASK                   0xff800000
#define BCHP_XPT_XMEMIF_RD_DEBUG1_reserved0_SHIFT                  23
