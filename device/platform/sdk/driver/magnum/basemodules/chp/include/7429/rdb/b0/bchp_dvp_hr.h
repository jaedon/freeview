 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7429/rdb/b0/bchp_dvp_hr.h $
 * 
 * Hydra_Software_Devel/1   6/14/12 12:24p pntruong
 ...
 ***************************************************************************/
#define BCHP_DVP_HR_CORE_REV                     0x006a4000 /* Digital Video Port Core Revision Number */
#define BCHP_DVP_HR_TOP_SW_INIT                  0x006a4004 /* Software Init for Top level Core */
#define BCHP_DVP_HR_HDMI_FE_0_SW_INIT            0x006a4008 /* Software Init for HDMI Receiver Front End 0 */
#define BCHP_DVP_HR_HDMI_RX_0_SW_INIT            0x006a4018 /* Software Init for HDMI Receiver 0 */
#define BCHP_DVP_HR_POWER_CONTROL                0x006a4028 /* Power Control */
#define BCHP_DVP_HR_PTHRU_CFG                    0x006a402c /* HDMI Pass Through Configuration */
#define BCHP_DVP_HR_PTHRU_STATUS                 0x006a4030 /* HDMI Pass Through Status */
#define BCHP_DVP_HR_VMS_LOOPBACK_ENABLE          0x006a4034 /* VMS loopback enable */
#define BCHP_DVP_HR_TEST_PORT_CONFIGURATION      0x006a4038 /* Configure which data is output on the test port */
#define BCHP_DVP_HR_DVP_FLOW_CONTROL             0x006a403c /* DVP Flow Control */
#define BCHP_DVP_HR_I2C_CONTROL                  0x006a4040 /* I2C Control Register */
#define BCHP_DVP_HR_DVP_HR_TIMER_1S_CONTROL      0x006a4044 /* Timer Control Register - 1S */
#define BCHP_DVP_HR_DVP_HR_TIMER_1MS_CONTROL     0x006a4048 /* Timer Control Register - 1MS */
#define BCHP_DVP_HR_DVP_HR_TIMER_1US_CONTROL     0x006a404c /* Timer Control Register - 1US */
#define BCHP_DVP_HR_FREQ_MEASURE_CONTROL         0x006a4050 /* Freq Measurement Control */
#define BCHP_DVP_HR_FREQ_MEASURE                 0x006a4054 /* Freq Measurement Current Value */
#define BCHP_DVP_HR_MAX_FREQ                     0x006a4058 /* Freq Measurement Max Value */
#define BCHP_DVP_HR_MIN_FREQ                     0x006a405c /* Freq Measurement Min Value */
#define BCHP_DVP_HR_RBUS_MONITOR_0_CFG_0         0x006a4060 /* RBUS Monitor Configuration */
#define BCHP_DVP_HR_RBUS_MONITOR_0_CTL_0         0x006a4064 /* RBUS Monitor Control */
#define BCHP_DVP_HR_RBUS_MONITOR_0_RESULTS_0     0x006a4068 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_0_RESULTS_1     0x006a406c /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_0_RESULTS_2     0x006a4070 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_0_RESULTS_3     0x006a4074 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_0_RESULTS_4     0x006a4078 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_1_CFG_0         0x006a407c /* RBUS Monitor Configuration */
#define BCHP_DVP_HR_RBUS_MONITOR_1_CTL_0         0x006a4080 /* RBUS Monitor Control */
#define BCHP_DVP_HR_RBUS_MONITOR_1_RESULTS_0     0x006a4084 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_1_RESULTS_1     0x006a4088 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_1_RESULTS_2     0x006a408c /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_1_RESULTS_3     0x006a4090 /* RBUS Monitor Results */
#define BCHP_DVP_HR_RBUS_MONITOR_1_RESULTS_4     0x006a4094 /* RBUS Monitor Results */
#define BCHP_DVP_HR_FSM_DEBUG_SAT_THLD           0x006a4098 /* FSM Debug Feature Related */
#define BCHP_DVP_HR_FSM_DEBUG_CNT_ENABLES        0x006a409c /* FSM Debug Feature Related */
#define BCHP_DVP_HR_FSM_DEBUG_CONTROL_SIGNALS    0x006a40a0 /* FSM Debug Feature Related */
#define BCHP_DVP_HR_FSM_DEBUG_LUMP_STATES        0x006a40a4 /* FSM Debug Feature Related */
#define BCHP_DVP_HR_FSM_DEBUG_FSM_STUCK          0x006a40a8 /* FSM Debug Feature Related */
#define BCHP_DVP_HR_FSM_DEBUG_INFO_OF_SELECTED_FSM 0x006a40ac /* FSM Debug Feature Related */
#define BCHP_DVP_HR_SPARE_REGISTER_BITS          0x006a41bc /* Spare Bits For ECO's */
