 ...
 *
 * $brcm_Workfile: bchp_memc_ddr23_shim_addr_cntl.h $
 ...
 *
 *
 * Date:           Generated on         Fri Sep 11 19:40:57 2009
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7468/rdb/a0/bchp_memc_ddr23_shim_addr_cntl.h $
 * 
 ...
 ***************************************************************************/
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_CONFIG    0x002c8000 /* DDR23_SHIM Config register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_DDR23_SHIM_REV_ID 0x002c8004 /* DDR23_SHIM Revision ID Register. */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_RESET     0x002c8008 /* DDR soft reset register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_ODT_CONFIG 0x002c8038 /* ODT Configuration register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_DDR_PLL_LOCK_STATUS 0x002c8040 /* DDR PLL lock status register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_PHY_USE_DYN_VDL 0x002c8044 /* DDR PHY USE DYN VDL Control register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_IDLE_POWER_SAVING 0x002c8048 /* DDR PHY Idle power saving Control register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_EXT_PLL_CNTL 0x002c804c /* DDR PHY PLL External Control register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_ANALOG_BYPASS_CNTRL 0x002c806c /* Analog macro register bypass control */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_DDR_PLL_EXT_CLKSEL 0x002c8070 /* DDR PLL external clock select register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_TEST_MODE_CNTRL_REG 0x002c8074 /* DDR23_SHIM testport control register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_DISABLE_CHIP_BYPASS_PLL 0x002c807c /* DDR bypass pll mode disable register. */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_VECTOR_MODE_CLK_SEL 0x002c8088 /* DDR VECTOR PLL bypass mode clock select */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_DDR_PAD_CNTRL 0x002c808c /* DDR Pad control register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_CLK_GATE  0x002c8098 /* CLK_667_ENABLE Register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_DDR23_SHIM_STATUS 0x002c809c /* DDR23_SHIM Status Register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_DRAM_FIFO_LEVEL 0x002c80a0 /* DRAM FIFO LEVEL register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_CMD_DATA_FIFO 0x002c8028 /* Command and Data FIFO Status Register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_RD_DATAPATH 0x002c802c /* Read Datapath Status Register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_FLAG_BUS  0x002c8030 /* TP_OUT bus value Register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_MISC      0x002c8034 /* Miscellaneous Register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_SPARE0_RW 0x002c80a4 /* Spare register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_SPARE1_RW 0x002c80a8 /* Spare register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_SPARE0_RO 0x002c80ac /* Spare register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_SPARE1_RO 0x002c80b0 /* Spare register */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_PHYBIST_CNTRL 0x002c8058 /* DDR Phy-Bist Control and Status */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_PHYBIST_SEED 0x002c805c /* DDR Phy-Bist PRPG Seed Value */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_PHYBIST_CTL_STATUS 0x002c8060 /* DDR Phy-Bist Address & Control Status */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_PHYBIST_DQ_STATUS 0x002c8064 /* DDR Phy-Bist DQ Status */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_PHYBIST_MISC_STATUS 0x002c8068 /* DDR Phy-Bist Miscellaneous Status */
#define BCHP_MEMC_DDR23_SHIM_ADDR_CNTL_DDR3_RESET_CNTRL 0x002c80b4 /* FORCE_DDR3_RESET Deassert  Register */
