 ...
 *
 *
 * Date:           Generated on         Fri Mar 26 19:42:58 2010
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7468/rdb/a0/bchp_sdio.h $
 * 
 * Hydra_Software_Devel/1   3/30/10 7:31p albertl
 * SW7550-351: Initial revision.
 *
 ***************************************************************************/
 ...
 *SDIO
 ***************************************************************************/
#define BCHP_SDIO_SDMA                           0x00310000 /* System DMA Address Register */
#define BCHP_SDIO_BLOCK                          0x00310004 /* Block Transfer Configuration Register */
#define BCHP_SDIO_ARGUMENT                       0x00310008 /* Argument Register */
#define BCHP_SDIO_CMD_MODE                       0x0031000c /* Command and Mode Register */
#define BCHP_SDIO_RESP_01                        0x00310010 /* Response Word 0 and 1 */
#define BCHP_SDIO_RESP_23                        0x00310014 /* Response Word 2 and 3 */
#define BCHP_SDIO_RESP_45                        0x00310018 /* Response Word 4 and 5 */
#define BCHP_SDIO_RESP_67                        0x0031001c /* Response Word 6 and 7 */
#define BCHP_SDIO_BUFFDATA                       0x00310020 /* Buffer Data Port for PIO Tranfers */
#define BCHP_SDIO_STATE                          0x00310024 /* Present State of Controller */
#define BCHP_SDIO_CTRL_SET0                      0x00310028 /* SD Standard Control Registers for Host, Power, BlockGap, WakeUp */
#define BCHP_SDIO_CTRL_SET1                      0x0031002c /* SD Standard Control Registers for Clock, Timeout, Resets */
#define BCHP_SDIO_INT_STATUS                     0x00310030 /* Interrupt Status for Normal and Error conditions */
#define BCHP_SDIO_INT_STATUS_ENA                 0x00310034 /* Interrupt Enables for Normal and Error conditions */
#define BCHP_SDIO_INT_SIGNAL_ENA                 0x00310038 /* Interrupt Signal Enables for Normal and Error conditions */
#define BCHP_SDIO_AUTOCMD12_STAT                 0x0031003c /* Auto Cmd12 Error Status */
#define BCHP_SDIO_CAPABLE                        0x00310040 /* Host Controller Capabilities to Software */
#define BCHP_SDIO_CAPABLE_RSVD                   0x00310044 /* Future Host Controller Capabilities to Software */
#define BCHP_SDIO_POWER_CAPABLE                  0x00310048 /* Host Controller Power Capabilities to Software */
#define BCHP_SDIO_POWER_CAPABLE_RSVD             0x0031004c /* Future Host Controller Power Capabilities to Software */
#define BCHP_SDIO_FORCE_EVENTS                   0x00310050 /* Force Events on Error Status Bits */
#define BCHP_SDIO_ADMA_ERR_STAT                  0x00310054 /* ADMA Error Status Bits */
#define BCHP_SDIO_ADMA_SYSADDR_LO                0x00310058 /* ADMA System Address Low Bits */
#define BCHP_SDIO_ADMA_SYSADDR_HI                0x0031005c /* ADMA System Address High Bits */
#define BCHP_SDIO_BOOT_TIMEOUT                   0x00310060 /* DAT line inactivity timeout on boot */
#define BCHP_SDIO_DEBUG_SELECT                   0x00310064 /* Debug probe output selection */
#define BCHP_SDIO_SPI_INTERRUPT                  0x003100f0 /* SPI Interrupt support */
#define BCHP_SDIO_VERSION_STATUS                 0x003100fc /* Controller Version and Slot Status */
...
/***************************************************************************
 *BLOCK - Block Transfer Configuration Register
 ***************************************************************************/
