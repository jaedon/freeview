...
void BCHP_PWR_P_HW_SVD0_CLK_Control(BCHP_Handle handle, bool activate)
{
    ...
    if (activate) {                
        ...
        mask = (
        BCHP_CLKGEN_SVD0_TOP_CLOCK_ENABLE_AVD_CORE_CLOCK_ENABLE_MASK |
        BCHP_CLKGEN_SVD0_TOP_CLOCK_ENABLE_AVD_CPU_CLOCK_ENABLE_MASK |
        BCHP_CLKGEN_SVD0_TOP_CLOCK_ENABLE_AVD_SCB_CLOCK_ENABLE_MASK |
        BCHP_CLKGEN_SVD0_TOP_CLOCK_ENABLE_AVD_108_CLOCK_ENABLE_MASK
        );
...
{   
    ...
    mask = BCHP_CLKGEN_SVD0_TOP_POWER_SWITCH_MEMORY_AVD_POWER_SWITCH_MEMORY_MASK;
...
void BCHP_PWR_P_HW_VEC_AIO_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (
        BCHP_CLKGEN_VEC_AIO_TOP_CLOCK_ENABLE_VEC_AIO_ALTERNATE2_SCB_CLOCK_ENABLE_MASK |
        BCHP_CLKGEN_VEC_AIO_TOP_CLOCK_ENABLE_VEC_AIO_ALTERNATE2_216_CLOCK_ENABLE_MASK |
        BCHP_CLKGEN_VEC_AIO_TOP_CLOCK_ENABLE_VEC_AIO_ALTERNATE2_108_CLOCK_ENABLE_MASK |
        BCHP_CLKGEN_VEC_AIO_TOP_CLOCK_ENABLE_VEC_AIO_ALTERNATE_SCB_CLOCK_ENABLE_MASK |
        BCHP_CLKGEN_VEC_AIO_TOP_CLOCK_ENABLE_VEC_AIO_ALTERNATE_216_CLOCK_ENABLE_MASK |
        BCHP_CLKGEN_VEC_AIO_TOP_CLOCK_ENABLE_VEC_AIO_ALTERNATE_108_CLOCK_ENABLE_MASK |
        BCHP_CLKGEN_VEC_AIO_TOP_CLOCK_ENABLE_VEC_AIO_SCB_CLOCK_ENABLE_MASK |
        BCHP_CLKGEN_VEC_AIO_TOP_CLOCK_ENABLE_VEC_AIO_216_CLOCK_ENABLE_MASK |
        BCHP_CLKGEN_VEC_AIO_TOP_CLOCK_ENABLE_VEC_AIO_108_CLOCK_ENABLE_MASK
        );
...
void BCHP_PWR_P_HW_V3D_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = BCHP_CLKGEN_GRAPHICS_CLOCK_ENABLE_GFX_V3D_CLOCK_ENABLE_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_GRAPHICS_CLOCK_ENABLE, mask, activate ? mask : 0);
...
void BCHP_PWR_P_HW_DMA_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = BCHP_CLKGEN_SECTOP_CLOCK_ENABLE_SEC_ALTERNATE_SCB_CLOCK_ENABLE_MASK;

    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_SECTOP_CLOCK_ENABLE, mask, activate?mask:0);
}
