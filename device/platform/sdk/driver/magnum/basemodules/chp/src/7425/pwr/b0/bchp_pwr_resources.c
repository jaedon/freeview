...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_BVN_MCVP_108M[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_BVN_MCVP_108M,
    "HW_BVN_MCVP_108M"
}};
...
const BCHP_PWR_P_Resource BCHP_PWR_P_Resource_HW_VEC_AIO_324M[] = {{
    BCHP_PWR_P_ResourceType_eLeaf,
    BCHP_PWR_HW_VEC_AIO_324M,
    "HW_VEC_AIO_324M"
}};
...
void BCHP_PWR_P_HW_Control(BCHP_Handle handle, const BCHP_PWR_P_Resource *resource, bool activate)
{
    switch(resource->id) {
        ...
        case BCHP_PWR_HW_BVN_108M:
            ...
            break;
        case BCHP_PWR_HW_BVN_MCVP_108M:
            BCHP_PWR_P_HW_BVN_MCVP_108M_Control(handle, activate);
            break;
        ...
        case BCHP_PWR_HW_VEC_SRAM:
            ...
            break;
        case BCHP_PWR_HW_VEC_AIO_324M:
            BCHP_PWR_P_HW_VEC_AIO_324M_Control(handle, activate);
            break;
