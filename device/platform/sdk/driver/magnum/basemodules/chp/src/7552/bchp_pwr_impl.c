...
void BCHP_PWR_P_HW_AVD0_CLK_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask;
...
void BCHP_PWR_P_HW_AVD0_PWR_Control(BCHP_Handle handle, bool activate)
{   
    uint32_t mask;
    ...
    BKNI_Sleep(1);  
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_AVD0_TOP_POWER_SWITCH_MEMORY, mask, 1);
    BKNI_Sleep(1); 
...
void BCHP_PWR_P_HW_RAAGA_Control(BCHP_Handle handle, bool activate)
{
    ...
    mask = (BCHP_CLKGEN_RAAGA_DSP_TOP_CLOCK_ENABLE_RAAGA_SCB_CLOCK_ENABLE_MASK |
	    BCHP_CLKGEN_RAAGA_DSP_TOP_CLOCK_ENABLE_RAAGA_DSP_CLOCK_ENABLE_MASK |
...
void BCHP_PWR_P_HW_RAAGA_SRAM_Control(BCHP_Handle handle, bool activate)
{
    ...
    BKNI_Sleep(1);  
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RAAGA_DSP_TOP_POWER_SWITCH_MEMORY, mask, 1);
    BKNI_Sleep(1); 
...
void BCHP_PWR_P_HW_BVN_SRAM_Control(BCHP_Handle handle, bool activate)
{
	...
	BKNI_Sleep(1);
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_BVN_TOP_POWER_SWITCH_MEMORY, mask, 1);
	BKNI_Sleep(1);
...
void BCHP_PWR_P_HW_VEC_SRAM_Control(BCHP_Handle handle, bool activate)
{
	...
	BKNI_Sleep(1);
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_VEC_AIO_TOP_POWER_SWITCH_MEMORY_A, mask, 1);
	BKNI_Sleep(1);
...
void BCHP_PWR_P_HW_XPT_SRAM_Control(BCHP_Handle handle, bool activate)
{
    ...
    BKNI_Sleep(1);  
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_CORE_XPT_POWER_SWITCH_MEMORY, mask, 1);
    BKNI_Sleep(1);  
...
void BCHP_PWR_P_HW_RFM_SRAM_Control(BCHP_Handle handle, bool activate)
{
    uint32_t mask;
    ...
    BKNI_Sleep(1);  
	BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RFM_TOP_POWER_SWITCH_MEMORY, mask, 1);
    BKNI_Sleep(1); 
	...
	if(activate) {  
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RFM_TOP_MEMORY_STANDBY_ENABLE, mask, mask);
    } else {    
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_RFM_TOP_MEMORY_STANDBY_ENABLE, mask, 0);
    }
...
#if 0
    mask = BCHP_CLKGEN_PLL_AVD_MIPS_PLL_CHANNEL_CTRL_CH_0_CLOCK_DIS_CH0_MASK;
    BREG_AtomicUpdate32(handle->regHandle, BCHP_CLKGEN_PLL_AVD_MIPS_PLL_CHANNEL_CTRL_CH_0, mask, activate?0:mask);
#else
    BSTD_UNUSED(mask);
    BSTD_UNUSED(handle);
#endif
