 ...
 * $brcm_Date: 1/10/13 11:29a $
 *
 * Module Description: Host DSP Task Interface
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/dsp/src/raaga/firmware/fp2008/bdsp_raaga_img.h $
 * 
 * Hydra_Software_Devel/25   1/10/13 11:29a skalapur
 * FWRAA-474:iLBC code merging to main latest
 * 
 * Hydra_Software_Devel/24   1/9/13 11:47p ananthan
 * FWRAA-535: Removing duplicate entries for SCM task in image interface
 * structure
 * 
 * Hydra_Software_Devel/23   11/27/12 7:24p ananthan
