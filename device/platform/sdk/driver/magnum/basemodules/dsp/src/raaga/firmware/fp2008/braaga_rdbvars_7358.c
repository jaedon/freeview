...
const uint32_t BDSP_IMG_system_rdbvars_array1[] = {
	...
	0x10821200, /* Priority of DMA Queues */
	...
	0x10821248, /* DMA Source Address Register for DMA Command Queue-0 */
	0x10821288, /* DMA Source Address Register for DMA command Queue-1 */
	0x1082124C, /* DMA destination address register for DMA Command Queue-0 */
	0x10821244, /* DMA SCB command type for Video Block Access and Video Raster access commands. */
	0x10821250, /* DMA transfer enable register for DMA-Queue-0 */
	...
	0x1082125C, /* DMA-Token-ID clear for DMA-Queue-0 */
