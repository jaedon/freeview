 ...
 * $brcm_Date: 1/29/13 5:45p $
 *
 * Module Description: Host DSP Task Interface
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/dsp/src/raaga/firmware/fp2011/bdsp_raaga_img.c $
 * 
 * Hydra_Software_Devel/27   1/29/13 5:45p sriniva
 * FWRAA-559: Renaming dts lbr braaga files to dts_express
 * 
 * Hydra_Software_Devel/26   1/10/13 11:19a skalapur
 * FWRAA-474:iLBC code merging to main latest
 * 
 * Hydra_Software_Devel/25   1/9/13 11:47p ananthan
 * FWRAA-535: Removing duplicate entries for SCM task in image interface
 * structure.
 * 
 * Hydra_Software_Devel/24   11/27/12 7:23p ananthan
