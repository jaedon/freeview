 ...
 *
 * $brcm_Workfile: bhab_4538.h $
 * $brcm_Revision: Hydra_Software_Devel/2 $
 * $brcm_Date: 7/13/12 1:56p $
 *
 * [File Description:]
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/hab/4538/bhab_4538.h $
 * 
 * Hydra_Software_Devel/2   7/13/12 1:56p enavarro
 * SWSATFE-174: updated interrupt and spare register definitions; updated
...
#define BHAB_4538_SPARE3_FLASH_ERROR_CODE_SHIFT 0x12
