 ...
 *
 * $brcm_Workfile: bhab_3520_priv.h $
 * $brcm_Revision: Hydra_Software_Devel/3 $
 * $brcm_Date: 10/18/11 3:21p $
 *
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/hab/3520/bhab_3520_priv.h $
 * 
 * Hydra_Software_Devel/3   10/18/11 3:21p atanugul
