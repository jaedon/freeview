 ...
 * 
 * Hydra_Software_Devel/15   2/1/11 5:36p VISHK
 * SW7422-171: Nexus support for the 3128 (8 ADS core + tuner on daughter
 * board) plug on 7422 board  Read and write memory modified to 32 bit
 * addressing to support 3128 chipset as it has 32 bit memory addressing.
 * 
 * Hydra_Software_Devel/14   12/2/10 7:18p VISHK
 * SW7405-5037: To make the i2c address programmable for the slave
 * device(LNA) of 31xx frontend chip.
 * 
 * Hydra_Software_Devel/13   8/31/10 3:36p mward
 * SW7125-35:  When closing, don't reset AP if it wasn't loaded by the
 * host at start time.
 * 
 * Hydra_Software_Devel/12   6/22/10 5:53p vishk
 * SW7420-839: Add support to program AGC gain to 31xx TNR PI
 * 
 * Hydra_Software_Devel/12   6/22/10 5:51p vishk
 * SW7420-839: Add support to program AGC gain to 31xx TNR PI
 * 
 * Hydra_Software_Devel/12   6/22/10 5:50p vishk
 * SW7420-839: Add support to program AGC gain to 31xx TNR PI
 * 
 * Hydra_Software_Devel/11   10/14/09 1:48p mward
 * SW7405-2851: Compiler warning:  Added "const" to BHAB_NmiSettings and
 * BHAB_WatchDogTimerSettings.
 * 
 * Hydra_Software_Devel/10   10/5/09 10:44a vishk
 * SW7405-2851: 31xx: Add support to configure the Watchdog feature of
 * 31xx.
 * 
 * Hydra_Software_Devel/9   5/12/09 10:54a vishk
 * PR 46431: Add support for BCM3117, BCM3114, and BCM3112
 * 
 * Hydra_Software_Devel/8   4/10/09 11:48a vishk
 * PR 46431: Add support for BCM3117, BCM3114, and BCM3112
 * 
 * Hydra_Software_Devel/7   3/13/09 11:19a vishk
 * PR 46431: Add support for BCM3117, BCM3114, and BCM3112
 * 
 * Hydra_Software_Devel/6   3/10/09 1:51p vishk
 * PR 46431: Add support for BCM3117, BCM3114, and BCM3112
 * 
 ***************************************************************************/
