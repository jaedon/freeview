 ...
 *
 * $brcm_Workfile: bhab_312x_priv.h $
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/hab/src/leapctfe/3128/bhab_312x_priv.h $
 * 
 * Hydra_Software_Devel/24   10/18/12 3:42p atanugul
 * SW3128-228: Add API Support for Reading New Front-End 312X, 314X, 346X
 * F/W Version IDs
 * 
 * Hydra_Software_Devel/23   9/28/12 1:39p atanugul
 * SW3128-228: Add support for BHAB_GetVersionInfo()
 * 
 * Hydra_Software_Devel/22   9/7/12 12:27p atanugul
 * SW7425-3788: restructure HAB directory
 * 
 * Hydra_Software_Devel/21   9/7/12 11:41a atanugul
 * SW7425-3788: restructure HAB directory
 * 
 * Hydra_Software_Devel/20   7/11/12 12:23p atanugul
 * SW3128-174: Add mutex protection to BHAB_312x_ReadRegister() and
 * BHAB_312x_WriteRegister()
 * 
 * Hydra_Software_Devel/19   7/6/12 11:55a vishk
 * SW3128-191: OOB synchronous lock status reported uncorrectly.
 * 
 * Hydra_Software_Devel/18   3/30/12 6:08p atanugul
 * SW3128-140: Add Spectrum Analyzer feature to the TNR PI
 * 
 * Hydra_Software_Devel/17   3/30/12 12:08p atanugul
 * SW3128-140: Add Spectrum Analyzer feature to the TNR PI
 * 
 * Hydra_Software_Devel/16   2/14/12 3:27p atanugul
 * SW3128-121: Add OOB No Signal IRQ support to 3128
 * 
 * Hydra_Software_Devel/15   12/22/11 2:21p atanugul
 * SW3128-97: Check for callback type installed before executing the
 * callback
 * 
 * Hydra_Software_Devel/14   12/8/11 3:13p atanugul
 * SW3128-89: Add PI support for Spectrum Analyzer Data retrieval
 * 
 * Hydra_Software_Devel/13   11/29/11 5:24p atanugul
 * SW7425-1722: move bchp_leap_ctrl.h bchp_leap_host_irq.h includes to
 * bhab_312x_priv.h
 * 
 * Hydra_Software_Devel/12   11/9/11 2:58p atanugul
 * SW3128-68: Add BHAB_ReadSlave() and BHAB_ReadSlave() API to 3128
 * 
 * Hydra_Software_Devel/11   11/8/11 5:06p atanugul
 * SW3128-64: Add BHAB_312x_GetConfigSettings BHAB_312x_SetConfigSettings
 * support for 312x
 * 
 * Hydra_Software_Devel/10   11/2/11 6:01p atanugul
 * SW3128-2: Update BHAB_GetApVersion()
 * 
 * Hydra_Software_Devel/9   10/18/11 3:21p atanugul
 * SW3461-67: change write_len, read_len and command_len in
 * BHAB_SendHabCommand() from type uint8_t to uint16_t
 * 
 * Hydra_Software_Devel/8   8/30/11 12:10p atanugul
 * SW3128-47: Add Support for BCM3123
 * 
 * Hydra_Software_Devel/7   8/25/11 11:04a atanugul
 * SW3128-40: Add No Signal support for 3128
 * 
 * Hydra_Software_Devel/6   6/13/11 10:56a atanugul
 * SW7425-706: bchp_3128.h doesn't exist and bhab_3128_priv.h tries to
 * include it; remove nexus flag and bcp_3128.h include as it doesn't
 * exist
 * 
 * Hydra_Software_Devel/5   5/6/11 3:50p atanugul
 ...
 * 
 * Hydra_Software_Devel/3   4/15/11 4:42p atanugul
