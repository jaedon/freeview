 ...
 *
 * $brcm_Workfile: bhab_34xx_priv.h $
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/hab/src/leapctfe/bhab_34xx_priv.h $
 * 
 * Hydra_Software_Devel/7   12/5/12 10:39a atanugul
 * SW3462-52: Add Support Tuner Gain API
 * 
 * Hydra_Software_Devel/6   12/4/12 2:04p atanugul
 * SW3462-50: Add BHAB_34xx_GetVersionInfo() support for 3462
 * 
 * Hydra_Software_Devel/5   9/7/12 11:42a atanugul
 * SW7425-3788: restructure HAB directory
 * 
 * Hydra_Software_Devel/4   7/19/12 12:07p atanugul
 * SW3472-8: Add EWS support to 3472; power on LEAP memories before FW
 * download for 3472
 * 
 * Hydra_Software_Devel/3   7/11/12 3:42p atanugul
 * SW3472-8: Add PI support for 3472
 * 
 * Hydra_Software_Devel/2   5/22/12 2:25p atanugul
