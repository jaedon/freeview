 ...
 *
 * $brcm_Workfile: bhab_4528_priv.h $
 * $brcm_Revision: Hydra_Software_Devel/5 $
 * $brcm_Date: 11/3/11 10:28a $
 *
 * [File Description:]
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/hab/4528/bhab_4528_priv.h $
 * 
 * Hydra_Software_Devel/5   11/3/11 10:28a enavarro
 * SWSATFE-86: changed GET_VERSION HAB command
 * 
 * Hydra_Software_Devel/4   10/18/11 3:47p enavarro
 * SWSATFE-86: BHAB_SendHabCommand() input parameter data type changed
 * 
 * Hydra_Software_Devel/3   9/12/11 3:57p enavarro
 * SW7425-883: add function to reset the LEAP
 * 
 * Hydra_Software_Devel/2   9/7/11 3:16p enavarro
 * SW7425-883: add function declarations for RBUS and BBSI access
 * 
 * Hydra_Software_Devel/1   8/11/11 4:05p enavarro
 * SW7425-883: initial version
 *
 ***************************************************************************/
#ifndef BHAB_4528_PRIV_H
#define BHAB_4528_PRIV_H
...
typedef struct BHAB_4528_P_CallbackInfo
{
   BHAB_IntCallbackFunc func;
   BHAB_4528_IrqStatus  callbackParams;
} BHAB_4528_P_CallbackInfo;


typedef struct BHAB_4528_P_Handle
{
    ...
    BHAB_4528_P_CallbackInfo callbackInfo;
} BHAB_4528_P_Handle;
...
BERR_Code BHAB_4528_P_ReadMemory(
...
BERR_Code BHAB_4528_P_WriteMemory(
...
BERR_Code BHAB_4528_P_WriteBbsi(
   BHAB_Handle h, /* [in] BHAB PI Handle */
...
BERR_Code BHAB_4528_P_ReadBbsi(
   BHAB_Handle h, /* [in] BHAB PI Handle */
   uint8_t addr,  /* [in] address */
...
BERR_Code BHAB_4528_P_ReadRbus(
   BHAB_Handle h, /* [in] BHAB PI Handle */
...
BERR_Code BHAB_4528_P_WriteRbus(
   BHAB_Handle h, /* [in] BHAB PI Handle */
   uint32_t addr, /* [in] address */
