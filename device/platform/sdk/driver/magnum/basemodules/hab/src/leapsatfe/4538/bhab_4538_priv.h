 ...
 *
 * $brcm_Workfile: bhab_4538_priv.h $
 * $brcm_Revision: Hydra_Software_Devel/4 $
 * $brcm_Date: 10/19/12 10:15a $
 *
 * [File Description:]
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/hab/src/leapsatfe/4538/bhab_4538_priv.h $
 * 
 * Hydra_Software_Devel/4   10/19/12 10:15a ronchan
 * SW3461-274: changes to bfec structure
 * 
 * Hydra_Software_Devel/3   10/15/12 2:12p enavarro
 * SWSATFE-220: implemented BHAB_GetVersionInfo()
 * 
 * Hydra_Software_Devel/2   7/13/12 1:56p enavarro
 * SWSATFE-174: formatting changes
 * 
 * Hydra_Software_Devel/1   7/11/12 4:03p enavarro
 * SWSATFE-174: initial check-in
 *
 ***************************************************************************/
#ifndef BHAB_4538_PRIV_H
#define BHAB_4538_PRIV_H
...
typedef struct BHAB_4538_P_CallbackInfo
{
   BHAB_IntCallbackFunc func;
   BHAB_4538_IrqStatus  callbackParams;
} BHAB_4538_P_CallbackInfo;


typedef struct BHAB_4538_P_Handle
{
    ...
    BHAB_4538_P_CallbackInfo callbackInfo;
} BHAB_4538_P_Handle;
...
BERR_Code BHAB_4538_P_ReadMemory(
...
BERR_Code BHAB_4538_P_WriteMemory(
...
BERR_Code BHAB_4538_P_WriteBbsi(
   BHAB_Handle h,    /* [in] BHAB PI Handle */
...
BERR_Code BHAB_4538_P_ReadBbsi(
   BHAB_Handle h,    /* [in] BHAB PI Handle */
   uint8_t     addr, /* [in] address */
...
BERR_Code BHAB_4538_P_ReadRbus(
   BHAB_Handle h,    /* [in] BHAB PI Handle */
...
BERR_Code BHAB_4538_P_WriteRbus(
   BHAB_Handle h,    /* [in] BHAB PI Handle */
   uint32_t    addr, /* [in] address */
...
BERR_Code BHAB_4538_P_ResetAp(
   BHAB_Handle h  /* [in] BHAB PI Handle */
);

BERR_Code BHAB_4538_P_GetVersionInfo(
    BHAB_Handle             handle,         /* [in]  BHAB handle */
