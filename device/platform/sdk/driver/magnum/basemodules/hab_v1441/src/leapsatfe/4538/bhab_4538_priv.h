...
typedef struct BHAB_4538_P_Handle
{
   ...
   BHAB_4538_P_CallbackInfo cbAst;   /* AST callback info */
   BHAB_4538_P_CallbackInfo cbWfe;   /* WFE callback info */
   BHAB_4538_P_CallbackInfo cbFsk;   /* FSK callback info */
} BHAB_4538_P_Handle;
