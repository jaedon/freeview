 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/int/7335/bint_7335.c $
 * 
 * Hydra_Software_Devel/18   10/5/12 11:13a mphillip
 * SW7425-3963: Merge interrupt changes to main
 * 
 * Hydra_Software_Devel/SW7425-3963/1   9/28/12 6:53p mphillip
 * SW7425-3963: Update interrupt handling with optimizations and support
 * for 'weak' interrupt masking
 * 
 * Hydra_Software_Devel/17   11/4/10 4:49p jrubio
 * SW7335-627: fix 7335 interrupt table, remove HIF
 * 
 * Hydra_Software_Devel/16   6/12/09 5:40p jrubio
 * PR55067: add GISB
 * 
 * Hydra_Software_Devel/15   1/29/09 11:11a gmullen
 * PR51198: Ported to 7335.
 * 
 * Hydra_Software_Devel/14   8/12/08 4:58p jrubio
 * PR45096: add Soft Modem
 * 
 * Hydra_Software_Devel/13   7/30/08 2:59p jrubio
 * PR43692: i- UART A/B, IRQ0 masking fix
 * 
 * Hydra_Software_Devel/12   5/14/08 8:01p jrubio
 * PR42640: enable uart c support
 * 
 * Hydra_Software_Devel/11   5/6/08 2:14p ronchan
 * PR 37881: removed support for 7335 A0
 * 
 * Hydra_Software_Devel/9   3/18/08 4:51p ronchan
 * PR37975: re-enabled ftm interrupt for A1
 * 
 * Hydra_Software_Devel/8   12/19/07 11:24a ronchan
 * PR37975: disabled FTM interrupt for A0 hardware bug, fixed sds1 rcvr 1
 * interrupt status register
 * 
 * Hydra_Software_Devel/7   12/14/07 6:06p ronchan
 * PR37975: re-enabled sds interrupts
 * 
 * Hydra_Software_Devel/6   12/11/07 4:33p katrep
 * PR37217: Updated the interrupt table
 * 
 * Hydra_Software_Devel/5   12/7/07 4:08p ronchan
 * PR37975: added support for sds interrupts
 * 
 * Hydra_Software_Devel/4   11/27/07 3:46p katrep
 * PR37217: Fixed compilation errors.
 * 
 * Hydra_Software_Devel/3   11/21/07 5:26p katrep
 * PR37217: Added more interrupts
 * 
 * Hydra_Software_Devel/2   11/21/07 4:36p katrep
 * PR37217: Updated standard L2 cases for 7335.
 * 
 * Hydra_Software_Devel/1   11/16/07 3:48p katrep
 * PR37217: Created place holder dirs for config spec
 ***************************************************************************/
#include "bstd.h"
#include "bint_7335.h"
