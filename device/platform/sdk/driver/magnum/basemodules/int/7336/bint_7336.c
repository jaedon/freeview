 ...
 *
 * $brcm_Workfile: bint_7336.c $
 * $brcm_Revision: Hydra_Software_Devel/3 $
 * $brcm_Date: 2/12/09 5:24p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/int/7336/bint_7336.c $
 * 
 * Hydra_Software_Devel/3   2/12/09 5:24p jrubio
 * PR51629: fix P3XD interrupt
 * 
 * Hydra_Software_Devel/2   2/9/09 11:18a jrubio
 * PR51629: add P3XD interrupt
 * 
 * Hydra_Software_Devel/1   1/27/09 9:25p tdo
...
BDBG_MODULE(interruptinterface_7336);
...
#define BINT_P_STANDARD_L2_CASES            \
   ...
   /* P3XD INTR*/                           \
   case BCHP_PX3D_INTR2_R5F_STATUS: 
...
static void BINT_P_7336_SetInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7336_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7336_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7336_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_7336_ReadMask( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t BINT_P_7336_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_7336[] =
{
    ...
    { BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_SUN_CPU_INTR_SHIFT,                 BCHP_SUN_L2_CPU_STATUS,                0xFFF0003F,          "SUN"},
    ...
    { BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_PX3D_CPU_INTR_SHIFT + 32,           BCHP_PX3D_INTR2_R5F_STATUS,            0,                   "PX3D_CPU"},
    ...
    { BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_FTM_CPU_INTR_SHIFT + 64,            BCHP_FTM_INTR2_CPU_STATUS,             0,                   "FTM"},
    ...
    { BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_SDS1_RCVR_1_CPU_INTR_SHIFT + 64,    BCHP_SDS_INTR2_1_1_CPU_STATUS,         0,                   "SDS1_RCVR_1"},
    { -1, 0, 0, NULL}
};

static const BINT_Settings bint_7336Settings =
{
    BINT_P_7336_SetInt,
    BINT_P_7336_ClearInt,
    BINT_P_7336_SetMask,
    BINT_P_7336_ClearMask,
    BINT_P_7336_ReadMask,
    BINT_P_7336_ReadStatus,
    bint_7336,
    "7336"
};
...
const BINT_Settings *BINT_7336_GetSettings( void )
{
    return &bint_7336Settings;
}
