 ...
 *
 * $brcm_Workfile: bint_7340.c $
 * $brcm_Revision: Hydra_Software_Devel/9 $
 * $brcm_Date: 6/6/11 9:32a $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/int/7340/bint_7340.c $
 * 
 * Hydra_Software_Devel/9   6/6/11 9:32a jrubio
 * SW7342-342: fix typo
 * 
 * Hydra_Software_Devel/8   6/3/11 11:41a jrubio
 * SW7342-342: add GISB timer
 * 
 * Hydra_Software_Devel/7   4/2/10 3:09p jrubio
 * SW7340-163: add MCIF interrupt
 * 
 * Hydra_Software_Devel/6   10/3/09 12:41a agin
 * SWNOOS-375: Fix compiler error due to hidden character.
 * 
 * Hydra_Software_Devel/5   8/25/09 6:45p jrubio
 * SW7340-10: disable HIF interrupt
 * 
 * Hydra_Software_Devel/4   8/12/09 6:05p jrubio
 * PR55882: fix interrupts
 * 
 * Hydra_Software_Devel/3   8/12/09 10:38a jrubio
 * PR55232: check in bint changes
 * 
 * Hydra_Software_Devel/2   8/11/09 12:38a jrubio
 * PR55882: initial impl of 7340
 * 
...
BDBG_MODULE(interruptinterface_7340);
...
static void BINT_P_7340_SetInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7340_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7340_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7340_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_7340_ReadMask( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t BINT_P_7340_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_7340[] =
{
    ...
    { BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_MC_CPU_INTR_SHIFT,     BCHP_MCIF_INTR2_CPU_STATUS,           0,                   "MCIF"},
    ...
    { BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_TFEC_CORE_CPU_INTR_SHIFT+64, 	BCHP_TFEC_INTR2_CPU_STATUS, 0 ,  "TFEC_0"},
...
static const BINT_Settings bint_7340Settings =
{
    BINT_P_7340_SetInt,
    BINT_P_7340_ClearInt,
    BINT_P_7340_SetMask,
    BINT_P_7340_ClearMask,
    BINT_P_7340_ReadMask,
    BINT_P_7340_ReadStatus, 
    bint_7340,
    "7340"
};
