 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/int/7346/bint_7346.c $
 * 
 * Hydra_Software_Devel/13   10/5/12 11:13a mphillip
 * SW7425-3963: Merge interrupt changes to main
 * 
 * Hydra_Software_Devel/SW7425-3963/1   9/24/12 6:21p mphillip
 * SW7425-3963: Update interrupt handling with optimizations and support
 * for 'weak' interrupt masking
 * 
 * Hydra_Software_Devel/12   3/14/12 12:53p jrubio
 * SW7346-644: add 4 more pcr's
 * 
 * Hydra_Software_Devel/11   2/27/12 11:13a agin
 * SWNOOS-518:  Create BICAP PI.
 * 
 * Hydra_Software_Devel/10   2/13/12 3:15p gmullen
 * SW7425-2376: Updated number of RAVE contexts
 * 
 * Hydra_Software_Devel/9   12/13/11 4:54p jrubio
 * SW7346-592: fix IRQ0 cases
 * 
 * Hydra_Software_Devel/8   12/12/11 2:45p jrubio
 * SW7231-506: disable SYS_PM. Kernel will enable it.
 * 
 * Hydra_Software_Devel/7   12/7/11 3:54p jrubio
 * SW7346-577: update int file to include 16 PB channels
 * 
 * Hydra_Software_Devel/6   9/28/11 4:30p ronchan
 * SW7346-426: updated UPG interrupt mask for B0
 * 
 * Hydra_Software_Devel/5   4/15/11 10:37a jrubio
 * SW7346-137: enable correct TMON bits
 * 
 * Hydra_Software_Devel/4   12/15/10 10:44a jrubio
 * SW7344-9: add pb3/pb4 interrupts
 * 
 * Hydra_Software_Devel/3   12/12/10 10:53p jrubio
 * SW7344-9:  add sds interrupts
 * 
 * Hydra_Software_Devel/3   12/11/10 2:48p ronchan
 * SW7344-9: added BCHP_XPT_PB3_INTR case
 * 
 * Hydra_Software_Devel/2   11/23/10 10:43a jrubio
 * SW7344-9: update bchp files
 * 
 * Hydra_Software_Devel/2   11/19/10 10:54a jrubio
 * SW7346-9: update bint
 * 
 * Hydra_Software_Devel/1   11/16/10 11:36a jrubio
 * SW7346-9: add 7346 support
 *
 *
 ***************************************************************************/
#include "bstd.h"
...
BDBG_MODULE(interruptinterface_7346);
...
static void BINT_P_7346_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7346_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7346_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_7346_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_7346[] =
{
...
static const BINT_Settings bint_7346Settings =
{
    NULL,
    BINT_P_7346_ClearInt,
    BINT_P_7346_SetMask,
    BINT_P_7346_ClearMask,
    NULL,
    BINT_P_7346_ReadStatus,
    bint_7346,
    "7346"
};
