 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/int/7358/bint_7358.c $
 * 
 * Hydra_Software_Devel/17   10/5/12 11:13a mphillip
 * SW7425-3963: Merge interrupt changes to main
 * 
 * Hydra_Software_Devel/SW7425-3963/1   9/20/12 7:18p mphillip
 * SW7425-3963: Update interrupt handling with optimizations and support
 * for 'weak' interrupt masking
 * 
 * Hydra_Software_Devel/16   9/3/12 12:57p bselva
 * SW7358-345: Enable HIF SPI interrupt only for 7218 platform.
 * 
 * Hydra_Software_Devel/15   8/24/12 4:17p vishk
 * SW7358-345: Merge changes to mainline. Change the channel indexing to
 * include spi core type.
 * 
 * Hydra_Software_Devel/SW7358-345/1   8/20/12 5:48p vishk
 * SW7358-345: Enable interrupts for HIF SPI.
 * 
 * Hydra_Software_Devel/14   1/12/12 4:24p bselva
 * SW7358-202: Added the changes required for UART A/B interrupt masking
 * 
 * Hydra_Software_Devel/13   12/14/11 3:56p bselva
 * SW7358-202: remove masked interrupts for Uart A/B
 * 
 * Hydra_Software_Devel/12   11/17/11 2:07p bselva
 * SW7358-193: Modified the code to disable BINT module processing
 * BCHP_AON_PM_L2_CPU_STATUS as this is taken care by kernel.
 * 
 * Hydra_Software_Devel/11   4/27/11 4:06p bselva
 * SW7358-39: Added the changes for 7358
 * 
 * Hydra_Software_Devel/10   1/12/11 3:10p pntruong
 * SW7358-3: update int table according to RDB change
 * 
 * Hydra_Software_Devel/10   1/12/11 3:09p pntruong
 * SW7358-3: update int table according to RDB change
 *
 * Hydra_Software_Devel/9   11/3/10 2:44p xhuang
 * SW7358-3: update int table according to RDB change
 *
 * Hydra_Software_Devel/8   10/29/10 10:58a xhuang
 * SW7358-3:update interrupt table by RDB change
 *
 * Hydra_Software_Devel/7   10/28/10 2:53p xhuang
 * SW7358-3:update interrupt table by RDB change
 *
 * Hydra_Software_Devel/6   10/28/10 11:10a xhuang
 * SW7358-3:update interrupt table by RDB change
 *
 * Hydra_Software_Devel/4   9/8/10 4:18p xhuang
 * SW7358-3: update according to RDB change
 *
 * Hydra_Software_Devel/3   8/19/10 5:42p xhuang
 * SW7358-3: Update interrupt table according to RDB change
 *
 * Hydra_Software_Devel/2   8/5/10 2:12p xhuang
 * SW7358-3: optimize code
 *
 * Hydra_Software_Devel/1   8/4/10 7:08p xhuang
...
static void BINT_P_7358_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7358_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7358_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_7358_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_7358[] =
{
    ...
    BINT_MAP_STD(0, HIF_SPI, HIF_SPI_INTR2_CPU),
#endif
...
static const BINT_Settings bint_7358Settings =
{
    NULL,
    BINT_P_7358_ClearInt,
    BINT_P_7358_SetMask,
    BINT_P_7358_ClearMask,
    NULL,
    BINT_P_7358_ReadStatus,
    bint_7358,
    "7358"
};
