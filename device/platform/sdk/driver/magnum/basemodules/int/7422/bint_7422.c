 ...
 *
 * $brcm_Workfile: bint_7422.c $
 * $brcm_Revision: Hydra_Software_Devel/9 $
 * $brcm_Date: 2/23/11 3:35p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/int/7422/bint_7422.c $
 * 
 * Hydra_Software_Devel/9   2/23/11 3:35p nickh
 * SW7422-285: Set correct masking bits for temperature monitor
 * 
 * Hydra_Software_Devel/8   1/6/11 4:35p nickh
...
BDBG_MODULE(interruptinterface_7422);
...
#define BINT_P_STANDARD_L2_CASES \
	...
	case BCHP_BVNF_INTR2_3_AVD1_STATUS: \
	case BCHP_BVNF_INTR2_4_AVD1_STATUS: \
...
static void BINT_P_7422_SetInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7422_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7422_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7422_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_7422_ReadMask( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t BINT_P_7422_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_7422[] =
{
	{ BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_MEMC1_CPU_INTR_SHIFT,           	BCHP_MEMC_L2_1_R5F_STATUS,             0,                   "MEMC1"},
	{ BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_MEMC0_CPU_INTR_SHIFT,           	BCHP_MEMC_L2_0_R5F_STATUS,             0,                   "MEMC0"},
	...
	{ BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_AVD1_0_CPU_INTR_SHIFT,         		BCHP_AVD_INTR2_1_CPU_STATUS, 	   	   0,                   "AVD1"},

	{ BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_AIO_CPU_INTR_SHIFT,         		BCHP_AIO_INTH_R5F_STATUS, 	   	   	   0,                   "AIO"},

	{ BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_UPG_AUX_CPU_INTR_SHIFT + 32,       	BCHP_UPG_AUX_INTR2_CPU_STATUS, 	   	   0xFFFFFE00,          "UPG_CTK"},
	{ BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_UPG_AUX_CPU_INTR_SHIFT + 32,       	BCHP_UPG_AUX_INTR2_CPU_STATUS, 	   	   0xFFFF9FFF,          "UPG_TMON"},
	...
	{ BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_UPG_BSC_AON_CPU_INTR_SHIFT + 32,  	BCHP_IRQ0_AON_IRQEN, 	   		   	   0xE7FFFFFF, 			"UPG_BSC_AON"},

	{ BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_UPG_MAIN_AON_CPU_INTR_SHIFT + 32,  	BCHP_IRQ0_AON_IRQEN, 	   		   	   0xFFFFFE1C, 			"UPG_MAIN_AON"},

	{ BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_UHF_CPU_INTR_SHIFT + 32,   			BCHP_UHFR_INTR2_CPU_STATUS, 	   	   0, 					"UHF"},
	...
	{ BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_SVD0_0_CPU_INTR_SHIFT + 32,    		BCHP_SVD_INTR2_0_CPU_STATUS, 	   	   0, 					"SVD0"},
    ...
    { BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_XPT_PCR_CPU_INTR_SHIFT + 64,  		BCHP_XPT_DPCR4_INTR_STATUS_REG,        0,                   "XPT_DPCR4"},
    { BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_XPT_PCR_CPU_INTR_SHIFT + 64,  		BCHP_XPT_DPCR5_INTR_STATUS_REG,        0,                   "XPT_DPCR5"},
    { BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_XPT_PCR_CPU_INTR_SHIFT + 64,  		BCHP_XPT_DPCR6_INTR_STATUS_REG,        0,                   "XPT_DPCR6"},
    { BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_XPT_PCR_CPU_INTR_SHIFT + 64,  		BCHP_XPT_DPCR7_INTR_STATUS_REG,        0,                   "XPT_DPCR7"},
...
static const BINT_Settings bint_7422Settings =
{
	BINT_P_7422_SetInt,
	BINT_P_7422_ClearInt,
	BINT_P_7422_SetMask,
	BINT_P_7422_ClearMask,
	BINT_P_7422_ReadMask,
	BINT_P_7422_ReadStatus,
	bint_7422,
	"7422"
};
...
const BINT_Settings *BINT_7422_GetSettings( void )
{
	return &bint_7422Settings;
}
