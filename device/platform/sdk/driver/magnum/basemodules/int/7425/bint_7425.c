 ...
 *
 * $brcm_Workfile: bint_7425.c $
 * $brcm_Revision: Hydra_Software_Devel/16 $
 * $brcm_Date: 10/12/12 6:41p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/int/7425/bint_7425.c $
 * 
 * Hydra_Software_Devel/16   10/12/12 6:41p syang
 * SW7346-572: change "VER" to "BCHP_VER" for version comparing
 * 
 * Hydra_Software_Devel/15   10/5/12 11:13a mphillip
 ...
 * 
 * Hydra_Software_Devel/14   9/17/12 1:16p hauxwell
 * SW7435-352 : Nexus interrupt map needs changing to remove programming
 * of V3D L2
 * 
 * Hydra_Software_Devel/13   4/30/12 2:01p jessem
 * SW7425-2896, SW7422-470: Added XPT PB 13, 14, and 15.
 *
 * Hydra_Software_Devel/12   4/18/12 11:05p agin
 * SWNOOS-518:  Support 7425.
 *
 * Hydra_Software_Devel/11   2/13/12 1:52p gmullen
 * SW7425-2376: Added support for RAVE contexts 24-47
 *
 * Hydra_Software_Devel/10   12/19/11 3:02p jessem
 * SW7425-2008: Updated per jira instructions except for bint_7425 table.
 *
 * Hydra_Software_Devel/9   12/14/11 1:27p jessem
 * SW7425-1942: Included UART B interrupt handling as default.
 *
 * Hydra_Software_Devel/8   9/13/11 12:12a hongtaoz
 * SW7425-1248: fixed V3D L1 bit mask for B0;
 *
 * Hydra_Software_Devel/7   9/12/11 7:46p hongtaoz
 * SW7425-1248: added new L2 interrupts for B0;
 *
 ***************************************************************************/
#include "bstd.h"
#include "bint_7425.h"
...
static const BINT_P_IntMap bint_7425[] =
{
    ...
    BINT_MAP(1, UPG_UART1, "", IRQ0_IRQEN, REGULAR, SOME, 0x20000),
    BINT_MAP(1, UPG_UART2, "", IRQ0_IRQEN, REGULAR, SOME, 0x40000),
#endif
