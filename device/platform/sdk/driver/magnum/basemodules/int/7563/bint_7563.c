 ...
 *
 * $brcm_Workfile: bint_7563.c $
 * $brcm_Revision: Hydra_Software_Devel/2 $
 * $brcm_Date: 7/23/12 3:21p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/int/7563/bint_7563.c $
 * 
 * Hydra_Software_Devel/2   7/23/12 3:21p randyjew
 * SW7563-2: Update includes
 * 
 * Hydra_Software_Devel/1   6/25/12 5:54p randyjew
 * SW7563-2: Initial version
 * 
 *
 ***************************************************************************/
#include "bstd.h"
...
BDBG_MODULE(interruptinterface_7563);
...
#define BINT_P_STANDARD_L2_CASES \
	...
	case BCHP_BVNF_INTR2_6_RAAGA0_STATUS: \
	case BCHP_BVNF_INTR2_6_RAAGA1_STATUS: \
	case BCHP_BVNF_INTR2_7_RAAGA0_STATUS: \
	case BCHP_BVNF_INTR2_7_RAAGA1_STATUS: \
	...
	case BCHP_LEAP_L2_CPU_STATUS: \
	case BCHP_M2MC_TOP_L2_CPU_STATUS: \
	case BCHP_MEMC_L2_0_R5F_STATUS: \
    case BCHP_MEMC_L2_1_0_R5F_STATUS: \
	case BCHP_RAAGA_DSP_INTH_HOST_STATUS: \
	case BCHP_RAAGA_DSP_FW_INTH_HOST_STATUS: \
	case BCHP_SUN_L2_CPU_STATUS: \
	case BCHP_T2_BICM_INTR2_0_CPU_STATUS: \
	case BCHP_T2_BICM_INTR2_1_CPU_STATUS: \
	case BCHP_T2_INTR_CPU_STATUS: \
	case BCHP_T2_INTR_OI_CPU_STATUS: \
...
static void BINT_P_7563_SetInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7563_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7563_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7563_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_7563_ReadMask( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t BINT_P_7563_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_7563[] =
{
	...
	{ BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_T2_BICM_0_CPU_INTR_SHIFT + 32,      BCHP_T2_BICM_INTR2_0_CPU_STATUS,       0, 					"T2_BICM_0"},
	{ BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_T2_BICM_1_CPU_INTR_SHIFT + 32,      BCHP_T2_BICM_INTR2_1_CPU_STATUS,       0, 					"T2_BICM_1"},
	{ BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_T2_RCVR_CPU_INTR_SHIFT + 32,        BCHP_T2_INTR_CPU_STATUS,               0, 					"T2_RCVR"},
	{  BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_T2_RCVR_OI_CPU_INTR_SHIFT + 32,    BCHP_T2_INTR_OI_CPU_STATUS,            0, 					"T2_RCVR_OI"},
...
/*	{ BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_XPT_RAV_CPU_INTR_SHIFT + 64,   		BCHP_XPT_RAVE_INT_MISC,                0,                   "RAV_MISC"},*/
	...
	/*{ BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_UFE_CPU_INTR_SHIFT  + 64,    		BCHP_UFE_MISC2_INTR2_STATUS, 	   	   0,                   "UFE"},*/
	{ BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_LEAP_CPU_INTR_SHIFT + 64,    		BCHP_LEAP_HOST_L2_CPU_STATUS, 	   	   0,                   "LEAP_HOST"},
	{ BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_LEAP_CPU_INTR_SHIFT + 64,    		BCHP_LEAP_L2_CPU_STATUS, 	   	   0,                   "LEAP"},
	{ -1, 0, 0, NULL}
};

static const BINT_Settings bint_7563Settings =
{
	BINT_P_7563_SetInt,
	BINT_P_7563_ClearInt,
	BINT_P_7563_SetMask,
	BINT_P_7563_ClearMask,
	BINT_P_7563_ReadMask,
	BINT_P_7563_ReadStatus,
	bint_7563,
	"7563"
};
