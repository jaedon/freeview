 ...
 *
 * $brcm_Workfile: bint_7601.c $
 * $brcm_Revision: Hydra_Software_Devel/3 $
 * $brcm_Date: 9/12/08 5:20p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/int/7601/bint_7601.c $
 * 
 * Hydra_Software_Devel/3   9/12/08 5:20p pntruong
 * PR33842: Merged from bringup.
 * 
 * Hydra_Software_Devel/BCM7601_bringup_temp/3   8/26/08 9:50a fbasso
 * PR 33842: clean up.
 *
 * Hydra_Software_Devel/BCM7601_bringup_temp/2   8/11/08 10:49a fbasso
 * Clean up code
 *
 * Hydra_Software_Devel/BCM7601_bringup_temp/1   8/9/08 4:58p fbasso
 * Bring up stage 0
 *
...
BDBG_MODULE(interruptinterface_7601);
...
static void BINT_P_7601_SetInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7601_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7601_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7601_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_7601_ReadMask( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t BINT_P_7601_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_7601A0[] =
{
...
static const BINT_Settings bint_7601Settings =
{
	BINT_P_7601_SetInt,
	BINT_P_7601_ClearInt,
	BINT_P_7601_SetMask,
	BINT_P_7601_ClearMask,
	BINT_P_7601_ReadMask,
	BINT_P_7601_ReadStatus,
	bint_7601A0,
	"7601"
};
