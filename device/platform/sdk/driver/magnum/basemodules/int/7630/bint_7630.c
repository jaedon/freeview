 ...
 *
 * $brcm_Workfile: bint_7630.c $
 * $brcm_Revision: Hydra_Software_Devel/1 $
 * $brcm_Date: 12/3/10 12:52p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/int/7630/bint_7630.c $
 * 
...
BDBG_MODULE(interruptinterface_7630);
...
#define BINT_P_STANDARD_L2_CASES_BASE \
    ...
    /*case BCHP_SHIFT_INTR2_CPU_STATUS:*/   
#else
#define BINT_P_STANDARD_L2_CASES_BASE \
	case BCHP_AIO_INTH_R5F_STATUS: \
	case BCHP_AUD_DSP_INTH0_R5F_STATUS: \
...
static void BINT_P_7630_SetInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7630_ClearInt( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7630_SetMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static void BINT_P_7630_ClearMask( BREG_Handle regHandle, uint32_t baseAddr, int shift );
static uint32_t BINT_P_7630_ReadMask( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t BINT_P_7630_ReadStatus( BREG_Handle regHandle, uint32_t baseAddr );
static uint32_t GetRaveIntEnableOffset( uint32_t BaseAddr );

static const BINT_P_IntMap bint_7630A0[] =
{
...
#endif
#if 0
    { BCHP_XPT_MSG_BUF_DAT_RDY_INTR_00_31_INTR_FLAG_SHIFT,                  BCHP_XPT_MSG_BUF_DAT_RDY_INTR_00_31,   0xffffffff,          "XPT_DATA_RDY" },
    { BCHP_XPT_MSG_BUF_OVFL_INTR_00_31_INTR_FLAG_SHIFT,                     BCHP_XPT_MSG_BUF_OVFL_INTR_00_31,      0xffffffff,          "XPT_BUF_OVFL" },
#endif
	...
	{ BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_HIF_CPU_INTR_SHIFT,           		BCHP_HIF_INTR2_CPU_STATUS,             0xffffe03f,          "HIF"},
	...
	//{ BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_SHIFT_CPU_INTR_SHIFT + 32,          BCHP_SHIFT_INTR2_CPU_STATUS,           0xFFFFFF80,          "SHIFT" },
...
static const BINT_Settings bint_7630Settings =
{
	BINT_P_7630_SetInt,
	BINT_P_7630_ClearInt,
	BINT_P_7630_SetMask,
	BINT_P_7630_ClearMask,
	BINT_P_7630_ReadMask,
	BINT_P_7630_ReadStatus,
	bint_7630A0,
	"7630"
};
...
const BINT_Settings *BINT_7630_GetSettings( void )
{
	return &bint_7630Settings;
}
