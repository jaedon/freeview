 ...
 * $brcm_Date: 12/22/09 5:51p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/kni/bkernel/bkni.h $
 * 
 * Hydra_Software_Devel/3   12/22/09 5:51p vsilyaev
 * SW7408-17: Enable tracking of malloc usage
 * 
 * Hydra_Software_Devel/2   12/22/09 12:34p vsilyaev
...
Returns:
	...
	depend on this result.
****************************************************************************/
#define BKNI_Vsnprintf vsnprintf
...
#define BKNI_Memset_isr memset
#define BKNI_Memcpy_isr memcpy
#define BKNI_Memcmp_isr memcmp
#define BKNI_Memchr_isr BKNI_Memchr
#define BKNI_Memmove_isr memmove
