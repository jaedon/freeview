 ...
 * $brcm_Date: 7/27/12 7:06p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/kni/linuxuser/bkni_metrics.h $
 * 
 * Hydra_Software_Devel/2   7/27/12 7:06p vsilyaev
...
#define BKNI_P_Stats_Print BKNI_P_Stats_Print 
