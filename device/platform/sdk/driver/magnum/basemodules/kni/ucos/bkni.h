 ...
 * $brcm_Date: 1/19/09 1:56p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/kni/ucos/bkni.h $
 * 
 * Hydra_Software_Devel/4   1/19/09 1:56p cnovak
 * PR32280: Add BKNI_ASSERT_ISR_CONTEXT functionality, merged from other
 * OS ports.
 * 
 * Hydra_Software_Devel/3   6/19/08 4:32p cnovak
 * PR43697: Clean up uCOS port and move back to Hyrdra branch.
 * 
 * Hydra_Software_Devel/2   2/4/05 6:21p cnovak
 * PR 12841: Add includes bkni_multi and bkni_ucos so modules don't have
 * to.
 * 
 * Hydra_Software_Devel/1   1/31/05 5:52p cnovak
 * PR 12841: Copied from ../generic directory, revision 29.
 * 
 ***************************************************************************/
#ifndef BKNI_H__
#define BKNI_H__
...
/**
BKNI_TRACK_MALLOCS is a simple way to track BKNI_Malloc
memory leaks and bad BKNI_Frees.
**/
