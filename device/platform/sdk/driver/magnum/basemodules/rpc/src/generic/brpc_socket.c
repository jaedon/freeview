 ...
 * $brcm_Date: 5/7/09 2:46p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/rpc/generic/brpc_socket.c $
 * 
 * Hydra_Software_Devel/9   5/7/09 2:46p anilmm
 * PR54891:  Include bkni_multi.h for multithread application
 * 
 * Hydra_Software_Devel/8   11/24/08 2:54p haisongw
 * PR49628:BRPC_Open_SocketImp() should free *handle NOT handle in case of
 * error
 * 
 * Hydra_Software_Devel/7   10/13/08 5:01p haisongw
 * PR47724: Xid mismatch in case of very slow host response
 *
 * Hydra_Software_Devel/6   10/9/08 4:39p anilmm
 * PR47753:  ISO C89 does not recognize inline keyword
 *
 * Hydra_Software_Devel/5   5/23/07 5:43p mward
 * PR30879:  Was allocating size of pointer to structure, not structure.
 *
 * Hydra_Software_Devel/4   4/12/07 5:24p haisongw
 * PR29783: Add run-time flag to run Trinity/Brutus without 3255
 *
 * Hydra_Software_Devel/3   11/21/06 4:06p haisongw
