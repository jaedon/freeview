 ...
 * $brcm_Date: 3/28/12 5:54p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/rpc/linuxuser/brpc_socket.c $
 * 
 * Hydra_Software_Devel/12   3/28/12 5:54p nickh
 * SW7425-2774: Bind to local private IP address
 * 
 * Hydra_Software_Devel/11   12/1/09 11:02a jowo
 * SW7420-328: fix compiler warnings
 * 
 * Hydra_Software_Devel/10   5/7/09 2:49p anilmm
 ...
 * error
 *
 * Hydra_Software_Devel/8   10/13/08 5:00p haisongw
 * PR47724: Xid mismatch in case of very slow host response
 *
 * Hydra_Software_Devel/7   10/9/08 4:35p anilmm
