 ...
 * $brcm_Date: 1/18/06 12:05p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/std/types/generic/bstd_defs.h $
 * 
 * Hydra_Software_Devel/8   1/18/06 12:05p rjlewis
 * PR19044: new compiler in vxworks 6 defines bool to be uchar.
 * 
...
/*****************************************************************************/
  ...
  #include <stdbool.h>
      ...
      #define bool BRCM_BOOL
        ...
        #if defined(__vxworks) && defined(__GNUC__) && (__GNUC__ >= 3)
          #define bool unsigned char
        #else
          #define bool unsigned int
        #endif
