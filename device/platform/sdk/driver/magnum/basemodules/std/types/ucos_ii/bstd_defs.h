 ...
 * $brcm_Date: 10/1/10 11:06a $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/std/types/ucos_ii/bstd_defs.h $
 * 
 * Hydra_Software_Devel/2   10/1/10 11:06a lruan
 * sw7572-104: add uintptr_t for UCOS_II for fixing release build error
 * 
 * Hydra_Software_Devel/1   7/20/10 3:16p jfisher
 * SW7572-30:  Add ucos_ii support.
 * 
 * Hydra_Software_Devel/6   9/26/07 8:53a cnovak
 * PR35368: For standard C compile, modify the bool data type to be uchar
 * instead of uint.
 * 
 * Hydra_Software_Devel/5   5/18/06 11:15a cnovak
 * PR21065: Move BDBG_Lock/Unlock into DBG
 * 
 * Hydra_Software_Devel/4   2/10/05 11:27a garylin
 * PR14085: fix compile fail for BSL SDE5
 * 
 * Hydra_Software_Devel/3   2/1/05 2:59p cnovak
 * PR 12841: Correction to previous check-in comments -- we can't use a
 * mutex because LOCK/UNLOCK can get called from an ISR context.
 * 
 * Hydra_Software_Devel/2   2/1/05 2:15p cnovak
 * PR 12841: Override BDBG_LOCK/UNLOCK - uC/OS port can not use a mutex.
 * 
 * Hydra_Software_Devel/1   9/28/04 5:39p cnovak
 * PR12841: Initial Revision for uCos
 * 
 ***************************************************************************/
