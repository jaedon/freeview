 ...
 * $brcm_Date: 11/11/10 3:16p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/test/wince/btst_kni.c $
 * 
 * Hydra_Software_Devel/1   11/11/10 3:16p rrlee
 * SW7405-4959: Add wince module to magnum
 * 
 * Hydra_Software_Devel/1   11/11/10 11:06a rrlee
 * SW7405-4959: Add wince module to magnum
 * 
