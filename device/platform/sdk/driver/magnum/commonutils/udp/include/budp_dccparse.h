 ...
 * $brcm_Date: 10/28/10 3:58p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/commonutils/udp/budp_dccparse.h $
 * 
...
/*****************************************************************************
  ...
  Description:
    ...
    format for DSS bitstreams that are AVC MPEG-4.  The userdata
    occurs in the NAL.
