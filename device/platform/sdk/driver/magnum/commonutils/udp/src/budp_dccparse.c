 ...
 * $brcm_Date: 12/15/11 12:07a $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/commonutils/udp/budp_dccparse.c $
 * 
...
typedef enum {
	...
	ParserType_eSEI       /* DSS userdata, AVC flavor (SEI). */
} ParserType;
...
/* The array of digital CC data parsers.  It does not include the DSS parser.
 * The DSS parser must be handled as a special case.  This is because this
 * software collection cannot discover on its own that it is dealing with DSS 
