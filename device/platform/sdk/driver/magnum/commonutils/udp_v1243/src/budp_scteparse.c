 ...
 * $brcm_Date: 1/10/13 1:34p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/commonutils/udp/src/budp_scteparse.c $
 * 
 * Hydra_Software_Devel/4   1/10/13 1:34p darnstein
 * SW7346-1160: fix mechanical error in parser. Found by customer.
 * 
