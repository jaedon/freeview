 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ads/src/8051/3112/bads_3112.c $
 * 
 ...
 * directory structure
 * 
 * Hydra_Software_Devel/16   2/8/12 5:59p atanugul
 * SW3128-119: Add initializers for for SetAcquireParams, GetAcquireParams
 * and PowerUp
 * 
 * Hydra_Software_Devel/15   12/8/11 3:30p atanugul
 * SW3128-89: Add Initializer for ADS_RequestSpectrumAnalyzerData  and
 * BADS_GetSpectrumAnalyzerData
 * 
 * Hydra_Software_Devel/14   9/15/11 3:29p atanugul
 * SW3128-50: Initializer fot BADS_GetScanStatus()
 * 
 * Hydra_Software_Devel/13   8/31/11 7:21p nickh
 * SW7425-1129: Add stub function
 * 
 * Hydra_Software_Devel/12   5/16/11 2:05p farshidf
 * SWDTV-6857: add the Scan calls
 * 
 * Hydra_Software_Devel/12   5/16/11 2:01p farshidf
 * SWDTV-6857: add the Scan calls
 * 
 * Hydra_Software_Devel/11   11/24/10 7:58p agin
 * SW7405-5021:  Allow 7405 host to control LNA via 31xx tuner/demod
 * chips.
 * 
 * Hydra_Software_Devel/10   10/21/10 6:54p vishk
 * SW7420-1020: Request for non-blocking call support in Nexus frontend
 * 
 * Hydra_Software_Devel/9   10/5/10 7:25p VISHK
