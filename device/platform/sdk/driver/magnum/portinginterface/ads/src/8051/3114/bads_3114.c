 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ads/src/8051/3114/bads_3114.c $
 * 
 ...
 * chips.
 * 
 * Hydra_Software_Devel/9   10/21/10 6:54p vishk
 ...
 * 
 * Hydra_Software_Devel/7   8/30/10 3:33p farshidf
 * SW7550-543: update the function table
 * 
 * Hydra_Software_Devel/6   2/11/10 11:08a farshidf
 * SW7550-262: make the API function compatible with 7550
 * 
 * Hydra_Software_Devel/5   11/24/09 4:47p farshidf
 * SW7550-38: set the new param for 7550 to NULL
 * 
 * Hydra_Software_Devel/4   11/5/09 1:51p VISHK
 ...
 * 
 * Hydra_Software_Devel/2   3/10/09 3:48p vishk
