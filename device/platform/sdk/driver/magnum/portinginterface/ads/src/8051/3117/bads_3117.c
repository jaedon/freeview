 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ads/src/8051/3117/bads_3117.c $
 * 
 * Hydra_Software_Devel/2   9/28/12 2:16p atanugul
 * SW3128-228: Add support for  BADS_GetVersionInfo()
 * 
 * Hydra_Software_Devel/1   6/21/12 3:35p vishk
 ...
 * 
 * Hydra_Software_Devel/15   8/31/11 7:26p nickh
 * SW7425-1129: Add stub function
 * 
 * Hydra_Software_Devel/14   5/16/11 2:01p farshidf
 * SWDTV-6857: add the Scan calls
 * 
 * Hydra_Software_Devel/13   11/24/10 7:58p agin
 * SW7405-5021:  Allow 7405 host to control LNA via 31xx tuner/demod
 * chips.
 * 
 * Hydra_Software_Devel/12   10/21/10 6:54p vishk
 * SW7420-1020: Request for non-blocking call support in Nexus frontend
 * 
 * Hydra_Software_Devel/11   10/5/10 7:25p VISHK
 ...
 * 
 * Hydra_Software_Devel/10   8/30/10 3:39p farshidf
 * SW7550-543: update the function table
 * 
 * Hydra_Software_Devel/9   2/11/10 11:06a farshidf
 * SW7550-262: make the API function compatible with 7550
 * 
 * Hydra_Software_Devel/8   11/24/09 4:56p farshidf
 * SW7550-38: set the 7550 Param to Null
 * 
 * Hydra_Software_Devel/7   11/5/09 1:49p VISHK
 * SW7405-3210: BADS_31xx_GetStatus not returning values for
 * correctedCount, uncorrectedCount and berRawCount
 * 
 * Hydra_Software_Devel/6   9/14/09 2:29p vishk
 ...
 * 
 * Hydra_Software_Devel/5   8/25/09 12:13p vishk
 * SW7405-2839: Bcm31xx: Add Power Management support for ADS
 * 
 * Hydra_Software_Devel/4   8/21/09 6:21p vishk
 * PR 57482: Bcm31xx: Add Power Management support for ADS
 * 
 * Hydra_Software_Devel/3   3/10/09 3:46p vishk
