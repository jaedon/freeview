 ...
 *
 * $brcm_Workfile: bads_7550_acquire.h $
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ads/src/soc/7550/bads_7550_acquire.h $
 * 
 * Hydra_Software_Devel/1   6/22/12 12:47p farshidf
 * SW7425-2983: add 7550 ADS code
 * 
 * Hydra_Software_Devel/14   10/29/10 1:24p farshidf
 * SW7550-607: merge charlie's changes
 * 
 * Hydra_Software_Devel/ADS_7550_40_11/2   10/29/10 12:43p cbrooks
 * removed debug code
 * 
 * Hydra_Software_Devel/ADS_7550_40_11/1   10/28/10 3:02p cbrooks
 ...
 * added DPM
 * 
 * Hydra_Software_Devel/11   4/14/10 4:50p farshidf
 ...
 * Fast Acquire
 * 
 * Hydra_Software_Devel/9   4/5/10 5:09p farshidf
 * SW7550-38: check-in charlie's changes
 * 
 * Hydra_Software_Devel/6   3/19/10 3:42p farshidf
 ...
 * 
 * Hydra_Software_Devel/5   2/12/10 4:06p farshidf
 * SW7550-38: move out  the static table
 * 
 * Hydra_Software_Devel/4   1/8/10 4:50p farshidf
 * SW7550-38: merge ADs branch 6
 * 
 * Hydra_Software_Devel/ADS_7550_40_6/1   1/5/10 5:48p cbrooks
 * Assed PI Status
 * 
 * Hydra_Software_Devel/3   1/5/10 1:02p farshidf
...
#ifndef _BADS_7550_ACQUIRE_H__
#define _BADS_7550_ACQUIRE__H__           

#ifdef __cplusplus
extern "C" {
#endif

/*DPM Tone locations used by bads_7550_dpm()*/
/*The DPM is called by the tuner*/
#define ANNEXA_DPM_TONE 3970588
#define ANNEXB_DPM_TONE 3000000

#define SNR_LEAKY_AVG 512



/*Lock Detector Values*/
/*Every 25 mS the PI calles the BADS_Soc_P_Get_LockStatus function*/
...
#define MAX_TIMING_OFFSET_FOR_LOCK 5000

/*Inital Values for BADS_7550_P_AcquireParams_t Structure*/
/*These values can also be overwriten by BBS*/
/*BBS needs everything passed as uint32_t*/
#define BBS_ACQWORD0 0		  /*unused*/
#define BBS_ACQWORD1 0			/*unused*/
#define BBS_ACQWORD2 0			/*unused*/
#define BBS_ACQWORD3 0			/*unused*/
#define RERUN_INIT 0				/*0 NoRerun, 1 ReRun*/
#define BURST_MODE 1				/*0 off, 1 on*/
...
static const uint16_t FrequencyLoopBurstModeCoeffs_TBL[NUM_BAUD_RATES] =
{
0x2521,
0x2521,
0x2521,
...
static const uint32_t PhaseLoopTrkBurstModeCoeffs_TBL[NUM_BAUD_RATES] =
{
0xF9C0EC6C,
0xFA78F0AB,
0xFB1BF3FE,
...
{
	{0x004A0000, 0xFF800620, 0x08050031, 0x0000002F, 0x0000006A},	/* Annex A 16QAM*/
	{0x004A0000, 0xFF800620, 0x08050041, 0x000000EB, 0x00000179},	/* Annex A 32QAM*/
	{0x004A0000, 0xFF800620, 0x08050051, 0x0000002F, 0x00000037},	/* Annex A 64QAM*/
	{0x004A0000, 0xFF800620, 0x08050061, 0x00000149, 0x0000011B},	/* Annex A 128QAM*/
	{0x004A0000, 0xFF800620, 0x08050071, 0x0000005E, 0x0000003B},	/* Annex A 256QAM*/
	{0x004A0000, 0xFF800620, 0x08050081, 0x0000002F, 0x00000015},	/* Annex A 512QAM*/
	{0x004A0000, 0xFF800620, 0x08050091, 0x000000EB, 0x00000047},	/* Annex A 1024QAM*/
...
static const FEC_t AnnexB_FEC_TBL[NUM_QAM_MODES] =
{
	...
	{0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000},	/* Annex A 512QAM unsupported*/
...
/*Main functions used in bads_7550_acquire.c*/
void BADS_7550_P_ProgramFilters(BADS_ChannelHandle); 
void BADS_7550_P_ProgramFEC(BADS_ChannelHandle);
MVAR_t BADS_7500_P_Get_MVAR(BADS_ChannelHandle);
uint32_t BADS_7500_P_SLEEP(BADS_ChannelHandle, uint8_t, uint32_t);
void BADS_7550_P_AcquisitionPercentageTest(BADS_ChannelHandle);


/*Main functions used in bads_7550_status.c*/

/*Utility functions bads_7550_utils.c*/
void BADS_7550_P_ADS_Init_Buffer(BADS_Soc_ChannelHandle);
void BADS_7550_P_Range_Check(BADS_Soc_ChannelHandle);
uint32_t BADS_7550_P_2560log10(uint32_t);

void BADS_7550_P_Set_SymbolRate(BADS_ChannelHandle, uint32_t);
void BADS_7550_P_Set_TimingFrequency(BADS_ChannelHandle, uint32_t, uint32_t, uint8_t, uint8_t);
void BADS_7550_P_Set_IfFrequency(BADS_ChannelHandle, uint32_t, uint32_t);
void BADS_7550_P_Set_IfIntegrator(BADS_ChannelHandle, int32_t, uint32_t);

uint32_t BADS_75xx_P_Get_SampleRate(BADS_ChannelHandle);
uint8_t BADS_75xx_P_Get_ARFFactor(BADS_ChannelHandle);
uint8_t  BADS_75xx_P_Get_FilterFactor(BADS_ChannelHandle);
uint32_t BADS_7550_P_Get_SymbolRate(BADS_ChannelHandle, uint8_t, uint8_t, uint32_t);
int32_t BADS_7550_P_Get_IfFrequency(BADS_ChannelHandle, uint32_t, uint8_t);
int32_t BADS_75xx_P_Get_VIDTimingError(BADS_ChannelHandle, uint8_t, uint8_t, uint32_t);
int32_t BADS_75xx_P_Get_CarrierFrequencyError(BADS_ChannelHandle, uint32_t);
int32_t BADS_75xx_P_Get_CarrierPhaseError(BADS_ChannelHandle, uint32_t);
...
#endif /* _BADS_7550_ACQUIRE_PRIV_H__ */
