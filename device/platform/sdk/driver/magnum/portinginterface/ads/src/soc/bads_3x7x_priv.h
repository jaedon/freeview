 ...
 *  ANY LIMITED REMEDY.
 * 
 * $brcm_Workfile: bads_3x7x_priv.h $
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ads/src/soc/bads_3x7x_priv.h $
 * 
 * Hydra_Software_Devel/4   9/21/12 4:09p farshidf
 * SW7552-360: Add BADS_3x7x_SetAcquireParams for 7552
 * 
 * Hydra_Software_Devel/3   9/5/12 11:57a farshidf
 * SW3128-213: changes due to new ADS verion 5.6
 * 
 * Hydra_Software_Devel/2   8/9/12 4:59p farshidf
 ...
 * 
 * Hydra_Software_Devel/5   6/14/12 5:25p farshidf
 * SW7552-289: Add SPUR_TBL for DS
 * 
 * Hydra_Software_Devel/4   3/29/12 8:46p farshidf
 * SW7552-239: fix the power
 * 
 * Hydra_Software_Devel/3   12/22/11 4:49p farshidf
 * SW7552-170: add scanstatus calls
 * 
 * Hydra_Software_Devel/2   11/16/11 6:05p atanugul
