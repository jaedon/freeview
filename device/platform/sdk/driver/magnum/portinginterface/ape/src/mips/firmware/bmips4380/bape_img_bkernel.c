...
*
* $brcm_Workfile: bape_img_bkernel.c $
...
* Revision History:
*
* $brcm_Log: /magnum/portinginterface/ape/7408/image/bape_img_bkernel.c $
* 
...
#include "bape_img_bkernel_be.h"
#elif BSTD_CPU_ENDIAN==BSTD_ENDIAN_LITTLE
#include "bape_img_bkernel_le.h"
#else
#error "Not supported"
#endif
