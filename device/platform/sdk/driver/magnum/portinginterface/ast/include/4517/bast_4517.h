 ...
 * $brcm_Date: 9/6/12 3:18p $
 *
 * [File Description:]
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ast/4517/bast_4517.h $
 * 
 * Hydra_Software_Devel/13   9/6/12 3:18p ronchan
 * SWSATFE-207: add tuner agc config parameters
 * 
 * Hydra_Software_Devel/12   7/24/12 10:03a enavarro
 * SWSATFE-140: update MISC_CTL config param
 * 
 * Hydra_Software_Devel/11   3/16/12 4:21p enavarro
 * SWSATFE-140: added reacq_cause config parameter
 * 
 * Hydra_Software_Devel/10   3/6/12 3:36p enavarro
 * SWSATFE-140: fixed compiler error under win32
 * 
 * Hydra_Software_Devel/9   2/15/12 4:27p ronchan
 * SWSATFE-140: add functions for tuner indirect register access
 * 
 * Hydra_Software_Devel/8   2/8/12 11:07a enavarro
 * SWSATFE-140: added hab_max_time and hab_max_time_cmd config params
 * 
 * Hydra_Software_Devel/7   1/24/12 2:39p enavarro
 * SWSATFE-140: removed BAST_4517_ConfigXbert()
 * 
 * Hydra_Software_Devel/6   1/24/12 9:48a enavarro
 * SWSATFE-140: added BAST_4517_ReadBsc()
 * 
 * Hydra_Software_Devel/5   1/19/12 11:37a enavarro
 * SWSATFE-140: added BAST_4517_WriteBsc()
 * 
 * Hydra_Software_Devel/4   1/13/12 3:33p enavarro
 * SWSATFE-140: added BAST_4517_GetTunerStatus()
 * 
 * Hydra_Software_Devel/3   1/13/12 10:46a enavarro
 * SWSATFE-140: added G3 config params
 * 
 * Hydra_Software_Devel/2   1/6/12 9:16a enavarro
 * SWSATFE-140: added config params
 * 
