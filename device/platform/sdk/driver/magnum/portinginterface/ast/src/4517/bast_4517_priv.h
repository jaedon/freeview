 ...
 *
 * $brcm_Workfile: bast_4517_priv.h $
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ast/src/4517/bast_4517_priv.h $
 * 
 * Hydra_Software_Devel/8   10/16/12 9:20a enavarro
 * SWSATFE-220: add BAST_GetVersionInfo()
 * 
 * Hydra_Software_Devel/7   7/24/12 10:04a enavarro
 * SWSATFE-140: removed duplicate definitions
 * 
 * Hydra_Software_Devel/6   2/1/12 2:41p enavarro
 * SWSATFE-140: added BAST_4517_P_GetTunerLnaStatus()
 * 
 * Hydra_Software_Devel/5   1/11/12 4:01p ronchan
 * SWSATFE-140: add fsk rx ready host interrupt bit and event
 * 
 * Hydra_Software_Devel/4   1/9/12 10:22a enavarro
 * SWSATFE-140: added BAST_4517_P_GetFskEventHandle()
 * 
 * Hydra_Software_Devel/3   1/6/12 4:41p enavarro
 * SWSATFE-140: added implementation for BAST_TunerConfigLna()
 * 
 * Hydra_Software_Devel/2   10/25/11 11:18a enavarro
 * SWSATFE-140: added function declarations
 * 
