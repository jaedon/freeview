 ...
 *
 * $brcm_Workfile: bast_7322_priv.c $
 * $brcm_Revision: Hydra_Software_Devel/3 $
 * $brcm_Date: 9/6/12 6:20p $
 *
 * [File Description:]
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ast/src/g2/7322/bast_7322_priv.c $
 * 
 * Hydra_Software_Devel/3   9/6/12 6:20p ronchan
 * SWSATFE-214: rename 73xx to g2
 * 
 * Hydra_Software_Devel/2   10/26/09 11:07a enavarro
...
#include "bast_7322_priv.h"


BDBG_MODULE(bast_7322);
