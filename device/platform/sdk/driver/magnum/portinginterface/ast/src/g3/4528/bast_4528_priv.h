 ...
 * $brcm_Date: 4/20/12 3:13p $
 *
 * [File Description:]
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ast/g3/4528/bast_4528.h $
 * 
 * Hydra_Software_Devel/16   4/20/12 3:13p ronchan
 * SWSATFE-75: add diseqc almost empty interrupt
 * 
 * Hydra_Software_Devel/15   7/28/11 10:46a mathew
 * SWSATFE-86: Updated the diseqc timer mapping for 4528
 * 
 * Hydra_Software_Devel/14   7/13/11 2:24p enavarro
 * SWSATFE-86: added BAST_4528_SetSampleFreq()
 * 
 * Hydra_Software_Devel/13   6/20/11 2:48p enavarro
 * SWSATFE-86: use combo AFEC/HP/BERT lock/unlock interrupts for AFEC
 * lock/unlock callbacks
 * 
 * Hydra_Software_Devel/12   6/16/11 11:32a enavarro
 * SWSATFE-127: added HP frame boundary interrupts
 * 
 * Hydra_Software_Devel/11   6/9/11 8:58a enavarro
 * SWSATFE-86: added comments
 * 
 * Hydra_Software_Devel/10   6/3/11 4:28p enavarro
 * SWSATFE-86: defined BCHP_SDS_OI_OIFCTL01_loop_en
 * 
 * Hydra_Software_Devel/9   6/3/11 1:19p enavarro
 * SWSATFE-86: fixed compiler error
 * 
 * Hydra_Software_Devel/8   5/25/11 6:24p enavarro
 * SWSATFE-86: added BAST_ADC_FREQ_KHZ
 * 
 * Hydra_Software_Devel/7   5/12/11 2:12p enavarro
 * SWSATFE-86: updated default sample freq
 * 
 * Hydra_Software_Devel/6   4/11/11 2:10p enavarro
 * SWSATFE-86: renamed BAST_4528_INT_ID_CREATE macro to
 * BAST_LEAP_INT_ID_CREATE
 * 
 * Hydra_Software_Devel/5   4/1/11 9:04a enavarro
 * SWSATFE-86: defined BAST_DEFAULT_SAMPLE_FREQ
 * 
 * Hydra_Software_Devel/4   3/21/11 7:01a enavarro
 * SWSATFE-86: updated interrupt IDs
 * 
 * Hydra_Software_Devel/3   3/4/11 3:44p enavarro
 * SWSATFE-86: fixed compiler errors
 * 
 * Hydra_Software_Devel/2   3/4/11 8:13a enavarro
 * SWSATFE-75: ongoing development
 * 
 * Hydra_Software_Devel/1   3/2/11 11:34a enavarro
