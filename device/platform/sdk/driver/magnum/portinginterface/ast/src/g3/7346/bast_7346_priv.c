 ...
 *
 * $brcm_Workfile: bast_7346_priv.c $
 * $brcm_Revision: Hydra_Software_Devel/19 $
 * $brcm_Date: 9/7/12 9:59a $
 *
 * [File Description:]
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ast/src/g3/7346/bast_7346_priv.c $
 * 
 * Hydra_Software_Devel/19   9/7/12 9:59a ronchan
 * SWSATFE-214: renamed debug module identifier
 * 
 * Hydra_Software_Devel/18   9/7/12 9:54a ronchan
 * SWSATFE-214: renamed chip header file
 * 
 * Hydra_Software_Devel/17   9/6/12 10:42a ronchan
 * SWSATFE-75: fix isr context violation in write register for < 8Mb
 * 
 * Hydra_Software_Devel/16   5/4/12 9:47a enavarro
 * SWSATFE-157: dont verify the register write for EQ_LUPD in
 * BAST_g3_P_WriteRegister()
 * 
 * Hydra_Software_Devel/15   4/20/12 2:52p ronchan
 * SWSATFE-75: add diseqc almost empty interrupt
 * 
 * Hydra_Software_Devel/14   11/30/11 3:43p enavarro
 * SWSATFE-157: fix compiler warning
 * 
 * Hydra_Software_Devel/13   11/30/11 2:48p enavarro
 * SWSATFE-157: use common function, BAST_g3_P_GetRegisterWriteWaitTime(),
 * to determine if register is in baud clock domain
 * 
 * Hydra_Software_Devel/12   11/10/11 5:02p ckpark
 * SWSATFE-127: added interrupt for fine frequency estimation
 * 
 * Hydra_Software_Devel/11   11/10/11 9:31a enavarro
 * SWSATFE-157: fix eq register access for low symbol rates
 * 
 * Hydra_Software_Devel/10   11/7/11 4:20p ronchan
 * SWSATFE-140: identify controlling channel of ref pll
 * 
 * Hydra_Software_Devel/9   7/27/11 4:33p ckpark
 * SWSATFE-136: put in register access workaround for low baud rate
 * 
 * Hydra_Software_Devel/8   6/16/11 9:09a enavarro
 * SWSATFE-127: added fine freq offset estimation for DVB-S2
 * 
 * Hydra_Software_Devel/7   4/29/11 11:33a enavarro
 * SWSATFE-75: bypass opll
 * 
 * Hydra_Software_Devel/6   3/2/11 3:59p ronchan
 * SWSATFE-75: fixed compiler warning
 * 
 * Hydra_Software_Devel/5   2/28/11 10:37a ckpark
 * SWSATFE-75: commented out printout
 * 
 * Hydra_Software_Devel/4   2/25/11 3:51p ckpark
 * SWSATFE-75: change afec clock calculation
 * 
 * Hydra_Software_Devel/3   12/8/10 2:14p enavarro
 * SWSATFE-75: added turbo sync detect interrupt
 * 
 * Hydra_Software_Devel/2   12/6/10 10:50a enavarro
