 ...
 *
 * $brcm_Workfile: bast_g3_priv_fsk.h $
 * $brcm_Revision: Hydra_Software_Devel/2 $
 * $brcm_Date: 9/7/12 10:19a $
 *
 * [File Description:]
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ast/src/g3/common/bast_g3_priv_fsk.h $
 * 
 * Hydra_Software_Devel/2   9/7/12 10:19a ronchan
...
#define BAST_FSK_WRITE(r, v) \
   { BREG_Write32(((BAST_73xx_P_Handle *)(h->pImpl))->hRegister, BCHP_##r, v); }

#define BAST_FSK_READ(r, v) \
   { *v = BREG_Read32(((BAST_73xx_P_Handle *)(h->pImpl))->hRegister, BCHP_##r); }

#define BAST_INT_CB_DEF(intr, id, enable) \
	{intr, BAST_73xx_Ftm_P_HandleInterrupt_isr, id, enable},
