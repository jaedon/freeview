 ...
 * $brcm_Date: 9/20/12 3:33p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hdm/src/core28nm/bhdm_priv.c $
 * 
 * Hydra_Software_Devel/1   9/20/12 3:33p vle
...
{	
	...
	Register |= BCHP_FIELD_DATA(HDMI_TX_PHY_CHANNEL_SWAP, TXCK_OUT_INV, 
...
)
{
	...
	stPreEmphasisConfig->uiPreEmphasis_Ch0 = BCHP_GET_FIELD_DATA(Register,HDMI_TX_PHY_CTL_0,PREEMP_CK);
	...
	BHDM_PreEmphasis_Configuration *stPreEmphasisConfig)
{
	...
	Register |=
		...
		| BCHP_FIELD_DATA(HDMI_TX_PHY_CTL_0, PREEMP_1, stPreEmphasisConfig->uiPreEmphasis_CK);
	BREG_Write32(hHDMI->hRegister, BCHP_HDMI_TX_PHY_CTL_0, Register) ;
