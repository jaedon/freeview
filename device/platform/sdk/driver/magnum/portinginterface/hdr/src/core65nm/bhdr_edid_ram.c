 ...
 *
 * $brcm_Log: /magnum/portinginterface/hdr/3548/bhdr_edid_ram.c $
 * 
 * Hydra_Software_Devel/6   8/18/11 3:24p rgreen
 * SW7425-833: Add BDBG_OBJECT_ASSERT support
 * 
 * Hydra_Software_Devel/5   6/16/09 5:10p rgreen
 * PR56074: Fix compilation issue
 * 
 * Hydra_Software_Devel/4   6/12/09 5:30p rgreen
 * PR52879: Fix BDBG_ENTER/LEAVE macros
 * 
 * Hydra_Software_Devel/3   4/8/09 4:33p rgreen
 * PR52879: Add support for on-chip EDID RAM
 * 
 * Hydra_Software_Devel/2   3/23/09 1:20p rgreen
 * PR52879: Additional support for EDID RAM
 * 
 * Hydra_Software_Devel/1   3/5/09 8:14p rgreen
 * PR52879: Initial version
 ***************************************************************************/
