 ...
 *
 * $brcm_Workfile: bsp_s_otp_7118A0.h $
 * $brcm_Revision: Hydra_Software_Devel/3 $
 * $brcm_Date: 12/4/06 4:16p $
 * Broadcom Security Processor Code
 ***************************************************************************/
 
#ifndef BSP_S_OTP_7118A0_H__
#define BSP_S_OTP_7118A0_H__
...
typedef enum BCMD_Otp_CmdMsp_e      
{
    ...
    BCMD_Otp_CmdMsp_eOtpCtrlBit32_NDS_SVP_DTV_CP_SELECT = 35, /* 1 bit */ 
    ...
    BCMD_Otp_CmdMsp_eOtpEPHY_TRIM0_3     = 39, /* 4 bits */
    
    BCMD_Otp_CmdMsp_eOtpCtrlBit43_eDisableAvKeyLoad = 40,   /* 1 bit */
