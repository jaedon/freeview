 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7400/a0/cust_generic/aegis/bsp_s_keycommon.h $
 * 
 * Hydra_Software_Devel/12   6/8/07 1:40p lyang
...
typedef enum BCMD_M2MSecCryptoAlg_e	 
{
    ...
    #error "ERROR: unsupported chip model!"
