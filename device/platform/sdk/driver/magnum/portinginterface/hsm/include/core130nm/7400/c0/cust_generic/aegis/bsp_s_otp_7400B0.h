 ...
 *
 * $brcm_Workfile: bsp_s_otp_7400B0.h $
 * $brcm_Revision: Hydra_Software_Devel/3 $
 * $brcm_Date: 5/9/07 3:40p $
 * Broadcom Security Processor Code
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7400/b0/cust_generic/aegis/bsp_s_otp_7400B0.h $
 * 
 * Hydra_Software_Devel/3   5/9/07 3:40p lyang
...
#ifndef BSP_S_OTP_7400B0_H__
#define BSP_S_OTP_7400B0_H__
...
typedef enum BCMD_Otp_CmdMsp_e      
{
    ...
    BCMD_Otp_CmdMsp_eReserved59          = 59,
    BCMD_Otp_CmdMsp_eReserved60          = 60,
    BCMD_Otp_CmdMsp_eReserved61          = 61,
    BCMD_Otp_CmdMsp_eReserved62          = 62,
    BCMD_Otp_CmdMsp_eReserved63          = 63,
    BCMD_Otp_CmdMsp_eReserved64          = 64,

    BCMD_Otp_CmdMsp_eSize                = 65
