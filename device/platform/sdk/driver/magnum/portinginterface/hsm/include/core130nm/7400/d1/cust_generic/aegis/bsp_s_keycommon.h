 ...
 * $brcm_Date: 9/18/07 2:40p $
 * Broadcom Security Processor Code
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7400/d0/cust_generic/aegis/bsp_s_keycommon.h $
 * 
 * Hydra_Software_Devel/1   9/18/07 2:40p lyang
...
{  
    ...
    BCMD_XptSecCryptoAlg_eReserved7 = 15,
    BCMD_XptSecCryptoAlg_eMaxNumber = 16 
