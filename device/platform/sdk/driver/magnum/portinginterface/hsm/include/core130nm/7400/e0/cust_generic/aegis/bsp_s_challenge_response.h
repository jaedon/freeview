 ...
 * $brcm_Date: 9/18/07 2:39p $
 * Security Processor Code for Register Access
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7400/d0/cust_generic/aegis/bsp_s_challenge_response.h $
 * 
 * Hydra_Software_Devel/1   9/18/07 2:39p lyang
