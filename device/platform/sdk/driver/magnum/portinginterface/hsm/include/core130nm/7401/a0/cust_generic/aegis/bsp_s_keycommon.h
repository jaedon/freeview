...
|  31..24      | 23..16     | 15..8      | 7..0                               | 
|--------------|------------|------------|------------------------------------| 
|  unused      | unused     | unused     | BCMD_KeyPointer_InCmdCfg_ePidChan  | 
|--------------|------------|------------|------------------------------------| 
...
{
    BCMD_KeyPointer_InCmdCfg_ePidChan = (5 << 2) + 3,   /* 8 bit index*/
...
enum BCMD_Alg_InCmdCfg_e
{
    ...
    BCMD_Alg_InCmdCfg_eGlobalXptSecureCtrl = (12 << 2) + 3,   /* 8 bit index*/ 
    BCMD_Alg_InCmdCfg_eDummyWord      = (13 << 2)
    /*
