...
Parameters passed:
eEnum - must be BCMD_Otp_CmdMsp_e
...
typedef enum BCMD_Otp_InCmdOfflineMspRead_e 
{
    ...
    ,
    BCMD_Otp_InCmdOfflineMspRead_eReserved7                = (22<<2) + 3  
...
typedef enum BCMD_Otp_OutCmdDataSectionRead_e
{
    ...
    BCMD_Otp_OutCmdDataSectionRead_eReserved0  = (14<< 2)+0 
...
are as define in the below #define statements.
...
#define BCMD_OTP_FLT_STAT_KEYA_OTP_KEYA_PROG_FAULT                  0x00000008
#define BCMD_OTP_FLT_STAT_KEYA_OTP_KEYA_INVALID                     0x00000004
#define BCMD_OTP_FLT_STAT_KEYA_OTP_KEYA_DATA_FAULT                  0x00000002
#define BCMD_OTP_FLT_STAT_KEYA_OTP_KEYA_CRC_FAULT                   0x00000001

#define BCMD_OTP_FLT_STAT_KEYB_OTP_KEYB_ERR_SYNDROME                0x00000100
#define BCMD_OTP_FLT_STAT_KEYB_OTP_KEYB_PROG_FAULT                  0x00000008
#define BCMD_OTP_FLT_STAT_KEYB_OTP_KEYB_INVALID                     0x00000004
#define BCMD_OTP_FLT_STAT_KEYB_OTP_KEYB_DATA_FAULT                  0x00000002
#define BCMD_OTP_FLT_STAT_KEYB_OTP_KEYB_CRC_FAULT                   0x00000001

#define BCMD_OTP_FLT_STAT_KEYC_OTP_KEYC_UNLOCKED_INVALID            0x80000000
#define BCMD_OTP_FLT_STAT_KEYC_OTP_KEYC_ERR_SYNDROME                0x00000100
#define BCMD_OTP_FLT_STAT_KEYC_OTP_KEYC_INVALID                     0x00000004
#define BCMD_OTP_FLT_STAT_KEYC_OTP_KEYC_DATA_FAULT                  0x00000002
#define BCMD_OTP_FLT_STAT_KEYC_OTP_KEYC_CRC_FAULT                   0x00000001

#define BCMD_OTP_FLT_STAT_DS_OTP_DS_ERR_SYNDROME                    0x00000100
#define BCMD_OTP_FLT_STAT_DS_OTP_DS_DATA_FAULT                      0x00000001
...
typedef enum BPI_Otp_CmdReadRegister_e 
{
    ...
    BPI_Otp_CmdReadRegister_eReserved0 = 1, 

    BPI_Otp_CmdReadRegister_eReserved1 = 2,
...
{
    BPI_Otp_HalReadRegister_eMc0OperationMode,
...
{
    BPI_Otp_DataSection_eReserved0 = 0x0,
    BPI_Otp_DataSection_eReserved1 = 0x1,
    BPI_Otp_DataSection_eReserved2 = 0x2,
    BPI_Otp_DataSection_eReserved3 = 0x3,
    BPI_Otp_DataSection_eReserved4 = 0x4,
    BPI_Otp_DataSection_eReserved5 = 0x5,
    BPI_Otp_DataSection_eReserved6 = 0x6,
    BPI_Otp_DataSection_eReserved7 = 0x7,
