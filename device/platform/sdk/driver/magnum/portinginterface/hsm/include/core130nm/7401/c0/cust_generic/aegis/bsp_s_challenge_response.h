 ...
 * $brcm_Date: 8/28/12 3:31p $
 * Security Processor Code for Register Access
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7401/b0/cust_generic/aegis/bsp_s_challenge_response.h $
 * 
 * Hydra_Software_Devel/1   8/28/12 3:31p zqian
 * SWSECURITY-175: Remove Symbolic Link for files under HSM cust_generic
 * 
 * Hydra_Software_Devel/5   6/8/07 3:46p lyang
...
typedef enum BCMD_Response_Method_e
{
    ...
    BCMD_Response_Method_eReserved
