 ...
 * $brcm_Date: 8/28/12 3:33p $
 * Broadcom Security Processor Code
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7401/b0/cust_generic/aegis/bsp_s_otp.h $
 * 
 * Hydra_Software_Devel/1   8/28/12 3:33p zqian
 * SWSECURITY-175: Remove Symbolic Link for files under HSM cust_generic
 * 
 * Hydra_Software_Devel/8   6/8/07 1:40p lyang
 * PR 27711: HSM Purge and shared *.h source udpated for 7400A0,
 * 7401B0/C1/C2/C3
 * 
 * Aegis_Firmware_Devel/58   5/1/07 11:47a ksekar
 * PR 57: Remove comments for code review filtering from data section read
 * and program.
 * 
 * Aegis_Firmware_Devel/57   4/13/07 7:07p ksekar
 * PR 617: Fix a compile error due to missing ,
 * 
 * Aegis_Firmware_Devel/56   4/13/07 6:50p ksekar
 * PR 617: Add enums for Redundant Row Bad Flags to be printed out in the
 * OfflineStatus command
 * 
 * Aegis_Firmware_Devel/55   4/10/07 5:34p ksekar
 * PR 57:
 * 
...
typedef enum BCMD_Otp_InCmdOfflineProgOtp_e 
{
    ...
    BCMD_Otp_InCmdOfflineProgOtp_eAlgorithm           = ( 5 << 2)+2, /* 8  bit index */
    BCMD_Otp_InCmdOfflineProgOtp_eNumErrorsMax        = ( 5 << 2)+1, /* 8  bit index */

    /* only used in eMode==eEnum */
    BCMD_Otp_InCmdOfflineProgOtp_eKey                 = ( 6 << 2)+3, /* 8  bit index */
    BCMD_Otp_InCmdOfflineProgOtp_eMc0Value            = ( 7 << 2)+0, /* 32 bit index */
    BCMD_Otp_InCmdOfflineProgOtp_eMc0ValueReserved    = ( 8 << 2)+0, /* 32 bit index */
    BCMD_Otp_InCmdOfflineProgOtp_e14x26ArrayKeyId     = ( 9 << 2)+0, /* 32 bit index */
    BCMD_Otp_InCmdOfflineProgOtp_e14x26ArrayKey       = (13 << 2)+0, /* 32 bit index */
    BCMD_Otp_InCmdOfflineProgOtp_e14x26ArrayCrc       = (21 << 2)+0, /* 32 bit index */
    
    BCMD_Otp_InCmdOfflineProgOtp_eReserved0           = (23 << 2)+0, /* 32 bit index */
    
    BCMD_Otp_InCmdOfflineProgOtp_eMspBit              = (24 << 2)+3, /* 8  bit index */
    BCMD_Otp_InCmdOfflineProgOtp_eBitAddr             = (25 << 2)+3, /* 8  bit index */
    BCMD_Otp_InCmdOfflineProgOtp_eRowAddr             = (26 << 2)+2, /* 8 bit index */
    BCMD_Otp_InCmdOfflineProgOtp_eBitData             = (27 << 2)+3  /* 8  bit index */
...
typedef enum BCMD_Otp_InCmdDataSectionProg_e 
{
    ...
    BCMD_Otp_InCmdDataSectionProg_eReserved0          = (14<< 2)+3,  /* 32 bit index */
    BCMD_Otp_InCmdDataSectionProg_eReserved1          = (14<< 2)+2,  /* 32 bit index */
    BCMD_Otp_InCmdDataSectionProg_eReserved2          = (14<< 2)+1,  /* 32 bit index */  
...
typedef enum BCMD_Otp_OutCmdStatus_e
{
    ...
    BCMD_Otp_OutCmdStatus_eKeyABadFlag                = (13 << 2)+0, /* 32 bit index */
    BCMD_Otp_OutCmdStatus_eKeyBCBadFlag               = (14 << 2)+0, /* 32 bit index */
    BCMD_Otp_OutCmdStatus_eDS01BadFlag                = (15 << 2)+0, /* 32 bit index */
    BCMD_Otp_OutCmdStatus_eDS23BadFlag                = (16 << 2)+0, /* 32 bit index */
    BCMD_Otp_OutCmdStatus_eDS45BadFlag                = (17 << 2)+0, /* 32 bit index */
    BCMD_Otp_OutCmdStatus_eDS67BadFlag                = (18 << 2)+0, /* 32 bit index */
    BCMD_Otp_OutCmdStatus_eCauseResetStatus           = (19 << 2)+0, /* 32 bit index */
    BCMD_Otp_OutCmdStatus_eRdnt1BadFlag               = (20 << 2)+0, /* 32 bit index */
    BCMD_Otp_OutCmdStatus_eRdnt2BadFlag               = (21 << 2)+0, /* 32 bit index */
    BCMD_Otp_OutCmdStatus_eRdnt3BadFlag               = (22 << 2)+0, /* 32 bit index */
...
typedef enum BCMD_Otp_InCmdWriteEn_e 
{
    ...
    BCMD_Otp_InCmdWriteEn_eMsp                   = (49<< 2)+0 /* 32 bit index - index not used */
