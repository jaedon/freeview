...
|-------------------|-------------------|-------------------|---------------------| 
*/
typedef enum BCMD_UserDESAES_CmdInputField_e
{
...
} BCMD_UserDESAES_CmdInputField_e;
...
|-------------------|-------------------|-------------------|---------------------| 
*/
typedef enum BCMD_UserDESAES_CmdOutputField_e
{
...
} BCMD_UserDESAES_CmdOutputField_e;
