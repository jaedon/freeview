 ...
 * $brcm_Revision: Aegis_Firmware_Devel/39 $
 * $brcm_Date: 10/6/11 5:27p $
...
typedef enum BCMD_KeyRamBuf_e
{
    ...
    BCMD_KeyRamBuf_ePKL                  	= 8, /* PKL key ladder */	
    BCMD_KeyRamBuf_eFirstRam                = 9, /* FW internal 192 bit user key ram, not used by host */
    BCMD_KeyRamBuf_eFek                		= 10, /* FW internal Fek key ram, not used by host */
    BCMD_KeyRamBuf_eMax
