 ...
 * $brcm_Revision: Aegis_Firmware_Devel/20 $
 * $brcm_Date: 10/4/11 5:39p $
...
typedef enum BPI_Otp_HalProgKey_e
{
    ...
    BPI_Otp_HalProgKey_eSOCUID,
    BPI_Otp_HalProgKey_eNPRIV0,
    BPI_Otp_HalProgKey_eNPRIV1,
    BPI_Otp_HalProgKey_eNPRIV2,
    BPI_Otp_HalProgKey_eNPRIV3,
    BPI_Otp_HalProgKey_eNPRIV4,
    BPI_Otp_HalProgKey_eNPRIV5,
    BPI_Otp_HalProgKey_eNPRIV6,
    BPI_Otp_HalProgKey_eNPRIV7,
