...
eMethod - Whether to perform Response method 0 or 1.
    0 - legacy response.
*/    
/* BRCM_IF(BSP_CODEREV_GVP) && (BSP_CODEREV_NDS)*/  
/*    1- Host authenticates BSP   */
/*BRCM_ELSE*/
/* 1- reserved  */
/*BRCM_ENDIF*/
/*
...
*/
/* BRCM_IF(BSP_CODEREV_GVP) && (BSP_CODEREV_NDS)*/  
/* eResponse - 128 bit decrypted nonce response. */
/*BRCM_ENDIF*/
...
/* BRCM_IF(BSP_CODEREV_GVP) && (BSP_CODEREV_NDS)*/  
/*   
|  eCustKeySelL - 128 (method 1: 128 bits nonce)            | eCustKeySelH - 8	| 
*/
/*BRCM_ELSE*/
/*
...
typedef enum BCMD_Response_Method_e
{
    ...
    BCMD_Response_Method_eReserved  = 1, /* BCMD_Response_Method_eHostAuthenticate = 1, */
