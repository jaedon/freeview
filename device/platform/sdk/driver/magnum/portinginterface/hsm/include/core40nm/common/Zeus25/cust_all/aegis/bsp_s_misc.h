...
typedef enum BCMD_SetMiscBitsSubCmd_e
{
   ...
   /* BRCM_IF(BSP_CODEREV_NDS*/
	BCMD_SetMiscBitsSubCmd_eICAMBits = 2,
   /*BRCM_ENDIF*/
...
/*BRCM_IF(BSP_CODEREV_NDS)*/
/*
3) Control Bits for BCMD_SetMiscBitsSubCmd_eICAMBits,
Bit 0: ICAM_IF_EN
	1 - CP-E input will come from external ICAM input.
	0 - CP-E input will come from CA directly.
Bit 1: ICAM_SCMOD_OVERRIDE_EN: Enables ICAM module allow_descramble to override
       SC_MOD control in KEY_TABLE
Bit 2: ICAM_IF_TIMING_EN
	1 - CA output will have gaps
	0 - No gaps
*/
/*BRCM_ENDIF*/
/*
