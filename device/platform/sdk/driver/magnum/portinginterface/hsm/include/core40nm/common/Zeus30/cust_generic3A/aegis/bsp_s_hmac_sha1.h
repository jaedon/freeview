...
/*    BCMD_HmacSha1_InCmdField_eAddress : Address after eDataLen */
	BCMD_HmacSha1_InCmdField_eReserved		= (8<<2) + 0
...
typedef enum BPI_HmacSha1_Context_e
{
    ...
    BPI_HmacSha1_Context_eWebCpu0    = 0x17, /* Core1 aka WebCPU: we only do one MICH region */
                                            ...
                                            /*
                                             * SCPU_SECURE:
                                             *      Note that Scpu_FSBL MUST appear first since it is used
                                             *      as the base from which to index when determining which
                                             *      bit to set/clear in the SCPU instruction checker PAR
                                             *      control registers.
                                             */
    BPI_HmacSha1_Context_eScpu_FSBL   = 0x18, /* SCPU_SECURE: SAGE FSBL region */
    BPI_HmacSha1_Context_eScpu_OSAppl = 0x19, /* SCPU_SECURE: SAGE OS/Appl region */
    BPI_HmacSha1_Context_eScpu_Region = 0x1A, /* SCPU_SECURE: SAGE general region */
    BPI_HmacSha1_Context_eScpu_SCM    = 0x1B, /* SCPU_SECURE: Sage SCM region (region not background checked) */

    BPI_HmacSha1_Context_eRegionMax  = 0x1B, /* The last context representing a checkable region. Used for query command */

    BPI_HmacSha1_Context_eReserved1  = 0x1C, /* Reserved for future */
    BPI_HmacSha1_Context_eReserved2  = 0x1D, /* Reserved for future */
    BPI_HmacSha1_Context_eReserved3  = 0x1E, /* Reserved for future */
    BPI_HmacSha1_Context_eReserved4  = 0x1F, /* Reserved for future */

    BPI_HmacSha1_Context_eHmacSha1CtxMin = 0x20,   /* Minimum valid User HMAC_SHA cmd context */
    BPI_HmacSha1_Context_eHmacSha1Ctx0 = 0x20,     /* User HMAC_SHA cmd context */
    BPI_HmacSha1_Context_eHmacSha1Ctx1 = 0x21,     /* User HMAC_SHA cmd context */

    BPI_HmacSha1_Context_eHmacSha1CtxSCM = 0x22,     /* User HMAC_SHA cmd context for SCM thread ONLY */
    BPI_HmacSha1_Context_eHmacSha1CtxMax = 0x22,   /* Maximum valid User HMAC_SHA cmd context */

    BPI_HmacSha1_Context_eCmdSig0    = 0x23, /* Context for processing command signature, second-tier key, EStar Root Key, Secure RSA etc */
                                             /* Context information NOT saved across commands (cannot be used by continual mode commands) */
    BPI_HmacSha1_Context_eCmdSig1    = 0x24, /* Context for processing command signature, second-tier key, EStar Root Key, Secure RSA etc */
                                             /* Context information NOT saved across commands (cannot be used by continual mode commands) */
 ...
 * Same value as BPI_HmacSha1_Context_eRegionMax.
 */
...
#else
#define REGION_IS_VALID(r)          (((UINT8)(r) <= (UINT8)BPI_HmacSha1_Context_eCpu2) \
                                        || ((UINT8)(r) == (UINT8)BPI_HmacSha1_Context_eRave0))
#endif
...
#define REGION_IS_SCPU_SCM(r)       ((BPI_HmacSha1_Context_e)(r) == BPI_HmacSha1_Context_eScpu_SCM)
#define REGION_IS_RAAGA0INTERNAL_SCM(r) ((BPI_HmacSha1_Context_e)(r) == BPI_HmacSha1_Context_eRaaga0_IntSCM)
#define REGION_IS_RAAGA0INTERNAL_AUD(r) ((BPI_HmacSha1_Context_e)(r) == BPI_HmacSha1_Context_eRaaga0_IntAUD)
...
#define REGION_IS_SCPU_FSBL(r)      ((BPI_HmacSha1_Context_e)(r) == BPI_HmacSha1_Context_eScpu_FSBL)
#define REGION_IS_SCPU_OSAPPL(r)    ((BPI_HmacSha1_Context_e)(r) == BPI_HmacSha1_Context_eScpu_OSAppl)
#define REGION_IS_SCPU_REGION(r)    ((BPI_HmacSha1_Context_e)(r) == BPI_HmacSha1_Context_eScpu_Region)
#define REGION_IS_SCPU(r)           (REGION_IS_SCPU_SCM(r) \
                                        || REGION_IS_SCPU_FSBL(r) \
                                        || REGION_IS_SCPU_OSAPPL(r) \
                                        || REGION_IS_SCPU_REGION(r))
