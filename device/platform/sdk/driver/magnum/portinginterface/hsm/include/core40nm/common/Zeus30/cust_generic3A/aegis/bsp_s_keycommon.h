...
typedef enum BCMD_CustomerSubMode_e
{
    ...
    BCMD_CustomerSubMode_eSAGE_128_5        = 0xC,  /* Key Ladder for SAGE */
...
{                                        
    ...
    BCMD_XptSecKeySlot_eType3               = 3, /* This slot type is reserved from ZEUS 3.0*/
    BCMD_XptSecKeySlot_eReserved3           = 3, 
...
typedef enum BCMD_VKLID_e
{
    ...
    BCMD_VKLID_eSWKey                       = 0x9, /* SW key source */
    BCMD_VKLReserved17                      = 0xA,

    BCMD_VKLReserved18                      = 0xB,

    BCMD_VKLID_eFekKey                      = 0xC, /* FEK, FW internal use, not used by host */
	BCMD_VKLID_eHwklKey						= 0xD,	/* HWKL, Internal use for ACL purposes */
	BCMD_VKLID_ePklKey						= 0xE,	/* PKL, Internal use for ACL purposes */
    BCMD_VKLID_eGenerateRouteOnceUsedRandomMacKey                      = 0xF, /* GenerateRouteOnceUsedRandomMacKey, FW internal use, not used by host */
...
typedef enum BCMD_KeyDestBlockType_e
{
    ...
    BCMD_KeyDestBlockType_eAesCMAC          = 13,
    BCMD_KeyDestBlockType_eDMA_AES          = 14,
    BCMD_KeyDestBlockType_eUserAES          = 15,
#else
    BCMD_KeyDestBlockType_eReserved8        = 13,
#endif
...
#if !defined(REMOVE_ASF_ALGORITHM)
...
|                               BCMD_GenKey_InCmd_eActivationCode( 32 bits words )               | 
|--------------|------------|-------------------------------|------------------------------------| 
|                               BCMD_GenKey_InCmd_eExtIVPtr  ( 16 bits words )                   | 
|--------------|------------|-------------------------------|------------------------------------| 
*/
typedef enum BCMD_GenKey_InCmd_e
{
    ...
    BCMD_GenKey_InCmd_eKeyTweak 		    	= (14 << 2) + 2, /* 8 bit index*/
    ...
    BCMD_GenKey_InCmd_eExtIVPtr            		= (45 << 2) + 2,  /* 16 bits index */	
    BCMD_GenKey_InCmd_eResetPKSM            	= (46 << 2) + 3,  /* 8 bits index */	
    BCMD_GenKey_InCmd_ePKSMInitSize            	= (47 << 2) + 3,  /* 8 bits index */	
    BCMD_GenKey_InCmd_ePKSMNumOfCycle           = (48 << 2) + 2  /* 16 bits index */	
} BCMD_GenKey_InCmd_e;

typedef enum BCMD_GenKey_OutCmdField_e
{
    BCMD_GenKey_OutCmd_eReserved        = (6 << 2),        /* 32 bit for ASKM zero detect dump */    
    BCMD_GenKey_OutCmd_eVKLAllocation   = (6 << 2) + 2,    /* 8 bit for SAGE vs Host allocation*/
    BCMD_GenKey_OutCmd_eVKLAssociation  = (6 << 2) + 3    /* 8 bit for sub-customer mode*/
...
typedef enum BCMD_PKSMInit_e
{
    BCMD_PKSMInit_eNoInit		= 0, 
    BCMD_PKSMInit_eInit64Bit	= 1, 
    BCMD_PKSMInit_eInit128Bit	= 2, 
    BCMD_PKSMInit_eInit192Bit	= 3, 
    BCMD_PKSMInit_eMax
} BCMD_PKSMInit_e;
...
typedef enum BCMD_KeyTweak_e
{
    ...
    BCMD_KeyTweak_ePKSM = 1, 
    BCMD_KeyTweak_eMax
} BCMD_KeyTweak_e;

typedef enum BCMD_ResetPKSM_e
{
    BCMD_ResetPKSM_eNoReset = 0, 
    BCMD_ResetPKSM_eReset = 1, 
    BCMD_ResetPKSM_eMax
} BCMD_ResetPKSM_e;
...
{
    BCMD_LoadUseKey_InCmd_eKeyLength            = (5 << 2) + 3, /* 8 bit index*/
    ...
    BCMD_LoadUseKey_InCmd_eExtKeyPtr            = (26 << 2) + 2,  /* 16 bits index */	
    BCMD_LoadUseKey_InCmd_eExtIVPtr             = (27 << 2) + 2  /* 16 bits index */	
...
typedef enum BCMD_SAGE_JTAG_UNLOCK_InCmdField_e
{
    BCMD_SAGE_JTAG_UNLOCK_InCmdField_eRootKeySrc       	= (5<<2) + 3,   /* 8 bit index */ 
    BCMD_SAGE_JTAG_UNLOCK_InCmd_eCAVendorID             = (6<<2) + 2,  /* 16 bit index*/
    BCMD_SAGE_JTAG_UNLOCK_InCmd_eSTBOwnerIDSel			= (7<<2) + 3,  /* 8 bit index*/
    BCMD_SAGE_JTAG_UNLOCK_InCmd_eTestKeySel			    = (7<<2) + 2,  /* 8 bit index*/
    BCMD_SAGE_JTAG_UNLOCK_InCmd_eModuleIDBit7Set	    = (7<<2) + 1,  /* 8 bit index*/
    BCMD_SAGE_JTAG_UNLOCK_InCmdField_eProcIn         	= (8<<2) + 0   /* 128 bit index */     
}BCMD_SAGE_JTAG_UNLOCK_InCmdField_e;

typedef enum BCMD_SAGE_JTAG_UNLOCK_OutCmdField_e
{
    BCMD_SAGE_JTAG_UNLOCK_OutCmdField_eStatus = (5<<2) + 3 /* 8 bit */
}BCMD_SAGE_JTAG_UNLOCK_OutCmdField_e;
