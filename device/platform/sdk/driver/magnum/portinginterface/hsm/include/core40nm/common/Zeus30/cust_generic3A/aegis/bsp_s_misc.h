...
typedef enum BCMD_MISC_PowerMgmtField_InCmdField_e
{
	...
	BCMD_MISC_PowerMgmtField_InCmdField_eReserved7	 = (7<<2) + 3
} BCMD_MISC_PowerMgmtField_InCmdField_e;

#if defined(BSP_HDDTA)
/*
 * Parameters and definitions for BCMD_DTA_Mode_Select command.
 */
/*
 * BCMD_DTA_Mode_Select_InCmdField_e
 * |-------------------|-------------------|-------------------|------------------| 
 * |  31..24           | 23..16            | 15..8             | 7..0             | 
 * |-------------------|-------------------|-------------------|------------------| 
 * |  unused           | unused            | unused            | DTAModeOp - 8    | 
 * |-------------------|-------------------|-------------------|------------------|
 * |  unused           | unused            | unused            | DTAMode - 8      | 
 * |-------------------|-------------------|-------------------|------------------|
 */
/*
 * BCMD_DTA_Mode_Select_OutCmdField_e
 * |-------------------|-------------------|-------------------|------------------| 
 * |  31..24           | 23..16            | 15..8             | 7..0             | 
 * |-------------------|-------------------|-------------------|------------------| 
 * |  unused           | unused            | unused            | DTAMode - 8      | 
 * |-------------------|-------------------|-------------------|------------------|
 */
typedef enum BCMD_DTA_Mode_Select_InCmdField_e
{
	BCMD_DTA_Mode_Select_InCmdField_eDTAModeOp      = (5<<2) + 3, /* 8 bit index */
	BCMD_DTA_Mode_Select_InCmdField_eDTAModeSelect  = (6<<2) + 3 /* 8 bit index */
} BCMD_DTA_Mode_Select_InCmdField_e;

typedef enum BCMD_DTA_Mode_Select_OutCmdField_e
{
	BCMD_DTA_Mode_Select_OutCmdField_eDTAMode       = (6<<2) + 3 /* 8 bit index */
} BCMD_DTA_Mode_Select_OutCmdField_e;

/*
 * IMPORTANT: The order (NOT necessarily the values) of the modes
 *  in BCMD_DTA_Mode_e MUST be the same as the order of the respective
 *  modes in BCMD_CustomerMode_e.  This is because of the math used to
 *  assign the final value to gucCustomerModeBits in the DTA_MODE_SELECT
 *  command.
 */
typedef enum BCMD_DTA_Mode_e
{
    BCMD_DTA_Mode_eUndefined    = 0,
    BCMD_DTA_Mode_eMin          = 1,
    BCMD_DTA_Mode_eGeneric      = 1,
    BCMD_DTA_Mode_eMotorola     = 2,
    BCMD_DTA_Mode_eCisco        = 3,
    BCMD_DTA_Mode_eMax
} BCMD_DTA_Mode_e;

/*
 * These are the sub-commands/operations permitted with the
 * DTA Mode Select command.
 */
typedef enum BCMD_DTA_Mode_Operation_e
{
    BCMD_DTA_Mode_Operation_eQuery  = 0,
    BCMD_DTA_Mode_Operation_eSelect = 1,
    BCMD_DTA_Mode_Operation_eMax
} BCMD_DTA_Mode_Operation_e;
