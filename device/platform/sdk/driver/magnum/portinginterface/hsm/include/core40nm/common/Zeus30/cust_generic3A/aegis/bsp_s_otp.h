...
/*-Zeus 3.0 additions-*/
    ...
    BCMD_Otp_OutCmdStatus_eReserved1                = (47 << 2)+0
...
#else
    BPI_Otp_CmdReadRegister_eKeyMc0_Reserved22                      = 22,
#endif
    BPI_Otp_CmdReadRegister_eKeyMc0_Reserved23                      = 23,       /* Added new in Z4 */
    BPI_Otp_CmdReadRegister_eKeyTag_Reserved24                      = 24,       /* Added new in Z4 */

    BPI_Otp_CmdReadRegister_eKeyMc0_SageKeyLadderDisallow           = 25,       /* Added during Z4 dev. Applies to Z3 also. */
