 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7325/b0/cust_generic/aegis/bsp_s_commands.h $
 * 
 * Hydra_Software_Devel/1   8/12/08 9:33p atruong
 * PR44849: 7335 B0 Bringup/Cleanup
 * 
 * Aegis_Firmware_Devel/14   3/16/08 5:43p wychen
 * PR906: Add debug command to verify Anti-Glitch OtpProg
 * 
 * Aegis_Firmware_Devel/13   3/11/08 4:01p ksekar
 * PR 1067: Glitch hardening to be split up into two features with
 * separate compile flags
 * 
 * Aegis_Firmware_Devel/12   3/11/08 12:49p ksekar
 * PR 1064: Add defines for padding constants used with the command fields
 * command ID, parameter length and continual mode.
 * 
 * Aegis_Firmware_Devel/11   2/17/08 6:30p ksekar
 * PR 906: Add debug code for OTP testing
 * 
 * Aegis_Firmware_Devel/10   1/30/08 12:21p pilmore
 * PR1023: Remove User DES/AES support
 * 
