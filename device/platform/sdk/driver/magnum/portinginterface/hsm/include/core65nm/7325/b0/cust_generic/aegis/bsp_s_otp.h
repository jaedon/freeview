...
typedef enum BCMD_Otp_InCmdOfflineProgMsp_e
{
    ...
    BCMD_Otp_InCmdOfflineProgMsp_eReserved            = ( 10 << 2)+3,  /* 8 bit index This is for future HMAC key sel */
...
typedef enum BCMD_Otp_InCmdOfflineMspRead_e
{
    ...
    BCMD_Otp_InCmdOfflineMspRead_eReserved            = ( 6 << 2)+3,  /* 8 bit index This is for future HMAC key sel */
...
typedef enum BCMD_Otp_InCmdDataSectionProg_e
{
    ...
    BCMD_Otp_InCmdDataSectionProg_eReserved           = ( 16 << 2)+3,  /* 8 bit index This is for future HMAC key sel */
