 ...
 *
 * $brcm_Workfile: bsp_s_otp_7325B0.h $
 * $brcm_Revision: Hydra_Software_Devel/1 $
 * $brcm_Date: 8/12/08 9:33p $
 * Broadcom Security Processor Code
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7325/b0/cust_generic/aegis/bsp_s_otp_7325B0.h $
 * 
...
#ifndef BSP_S_OTP_7325B0_H__
#define BSP_S_OTP_7325B0_H__
...
#ifdef BSP_LOTP
	BCMD_Otp_CmdMsp_eStartHash			 = 94,
	BCMD_Otp_CmdMsp_eStopHash			 = 95,

	BCMD_Otp_CmdMsp_eReserved96          = 96, /* 96 - 2 bits */

	BCMD_Otp_CmdMsp_eSize                = 97
#else
	BCMD_Otp_CmdMsp_eReserved94          = 94, /* 94 - 2 bits */

	BCMD_Otp_CmdMsp_eSize                = 95
#endif
