 ...
 *
 * $brcm_Workfile: bsp_s_otp_7325A0.h $
 * $brcm_Revision: Hydra_Software_Devel/1 $
 * $brcm_Date: 10/15/07 6:12p $
 * Broadcom Security Processor Code
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7325/a0/cust_generic/aegis/bsp_s_otp_7325A0.h $
 * 
 * Hydra_Software_Devel/1   10/15/07 6:12p lyang
 * PR 35021: HSM bringup on 7325, part of 7335 added also
 * 
 * Aegis_Firmware_Devel/3   7/19/07 6:12p ksekar
 * PR 670: Update OTP code according to latest OTP map
 * 
...
#ifndef BSP_S_OTP_7325A0_H__
#define BSP_S_OTP_7325A0_H__
