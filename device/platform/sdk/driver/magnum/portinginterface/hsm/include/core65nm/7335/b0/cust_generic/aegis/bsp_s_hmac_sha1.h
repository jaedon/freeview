 ...
 * $brcm_Date: 4/24/09 9:04a $
 * Security Processor Code for Register Access
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7325/b0/cust_generic/aegis/bsp_s_hmac_sha1.h $
 * 
 * Hydra_Software_Devel/3   4/24/09 9:04a atruong
 * PR53675: Remove obsolete commands for BCM7325B0
 * 
 * Aegis_Firmware_Devel/14   5/29/08 6:13p pilmore
 * PR1187: Initial 7420A0 source files/changes
 * 
 * Aegis_Firmware_Devel/13   4/3/08 4:15p nsamar
 * PR1093: Add support for 7335b0.
 * 
 * Aegis_Firmware_Devel/12   1/11/08 5:08p pilmore
 * PR963: FIRMWARE: 7400E0 support
 * 
 * Aegis_Firmware_Devel/11   12/19/07 10:46a nsamar
 * PR908: Add support for 7325B0
 * 
 * Aegis_Firmware_Devel/10   10/18/07 3:07p ksekar
 * PR 872: Update for 7405B0
 * 
 * Aegis_Firmware_Devel/9   8/22/07 12:31p wychen
 * PR760: 7335A0 chip support
 * 
 * Aegis_Firmware_Devel/8   8/7/07 4:49p wychen
 * PR660: clean up, remove 7400B0
 * 
 * Aegis_Firmware_Devel/7   8/7/07 3:53p sshekhar
 * PR 57: Adding 3573A0 defines to the fullcode rom codebase.
 * 
 * Aegis_Firmware_Devel/6   7/18/07 2:30p pilmore
 * PR685: 7400D0 update
 * 
 * Aegis_Firmware_Devel/5   6/13/07 4:40p hzhu
 * PR660:PreB-SECK clean up. remove chip/customer defines
 * 
 * Aegis_Firmware_Devel/4   6/4/07 11:01a ksekar
 * PR 656: Add 7325A0 compile flag
 * 
 * Aegis_Firmware_Devel/2   1/31/07 4:12p whou
 * PR525: 7405A0 support.
 * 
...
typedef enum BPI_HmacSha1_Context_e
{
    ...
    BPI_HmacSha1_Context_eRave0 = 0xA,     /* Verify Rave cmd */
    BPI_HmacSha1_Context_eReserved1 = 0xA,     /* BRCM reserved */
