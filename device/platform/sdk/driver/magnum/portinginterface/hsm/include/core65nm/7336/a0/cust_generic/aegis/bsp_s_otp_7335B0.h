 ...
 *
 * $brcm_Workfile: bsp_s_otp_7335B0.h $
 * $brcm_Revision: Hydra_Software_Devel/1 $
 * $brcm_Date: 8/12/08 9:33p $
 * Broadcom Security Processor Code
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7325/b0/cust_generic/aegis/bsp_s_otp_7335B0.h $
 * 
 * Hydra_Software_Devel/1   8/12/08 9:33p atruong
 * PR44849: 7335 B0 Bringup/Cleanup
 * 
 * Aegis_Firmware_Devel/2   4/20/08 6:34p nsamar
 * PR1145: To fix the MSP enum to make it consistent across chip. In this
 * PR we add the support for MSIPTV enable bit as well as the LV Bist
 * enum in the share files
 * 
 * Aegis_Firmware_Devel/4   2/20/08 1:11p pilmore
 * PR1052: Backout LV BIST OTP bits for 7325B0 - not supported
 * 
 * Aegis_Firmware_Devel/3   2/19/08 7:31p pilmore
 * PR1052: Add OTP bit support for LV BIST
 * 
 * Aegis_Firmware_Devel/2   12/27/07 1:20p nsamar
 * PR908: Update for 7325B0
 * 
 * Aegis_Firmware_Devel/1   12/19/07 10:36a nsamar
 * PR908: Add bsp_s_otp_7325B0.h to version control
 * 
 * Aegis_Firmware_Devel/5   11/6/07 12:09p pilmore
 * PR881: Support for MSP bit 59 (Force_3DES_Key_Ladder)
 * 
 * Aegis_Firmware_Devel/4   10/31/07 12:10p nsamar
 * PR873:LOTP firmware implementation: Fix compilation problem
 * 
 * Aegis_Firmware_Devel/3   10/26/07 11:26a nsamar
 * PR873: Latch OTP firmware implementation: Changes after self review.
 * 
 * Aegis_Firmware_Devel/2   10/21/07 3:50a nsamar
 * PR873: Latch OTP firmware implementation
 * New files added:
 * Added file element "bpi_otpl.c".
 * Added file element "bpi_otpl.h".
 * 
 * Aegis_Firmware_Devel/1   10/18/07 10:46a ksekar
 * PR 872:
 * 
 * Aegis_Firmware_Devel/4   7/19/07 6:13p ksekar
 * PR 672: Update OTP code according to latest OTP map
 * 
 * Aegis_Firmware_Devel/3   6/28/07 11:27a pilmore
 * PR685: 7400D0 support
 * 
 * Aegis_Firmware_Devel/4   6/13/07 4:51p ksekar
 * PR 664: Add OTP MSP bit (52) for Generic Pin Boundary Scan Protect
 * 
...
#ifndef BSP_S_OTP_7335B0_H__
#define BSP_S_OTP_7335B0_H__
...
typedef enum BCMD_Otp_CmdMsp_e      
{
    ...
    BCMD_Otp_CmdMsp_eLVBIST              = 96,  /* 96 - 2 bits */
    BCMD_Otp_CmdMsp_eEnable_MSIPTV       = 97,  /* 97 - 1 bit */

    BCMD_Otp_CmdMsp_eSize                = 98
