 ...
 * $brcm_Date: 6/8/07 6:45p $
 * Module Description: This file contains misc data structures that shall be shared with
 *					host. 
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7405/a0/cust_generic/aegis/bsp_s_misc.h $
 * 
 * Hydra_Software_Devel/2   6/8/07 6:45p lyang
 ...
 * 
 * Aegis_Firmware_Devel/2   1/31/07 6:23p whou
