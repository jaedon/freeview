...
typedef enum BCMD_Otp_CmdMsp_e      
{
    ...
    BCMD_Otp_CmdMsp_eReserved106         = 106, /* 106 - 1 bit */
    ...
    BCMD_Otp_CmdMsp_eReserved112          = 112, /* 112 - 1 bit */
    BCMD_Otp_CmdMsp_eReserved113          = 113, /* 3 bits */
    BCMD_Otp_CmdMsp_eReserved114          = 114, /* 1 bit */
    BCMD_Otp_CmdMsp_eReserved115          = 115, /* 32 bits */
    BCMD_Otp_CmdMsp_eReserved116          = 116, /* 1 bit */
    BCMD_Otp_CmdMsp_eFinal3DesRouteKeyK1K2Check  = 117, /*1 bit */ 
    BCMD_Otp_CmdMsp_eReserved118          = 118, /* 1 bit */
    BCMD_Otp_CmdMsp_eReserved119          = 119, /* 1 bit */    
    BCMD_Otp_CmdMsp_eReserved120          = 120, /* 1 bit */
    BCMD_Otp_CmdMsp_eReserved121          = 121, /* 1 bit */    
    ...
    BCMD_Otp_CmdMsp_eKey3ExportDisable    = 127, /* 1 bit */
    BCMD_Otp_CmdMsp_eFastCyclingEnable    = 128, /* 1 bit */ 
    BCMD_Otp_CmdMsp_eReserved129          = 129, /* 1 bit */
    BCMD_Otp_CmdMsp_eReserved130          = 130, /* 4 bit */
    BCMD_Otp_CmdMsp_eReserved131          = 131, /* 3 bit */
    BCMD_Otp_CmdMsp_eReserved132          = 132, /* 3 bit */ 
