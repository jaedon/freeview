...
{                    
    BCMD_STBOwnerID_eOTPVal,      /* Use OTP value as STB Owner ID */
    BCMD_STBOwnerID_eOneVal,     /* Use value 1 as STB Owner ID */
    BCMD_STBOwnerID_eZeroVal,     /* Use value 0 as STB Owner ID */
...
{                    
    BCMD_ModuleID_eZero,      /* Zero module ID */
    BCMD_ModuleID_eNSK,      /* NSK_KEY2 module ID */
    BCMD_ModuleID_eAVK,     /* AVK_KEY2 module ID */
    BCMD_ModuleID_eREG1,     /* KEY2_REG1 module ID */
    BCMD_ModuleID_eREG2,     /* KEY2_REG2 module ID */
    BCMD_ModuleID_eREG3,     /* KEY2_REG3 module ID */
    BCMD_ModuleID_eMax
}BCMD_ModuleID_e;
#endif 
...
typedef enum BCMD_KeyDestBlockType_e
{
    ...
    BCMD_KeyDestBlockType_eInvalid = 8
    /*
...
typedef enum BCMD_M2MSecCryptoAlg_e	 
{
    ...
    BCMD_M2MSecCryptoAlg_eMaxNumber = 24
#elif defined (AACS)
...
enum BCMD_GenKey_OutCmdField_e
{
...
#if defined(ASKM)
/* command buffer defines for BCMD_ASKM_KEY_GEN */
/*
|--------------|------------|----------|----------------------------------------| 
|  31..24      | 23..16     | 15..8    | 7..0                                   | 
|--------------|------------|----------|----------------------------------------| 
|  unused      | unused     | unused   |  BCMD_ASKM_KEY_GEN_InCmd_eSTBOwnerIDSel| 
|--------------|------------|----------|----------------------------------------|
|  unused      | unused     | BCMD_ASKM_KEY_GEN_InCmd_eCAVendorID              | 
|--------------|------------|----------|----------------------------------------|
|  unused      | unused     |TestKeySel|  BCMD_ASKM_KEY_GEN_InCmd_eModuleID     | 
|--------------|------------|----------|----------------------------------------|  
*/
enum BCMD_ASKM_KEY_GEN_InCmd_e
{
    BCMD_ASKM_KEY_GEN_InCmd_eSTBOwnerIDSel = (5 << 2)+ 3,        /* 8 bit */
    BCMD_ASKM_KEY_GEN_InCmd_eCAVendorID = (6 << 2) + 2,          /* 16 bit */ 
    BCMD_ASKM_KEY_GEN_InCmd_eTestKeySel = (7 << 2)+ 2,              /* 8 bit */
    BCMD_ASKM_KEY_GEN_InCmd_eModuleID = (7 << 2)+ 3              /* 8 bit */
};

enum BCMD_ASKM_KEY_GEN_OutCmdField_e
{
