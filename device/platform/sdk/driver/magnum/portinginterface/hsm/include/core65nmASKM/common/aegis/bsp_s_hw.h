 ...
 * $brcm_Date: 8/5/09 7:31a $
 * Broadcom Security Processor Code
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7420/b0/common/aegis/bsp_s_hw.h $
 * 
 * Hydra_Software_Devel/1   8/5/09 7:31a atruong
 * PR55169: HSM PI Support for 7420B0
 * 
 * Hydra_Software_Devel/1   6/29/09 5:37p atruong
 * PR55169: HSM PI Support for 7420A1
 * 
 * Hydra_Software_Devel/4   9/30/08 7:30p yili
 * PR42660:MSIPTV Integration:Changed M2M keyslot numbers from 16 to 42
 * 
