...
typedef enum BCMD_KeyDestBlockType_e
{
    ...
    /* The enums below are only used for ACL. They are not used by the host */
    BCMD_KeyDestBlockType_eIV               = 9,
    BCMD_KeyDestBlockType_eProcOut          = 10,
    /* The enums above are only used for ACL. They are not used by the host */
...
typedef enum BPI_Otp_HalOperationMode_e
{
    ...
    BPI_Otp_HalOperationMode_eReserved3     = 0x01,

    BPI_Otp_HalOperationMode_eMax 
