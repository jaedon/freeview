...
typedef enum BCMD_KeyDestBlockType_e
{
    ...
    BCMD_KeyDestBlockType_eHdmi = 5,        /* HDMI 0, old name to keep backward compatibility */
    BCMD_KeyDestBlockType_eHdmi0 = 5,        /* HDMI 0 , new name to have a consistent name according to Ron G.*/
...
{  
    ...
    BCMD_XptSecCryptoAlg_eReserved8    = 8,
