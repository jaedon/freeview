...
/********************  END of Settopbox Enums *************************/
  ...
  BCMD_KeyRamBuf_eSecretKey_End  = 0x8f, /* NOTE : End ID should NOT be used (Modular code :) */
  BCMD_KeyRamBuf_eSecretKey_Invalid  = 0x8f,  /* Second 1024 bit user ram*/
...
typedef enum BCMD_M2MSecCryptoAlg_e	 
{
    ...
    BCMD_M2MSecCryptoAlg_eMaxNumber = 18
