 ...
 *
 * $brcm_Workfile: bsp_s_otp_7601A0.h $
 * $brcm_Revision: Hydra_Software_Devel/1 $
 * $brcm_Date: 8/12/08 5:29p $
 * Broadcom Security Processor Code
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7601/a0/cust_generic/aegis/bsp_s_otp_7601A0.h $
 * 
 * Hydra_Software_Devel/1   8/12/08 5:29p atruong
...
#ifndef BSP_S_OTP_7601A0_H__
#define BSP_S_OTP_7601A0_H__
...
typedef enum BCMD_Otp_CmdMsp_e      
{
    ...
    BCMD_Otp_CmdMsp_eReserved90          = 90, /* 90 - 1 bit */
    BCMD_Otp_CmdMsp_eReserved91          = 91, /* 91 - 1 bit */
    ...
    BCMD_Otp_CmdMsp_eEnable_MSIPTV       = 96, /* 96 - 1 bit */
