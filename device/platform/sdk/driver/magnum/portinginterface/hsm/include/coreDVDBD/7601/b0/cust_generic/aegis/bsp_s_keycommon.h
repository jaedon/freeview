 ...
 * $brcm_Date: 8/29/08 3:58p $
 * Broadcom Security Processor Code
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7601/a0/cust_generic/aegis/bsp_s_keycommon.h $
 * 
 * Hydra_Software_Devel/2   8/29/08 3:58p atruong
 * PR45631: BCM97601A0 Bringup
 * 
 * Hydra_Software_Devel/1   8/12/08 5:30p atruong
 * PR45631: HSM PI support for BCM7601 platform
 * 
 * 3   6/6/08 10:28a aratim
 * PR21 : Adding HW SHARF Block.
 * 
 * 2   1/23/08 2:30p aratim
 * PR3: Ported from 7440
 * 
 * 2   1/23/08 2:30p aratim
 * PR3: Ported from 7440
 * 
 * 2   1/23/08 2:29p aratim
 * PR3: Ported from 7440
 * 
 * Aegis_Firmware_Devel/2   11/6/07 5:40p wychen
 * PR883: support swap AES Key ladder key to 64 bit Algo
 * 
 * Aegis_Firmware_Devel/6   6/21/07 11:36a wychen
 * PR660: remove unused enums, AES CBC Comcast
 * 
 * Aegis_Firmware_Devel/5   6/13/07 2:37p rjejuri
 * PR 660: cleanup and AesCbcComcast enum - removal
 * 
 ...
 * 
 * Aegis_Firmware_Devel/3   6/1/07 6:51p ksekar
 * PR 656: Add 7325A0 compile flags
 * 
 * Aegis_Firmware_Devel/2   1/31/07 4:17p whou
 * PR525: 7405A0 uses only one m2m.
 * 
