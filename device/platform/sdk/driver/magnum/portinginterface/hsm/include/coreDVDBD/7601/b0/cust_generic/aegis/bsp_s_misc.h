 ...
 * $brcm_Date: 8/25/08 10:18p $
 * Module Description: This file contains misc data structures that shall be shared with
 *					host. 
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7601/a0/cust_generic/aegis/bsp_s_misc.h $
 * 
 * Hydra_Software_Devel/2   8/25/08 10:18p atruong
 * PR45631: BCM7601A0 Bring up
 * 
 * Hydra_Software_Devel/1   8/12/08 5:29p atruong
 * PR45631: HSM PI support for BCM7601 platform
 * 
 * Aegis_Firmware_Devel/3   12/13/07 6:49p wychen
 * PR939: remove GetScArrayStatus command
 * 
 * Aegis_Firmware_Devel/2   9/7/07 6:03p wychen
