 ...
 * $brcm_Date: 2/9/07 3:57p $
 *
 * Module Description: 
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7400/a0/common/bhsm.h $
 * 
 * Hydra_Software_Devel/6   2/9/07 3:57p lyang
 * PR 27777: HSM add IRDY waiting loop, add polling support 27393
 * 
 * Hydra_Software_Devel/5   12/1/06 10:40p lyang
 ...
 * 
 * Hydra_Software_Devel/3   8/4/06 12:16a btan
