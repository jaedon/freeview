 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/src/core40nm/common/bhsm.h $
 * 
 * Hydra_Software_Devel/13   12/5/12 1:23a atruong
 * SW7563-16: HSM PI support for 7563A0
 * 
 * Hydra_Software_Devel/12   11/19/12 11:06a atruong
 * SW7584-46: HSM PI/Nexus Security support for 7584A0 SW7435-232: HSM
 * PI/Nexus Security support for 7435B0
 * 
 * Hydra_Software_Devel/11   9/21/12 11:09a qxie
 * SW7360-34:add support to 7360
 * 
 * Hydra_Software_Devel/10   9/11/12 2:51p atruong
 * SWSECURITY-175: Remove symbolic links in HSM PI
 * 
 * Hydra_Software_Devel/9   7/23/12 10:03p atruong
 * SW7429-195: Support for 7429B0
 * 
 * Hydra_Software_Devel/8   3/30/12 9:16a atruong
 * SW7435-6: Add Nexus and HSM PI Security Support
 * 
 * Hydra_Software_Devel/7   3/30/12 3:51a atruong
 * SW7435-6: Add Nexus and HSM PI Security Support
 * 
 * Hydra_Software_Devel/6   3/27/12 8:43p atruong
 * SWSECURITY-116: Bug for BHCP_VER referencing fixed
 * 
 * Hydra_Software_Devel/5   2/6/12 4:02p atruong
 * SW7429-6: HSM PI/Nexus Security Support for 7429A0
 * 
 * Hydra_Software_Devel/4   2/6/12 2:40p atruong
 * SW7429-6: HSM PI/Nexus Security Support for 7429A0
 * 
 * Hydra_Software_Devel/3   11/30/11 1:00a atruong
 * SWSECURITY-53: HSM PI code maintenance - Latest 40-nm B0 OTP map
 * 
 * Hydra_Software_Devel/2   10/17/11 10:46a atruong
...
/* To support Zeus platforms */
#define HSM_IS_ASKM_40NM 1
#if (BCHP_VER <= BCHP_VER_A1) && (BCHP_CHIP != 7429) && (BCHP_CHIP != 7435) && (BCHP_CHIP != 7360) && (BCHP_CHIP != 7563) && (BCHP_CHIP != 7584)
...
#define HSM_IS_ASKM_40NM_ZEUS_2_5 1
#endif
#if (BCHP_VER == BCHP_VER_A0) && (BCHP_CHIP == 7429)
#define HSM_IS_ASKM_40NM_ZEUS_2_0 1
#endif
#if (BCHP_VER == BCHP_VER_A0) && (BCHP_CHIP == 7360)
#define HSM_IS_ASKM_40NM_ZEUS_2_0 1
#endif
#if (BCHP_VER == BCHP_VER_A0) && (BCHP_CHIP == 7563)
#define HSM_IS_ASKM_40NM_ZEUS_2_0 1
#endif
#if (BCHP_VER == BCHP_VER_B0) && (BCHP_CHIP == 7429)
#define HSM_IS_ASKM_40NM_ZEUS_2_0 1
#if defined(HUMAX_PLATFORM_BASE) && !defined(CONFIG_CAS_NA)
#define HSM_IS_ASKM_40NM_ZEUS_2_5 1
#endif
#endif
#if (BCHP_VER >= BCHP_VER_A0) && (BCHP_CHIP == 7435)
#define HSM_IS_ASKM_40NM_ZEUS_2_0 1
#define HSM_IS_ASKM_40NM_ZEUS_2_5 1
#endif
#if (BCHP_VER >= BCHP_VER_B0) && (BCHP_CHIP == 7435)
#define HSM_IS_ASKM_40NM_ZEUS_2_0 1
#define HSM_IS_ASKM_40NM_ZEUS_2_5 1
#define HSM_IS_ASKM_40NM_ZEUS_3_0 1
#endif

#if (BCHP_VER >= BCHP_VER_A0) && (BCHP_CHIP == 7584)
#define HSM_IS_ASKM_40NM_ZEUS_2_0 1
#define HSM_IS_ASKM_40NM_ZEUS_2_5 1
#define HSM_IS_ASKM_40NM_ZEUS_3_0 1
#endif
