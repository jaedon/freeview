 ...
 * $brcm_Date: 1/14/12 2:15a $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7425/b0/keyladder/bhsm_keyladder.h $
 * 
 * Hydra_Software_Devel/2   1/14/12 2:15a atruong
 * SWSECURITY-71:Defining BHSM_FastLoadEncryptedHdcpKey for HDCP Support
 * on 40-nm
 * 
 * Hydra_Software_Devel/1   10/12/11 7:50p atruong
...
/* Port from bhdcplib.h, it should be exact same as BHDCPlib_EncryptedHdcpKeyStruct */
