 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7420/b0/common/bhsm_datatypes.h $
 * 
 * Hydra_Software_Devel/12   10/13/10 1:14p atruong
 * SW7420-1168:Added support for new BSP USER_HMAC_SHA command interface
 * 
 * Hydra_Software_Devel/11   7/13/10 3:26p atruong
 * SW7125-179: HSM PI Support for BCM7125C0
 * 
 * Hydra_Software_Devel/10   5/17/10 11:54a atruong
 * SW7468-234: HSM PI Support for BCM7468B0
 * 
 * Hydra_Software_Devel/9   5/5/10 1:35a atruong
 * SW7420-712: HSM PI Support for 7420C1
 * 
 * Hydra_Software_Devel/8   2/26/10 11:57a atruong
 * SW7342-169: HSM PI Support for 7340B0/7342B0
 * 
 * Hydra_Software_Devel/7   1/20/10 2:23a atruong
 * SW7420-554: HSM PI Support for 7420 C0
 * 
 * Hydra_Software_Devel/6   12/9/09 4:26p atruong
 * SW7468-16: HSM PI Support For 7468A0
 * 
 * Hydra_Software_Devel/5   11/24/09 1:16p atruong
 * SW7125-94: HSM PI Support for 7125 B0
 * 
 * Hydra_Software_Devel/4   8/20/09 7:18p atruong
