 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/3548/b3/common/bhsm_datatypes.h $
 * 
 * Hydra_Software_Devel/2   11/6/09 5:40p atruong
...
#elif (BCHP_CHIP==3548)&& (BCHP_VER == BCHP_VER_B3)
        #define BSP_S_CHIP_NUMBER                               BSP_S_CHIP_NUMBER_3548
        #define BSP_S_CHIP_VERSION                              BSP_S_B3_CHIP_VERSION
        #define BSP_S_ROM_NUMBER                                BSP_S_ROM_NUMBER_0
        #define BSP_MAJOR_VERSION                       0x0
        #define BSP_MINOR_VERSION                       0x0
        #define BCM3548B3

#elif (BCHP_CHIP==3548)&& (BCHP_VER == BCHP_VER_B4)
        #define BSP_S_CHIP_NUMBER                               BSP_S_CHIP_NUMBER_3548
        #define BSP_S_CHIP_VERSION                              BSP_S_B4_CHIP_VERSION
        #define BSP_S_ROM_NUMBER                                BSP_S_ROM_NUMBER_0
        #define BSP_MAJOR_VERSION                       0x0
        #define BSP_MINOR_VERSION                       0x0
        #define BCM3548B4
