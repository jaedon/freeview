 ...
 * $brcm_Date: 11/6/09 5:41p $
 *
 * Module Description: 
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/3548/b3/common/bhsm_misc.h $
 * 
 * Hydra_Software_Devel/3   11/6/09 5:41p atruong
...
#define	BHSM_OTP_ID_LEN			4		/* OTP ID is 4 bytes long for 3548B3/B4 */
...
typedef struct BHSM_ReadOTPIdIO {
	...
	/* In:   Which OTP ID to read - For compatibility - ignored if 3548B3/B4 */
