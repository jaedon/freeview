 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7400/a0/common/bhsm_priv.h $
 * 
...
typedef struct BHSM_P_InterruptCallback
{
 ...
 typedef struct BHSM_P_CAKeySlotInfo {
	...
	BHSM_P_KeySlotAlgorithm_t	aKeySlotAlgorithm[BCMD_KeyDestEntryType_eReserved0+1] ;	
