 ...
 * $brcm_Date: 4/2/07 5:36p $
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7440/b0/dvd_cmds/aegis/bsp_s_calc_media_key.h $
 * 
 * Hydra_Software_Devel/3   4/2/07 5:36p lyang
 * PR 27763: HSM to add 2 new PIs to support 7440B0
 * 
 * Hydra_Software_Devel/2   3/5/07 9:10p lyang
 * PR 27763: HSM to add a new PI to support 7440B0
 * 
 * Hydra_Software_Devel/1   11/28/06 10:51a btan
...
/* WHy do you need these??? */
    BCMD_UserMediaKey_CmdOutputField_TK0       = (0x10 << 2),          
    BCMD_UserMediaKey_CmdOutputField_TK1       = (0x14 << 2),          
    BCMD_UserMediaKey_CmdOutputField_Decrypt_TK0       = (0x18 << 2),          
    BCMD_UserMediaKey_CmdOutputField_Decrypt_TK1       = (0x1c << 2),          
    BCMD_UserMediaKey_CmdOutputField_keyMap       = (0x20 << 2),          
    BCMD_UserMediaKey_CmdOutputField_ContentKey0  = (0x22 << 2),          
    BCMD_UserMediaKey_CmdOutputField_ContentKey0_AES_D  = (0x26 << 2),          
    BCMD_UserMediaKey_CmdOutputField_ContentKey0_AES_G  = (0x2a << 2),          

	BCMD_UserMediaKey_CmdOutputField_eEnd
};
