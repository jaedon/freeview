 ...
 * Revision History:$
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7601/a0/common/aegis/bsp_s_mode_config.h $
 * 
 * Hydra_Software_Devel/1   8/12/08 4:42p atruong
 * PR45631: HSM PI support for BCM7601 platform
 * 
 * Aegis_Firmware_Devel/8   8/14/06 9:12a btan
 * PR  385 : Fixed a few minor compilation issues.
 * 
 * Aegis_Firmware_Devel/7   3/6/06 1:02a btan
 * PR 302: Modified ACL for After First ACL review (03/03/06) and 7401B0
 * OTP Bit Map
 * 
 * Aegis_Firmware_Devel/6   12/22/05 2:15p btan
 * PR 228: Remove ForceDRAM from mode_config.
 * 
 * Aegis_Firmware_Devel/5   9/19/05 7:02p btan
 * PR 185: Updated the shared file for host compilation
 * 
 * Aegis_Firmware_Devel/4   8/19/05 6:27a btan
 * PR 121: Fixed some typos.
 * 
 * Aegis_Firmware_Devel/3   8/19/05 5:46a btan
 * PR 121: Modified the input and output commands to conform with coding
 * convention.
 * 
 * Aegis_Firmware_Devel/2   7/10/05 4:18a btan
 * PR 42: Edited code for E* review
 * 
