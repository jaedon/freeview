 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7601/a0/common/bhsm_user_cmds.c $
 * 
 * Hydra_Software_Devel/5   9/15/09 12:26a atruong
 * SW7630-18: HSM PI Support for 7630B0
 * 
 * Hydra_Software_Devel/4   4/23/09 10:25a atruong
 * PR54377: Remove length checking for output parameters
 * 
 * Hydra_Software_Devel/3   3/30/09 12:26p atruong
...
#if (BCHP_CHIP != 7440) && (BCHP_CHIP != 7601) && (BCHP_CHIP != 7635) && (BCHP_CHIP != 7630)
		&&
