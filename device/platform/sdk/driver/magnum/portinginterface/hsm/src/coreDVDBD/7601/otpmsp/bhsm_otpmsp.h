 ...
 * $brcm_Date: 9/15/09 12:32a $
 *
 * Module Description: 
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/7601/a0/otpmsp/bhsm_otpmsp.h $
 * 
 * Hydra_Software_Devel/4   9/15/09 12:32a atruong
 * SW7630-18: HSM PI Support for 7630B0
 * 
 * Hydra_Software_Devel/3   4/1/09 11:10a atruong
 * PR52979: Support for BCM7635A0
 * 
 * Hydra_Software_Devel/2   12/4/08 1:08p atruong
...
#if ((BCHP_CHIP==7630) && (BCHP_VER >= BCHP_VER_B0))
