 ...
 *
 * $brcm_Workfile: chip_secure_35230.h $
 * $brcm_Revision: Hydra_Software_Devel/2 $
 * $brcm_Date: 6/8/10 5:23p $
 *
 * Module Description:
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/35230/a0/common/chip_secure_35230.h $
 * 
 * Hydra_Software_Devel/2   6/8/10 5:23p cdisc
 * SW35230-277: HSM: ICAM needs to be disabled in the secure RDB before
 * XPT will put data in CDB
 * 
 ...
 ***************************************************************************/
#define XPT_SECURITY_MULTI2_SK0_0      0x00770000 /* Multi2 system key0 bits [31:0] */
#define XPT_SECURITY_MULTI2_SK0_1      0x00770004 /* Multi2 system key0 bits [63:32] */
#define XPT_SECURITY_MULTI2_SK0_2      0x00770008 /* Multi2 system key0 bits [95:64] */
#define XPT_SECURITY_MULTI2_SK0_3      0x0077000c /* Multi2 system key0 bits [127:96] */
#define XPT_SECURITY_MULTI2_SK0_4      0x00770010 /* Multi2 system key0 bits [159:128] */
#define XPT_SECURITY_MULTI2_SK0_5      0x00770014 /* Multi2 system key0 bits [191:160] */
#define XPT_SECURITY_MULTI2_SK0_6      0x00770018 /* Multi2 system key0 bits [223:192] */
#define XPT_SECURITY_MULTI2_SK0_7      0x0077001c /* Multi2 system key0 bits [255:224] */
#define XPT_SECURITY_MULTI2_SK1_0      0x00770020 /* Multi2 system key1 bits [31:0] */
#define XPT_SECURITY_MULTI2_SK1_1      0x00770024 /* Multi2 system key1 bits [63:32] */
#define XPT_SECURITY_MULTI2_SK1_2      0x00770028 /* Multi2 system key1 bits [95:64] */
#define XPT_SECURITY_MULTI2_SK1_3      0x0077002c /* Multi2 system key1 bits [127:96] */
#define XPT_SECURITY_MULTI2_SK1_4      0x00770030 /* Multi2 system key1 bits [159:128] */
#define XPT_SECURITY_MULTI2_SK1_5      0x00770034 /* Multi2 system key1 bits [191:160] */
#define XPT_SECURITY_MULTI2_SK1_6      0x00770038 /* Multi2 system key1 bits [223:192] */
#define XPT_SECURITY_MULTI2_SK1_7      0x0077003c /* Multi2 system key1 bits [255:224] */
#define XPT_SECURITY_MULTI2_RC0        0x00770040 /* Multi2 system key0 round count */
#define XPT_SECURITY_MULTI2_RC1        0x00770044 /* Multi2 system key1 round count */
#define XPT_SECURITY_SECURITY_CTRL     0x00770048 /* Security Control Register */
#define XPT_SECURITY_SC_ARRAY0         0x0077004c /* Scrambling Control Array, PID channel 15 - 0 */
#define XPT_SECURITY_SC_ARRAY1         0x00770050 /* Scrambling Control Array, PID channel 31 - 16 */
#define XPT_SECURITY_SC_ARRAY2         0x00770054 /* Scrambling Control Array, PID channel 47 - 32 */
#define XPT_SECURITY_SC_ARRAY3         0x00770058 /* Scrambling Control Array, PID channel 63 - 48 */
#define XPT_SECURITY_SC_ARRAY4         0x0077005c /* Scrambling Control Array, PID channel 79 - 64 */
#define XPT_SECURITY_SC_ARRAY5         0x00770060 /* Scrambling Control Array, PID channel 95 - 80 */
#define XPT_SECURITY_SC_ARRAY6         0x00770064 /* Scrambling Control Array, PID channel 111 - 96 */
#define XPT_SECURITY_SC_ARRAY7         0x00770068 /* Scrambling Control Array, PID channel 127 - 112 */
#define XPT_SECURITY_SC_FORCE_CTRL_IBP0 0x0077006c /* SC Force Control for IBP0 */
#define XPT_SECURITY_SC_FORCE_CTRL_IBP1 0x00770070 /* SC Force Control for IBP1 */
#define XPT_SECURITY_SC_FORCE_CTRL_IBP2 0x00770074 /* SC Force Control for IBP1 */
#define XPT_SECURITY_SC_FORCE_CTRL_IBP3 0x00770078 /* SC Force Control for IBP1 */
#define XPT_SECURITY_SC_FORCE_CTRL_IBP4 0x0077007c /* SC Force Control for IBP1 */
#define XPT_SECURITY_SC_FORCE_CTRL_IBP5 0x00770080 /* SC Force Control for IBP1 */
#define XPT_SECURITY_SC_FORCE_CTRL_IBP6 0x00770084 /* SC Force Control for IBP1 */
#define XPT_SECURITY_SC_FORCE_CTRL_PBP0 0x00770088 /* SC Force Control for PBP0 */
#define XPT_SECURITY_SC_FORCE_CTRL_PBP1 0x0077008c /* SC Force Control for PBP0 */
#define XPT_SECURITY_SC_FORCE_CTRL_PBP2 0x00770090 /* SC Force Control for PBP0 */
#define XPT_SECURITY_SC_FORCE_CTRL_PBP3 0x00770094 /* SC Force Control for PBP0 */
#define XPT_SECURITY_SECURITY_ERROR    0x00770098 /* Security Errors */
#define XPT_SECURITY_PROC_IN_LO        0x0077009c /* Proc_in LSW */
#define XPT_SECURITY_PROC_IN_HI        0x007700a0 /* Proc_in MSW */
#define XPT_SECURITY_KEYGEN_CTRL       0x007700a4 /* Key Ladder Control */
#define XPT_SECURITY_RNG_WORD          0x007700a8 /* Random number Output Word */
#define XPT_SECURITY_RNG_CTRL          0x007700ac /* RNG Control */
#define XPT_SECURITY_RNG_STATUS        0x007700b0 /* RNG Status */
#define XPT_SECURITY_CR_RESET_LOCK_RELEASE 0x007700b4 /* CR Reset Lock Release */
#define XPT_SECURITY_RBG_DBG           0x007700b8 /* RBG100 debug */
#define XPT_SECURITY_KEY_POINTER0      0x00770400 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER1      0x00770404 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER2      0x00770408 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER3      0x0077040c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER4      0x00770410 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER5      0x00770414 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER6      0x00770418 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER7      0x0077041c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER8      0x00770420 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER9      0x00770424 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER10     0x00770428 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER11     0x0077042c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER12     0x00770430 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER13     0x00770434 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER14     0x00770438 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER15     0x0077043c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER16     0x00770440 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER17     0x00770444 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER18     0x00770448 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER19     0x0077044c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER20     0x00770450 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER21     0x00770454 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER22     0x00770458 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER23     0x0077045c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER24     0x00770460 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER25     0x00770464 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER26     0x00770468 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER27     0x0077046c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER28     0x00770470 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER29     0x00770474 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER30     0x00770478 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER31     0x0077047c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER32     0x00770480 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER33     0x00770484 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER34     0x00770488 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER35     0x0077048c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER36     0x00770490 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER37     0x00770494 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER38     0x00770498 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER39     0x0077049c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER40     0x007704a0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER41     0x007704a4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER42     0x007704a8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER43     0x007704ac /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER44     0x007704b0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER45     0x007704b4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER46     0x007704b8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER47     0x007704bc /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER48     0x007704c0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER49     0x007704c4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER50     0x007704c8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER51     0x007704cc /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER52     0x007704d0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER53     0x007704d4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER54     0x007704d8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER55     0x007704dc /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER56     0x007704e0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER57     0x007704e4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER58     0x007704e8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER59     0x007704ec /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER60     0x007704f0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER61     0x007704f4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER62     0x007704f8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER63     0x007704fc /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER64     0x00770500 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER65     0x00770504 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER66     0x00770508 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER67     0x0077050c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER68     0x00770510 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER69     0x00770514 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER70     0x00770518 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER71     0x0077051c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER72     0x00770520 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER73     0x00770524 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER74     0x00770528 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER75     0x0077052c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER76     0x00770530 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER77     0x00770534 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER78     0x00770538 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER79     0x0077053c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER80     0x00770540 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER81     0x00770544 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER82     0x00770548 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER83     0x0077054c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER84     0x00770550 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER85     0x00770554 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER86     0x00770558 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER87     0x0077055c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER88     0x00770560 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER89     0x00770564 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER90     0x00770568 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER91     0x0077056c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER92     0x00770570 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER93     0x00770574 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER94     0x00770578 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER95     0x0077057c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER96     0x00770580 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER97     0x00770584 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER98     0x00770588 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER99     0x0077058c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER100    0x00770590 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER101    0x00770594 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER102    0x00770598 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER103    0x0077059c /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER104    0x007705a0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER105    0x007705a4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER106    0x007705a8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER107    0x007705ac /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER108    0x007705b0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER109    0x007705b4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER110    0x007705b8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER111    0x007705bc /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER112    0x007705c0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER113    0x007705c4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER114    0x007705c8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER115    0x007705cc /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER116    0x007705d0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER117    0x007705d4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER118    0x007705d8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER119    0x007705dc /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER120    0x007705e0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER121    0x007705e4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER122    0x007705e8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER123    0x007705ec /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER124    0x007705f0 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER125    0x007705f4 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER126    0x007705f8 /* Key pointer table */
#define XPT_SECURITY_KEY_POINTER127    0x007705fc /* Key pointer table */


/****************************************************************************
 * BCM35230_XPT_SECTOP_35130_XPT_OTP
 ***************************************************************************/
#define XPT_OTP_CONFIGURE              0x00778000 /* OTP Configuration Register */
#define XPT_OTP_PROG_SIGNALS           0x00778004 /* OTP Programming Signals Register */
#define XPT_OTP_PROG_DATA              0x00778008 /* OTP Programming Signals Register - Row data */
#define XPT_OTP_SIGNAL_READ            0x0077800c /* OTP Status Signals Read Register */
#define XPT_OTP_FLT_STAT               0x00778010 /* OTP Fault Status Register */
#define XPT_OTP_FLT_STAT_KEYA          0x00778014 /* OTP Fault Status Register */
#define XPT_OTP_FLT_STAT_HASH          0x00778018 /* OTP Fault Status Register */
#define XPT_OTP_ID_WORD_LO             0x0077801c /* OTP ID Word LSBs Register */
#define XPT_OTP_ID_WORD_HI             0x00778020 /* OTP ID Word MSBs Register */
#define XPT_OTP_MAC_WORD_LO            0x00778024 /* OTP MAC Word LSBs Register */
#define XPT_OTP_MAC_WORD_HI            0x00778028 /* OTP MAC Word MSBs Register */
#define XPT_OTP_TIMEOUTS               0x0077802c /* OTP Timeouts Register */
#define XPT_OTP_MC1_BASE               0x00778030 /* OTP MC1 Base Register */
#define XPT_OTP_MC1_EXT_LO             0x00778034 /* OTP MC1 Extended Register */
#define XPT_OTP_MC1_EXT_HI             0x00778038 /* OTP MC1 Extended Register */
#define XPT_OTP_MSP_WORD_0             0x0077803c /* OTP MSP Word Register */
#define XPT_OTP_MSP_WORD_1             0x00778040 /* OTP MSP Word Register */
#define XPT_OTP_MSP_WORD_2             0x00778044 /* OTP MSP Word Register */
#define XPT_OTP_MSP_WORD_3             0x00778048 /* OTP MSP Word Register */
#define XPT_OTP_MC1_BASE_LOCK          0x0077804c /* OTP MC1 Base Register */
#define XPT_OTP_MC1_EXT_LO_LOCK        0x00778050 /* OTP MC1 Extended Register */
#define XPT_OTP_MC1_EXT_HI_LOCK        0x00778054 /* OTP MC1 Extended Register */
#define XPT_OTP_MSP_WORD_0_LOCK        0x00778058 /* OTP MSP Word Register */
#define XPT_OTP_MSP_WORD_1_LOCK        0x0077805c /* OTP MSP Word Register */
#define XPT_OTP_MSP_WORD_2_LOCK        0x00778060 /* OTP MSP Word Register */
#define XPT_OTP_MSP_WORD_3_LOCK        0x00778064 /* OTP MSP Word Register */
#define XPT_OTP_OTP_SRAM_WRITE_CTRL    0x0077806c /* OTP SRAM WRITE CONTROL */
#define XPT_OTP_OTP_SRAM_WRITE_DATA_0  0x00778070 /* OTP SRAM WRITE CONTROL */
#define XPT_OTP_KEYA_BADFLAG_HI        0x00778074 /* OTP KEYA BAD FLAGS */
#define XPT_OTP_KEYA_BADFLAG_LO        0x00778078 /* OTP KEYA BAD FLAGS */
#define XPT_OTP_RDNT_BADFLAG           0x0077807c /* OTP RDNT BAD FLAGS */
#define XPT_OTP_IF_SEL                 0x00778080 /* OTP Interface Select */
#define XPT_OTP_PROG_PATTERN           0x00778084 /* OTP Programming Pattern */
#define XPT_OTP_PATTERN_DBG            0x00778088 /* OTP Programming Pattern Debug information" */
#define XPT_OTP_GLITCH                 0x0077808c /* OTP Glitch vectors */
#define XPT_OTP_GLITCH_1               0x00778090 /* OTP Glitch vectors */
#define XPT_OTP_GLITCH_2               0x00778094 /* OTP Glitch vectors */
#define XPT_OTP_HASH_0                 0x00778098 /* OTP Hash */
#define XPT_OTP_HASH_1                 0x0077809c /* OTP Hash */
#define XPT_OTP_HASH_2                 0x007780a0 /* OTP Hash */
#define XPT_OTP_HASH_3                 0x007780a4 /* OTP Hash */
#define XPT_OTP_HASH_4                 0x007780a8 /* OTP Hash */
#define XPT_OTP_PROG_DBG_SIGNALS_1     0x007780ac /* OTP Programming Signals Register */
#define XPT_OTP_PROG_DBG_SIGNALS_2     0x007780b0 /* OTP Programming Signals Register */
#define XPT_OTP_OTP_RD_DATA            0x007780b4 /* OTP Read Data Register */
#define XPT_OTP_WRP_STATUS             0x007780b8 /* OTP Wrapper Status Register */


/****************************************************************************
 * BCM35230_XPT_SECTOP_35130_XPT_MMSCRAM
 ***************************************************************************/
#define XPT_MMSCRAM_SECURITY_CTRL      0x00779000 /* Security Control Register */
#define XPT_MMSCRAM_DTV_MSC_CTRL       0x00779004 /* DTV Local Scrambling MSC Control */
#define XPT_MMSCRAM_ENDIAN_SWAP        0x00779008 /* 32 bit word byte swap control */
#define XPT_MMSCRAM_MMSCRAM_ERROR      0x0077900c /* Security Errors */


/****************************************************************************
 * BCM35230_XPT_SECTOP_35130_MEM_DMA
 ***************************************************************************/
#define MEM_DMA_REVISION               0x0077a000 /* MEM_DMA REVISION */
#define MEM_DMA_FIRST_DESC             0x0077a004 /* MEM_DMA First Descriptor Address Register */
#define MEM_DMA_CTRL                   0x0077a008 /* MEM_DMA Control Register */
#define MEM_DMA_WAKE_CTRL              0x0077a00c /* MEM_DMA Wake Control Register */
#define MEM_DMA_STATUS                 0x0077a014 /* MEM_DMA Status Register */
#define MEM_DMA_CUR_DESC               0x0077a018 /* MEM_DMA Current Descriptor Address Register */
#define MEM_DMA_CUR_BYTE               0x0077a01c /* MEM_DMA Current Byte Count Register */
#define MEM_DMA_SCRATCH                0x0077a024 /* MEM_DMA Scratch Register */


/****************************************************************************
 * BCM35230_XPT_SECTOP_35130_MEM_DMA_SECURE
 ***************************************************************************/
#define MEM_DMA_SECURE_RSV_S           0x0077b000 /* RESERVED */
#define MEM_DMA_SECURE_RSV_E           0x0077b00c /* RESERVED */
