 ...
 * $brcm_Date: 9/12/12 12:40a $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/hsm/src/coreNoBSP/35230/keyladder/bhsm_keyladder.c $
 * 
 * Hydra_Software_Devel/1   9/12/12 12:40a atruong
...
)
{
	...
	regVal2 =	((inp_configAlgorithmIO->cryptoAlg.m2mCryptAlg.bEnableTimestamp << XPT_MMSCRAM_KEY_TABLE_KEY_MODE_HI_TIMESTSMP_EN_SHIFT ) & XPT_MMSCRAM_KEY_TABLE_KEY_MODE_HI_TIMESTSMP_EN_MASK) |
			...
			((inp_configAlgorithmIO->cryptoAlg.m2mCryptAlg.bDisallow_GR << XPT_MMSCRAM_KEY_TABLE_KEY_MODE_HI_DISALLOW_GR_MASK) & XPT_MMSCRAM_KEY_TABLE_KEY_MODE_HI_DISALLOW_GR_MASK) |
