 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/led/7405/bled.h $
 * 
 * Hydra_Software_Devel/7   7/20/12 6:42p jkim
 * SWNOOS-541: Add support for HW driven HH:MM clock LED display.
 * 
 * Hydra_Software_Devel/6   11/11/03 11:59a brianlee
 * Added LED character definitions.
 * 
 * Hydra_Software_Devel/5   11/6/03 4:12p lseverin
 * updated module overview for DocJet format
 * 
 * Hydra_Software_Devel/4   10/1/03 11:41a brianlee
 * Fixed sample code.
 * 
 * Hydra_Software_Devel/3   9/25/03 12:08p brianlee
 * Fixed tags for Midas service generator.
 * 
 * Hydra_Software_Devel/2   9/23/03 10:13a brianlee
 * LED does not need interrupt.
 * 
 * Hydra_Software_Devel/1   7/25/03 4:47p brianlee
 * Initial version.
 * 
 ***************************************************************************/
...
/* used by HLCD */
#define DIGIT1_OFFSET 	(0x1C)
#define DIGIT2_OFFSET 	(0x18)
#define DIGIT3_OFFSET 	(0x24)
#define DIGIT4_OFFSET 	(0x20)
