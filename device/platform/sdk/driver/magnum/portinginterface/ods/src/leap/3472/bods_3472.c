 ...
 *
 * $brcm_Workfile: bods_3472.c $
 * $brcm_Revision: Hydra_Software_Devel/3 $
 * $brcm_Date: 12/4/12 4:46p $
 *
 * Module Description:
 *
 * [File Description:]
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/ods/src/leap/3472/bods_3472.c $
 * 
 * Hydra_Software_Devel/3   12/4/12 4:46p atanugul
 * SW3472-34: Add Support for GetVersionInfo() API
 * 
 * Hydra_Software_Devel/2   7/16/12 11:52a atanugul
