...
* Revision History:
*
* $brcm_Log: /magnum/portinginterface/rap/base/brap_spdiffm_priv.h $
* 
* Hydra_Software_Devel/28   11/21/09 7:00a srajapur
...
* 
* Hydra_Software_Devel/27   8/13/08 2:36p bhanus
...
* 
* Hydra_Software_Devel/26   5/19/08 5:25p srajapur
* PR42245 : [7400] Added 7.1 Channel Pass-Thru Support for DDP on HDMI
* output
* 
* Hydra_Software_Devel/25   4/30/08 12:12p gdata
...
#define BRAP_SPDIFFM_ASYNC_TX_RE_ENABLE     0
#endif
...
/***************************************************************************
Summary:
    SPDIF Formatter can be bypassed for a particular stream

Description:
    This function is called to bypass SPDIF Formatter for the specified stream
