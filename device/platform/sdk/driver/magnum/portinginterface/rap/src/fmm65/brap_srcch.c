...
* Revision History:
*
* $brcm_Log: /magnum/portinginterface/rap/base3/brap_srcch.c $
* 
* Hydra_Software_Devel/7   6/18/09 11:50a gautamk
* PR56010: [7405] using BKNI_Sleep(1) instead of some higher value.
* 
* Hydra_Software_Devel/6   6/12/09 3:37p gautamk
* PR53302: [7405] Merging cleanup code to mainline
* 
* Hydra_Software_Devel/5   2/13/09 5:01p gautamk
* PR51897: [7405] using SHaredPP Path type incase of Playback and capture
* channel for 7405
* 
* Hydra_Software_Devel/4   2/5/09 12:48p gautamk
* PR48850: [7405] correcting debug messages
* 
* Hydra_Software_Devel/3   2/2/09 3:19p gautamk
* PR48683: [7405] Correcting the stopping sequence of FMM blocks as per
* RDB description.
* 
* Hydra_Software_Devel/2   9/9/08 6:52p sushmit
...
* 
* Hydra_Software_Devel/Rap_NewFwArch/5   7/9/08 10:09a speter
* PR 44660:[3548,3556] Merging the Phase 1.5 release branch code to main
* line of development
* 
* Hydra_Software_Devel/Rap_NewFwArch/4   6/24/08 7:02a speter
* PR 38950: [3548,3556] Adding support for SPDIF In without DSP
* 
* Hydra_Software_Devel/Rap_NewFwArch/3   6/12/08 1:28p gautamk
* PR43465: [7405] Not overwriting the states in case of watchdog recovery
* 
* Hydra_Software_Devel/Rap_NewFwArch/2   4/22/08 2:22p gautamk
* PR41994: [7405] Using BCHP_VER_ Correctly...
* 
* Hydra_Software_Devel/Rap_NewFwArch/1   4/8/08 2:09p gautamk
* PR34648: [7405] Merging wdog code to mainline
* 
* Hydra_Software_Devel/Rap_NewFwArch/RAP_NEWFWARCH_WDOG/1   3/28/08 4:09p gautamk
