...
* Revision History:
*
* $brcm_Log: /magnum/portinginterface/rap/src/fmm65/firmware/zsp500/brap_img.c $
* 
* Hydra_Software_Devel/1   9/11/12 4:58p srajapur
* SW7420-2341:Remove symbolic links and flatten the RAP directory
* 
* Hydra_Software_Devel/NEW_DIR_SW7420_2341/1   9/7/12 4:10p srajapur
* SW7420-2341:Remove symbolic links and flatten the RAP directory
* 
