...
*
*****************************************************************************/
#ifndef _BSAT_45216_PRIV_H_
#define _BSAT_45216_PRIV_H_
...
#define BSAT_45216_MAX_CHANNELS 16

#define BSAT_45216_CHK_RETCODE(x) \
...
See Also:
   None.
****************************************************************************/
typedef struct BSAT_45216_P_Handle
{
   BHAB_Handle      hHab;
...
See Also:
   None.
****************************************************************************/
typedef struct BSAT_45216_P_ChannelHandle
{
...
BERR_Code BSAT_45216_P_GetVersionInfo(BSAT_Handle h, BFEC_VersionInfo *pVersion);
...
BERR_Code BSAT_45216_P_IsChannelOn(BSAT_ChannelHandle, bool*);
...
BERR_Code BSAT_45216_P_SetNotchSettings(BSAT_Handle, uint32_t, BSAT_NotchSettings*);
BERR_Code BSAT_45216_P_GetNotchSettings(BSAT_Handle, uint32_t*, BSAT_NotchSettings*);
BERR_Code BSAT_45216_P_GetTraceInfo(BSAT_ChannelHandle h, BSAT_TraceInfo*);
BERR_Code BSAT_45216_P_SetExternalBertSettings(BSAT_Handle h, BSAT_ExternalBertSettings*);
BERR_Code BSAT_45216_P_GetExternalBertSettings(BSAT_Handle h, BSAT_ExternalBertSettings*);
