 ...
 * 
 * Hydra_Software_Devel/27   9/25/13 1:53p vishk
 * SW7231-1268: Add support for 16-bit transfer for 97429/97241 platforms.
 * 
 * Hydra_Software_Devel/26   1/31/13 4:52p alexc
 * SW7145-27: Add 7145 support
 * 
 * Hydra_Software_Devel/25   10/19/12 11:16a brianlee
 * SW7208-202: Added HIF support for 7346.
 * 
...
#if (BCHP_CHIP==7358) || (BCHP_CHIP==7468) || (BCHP_CHIP==7208) || (BCHP_CHIP==7346) || (BCHP_CHIP==7145)
...
#if (BCHP_CHIP==7429)
#define UPG_MSPI_SUPPORTS_16BIT_TRANSFER  	1
#else
