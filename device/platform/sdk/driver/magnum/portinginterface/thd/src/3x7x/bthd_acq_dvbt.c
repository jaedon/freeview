...
* $brcm_Date: 9/7/12 9:34a $
*
* [File Description:]
*
* Revision History:
*
* $brcm_Log: /magnum/portinginterface/thd/src/3x7x/bthd_acq_dvbt.c $
* 
* Hydra_Software_Devel/1   9/7/12 9:34a farshidf
* SW7425-3819: Remove symbolic links and flatten out THD directory
* structure
* 
* Hydra_Software_Devel/1   8/27/12 3:13p farshidf
...
#include "../../../../../../AP/ctfe/core/thd/bthd_acq_dvbt.c" 