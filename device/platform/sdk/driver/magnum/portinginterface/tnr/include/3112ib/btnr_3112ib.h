 ...
 *
 * $brcm_Workfile: btnr_3112ib.h $
 * $brcm_Revision: Hydra_Software_Devel/1 $
 * $brcm_Date: 3/11/09 3:23p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: //fs-irva-74/stbdev/vishk/win_views/nexus_latest/magnum/portinginterface/tnr/3112ib/btnr_3112ib.h $
 * 
 * Hydra_Software_Devel/1   3/11/09 3:23p vishk
