 ...
 *
 * $brcm_Workfile: btnr_3117ib.c $
 * $brcm_Revision: Hydra_Software_Devel/4 $
 * $brcm_Date: 6/22/10 6:04p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/tnr/3117ib/btnr_3117ib.c $
 * 
 * Hydra_Software_Devel/4   6/22/10 6:04p vishk
 * SW7420-839: Add support to program AGC gain to 31xx TNR PI
 * 
 * Hydra_Software_Devel/3   8/21/09 6:13p vishk
...
BDBG_MODULE(btnr_3117ib);

#define DEV_MAGIC_ID                    ((BERR_TNR_ID<<16) | 0xFACE)
#define BTNR_3117Ib_SETTINGS_I2CADDR    (0x66)          /* 7bit addr */

/*******************************************************************************/
BERR_Code BTNR_3117Ib_Open(
    BTNR_Handle *phDev,                 /* [output] Returns handle */
    BTNR_3117Ib_Settings *pSettings, /* [Input] settings structure */
    ...
    )
{
    ...
    if( h31xxIbDev == NULL )
    {
        ...
        BDBG_ERR(("BTNR_3117Ib_Open: BKNI_malloc() failed\n"));
        goto done;
    }
    ...
    )
{
    ...
    pDefSettings->i2cAddr = BTNR_3117Ib_SETTINGS_I2CADDR;
