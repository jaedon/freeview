 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/vbi/7405/bvbi_a656.c $
 * 
 * Hydra_Software_Devel/6   8/21/12 4:47p darnstein
 ...
 * 
 * Hydra_Software_Devel/5   10/4/10 3:49p darnstein
 * SW7422-46: porting work for 7422 and 7425 broke the build for older
 * chipsets.
 * 
 * Hydra_Software_Devel/4   1/14/10 6:05p darnstein
 * SW7550-120: Add support for SECAM variants.
 * 
 * Hydra_Software_Devel/3   2/20/09 12:16p darnstein
 * PR49987: apply parity bits to DID byte, for SMPTE-291M ancillary data
 * packets.
 * 
...
#endif /** } (BVBI_P_NUM_ANCI656_656 > 0) **/
