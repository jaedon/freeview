 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/vbi/7405/bvbi_in656.c $
 * 
 * Hydra_Software_Devel/6   8/21/12 4:48p darnstein
 ...
 * 
 * Hydra_Software_Devel/5   1/14/10 6:05p darnstein
 * SW7550-120: Add support for SECAM variants.
 * 
 * Hydra_Software_Devel/4   2/20/09 12:21p darnstein
 * PR49987: shorten ADP detection window. This prevents false error
 * reports. Also, add a missing piece of logic for the bBrokenDataCount
 * option.
 * 
 * Hydra_Software_Devel/3   12/4/08 3:33p darnstein
 * PR45819: fix up #if statements for chip types.
 * 
