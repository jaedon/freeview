 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/vbi/7420/bvbi_tte.c $
 * 
 * Hydra_Software_Devel/12   8/10/12 3:32p pntruong
 * SW7435-276: Updated NTSC/480p to 720x480i/720x480p respectively.
 * Added support 482i/483p with new enums.
 *
 * Hydra_Software_Devel/11   8/2/12 1:18p darnstein
 * SW7125-1311: with regards to teletext, handle PAL-M in same way as NTSC
 * and NTSC-J.
 *
 * Hydra_Software_Devel/10   2/20/12 2:53p darnstein
 * SW7425-2434: more detail in error messages.
 *
 * Hydra_Software_Devel/9   2/20/12 12:56p darnstein
 * SW7425-2434: when an unsupported video format is entered, the BDBG
 * error message should be informative.
 *
 * Hydra_Software_Devel/8   12/21/09 7:01p darnstein
 * SW7550-120: Add support for SECAM variants.
 *
 * Hydra_Software_Devel/7   6/30/09 5:51p darnstein
 * PR56342: support for 7550 chipset.
 *
 * Hydra_Software_Devel/6   6/24/09 5:39p darnstein
 * PR56342: BVBI compiles for 7550 chipset now.
 *
 * Hydra_Software_Devel/5   4/17/09 6:27p darnstein
 * PR54282: On big-endian systems, do a 32-bit swap on the teletext line
 * bitmask.
 *
 * Hydra_Software_Devel/4   4/13/09 3:26p darnstein
 * PR54117: At the request of a 97405 customer, allow NABTS to occupy
 * video lines as late as line 22.
 *
...
***************************************************************************/
#if (BVBI_P_NUM_TTE >= 1) || (BVBI_P_NUM_TTE_656 >= 1)
