 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/vce/7425/bvce.h $
 * 
...
typedef struct BVCE_Channel_OpenSettings
{
      ...
      BVCE_MultiChannelMode eMultiChannelMode;
...
typedef enum BVCE_Channel_StopMode
{
   ...
   BVCE_Channel_StopMode_eImmediate, /* Encoder will stop as fast as possible.
                                      ...
                                      * The ES stream may not end with a proper EOS
                                      */
...
typedef struct BVCE_Channel_UserData_Status
{
        unsigned uiPendingBuffers; /* Buffers pending */
        unsigned uiCompletedBuffers; /* Buffers completed since previous call to BVCE_Channel_GetStatusUserDataBuffers_isr() */
} BVCE_Channel_UserData_Status;
