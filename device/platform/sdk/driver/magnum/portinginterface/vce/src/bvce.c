 ...
 * $brcm_Revision: Hydra_Software_Devel/219 $
 * $brcm_Date: 10/17/12 4:52p $
 *
 * [File Description:]
 *
 * Revision History:
         ...
         )
{
   ...
   BDBG_ERR(("ARC[%d] Watchdog!", iParam));
         ...
         )
{
...
#if BVCE_P_POLL_FW_MBX
   {
...
#endif
	 {
	   ...
	   BDBG_MSG(("ARC[0] PC = %08x, STATUS32 = %08x, L2 = %08x, Host2Vice %08x",
	             BREG_Read32(
	                         hVce->handles.hReg,
	                         hVce->stPlatformConfig.stDebug.uiPicArcPC
	                         ),
         ...
         )
{
   ...
   hVce->fw.stCommand.type.stInit.VerificationModeFlag = hVce->stOpenSettings.bVerificationMode ? 1 : 0;
   ...
   {
      BDBG_ERR(("API Version Mismatch: Expected 0x%08x but got 0x%08x", VICE2_API_VERSION, hVce->fw.stResponse.type.stInit.FwApiVersion ));
   }
         ...
         )
{
   ...
   hVce->fw.stCommand.type.stOpenChannel.MultiChannelMode = BVCE_P_MultiChannelModeLUT[hVceCh->stOpenSettings.eMultiChannelMode];
...
static const uint32_t BVCE_P_ProtocolLUT[BVCE_P_VIDEOCOMPRESSIONSTD_MAX + 1] =
{
 ENCODING_STD_H264,                              /* H.264 */
 ENCODING_STD_MPEG2,                            /* MPEG-2 */
 BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* H.261 */
 BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* H.263 */
 BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* VC1 Advanced profile */
 BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* MPEG-1 */
 BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* MPEG-2 DirecTV DSS ES */
 ENCODING_STD_VC1,                              /* VC1 Simple & Main profile */
 ENCODING_STD_MPEG4,                            /* MPEG 4, Part 2. */
 BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* AVS Jinzhun profile. */
 BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* MPEG-2 DirecTV DSS PES */
 BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* Scalable Video Codec */
 BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* Scalable Video Codec Base Layer */
 BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* MVC Multi View Coding */
};
...
static const uint32_t BVCE_P_ProfileVC1LUT[BAVC_VideoCompressionProfile_eMax] =
{
 BVCE_P_VIDEOCOMPRESSIONPROFILE_UNSUPPORTED, /* BAVC_VideoCompressionProfile_eUnknown */
 BVCE_P_VIDEOCOMPRESSIONPROFILE_UNSUPPORTED, /* BAVC_VideoCompressionProfile_eSimple */
 ENCODING_VC1_PROFILE_MAIN, /* BAVC_VideoCompressionProfile_eMain */
 BVCE_P_VIDEOCOMPRESSIONPROFILE_UNSUPPORTED, /* BAVC_VideoCompressionProfile_eHigh */
 BVCE_P_VIDEOCOMPRESSIONPROFILE_UNSUPPORTED, /* BAVC_VideoCompressionProfile_eAdvance */
 BVCE_P_VIDEOCOMPRESSIONPROFILE_UNSUPPORTED, /* BAVC_VideoCompressionProfile_eJizhun */
 BVCE_P_VIDEOCOMPRESSIONPROFILE_UNSUPPORTED, /* BAVC_VideoCompressionProfile_eSnrScalable */
...
static const uint32_t BVCE_P_LevelVC1LUT[BAVC_VideoCompressionLevel_eMax] =
{
 BVCE_P_VIDEOCOMPRESSIONLEVEL_UNSUPPORTED, /* BAVC_VideoCompressionLevel_eUnknown */
 BVCE_P_VIDEOCOMPRESSIONLEVEL_UNSUPPORTED, /* BAVC_VideoCompressionLevel_e00 */
 BVCE_P_VIDEOCOMPRESSIONLEVEL_UNSUPPORTED, /* BAVC_VideoCompressionLevel_e10 */
 ...
 BVCE_P_VIDEOCOMPRESSIONLEVEL_UNSUPPORTED, /* BAVC_VideoCompressionLevel_e60 */
 BVCE_P_VIDEOCOMPRESSIONLEVEL_UNSUPPORTED, /* BAVC_VideoCompressionLevel_e62 */
 ENCODING_VC1_LEVEL_LOW, /* BAVC_VideoCompressionLevel_eLow */
 ENCODING_VC1_LEVEL_MEDIUM, /* BAVC_VideoCompressionLevel_eMain */
 BVCE_P_VIDEOCOMPRESSIONLEVEL_UNSUPPORTED, /* BAVC_VideoCompressionLevel_eHigh */
 BVCE_P_VIDEOCOMPRESSIONLEVEL_UNSUPPORTED, /* BAVC_VideoCompressionLevel_eHigh1440 */
};
         ...
         )
{
   ...
   if ( NULL == hVceCh->hConfigLog )
   {
      ...
      {
         BVCE_Debug_P_WriteLog_isr( hVceCh->hConfigLog, "count,nrt,pipeline low delay,adaptive low delay,protocol,profile,level,input type,stc index,output index,rate buffer delay" );
         BVCE_Debug_P_WriteLog_isr( hVceCh->hConfigLog, ",on input change,new rap");
         BVCE_Debug_P_WriteLog_isr( hVceCh->hConfigLog, ",frame rate,frame rate mode,bitrate,A2P delay,p frames,b frames,open gop,itfp");
   ...
   if ( NULL != hVceCh->hConfigLog )
   {
      ...
      BVCE_Debug_P_WriteLog_isr( hVceCh->hConfigLog, "%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u",
      ...
      BVCE_Debug_P_WriteLog_isr( hVceCh->hConfigLog, ",%u,%u",
         pstConfigChannelSettings->bOnInputChange,
         pstConfigChannelSettings->bBeginNewRAP
         );

      /* Encode Settings */
      BVCE_Debug_P_WriteLog_isr( hVceCh->hConfigLog, ",%u,%u,%u,%u,%u,%u,%u,%u",
   ...
   switch ( hVce->fw.stCommand.type.stConfigChannel.Protocol )
   {
      ...
      case ENCODING_STD_VC1:
         hVce->fw.stCommand.type.stConfigChannel.Profile = BVCE_P_ProfileVC1LUT[hVceCh->stStartEncodeSettings.stProtocolInfo.eProfile];
         hVce->fw.stCommand.type.stConfigChannel.Level = BVCE_P_LevelVC1LUT[hVceCh->stStartEncodeSettings.stProtocolInfo.eLevel];
         break;
   ...
   /* Calculate GOP Structure */
   {
      ...
      if ( true == hVceCh->stStartEncodeSettings.bPipelineLowDelayMode )
      {
         ...
         {
            case ENCODING_GOP_STRUCT_TRACK_INPUT:
         BDBG_WRN(("When tracking input GOP and pipeline low delay mode=%d, app must ensure there are no B frames at input",
                  hVceCh->stStartEncodeSettings.bPipelineLowDelayMode
                  ));
               break;
            ...
            case ENCODING_GOP_STRUCT_IBBP:
            case ENCODING_GOP_STRUCT_IBBBP:
                  BDBG_ERR(("B frames not allowed with pipeline low delay mode=%d",
                           hVceCh->stStartEncodeSettings.bPipelineLowDelayMode
                  ));
                  return BERR_TRACE( BERR_INVALID_PARAMETER );
               break;
         ...
         )
{
   ...
   switch ( hVceCh->eStatus )
   {
      ...
      case BVCE_P_Status_eStarted:
         ...
         BDBG_WRN(("Channel is started, stopping first"));
         rc = BERR_TRACE( BVCE_P_SendCommand_StopChannel(
                  hVceCh->hVce,
                  hVceCh
                  ));
      ...
      case BVCE_P_Status_eStopping:
         /* Continue with warning */
         BDBG_WRN(("Channel is in process of stopping"));
         ...
         )
{
   ...
   switch ( hVceCh->eStatus )
   {
      ...
      case BVCE_P_Status_eStopping:
         /* Continue with warning */
         BDBG_ERR(("Channel has not completed stopping"));
         return BERR_TRACE( BERR_UNKNOWN );
         ...
         )
{
   ...
   /* Set Channel Status */
   if ( BVCE_Channel_StopMode_eImmediate == hVceCh->stStopEncodeSettings.eStopMode )
   {
      hVceCh->eStatus = BVCE_P_Status_eOpened; /* State changes to eOpened now */
         ...
         )
{
   ...
   if ( NULL == hVceCh->hStatusLog )
   {
      ...
      {
         BVCE_Debug_P_WriteLog_isr( hVceCh->hStatusLog, "count,error flags,event flags,total errors,received,dropped (frc),dropped (err),encoded" );
   ...
   {
      /* Start Encode Settings */
      BVCE_Debug_P_WriteLog_isr( hVceCh->hStatusLog, "%u,%u,%u,%u,%u,%u,%u,%u",
         ( NULL == hVceCh->stStartEncodeSettings.hOutputHandle ) ? (unsigned)-1 : hVceCh->stStartEncodeSettings.hOutputHandle->uiDescriptorCount,
...
static const uint16_t BVCE_P_UserData_PacketTypeLUT[BUDP_DCCparse_Format_Divicom + 1] =
{
   ...
   BVCE_P_UserData_PacketType_UNSUPPORTED, /* BUDP_DCCparse_Format_Divicom */
};
...
BVCE_Channel_UserData_GetStatus_isr(
      BVCE_Channel_Handle hVceCh,
      BVCE_Channel_UserData_Status *pstUserDataStatus
      )
{
   BERR_Code rc = BERR_SUCCESS;
   ...
   BKNI_Memset( pstUserDataStatus, 0, sizeof( BVCE_Channel_UserData_Status ) );
         ...
         )
      {
         ...
         switch ( uiProtocol )
         {
            ...
            case ENCODING_STD_MPEG4:
               ...
               break;
            case ENCODING_STD_VC1:
               uiProfile = BVCE_P_ProfileVC1LUT[pstChStartEncodeSettings->stProtocolInfo.eProfile];
               uiLevel = BVCE_P_LevelVC1LUT[pstChStartEncodeSettings->stProtocolInfo.eLevel];
               break;
