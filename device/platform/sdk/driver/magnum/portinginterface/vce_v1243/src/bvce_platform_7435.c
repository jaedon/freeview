 ...
 *
 * $brcm_Workfile: bvce_platform_7435.c $
 * $brcm_Revision: Hydra_Software_Devel/19 $
 * $brcm_Date: 4/8/13 3:04p $
 *
 * [File Description:]
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/vce/src/bvce_platform_7435.c $
 * 
 * Hydra_Software_Devel/19   4/8/13 3:04p nilesh
 * SW7425-4610: Enable BCHP_VICE2_ARCSS_ESS_CTRL_INIT_SYS_HOST_IF access
 * to read the ARC PC value during a watchdog
 * 
 * Hydra_Software_Devel/18   4/4/13 3:47p nilesh
 * SW7425-2568: Fix coverity error
 * 
 * Hydra_Software_Devel/17   12/5/12 2:00p nilesh
 * SW7445-39: Added runtime BVN2VICE MBOX version validation
 * 
 * Hydra_Software_Devel/16   12/3/12 5:38p nilesh
 * SW7445-39: FW v4.0.7.0
 * 
 * Hydra_Software_Devel/SW7445-39/1   11/20/12 3:16p nilesh
 * SW7445-39: Removed MPEG4 support from 7445
 * 
 * Hydra_Software_Devel/15   10/8/12 4:26p nilesh
 * SW7425-3959: Removed code to set VIP_BVB and VIP_ERR registers.  VCE FW
 * will set the registers, instead.
 * 
 * Hydra_Software_Devel/14   9/5/12 11:32a nilesh
 * SW7425-3816: Added MAU PFRI sw init to MAU reset logic
 * 
 * Hydra_Software_Devel/13   8/29/12 2:00p nilesh
 ...
 * 
 * Hydra_Software_Devel/SW7425-3360/1   7/17/12 1:55p nilesh
 * SW7425-3360: Added support for new FNRT MBOX
 * 
 * Hydra_Software_Devel/12   5/10/12 4:08p nilesh
 * SW7435-178: Updated to new MBOX MAJOR revision
 * 
 * Hydra_Software_Devel/11   4/13/12 9:28a nilesh
 * SW7435-76: Clear BVB/ERR status on VIP and VIP1 on both cores
 * 
 * Hydra_Software_Devel/10   4/12/12 1:42p nilesh
 * SW7435-76: Enabled BVB/ERR status on VIP and VIP1 on both cores
 * 
 * Hydra_Software_Devel/9   3/1/12 2:47p nilesh
 * SW7435-1: Fixed incorrect DCCM base address for MbArc
 * 
 * Hydra_Software_Devel/8   2/28/12 3:09p rayshap
 * SW7435-41: Fix issue with RDB header checks and revisions
 * 
 * Hydra_Software_Devel/7   2/14/12 10:05a nilesh
 * SW7425-2220: Cleaned up state when StopEncode(eImmediate) is used
 * 
 * Hydra_Software_Devel/6   1/31/12 3:44p nilesh
 * SW7435-2: Fixed setting of MBArc's instruction start address
 * 
 * Hydra_Software_Devel/5   1/31/12 3:25p nilesh
 * SW7435-1: Fixed bug setting register address offset for instance 1
 * 
 * Hydra_Software_Devel/4   1/18/12 3:43p nilesh
 * SW7425-2084: Added support for new BVN2VICE RDB definition
 * 
 * Hydra_Software_Devel/3   1/10/12 1:25p nilesh
 * SW7435-1: Added support for multiple instances
 * 
 * Hydra_Software_Devel/2   1/10/12 10:38a nilesh
 * SW7435-2: Updated to use latest 7435 RDB
 * 
...
const uint32_t BVCE_P_ProtocolLUT[BVCE_P_VIDEOCOMPRESSIONSTD_MAX + 1] =
 {
  ...
  BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* VC1 Simple & Main profile */
