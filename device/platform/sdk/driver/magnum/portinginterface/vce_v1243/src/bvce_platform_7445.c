         ...
         )
{
...

   {
      ...
      pstPlatformConfig->stDebug.uiPicArcPC = BCHP_VICE2_ARCSS_ESS_HOSTIF_0_0_HOSTIFi_ARRAY_BASE + 0x18 + iInstanceRegisterOffset;
...
const uint32_t BVCE_P_ProtocolLUT[BVCE_P_VIDEOCOMPRESSIONSTD_MAX + 1] =
 {
  ...
  BVCE_P_VIDEOCOMPRESSIONSTD_UNSUPPORTED,        /* MPEG 4, Part 2. */
