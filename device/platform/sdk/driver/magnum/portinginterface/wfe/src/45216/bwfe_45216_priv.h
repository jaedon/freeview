...
#define BWFE_45216_RELEASE_VERSION 0

#define BWFE_MAX_BBSI_RETRIES 10

#define BWFE_45216_MAX_CHANNELS 4

/* default only adc0 and adc1 */
#define BWFE_45216_NUM_CHANNELS 2
#define BWFE_45216_CHANNEL_MASK 0x3

#define BWFE_45216_CHK_RETCODE(x) \
...
See Also:
   None.
****************************************************************************/
typedef struct BWFE_45216_P_Handle
{
   BHAB_Handle       hHab;
...
See Also:
   None.
****************************************************************************/
typedef struct BWFE_45216_P_ChannelHandle
{
   BKNI_EventHandle  hWfeReady;  /* wfe ready event */
} BWFE_45216_P_ChannelHandle;


/* 45216 implementation of API functions */
BERR_Code BWFE_45216_P_Open(BWFE_Handle *h, BCHP_Handle hChip, void *pReg, BINT_Handle hInt, const BWFE_Settings *pDefSettings);
BERR_Code BWFE_45216_P_Close(BWFE_Handle h);
BERR_Code BWFE_45216_P_GetTotalChannels(BWFE_Handle h, BWFE_ChannelInfo *pInfo);
BERR_Code BWFE_45216_P_OpenChannel(BWFE_Handle h, BWFE_ChannelHandle *pChannelHandle, uint8_t chanNum, const BWFE_ChannelSettings *pSettings);
BERR_Code BWFE_45216_P_CloseChannel(BWFE_ChannelHandle h);
BERR_Code BWFE_45216_P_Reset(BWFE_Handle h);
BERR_Code BWFE_45216_P_GetVersion(BWFE_Handle h, BFEC_VersionInfo *pVersion);
...
BERR_Code BWFE_45216_P_GetSaDoneEventHandle(BWFE_Handle h, BKNI_EventHandle *hEvent);
