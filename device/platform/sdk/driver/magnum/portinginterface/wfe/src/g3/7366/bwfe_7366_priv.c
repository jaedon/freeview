...
BERR_Code BWFE_P_GetRegisterAddress(BWFE_ChannelHandle h, uint32_t reg, uint32_t *pAddr)
{
   ...
   *pAddr = reg;
   ...
   if (!h->bReference)
   {
      if ((reg >= 0x1230000) && (reg <= 0x12310B8))
      {
...
BERR_Code BWFE_P_InitAdc(BWFE_ChannelHandle h)
{
   ...
   /* package2-specific adc settings */
   BWFE_P_WriteRegister(h, BCHP_WFE_ANA_ADC_CNTL1, 0x42511085);
   BWFE_P_WriteRegister(h, BCHP_WFE_ANA_ADC_CNTL2, 0x54524924);
   BWFE_P_WriteRegister(h, BCHP_WFE_ANA_ADC_CNTL4, 0x26E1B6A0);
   BWFE_P_WriteRegister(h, BCHP_WFE_ANA_ADC_CNTL5, 0x02008000);
   BWFE_P_WriteRegister(h, BCHP_WFE_ANA_ADC_CNTL7, 0x60000000);
   BWFE_P_WriteRegister(h, BCHP_WFE_ANA_ADC_CNTL12, 0x00042023);
   BWFE_P_WriteRegister(h, BCHP_WFE_ANA_ADC_CNTL15, 0x1800001F);
#else
...
BERR_Code BWFE_P_ShutdownAdc(BWFE_ChannelHandle h)
{
   ...
   /* disable out, misc, corr, and mdac clock */
