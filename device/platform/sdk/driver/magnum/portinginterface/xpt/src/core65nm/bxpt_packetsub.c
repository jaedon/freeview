 ...
 * $brcm_Date: 3/7/12 12:22p $
 *
 * Porting interface code for the data transport core. 
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/xpt/7400/bxpt_packetsub.c $
 * 
 * Hydra_Software_Devel/27   3/7/12 12:22p gmullen
 * SW7325-879: Added BXPT_HAS_PACKETSUB_FORCED_INSERTION around code
 * 
 * Hydra_Software_Devel/26   3/5/12 5:29p gmullen
 * SW7325-879: Stubbed _SetForcedInsertion() for chips that don't support
 * it
 * 
 * Hydra_Software_Devel/25   2/28/12 11:29a gmullen
 * SW7325-879: Added _SetForcedInsertion()
 * 
 * Hydra_Software_Devel/24   12/16/11 2:13p gmullen
 * SW7405-5573: Check that packetsub channel is not already open
 * 
 * Hydra_Software_Devel/23   12/15/11 9:50a gmullen
 * SW7425-1589: Merged to Hydra_Software_Devel
 * 
 * Hydra_Software_Devel/SW7425-1589/1   12/12/11 5:20p gmullen
 * SW7425-1589: Added BXPT_PacketSub_GetEobIntId()
 * 
 * Hydra_Software_Devel/22   3/15/11 10:20a gmullen
 * SW7400-3015: Fixed coverity issue
 * 
 * Hydra_Software_Devel/21   2/16/11 9:44a jtna
 * SW7420-1320: replace BDBG_OBJECT_DESTROY with BDBG_OBJECT_UNSET
 * 
 * Hydra_Software_Devel/20   2/15/11 10:28p jtna
 * SW7420-1320: merge XPT power management
 * 
 * Hydra_Software_Devel/19   1/24/11 2:51p rjlewis
 * SW7420-879: supply a means to provide an output rate default on open.
 * Get defaults provides the default value.
 * 
 * Hydra_Software_Devel/18   1/18/11 11:36a rjlewis
 * SW7420-1383: Added support for BDBG_OBJECT interface
 * 
 * Hydra_Software_Devel/17   10/28/10 11:19a gmullen
 * SW7420-879: Merged fix to rate calc to mainline
 * 
 * Hydra_Software_Devel/SW7420-879/1   7/8/10 3:41p gmullen
 * SW7420-879: Updated rate calc formula to match new register description
 * 
 * Hydra_Software_Devel/16   10/20/10 3:11p gmullen
 * SW7420-879: Reduced default output rate to 1Mbps, to prevent RS and XC
 * overflows
 * 
