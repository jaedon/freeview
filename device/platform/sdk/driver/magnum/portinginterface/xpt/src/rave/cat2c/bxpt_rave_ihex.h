 ...
 * Revision History:                                                        
 *                                                                          
 * $brcm_Log: /magnum/portinginterface/xpt/src/rave/cat2c/bxpt_rave_ihex.h $                                                            
 * 
 ...
 * 
 * 2   6/27/11 4:06p teocw
 * xpt_rave_fw_2.0.s  - Upgraded to version 2.0
 * 
 * 1   6/24/11 3:31p bryanl
 * xpt_rave_fw_1.0.s
 *  - This is the baseline version for Category based 2C RAVE FW code.
 *  - This is based on GRAINA0 ver1.3 RAVE FW code
 ...
 *                                                                          
 *                                                                          
 * RAVE FW Category  : CAT2C                                             
 * RAVE FW Version   : 2.0
 * RAVE FW CRC       : 13be99                                                 
 * Chips supported   : 7631A, 7632A, 7632B
 *                                                                          
 ***************************************************************************/
