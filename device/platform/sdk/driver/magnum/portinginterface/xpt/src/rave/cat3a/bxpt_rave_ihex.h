 ...
 * $brcm_Date: 8/31/12 11:15a $                                                           
 *                                                                          
 * Porting interface code for the data transport core.                      
 *                                                                          
 * Revision History:                                                        
 *                                                                          
 * $brcm_Log: /magnum/portinginterface/xpt/src/rave/cat3a/bxpt_rave_ihex.h $                                                            
 * 
 * Hydra_Software_Devel/2   8/31/12 11:15a gmullen
 * SW7425-3146 : Copied fw to Hydra branch
 * 
 * 4   8/31/12 5:02p shilpag
 * xpt_rave_fw_2.2.s (31st August 2012)  - This firmware is generated
 * based on CAT3A Rave Firmware version 2.1  - This firmware is generated
 * from UNIFIED RAVE FW version 4.003.008  - It includes the following
 * changes,     - Added FWXPT-32 fix for (SW7425-3146) Invalid SCT
 * produced in 16-byte extraction mode     - Added ATS Offset related fix
 * in ATS Offset feature     - Added
 * FWXPT_35_REC_ITB_WRAPAROUND_FOR_CDB_OVERFLOW - Rave Firmware Fix for
 * ITB Wrapraound issue during CDB Overflow condition     - Added
 * FWXPT_31_BPP_BTP_HEADEND_TAILEND_FIX
 * 
 * 3   8/10/11 2:54p shilpag
 * xpt_rave_fw_2.1.s (10th August 2011) - This firmware is generated based
 * on CAT3A Rave Firmware version 2.0 - This firmware is generated based
 ...
 * 
 * 2   6/27/11 4:02p teocw
 * xpt_rave_fw_2.0.s  - Upgraded to version 2.0
 * 
 * 1   6/23/11 2:27p bryanl
 * xpt_rave_fw_1.0.s
 *  - This is the baseline version for Category based 3A RAVE FW code.
 *  - This is based on 7425A ver1.3 RAVE FW code
 ...
 *                                                                          
 * RAVE FW Category  : CAT3A                                             
 * RAVE FW Version   : 2.2                                             
 * RAVE FW CRC       : 268249                                                 
 * Chips supported   : 7135A, 7231A, 7344A, 7563
 *                   : 7346A, 7358A, 7422A
 *                   : 7425A, 7360A, 7552A
 *                                                                          
 ***************************************************************************/
