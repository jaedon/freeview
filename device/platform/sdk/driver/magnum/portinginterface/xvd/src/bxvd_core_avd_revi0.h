 ...
 *
 * $brcm_Workfile: bxvd_core_avd_revi0.h $
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/xvd/7401/bxvd_core_avd_revi0.h $
 * 
 ...
 * 
 * Hydra_Software_Devel/8   9/16/09 5:02p davidp
 * SW3548-2458: Add IL PC ctrl regs, plus reset regs for AVD HW blocks.
 * 
 ...
 * 
 * Hydra_Software_Devel/1   1/29/08 6:48p davidp
 * PR39098: Add support for AVD core rev i0.
 * 
 ***************************************************************************/
#ifndef _BXVD_CORE_AVD_REVI0_H_
#define _BXVD_CORE_AVD_REVI0_H_
...
} BXVD_P_PlatformReg_RevI0;

typedef struct {
	BXVD_P_CoreFirmware_RevI0 stFirmware;
	BXVD_P_PlatformReg_RevI0 stReg;
} BXVD_P_PlatformInfo_RevI0;

#define BXVD_P_CONTEXT_PLATFORM BXVD_P_PlatformInfo_RevI0 stPlatformInfo;
