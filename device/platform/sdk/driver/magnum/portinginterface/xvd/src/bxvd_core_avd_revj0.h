 ...
 *
 * $brcm_Workfile: bxvd_core_avd_revj0.h $
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/portinginterface/xvd/7401/bxvd_core_avd_revj0.h $
 * 
 ...
 * 
 * Hydra_Software_Devel/6   6/8/11 1:04p btosi
 * SW7425-542: moved the delivery/release queue management macros to the
 * platform files
 * 
 * Hydra_Software_Devel/5   7/13/10 4:30p davidp
 * SW7405-4628: Remove seq header callback support, add stereo seq error
 * callback support.
 * 
 * Hydra_Software_Devel/4   4/1/10 2:59p davidp
 * SW7405-4160: Fix PM clock register field names.
 * 
 * Hydra_Software_Devel/3   1/28/10 4:39p davidp
 * SW7550-173: Set AVD PCache mode register based on DDR type and memory
 * data width.
 * 
 * Hydra_Software_Devel/2   10/5/09 5:18p davidp
 * SW7550-53: Add registers to reset decoder in a more controlled manner.
 * 
