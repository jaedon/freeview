 ...
 * $brcm_Date: 7/20/12 10:33a $
 *
 * [File Description:]
 *
 * Revision History:
 *
 * $brcm_Log: /magnum/syslib/muxlib/7425/stream/ts/bmuxlib_ts.h $
 * 
...
{
   const void *pBufferAddress; /* uncached virtual address of data to be muxed.
                                * Caller is responsible for converting to a cached
                                * address before CPU use and flushing before HW use.
                                */
...
typedef struct BMUXlib_TS_SystemData
{
      ...
      const void *pData; /* uncached virtual address of data to be muxed.
                          * Caller is responsible for converting to a cached
                          * address before CPU use and flushing before HW use.
