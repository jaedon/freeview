 ...
 * 
 * Hydra_Software_Devel/78   5/13/13 10:47a nilesh
 ...
 * 
 * Hydra_Software_Devel/77   4/5/13 5:19p delkert
 ...
 * video input exists.
 * 
 * Hydra_Software_Devel/74   3/25/13 5:23p nilesh
 ...
 * 
 * Hydra_Software_Devel/73   3/20/13 6:09p delkert
 * SW7425-4642: Merge to mainline
 * 
 * Hydra_Software_Devel/SW7425-4642/1   3/20/13 1:42p delkert
 * SW7425-4642: Add a separate memory type for userdata PTS since it has a
 * different count than pending entries.
 *
 * Hydra_Software_Devel/72   3/13/13 5:21p nilesh
 * SW7425-659: Fixed "Late ESCR" reporting when in NRT mode
 *
 * Hydra_Software_Devel/71   3/12/13 6:41p nilesh
 ...
 *
 * Hydra_Software_Devel/70   3/12/13 6:36p nilesh
 ...
 * warning.
 *
 * Hydra_Software_Devel/69   3/6/13 9:49a nilesh
 * SW7425-659: Merge MTU BPP support
 *
 * Hydra_Software_Devel/SW7425-659/4   2/25/13 3:36p nilesh
 ...
 *
 * Hydra_Software_Devel/68   2/13/13 6:15p delkert
 ...
 *
 * Hydra_Software_Devel/67   1/4/13 9:48a nilesh
 * SW7425-4388: Added BMUXLIB_DUMP_PCR debug
 *
 * Hydra_Software_Devel/66   12/10/12 4:24p nilesh
...
#if ( BMUXLIB_TS_P_DUMP_AUDIO_DESC || BMUXLIB_TS_P_DUMP_VIDEO_DESC ||  BMUXLIB_TS_P_DUMP_TRANSPORT_DESC || BMUXLIB_TS_P_DUMP_TRANSPORT_PES || BMUXLIB_TS_P_DUMP_PCR || BMUXLIB_TS_P_TEST_MODE)
#include <stdio.h>
#endif
...
typedef struct BMUXlib_TS_P_Context
{
...
#if defined(HUMAX_PLATFORM_BASE) && defined(CONFIG_BCM_TBD)
#if BMUXLIB_TS_P_ENABLE_MTU
      BMUXlib_TS_P_MTUBPPData *astMTUBPPDataUnCached;
      BMUXlib_TS_P_MTUBPPData *astMTUBPPData; /* Used for MTU BPP packets.  Cannot be reused within a playback. */
      BMUXlib_List_Handle hMTUBPPFreeList; /* Stack containing BPP buffers */
#endif
#endif
      ...
      struct
      {
         ...
         uint32_t uiTransportLastStartingESCR[BMUXLIB_TS_MAX_TRANSPORT_INSTANCES]; /* Contains the last starting ESCR for descriptors
                                                                                    * in the queue queue. */
         ...
         } stTransportQueued[BMUXLIB_TS_MAX_TRANSPORT_INSTANCES];
         ...
         struct
         {
            bool bValid;
            unsigned uiValue;
         } stPacket2PacketDelta[BMUXLIB_TS_MAX_TRANSPORT_INSTANCES];
