...
* $brcm_Revision: 1 $
* $brcm_Date: 5/21/08 4:42p $
*
* API Description:
*
* Revision History:
*
* $brcm_Log: /nexus/base/include/vxworks/nexus_base_os_types.h $
* 
* 1   5/21/08 4:42p rjlewis
...
#include <timers.h>
/* platform specfic type for timestamps */
struct vxworks_nexus_timeval {
    uint32_t    tv_sec;     /* seconds */
    uint32_t    tv_usec;    /* microseconds */
};
/* platform spefic type for timestamps */
typedef struct vxworks_nexus_timeval NEXUS_Time;
...
/* Roy - this comes from BSEAV/api/src/xxx/board/bsettop_vxworks.h */
