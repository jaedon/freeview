...
# ANY LIMITED REMEDY.
#
# $brcm_Workfile: generate_nexus_ipc_modules.pl $
# $brcm_Revision: 2 $
# $brcm_Date: 1/19/11 2:03p $
#
# Module Description:
#
# Revision History:
#
# $brcm_Log: /nexus/build/os/linuxuser/generate_nexus_ipc_modules.pl $
# 
...
# remove BASE & local modules
@modules = grep(!/BASE|RECORD|PLAYBACK|FILE/,@modules);
