 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: atsc_a85.c $
 * $brcm_Revision: 2 $
 * $brcm_Date: 12/20/11 5:24p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/audio/atsc_a85.c $
 * 
 * 2   12/20/11 5:24p jgarrett
 * SW7425-1018: fixing audio module family macro usage
 * 
 * 1   12/20/11 5:06p jgarrett
 * SW7425-1018:Adding ATSC A/85 example
 * 
******************************************************************************/
...
int main(void)
{
    ...
    /* HDMI is considered a passive output per ATSC A/85.  Since the decoder outputs at -20dB we must attenuate
       another 11dB to achieve -31dB.  */
    NEXUS_AudioOutput_GetSettings(
