 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: audio_capture_multichannel.c $
 * $brcm_Revision: 3 $
 * $brcm_Date: 5/23/11 6:49p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/audio/audio_capture_multichannel.c $
 * 
 * 3   5/23/11 6:49p jgarrett
 * SW7425-402: Adding multichannel capture support
 * 
 * 2   8/10/10 3:58p erickson
 * SW7420-934: rename NEXUS_AudioCapture_WriteComplete to
 *  NEXUS_AudioCapture_ReadComplete
 * 
 * 1   8/28/09 4:00p jgarrett
