 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: btsc_encode.c $
 * $brcm_Revision: 3 $
 * $brcm_Date: 12/14/11 11:32a $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/audio/btsc_encode.c $
 * 
 * 3   12/14/11 11:32a jgarrett
 * SW7125-1092: Making PIDs changeable at runtime
 * 
 * 2   9/16/11 5:56p jgarrett
 * SW7125-1092: Adding BTSC encoder support to 7420/7125
 * 
 * 1   8/29/11 5:50p jgarrett
 * SW7425-724: Adding BTSC encode example
 * 
******************************************************************************/
...
int main(int argc, char **argv)
{
    argc=argc;
    argv=argv;
    fprintf(stderr, "RF Encoder not supported on this chipset\n");
    return -1;
}
#endif
