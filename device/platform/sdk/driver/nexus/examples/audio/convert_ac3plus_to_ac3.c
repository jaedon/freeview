 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: convert_ac3plus_to_ac3.c $
 * $brcm_Revision: 1 $
 * $brcm_Date: 8/26/11 4:40p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/audio/convert_ac3plus_to_ac3.c $
 * 
 * 1   8/26/11 4:40p jgarrett
 * SWDTV-8371: Adding example to convert AC3Plus to AC3
 * 
******************************************************************************/
