 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: playback_encrypted.c $
 * $brcm_Revision: 7 $
 ...
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/dvr/playback_encrypted.c $
 * 
 * 7   1/26/12 3:00p rjlewis
 * SW7425-1136: Added HDMI Support.
 * 
 * 6   12/8/11 3:13p mphillip
 * SW7346-481: 7346/7425 B0 support exposed a lack of
 *  NEXUS_Security_GetDefaultClearKey calls
 * 
 * 5   11/10/11 2:10p jtna
 * SWDEPRECATED-3629: fix broken example by specifying correct audio pid
 *  and audioDecoder
 * 
...
#define FILE_NAME "videos/cnnticker_3des.mpg"
