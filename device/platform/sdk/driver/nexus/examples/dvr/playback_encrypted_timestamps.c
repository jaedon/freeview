 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: playback_encrypted_timestamps.c $
 * $brcm_Revision: 4 $
 ...
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/dvr/playback_encrypted_timestamps.c $
 * 
 * 4   1/26/12 3:00p rjlewis
...
#define INDEX_NAME "videos/stream_3des.nav"
...
int main(void)
{
    ...
    playbackSettings.playpumpSettings.timestamp.type = NEXUS_TransportTimestampType_eMod300; /* enable timestamps */
