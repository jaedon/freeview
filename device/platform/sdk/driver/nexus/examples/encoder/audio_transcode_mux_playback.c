 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: audio_transcode_mux_playback.c $
 * $brcm_Revision: 5 $
 * $brcm_Date: 1/30/12 2:35p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/encoder/audio_transcode_mux_playback.c $
 * 
 * 5   1/30/12 2:35p rjlewis
 * SW7425-1136: cleanup option for not supported on platform.
 * 
 * 4   1/30/12 2:04p rjlewis
 * SW7425-1136: restored transport definition for mux config.
 * 
 * 3   1/27/12 5:55p rjlewis
 * SW7425-1136: Added HDMI Support.
 * 
 * 2   9/29/11 12:39p erickson
 * SW7425-1320: rely on NEXUS_ENCODER_DISPLAY_IDX defined in
 *  nexus_platform_features.h
 * 
 * 1   5/16/11 4:53p hongtaoz
 * SW7425-356: move encoder examples to the encoder directory;
 * 
 * 2   3/14/11 2:36p jgarrett
 * SW7425-166: Resolving kernel mode shutdown issues
 * 
 * 1   2/18/11 6:51p jgarrett
 * SW7425-94: Merge to main branch
 * 
 * NEXUS_AACENC_INTEGRATION/1   2/15/11 7:36p jgarrett
 * SW7425-94: Adding example app
 * 
