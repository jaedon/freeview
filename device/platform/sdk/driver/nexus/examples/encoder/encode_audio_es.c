...
* $brcm_Revision: 5 $
* $brcm_Date: 1/30/12 3:14p $
*
* Module Description:
*
* Revision History:
*
* $brcm_Log: /nexus/examples/encoder/encode_audio_es.c $
* 
* 5   1/30/12 3:14p rjlewis
* SW7425-1136: added alternate main for non-supported platforms.
* 
* 4   1/27/12 5:55p rjlewis
...
int main(void)
{
	...
	printf("\n decode stream codec (1) Mpg (3) AAC (8) AAC+ (9) AC3");   scanf("%d", (int32_t*)&stInput.eAudioCodec);
	printf("\n Audio pid ");                                             scanf("%d", &stInput.iAudioPid);
	printf("\n Pcr   pid ");                                             scanf("%d", &stInput.iPcrPid);
	printf("\n encode stream: ");                                        scanf("%s", stEncode.fname);
	printf("\n encode stream code (1) Mpg (3) AAC (8) AAC+ (9) AC3");    scanf("%d", (int32_t*)&stEncode.eAudioCodec);

	printf("\n****************************************************************\n");
	printf("\n Input Parameters\n");
	printf("\n Input filename           %s", stInput.fname);
	printf("\n Streamtype %d iencoderAudioCodec %d", stInput.eStreamType, stInput.eAudioCodec);
	printf("\n vPid %4d, PcrPid  %4d", stInput.iAudioPid, stInput.iPcrPid);
	printf("\n\n Encode Parameters\n");
