 ...
 * $brcm_Revision: 21 $
 * $brcm_Date: 2/29/12 12:02p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/graphics/fill.c $
 * 
 * 21   2/29/12 12:02p erickson
 * SW7405-3671: always WaitForEvent after Checkpoint
 * 
 * 20   1/25/12 5:22p rjlewis
 * SW7425-1136: Added HDMI Support.
 * 
 * 19   1/13/12 7:58p erickson
 * SW7425-1136: add HDMI output, remove unused code
 * 
 * 18   9/16/11 1:54p erickson
 * SW7405-3671: add required checkpoint before calling
 *  NEXUS_Display_SetGraphicsFramebuffer
 * 
 * 17   8/24/11 10:00a erickson
 * SW7231-199: add hdmi output
 * 
 * 16   5/25/11 4:12p erickson
 ...
 *
 * 11   7/23/10 10:23a erickson
 * SW7405-3671: speed up fill example, normalize use of checkpoint, add
 *  metrics
 *
 * 10   2/24/10 9:43p mphillip
 * SW7550-277: Guard graphics examples for platforms lacking graphics2d
 *
 * 9   2/2/10 9:29a erickson
 * SW7405-3856: fix use of checkpoint in example
 *
 * 8   11/10/09 3:15p nickh
 * SW7420-166: Explicitly pass in heap1 for allocated surfaces on 7420 as
 *  nexus defaults to heap0.
 *
 * 7   6/25/09 9:45a erickson
 * PR55968: fix fill for DTV
 *
 * 6   5/13/09 9:24a erickson
 * PR54982: fix range error on fill
 *
 * 5   5/11/09 11:42a erickson
 * PR54982: use NEXUS_Graphics2D_Checkpoint in non-deprecated way. add
 *  sample shutdown code.
 *
