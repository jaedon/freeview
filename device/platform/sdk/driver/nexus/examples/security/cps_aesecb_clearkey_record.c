 ...
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/security/cps_aesecb_clearkey_record.c $
 * 
...
#endif
	unsigned char VidEvenCpsControlWord[] ={0x6e, 0xf6, 0xb6, 0xcc, 0x5b, 0x6c, 0x86, 0xf7,0x92, 0xa2, 0x48, 0x70, 0xac, 0xd9, 0x46, 0x73};   
	unsigned char VidOddCpsControlWord[] = {0x6e, 0xf6, 0xb6, 0xcc, 0x5b, 0x6c, 0x86, 0xf7,0x92, 0xa2, 0x48, 0x70, 0xac, 0xd9, 0x46, 0x73};   
	unsigned char AudEvenCpsControlWord[] ={0x6e, 0xf6, 0xb6, 0xcc, 0x5b, 0x6c, 0x86, 0xf7,0x92, 0xa2, 0x48, 0x70, 0xac, 0xd9, 0x46, 0x73};   
	unsigned char AudOddCpsControlWord[] = {0x6e, 0xf6, 0xb6, 0xcc, 0x5b, 0x6c, 0x86, 0xf7,0x92, 0xa2, 0x48, 0x70, 0xac, 0xd9, 0x46, 0x73};   
...
/* Just testing CPS clear stream input encryption even though opening CaCp engine */
	...
	***************************************************************************************/
	...
	if ( ConfigureKeySlotForAesCPS (videoKeyHandle,
                                    ...
                                    NEXUS_SecurityAlgorithmScPolarity_eClear) != 0 )
	{
	...
	printf("Press enter to remove pidchannel & free keyslot\n");
    getchar();
