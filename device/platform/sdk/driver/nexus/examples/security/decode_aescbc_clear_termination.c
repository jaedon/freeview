 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: decode_aescbc_clear_termination.c $
 * $brcm_Revision: 3 $
 ...
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/security/decode_aescbc_clear_termination.c $
 * 
 ...
 *  PTS - STC difference
 * 
 * 1   6/28/10 12:42p erickson
 * SW35230-421: added decode_aescbc_clear_termination.c
 *
 *****************************************************************************/
