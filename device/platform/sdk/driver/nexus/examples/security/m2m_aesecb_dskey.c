 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: m2m_aesecb_dskey.c $
 * $brcm_Revision: 3 $
 * $brcm_Date: 4/15/11 3:10p $
 * 
 * Module Description:
 * 
 * Revision History:
 * 
 * $brcm_Log: /nexus/examples/security/m2m_aesecb_dskey.c $
 * 
 * 3   4/15/11 3:10p jtna
...
int main(void)
{
	...
	/* Route data section key */
	if (NEXUS_Security_RouteDataSectionKey(decKeyHandle) != 0) {
