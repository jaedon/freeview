 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: decode_16bitmode.c $
 * $brcm_Revision: 3 $
 * $brcm_Date: 1/7/11 3:26p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/video/decode_16bitmode.c $
 * 
 * 3   1/7/11 3:26p jtna
 * SW7422-165: use NEXUS_VideoDecoderStatus.ptsStcDifference to calculate
 *  PTS - STC difference
 * 
 * 2   2/19/09 3:30p erickson
 * PR51841: remove examples_lib
 *
 * 1   8/26/08 6:10p jrubio
 * PR45795: checking in 16 bit mode decode app
 *
******************************************************************************/
