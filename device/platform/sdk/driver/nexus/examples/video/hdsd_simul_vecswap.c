 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: hdsd_simul_vecswap.c $
 * $brcm_Revision: 3 $
 ...
 * Revision History:
 *
 * $brcm_Log: /nexus/examples/video/hdsd_simul_vecswap.c $
 * 
 * 3   1/26/12 11:23a rjlewis
 * SW7425-1136: Added HDMI Support.
 * 
 * 2   5/12/10 9:50a erickson
 * SW7405-4230: merge
 *
 * SW7405-4230/2   5/11/10 1:59p yuxiaz
 * SW7405-4230: Set HD display format to 480p for both configurations.
 *
 * SW7405-4230/1   5/3/10 3:45p yuxiaz
 * SW7405-4230: Added code to time vec swap.
 *
 * 1   4/30/10 1:53p erickson
 * SW7405-4230: merge
******************************************************************************/
