 ...
 *  ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: nexus_picture_decoder_sid_video_decoder_module.c $
 * $brcm_Revision: 2 $
 ...
 * Revision History:
 *
 * $brcm_Log: /nexus/extensions/picture_decoder/sid_video_decoder/src/nexus_picture_decoder_sid_video_decoder_module.c $
 * 
