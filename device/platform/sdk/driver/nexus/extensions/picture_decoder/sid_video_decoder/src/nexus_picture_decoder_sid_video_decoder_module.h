 ...
 *  ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: nexus_picture_decoder_sid_video_decoder_module.h $
 * $brcm_Revision: 2 $
 ...
 * Revision History:
 *
 * $brcm_Log: /nexus/extensions/picture_decoder/sid_video_decoder/src/nexus_picture_decoder_sid_video_decoder_module.h $
 * 
 ...
 * SW7425-409: Adding SID video decoder extensions for VDE
 * 
 **************************************************************************/
#ifndef NEXUS_PICTURE_DECODER_SID_VIDEO_DECODER_MODULE_H__
#define NEXUS_PICTURE_DECODER_SID_VIDEO_DECODER_MODULE_H__
...
NEXUS_Error NEXUS_PictureDecoderModule_P_InitSidVideoDecoder(void);
void NEXUS_PictureDecoderModule_P_UninitSidVideoDecoder(void);
...
#endif /* NEXUS_PICTURE_DECODER_SID_VIDEO_DECODER_MODULE_H__ */
