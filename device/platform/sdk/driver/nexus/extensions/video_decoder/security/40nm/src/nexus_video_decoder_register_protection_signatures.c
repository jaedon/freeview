 ...
 * $brcm_Revision: 2 $
 * $brcm_Date: 7/20/11 4:07p $
 * 
 * Module Description:
 * 
 * Revision History:
 * 
 * $brcm_Log: /nexus/extensions/video_decoder/security/7422/src/nexus_video_decoder_register_protection_signatures.c $
 * 
 * 2   7/20/11 4:07p yili
 * SW7422-404:Security system test
 * 
 * 1   7/20/11 3:28p yili
 * SW7358-81:VICH signatures
 * 
 *****************************************************************************/
