 ...
 * $brcm_Revision: 1 $
 * $brcm_Date: 11/9/11 11:26a $
 * 
 * Module Description:
 * 
 * Revision History:
 * 
 * $brcm_Log: /nexus/extensions/video_decoder/security/7346/src/nexus_video_decoder_register_protection_signatures.c $
 * 
 * 1   11/9/11 11:26a yili
 * SW7231-272:Duplicate for 7346
 * 
