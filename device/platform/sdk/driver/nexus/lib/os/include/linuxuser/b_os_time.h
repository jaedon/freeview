...
* Revision History:
*
* $brcm_Log: /nexus/lib/os/include/linuxuser/b_os_time.h $
* 
* 1   3/31/08 1:14p jgarrett
* PR 41043: Making time interface public
* 
***************************************************************************/
