...
* Revision History:
*
* $brcm_Log: /nexus/modules/audio/7405/src/nexus_audio_decoder_extra.c $
* 
* 3   7/28/08 11:04a jtna
...
* PR 42924: Adding NEXUS_AudioDecoder_ChannelChangeReport
* 
***************************************************************************/
