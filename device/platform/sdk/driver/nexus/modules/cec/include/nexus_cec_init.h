...
* ANY LIMITED REMEDY.
*
* $brcm_Workfile: nexus_cec_init.h $
* $brcm_Revision: 1 $
* $brcm_Date: 12/15/11 4:27p $
*
* Module Description:
*
* Revision History:
*
* $brcm_Log: /nexus/modules/cec/7425/include/nexus_cec_init.h $
* 
...
#ifndef NEXUS_CEC_INIT_H__
#define NEXUS_CEC_INIT_H__
...
typedef struct NEXUS_CecModuleSettings
{
	bool enabled;
