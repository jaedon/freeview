 ...
 *  ANY LIMITED REMEDY.
 * 
 * $brcm_Workfile: nexus_syslib_framework.h $
 * $brcm_Revision: 1 $
 * $brcm_Date: 3/26/08 5:11p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/modules/core/7400/include/priv/nexus_syslib_framework.h $
 * 
 * 1   3/26/08 5:11p bandrews
