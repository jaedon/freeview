...
* Revision History:
*
* $brcm_Log: /nexus/modules/dvb_ci/7358/src/nexus_dvb_ci_chip.c $
* 
* 2   1/12/12 5:26p bselva
* SW7358-160: pinmux setting modified for RMX and PPKT for DVB CI
* 
* SW7358-160/2   10/21/11 11:00p ksk
* Clear bit of gpio_46 in changing mode.
* 
* SW7358-160/1   10/6/11 12:42a ksk
* SW7358-160: Adding tsMode in setting Pinmux
* 
* 1   7/13/11 4:22p garylin
* SW7358-68: initial version
* 
***************************************************************************/
