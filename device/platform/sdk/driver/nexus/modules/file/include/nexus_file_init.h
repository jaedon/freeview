 ...
 *  ANY LIMITED REMEDY.
 * 
 * $brcm_Workfile: nexus_file_init.h $
 * $brcm_Revision: 3 $
 * $brcm_Date: 9/6/11 10:05a $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/modules/file/include/nexus_file_init.h $
 * 
 * 3   9/6/11 10:05a erickson
 * SWNOOS-482: add NEXUS_FileModuleSettings.schedulerSettings[] per-thread
 *  array
 * 
 * 2   4/20/11 7:48p vsilyaev
