 ...
 * $brcm_Revision: 7 $
 * $brcm_Date: 8/25/12 12:45p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/modules/file/src/ucos_ii/nexus_file_posix.c $
 * 
 * 7   8/25/12 12:45p agin
 * SWNOOS-559:  Compare file->fd properly, call _fclose instead of close.
 * 
 * 6   8/6/12 12:24p agin
 * SWNOOS-559:  Support _fwrite.
 * 
 * 5   8/3/12 9:26p agin
 * SWNOOS-559:  Support posix_bounds and b_file_io_write_posix_open.
 * 
 * 4   8/1/12 5:33p agin
 * SWNOOS-559:  Use _fopen, _fclose, _fread, _fseek.
 * 
 * 3   7/31/12 12:12a agin
 * SW7425-2821:  Sync to
 *  /nexus/modules/file/src/linuxuser/nexus_file_posix.c /main/17
 * 
 * 2   3/18/12 6:13p agin
