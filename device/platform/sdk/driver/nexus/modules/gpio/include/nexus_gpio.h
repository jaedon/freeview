...
*  ANY LIMITED REMEDY.
*
* $brcm_Workfile: nexus_gpio.h $
* $brcm_Revision: 12 $
* $brcm_Date: 7/14/11 2:11p $
*
* API Description:
*   API name: Gpio
...
* Revision History:
*
* $brcm_Log: /nexus/modules/gpio/7405/include/nexus_gpio.h $
* 
* 12   7/14/11 2:11p jtna
* SW7405-5414: added NEXUS_GpioSettings.maskEdgeInterrupts
* 
* 11   5/2/11 4:03p erickson
* SW7422-75: clarify use of nexus_platform_features.h for GPIO type
*  values
* 
* 10   12/6/10 10:53a erickson
* SW7408-146: add NEXUS_Gpio_GetPinMux
* 
* 9   10/11/10 3:46p erickson
...
*
* 7   4/16/10 11:42a erickson
* SW35230-124: update comments
*
* 6   4/5/10 3:06p jhaberf
* SW35230-124: Added TV-Micro enumeration
*
* 5   3/18/09 11:54a jgarrett
* PR 53230: Chaning default GPIO state to input for safety
*
* 4   2/26/08 10:49p erickson
* PR35457: improved comments
*
...
*
* Nexus_Devel/4   11/29/07 2:25p erickson
...
NEXUS_GpioHandle NEXUS_Gpio_OpenAux(
    ...
    const NEXUS_GpioSettings *pSettings /* additional settings for the pin */
    );
...
Example code:
    ...
    NEXUS_Rdb_GetGpioPinMux(1, &addr, &mask, &shift);
