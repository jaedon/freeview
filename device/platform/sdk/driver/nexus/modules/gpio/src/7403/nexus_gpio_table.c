...
* Revision History:
*
* $brcm_Log: /nexus/modules/gpio/7403/src/nexus_gpio_table.c $
* 
* 1   7/31/09 2:08p gmohile
* PR 56512 : Add 7403 spio table
* 
* 97403_nexus/1   7/6/09 5:54p gqli
...
/*gqli this is a temp version need to be checked later so will not check in*/
