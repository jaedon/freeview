 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: nexus_hdmi_output_control.c $
 * $brcm_Revision: 1 $
 ...
 * Revision History:
 *
 * $brcm_Log: /nexus/modules/hdmi_output/7400/src/nexus_hdmi_output_control.c $
 * 
...
)
{
	...
	BDBG_CASSERT(sizeof(NEXUS_HdmiOutputPreEmphasisConfiguration) == sizeof(BHDM_PreEmphasis_Configuration));
