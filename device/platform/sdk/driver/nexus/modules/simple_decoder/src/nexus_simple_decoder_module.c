 ...
 *  ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: nexus_simple_decoder_module.c $
 * $brcm_Revision: 2 $
 * $brcm_Date: 10/12/12 3:11p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/modules/simple_decoder/src/nexus_simple_decoder_module.c $
 * 
 * 2   10/12/12 3:11p erickson
 * SW7435-419: remove unused proc func. change priority to eDefault.
 * 
