 ...
 * $brcm_Revision: 6 $
 * $brcm_Date: 7/14/11 7:37p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/modules/transport/7400/secure_ext/src/nexus_transport_security.c $
 * 
 * 6   7/14/11 7:37p mphillip
...
#if (BCHP_CHIP == 7400 || BCHP_CHIP == 7405 || BCHP_CHIP == 7420 || BCHP_CHIP == 7340 || BCHP_CHIP == 7342 )
#define RAVE_REGION_ID 11
#else
#define RAVE_REGION_ID 10
#endif
