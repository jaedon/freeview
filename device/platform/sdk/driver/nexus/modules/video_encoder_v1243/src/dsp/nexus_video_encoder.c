 ...
 * $brcm_Revision: 10 $
 * $brcm_Date: 1/17/13 3:18p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/modules/video_encoder/src/dsp/nexus_video_encoder.c $
 * 
 * 10   1/17/13 3:18p gmohile
 * SW7231-1109 : Flush rave context during stop
 * 
