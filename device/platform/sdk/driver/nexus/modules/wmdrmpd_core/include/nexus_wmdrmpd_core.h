...
*  ANY LIMITED REMEDY.
*
* $brcm_Workfile: nexus_wmdrmpd_core.h $
* $brcm_Revision: 4 $
...
* Revision History:
*
* $brcm_Log: /nexus/modules/wmdrmpd_core/include/nexus_wmdrmpd_core.h $
* 
* 4   10/4/12 1:13p erickson
* SW7425-4027: merge
* 
* SW7425-4027/1   10/3/12 2:25p hugost
* New API NEXUS_WmDrmPdCore_GetCustomLicenseChallenge
* 
...
* Added the following APIs: NEXUS_WmDrmPdCore_GetDefaultPsshBoxInfo(),
*  NEXUS_WmDrmPdCore_SetPsshBox(),
*  NEXUS_WmDrmPdCore_GetDefaultProtectionSchemeInfo(),
*  NEXUS_WmDrmPdCore_SetProtectionSchemeBox() and
*  NEXUS_WmDrmPdCore_CleanupLicenseStore()..
* 
