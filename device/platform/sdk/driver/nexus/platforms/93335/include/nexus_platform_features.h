 ...
 * $brcm_Revision: 3 $
 * $brcm_Date: 11/1/12 5:28p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/platforms/93335/include/nexus_platform_features.h $
 * 
 * 3   11/1/12 5:28p jzhu
 * SW7435-246: Add hdmi module
 *
 * 2   9/28/12 1:45p jzhu
 * SW7435-246:2 tuners, 8 IB each, 1 OOB.
 *
...
#define NEXUS_NUM_STC_CHANNELS 8
