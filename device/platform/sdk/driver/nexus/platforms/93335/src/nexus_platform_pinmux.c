 ...
 * $brcm_Revision: 1 $
 * $brcm_Date: 9/26/12 1:18p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/platforms/93335/src/nexus_platform_pinmux.c $
 * 
 * 1   9/26/12 1:18p jzhu
...
#endif
            BCHP_FIELD_DATA(SUN_TOP_CTRL_PIN_MUX_CTRL_9, gpio_029, 0) | /* PKT_SYNC3 */
