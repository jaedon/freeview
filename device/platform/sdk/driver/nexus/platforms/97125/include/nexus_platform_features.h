...
* 
* 15   8/26/10 6:14p mward
* SW7125-497: Host control for internal tuner/DS.
* 
* 14   6/29/10 4:27p ayxiang
* SW7125-497: add tuner control number who can be controlled by host
*  directly when frontend standby state
* 
* 13   6/8/10 5:44p mward
* SW7125-460:  DVB_CI values.
* 
* 12   3/17/10 2:30p mward
* SW7125-234: Add PEP related defines after Picture control refactoring.
* 
* 9   11/23/09 4:31p mward
* SW7125-4:  Correct check-in comments for prior version.  s/b two 3112
*  not two 3255.
* 
* 8   11/23/09 12:38p mward
* SW7125-4:  Increase NEXUS_MAX_FRONTENDS and NEXUS_MAX_3255_ADSCHN for
*  the two 3112's under BNM control.
* 
* 7   10/15/09 7:19p mward
* SW7125-35: NEXUS_97125_HOST_3112=y build option.
* 
* 6   10/14/09 2:19p mward
* SW7125-35:  Support control of BCM3112's by host.
* 
* 5   9/29/09 10:22a mward
* SW7125-27:  Only one video window per display if only one video
*  decoder.
* 
* 4   8/26/09 4:27p mward
* SW7125-4: Update.
* 
...
for other uses.  The unit of ulBitsPerPixel is 0.5 bits.  CFE 3.14 and CFE 3.16 or later require this compression,
CFE 3.15 does not.
*/
...
/* Cable Frontend */
#define NEXUS_HOST_CONTROL_EXTERNAL_FRONTEND_STANDBY 2
...
#define NEXUS_FRONTEND_ID_CM_CONTROLLED_EXTERNAL_31XX_DS2    0
#define NEXUS_FRONTEND_ID_CM_CONTROLLED_INTERNAL_7125_DS1    1
#define NEXUS_FRONTEND_ID_CM_CONTROLLED_EXTERNAL_31XX_DS3    2
#define NEXUS_FRONTEND_ID_CM_CONTROLLED_INTERNAL_7125_DS0    3
#define NEXUS_FRONTEND_ID_CM_CONTROLLED_OOB                  4
/* HOST_CONTROLLED and CM_CONTROLLED frontends cannot be open simultaneously */
#define NEXUS_FRONTEND_ID_HOST_CONTROLLED_EXTERNAL_31XX_DS2  (NEXUS_FRONTEND_ID_CM_CONTROLLED_EXTERNAL_31XX_DS2+NEXUS_FRONTEND_ID_HOST_CONTROLLED)
...
#define NEXUS_FRONTEND_ID_HOST_CONTROLLED_EXTERNAL_31XX_DS3  (NEXUS_FRONTEND_ID_CM_CONTROLLED_EXTERNAL_31XX_DS3+NEXUS_FRONTEND_ID_HOST_CONTROLLED)
