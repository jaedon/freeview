...
*
* API Description:
*   This file contains VCXO initialization for the 97125 reference board.
*
* Revision History:
*
* $brcm_Log: /nexus/platforms/97125/src/nexus_platform_vcxo.c $
* 
...
NEXUS_Error NEXUS_Platform_P_InitVcxo(void)
{
	...
	BREG_Write32(hRegister, BCHP_VCXO_0_RM_CONTROL, ui32RegVal);

	/* assert reset */
	ui32RegVal = BCHP_FIELD_DATA(VCXO_CTL_MISC_VC0_CTRL, DRESET, 1);
	BREG_AtomicUpdate32(hRegister, BCHP_VCXO_CTL_MISC_VC0_CTRL, ui32RegVal, ui32RegVal);

	ui32RegVal = BCHP_FIELD_DATA(VCXO_0_RM_RATE_RATIO, DENOMINATOR, 32);
	BREG_Write32(hRegister, BCHP_VCXO_0_RM_RATE_RATIO, ui32RegVal);

	ui32RegVal =
		BCHP_FIELD_DATA(VCXO_0_RM_SAMPLE_INC, NUMERATOR, 29) |
		BCHP_FIELD_DATA(VCXO_0_RM_SAMPLE_INC, SAMPLE_INC, 3);
	BREG_Write32(hRegister, BCHP_VCXO_0_RM_SAMPLE_INC, ui32RegVal);

	ui32RegVal = BCHP_FIELD_DATA(VCXO_0_RM_PHASE_INC, PHASE_INC, 0x7d634);
	BREG_Write32(hRegister, BCHP_VCXO_0_RM_PHASE_INC, ui32RegVal);

	BREG_Write32(hRegister, BCHP_VCXO_0_RM_INTEGRATOR, 0x0);

	ui32RegVal =
		BCHP_FIELD_DATA(VCXO_0_RM_FORMAT, SHIFT, 2) |
		BCHP_FIELD_DATA(VCXO_0_RM_FORMAT, STABLE_COUNT, 10000);
	BREG_Write32(hRegister, BCHP_VCXO_0_RM_FORMAT, ui32RegVal);

	ui32RegVal =
		BCHP_FIELD_DATA(VCXO_0_RM_OFFSET, OFFSET_ONLY, 0) |
		BCHP_FIELD_DATA(VCXO_0_RM_OFFSET, OFFSET, 0x10000000);
	BREG_Write32(hRegister, BCHP_VCXO_0_RM_OFFSET, ui32RegVal);

	ui32RegVal =
		BCHP_FIELD_DATA(VCXO_0_RM_CONTROL, TIMEBASE, 0) |	/* Timebase 0 */
	...
	/* Deassert reset */
	ui32RegVal = BCHP_FIELD_DATA(VCXO_CTL_MISC_VC0_CTRL, DRESET, 1);
	BREG_AtomicUpdate32(hRegister, BCHP_VCXO_CTL_MISC_VC0_CTRL, ui32RegVal, 0);
