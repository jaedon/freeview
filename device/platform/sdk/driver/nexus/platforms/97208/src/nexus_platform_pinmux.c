...
* Revision History:
 *
 * $brcm_Log: /nexus/platforms/97208/src/nexus_platform_pinmux.c $
 * 
 * 1   12/20/09 4:26p randyjew
 * SW7468-6:Add 7208 support
 * 
 * 1   12/20/09 4:25p randyjew
 * SW7468-6:Add 7208 support
 * 
 * 1   12/20/09 4:21p randyjew
 * SW7468-6:Add 7208 support
 * 
 * 1   12/20/09 3:55p randyjew
 * SW7468-6:Add 7208 support
 * 
 * 1   12/20/09 3:41p randyjew
 * SW7468-6:Add 7208 support
 * 
