 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: nexus_platform_standby_7344.c $
 * $brcm_Revision: 6 $
 * $brcm_Date: 3/9/12 4:54p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/platforms/97344/src/nexus_platform_standby_7344.c $
 * 
 * 6   3/9/12 4:54p randyjew
 * SW7418-73: Workaround, disable KBD3 Seijin device.
 * 
 * 5   1/16/12 4:30p randyjew
 * SW7344-104: Add Xpt wake up
 * 
 * 4   1/16/12 1:19p randyjew
 * SW7344-104:Update for B0 support
 * 
 * 3   6/20/11 12:53p randyjew
 * SW7344-104: Update for PM2.0
 * 
 * 2   2/25/11 2:29p randyjew
 * SW7344-9: Update for PowerMangement 2.0.
 * 
 * 1   12/2/10 6:07p jrubio
 * SW7344-9: add initial standby file
 * 
 *
 *****************************************************************************/
...
BDBG_MODULE(nexus_platform_standby_7344);
