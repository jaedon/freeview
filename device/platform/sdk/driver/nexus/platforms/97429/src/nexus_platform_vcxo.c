...
* Revision History:
* 
* $brcm_Log: /nexus/platforms/97429/src/nexus_platform_vcxo.c $
* 
...
#if 0
    /* assert reset */
    ui32RegVal = BREG_Read32(hRegister, BCHP_VCXO_0_CTL_MISC_VC0_CTRL);
    ui32RegVal &= ~BCHP_MASK(VCXO_0_CTL_MISC_VC0_CTRL, DRESET);
    ui32RegVal |= BCHP_FIELD_DATA(VCXO_0_CTL_MISC_VC0_CTRL, DRESET, 1);
    BREG_Write32(hRegister, BCHP_VCXO_0_CTL_MISC_VC0_CTRL, ui32RegVal);
#endif
