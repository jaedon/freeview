...
*  ANY LIMITED REMEDY.
*
* $brcm_Workfile: nexus_platform_97435.c $
* $brcm_Revision: 21 $
* $brcm_Date: 11/9/12 4:50p $
*
* Revision History:
*
* $brcm_Log: /nexus/platforms/97435/src/nexus_platform_97435.c $
* 
* 21   11/9/12 4:50p mward
* SW7435-233:  RTS differences for B0.
* 
* 20   10/29/12 6:40p mward
* SW7435-233:  7435B0 currently has no 1T mode defined.
* 
* 19   10/29/12 6:30p mward
* SW7435-233:  7435B0 currently has no 1T mode defined.
* 
...
static void NEXUS_Platform_P_DisplaySettings(NEXUS_DisplayModuleSettings *pSettings)
{
    ...
    */
    if (g_num_xcodes == 4) {
		...
		pSettings->videoWindowHeapIndex[4][0] = NEXUS_MEMC0_PICTURE_BUFFER_HEAP;/* xcode 1 */
...
#else
	{
		g_num_xcodes = 2; /* 1 transcode RTS is not currently defined */
	}
#endif
