 ...
 * $brcm_Revision: 7 $
 * $brcm_Date: 11/6/12 11:37a $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/platforms/97435/src/nexus_platform_pinmux.c $
 * 
 * 7   11/6/12 11:37a mward
 ...
 * 
 * 6   10/25/12 1:26a mward
 * SW7435-452:  warning: statement with no effect in
 *  NEXUS_Platform_P_InitPinmux().
 * 
 * 5   5/2/12 1:18p mward
 * SW7435-92: change the pin muxing for the 3383 console only for the
 *  VMS_SFF board.
 * 
 * 4   5/1/12 3:26p ayxiang
 * SW7435-92: change the pin muxing to use the connect as 3383 console.
 * 
 * 3   3/7/12 7:30p mward
 * SW7435-7: Merge changes from 7425.
 * 
 ...
 *
 * 2   11/1/11 11:06a mward
 * SW7435-7:  Fix register field name.
 * 
 * 1   10/25/11 5:02p mward
...
*
* API Description:
*   This file contains pinmux initialization for the 97435 reference board.
*
*
***************************************************************************/
