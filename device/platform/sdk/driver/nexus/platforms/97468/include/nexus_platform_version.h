...
* Revision History:
*
* $brcm_Log: /nexus/platforms/97468/include/nexus_platform_version.h $
* 
* SW7435-433/1   10/19/12 5:05p mward
* SW7435-433: Set version 12.4
* 
* 4   8/8/12 5:10p randyjew
* SW7208-112: Update version to 4.5
* 
* 3   2/14/11 4:44p randyjew
* SW7208-112: Update version to 4.0
* 
* 2   6/18/10 2:16p randyjew
* SW7468-247:Update version to 3.0
* 
* 1   4/26/10 4:47p randyjew
* SW7405-3832: Add 7468 support
* 
...
**/
#define NEXUS_PLATFORM_97468        NEXUS_PLATFORM_VERSION(12,4)
#define NEXUS_PLATFORM_97468_CUSTOM ""
