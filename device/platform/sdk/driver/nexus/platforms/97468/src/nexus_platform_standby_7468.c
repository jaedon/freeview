 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: nexus_platform_standby_7468.c $
 * $brcm_Revision: 7 $
 * $brcm_Date: 5/10/11 2:45p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/platforms/97468/src/nexus_platform_standby_7468.c $
 * 
 * 7   5/10/11 2:45p randyjew
 * SW7208-158:Adding PM 2.0 power standby
 * 
 * 6   9/24/10 6:10p gskerl
 * SW7468-102: Cleaned up some debug code
 * 
 * 5   9/24/10 3:20p gskerl
 * SW7468-102: Merged back to /main branch
 * 
 * BRUTUS_97468_IBC_PM_DEMO/1   8/26/10 3:12p gskerl
 * SW7468-102: Added platform-specific pre and post passive standby code
 * 
...
BDBG_MODULE(nexus_platform_standby_7468);
