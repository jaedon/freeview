...
*  ANY LIMITED REMEDY.
* 
* $brcm_Workfile: nexus_platform_fpga.h $
* $brcm_Revision: 2 $
* $brcm_Date: 3/19/09 4:59p $
*
* API Description:
...
* Revision History:
*
* $brcm_Log: /nexus/platforms/97400/src/nexus_platform_fpga.h $
* 
* 2   3/19/09 4:59p erickson
...
* PR 35551: Adding I2C Handle
*
* Nexus_Devel/1   9/21/07 6:26p jgarrett
* PR 35002: Adding nexus_platform_fpga
*
***************************************************************************/
#ifndef NEXUS_PLATFORM_FPGA_H__
#define NEXUS_PLATFORM_FPGA_H__
