 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: nexus_platform_pci.h $
 * $brcm_Revision: 2 $
 * $brcm_Date: 2/10/09 12:43p $
 * 
 * Module Description:
 * 
 * Revision History:
 * 
 * $brcm_Log: /nexus/platforms/97400/src/nexus_platform_pci.h $
 * 
 * 2   2/10/09 12:43p shyam
 * PR51749 : Update PCI to support enabling the PCI slot
 * 
 * 1   3/31/08 12:37p shyam
 * PR 39899 : Add PCI detection for Transcoder module
 * 
 * PR39899/1   2/27/08 6:16p shyam
