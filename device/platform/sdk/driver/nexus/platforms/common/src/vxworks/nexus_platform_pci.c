 ...
 * $brcm_Revision: 2 $
 * $brcm_Date: 5/30/08 5:00p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/platforms/97405/src/vxworks/nexus_platform_pci.c $
 * 
 * 2   5/30/08 5:00p rjlewis
 * PR40352: warnings.
 * 
...
/***************************************************************************
Summary:
    Detect a PCI device with specified VendorId-DeviceId and make it current
***************************************************************************/
