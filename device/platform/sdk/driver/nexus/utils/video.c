 ...
 * $brcm_Revision: 11 $
 * $brcm_Date: 1/31/12 5:07p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /nexus/utils/video.c $
 * 
 * 11   1/31/12 5:07p rjlewis
 * SW7425-1136: Added HDMI support (and some cleanup).
 * 
 * 10   3/23/11 5:41p vsilyaev
 * SW7422-406: Unified parsing of command line parameters
 * 
 * 9   3/4/11 12:40p erickson
 * SW7420-1560: adapt to NEXUS_CalculateVideoWindowPosition change
 *
