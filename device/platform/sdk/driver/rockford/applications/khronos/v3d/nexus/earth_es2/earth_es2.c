 ...
 * Revision History:
 *
 * $brcm_Log: /rockford/applications/opengles_v3d/v3d/nexus/earth_es2/earth_es2.c $
 * 
 ...
 * SWVC4-101: Allow abstract platform support for V3D driver.
 * 
 * hauxwell_35230_v3d/13   11/23/10 12:30p gsweet
 * Fixed earth example for 7422
 * 
 * hauxwell_35230_v3d/12   11/3/10 3:42p hauxwell
 * add 7422 support
 * 
 * hauxwell_35230_v3d/11   11/1/10 10:53a hauxwell
 * fix SWVC4-76
 * 
 * hauxwell_35230_v3d/10   10/26/10 4:58p hills
 * Changed vertical filter mode to bilinear.
 * 
 * hauxwell_35230_v3d/9   10/19/10 3:38p hauxwell
 * add new BRCM_RegisterDisplay API
 * 
 * hauxwell_35230_v3d/8   10/12/10 1:20p hauxwell
 * update so frame divider doesn't half the max framerate
 * 
 * hauxwell_35230_v3d/7   10/8/10 12:01p hauxwell
 * add 60Hz
 * 
 * hauxwell_35230_v3d/6   9/7/10 11:54a hills
 * Minor fixes and added some consts
 * 
 * hauxwell_35230_v3d/5   9/7/10 10:20a hills
 * Modified viewport to scale appropriately when stretching to fit
 * 
 * hauxwell_35230_v3d/4   9/6/10 12:38p hills
 * Removed some redundant code and corrected some spelling mistakes
 * 
 * hauxwell_35230_v3d/3   9/3/10 4:03p hills
 * Simplified shaders, added error checking for compilation, corrected
 * earth orientation
 * 
 * hauxwell_35230_v3d/2   8/23/10 11:40a gsweet
 * Updated earth example. Point based starfield. Compressed textures.
 * 
 * hauxwell_35230_v3d/1   8/18/10 3:17p gsweet
...
int main(int argc, char** argv)
{
   ...
   if (!processArgs(argc, argv))
   {
      ...
      fprintf(stderr, "Usage: %s [+m] [+p] [+s] [d=WxH] [bpp=16/24/32]\n", progname);
      return 0;
   }
