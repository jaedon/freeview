 ...
 * Revision History:
 *
 * $brcm_Log: /rockford/applications/opengles_v3d/v3d/nexus/poly_rate/poly_rate.c $
 * 
 * Hydra_Software_Devel/2   3/17/11 4:23p erickson
 * SWVC4-133: merge
 * 
 * hauxwell_35230_v3d/4   12/15/10 12:22p gsweet
 ...
 * add 7422 support
 * 
 * hauxwell_35230_v3d/4   10/19/10 3:53p hauxwell
 * add new BRCM_RegisterDisplay API
 * 
 * hauxwell_35230_v3d/3   10/12/10 1:29p hauxwell
 * update so frame divider doesn't half the max framerate
 * 
 * hauxwell_35230_v3d/2   10/8/10 12:01p hauxwell
 * add 60Hz
 * 
 * hauxwell_35230_v3d/1   9/9/10 4:49p gsweet
 * Added poly_rate benchmark
 * 
 *
 *****************************************************************************/
