...
*  ANY LIMITED REMEDY.
* 
* $brcm_Workfile: b_psip_stateengine.h $
...
* Revision History:
*
* $brcm_Log: /rockford/lib/psip/src/b_psip_stateengine.h $
* 
...
***************************************************************************/
#define STATE_ENGINE(pJob,event) B_PSIP_StateEngine((pJob),(event),__FUNCTION__,__LINE__)
