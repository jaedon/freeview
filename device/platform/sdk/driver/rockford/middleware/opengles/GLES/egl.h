...
GLAPI EGLSurface APIENTRY eglCreateWindowSurface (EGLDisplay dpy, EGLConfig config, NativeWindow window, const EGLint *attrib_list);
GLAPI EGLSurface APIENTRY eglCreatePixmapSurface (EGLDisplay dpy, EGLConfig config, NativePixmap pixmap, const EGLint *attrib_list);
...
GLAPI void APIENTRY eglConfigureContext (EGLDisplay dpy, EGLContext ctx, EGLBoolean bRectangleBlit2D);
GLAPI void APIENTRY eglConfigureDevice (EGLDisplay dpy, GLuint uiTileWidth, GLuint uiTileHeight, GLboolean bTileMergeHorizontal, GLboolean bTileMergeVertical);
GLAPI GLint APIENTRY eglConfigureMemoryBlockout (EGLDisplay dpy, GLint iMemoryBlockout);
...
GLAPI EGLBoolean APIENTRY eglCopyBuffers (EGLDisplay dpy, EGLSurface surface, NativePixmap target);
