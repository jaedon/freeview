...
#ifndef _CARPL_DEFAULT_CARBON_H__
#define _CARPL_DEFAULT_CARBON_H__
 ...
 */
extern void CARPL_RegisterDisplayPlatform(NXPL_PlatformHandle *handle);
...
extern void *CARPL_CreateNativeWindow(const CARPL_NativeWindowInfo *info);

/* Update the 'native window' with new settings */
extern void CARPL_UpdateNativeWindow(void *native, const CARPL_NativeWindowInfo *info);

/* Destroy a 'native window' */
extern void CARPL_DestroyNativeWindow(void *nativeWin);
