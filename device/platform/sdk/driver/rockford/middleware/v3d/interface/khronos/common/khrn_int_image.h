...
typedef enum {
   ...
   */
   ...
   YUV_422     = IMAGE_FORMAT_PACK(_, UNCOMP, 16, COLOR  , YUYV, _   , YUYV_STD, _ , 888 ),
   YUV_422_REV = IMAGE_FORMAT_PACK(_, UNCOMP, 16, COLOR  , YUYV, _   , YUYV_REV, _ , 888 ),
...
{
   vcos_assert(format != IMAGE_FORMAT_INVALID);
   return (format & IMAGE_FORMAT_YUYV) == IMAGE_FORMAT_YUYV;
}
