...
#define VCOS_AFFINITY_CPU2    _VCOS_AFFINITY_CPU2
#define VCOS_AFFINITY_CPU3    _VCOS_AFFINITY_CPU3
...
/**
  * \brief Return the currently executing thread's ID as a uint32_t
  */
VCOS_INLINE_DECL
...
/** Return the number of logical processors in the system
  *
  */
VCOSPRE_ int VCOSPOST_ vcos_thread_num_processors(void);
