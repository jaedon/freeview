...
"   return vec2(x[0] - y * floor(x[0] * ry), "
"               x[1] - y * floor(x[1] * ry));"
"}";
...
"   return vec3(x[0] - y * floor(x[0] * ry), "
"               x[1] - y * floor(x[1] * ry), "
"               x[2] - y * floor(x[2] * ry));"
"}";
...
"   return vec4(x[0] - y * floor(x[0] * ry), "
"               x[1] - y * floor(x[1] * ry), "
"               x[2] - y * floor(x[2] * ry), "
"               x[3] - y * floor(x[3] * ry));"
"}";
...
"   return $$texture_2d_bias(sampler, coord.st *= oocoord, bias);"
"}"

"vec4 texture2DProj(sampler2D sampler, vec3 coord)"
"{"
"   float oocoord = 1.0 / coord[2];"
"   return $$texture_2d_bias(sampler, coord.st *= oocoord, 0.0);"
"}"
...
"{"
"   float maxabs = $$fmaxabs( coord[0], $$fmaxabs( coord[1], coord[2] ) );"
"   float oomaxabs = 1.0 / maxabs;"
"   vec3 norm_coord = coord * oomaxabs;"
