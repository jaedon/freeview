...
extern void glxx_server_state_set_buffers(GLXX_SERVER_STATE_T *state, MEM_HANDLE_T draw, uint32_t swapchainc, MEM_HANDLE_T read, MEM_HANDLE_T depth, MEM_HANDLE_T multi);
