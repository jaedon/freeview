   ...
   const int32_t *scissor_rects, uint32_t scissor_rects_count)
{
   ...
   khrn_memcpy(msg->u.copy_scissor_regions.scissor_rects, scissor_rects, scissor_rects_count * sizeof(int32_t));
   ...
   KHRN_IMAGE_FORMAT_T output_format)
{
   ...
   khrn_memcpy(msg->u.lookup.red_lut, red_lut, 256);
   khrn_memcpy(msg->u.lookup.green_lut, green_lut, 256);
   khrn_memcpy(msg->u.lookup.blue_lut, blue_lut, 256);
   khrn_memcpy(msg->u.lookup.alpha_lut, alpha_lut, 256);
   ...
   KHRN_IMAGE_FORMAT_T output_format)
{
   ...
   khrn_memcpy(msg->u.lookup_single.lut, lut, 256 * sizeof(uint32_t));
...
#ifdef NO_VPU
   khrn_memcpy(msg->u.sconv.kernel_x, kernel_x, kernel_width * 2);
   khrn_memcpy(msg->u.sconv.kernel_y, kernel_y, kernel_height * 2);
...
#ifdef NO_VPU
   khrn_memcpy(msg->u.conv.kernel, kernel, kernel_width * kernel_height * 2);
