 ...
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/nexus/astm/pr50561.c $
 * 
...
int main(void)
{
    ...
    astmSettings.enableClockReferenceDetection = false;
    astmSettings.preferPtsMasterMode = true;
