 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: use_after_close.c $
 ...
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/nexus/debug/use_after_close.c $
 * 
...
int main(void)
{
    ...
    NEXUS_Surface_GetCreateSettings(surface,&createSettings); /* should fail */
