 ...
 *  ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: get_encode_latency.c $
 * $brcm_Revision: Hydra_Software_Devel/1 $
 * $brcm_Date: 10/9/12 2:59p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/nexus/encoder/get_encode_latency.c $
 * 
 * Hydra_Software_Devel/1   10/9/12 2:59p jessem
 * SW7425-3832: Initial version.
 *
 **************************************************************************/
