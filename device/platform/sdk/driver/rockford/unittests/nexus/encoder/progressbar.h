 ...
 * $brcm_Date: 8/31/12 1:48p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/nexus/encoder/progressbar.h $
 * 
 * Hydra_Software_Devel/1   8/31/12 1:48p hongtaoz
 * SW7425-3425, SW7425-3349: merged FNRT to mainline; added FNRT unit
 * test;
 * 
 * Hydra_Software_Devel/FNRT_Demo/1   8/24/12 4:36p hongtaoz
 * SW7425-3349: added progress bar to simul display for demo;
 * 
