 ...
 *  ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: video_conf.c $
 * $brcm_Revision: Hydra_Software_Devel/4 $
 * $brcm_Date: 8/23/12 2:29p $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/nexus/encoder/video_conf.c $
 * 
 * Hydra_Software_Devel/4   8/23/12 2:29p jessem
 * SW7425-2241: Updated encoder settings for low delay mode and added
 * encode latency logging.
 *
 * Hydra_Software_Devel/3   8/20/12 12:04p jessem
 * SW7425-2241: Added record to file and loopback support.
 *
 * Hydra_Software_Devel/2   5/22/12 4:33p jessem
 * SW7425-2241: COrrected command line option parsing.
 *
 * Hydra_Software_Devel/1   5/22/12 3:11p jessem
    ...
    */
    ...
    for (i=0;i<500;i++)
    {
        ...
        do
		{
			...
			if (i != 0)
			{
			    BDBG_ERR(("Pic %d: Surface PTS = 0x%x", surfaceSettings.picId, surfaceSettings.pts));
			}
