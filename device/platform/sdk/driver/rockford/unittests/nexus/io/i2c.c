 ...
 * $brcm_Date: 2/18/09 9:37a $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/nexus/io/i2c.c $
 * 
...
int main(void)
{
    ...
    i2c = NEXUS_I2c_Open(0, &i2cSettings);
    NEXUS_I2c_GetSettings(i2c, &i2cSettings);
    rc = NEXUS_I2c_SetSettings(i2c, &i2cSettings);
    BDBG_ASSERT(!rc);
    NEXUS_I2c_Close(i2c);
