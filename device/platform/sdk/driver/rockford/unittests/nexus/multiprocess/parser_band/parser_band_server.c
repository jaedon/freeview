 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: parser_band_server.c $
 ...
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/nexus/multiprocess/parser_band/parser_band_server.c $
 * 
...
BDBG_MODULE(parser_band_server);
...
int main(int argc, char **argv)  
{
    ...
    if (use_band_0)
    {
        ...
        printf("Server acquiring parser band 0...");
    ...
    {
        printf("Server not acquiring any parser bands\n");
    }
