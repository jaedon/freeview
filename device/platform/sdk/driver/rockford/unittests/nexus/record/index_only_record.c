 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: index_only_record.c $
 ...
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/nexus/record/index_only_record.c $
 * 
...
int main(int argc, char **argv) {
    ...
    /* TODO: The data buffer has to exist because the HW monitors overflow, but its contents don't matter.
    because of this, multiple index-only recpumps can share the same buffer, which saves system memor. */
    ...
    recordFile = NEXUS_FileRecord_OpenPosix(NULL, "videos/stream.nav");
