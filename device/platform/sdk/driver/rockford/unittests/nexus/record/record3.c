 ...
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/nexus/record/record3.c $
 * 
 * Hydra_Software_Devel/4   5/27/11 11:56a erickson
 * SW7405-691: update tests
 * 
 * Hydra_Software_Devel/3   7/29/10 12:15p calvinho
