 ...
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/nexus/video_decoder/avc_fcc_demo.c $
 * 
 ...
 * 
 * Hydra_Software_Devel/8   5/11/11 5:21p jtna
 * SW7425-568: increase parserband maxdatarate for 40nm platforms
 * 
 * Hydra_Software_Devel/7   9/10/10 12:33p jtna
 ...
 * 
 * Hydra_Software_Devel/4   7/28/10 4:23p calvinho
 * SW7405-4653: Added Ip Streamer input support
 * 
 * Hydra_Software_Devel/3   1/26/10 4:52p jtna
 * SW7405-3753: add more test streams
 * 
 * Hydra_Software_Devel/2   10/9/09 5:47p jtna
 * SW7405-3119: add options to control primer transition behavior
 * 
 * Hydra_Software_Devel/1   9/25/09 3:29p jtna
 * SWDEPRECATED-4001: add avc_fcc_demo.c
 *
******************************************************************************/
...
#define TOTAL_PRIMERS 4 /* this should match the number of pids in the TS stream you're using below */
struct {
    unsigned short video_pid; /* AVC */
    unsigned short audio_pid; /* AC3 */
    unsigned parser;
} g_programs[TOTAL_PRIMERS] = {

#if 0 /* \\lbirv-nas-0001\streams\streams\streamer\EchoStar_Misc\estar1_avc.mpg */
    {0x1022, 0x1023, 0},
    {0x1122, 0x1123, 0},
    {0x1222, 0x1223, 0},
    {0x1322, 0x1323, 0},
...
#if 1 /* \\lbirv-nas-0001\streams\streams\streamer\video_primer\CES2011_QAMStreams\ces2011_qam256-1_v0.ts */
    {0x101, 0x104, 0},
    {0x201, 0x204, 0},
    {0x301, 0x304, 0},
    {0x401, 0x404, 0},
...
#define MAX_DATA_RATE 42*1024*1024
...
int main(void)
{
    ...
    parserBandSettings.maxDataRate = MAX_DATA_RATE; /* higher bandwidth required to cover high-bitrate stream */
    ...
    videoDecoderOpenSettings.fifoSize = 8 * 1024 * 1024; /* larger CDB needed for AVC HD fcc */
#ifdef IP_STREAMER_SUBST
    /* Omit ip streamer settings for videoDecoder */
#endif
