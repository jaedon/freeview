 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: apetest_cmdline.h $
 ...
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/portinginterface/ape/97422/common/apetest_cmdline.h $
 * 
 ...
 *
 *****************************************************************************/
#ifndef APETEST_CMDLINE_H__
#define APETEST_CMDLINE_H__
...
typedef struct APETEST_CommonOpts {
    BAVC_StreamType streamType;
    BAVC_ItbEsType  itbType;
    unsigned pcrPid, audioPid;
    unsigned audioCdb;
    BAVC_AudioCompressionStd audioCodec;
...
/*
APETEST_PrintUsageCommon can be called if APETEST_ParseCommon fails
*/
...
/* convert opts to AvCtxCfg params */
BERR_Code APETEST_OptsToRaveSettings( BXPT_RaveCx_Handle hCtx, APETEST_CommonOpts *opts, BXPT_Rave_AvSettings *AvCtxCfg );
