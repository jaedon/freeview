 ...
 * ANY LIMITED REMEDY.
 *
 * $brcm_Workfile: bvat_main.c $
 * $brcm_Revision: Hydra_Software_Devel/2 $
 * $brcm_Date: 4/23/09 11:33a $
 *
 * Module Description:
 *
 * Revision History:
 *
 * $brcm_Log: /rockford/unittests/portinginterface/vdc/vat/bvat_main.c $
 * 
...
int main(void)
{
	...
	BDBG_MSG(("starting nexus platform - base and core only"));
	NEXUS_Platform_Init(NULL);
	NEXUS_PowerManagement_SetCoreState(NEXUS_PowerManagementCore_eVdec, true);
