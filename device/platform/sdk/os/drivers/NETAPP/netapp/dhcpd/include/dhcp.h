 ...
 *
 * $Id: dhcp.h,v 1.13 2010-05-19 15:12:06 franckf Exp $
 */
#ifndef DHCP_H
#define DHCP_H
...
typedef void (*DHCP_REQUEST_CALLBACK)(unsigned long ip_address, void *pParam);

void DHCP_main(void *Handle);
void *DHCP_init(unsigned long subnet, unsigned char starting_ip, unsigned char ending_ip,
                unsigned long gateway, unsigned long dns, char *interface, DHCP_REQUEST_CALLBACK callback, void *Param);
