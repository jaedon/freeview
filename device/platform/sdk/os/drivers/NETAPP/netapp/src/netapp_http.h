 ...
 *
 * Implement a HTTP voice recognision search by taking the Bluetooth recorded
 * PCM voice, convert it to FLAC and send it off to google voice search
 */

#ifndef NETAPP_HTTP_H
#define NETAPP_HTTP_H
