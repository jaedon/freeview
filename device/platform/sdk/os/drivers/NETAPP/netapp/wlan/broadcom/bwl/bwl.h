 ...
 *
 * $Id: bwl.h,v 1.15 2010/08/13 23:21:01 Exp $
 */
#include <stdio.h>
#include <stdlib.h>
...
int32_t BWL_EScan(BWL_Handle hBwl, ScanParams_t *pScanParams);
int32_t BWL_EScanAbort(BWL_Handle hBwl);
int32_t BWL_EScanResults(BWL_Handle hBwl, const char *pIface, ScanInfo_t **pData, uint32_t *pulCount, bool *pbStop);
