 ...
 *
 * $Id: fbsd_osl.h 497623 2014-08-20 01:28:11Z $
 */
...
/* #define PKTSETSUMGOOD(skb, x)   1 //will cause "warning: statement with no effect" */
#define PKTSETSUMGOOD(skb, x)	BCM_REFERENCE(skb)
