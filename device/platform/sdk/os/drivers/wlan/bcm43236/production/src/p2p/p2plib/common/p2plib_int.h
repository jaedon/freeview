 ...
 */
#ifdef IL_BIGENDIAN
extern BCMP2P_BOOL bcm_endian_swap = FALSE;
#define htod32(i) (bcm_endian_swap?bcmswap32(i):i)
#define htod16(i) (bcm_endian_swap?bcmswap16(i):i)
#define dtoh32(i) (bcm_endian_swap?bcmswap32(i):i)
#define dtoh16(i) (bcm_endian_swap?bcmswap16(i):i)
