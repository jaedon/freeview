...
ifeq ($(CONFIG_SUPPORT_WPS),y)
	CFLAGS += -DCONFIG_SUPPORT_WPS
	
	ifeq ($(CONFIG_SUPPORT_PBC_PHYSICAL),y)
		CFLAGS += -DCONFIG_SUPPORT_PBC_PHYSICAL
	endif
endif
	
ifeq ($(CONFIG_SUPPORT_ENTERPRISE),y)
	CFLAGS += -DCONFIG_SUPPORT_ENTERPRISE
endif

CFLAGS += -DBCMWPA2 -fPIC
CFLAGS += -fno-strict-aliasing -Wno-error
