...
extern "C"
{
...
#ifdef	HUMAX_FTP
	#define REPL_120 "Server is busy. Please try again.\r\n"
	#define REPL_150 "Opening data connection for directory list\r\n"
	#define REPL_200 "Port command successful\r\n"
	#define REPL_202 "Command is not implemented\r\n"
	#define REPL_211_STATUS "Extension supported :\r\n %s.\r\n"
	#define REPL_211_END "END\r\n"
	#define REPL_214 "FTP Server Help.\r\n"
	#define REPL_214_END "End\r\n"
	#define REPL_215 "%s system type.\r\n"
	#define REPL_220 "Welcome to connection.\r\n"
	#define REPL_221 "Bye bye~\r\n"
	#define REPL_226 "Closing data connection.\r\n"
	#define REPL_230 "User logged in, proceed.\r\n"
	#define REPL_250 "File action is successful. Proceed.\r\n"
	#define REPL_257 "Directory (%s) created.\r\n"
	#define REPL_257_PWD "\"%s\" is current working dir.\r\n"

	#define	REPL_331 "Password required for %s.\r\n"
	#define REPL_331_ANON "Anonymous login okay, send your complete email as your password.\r\n"
	#define REPL_332 "Need account for login.\r\n"
	#define REPL_350 "Requested file action pending further information.\r\n"
	#define REPL_425 "Fail to open data connection.\r\n"
	#define REPL_426 "Connection is closed. Transfer action is aborted.\r\n"
	#define REPL_450 "Requested file action not taken.\r\n"
	#define REPL_451 "Requested action aborted. Local error in processing.\r\n"
	#define REPL_500 "Syntax error, command unrecognized.\r\n"
	#define REPL_501 "Syntax error in parameters or arguments.\r\n"
	#define REPL_502 "Command not implemented.\r\n"
	#define REPL_502_NOT_SUPPORT "Command not supported.\r\n"
	#define REPL_503 "Bad sequence of commands.\r\n"
	#define REPL_504 "Command not implemented for that parameter.\r\n"
	#define REPL_530 "Not logged in. Please log-in first.\r\n"
	#define REPL_550 "Requested action not taken.\r\n"
	#define REPL_552 "Requested file action aborted.\r\n"
	#define REPL_553 "Requested action not taken.\r\n"
	#define	REPL_560 "Cannot retrieve this content because of copy protection.\r\n"
	#define REPL_561 "Cannot store this content because of copy protection.\r\n"
	#define REPL_562 "Cannot delete this content because of copy protection.\r\n"
#else
	...
	int send_repl_len(int ,int errCode, char *,int );
