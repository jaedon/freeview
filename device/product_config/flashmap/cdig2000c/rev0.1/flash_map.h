...
#define    N_PART_BOOT1_DEVICE				"flash1"
...
#define    N_PART_GP1_DEVICE				"flash4"
...
#define    N_PART_GP2_DEVICE				"flash5"
...
#define    N_PART_NVRAM_ENV_DEVICE          "flash6.env"
...
#define    N_PART_GP3_DEVICE				"flash6"
...
#define    N_IMAGE_KERNEL_BOOT_DEVICE		"flash4"
#define    N_IMAGE_KERNEL_BOOT_OPT		    "initrd=0x14000000,0xc800000 root=/dev/ram0 rw ramdisk_size=204800 brcm_cma_kern_rsv=520M"

#define    N_IMAGE_2ND_KERNEL_OFFSET		0x0F000000
#define    N_IMAGE_2ND_KERNEL_SIZE			(16*MEGABYTES)
#define    N_IMAGE_2ND_KERNEL_BOOT_DEVICE	"flash5"
...
#define    N_IMAGE_OTA_KERNEL_BOOT_DEVICE	"flash3"
