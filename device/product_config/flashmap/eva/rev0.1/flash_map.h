...
static const struct emmc_fs_partition_t emmc_fs_partition_map[] = {
	{"gpt1", 2000*MEGABYTES, EMMCFS_PRIMARY, EMMCFS_FSTYPE_EXT4, N_PART_FSAREA_NODE"p1"},
	{"gpt2", 2000*MEGABYTES, EMMCFS_PRIMARY, EMMCFS_FSTYPE_EXT4, N_PART_FSAREA_NODE"p2"},
	{"gpt3", 1000*MEGABYTES, EMMCFS_PRIMARY, EMMCFS_FSTYPE_EXT4, N_PART_FSAREA_NODE"p3"},
	{"gpt4", 1000*MEGABYTES, EMMCFS_PRIMARY, EMMCFS_FSTYPE_FAT32, N_PART_FSAREA_NODE"p4"},
#if 0//example	
