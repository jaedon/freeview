...
#define FLASH_UBI_AREA_ROOTFS_SIZE			(33*MEGABYTES + 60*KILOBYTES)	/* Root FS(33MB+60kB) */
#define FLASH_UBI_AREA_KERNEL_SIZE			(4*MEGABYTES - 4*KILOBYTES)		/* Kernel(4MB-4kB) */
#define FLASH_UBI_AREA_RAWFS_SIZE			(37*MEGABYTES + 56*KILOBYTES)	/* RAW FS(37MB+52kB) */
...
#define N_HMX_BOOTMTD_NODE			"/dev/mtd1"			/* 4M loader mtd */
#define N_HMX_MTD2UBIRAWFS_NODE		"/dev/mtdblock8"			/* ubi volume  ubia*/
