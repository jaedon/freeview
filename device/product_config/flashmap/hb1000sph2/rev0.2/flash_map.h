...
#define FLASH_UBIFS_AREA_SIZE				(355*MEGABYTES)				/* DB backup(16MB) + Reserved(1MB) + DB(16MB) + Reserved(1MB) + DB user(58MB)+ Reserved(1MB) + DB data(230MB)+ Reserved(32MB) */
...
#define UBIFS_PART4_SIZE					(230*MEGABYTES)				/* db data area*/
#define NUM_UBIFS_PART						(4)							/* total number of ubifs partition*/
...
#define DEFAULT_BBT0_SIZE_MB				0x00200000					/* 1 MB for total 128MB, 2MB for total 256MB */

#define N_HMX_BOOTMTD_NODE					"/dev/mtdblock2"					/* 4M loader mtd */
#define N_HMX_MTD2UBIRAWFS_NODE				"/dev/mtdblock6"			/* ubi volume */
#define N_HMX_MTD2UBIROOTFS_NODE			"/dev/mtdblock6"			/* ubi volume */
#define N_HMX_MTD2UBIDBBACKUP_NODE			"/dev/mtdblock7"			/* ubi volume */
#define N_HMX_MTD2UBIDB_NODE				"/dev/mtdblock8"			/* ubi volume */
#define N_HMX_MTD2UBIDBUSER_NODE			"/dev/mtdblock9"			/* ubi volume */
#define N_HMX_MTD2UBIDBUSEREXT_NODE			"/dev/mtdblock10"			/* ubi volume */
