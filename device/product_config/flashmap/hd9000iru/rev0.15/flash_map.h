...
#define N_TOTAL_SIZE						0x20000000					/* 512MB */
...
#define NAGRA_FPK_LOGICAL_OFFSET			(0x00000418)
...
#define UBIFS_PART4_SIZE					(115*MEGABYTES)				/* db data area*/
#define UBIFS_PART5_SIZE					(115*MEGABYTES)				/* db data backup area*/
#define NUM_UBIFS_PART						(5)							/* total number of ubifs partition*/
...
#define N_HMX_MTD2UBIDBUSEREXT_NODE			"/dev/mtdblock9"			/* ubi volume */
#define N_HMX_MTD2UBIDBUSEREXTBACKUP_NODE	"/dev/mtdblock10"			/* ubi volume */
