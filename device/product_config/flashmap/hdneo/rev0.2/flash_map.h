...
#define N_HMX_BOOTMTD_NODE					"/dev/mtdblock3"					/* 4M loader mtd */
#define N_HMX_MTD2UBIRAWFS_NODE				"/dev/mtdblock7"			/* ubi volume */
#define N_HMX_MTD2UBIROOTFS_NODE			"/dev/mtdblock7"			/* ubi volume */
#define N_HMX_MTD2UBIDBBACKUP_NODE			"/dev/mtdblock8"			/* ubi volume */
#define N_HMX_MTD2UBIDB_NODE				"/dev/mtdblock9"			/* ubi volume */
#define N_HMX_MTD2UBIDBUSER_NODE			"/dev/mtdblock10"			/* ubi volume */
