...
#define FLASH_UBI_AREA_SIZE					(82*MEGABYTES)		/* total ubi area size */
#define FLASH_UBI_AREA_RESERVED_SIZE		(6096*KILOBYTES)	/* ubi area reserved size */
#define UBI_PART1_SIZE						(FLASH_UBI_AREA_SIZE - FLASH_UBI_AREA_RESERVED_SIZE)
...
#define UBIFS_PART2_SIZE					(4*MEGABYTES) 				/* db area */
#define UBIFS_PART3_SIZE					(28*MEGABYTES)				/* db user */
...
#define 			N_UBI_KERNEL_SIZE			(4*MEGABYTES - 4*KILOBYTES)
#define 		N_UBI_RAW_FS_OFFSET			(N_UBI_KERNEL_OFFSET + N_UBI_KERNEL_SIZE)
#define 			N_UBI_RAW_FS_SIZE			(37*MEGABYTES + 56*KILOBYTES)
