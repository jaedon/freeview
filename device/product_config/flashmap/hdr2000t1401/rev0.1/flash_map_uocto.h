...
#define N_TOTAL_SIZE					(0x08000000) /* 128MB */
...
#define FLASH_UBI_AREA_SIZE					(0x06400000)		/* MTD Size : 100 MB */
#define UBI_PART1_SIZE							(306*LOGICAL_BLOCK_SIZE) /*VOL1 Size : 306 LEB*/
#define UBI_PART2_SIZE							(306*LOGICAL_BLOCK_SIZE) /*VOL2 Size : 306 LEB*/
#define UBI_PART3_SIZE							(104*LOGICAL_BLOCK_SIZE)  /*VOL3 Size : 104LEB*/
...
#define FLASH_UBIFS_AREA_SIZE				(0x1200000)	/* MTD Size : 18 MB */
#define UBIFS_PART1_SIZE						(4*MEGABYTES)  /*VOL2 Size - db_backup : 4MB */
#define UBIFS_PART2_SIZE						(7*MEGABYTES) /*VOL3 Size - db_backup : 7MB */
#define UBIFS_PART3_SIZE						(7*MEGABYTES) /*VOL4 Size - db_backup : 7MB */

/* UBI Partition physical offset */
#define UBIFS_PART1_PHY_OFFSET				(FLASH_UBIFS_AREA_START)
#define UBIFS_PART2_PHY_OFFSET				(FLASH_UBIFS_AREA_START + PHY_PART_SIZE(UBIFS_PART1_SIZE))
#define UBIFS_PART3_PHY_OFFSET				(UBIFS_PART2_PHY_OFFSET + PHY_PART_SIZE(UBIFS_PART2_SIZE))

#define N_BL_PROTECTED						"boot"
#define N_LDR_PROTECTED						"ldr"
#define N_UBI_CTRLED						"ubi_area"
#define N_UBINVRAM_CTRLED					"ubinvram_area"
...
#define 			N_UBI_ROOT_FS_SIZE			(33*MEGABYTES + 60*KILOBYTES)
...
#define N_UBI_2ND_ROOT_FS_SIZE			(258*LOGICAL_BLOCK_SIZE)		/* 2nd ROOTFS Size : 258 LEB */
...
#define N_UBI_OTA_KERNEL_OFFSET			(UBI_PART3_PHY_OFFSET)			/* VOL3 Start Address : 0x14A78000 */
#define N_UBI_OTA_KERNEL_SIZE				(104*LOGICAL_BLOCK_SIZE)			/* OTA KERNEL Size : 104 LEB */

/* NVRAM size must be alligned to LEB size */
	/* NVRAM */
#define FLASH_NVRAM_VOL_START				(FLASH_UBINVRAM_AREA_START)				/* NVRAM MTD Start Address : 0x16C00000 */
...
#define N_HMX_MTD2UBIRAWFS_NODE			"/dev/mtdblock9"			/* ubi volume 1 */
#define N_HMX_MTD2UBIROOTFS_NODE		"/dev/mtdblock7"			/* ubi volume 1 */
#define N_HMX_MTD2UBIDBBACKUP_NODE	"/dev/mtdblock10"			/* ubifs volume 1 */
#define N_HMX_MTD2UBIDB_NODE				"/dev/mtdblock11"			/* ubifs volume 2 */
#define N_HMX_MTD2UBIDBUSER_NODE		"/dev/mtdblock12"			/* ubifs volume 3 */
...
#define N_HMX_MTD2UBIPART3_NODE     "/dev/mtdblock9"        	/* ubi volume 2 : OTA Image partition */

/* In case of using separate NVRAM volume */
#define N_HMX_MTD2UBINVRAM_NODE			"/dev/mtdblock13"			/* ubinvram volume 0 */
#define N_HMX_MTD2UBINVRAMB_NODE		"/dev/mtdblock14"			/* ubinvram volume 1 */
...
static struct mtd_partition fixed_nand_partition_map[] MAYBE_UNUSED  = 
{
	...
	{ name: N_UBINVRAM_CTRLED,	offset: FLASH_UBINVRAM_AREA_START,		size: FLASH_UBINVRAM_AREA_SIZE },	
};
#endif
