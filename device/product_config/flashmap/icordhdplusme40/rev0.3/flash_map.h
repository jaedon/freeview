...
#define UBIFS_PART3_SIZE		(28*MEGABYTES) /*db_user area*/
...
#define N_BL_OFFSET						0x00000000 /* BOOT block??4M ?꾩껜 ?곸뿭??°�?access ??룄潿????*/
...
#define NUM_UBI_PARTITION 2 /*ubi_area, ubifs_area*/
#define NUM_FLASHFS_MOUNT_POINT 2
#endif
