...
#define    N_PART_NVRAM_ENV_DEVICE          "emmcflash1"
#else
#define    N_PART_NVRAM_RW_OFFSET           (0x22800000)
...
#define    N_PART_FSAREA_OFFSET             (0x23000000)
