...
#define FLASH_UBI_AREA_SIZE					(0x25F00000)		/* MTD Size : 607 MB */
...
#define FLASH_UBINVRAM_AREA_SIZE			(0x6400000)			/* MTD Size : 100 MB */
#define UBINVRAM_PART1_SIZE					(4*LOGICAL_BLOCK_SIZE)   /*VOL0 Size : 4 LEB*/
#define UBINVRAM_PART2_SIZE					(4*LOGICAL_BLOCK_SIZE)   /*VOL1 Size : 4 LEB*/
...
#define FLASH_NVRAM_VOL_START			(FLASH_UBINVRAM_AREA_START)				/* NVRAM MTD Start Address : 0x26300000 */
...
#define N_HMX_MTD2UBIRAWFS_NODE				"/dev/mtdblock8"			/* ubi volume 1 */
#define N_HMX_MTD2UBIROOTFS_NODE			"/dev/mtdblock8"			/* ubi volume 1 */
#define N_HMX_MTD2UBIDBBACKUP_NODE			"/dev/mtdblock13"			/* ubifs volume 1 */
#define N_HMX_MTD2UBIDB_NODE				"/dev/mtdblock14"			/* ubifs volume 2 */
#define N_HMX_MTD2UBIDBUSER_NODE			"/dev/mtdblock15"			/* ubifs volume 3 */
#define N_HMX_MTD2UBIBLOCK_NODE   3						/* mtd block without ubi, kernel region + rootfs region */

#define N_HMX_MTD2UBIPART2_NODE     		"/dev/mtdblock9"        	/* ubi volume 2 : 2nd Image partition */
#define N_HMX_MTD2UBIPART3_NODE     		"/dev/mtdblock10"        	/* ubi volume 3 : 3rd Image partition */

/* In case of using separate NVRAM volume */
#define N_HMX_MTD2UBINVRAM_NODE				"/dev/mtdblock11"			/* ubinvram volume 0 */
#define N_HMX_MTD2UBINVRAMB_NODE			"/dev/mtdblock12"			/* ubinvram volume 1 */
