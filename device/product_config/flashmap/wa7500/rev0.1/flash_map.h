...
#define UBI_PART1_OFFSET				FLASH_LOADER_AREA_SIZE
#define UBI_PART1_SIZE					(0x1C66C000)		/* VOL1 SIze : 458*1016*1024 LEB*/
#define UBI_PART1_RESERVED_SIZE			(0x94000)
#define UBI_PART2_OFFSET				(UBI_PART1_OFFSET + UBI_PART1_SIZE + UBI_PART1_RESERVED_SIZE)
...
#define N_UBI_KERNEL_OFFSET   (0x084FC000)
#define N_UBI_KERNEL_SIZE				(0x5F4000)				/* 5MB + 976KB */
#define N_UBI_RAW_FS_OFFSET		(0x08AF0000)
#define N_UBI_RAW_FS_SIZE				(0x13988000)			/* 313MB + 544KB */
#define N_UBI_ROOT_FS_OFFSET	(0x1CB00000)
#define N_UBI_ROOT_FS_SIZE		(0xB494000) 		  /* 180MB + 592KB */
...
#define N_HMX_MTD2UBIROOTFS_NODE		"/dev/mtdblock7"		/* for ubi_xxx(), ubi volume */
#define N_HMX_MTD2UBIANDROID_NODE		"/dev/mtdblock6"		/* for ubi_xxx(), ubi volume */
#define N_HMX_MTD2UBIPART2_NODE		"/dev/mtdblock7"		/* for ubi_xxx(), ubi volume */
