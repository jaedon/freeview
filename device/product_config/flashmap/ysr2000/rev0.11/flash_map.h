...
#define    N_PART_GP2_APP_OFFSET            (N_PART_GP2_OFFSET)
#define    N_PART_GP2_APP_SIZE              (N_PART_GP2_SIZE)
#define    N_PART_GP2_APP_NODE              MAIN_EMMC_DEVICE"gp2"
...
static const struct emmc_partition_t emmc_partition_map[] = {
	...
	{"gp0",        N_PART_GP0_OTALDR_SIZE,      N_PART_GP0_OTALDR_OFFSET, 0,            N_PART_GP0_OTALDR_NODE,  N_PART_GP0_DEVICE},
...
/************************<eMMC Parameters in CFE -start- >*****************************************/
#define CONFIG_EMMC_PARTITON_CTRL

#if defined(CONFIG_EMMC_PARTITON_CTRL)
#define STB_EMMC_PATITION_CTRL	EMMC_ON		/* Top Level Partition Control */
#else
#define STB_EMMC_PATITION_CTRL	EMMC_OFF		/* Top Level Partition Control */
#endif

#define STB_EMMC_GPT_SUPPORT	EMMC_OFF

#define STB_EMMC_GP1_PATITION	EMMC_ON		/* GP1 Partition in Data Area */
#define STB_EMMC_GP2_PATITION	EMMC_ON		/* GP2 Partition in Data Area */
#define STB_EMMC_GP3_PATITION	EMMC_ON		/* GP3 Partition in Data Area */
#define STB_EMMC_GP4_PATITION	EMMC_ON		/* GP4 Partition in Data Area */
#define STB_EMMC_ENH_PATITION	EMMC_ON		/* ENH Partition in Data Area */

#define STB_EMMC_PHY_PATITION	( STB_EMMC_PATITION_CTRL & \
									( STB_EMMC_GP1_PATITION | STB_EMMC_GP2_PATITION \
									| STB_EMMC_GP3_PATITION | STB_EMMC_GP4_PATITION \
									| STB_EMMC_ENH_PATITION ) )

/* SET eMMC PARTITON SIZE */
#define STB_EMMC_PART_SIZE_GP1		((N_PART_GP0_SIZE + 1) / MEGABYTES)	/* [MB] */
#define STB_EMMC_PART_SIZE_GP2		((N_PART_GP1_SIZE + 1) / MEGABYTES)	/* [MB] */
#define STB_EMMC_PART_SIZE_GP3		((N_PART_GP2_SIZE + 1) / MEGABYTES)	/* [MB] */
#define STB_EMMC_PART_SIZE_GP4		((N_PART_GP3_SIZE + 1) / MEGABYTES)	/* [MB] */
#define STB_EMMC_PART_SIZE_ENH		((N_PART_ENH_SIZE + 1) / MEGABYTES)	/* [MB] */

#define STB_EMMC_PART_ATTR_EXT_GP1	EMMC_PART_ATTR_SYS		/* DFT(default), SYS(System code), NOP(Non-persistent) */
#define STB_EMMC_PART_ATTR_EXT_GP2	EMMC_PART_ATTR_SYS		/* DFT(default), SYS(System code), NOP(Non-persistent) */
#define STB_EMMC_PART_ATTR_EXT_GP3	EMMC_PART_ATTR_SYS		/* DFT(default), SYS(System code), NOP(Non-persistent) */
#define STB_EMMC_PART_ATTR_EXT_GP4	EMMC_PART_ATTR_SYS		/* DFT(default), SYS(System code), NOP(Non-persistent) */
/************************<eMMC Parameters in CFE -end- >*****************************************/
