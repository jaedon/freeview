...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
    ...
    {GPIO_ID_FAN_SPEED,    	NULL,   NEXUS_GpioType_eAonStandard, 	3,    GPIO_MODE_INTERRUPT,	GPIO_INT_MODE_FALLING_EDGE,		GPIO_INVAILD},
...
{
		{NEXUS_InputBand_e6, 0},
		{NEXUS_InputBand_e7, 1},
};
