...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_KEY_STBY,    	NULL,	NEXUS_GpioType_eAonStandard, 		3,	GPIO_MODE_INTERRUPT,	GPIO_INT_MODE_FALLING_EDGE,	GPIO_HI},
	...
	{GPIO_ID_LED_STBY,  	NULL,	NEXUS_GpioType_eAonStandard, 		7,	GPIO_MODE_WRITE,		GPIO_INT_MODE_DISABLED,	GPIO_LOW},
	{GPIO_ID_FBO_SCART,	NULL,	NEXUS_GpioType_eAonStandard, 		15,	GPIO_MODE_WRITE,		GPIO_INT_MODE_DISABLED,	GPIO_LOW},
	{GPIO_ID_SLB1_SCART,	NULL,	NEXUS_GpioType_eAonStandard, 		16,	GPIO_MODE_WRITE,		GPIO_INT_MODE_DISABLED,	GPIO_LOW},
	{GPIO_ID_SLB2_SCART,	NULL,	NEXUS_GpioType_eAonStandard, 		17,	GPIO_MODE_WRITE,		GPIO_INT_MODE_DISABLED,	GPIO_LOW},
	...
	{GPIO_ID_BOOT_MODE,				NULL,	NEXUS_GpioType_eAonStandard,	5,	GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,	GPIO_LOW}, /* H : Warm Boot  L : Cold Boot */		
#endif	
};
...
const DI_KEY_FRONT s_BoardFrontKeyMapping[] =
{
		...
		DI_KEY_FRONT_UP,					/* Micom KeyID 2 */
		DI_KEY_FRONT_DOWN,				/* Micom KeyID 3 */
		DI_KEY_FRONT_LEFT,				/* Micom KeyID 4 */
		DI_KEY_FRONT_RIGHT,	 			/* Micom KeyID 5 */
		DI_KEY_FRONT_MENU,				/* Micom KeyID 6 */
		DI_KEY_FRONT_OK,					/* Micom KeyID 7 */
		DI_KEY_FRONT_BACK,				/* Micom KeyID 8 */
