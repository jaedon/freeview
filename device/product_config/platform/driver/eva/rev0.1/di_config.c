...
/* GPIO_ID      GPIO_HANDLER      GPIOTYPE	GPIO_NUMBER      GPIO_MODE      GPIO_INT_MODE      GPIO_INIT_STATE */
	...
	{GPIO_ID_BOOT_MODE,		NULL,	NEXUS_GpioType_eAonStandard,		15,	GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,	GPIO_HI}, /* H : Warm Boot  L : Cold Boot */
#endif
...
HUINT32 DRV_CFG_PlatformInit(void)
{
	...
	NEXUS_SetEnv("B_REFSW_BOXMODE", "13");
