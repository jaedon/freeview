...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_HW_REV0,	  NULL,	  NEXUS_GpioType_eStandard,			147, 		GPIO_MODE_READ,		GPIO_INT_MODE_DISABLED, 		GPIO_INVAILD},
	{GPIO_ID_HW_REV1,   NULL,   NEXUS_GpioType_eStandard, 		146,    	GPIO_MODE_READ,    	GPIO_INT_MODE_DISABLED,    		GPIO_INVAILD},
	{GPIO_ID_HW_REV2,   NULL,   NEXUS_GpioType_eStandard, 		145,    	GPIO_MODE_READ,    	GPIO_INT_MODE_DISABLED,    		GPIO_INVAILD},
	...
	{GPIO_ID_CEC,	NULL,   NEXUS_GpioType_eAonStandard, 		20,   	GPIO_MODE_READ,   	GPIO_INT_MODE_DISABLED, 	GPIO_INVAILD},
...
static const BSPCFG_P_HeapInfo gHeapInfo[BSPCFG_P_HeapType_Last] =
{
	...
	{0, 2, 1, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_General = 2,
	{0, 2, 1, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_Picture = 3,
...
****************************************************************************************************************/
#if defined(CONFIG_DIRECTFB)
#if defined(CONFIG_NETFLIX_SUPPORT) /* Adjust BMEM size for netflix's surface*/
#define NETFLIX_SURFACE_SIZE 50*1024*1024 /* netflix surface cache capacity 41M in oem.xml but running usage is 49M */
#else
#define NETFLIX_SURFACE_SIZE 0
#endif
#define TOTAL_SURFACE_SIZE (90*1024*1024 + NETFLIX_SURFACE_SIZE) /* Temporarily, assigned 90M memory for DFB Surface memory. */
#else
...
#define XPT_UNKNOWN_HEAP_SIZE			(12*1024*1024)
