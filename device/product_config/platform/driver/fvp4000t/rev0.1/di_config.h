...
#define CONFIG_NUM_PARSER_BANDS				(NUM_LIVE+NUM_PIP+NUM_TSR+NUM_REC+NUM_TRANSCODING+NUM_REMUX+SUPPORT_MHEG)
...
#error NEXUS_NUM_PLAYPUMPS
#endif
//use DMA for palyback and record
