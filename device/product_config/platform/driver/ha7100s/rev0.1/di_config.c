...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_HW_REV0,	  NULL,	  NEXUS_GpioType_eStandard,			51, 		GPIO_MODE_READ,		GPIO_INT_MODE_DISABLED, 		GPIO_INVAILD},
	{GPIO_ID_HW_REV1,   NULL,   NEXUS_GpioType_eStandard, 		50,    	GPIO_MODE_READ,    	GPIO_INT_MODE_DISABLED,    		GPIO_INVAILD},
	{GPIO_ID_HW_REV2,   NULL,   NEXUS_GpioType_eStandard, 		49,    	GPIO_MODE_READ,    	GPIO_INT_MODE_DISABLED,    		GPIO_INVAILD},
	...
	{GPIO_ID_LED_STBY,  	NULL,	NEXUS_GpioType_eAonStandard, 		6,	GPIO_MODE_WRITE,		GPIO_INT_MODE_DISABLED,	GPIO_LOW},
	{GPIO_ID_SC1_PWR_SEL,  	NULL,	NEXUS_GpioType_eStandard, 		86,	GPIO_MODE_WRITE,		GPIO_INT_MODE_DISABLED,	GPIO_HI},
    ...
    {GPIO_ID_KEY_CHUP,  NULL,   NEXUS_GpioType_eStandard,        107,     GPIO_MODE_READ,     GPIO_INT_MODE_DISABLED,     GPIO_INVAILD},
    {GPIO_ID_KEY_CHDN,  NULL,   NEXUS_GpioType_eStandard,        108,     GPIO_MODE_READ,     GPIO_INT_MODE_DISABLED,     GPIO_INVAILD},
    {GPIO_ID_KEY_VOLUP, NULL,   NEXUS_GpioType_eStandard,        109,     GPIO_MODE_READ,     GPIO_INT_MODE_DISABLED,     GPIO_INVAILD},
    {GPIO_ID_KEY_VOLDN, NULL,   NEXUS_GpioType_eStandard,        110,     GPIO_MODE_READ,     GPIO_INT_MODE_DISABLED,     GPIO_INVAILD},
#endif
};
...
static const BSPCFG_P_HeapInfo gHeapInfo[BSPCFG_P_HeapType_Last] =
{
	...
	{0, HUMAX_GRAPHICS_HEAP, 0, NEXUS_MemoryType_eApplication},	// BSPCFG_P_HeapType_Surface = 1,
...
#define BSPCFG_P_AUDIO_LOUDNESS_MODE				NEXUS_AudioLoudnessEquivalenceMode_eNone
...
#define FRAMEBUFFERSIZE	6*1024*1024
...
XPT Heap:
****************************************************************************************************************/
#define XPT_HEAP_SIZE 								5*1024*1024
...
****************************************************************************************************************/
	{
		...
		platformSettings->heap[gHeapInfo[heapInfoIndex].heapIndex].size += SIZE_ALIGNED((6*1024*1024), 20);
	}
...
void BSPCFG_GetPlatformSettings(NEXUS_PlatformSettings *tPlatformSettings)
{
...
#endif
		tVideoDecoderModuleSettings->supportedCodecs[NEXUS_VideoCodec_eVp6]  = NEXUS_VideoCodec_eNone;
		tVideoDecoderModuleSettings->supportedCodecs[NEXUS_VideoCodec_eVp7]  = NEXUS_VideoCodec_eNone;
		tVideoDecoderModuleSettings->supportedCodecs[NEXUS_VideoCodec_eVp8]  = NEXUS_VideoCodec_eNone;
		tVideoDecoderModuleSettings->supportedCodecs[NEXUS_VideoCodec_eH265]  = NEXUS_VideoCodec_eNone;
	...
	/* Set the Gfx configuration */
	{
		...
		printf("\n\ngHeapInfo[BSPCFG_P_HeapType_Surface].heapIndex %d, %d  \n\n", gHeapInfo[BSPCFG_P_HeapType_Surface].heapIndex, tSurfaceModuleSettings->heapIndex);
	}
...
#else
	//bmem temporary minimize
	tPlatformSettings->heap[gHeapInfo[0].heapIndex].memcIndex = gHeapInfo[0].memcIndex;
	tPlatformSettings->heap[gHeapInfo[0].heapIndex].subIndex = gHeapInfo[0].uSubIndex;
	tPlatformSettings->heap[gHeapInfo[0].heapIndex].memoryType = gHeapInfo[0].heapType;
	tPlatformSettings->heap[gHeapInfo[0].heapIndex].size += SIZE_ALIGNED((128*1024*1024), 20);
...
HUINT32 DRV_CFG_PlatformInit(void)
{
	...
	NEXUS_Error	eNError		= NEXUS_SUCCESS;
		...
		dfbSettings.displayOutput[1].init = false;
