...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_KEY_STBY,		NULL,   		NEXUS_GpioType_eStandard, 		42,   			GPIO_MODE_READ,   	GPIO_INT_MODE_DISABLED, 	GPIO_INVAILD},
...
#if defined(CONFIG_NETFLIX_SUPPORT) /* Adjust BMEM size for netflix's surface creation failure */
	platformSettings.heap[NEXUS_MEMC0_GRAPHICS_HEAP].size+= 40*1024*1024;
#endif
