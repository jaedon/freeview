...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
    ...
    {GPIO_ID_HW_MUTE,    	NULL,   NEXUS_GpioType_eStandard, 		117,    	GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_INVAILD},
    {GPIO_ID_NVRAM_WP,    	NULL,   NEXUS_GpioType_eStandard, 		146,   	GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_HI},
    {GPIO_ID_FBO_SCART,   	NULL,   NEXUS_GpioType_eStandard, 		85,    	GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_LOW},
    {GPIO_ID_SLB1_SCART,  	NULL,   NEXUS_GpioType_eStandard, 		83,    	GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_LOW},
    {GPIO_ID_SLB2_SCART,    NULL,   NEXUS_GpioType_eStandard, 		84,		GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_LOW},
	{GPIO_ID_LED_STBY,			NULL,	NEXUS_GpioType_eAonStandard,		6,		GPIO_MODE_WRITE,		GPIO_INT_MODE_DISABLED,		GPIO_LOW},
	{GPIO_ID_LED_POWER,			NULL,	NEXUS_GpioType_eAonStandard,		7,		GPIO_MODE_WRITE,		GPIO_INT_MODE_DISABLED,		GPIO_HI},
    {GPIO_ID_KEY_STBY,		NULL,   		NEXUS_GpioType_eAonStandard, 		5,   			GPIO_MODE_READ,   	GPIO_INT_MODE_DISABLED, 	GPIO_INVAILD},
};
...
#define BSPCFG_HEAP_XVD_GENERAL_HEAP_SIZE				10*1024*1024	/*FW 1M, General HEAP 23.3M, Still 4.27M===>Main HeaP*/
#define BSPCFG_HEAP_XVD_PICTURE_HEAP_SIZE				25*1024*1024	/*PICTURE HEAP 61.04===>Picture Heap*/
#define BSPCFG_HEAP_XVD_CDBITB_HEAP_SIZE				3*1024*1024	/*CDB and ITB ===>Main Heap*/
#define BSPCFG_HEAP_XVD_SECURE_HEAP_SIZE				0

/*VDC*/
#define BSPCFG_HEAP_VDC_NUM_FULL_HD_BUFFERS_MEMC0			6
#define BSPCFG_HEAP_VDC_NUM_HD_BUFFERS_MEMC0				0
#define BSPCFG_HEAP_VDC_NUM_SD_BUFFERS_MEMC0				0
#define BSPCFG_HEAP_VDC_NUM_FULL_HD_PIP_BUFFERS_MEMC0			0
#define BSPCFG_HEAP_VDC_NUM_HD_PIP_BUFFERS_MEMC0			0
#define BSPCFG_HEAP_VDC_NUM_SD_PIP_BUFFERS_MEMC0			0
#define BSPCFG_HEAP_VDC_HEAP_SIZE					24*1024*1024	/*support PIP*/

#define BSPCFG_HEAP_RAP_HEAP_SIZE					11*1024*1024	/*====>Main Heap*/
#define BSPCFG_HEAP_XPT_HEAP_SIZE					20*1024*1024
...
#define BSPCFG_HEAP_NEXUS_HEAP_SIZE					16*1024*1024

/*GRC*/
#define BSPCFG_HEAP_GRC_FRAMEBUFFER_HEAP_SIZE				20*1024*1024	/*===> Main Heap*/
#define BSPCFG_HEAP_GRC_SURFACE_HEAP_SIZE				25*1024*1024	/*APP surface ===> Graphic Heap*/

#if defined(CONFIG_DEVICE_MODE_KERNEL)
#define BSPCFG_HEAP_MEMC0_MAIN_HEAP					(BSPCFG_HEAP_XVD_GENERAL_HEAP_SIZE + BSPCFG_HEAP_RAP_HEAP_SIZE + BSPCFG_HEAP_XPT_ACTUAL_HEAP_SIZE + BSPCFG_HEAP_GRC_FRAMEBUFFER_HEAP_SIZE + BSPCFG_HEAP_GRC_SURFACE_HEAP_SIZE + BSPCFG_HEAP_NEXUS_HEAP_SIZE)/*150M*/
...
#else
#define BSPCFG_HEAP_MEMC0_MAIN_HEAP					(BSPCFG_HEAP_XVD_GENERAL_HEAP_SIZE + BSPCFG_HEAP_RAP_HEAP_SIZE + BSPCFG_HEAP_XPT_ACTUAL_HEAP_SIZE + BSPCFG_HEAP_GRC_FRAMEBUFFER_HEAP_SIZE + BSPCFG_HEAP_NEXUS_HEAP_SIZE)/*145M*/
#define BSPCFG_HEAP_PICTURE_BUFFER_HEAP					(BSPCFG_HEAP_XVD_PICTURE_HEAP_SIZE + BSPCFG_HEAP_VDC_HEAP_SIZE) /*118M*/
#define BSPCFG_HEAP_GRAPHICS_HEAP      					(BSPCFG_HEAP_GRC_SURFACE_HEAP_SIZE) /*62M */
#endif
