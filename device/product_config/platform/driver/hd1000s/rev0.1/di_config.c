...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
    ...
    {GPIO_ID_HW_MUTE,    	NULL,   NEXUS_GpioType_eStandard, 		62,   GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_INVAILD},
    {GPIO_ID_nCI_CD1,    	NULL,  	NEXUS_GpioType_eStandard, 	16,    GPIO_MODE_INTERRUPT,	GPIO_INT_MODE_BOTH_EDGES,		GPIO_INVAILD},
    {GPIO_ID_nCI_CD2,    	NULL,  	NEXUS_GpioType_eStandard, 	17,    GPIO_MODE_READ,    	GPIO_INT_MODE_DISABLED,  		GPIO_INVAILD},
    {GPIO_ID_CI_RST,    	NULL,  	NEXUS_GpioType_eStandard,	64,    GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,  		GPIO_LOW},
    {GPIO_ID_CI_PWR,    	NULL,   NEXUS_GpioType_eStandard, 	41,    GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_HI},
    {GPIO_ID_nCI_OUTEN,    	NULL,   NEXUS_GpioType_eStandard,	15,	  GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_LOW},
    {GPIO_ID_CI_IRQ_N, 		NULL,	NEXUS_GpioType_eStandard,		41,   GPIO_MODE_READ,		GPIO_INT_MODE_DISABLED, 		GPIO_INVAILD},
    ...
    {GPIO_ID_FBO_SCART,   	NULL,   NEXUS_GpioType_eStandard, 		26,   GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_LOW},
    {GPIO_ID_SLB1_SCART,  	NULL,   NEXUS_GpioType_eStandard, 		31,   GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_LOW},
    {GPIO_ID_SLB2_SCART,    NULL,   NEXUS_GpioType_eStandard, 		34,	  GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_LOW}
