...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_RST_QAM,    	NULL,   NEXUS_GpioType_eStandard, 		74,   	GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_HI},
...
****************************************************************************************************************/
#if defined(CONFIG_DIRECTFB)
#define TOTAL_SURFACE_SIZE 256*1024*1024 /* Temporarily, assigned 90M memory for DFB Surface memory. */
#else
...
HUINT32 LED_CAPABILITY = (DI_LED_NUM0|DI_LED_NUM1); /* STANDBY_LED, CUBE_LED */
#endif
