...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
    ...
    {GPIO_ID_KEY_STBY,		NULL,   NEXUS_GpioType_eAonStandard, 		3,   	GPIO_MODE_READ,   	GPIO_INT_MODE_DISABLED, 	GPIO_INVAILD},
#endif
...
static const BSPCFG_P_HeapInfo gHeapInfo[BSPCFG_P_HeapType_Last] = 
{
	...
	{0, BSPCFG_P_HeapType_Surface, 0, NEXUS_MemoryType_eApplication},	// BSPCFG_P_HeapType_Surface = 1,
	{0, BSPCFG_P_HeapType_Xvd_General, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_General = 2,
	{0, BSPCFG_P_HeapType_Xvd_Picture, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_Picture = 3,
	{0, BSPCFG_P_HeapType_Ragga, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Ragga = 4,
	{0, BSPCFG_P_HeapType_Vdc, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Vdc = 5,
...
#else
	{0, BSPCFG_P_HeapType_General, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_General = 0,
	{0, BSPCFG_P_HeapType_General, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Surface = 1,
	{0, BSPCFG_P_HeapType_General, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_General = 2,
	{0, BSPCFG_P_HeapType_General, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_Picture = 3,
	{0, BSPCFG_P_HeapType_General, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Ragga = 4,
	{0, BSPCFG_P_HeapType_General, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Vdc = 5,
	{0, BSPCFG_P_HeapType_General, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xpt = 6,
	{0, BSPCFG_P_HeapType_General, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Secure = 7,
#endif
};
...
/*Osd*/
/*Common*/
#define BSPCFG_P_OSD_GFX_HEAP_SIZE					(10*1024*1024)	/*hkyang (20*1024*1024)*/	
...
#define BSPCFG_P_HEAP_RAGGA_SIZE					23*1024*1024 /*35M*/	// Kevin : Fixed
...
#else
#define MISC_HEAP_SIZE ((CONFIG_NUM_PLAYPUMPS*16*1024*1024/10) + VBI_TT_BUFFER + DFB_SURFACE_BUFFER)		// Kevin
#endif
...
#define XPT_UNKNOWN_HEAP_SIZE			0 //10*1024*1024
...
void BSPCFG_GetPlatformSettings(NEXUS_PlatformSettings *tPlatformSettings)
{
	...
	/* Set the display configuration */
	{
		...
		/* platformSettings.displayModuleSettings.vbi.allowTeletext = true; BVBI_Settings struct has no member named 'allowTeletext' */
...
{
	{NEXUS_VideoFormat_e1080p50hz, NEXUS_HdmiColorDepth_e8bit, 0x3b},
