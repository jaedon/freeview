...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
    ...
    {GPIO_ID_LED_WORK,	    NULL,   NEXUS_GpioType_eStandard, 		58,   GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_HI},
...
HUINT32 DRV_CFG_PlatformInit(void)
{
	...
	platformSettings.heap[NEXUS_MEMC0_GRAPHICS_HEAP].size+= 30*1024*1024;
#endif
