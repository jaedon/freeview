...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
    ...
    {GPIO_ID_nCI_CD2,    	NULL,  	NEXUS_GpioType_eStandard, 		73,    	GPIO_MODE_READ,    		GPIO_INT_MODE_DISABLED,    		GPIO_INVAILD},
    {GPIO_ID_CI_RST,    	NULL,   NEXUS_GpioType_eStandard, 		71,    	GPIO_MODE_WRITE,   		GPIO_INT_MODE_DISABLED,    		GPIO_LOW},
    {GPIO_ID_CI_PWR,    	NULL,   NEXUS_GpioType_eStandard, 		57,    	GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_HI},
    {GPIO_ID_nCI_OUTEN,		NULL,   NEXUS_GpioType_eStandard, 		70,    	GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_HI},
    ...
    {GPIO_ID_nCH1_RST,    	NULL,   NEXUS_GpioType_eStandard,				91,    GPIO_MODE_WRITE,    GPIO_INT_MODE_DISABLED,    GPIO_INVAILD},
    {GPIO_ID_nCH0_RST,    	NULL,   NEXUS_GpioType_eStandard,				105,    GPIO_MODE_WRITE,    GPIO_INT_MODE_DISABLED,    GPIO_INVAILD}
};
...
#define BSPCFG_HEAP_VDC_HEAP_SIZE					56*1024*1024	/*support PIP*/
...
#define BSPCFG_HEAP_NEXUS_HEAP_SIZE					36*1024*1024

/*GRC*/
#define BSPCFG_HEAP_GRC_FRAMEBUFFER_HEAP_SIZE				35*1024*1024	/*===> Main Heap*/
#define BSPCFG_HEAP_GRC_SURFACE_HEAP_SIZE				62*1024*1024	/*APP surface ===> Graphic Heap*/
