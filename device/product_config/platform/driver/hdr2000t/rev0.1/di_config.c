...
#if defined(CONFIG_LED_CAPABILITY_MODEL) 
#include "di_led.h"
#endif
...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
    ...
    {GPIO_ID_HW_REV0,	NULL,	NEXUS_GpioType_eStandard,		135, 	GPIO_MODE_READ,		GPIO_INT_MODE_DISABLED, 		GPIO_INVAILD},
    {GPIO_ID_HW_REV1,  NULL,   NEXUS_GpioType_eStandard, 		136,    	GPIO_MODE_READ,    	GPIO_INT_MODE_DISABLED,    		GPIO_INVAILD},
    {GPIO_ID_HW_REV2,  NULL,   NEXUS_GpioType_eStandard, 		137,    	GPIO_MODE_READ,    	GPIO_INT_MODE_DISABLED,    		GPIO_INVAILD},
    ...
    {GPIO_ID_nCH1_RST,      NULL,   NEXUS_GpioType_eStandard,			91,     GPIO_MODE_WRITE,      GPIO_INT_MODE_DISABLED,       GPIO_HI},
    {GPIO_ID_nCH0_RST,      NULL,   NEXUS_GpioType_eStandard,			105,    GPIO_MODE_WRITE,      GPIO_INT_MODE_DISABLED,       GPIO_HI},
    {GPIO_ID_FAN_SPEED,     NULL,   NEXUS_GpioType_eStandard, 		116,   	GPIO_MODE_INTERRUPT,	GPIO_INT_MODE_RISING_EDGE,   GPIO_INVAILD},
    ...
    {GPIO_ID_ANT_EN,        NULL,   NEXUS_GpioType_eStandard,		  149,	  GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_INVAILD}
};
...
static const BSPCFG_P_HeapInfo gHeapInfo[BSPCFG_P_HeapType_Last] = 
{
	...
	{0, BSPCFG_P_HeapType_General, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_General = 0,
	{0, BSPCFG_P_HeapType_Surface, 1, NEXUS_MemoryType_eApplication},	// BSPCFG_P_HeapType_Surface = 1,
	{0, BSPCFG_P_HeapType_Xvd_General, 1, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_General = 2,
	{0, BSPCFG_P_HeapType_Xvd_Picture, 1, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_Picture = 3,
	{0, BSPCFG_P_HeapType_Ragga, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Ragga = 4,
	{0, BSPCFG_P_HeapType_Vdc, 1, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Vdc = 5,
	{0, BSPCFG_P_HeapType_Xpt, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xpt = 6,
	{0, BSPCFG_P_HeapType_Secure, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Secure = 7,
#else
	...
	{0, NEXUS_MEMC0_PICTURE_BUFFER_HEAP, 1, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_General = 2,
	{0, NEXUS_MEMC0_PICTURE_BUFFER_HEAP, 1, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_Picture = 3,
	{0, NEXUS_MEMC0_MAIN_HEAP, 0, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Ragga = 4,
	{0, NEXUS_MEMC0_PICTURE_BUFFER_HEAP, 1, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Vdc = 5,
...
#define BSPCFG_P_AUDIO_PRIMER_NUMBER					0
...
#define BSPCFG_P_FILE_PLAYBACK_FIFO_SIZE				((192/4)*4096)*8
/*Record*/
#define BSPCFG_P_FILE_RECORD_CDB_SIZE					((192/4)*4096)*14*2
#if defined(CONFIG_DOUBLE_SIZE_RECORD_BUFFER)
#define BSPCFG_P_FILE_RECORD_ITB_BUFFER_CHUNK_COUNT	192  /*actually over than double*/
#else
#define BSPCFG_P_FILE_RECORD_ITB_BUFFER_CHUNK_COUNT	48
#endif
#define BSPCFG_P_FILE_RECORD_ITB_SIZE					6*4*16*BSPCFG_P_FILE_RECORD_ITB_BUFFER_CHUNK_COUNT
...
/*Osd*/
/*Common*/
#define BSPCFG_P_OSD_GFX_HEAP_SIZE					(30*1024*1024)	
...
#endif
#define PVR_UNKNOWN_HEAP_SIZE			10*1024*1024
#if defined(CONFIG_DIRECTFB_MASTER)
#define MISC_HEAP_SIZE ((CONFIG_NUM_PLAYPUMPS*16*1024*1024/10) + VBI_TT_BUFFER + DFB_SURFACE_BUFFER + BSPCFG_P_PLAYPUMP_BUFF + PVR_UNKNOWN_HEAP_SIZE)		// Kevin
#else
#define MISC_HEAP_SIZE ((CONFIG_NUM_PLAYPUMPS*16*1024*1024/10) + VBI_TT_BUFFER + DFB_SURFACE_BUFFER + PVR_UNKNOWN_HEAP_SIZE )		// Kevin
#endif
...
#define XPT_UNKNOWN_HEAP_SIZE			30*1024*1024
...
****************************************************************************************************************/
	{
		...
		for (uHeapLoop = 0; uHeapLoop < BSPCFG_P_HeapType_Last; uHeapLoop++) {
			...
			BKNI_Printf("#%20s Size: %4d.%d%d%d Mbytes, Type: %d, Index : %d\n", cHeapName[uHeapLoop], uSizeMbytes, 
																	...
																	platformSettings->heap[uHeapLoop].memoryType, platformSettings->heap[uHeapLoop].subIndex);
...
void BSPCFG_GetPlatformSettings(NEXUS_PlatformSettings *tPlatformSettings)
{
	...
	/* Set the Transport configuration */
	{
...
#if !defined(DO_NOT_OPTIMIZE_RAVE)
		...
		for(uParserBandLoop = NEXUS_ParserBand_e0; uParserBandLoop < CONFIG_NUM_PARSER_BANDS; uParserBandLoop++)
		{
			...
			tTransportModuleSettings->clientEnabled.parserBand[uParserBandLoop].remux[0] = true;
			tTransportModuleSettings->clientEnabled.parserBand[uParserBandLoop].remux[1] = true;
#endif
		}
