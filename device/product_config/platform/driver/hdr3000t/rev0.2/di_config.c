...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_nCH1_RST,      NULL,   NEXUS_GpioType_eStandard,		105,    GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,       	GPIO_HI},
	...
	{GPIO_ID_IP_LED,	NULL,   NEXUS_GpioType_eStandard, 		83,   	GPIO_MODE_WRITE,   	GPIO_INT_MODE_DISABLED, 	GPIO_LOW},
...
const HUINT8 s_FanExecuteCPUTemp[7] =
{
	...
	100,	/* LOW_THRESHOLD */
	105,	/* LOW_MIDDLE_THRESHOLD */
	105,	/* MIDDLE_THRESHOLD */
	105,	/* MIDDLE_HIGH_THRESHOLD */
	105,	/* HIGH_THRESHOLD */
