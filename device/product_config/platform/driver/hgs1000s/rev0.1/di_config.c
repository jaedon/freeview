...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_STBY_KEY_FROM_MICOM,        NULL,    NEXUS_GpioType_eAonStandard, 3,     GPIO_MODE_INTERRUPT,    GPIO_INT_MODE_BOTH_EDGES,  GPIO_INVAILD},
#endif
};
...
static void mem_usage( NEXUS_PlatformSettings *pPlatformSettings, NEXUS_MemoryConfigurationSettings *pMemConfigSettings ) {
	...
	pMemConfigSettings->videoDecoder[3].maxFormat = 30; /* 1080p30 */
	...
	pMemConfigSettings->videoDecoder[3].colorDepth = 8;
	...
	pPlatformSettings->heap[0].size = 185*1024*1024; /* Main */

	pPlatformSettings->heap[3].size = 82*1024*1024; /* Secure */

	pPlatformSettings->heap[4].size = 0*1024*1024; /* Picture */

	pPlatformSettings->heap[5].size = 0*1024*1024; /* Picture */

	pPlatformSettings->heap[6].size = 90*1024*1024; /* Graphics */
