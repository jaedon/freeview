...
#if defined(CONFIG_DEVICE_PRIVILEGE)
#include "privilege.h"
#endif
...
#if defined(CONFIG_DEVICE_PRIVILEGE)
#define DFBMASTER_CAP     PRVLG_CAP_AUDIT_CONTROL,\
		                  PRVLG_CAP_AUDIT_WRITE,\
		                  PRVLG_CAP_CHOWN,\
		                  PRVLG_CAP_DAC_OVERRIDE,\
		                  PRVLG_CAP_DAC_READ_SEARCH,\
		                  PRVLG_CAP_FOWNER,\
		                  PRVLG_CAP_FSETID,\
		                  PRVLG_CAP_IPC_LOCK,\
		                  PRVLG_CAP_IPC_OWNER,\
		                  PRVLG_CAP_KILL,\
		                  PRVLG_CAP_LEASE,\
		                  PRVLG_CAP_LINUX_IMMUTABLE,\
		                  PRVLG_CAP_MAC_ADMIN,\
		                  PRVLG_CAP_MAC_OVERRIDE,\
		                  PRVLG_CAP_MKNOD,\
		                  PRVLG_CAP_NET_ADMIN,\
		                  PRVLG_CAP_NET_BIND_SERVICE,\
		                  PRVLG_CAP_NET_BROADCAST,\
		                  PRVLG_CAP_NET_RAW,\
		                  PRVLG_CAP_SETGID,\
		                  PRVLG_CAP_SETFCAP,\
		                  PRVLG_CAP_SETPCAP,\
		                  ...
		                  PRVLG_CAP_SYS_ADMIN,\
		                  PRVLG_CAP_SYS_BOOT,\
		                  PRVLG_CAP_SYS_CHROOT,\
		                  PRVLG_CAP_SYS_MODULE,\
		                  PRVLG_CAP_SYS_NICE,\
		                  PRVLG_CAP_SYS_PACCT,\
		                  PRVLG_CAP_SYS_TRACE,\
		                  PRVLG_CAP_SYS_RAWIO,\
		                  PRVLG_CAP_SYS_RESOURCE,\
		                  PRVLG_CAP_SYS_TIME,\
		                  PRVLG_CAP_SYS_TTY_CONFIG,\
		                  PRVLG_CAP_SYSLOG,\
...
{
	{GPIO_ID_CI_IRQ_N,           NULL,    NEXUS_GpioType_eStandard, 16,     GPIO_MODE_READ,        GPIO_INT_MODE_DISABLED,    GPIO_INVAILD},
	{GPIO_ID_nCI_CD1,           NULL,    NEXUS_GpioType_eStandard, 17,     GPIO_MODE_INTERRUPT,        GPIO_INT_MODE_BOTH_EDGES,    GPIO_INVAILD},
	{GPIO_ID_nCI_CD2,           NULL,    NEXUS_GpioType_eStandard, 18,     GPIO_MODE_READ,        GPIO_INT_MODE_DISABLED,    GPIO_INVAILD},
	{GPIO_ID_FAN_SPEED,           NULL,    NEXUS_GpioType_eStandard, 61,     GPIO_MODE_INTERRUPT,        GPIO_INT_MODE_FALLING_EDGE,    GPIO_INVAILD},
	{GPIO_ID_HW_MUTE,           NULL,    NEXUS_GpioType_eStandard, 62,     GPIO_MODE_WRITE,        GPIO_INT_MODE_DISABLED,    GPIO_LOW},
	{GPIO_ID_CI_RST,           NULL,    NEXUS_GpioType_eStandard, 66,     GPIO_MODE_WRITE,        GPIO_INT_MODE_DISABLED,    GPIO_LOW},
	{GPIO_ID_CI_PWR,           NULL,    NEXUS_GpioType_eStandard, 67,     GPIO_MODE_WRITE,        GPIO_INT_MODE_DISABLED,    GPIO_HI},
	{GPIO_ID_HDD_PWR_CTRL,    NULL,    NEXUS_GpioType_eStandard,    70,    GPIO_MODE_WRITE,        GPIO_INT_MODE_DISABLED,    GPIO_LOW},
	{GPIO_ID_SC1_PWR_SEL,    NULL,    NEXUS_GpioType_eStandard,    93,    GPIO_MODE_WRITE,        GPIO_INT_MODE_DISABLED,    GPIO_LOW},
	{GPIO_ID_S2_ON,           NULL,    NEXUS_GpioType_eAonStandard, 2,     GPIO_MODE_WRITE,        GPIO_INT_MODE_DISABLED,    GPIO_HI},
#if defined(CONFIG_BRCM_MOD_NEXUS_POWER_MANAGEMENT) && (defined(CONFIG_MICOM) || defined(CONFIG_MICOM_JP))
	{GPIO_ID_BOOT_MODE,    NULL,    NEXUS_GpioType_eAonStandard,    0,    GPIO_MODE_WRITE,        GPIO_INT_MODE_DISABLED,    GPIO_HI}, /* H : Warm Boot  L : Cold Boot */
	{GPIO_ID_STBY_KEY_FROM_MICOM,        NULL,    NEXUS_GpioType_eAonStandard, 1,     GPIO_MODE_INTERRUPT,    GPIO_INT_MODE_BOTH_EDGES,  GPIO_INVAILD},
#endif
#if defined(CONFIG_WIFI)
	{GPIO_ID_WIFI_HOST_WAKE,    NULL,    NEXUS_GpioType_eAonStandard,    9,    GPIO_MODE_READ,        GPIO_INT_MODE_BOTH_EDGES,    GPIO_INVAILD},
#endif
};
...
static void mem_usage( NEXUS_PlatformSettings *pPlatformSettings, NEXUS_MemoryConfigurationSettings *pMemConfigSettings ) {
    ...
    pMemConfigSettings->display[2].maxFormat = NEXUS_VideoFormat_e1080p25hz;
    ...
    pMemConfigSettings->display[3].maxFormat = NEXUS_VideoFormat_e1080p25hz;
    ...
    pPlatformSettings->heap[0].size = 243*1024*1024; /* NEXUS_MEMC0_MAIN_HEAP */
    ...
    pPlatformSettings->heap[6].size = 130*1024*1024; /* NEXUS_MEMC1_GRAPHICS_HEAP */

    pPlatformSettings->heap[7].size = 0*1024*1024; /* NEXUS_MEMC1_DRIVER_HEAP */

    pPlatformSettings->heap[8].size = 32*1024*1024;  /* NEXUS_SAGE_SECURE_HEAP */
    pPlatformSettings->heap[8].memcIndex = 1;

    pPlatformSettings->heap[9].size = 0 * 1024 * 1024; /* NEXUS_MEMC1_HIGH_MEMORY_HEAP */
} /* mem_usage */
#endif
...
HUINT32 DRV_CFG_PlatformInit(void)
{
	...
	NEXUS_SetEnv("B_REFSW_BOXMODE", "4");
    ...
    platformSettings.heap[NEXUS_MEMC0_MAIN_HEAP].size = 264*1024*1024; /* MEMC0_MAIN_HEAP */
    ...
    platformSettings.heap[NEXUS_MEMC1_PICTURE_BUFFER_HEAP].size = 95*1024*1024; /* MEMC1_PICTURE_BUFFER_HEAP */
...
#if defined(CONFIG_DEVICE_PRIVILEGE)
	(void)PRVLG_GetId("dfbmaster", &platformSettings.permissions.userId, &platformSettings.permissions.groupId);
	(void)PRVLG_LimitRootCapability(37,DFBMASTER_CAP);
	(void)PRVLG_ChangeGroup("dfbmaster");
#endif
...
#if defined(CONFIG_DEVICE_PRIVILEGE)
	/* we must call one more time after dropping root */
	(void)PRVLG_LimitRootCapability(37,DFBMASTER_CAP);
#endif
...
const HUINT32 s_FanFreq = 0x3CF0;
