...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
   ...
   // {GPIO_ID_nCI_OUTEN,		NULL,   NEXUS_GpioType_eStandard, 		89,    	GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    		GPIO_HI},
	...
	{GPIO_ID_SLB1_SCART, 	NULL,	NEXUS_GpioType_eStandard,		96,		GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,		GPIO_HI},
	{GPIO_ID_FBO_SCART, 	NULL,	NEXUS_GpioType_eStandard,		97,		GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,		GPIO_HI},
	{GPIO_ID_SLB2_SCART, 	NULL,	NEXUS_GpioType_eStandard,		98,		GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,		GPIO_HI},
...
#if defined(CONFIG_FRONTKEY_GPIO)
/*
	s_GPIO_KeyConfig ±¸Á¶Ã¼´Â di_config.cÀÇ s_BoardFrontKeyMapping¿Í µ¿ÀÏÇÑ index¸¦ °®¾î¾ß ÇÑ´Ù.
	1 : DI_KEY_FRONT_PWR = GPIO_ID_KEY_STBY
	2 ~ n : ÇâÈÄ GPIO KEY ¼³Á¤ ½Ã
*/
...
#endif
	//platformSettings.sharedAnalogMemory = false;	//default : phase 6.5 Â¿Â¡Â´Ã‚ Â»Ã§Â¶Ã³ÃÃ¸ member ?ÃŒÂ¸Ã§, default Â°Âª?ÃŒÂ¶Ã³ Â¸Â·?Â½.
