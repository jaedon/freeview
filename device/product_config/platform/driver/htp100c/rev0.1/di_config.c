...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_LED_POWER,  	NULL,	NEXUS_GpioType_eAonStandard, 		7,	GPIO_MODE_WRITE,		GPIO_INT_MODE_DISABLED,	GPIO_LOW},
	{GPIO_ID_SC0_PWR_SEL,	NULL,	NEXUS_GpioType_eStandard,		23,		GPIO_MODE_WRITE,		GPIO_INT_MODE_DISABLED,		GPIO_INVAILD},	
    ...
    {GPIO_ID_KEY_CHUP,  NULL,   NEXUS_GpioType_eAonStandard,        18,     GPIO_MODE_READ,     GPIO_INT_MODE_DISABLED,     GPIO_INVAILD},
    {GPIO_ID_KEY_CHDN,  NULL,   NEXUS_GpioType_eAonStandard,        19,     GPIO_MODE_READ,     GPIO_INT_MODE_DISABLED,     GPIO_INVAILD},
    {GPIO_ID_KEY_VOLUP, NULL,   NEXUS_GpioType_eAonStandard,        8,     GPIO_MODE_READ,     GPIO_INT_MODE_DISABLED,     GPIO_INVAILD},
    {GPIO_ID_KEY_VOLDN, NULL,   NEXUS_GpioType_eAonStandard,        9,     GPIO_MODE_READ,     GPIO_INT_MODE_DISABLED,     GPIO_INVAILD},
#endif
};
...
{
	{
		...
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_74_pad_ctrl_MASK,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_74_pad_ctrl_SHIFT,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_74_pad_ctrl_PULL_NONE
	},
	{
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_75_pad_ctrl_MASK,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_75_pad_ctrl_SHIFT,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_75_pad_ctrl_PULL_NONE
	},
	{
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_76_pad_ctrl_MASK,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_76_pad_ctrl_SHIFT,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_76_pad_ctrl_PULL_NONE
	},
	{
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_77_pad_ctrl_MASK,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_77_pad_ctrl_SHIFT,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_77_pad_ctrl_PULL_NONE
	},	
	{
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_78_pad_ctrl_MASK,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_78_pad_ctrl_SHIFT,
		BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_78_pad_ctrl_PULL_NONE
	}
};
...
HUINT32 DRV_CFG_PlatformInit(void)
{
	...
	}
	{
		...
		HUINT32 reg = (418 - MAX_TEMPERATURE) * 1000 / 556;
		BREG_Write32(g_hReg, 0x0042306c, reg);
		BREG_Write32(g_hReg, 0x00423068, 1);
	}
...
const HUINT8 s_FanExecuteCPUTemp[7] =
{
	...
	100,	/* LOW_THRESHOLD */
	100,	/* LOW_MIDDLE_THRESHOLD */
	100,	/* MIDDLE_THRESHOLD */
	100,	/* MIDDLE_HIGH_THRESHOLD */
	105,	/* HIGH_THRESHOLD */
