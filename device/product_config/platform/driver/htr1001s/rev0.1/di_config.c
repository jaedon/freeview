...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_BOOT_MODE,		NULL,	NEXUS_GpioType_eAonStandard,	20,	 GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED, 	GPIO_HI}, /* H : Warm Boot  L : Cold Boot */
	#endif
};
...
#define	XPT_PSI_PES_BUFFER_SIZE			(BSPCFG_P_PSI_BUFFER_SIZE*AKYO_SECTION_PSI_NUMBER +\
										BSPCFG_P_PES_BUFFER_SIZE*AKYO_SECTION_PES_NUMBER)	/* Kevin : drv_demux.h ¿Í ¿¬°èÇÏ¿© È®ÀÎ ÇÊ¿ä. */
