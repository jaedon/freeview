...
#define BSPCFG_HEAP_NEXUS_HEAP_SIZE					49*1024*1024
#else
...
HUINT32 DRV_CFG_PlatformInit(void)
{
	...
	PrintError("[DRV_CFG_PlatformInit] Nexus Heap (0-%dMB), (1-%dMB), (2-%dMB)\n", BSPCFG_HEAP_MEMC0_MAIN_HEAP/1024/1024, BSPCFG_HEAP_PICTURE_BUFFER_HEAP/1024/1024, BSPCFG_HEAP_GRAPHICS_HEAP/1024/1024);
