...
static void NEXUS_Platform_P_GetDefaultSettings_by_Custom(NEXUS_PlatformSettings *pSettings)
{
    ...
    pSettings->heap[NEXUS_MEMC1_PICTURE_BUFFER_HEAP].size 		= 256*1024*1024; /* calculated */
    pSettings->heap[NEXUS_MEMC1_PICTURE_BUFFER_HEAP].memoryType = NEXUS_MEMORY_TYPE_MANAGED | NEXUS_MEMORY_TYPE_NOT_MAPPED;

#if (NEXUS_VERSION >= 1402) && (NEXUS_VERSION_MINOR >= 2)
    pSettings->heap[NEXUS_MEMC1_DRIVER_HEAP].memcIndex 		= 1;
    pSettings->heap[NEXUS_MEMC1_DRIVER_HEAP].subIndex 		= 0;
    pSettings->heap[NEXUS_MEMC1_DRIVER_HEAP].size 		= (0x00400000*2); /*NEXUS_VIDEO_ENCODER_ViCE_MEMC0_SECURE_HEAP_SIZE; add some graphics buffers to distribute m2mc load across various memc */                                                                                                     
    ...
    pSettings->heap[NEXUS_MEMC2_PICTURE_BUFFER_HEAP].size 		= 150*1024*1024; /* calculated */
    ...
    pSettings->heap[NEXUS_MEMC2_DRIVER_HEAP].subIndex 			= 0;
    pSettings->heap[NEXUS_MEMC2_DRIVER_HEAP].memoryType 		= NEXUS_MEMORY_TYPE_MANAGED | NEXUS_MEMORY_TYPE_DRIVER_UNCACHED|NEXUS_MEMORY_TYPE_DRIVER_CACHED|NEXUS_MEMORY_TYPE_APPLICATION_CACHED;
    pSettings->heap[NEXUS_MEMC2_DRIVER_HEAP].size 				= 4*1024*1024;  /* RDC heap plus margin */
#else
...
HUINT32 DRV_CFG_PlatformInit(void)
{
    ...
    platformSettings.securitySettings.numKeySlotsForType[0] = 30;
    ...
    platformSettings.securitySettings.numKeySlotsForType[3] = 30;
