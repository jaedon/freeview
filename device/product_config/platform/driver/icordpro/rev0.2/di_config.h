...
#define CONFIG_NUM_INPUT_BANDS				NEXUS_NUM_INPUT_BANDS //(NUM_DEMOD+NUM_CI)
#define CONFIG_NUM_PARSER_BANDS				NEXUS_NUM_PARSER_BANDS //(NUM_LIVE+NUM_PIP+NUM_TSR+NUM_REC+NUM_TRANSCODING+NUM_REMUX)
#define CONFIG_NUM_PLAYPUMPS				NEXUS_NUM_PLAYPUMPS //(NUM_PLAYBACK+NUM_THUMNAIL_DECODE+NUM_AUDIO_PLAYBACK+NUM_PLAYPUMP_TRANSCODING)
