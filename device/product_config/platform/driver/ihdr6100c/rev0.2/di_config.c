...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_CH_RST_N,               NULL,           NEXUS_GpioType_eStandard,       30,             GPIO_MODE_WRITE,        GPIO_INT_MODE_DISABLED,        GPIO_HI},
	{GPIO_ID_CH_IRQ_N,               NULL,           NEXUS_GpioType_eStandard,       28,             GPIO_MODE_READ,         GPIO_INT_MODE_FALLING_EDGE,    GPIO_INVAILD},
	{GPIO_ID_DDR_CLAMPING_CIRCUIT,   NULL,           NEXUS_GpioType_eAonStandard,    17,             GPIO_MODE_WRITE,        GPIO_INT_MODE_DISABLED,        GPIO_INVAILD},
	{GPIO_ID_STBY_KEY_FROM_MICOM,    NULL,           NEXUS_GpioType_eAonStandard,    1,              GPIO_MODE_INTERRUPT,    GPIO_INT_MODE_FALLING_EDGE,    GPIO_INVAILD}
	//{GPIO_ID_RF4CE_RST,     NULL,           NEXUS_GpioType_eStandard,     84,              GPIO_MODE_WRITE,    GPIO_INT_MODE_DISABLED,     GPIO_HI}
};
...
HUINT32 DRV_CFG_PlatformInit(void)
{
	...
	/* because of RTS value, we have to use memc1 for display memory. */	    
	dfbSettings.displayHeapHandle = NEXUS_Platform_GetFramebufferHeap(0);
	dfbSettings.secondaryDisplayHeapHandle = NEXUS_Platform_GetFramebufferHeap(1);
	dfbSettings.offscreenHeapHandle = NEXUS_Platform_GetFramebufferHeap(1);	
