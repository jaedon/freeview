...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_CH_LOOPTHROUGH,    NULL,  	NEXUS_GpioType_eStandard, 		64,    	GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    	GPIO_HI},
	{GPIO_ID_LED_STBY,			NULL,	NEXUS_GpioType_eStandard,		62,		GPIO_MODE_WRITE,		GPIO_INT_MODE_DISABLED,		GPIO_LOW},
	{GPIO_ID_IRQ_FRONT,			NULL,	NEXUS_GpioType_eStandard,		63,		GPIO_MODE_INTERRUPT,	GPIO_INT_MODE_RISING_EDGE,	GPIO_INVAILD},
