...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_SC1_PWR_SEL,	 NULL,	NEXUS_GpioType_eStandard,  87,	  GPIO_MODE_WRITE,	  GPIO_INT_MODE_DISABLED,	 GPIO_INVAILD}, /*B-CAS*/
	{GPIO_ID_SC0_PWR_SEL,	 NULL,	NEXUS_GpioType_eStandard,  84,	  GPIO_MODE_WRITE,	  GPIO_INT_MODE_DISABLED,	 GPIO_INVAILD}, /*C-CAS*/
...
const DI_KEY_FRONT s_BoardFrontKeyMapping[] =
{
		...
		DI_KEY_FRONT_DOWN,				/* Micom KeyID 4 */
