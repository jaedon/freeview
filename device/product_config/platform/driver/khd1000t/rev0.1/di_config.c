...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_HW_MUTE,       NULL,   NEXUS_GpioType_eAonStandard, 		6,		GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED, 	GPIO_INVAILD},
	{GPIO_ID_ANT_PWR_CHK,   NULL,   NEXUS_GpioType_eAonStandard,		4,		GPIO_MODE_READ,		GPIO_INT_MODE_DISABLED,    	GPIO_INVAILD},
	{GPIO_ID_ANT_PWR_EN,    NULL,   NEXUS_GpioType_eAonStandard,		5,		GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    	GPIO_INVAILD},

	{GPIO_ID_LED_STBY,    NULL,   NEXUS_GpioType_eAonStandard,		9,		GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    	GPIO_HI},
...
#endif
#if defined(CONFIG_EXTERNAL_USB_HUB)
	{GPIO_ID_HUB_RESET,    NULL,   NEXUS_GpioType_eAonStandard,		14,		GPIO_MODE_WRITE,    	GPIO_INT_MODE_DISABLED,    	GPIO_HI},
#endif
#if defined(CONFIG_BRCM_MOD_NEXUS_POWER_MANAGEMENT)
	{GPIO_ID_DDR_CLAMPING_CIRCUIT,	NULL,	NEXUS_GpioType_eAonStandard,	12,	 GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED, 	GPIO_LOW},
	{GPIO_ID_BOOT_MODE,		NULL,	NEXUS_GpioType_eAonStandard,	7,	 GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED, 	GPIO_HI}, /* H : Warm Boot  L : Cold Boot */
	#endif
...
{
	/* 75639 index order */
	/* BSPCFG_P_HeapType_General = NEXUS_MEMC0_MAIN_HEAP */
	/* BSPCFG_P_HeapType_Xvd_Picture = NEXUS_MEMC0_PICTURE_BUFFER_HEAP */
	/* BSPCFG_P_HeapType_Surface = NEXUS_MEMC0_GRAPHICS_HEAP */
	BSPCFG_P_HeapType_General = 0,
	BSPCFG_P_HeapType_Xvd_Picture = 1,
	BSPCFG_P_HeapType_Surface = 2,
	BSPCFG_P_HeapType_Xvd_General = 3,
...
/* 75639 index order */
	...
	{0, NEXUS_MEMC0_PICTURE_BUFFER_HEAP, 1, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_Picture = 1,
	{0, NEXUS_MEMC0_GRAPHICS_HEAP, 1, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Surface = 2,
	{0, 3, 1, NEXUS_MemoryType_eFull},	// BSPCFG_P_HeapType_Xvd_General = 3,
...
HUINT32 LED_CAPABILITY = (DI_LED_NUM0|DI_LED_NUM8);
#endif
