...
{
	{GPIO_ID_CH_IRQ_N,                  NULL,    NEXUS_GpioType_eStandard,      93,    GPIO_MODE_INTERRUPT,    GPIO_INT_MODE_LOW_LEVEL,     GPIO_HI},
...
//	{GPIO_ID_KEY_STBY,                  NULL,    NEXUS_GpioType_eAonStandard,   13,    GPIO_MODE_INTERRUPT,    GPIO_INT_MODE_FALLING_EDGE,  GPIO_INVAILD},
	...
	/* LED */
	{GPIO_ID_LED_STBY,                  NULL,    NEXUS_GpioType_eAonStandard,   14,     GPIO_MODE_WRITE,        GPIO_INT_MODE_DISABLED,      GPIO_LOW},
