...
{
	{GPIO_ID_KEY_STBY,                  NULL,    NEXUS_GpioType_eAonStandard,   3,     GPIO_MODE_INTERRUPT,        GPIO_INT_MODE_FALLING_EDGE,      GPIO_INVAILD},
...
#endif
#if defined(CONFIG_CABLE_MODEM) && defined(CONFIG_CABLE_MODEM_RESET_BY_HOST)
	{GPIO_ID_CM_RST_N,                   NULL,    NEXUS_GpioType_eAonStandard,   11,    GPIO_MODE_WRITE,        GPIO_INT_MODE_DISABLED,      GPIO_LOW},
#endif
};
...
static void mem_usage( NEXUS_PlatformSettings *pPlatformSettings, NEXUS_MemoryConfigurationSettings *pMemConfigSettings ) {
    ...
    pPlatformSettings->heap[0].size = 119*1024*1024; /* {98MB + cdb(+13MB) + dmx(8MB)} Main */
