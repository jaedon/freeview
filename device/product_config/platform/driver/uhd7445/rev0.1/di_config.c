...
#define ADDITIONAL_4K_STILL_IMAGE_HEAP_SIZE (36*1024*1024)
...
static void NEXUS_Platform_P_VideoDecoderSettings(NEXUS_VideoDecoderModuleSettings *pSettings)
{
    ...
    pSettings->heapSize[0].picture = NEXUS_VIDEO_DECODER_SHVD0_MEMC2_PICTURE_HEAP_SIZE + ADDITIONAL_4K_STILL_IMAGE_HEAP_SIZE;
...
static void NEXUS_Platform_P_GetDefaultSettings_by_Custom(NEXUS_PlatformSettings *pSettings)
{
    ...
    pSettings->heap[NEXUS_MEMC2_PICTURE_BUFFER_HEAP].size = PAGE_ALIGN(NEXUS_VIDEO_DECODER_SHVD0_MEMC2_PICTURE_HEAP_SIZE + NEXUS_DISPLAY_MEMC2_HEAP_SIZE + ADDITIONAL_4K_STILL_IMAGE_HEAP_SIZE); /*(130+104)*1024*1024;*/
