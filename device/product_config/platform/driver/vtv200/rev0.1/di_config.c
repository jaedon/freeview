...
const GPIO_ConfigInfo_t GPIO_ConfigInfoTable[] =
{
	...
	{GPIO_ID_HW_MUTE,	NULL,	NEXUS_GpioType_eAonStandard,	13,	GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,		GPIO_INVAILD},
	{GPIO_ID_HW_REV0,	NULL,	NEXUS_GpioType_eAonStandard,	14,	GPIO_MODE_READ,		GPIO_INT_MODE_DISABLED,		GPIO_INVAILD},
	{GPIO_ID_HW_REV1,	NULL,	NEXUS_GpioType_eAonStandard,	15,	GPIO_MODE_READ,		GPIO_INT_MODE_DISABLED,		GPIO_INVAILD},
	{GPIO_ID_5V_STANDBY,	NULL,	NEXUS_GpioType_eAonStandard,	20,	GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,		GPIO_HI},
//	{GPIO_ID_SC0_PWR_SEL,	NULL,	NEXUS_GpioType_eAonStandard,	16,	GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,		GPIO_LOW},
	{GPIO_ID_SPI_WP,	NULL,	NEXUS_GpioType_eStandard,	24,	GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,		GPIO_HI},

#if defined(CONFIG_FRONTKEY_GPIO)
	/* front gpio key */
	{GPIO_ID_KEY_STBY,	NULL,	NEXUS_GpioType_eAonStandard,	17,	GPIO_MODE_READ,		GPIO_INT_MODE_FALLING_EDGE,		GPIO_INVAILD},
	{GPIO_ID_KEY_CHUP,	NULL,	NEXUS_GpioType_eAonStandard,	8,	GPIO_MODE_READ,		GPIO_INT_MODE_FALLING_EDGE,		GPIO_INVAILD},
	{GPIO_ID_KEY_CHDN,	NULL,	NEXUS_GpioType_eAonStandard,	9,	GPIO_MODE_READ,		GPIO_INT_MODE_FALLING_EDGE,		GPIO_INVAILD},

#endif

#if defined(CONFIG_LED_GPIO)
	/* front led key */
	{GPIO_ID_LED_POWER,	NULL,	NEXUS_GpioType_eAonStandard,	6,	GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,		GPIO_LOW},
	{GPIO_ID_LED_STBY,	NULL,	NEXUS_GpioType_eAonStandard,	7,	GPIO_MODE_WRITE,	GPIO_INT_MODE_DISABLED,		GPIO_HI}
#endif
};
...
#if defined(CONFIG_FRONTKEY_GPIO)
/*
	s_GPIO_KeyConfig 구조체는 di_config.c의 s_BoardFrontKeyMapping와 동일한 index를 갖어야 한다.
	1 : DI_KEY_FRONT_PWR = GPIO_ID_KEY_STBY
	2 ~ n : 향후 GPIO KEY 설정 시
*/
...
/*
	7584 platform 의 내장 frontend 를 사용하는 경우 device 별 input band 가 이미 정의되어 잇음.
	nexus_platform_frontend.c(7584) 에서 확인해 보면 하기와 같음.
		* ch0 : IB0
		* ch1 : IB6
		* ch2 : IB7
		* ch3 : IB8
...
/*
	내부 frontend 를 사용하므로 여기에 정의된 값은 별 의미 없음.
*/
const DRV_CH_TSOUTPUTMODE s_TSConfig[] =
{
	{DI_CH_TYPE_CAB, CH_TS_MODE_SERIAL}
};
...
#if defined(CONFIG_DIRECTFB)
#define HEAP1_SIZE SIZE_ALIGNED(TOTAL_SURFACE_SIZE, 20)
#else
#define HEAP1_SIZE SIZE_ALIGNED((DEST_RESIZE_SURFACE_SIZE + SRC_SURFACE_SIZE + DEST_SURFACE_SIZE + BSPCFG_P_OSD_GFX_HEAP_SIZE), 20)
#endif

#define HEAP2_SIZE SIZE_ALIGNED(((300 * 1024 * 1024) - HEAP1_SIZE), 20)
        ...
        tPlatformSettings->heap[0].size = HEAP0_SIZE;
...
/* Image_Usage_t */				Image_Usage_FacotryAppBoot,
								{
/* ulStoredAddress */				0,
/* ulLoadingAddress */				(0x52000000),
/* ulSignatureCheckAddress */		0,
/* ulRamdiskRootfsLoadingAddress */	0,
/* ulEntryAddress */				(0x52000000),
/* defaultImageSize */				(0x08000000),
/* Image_Type */					Image_Type_BINARY_ZIPPED,
/* Image_OS */					Image_OS_Linux,
/* Flash_Type */					Flash_Type_eMMC,
/* Secure Execution */				FALSE,
...
/* Image_Usage_t */				Image_Usage_UpgraderBoot,
								{
/* ulStoredAddress */				(FLASH_UBI_DOWNLOADER_PRIMARY_AREA_START),
/* ulLoadingAddress */				0x50030000,
/* ulSignatureCheckAddress */		0,
/* ulRamdiskRootfsLoadingAddress */	0,
/* ulEntryAddress */				0,
/* defaultImageSize */				(UBI_DOWNLOADER_REDUNDANT_PART1_SIZE),
...
/* Image_Usage_t */				Image_Usage_UpgraderBoot2nd,
								{
/* ulStoredAddress */				(FLASH_UBI_DOWNLOADER_REDUNDANT_AREA_START),
/* ulLoadingAddress */				0x50030000,
/* ulSignatureCheckAddress */		0,
/* ulRamdiskRootfsLoadingAddress */	0,
/* ulEntryAddress */				0,
