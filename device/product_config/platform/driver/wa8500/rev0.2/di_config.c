...
#if defined(CONFIG_BRCM_MOD_NEXUS_POWER_MANAGEMENT) && defined(CONFIG_MICOM_JP)
	{GPIO_ID_STBY_KEY_FROM_MICOM,	NULL,	NEXUS_GpioType_eAonStandard,	10,	GPIO_MODE_INTERRUPT,	GPIO_INT_MODE_FALLING_EDGE, GPIO_INVAILD},
#endif
