...
****************************************************************************************************************/
#if defined(CONFIG_DIRECTFB)
#define TOTAL_SURFACE_SIZE 180*1024*1024 /* Temporarily, assigned 180M memory for DFB and OpenGL Surface memory. */
#else
...
#define	XPT_PSI_PES_BUFFER_SIZE			(BSPCFG_P_PSI_BUFFER_SIZE*AKYO_SECTION_PSI_NUMBER +\
										BSPCFG_P_PES_BUFFER_SIZE*AKYO_SECTION_PES_NUMBER)	/* Kevin : drv_demux.h Â¿I Â¿ï¿¢Â°eCIÂ¿??EÂ®?I CEÂ¿a. */
...
{
	{0, "br0:1", DI_NETWORK_DEV_LAN, TRUE, "eth0"},
};
...
#if defined(CONFIG_PRODUCT_IMAGE_UPGRADER)
