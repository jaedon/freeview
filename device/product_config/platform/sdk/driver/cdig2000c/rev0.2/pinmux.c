...
const char g_humaxGpioFunctionTable[HUMAX_NUM_GPIO_PINS] = {
	...
	/*  58 */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 058 */ /* SC0_VCC */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 059 */ /* SC0_CLK */	
	/*  60 */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 060 */ /* SC0_RST */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 061 */ /* SC0_IO */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 062 */ /* SC0_PRES */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 063 */ /* SC0_AUX1 */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 064 */ /* SC0_AUX2 */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 065 */ /* SC0_VPP */
	/*  70 */
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 079 */ /* MTSIF0_CLK */
	/*  80 */ 
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 080 */ /* MTSIF0_DATA0 */
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 081 */ /* MTSIF0_SYNC */
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 082 */ /* MTSIF0_DATA1 */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 083 */ /* NC */
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 084 */ /* MTSIF0_DATA2 */
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 085 */ /* MTSIF0_DATA3 */
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 086 */ /* MTSIF0_DATA4 */
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 087 */ /* MTSIF0_DATA5 */
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 088 */ /* MTSIF0_DATA6 */
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 089 */ /* MTSIF0_DATA7 */
	/*  90 */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 090 */ /* NC */
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 091 */ /* MTSIF0_INC */
	HUMAX_GPIO_FUNCTION_ALT5,	/* GPIO 092 */ /* MTSIF0_RST */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 093 */ /* GP_DEMOD_IRQ */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 094 */ /* NC */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 095 */ /* GP_ENET_LED */
	HUMAX_GPIO_FUNCTION_ALT4,	/* GPIO 096 */ /* ENET_LINK */
	HUMAX_GPIO_FUNCTION_ALT4,	/* GPIO 097 */ /* ENET_ACT */ 
	/* 110 */	
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 110 */ /* UART_TXD_0 */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 111 */ /* UART_RXD_0 */
	
	/* AON_GPIO 00(0~20) */	
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_GPIO 00  */ /* NC */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_GPIO 01  */ /* NC */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_GPIO 02  */ /* NC */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 03  */ /* FR_LED_STBY */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 04  */ /* FR_LED_POWER */
	...
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 12  */ /* BCM3144_RESET */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_GPIO 13  */ /* NC */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 14  */ /* WARM_#COLD */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_GPIO 15  */ /* NC */
	HUMAX_GPIO_FUNCTION_ALT3,	/* AON_GPIO 16  */ /* SPI_CLK*/
	HUMAX_GPIO_FUNCTION_ALT3,	/* AON_GPIO 17  */ /* SPI_MOSI */
	HUMAX_GPIO_FUNCTION_ALT3,	/* AON_GPIO 18  */ /* SPI_MISO */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 19  */ /* SPI_STR (Control GPIO) */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 20  */ /* GP_HDD_PWR_CTRL */

	/* AON_SGPIO (0~1, 4~7)  */	
	HUMAX_GPIO_FUNCTION_ALT1,	/* AON_SGPIO 00 */ /* HDMI_BSC_SCL */
	HUMAX_GPIO_FUNCTION_ALT1,	/* AON_SGPIO 01 */ /* HDMI_BSC_SDA */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_SGPIO 04 */ /* NC */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_SGPIO 05 */ /* NC */
	HUMAX_GPIO_FUNCTION_ALT1,	/* AON_SGPIO 06 */ /* I2C_DEMOD_SCL */
	HUMAX_GPIO_FUNCTION_ALT1,	/* AON_SGPIO 07 */ /* I2C_DEMOD_SDA */
};
