...
const char g_humaxGpioFunctionTable[HUMAX_NUM_GPIO_PINS] = {
	...
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 79   */

	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 80   */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 81   */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 82   */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 83   */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 84   */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 85   */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 86   */
