...
/*				20 			*/
	...
	HUMAX_GPIO_FUNCTION_ALT2,	/* GPIO 024 - SPI SSB*/
...
/*				30 			*/
	...
	HUMAX_GPIO_FUNCTION_ALT2,	/* GPIO 038 - SPI MOSI  */
	HUMAX_GPIO_FUNCTION_ALT2,	/* GPIO 039 - SPI MISO  */
/*				40 			*/
	HUMAX_GPIO_FUNCTION_ALT2,	/* GPIO 040 - SPI SCK  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 041 - NC  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 042 - NC  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 043 - eMMC_CLK/EBI_DS_N  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 044 - eMMC_CMD/EBI_TS_N  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 045 - NC  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 046 - GP_LED_REC_Hi  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 047 - GP_LED_REC_Low  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 048 - GP_LED_SIG_Hi  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 049 - GP_LED_SIG_Low  */
/*				50 			*/
	...
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 059 - GP_3148_IRQ_N */
/*				60 			*/
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 060 - GP_3148_RST_N */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 061 - WIFI_RST#  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 062 - WIFI_RTD_GPIO_B_5  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 063 - WIFI_WLAN_DISABLE1#_GPIO_B_12  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 064 - WIFI_WLAN_DISABLE2#_GPIO_B_2  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 065 - WIFI_WAKE#  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 066 - WIFI_BOARD_DETECT_GPIO_B_16  */
...
/*				70 			*/
	...
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 074 - GP_HDD_PWR_CTRL */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 075 - HW_MUTE */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 076 - SLB1_SCART */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 077 - SLB2_SCART */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 078 - FBO_SCART */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 079 - GP_LED_REC_RED  */
/*				80 			*/
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 080 - GP_LED_REC_BLUE  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 081 - GP_LED_REC_GREEN  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 082 - NC  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 083 - NC */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 084 - GP_LED_SIG_RED  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 085 - GP_LED_SIG_BLUE  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 086 - GP_LED_SIG_GREEN  */
	HUMAX_GPIO_FUNCTION_ALT3,	/* GPIO 087 - GP_MTSIF0_CLK */
	HUMAX_GPIO_FUNCTION_ALT3,	/* GPIO 088 - GP_MTSIF0_DATA0 */
	HUMAX_GPIO_FUNCTION_ALT3,	/* GPIO 089 - GP_MTSIF0_SYNC */
/*				90			*/
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 090 - TP */
	HUMAX_GPIO_FUNCTION_ALT3,	/* GPIO 091 - GP_MTSIF0_DATA1  */
	...
	HUMAX_GPIO_FUNCTION_GPIO,	/* GPIO 095 - RST_SW  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 096 - UART_TXD_2 */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 097 - UART_RXD_2 */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 098 - SF_HOLD_N  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 099 - SF_WP_N  */
/*				100			*/
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 100 - NC  */
	HUMAX_GPIO_FUNCTION_ALT7,	/* GPIO 101 - GP_MTSIF0_DATA2  */
	HUMAX_GPIO_FUNCTION_ALT7,	/* GPIO 102 - GP_MTSIF0_DATA3  */
	HUMAX_GPIO_FUNCTION_ALT4,	/* GPIO 103 - GP_MTSIF0_DATA4  */
	HUMAX_GPIO_FUNCTION_ALT7,	/* GPIO 104 - GP_MTSIF_ATS_RST_025 */
	HUMAX_GPIO_FUNCTION_ALT6,	/* GPIO 105 - GP_MTSIF0_DATA5  */
...
/*				110			*/
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 110 - +3.3V pull up */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 111 - USB1_PWRFLT */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 112 - +3.3V pull up */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 113 - +3.3V pull up */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 114 - ENET_ACT  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 115 - NC  */
	HUMAX_GPIO_FUNCTION_ALT7,	/* GPIO 116 - GP_MTSIF_ATS_INC_058  */
	HUMAX_GPIO_FUNCTION_ALT7,	/* GPIO 117 - GP_MTSIF0_DATA6  */
	HUMAX_GPIO_FUNCTION_ALT7,	/* GPIO 118 - GP_MTSIF0_DATA7  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 119 - NC  */
/*				120			*/
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 120 - NC  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 121 - NC  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 122 - SDIO_CMD  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 123 - SDIO_WPROT  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 124 - TP  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 125 - SDIO_CLK  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 126 - SDIO_DAT0  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 127 - SDIO_DAT1  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 128 - SDIO_DAT2  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 129 - SDIO_DAT3 */
/*				130			*/
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 130 - SDIO_PRES  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 131 - TP  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 132 - WIFI_GTXEN0_O  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 133 - TP  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 134 - WIFI_GTXCLK0_O  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 135 - TP  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 136 - TP  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 137 - TP  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 138 - WIFI_GRXCLK0_I  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 139 - WIFI_GTXD0_O_3  */
/*				140			*/
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 140 - WIFI_GTXD0_O_2  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 141 - WIFI_GTXD0_O_1  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 142 - WIFI_GTXD0_O_0  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 143 - WIFI_GRXD0_I_3  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 144 - WIFI_GRXD0_I_2  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 145 - WIFI_GRXD0_I_1  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 146 - WIFI_GRXD0_I_0  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* GPIO 147 - WIFI_GRXDV0_I  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 148 - TP  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* GPIO 149 - TP  */
/*				150			*/
	HUMAX_GPIO_FUNCTION_NCTP,	/* SGPIO 00 - HDMI_M2_SCL ?  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* SGPIO 01 - HDMI_M2_SDA ?  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* SGPIO 02 - +3.3V pull up  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* SGPIO 03 - +3.3V pull up  */
	...
	HUMAX_GPIO_FUNCTION_ALT3,	/* AON_GPIO 03 - STBY_Key_IN  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 04 - AON_LED_STBY  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 05 - AON_LED_PWR  */
/*				160			*/
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 06 - AON_LED_STBY_CTL  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 07 - AON_LED_PWR_CTL  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 08 - WIFI_WAKE  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_GPIO 09 - NC  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_GPIO 10 - AON_STRAP_OSC_HIGHPASS_UP  */
	HUMAX_GPIO_FUNCTION_ALT5,	/* AON_GPIO 11 - AON_GPIO_3461_SPI_SCK  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 12 - WARM_#COLD  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 13 - STBY_Key_IN  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 14 - AON_LED_STBY_DIM  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 15 - AON_LED_PWR_DIM  */
/*				170			*/
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_GPIO 16 - NC  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_GPIO 17 - NC */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_GPIO 18 - NC  */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_GPIO 19 - NC  */
	HUMAX_GPIO_FUNCTION_GPIO,	/* AON_GPIO 20 - AON_HDMI_CEC  */
	HUMAX_GPIO_FUNCTION_ALT1,	/* AON_SGPIO 00 - BSC_M0_SCL */
	HUMAX_GPIO_FUNCTION_ALT1,	/* AON_SGPIO 01 - BSC_M0_SCA */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_SGPIO 02 - NC */
	HUMAX_GPIO_FUNCTION_NCTP,	/* AON_SGPIO 03 - NC */
	HUMAX_GPIO_FUNCTION_ALT1,	/* AON_SGPIO 04 - HDMI_M2_SCL(in schematic) */
/*				180			*/
	HUMAX_GPIO_FUNCTION_ALT1,	/* AON_SGPIO 05 - HDMI_M2_SDA(in schematic) */


	/* set Pad of RGB LEDs to PULL-UP */
	BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_079_pad_ctrl_PULL_UP,
	BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_080_pad_ctrl_PULL_UP,
	
	BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_081_pad_ctrl_PULL_UP,
	BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_084_pad_ctrl_PULL_UP,
	BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_085_pad_ctrl_PULL_UP,
	BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_086_pad_ctrl_PULL_UP,

	/* set Pad of AON GPIO of STANDBY/POWER LED to PULL-NONE */
	BCHP_AON_PIN_CTRL_PIN_MUX_PAD_CTRL_1_aon_gpio_14_pad_ctrl_PULL_NONE,
	BCHP_AON_PIN_CTRL_PIN_MUX_PAD_CTRL_1_aon_gpio_15_pad_ctrl_PULL_NONE
};
...
/* set Pad of RGB LEDs to PULL-UP */
	{BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_079_pad_ctrl_MASK, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_079_pad_ctrl_SHIFT},
	{BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_080_pad_ctrl_MASK, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_5_gpio_080_pad_ctrl_SHIFT},	

       {BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_081_pad_ctrl_MASK, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_081_pad_ctrl_SHIFT},
       {BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_084_pad_ctrl_MASK, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_084_pad_ctrl_SHIFT},
       {BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_085_pad_ctrl_MASK, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_085_pad_ctrl_SHIFT},
       {BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_086_pad_ctrl_MASK, BCHP_SUN_TOP_CTRL_PIN_MUX_PAD_CTRL_6_gpio_086_pad_ctrl_SHIFT},

/* set Pad of AON GPIO of STANDBY/POWER LED to PULL-NONE */
	{BCHP_AON_PIN_CTRL_PIN_MUX_PAD_CTRL_1, BCHP_AON_PIN_CTRL_PIN_MUX_PAD_CTRL_1_aon_gpio_14_pad_ctrl_MASK, BCHP_AON_PIN_CTRL_PIN_MUX_PAD_CTRL_1_aon_gpio_14_pad_ctrl_SHIFT},
	{BCHP_AON_PIN_CTRL_PIN_MUX_PAD_CTRL_1, BCHP_AON_PIN_CTRL_PIN_MUX_PAD_CTRL_1_aon_gpio_15_pad_ctrl_MASK, BCHP_AON_PIN_CTRL_PIN_MUX_PAD_CTRL_1_aon_gpio_15_pad_ctrl_SHIFT},
