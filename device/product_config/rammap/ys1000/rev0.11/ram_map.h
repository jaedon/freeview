...
#define HDF_COMPRESSED_RAM_ADDR		(0xD0000000)
#define HDF_COMPRESSED_RAM_SIZE			(0x10000000)	// 256MB

#define HDF_DECOMPRESSED_RAM_ADDR		(0xE0000000)
#define HDF_DECOMPRESSED_RAM_SIZE		(0x10000000)	// 256MB
