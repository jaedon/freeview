...
then
	...
	OUTPUT_FILE_NAME="$PRODUCT_NAME"_upgrade_loader.hdf
	APP_CFG=app_loader.cfg
	...
	cp $INPUT_IMAGE_PATH/aes_key.bin $INPUT_IMAGE_PATH/rsa_private_key_2048.bin $INPUT_IMAGE_PATH/rsa_public_key_2048.bin $INPUT_IMAGE_PATH/loader.bin $APP_IMAGE_PATH
