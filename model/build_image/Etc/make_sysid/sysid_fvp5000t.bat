...
if "%1"=="" (
	SET CFG_NAME=sysid_fvp5000t.cfg
) else (
	SET CFG_NAME=%1
)
...
if /i %CFG_NAME%==help (
	...
	@echo config_file_name : default name sysid_fvp5000t.cfg
	@echo output_file_name : default name sysid_fvp5000t.hdf
	@echo e.g. %0 : output sysid_fvp5000t.hdf
	@echo e.g. %0 sysid_00001111.cfg : output sysid_fvp5000t.hdf
...
if "%2"=="" (
	SET OUTPUT_FILE_NAME=fvp5000t_upgrade_systemid.hdf
) else (
