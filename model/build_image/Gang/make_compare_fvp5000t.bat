...
SET OUTPUT_FILE_NAME=%PROD_NAME%_compare_fvp5000t.hdf
SET CFG_NAME=compare_fvp5000t.cfg
...
%BIN_DIR%\unzip.exe -o nvram_fvp5000t.bin.zip
if /i NOT %ERR_CODE%==0 goto error

@echo STEP 2. Create Singed/Encrypted Kernel/Rootfs Binary.
%BIN_DIR%\makehdf.exe enc_sign_kernel_N_rootfs.cfg fvp5000t_enc_N_sign_tmp.hdf
if NOT EXIST fvp5000t_enc_N_sign_tmp.hdf (
	SET ERR_CODE=5
	goto error
)
...
%BIN_DIR%\makenvram ronvram_fvp5000t.cfg ronvram.bin
