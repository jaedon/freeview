...
#if 1 /* HUMAX */
    /* to separate sqeuence header and frame date of VC1 simple & main codec for vc1_asftobrcm filter */
    struct AVPacket *next;
#endif
...
#if 1 /* HUMAX */
#define AV_PKT_FLAG_SECURE_BUF 0x0400  ///< The packet contains data in secure buffer
#define AV_PKT_FLAG_NEED_FREE_SECURE_BUF 0x800	///< The packet should be freed
#endif
...
#if 1 /* HUMAX */
                               AVCodecContext *avctx, char *args,
#else
                               AVCodecContext *avctx, const char *args,
#endif
                               uint8_t **poutbuf, int *poutbuf_size,
