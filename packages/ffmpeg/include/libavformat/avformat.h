...
*************************/
	void *drm_handle;
	int (*get_license)(void *drm_handle, unsigned char *drm_name, unsigned char *data, unsigned int len);
	int (*do_decrypt)(void *drm_handle, unsigned char *data, unsigned int size, unsigned char *key, unsigned char *iv);
	int (*read_wmdrm10_wrmheader)(void *drm_handle, struct AVFormatContext *s, uint8_t **wrmheader, uint32_t *wrmheaderlen);
	int (*read_playready_wrmheader)(void *drm_handle, struct AVFormatContext *s, uint8_t **wrmheader, uint32_t *wrmheaderlen);
#endif
...
#if 1 /* HUMAX */
int av_set_getlicense_callback(AVFormatContext *s, void *drm_handle, void* callback);
int av_set_decrypt_callback(AVFormatContext *s, void *drm_handle, void* callback);
int av_set_read_wmdrm10_wrmheader_callback(AVFormatContext *s, void *drm_handle, void* callback);
int av_set_read_playready_wrmheader_callback(AVFormatContext *s, void *drm_handle, void* callback);
#endif
