...
#ifdef NETFLIX_EXT
DRM_API DRM_RESULT DRM_CALL Drm_LicenseAcq_GenerateChallenge_Netflix(
    __in                                          DRM_APP_CONTEXT  *f_poAppContext,
    __in_ecount_opt( f_cRights )            const DRM_CONST_STRING *f_rgpdstrRights[],
    __in                                          DRM_DWORD         f_cRights,
    __in_opt                                const DRM_DOMAIN_ID    *f_poDomainID,
    ...
    __in                                    const DRM_BOOL          f_fIsLDL); // LDL challenge
#endif
...
DRM_API DRM_RESULT DRM_CALL Drm_LicenseAcq_ProcessResponse_Netflix(
    __in                        DRM_APP_CONTEXT                *f_poAppContext,
    __in                        DRM_PROCESS_LIC_RESPONSE_FLAG   f_dwFlags,
    __in_opt                    pfnLicenseResponseCallback      f_pfnCallback,
    __in_opt                    DRM_VOID                       *f_pvCallbackContext,
...
DRM_API DRM_RESULT DRM_CALL Drm_LicenseAcq_CancelChallenge_Netflix(
    __in               const DRM_APP_CONTEXT  *f_poAppContext,
    __in_bcount( 16 )  const DRM_BYTE         *f_pbNonce);

DRM_API DRM_RESULT DRM_CALL Drm_LicenseAcq_GetLdlSessionsLimit_Netflix(
    __in               const DRM_APP_CONTEXT  *f_poAppContext,
    __out                    DRM_DWORD        *f_pLdlSessionsLimit);

DRM_API DRM_RESULT DRM_CALL Drm_LicenseAcq_FlushLdlChallenges_Netflix(
    __in               const DRM_APP_CONTEXT  *f_poAppContext);
...
#ifdef NETFLIX_EXT
DRM_API DRM_RESULT DRM_CALL Drm_Reader_Bind_Netflix(
    __in                           DRM_APP_CONTEXT      *f_poAppContext,
...
/**********************************************************************
** Function:    Drm_Clock_GetSystemTime
** Synopsis:    Gets current System time. It is expressed in UTC as
**              a time_t compatible value.
** Arguments:   [f_poAppContext]--App context
**              [f_psystem]--Pointer to DRM_UINT64 value to get the
**              time.
***********************************************************************/
