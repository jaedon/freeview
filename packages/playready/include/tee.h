 ...
 ***************************************************************************************/
int TEE_StartSession(const DRM_BYTE * const inSessionId, const DRM_BOOL isLdl );
 ...
 ***********************************/
int TEE_GetLdlSessionsLimit(DRM_DWORD * const outLdlSessionsLimit);

/*****************************************
 * Flush all outstanding LDL chaallenges *
 *****************************************/
int TEE_FlushLdlChallenges(DRM_VOID);
 ...
 *************************************************************/
// NOTE: Return type is NOT bool! Returns TEE_SUCCESS (0) if the session exists,
// non-zero otherwise.
int TEE_HasSessionByKID(const DRM_BYTE * const inKID);

/***********************************************************************************
 * Bind content decryption key to a given session, at the beginning of a playback. *
 ***********************************************************************************/
int TEE_BindSession(const DRM_BYTE * const inSessionId,
 ...
 **************************************************************************/
int TEE_DecryptUpdate(const OEM_HAL_KEY_REGISTER_INDEX inKeyIndex,
