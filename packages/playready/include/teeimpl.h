...
int teeUpdate(const DRM_BYTE * const inbuf,
	      const DRM_DWORD        inlen);
 ...
 ***************************************************************************************/
int teeStartSession(const DRM_BYTE * const inSessionId, const DRM_BOOL isLdl);
...
/************************************
 * Get Upper Limit for LDL Sessions *
 ************************************/
int teeGetLdlSessionsLimit(DRM_DWORD * const outLdlSessionsLimit);

/****************************************
 * Remove all LDL challenges from cache *
 ****************************************/
int teeFlushLdlChallenges();
 ...
 *************************************************************/
int teeHasSessionByKID(const DRM_BYTE * const inKID);

/***********************************************************************************
 * Bind content decryption key to a given session, at the beginning of a playback. *
 ***********************************************************************************/
int teeBindSession(const DRM_BYTE * const inSessionId,
 ...
 **************************************************************************/
int teeDecryptUpdate(const OEM_HAL_KEY_REGISTER_INDEX inKeyIndex,
